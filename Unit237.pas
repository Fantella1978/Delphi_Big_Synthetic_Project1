...
type
  ...
  TMyObj237_List0 = TObjectList<TMyObj237>;

  TMyObj237_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj237_List1 = TObjectList<TMyObj237_1>;
...
constructor TMyObj237_1.Create;
begin
  inherited;
  FInt := 237 * 3;
  FTest := 'Value: ' + Random(22372).ToString + Random(23700).ToString;
end;

procedure TForm237.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum237;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj237_List0 := TMyObj237_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj237_List1 := TMyObj237_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
