...
type
  ...
  TMyObj1326_List0 = TObjectList<TMyObj1326>;

  TMyObj1326_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1326_List1 = TObjectList<TMyObj1326_1>;
...
constructor TMyObj1326_1.Create;
begin
  inherited;
  FInt := 1326 * 3;
  FTest := 'Value: ' + Random(213262).ToString + Random(132600).ToString;
end;

procedure TForm1326.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1326;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1326_List0 := TMyObj1326_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1326_List1 := TMyObj1326_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
