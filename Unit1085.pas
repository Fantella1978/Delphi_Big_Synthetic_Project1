...
type
  ...
  TMyObj1085_List0 = TObjectList<TMyObj1085>;

  TMyObj1085_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1085_List1 = TObjectList<TMyObj1085_1>;
...
constructor TMyObj1085_1.Create;
begin
  inherited;
  FInt := 1085 * 3;
  FTest := 'Value: ' + Random(210852).ToString + Random(108500).ToString;
end;

procedure TForm1085.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1085;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1085_List0 := TMyObj1085_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1085_List1 := TMyObj1085_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
