...
type
  ...
  TMyObj772_List0 = TObjectList<TMyObj772>;

  TMyObj772_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj772_List1 = TObjectList<TMyObj772_1>;
...
constructor TMyObj772_1.Create;
begin
  inherited;
  FInt := 772 * 3;
  FTest := 'Value: ' + Random(27722).ToString + Random(77200).ToString;
end;

procedure TForm772.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum772;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj772_List0 := TMyObj772_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj772_List1 := TMyObj772_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
