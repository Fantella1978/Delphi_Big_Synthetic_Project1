...
type
  ...
  TMyObj1375_List0 = TObjectList<TMyObj1375>;

  TMyObj1375_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1375_List1 = TObjectList<TMyObj1375_1>;
...
constructor TMyObj1375_1.Create;
begin
  inherited;
  FInt := 1375 * 3;
  FTest := 'Value: ' + Random(213752).ToString + Random(137500).ToString;
end;

procedure TForm1375.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1375;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1375_List0 := TMyObj1375_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1375_List1 := TMyObj1375_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
