...
type
  ...
  TMyObj1465_List0 = TObjectList<TMyObj1465>;

  TMyObj1465_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1465_List1 = TObjectList<TMyObj1465_1>;
...
constructor TMyObj1465_1.Create;
begin
  inherited;
  FInt := 1465 * 3;
  FTest := 'Value: ' + Random(214652).ToString + Random(146500).ToString;
end;

procedure TForm1465.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1465;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1465_List0 := TMyObj1465_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1465_List1 := TMyObj1465_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
