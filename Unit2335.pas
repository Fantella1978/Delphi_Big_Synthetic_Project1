...
type
  ...
  TMyObj2335_List0 = TObjectList<TMyObj2335>;

  TMyObj2335_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2335_List1 = TObjectList<TMyObj2335_1>;
...
constructor TMyObj2335_1.Create;
begin
  inherited;
  FInt := 2335 * 3;
  FTest := 'Value: ' + Random(223352).ToString + Random(233500).ToString;
end;

procedure TForm2335.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2335;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2335_List0 := TMyObj2335_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2335_List1 := TMyObj2335_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
