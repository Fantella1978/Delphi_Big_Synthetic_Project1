...
type
  ...
  TMyObj133_List0 = TObjectList<TMyObj133>;

  TMyObj133_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj133_List1 = TObjectList<TMyObj133_1>;
...
constructor TMyObj133_1.Create;
begin
  inherited;
  FInt := 133 * 3;
  FTest := 'Value: ' + Random(21332).ToString + Random(13300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj133_List0 := TMyObj133_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj133_List1 := TMyObj133_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
