...
type
  ...
  TMyObj2484_List0 = TObjectList<TMyObj2484>;

  TMyObj2484_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2484_List1 = TObjectList<TMyObj2484_1>;
...
constructor TMyObj2484_1.Create;
begin
  inherited;
  FInt := 2484 * 3;
  FTest := 'Value: ' + Random(224842).ToString + Random(248400).ToString;
end;

procedure TForm2484.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2484;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2484_List0 := TMyObj2484_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2484_List1 := TMyObj2484_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
