...
type
  ...
  TMyObj1481_List0 = TObjectList<TMyObj1481>;

  TMyObj1481_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1481_List1 = TObjectList<TMyObj1481_1>;
...
constructor TMyObj1481_1.Create;
begin
  inherited;
  FInt := 1481 * 3;
  FTest := 'Value: ' + Random(214812).ToString + Random(148100).ToString;
end;

procedure TForm1481.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1481;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1481_List0 := TMyObj1481_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1481_List1 := TMyObj1481_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
