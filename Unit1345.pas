...
type
  ...
  TMyObj1345_List0 = TObjectList<TMyObj1345>;

  TMyObj1345_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1345_List1 = TObjectList<TMyObj1345_1>;
...
constructor TMyObj1345_1.Create;
begin
  inherited;
  FInt := 1345 * 3;
  FTest := 'Value: ' + Random(213452).ToString + Random(134500).ToString;
end;

procedure TForm1345.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1345;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1345_List0 := TMyObj1345_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1345_List1 := TMyObj1345_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
