...
type
  ...
  TMyObj151_List0 = TObjectList<TMyObj151>;

  TMyObj151_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj151_List1 = TObjectList<TMyObj151_1>;
...
constructor TMyObj151_1.Create;
begin
  inherited;
  FInt := 151 * 3;
  FTest := 'Value: ' + Random(21512).ToString + Random(15100).ToString;
end;

procedure TForm151.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum151;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj151_List0 := TMyObj151_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj151_List1 := TMyObj151_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
