...
type
  ...
  TMyObj561_List0 = TObjectList<TMyObj561>;

  TMyObj561_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj561_List1 = TObjectList<TMyObj561_1>;
...
constructor TMyObj561_1.Create;
begin
  inherited;
  FInt := 561 * 3;
  FTest := 'Value: ' + Random(25612).ToString + Random(56100).ToString;
end;

procedure TForm561.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum561;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj561_List0 := TMyObj561_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj561_List1 := TMyObj561_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
