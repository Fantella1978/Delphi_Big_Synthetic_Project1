...
type
  ...
  TMyObj981_List0 = TObjectList<TMyObj981>;

  TMyObj981_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj981_List1 = TObjectList<TMyObj981_1>;
...
constructor TMyObj981_1.Create;
begin
  inherited;
  FInt := 981 * 3;
  FTest := 'Value: ' + Random(29812).ToString + Random(98100).ToString;
end;

procedure TForm981.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum981;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj981_List0 := TMyObj981_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj981_List1 := TMyObj981_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
