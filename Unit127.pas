...
type
  ...
  TMyObj127_List0 = TObjectList<TMyObj127>;

  TMyObj127_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj127_List1 = TObjectList<TMyObj127_1>;
...
constructor TMyObj127_1.Create;
begin
  inherited;
  FInt := 127 * 3;
  FTest := 'Value: ' + Random(21272).ToString + Random(12700).ToString;
end;

procedure TForm127.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum127;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj127_List0 := TMyObj127_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj127_List1 := TMyObj127_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
