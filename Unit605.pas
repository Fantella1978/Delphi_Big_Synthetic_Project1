...
type
  ...
  TMyObj605_List0 = TObjectList<TMyObj605>;

  TMyObj605_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj605_List1 = TObjectList<TMyObj605_1>;
...
constructor TMyObj605_1.Create;
begin
  inherited;
  FInt := 605 * 3;
  FTest := 'Value: ' + Random(26052).ToString + Random(60500).ToString;
end;

procedure TForm605.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum605;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj605_List0 := TMyObj605_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj605_List1 := TMyObj605_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
