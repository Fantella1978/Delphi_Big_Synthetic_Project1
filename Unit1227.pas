...
type
  ...
  TMyObj1227_List0 = TObjectList<TMyObj1227>;

  TMyObj1227_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1227_List1 = TObjectList<TMyObj1227_1>;
...
constructor TMyObj1227_1.Create;
begin
  inherited;
  FInt := 1227 * 3;
  FTest := 'Value: ' + Random(212272).ToString + Random(122700).ToString;
end;

procedure TForm1227.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1227;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1227_List0 := TMyObj1227_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1227_List1 := TMyObj1227_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
