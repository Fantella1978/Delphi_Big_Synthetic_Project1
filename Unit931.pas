...
type
  ...
  TMyObj931_List0 = TObjectList<TMyObj931>;

  TMyObj931_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj931_List1 = TObjectList<TMyObj931_1>;
...
constructor TMyObj931_1.Create;
begin
  inherited;
  FInt := 931 * 3;
  FTest := 'Value: ' + Random(29312).ToString + Random(93100).ToString;
end;

procedure TForm931.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum931;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj931_List0 := TMyObj931_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj931_List1 := TMyObj931_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
