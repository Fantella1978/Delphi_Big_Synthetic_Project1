...
type
  ...
  TMyObj381_List0 = TObjectList<TMyObj381>;

  TMyObj381_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj381_List1 = TObjectList<TMyObj381_1>;
...
constructor TMyObj381_1.Create;
begin
  inherited;
  FInt := 381 * 3;
  FTest := 'Value: ' + Random(23812).ToString + Random(38100).ToString;
end;

procedure TForm381.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum381;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj381_List0 := TMyObj381_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj381_List1 := TMyObj381_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
