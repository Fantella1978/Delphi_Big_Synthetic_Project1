...
type
  ...
  TMyObj1580_List0 = TObjectList<TMyObj1580>;

  TMyObj1580_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1580_List1 = TObjectList<TMyObj1580_1>;
...
constructor TMyObj1580_1.Create;
begin
  inherited;
  FInt := 1580 * 3;
  FTest := 'Value: ' + Random(215802).ToString + Random(158000).ToString;
end;

procedure TForm1580.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1580;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1580_List0 := TMyObj1580_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1580_List1 := TMyObj1580_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
