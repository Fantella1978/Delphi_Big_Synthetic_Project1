...
type
  ...
  TMyObj1145_List0 = TObjectList<TMyObj1145>;

  TMyObj1145_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1145_List1 = TObjectList<TMyObj1145_1>;
...
constructor TMyObj1145_1.Create;
begin
  inherited;
  FInt := 1145 * 3;
  FTest := 'Value: ' + Random(211452).ToString + Random(114500).ToString;
end;

procedure TForm1145.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1145;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1145_List0 := TMyObj1145_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1145_List1 := TMyObj1145_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
