...
type
  ...
  TMyObj1661_List0 = TObjectList<TMyObj1661>;

  TMyObj1661_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1661_List1 = TObjectList<TMyObj1661_1>;
...
constructor TMyObj1661_1.Create;
begin
  inherited;
  FInt := 1661 * 3;
  FTest := 'Value: ' + Random(216612).ToString + Random(166100).ToString;
end;

procedure TForm1661.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1661;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1661_List0 := TMyObj1661_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1661_List1 := TMyObj1661_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
