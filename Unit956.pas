...
type
  ...
  TMyObj956_List0 = TObjectList<TMyObj956>;

  TMyObj956_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj956_List1 = TObjectList<TMyObj956_1>;
...
constructor TMyObj956_1.Create;
begin
  inherited;
  FInt := 956 * 3;
  FTest := 'Value: ' + Random(29562).ToString + Random(95600).ToString;
end;

procedure TForm956.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum956;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj956_List0 := TMyObj956_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj956_List1 := TMyObj956_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
