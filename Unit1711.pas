...
type
  ...
  TMyObj1711_List0 = TObjectList<TMyObj1711>;

  TMyObj1711_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1711_List1 = TObjectList<TMyObj1711_1>;
...
constructor TMyObj1711_1.Create;
begin
  inherited;
  FInt := 1711 * 3;
  FTest := 'Value: ' + Random(217112).ToString + Random(171100).ToString;
end;

procedure TForm1711.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1711;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1711_List0 := TMyObj1711_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1711_List1 := TMyObj1711_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
