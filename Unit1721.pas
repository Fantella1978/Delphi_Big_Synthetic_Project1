...
type
  ...
  TMyObj1721_List0 = TObjectList<TMyObj1721>;

  TMyObj1721_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1721_List1 = TObjectList<TMyObj1721_1>;
...
constructor TMyObj1721_1.Create;
begin
  inherited;
  FInt := 1721 * 3;
  FTest := 'Value: ' + Random(217212).ToString + Random(172100).ToString;
end;

procedure TForm1721.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1721;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1721_List0 := TMyObj1721_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1721_List1 := TMyObj1721_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
