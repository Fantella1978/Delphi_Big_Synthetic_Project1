...
type
  ...
  TMyObj735_List0 = TObjectList<TMyObj735>;

  TMyObj735_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj735_List1 = TObjectList<TMyObj735_1>;
...
constructor TMyObj735_1.Create;
begin
  inherited;
  FInt := 735 * 3;
  FTest := 'Value: ' + Random(27352).ToString + Random(73500).ToString;
end;

procedure TForm735.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum735;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj735_List0 := TMyObj735_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj735_List1 := TMyObj735_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
