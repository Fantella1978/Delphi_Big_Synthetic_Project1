...
type
  ...
  TMyObj1894_List0 = TObjectList<TMyObj1894>;

  TMyObj1894_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1894_List1 = TObjectList<TMyObj1894_1>;
...
constructor TMyObj1894_1.Create;
begin
  inherited;
  FInt := 1894 * 3;
  FTest := 'Value: ' + Random(218942).ToString + Random(189400).ToString;
end;

procedure TForm1894.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1894;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1894_List0 := TMyObj1894_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1894_List1 := TMyObj1894_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
