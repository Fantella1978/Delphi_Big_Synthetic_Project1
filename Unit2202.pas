...
type
  ...
  TMyObj2202_List0 = TObjectList<TMyObj2202>;

  TMyObj2202_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2202_List1 = TObjectList<TMyObj2202_1>;
...
constructor TMyObj2202_1.Create;
begin
  inherited;
  FInt := 2202 * 3;
  FTest := 'Value: ' + Random(222022).ToString + Random(220200).ToString;
end;

procedure TForm2202.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2202;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2202_List0 := TMyObj2202_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2202_List1 := TMyObj2202_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
