...
type
  ...
  TMyObj1244_List0 = TObjectList<TMyObj1244>;

  TMyObj1244_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1244_List1 = TObjectList<TMyObj1244_1>;
...
constructor TMyObj1244_1.Create;
begin
  inherited;
  FInt := 1244 * 3;
  FTest := 'Value: ' + Random(212442).ToString + Random(124400).ToString;
end;

procedure TForm1244.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1244;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1244_List0 := TMyObj1244_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1244_List1 := TMyObj1244_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
