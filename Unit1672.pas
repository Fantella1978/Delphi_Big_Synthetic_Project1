...
type
  ...
  TMyObj1672_List0 = TObjectList<TMyObj1672>;

  TMyObj1672_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1672_List1 = TObjectList<TMyObj1672_1>;
...
constructor TMyObj1672_1.Create;
begin
  inherited;
  FInt := 1672 * 3;
  FTest := 'Value: ' + Random(216722).ToString + Random(167200).ToString;
end;

procedure TForm1672.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1672;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1672_List0 := TMyObj1672_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1672_List1 := TMyObj1672_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
