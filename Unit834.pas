...
type
  ...
  TMyObj834_List0 = TObjectList<TMyObj834>;

  TMyObj834_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj834_List1 = TObjectList<TMyObj834_1>;
...
constructor TMyObj834_1.Create;
begin
  inherited;
  FInt := 834 * 3;
  FTest := 'Value: ' + Random(28342).ToString + Random(83400).ToString;
end;

procedure TForm834.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum834;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj834_List0 := TMyObj834_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj834_List1 := TMyObj834_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
