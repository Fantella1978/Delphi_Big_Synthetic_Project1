...
type
  ...
  TMyObj471_List0 = TObjectList<TMyObj471>;

  TMyObj471_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj471_List1 = TObjectList<TMyObj471_1>;
...
constructor TMyObj471_1.Create;
begin
  inherited;
  FInt := 471 * 3;
  FTest := 'Value: ' + Random(24712).ToString + Random(47100).ToString;
end;

procedure TForm471.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum471;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj471_List0 := TMyObj471_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj471_List1 := TMyObj471_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
