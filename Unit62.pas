...
type
  ...
  TMyObj62_List0 = TObjectList<TMyObj62>;

  TMyObj62_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj62_List1 = TObjectList<TMyObj62_1>;
...
constructor TMyObj62_1.Create;
begin
  inherited;
  FInt := 62 * 3;
  FTest := 'Value: ' + Random(2622).ToString + Random(6200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj62_List0 := TMyObj62_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj62_List1 := TMyObj62_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
