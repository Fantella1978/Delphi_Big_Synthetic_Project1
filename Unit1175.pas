...
type
  ...
  TMyObj1175_List0 = TObjectList<TMyObj1175>;

  TMyObj1175_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1175_List1 = TObjectList<TMyObj1175_1>;
...
constructor TMyObj1175_1.Create;
begin
  inherited;
  FInt := 1175 * 3;
  FTest := 'Value: ' + Random(211752).ToString + Random(117500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1175_List0 := TMyObj1175_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1175_List1 := TMyObj1175_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
