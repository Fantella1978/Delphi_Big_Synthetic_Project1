...
type
  ...
  TMyObj1383_List0 = TObjectList<TMyObj1383>;

  TMyObj1383_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1383_List1 = TObjectList<TMyObj1383_1>;
...
constructor TMyObj1383_1.Create;
begin
  inherited;
  FInt := 1383 * 3;
  FTest := 'Value: ' + Random(213832).ToString + Random(138300).ToString;
end;

procedure TForm1383.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1383;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1383_List0 := TMyObj1383_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1383_List1 := TMyObj1383_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
