...
type
  ...
  TMyObj1983_List0 = TObjectList<TMyObj1983>;

  TMyObj1983_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1983_List1 = TObjectList<TMyObj1983_1>;
...
constructor TMyObj1983_1.Create;
begin
  inherited;
  FInt := 1983 * 3;
  FTest := 'Value: ' + Random(219832).ToString + Random(198300).ToString;
end;

procedure TForm1983.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1983;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1983_List0 := TMyObj1983_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1983_List1 := TMyObj1983_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
