...
type
  ...
  TMyObj1319_List0 = TObjectList<TMyObj1319>;

  TMyObj1319_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1319_List1 = TObjectList<TMyObj1319_1>;
...
constructor TMyObj1319_1.Create;
begin
  inherited;
  FInt := 1319 * 3;
  FTest := 'Value: ' + Random(213192).ToString + Random(131900).ToString;
end;

procedure TForm1319.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1319;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1319_List0 := TMyObj1319_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1319_List1 := TMyObj1319_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
