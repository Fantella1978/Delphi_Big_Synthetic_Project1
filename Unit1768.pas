...
type
  ...
  TMyObj1768_List0 = TObjectList<TMyObj1768>;

  TMyObj1768_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1768_List1 = TObjectList<TMyObj1768_1>;
...
constructor TMyObj1768_1.Create;
begin
  inherited;
  FInt := 1768 * 3;
  FTest := 'Value: ' + Random(217682).ToString + Random(176800).ToString;
end;

procedure TForm1768.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1768;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1768_List0 := TMyObj1768_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1768_List1 := TMyObj1768_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
