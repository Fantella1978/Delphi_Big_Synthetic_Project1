...
type
  ...
  TMyObj1774_List0 = TObjectList<TMyObj1774>;

  TMyObj1774_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1774_List1 = TObjectList<TMyObj1774_1>;
...
constructor TMyObj1774_1.Create;
begin
  inherited;
  FInt := 1774 * 3;
  FTest := 'Value: ' + Random(217742).ToString + Random(177400).ToString;
end;

procedure TForm1774.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1774;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1774_List0 := TMyObj1774_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1774_List1 := TMyObj1774_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
