...
type
  ...
  TMyObj1904_List0 = TObjectList<TMyObj1904>;

  TMyObj1904_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1904_List1 = TObjectList<TMyObj1904_1>;
...
constructor TMyObj1904_1.Create;
begin
  inherited;
  FInt := 1904 * 3;
  FTest := 'Value: ' + Random(219042).ToString + Random(190400).ToString;
end;

procedure TForm1904.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1904;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1904_List0 := TMyObj1904_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1904_List1 := TMyObj1904_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
