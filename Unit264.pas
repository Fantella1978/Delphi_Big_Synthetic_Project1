...
type
  ...
  TMyObj264_List0 = TObjectList<TMyObj264>;

  TMyObj264_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj264_List1 = TObjectList<TMyObj264_1>;
...
constructor TMyObj264_1.Create;
begin
  inherited;
  FInt := 264 * 3;
  FTest := 'Value: ' + Random(22642).ToString + Random(26400).ToString;
end;

procedure TForm264.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum264;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj264_List0 := TMyObj264_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj264_List1 := TMyObj264_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
