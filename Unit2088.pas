...
type
  ...
  TMyObj2088_List0 = TObjectList<TMyObj2088>;

  TMyObj2088_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2088_List1 = TObjectList<TMyObj2088_1>;
...
constructor TMyObj2088_1.Create;
begin
  inherited;
  FInt := 2088 * 3;
  FTest := 'Value: ' + Random(220882).ToString + Random(208800).ToString;
end;

procedure TForm2088.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2088;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2088_List0 := TMyObj2088_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2088_List1 := TMyObj2088_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
