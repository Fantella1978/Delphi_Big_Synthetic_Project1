...
type
  ...
  TMyObj360_List0 = TObjectList<TMyObj360>;

  TMyObj360_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj360_List1 = TObjectList<TMyObj360_1>;
...
constructor TMyObj360_1.Create;
begin
  inherited;
  FInt := 360 * 3;
  FTest := 'Value: ' + Random(23602).ToString + Random(36000).ToString;
end;

procedure TForm360.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum360;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj360_List0 := TMyObj360_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj360_List1 := TMyObj360_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
