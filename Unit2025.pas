...
type
  ...
  TMyObj2025_List0 = TObjectList<TMyObj2025>;

  TMyObj2025_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2025_List1 = TObjectList<TMyObj2025_1>;
...
constructor TMyObj2025_1.Create;
begin
  inherited;
  FInt := 2025 * 3;
  FTest := 'Value: ' + Random(220252).ToString + Random(202500).ToString;
end;

procedure TForm2025.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2025;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2025_List0 := TMyObj2025_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2025_List1 := TMyObj2025_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
