...
type
  ...
  TMyObj1258_List0 = TObjectList<TMyObj1258>;

  TMyObj1258_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1258_List1 = TObjectList<TMyObj1258_1>;
...
constructor TMyObj1258_1.Create;
begin
  inherited;
  FInt := 1258 * 3;
  FTest := 'Value: ' + Random(212582).ToString + Random(125800).ToString;
end;

procedure TForm1258.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1258;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1258_List0 := TMyObj1258_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1258_List1 := TMyObj1258_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
