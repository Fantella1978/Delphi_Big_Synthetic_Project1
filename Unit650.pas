...
type
  ...
  TMyObj650_List0 = TObjectList<TMyObj650>;

  TMyObj650_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj650_List1 = TObjectList<TMyObj650_1>;
...
constructor TMyObj650_1.Create;
begin
  inherited;
  FInt := 650 * 3;
  FTest := 'Value: ' + Random(26502).ToString + Random(65000).ToString;
end;

procedure TForm650.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum650;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj650_List0 := TMyObj650_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj650_List1 := TMyObj650_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
