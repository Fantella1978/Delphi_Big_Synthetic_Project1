...
type
  ...
  TMyObj1911_List0 = TObjectList<TMyObj1911>;

  TMyObj1911_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1911_List1 = TObjectList<TMyObj1911_1>;
...
constructor TMyObj1911_1.Create;
begin
  inherited;
  FInt := 1911 * 3;
  FTest := 'Value: ' + Random(219112).ToString + Random(191100).ToString;
end;

procedure TForm1911.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1911;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1911_List0 := TMyObj1911_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1911_List1 := TMyObj1911_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
