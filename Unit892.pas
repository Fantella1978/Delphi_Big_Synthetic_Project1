...
type
  ...
  TMyObj892_List0 = TObjectList<TMyObj892>;

  TMyObj892_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj892_List1 = TObjectList<TMyObj892_1>;
...
constructor TMyObj892_1.Create;
begin
  inherited;
  FInt := 892 * 3;
  FTest := 'Value: ' + Random(28922).ToString + Random(89200).ToString;
end;

procedure TForm892.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum892;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj892_List0 := TMyObj892_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj892_List1 := TMyObj892_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
