...
type
  ...
  TMyObj176_List0 = TObjectList<TMyObj176>;

  TMyObj176_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj176_List1 = TObjectList<TMyObj176_1>;
...
constructor TMyObj176_1.Create;
begin
  inherited;
  FInt := 176 * 3;
  FTest := 'Value: ' + Random(21762).ToString + Random(17600).ToString;
end;

procedure TForm176.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum176;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj176_List0 := TMyObj176_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj176_List1 := TMyObj176_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
