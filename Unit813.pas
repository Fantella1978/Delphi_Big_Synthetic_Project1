...
type
  ...
  TMyObj813_List0 = TObjectList<TMyObj813>;

  TMyObj813_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj813_List1 = TObjectList<TMyObj813_1>;
...
constructor TMyObj813_1.Create;
begin
  inherited;
  FInt := 813 * 3;
  FTest := 'Value: ' + Random(28132).ToString + Random(81300).ToString;
end;

procedure TForm813.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum813;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj813_List0 := TMyObj813_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj813_List1 := TMyObj813_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
