...
type
  ...
  TMyObj2423_List0 = TObjectList<TMyObj2423>;

  TMyObj2423_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2423_List1 = TObjectList<TMyObj2423_1>;
...
constructor TMyObj2423_1.Create;
begin
  inherited;
  FInt := 2423 * 3;
  FTest := 'Value: ' + Random(224232).ToString + Random(242300).ToString;
end;

procedure TForm2423.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2423;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2423_List0 := TMyObj2423_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2423_List1 := TMyObj2423_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
