...
type
  ...
  TMyObj663_List0 = TObjectList<TMyObj663>;

  TMyObj663_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj663_List1 = TObjectList<TMyObj663_1>;
...
constructor TMyObj663_1.Create;
begin
  inherited;
  FInt := 663 * 3;
  FTest := 'Value: ' + Random(26632).ToString + Random(66300).ToString;
end;

procedure TForm663.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum663;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj663_List0 := TMyObj663_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj663_List1 := TMyObj663_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
