...
type
  ...
  TMyObj2177_List0 = TObjectList<TMyObj2177>;

  TMyObj2177_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2177_List1 = TObjectList<TMyObj2177_1>;
...
constructor TMyObj2177_1.Create;
begin
  inherited;
  FInt := 2177 * 3;
  FTest := 'Value: ' + Random(221772).ToString + Random(217700).ToString;
end;

procedure TForm2177.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2177;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2177_List0 := TMyObj2177_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2177_List1 := TMyObj2177_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
