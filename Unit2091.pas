...
type
  ...
  TMyObj2091_List0 = TObjectList<TMyObj2091>;

  TMyObj2091_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2091_List1 = TObjectList<TMyObj2091_1>;
...
constructor TMyObj2091_1.Create;
begin
  inherited;
  FInt := 2091 * 3;
  FTest := 'Value: ' + Random(220912).ToString + Random(209100).ToString;
end;

procedure TForm2091.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2091;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2091_List0 := TMyObj2091_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2091_List1 := TMyObj2091_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
