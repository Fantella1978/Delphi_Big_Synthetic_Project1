...
type
  ...
  TMyObj2326_List0 = TObjectList<TMyObj2326>;

  TMyObj2326_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2326_List1 = TObjectList<TMyObj2326_1>;
...
constructor TMyObj2326_1.Create;
begin
  inherited;
  FInt := 2326 * 3;
  FTest := 'Value: ' + Random(223262).ToString + Random(232600).ToString;
end;

procedure TForm2326.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2326;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2326_List0 := TMyObj2326_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2326_List1 := TMyObj2326_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
