...
type
  ...
  TMyObj595_List0 = TObjectList<TMyObj595>;

  TMyObj595_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj595_List1 = TObjectList<TMyObj595_1>;
...
constructor TMyObj595_1.Create;
begin
  inherited;
  FInt := 595 * 3;
  FTest := 'Value: ' + Random(25952).ToString + Random(59500).ToString;
end;

procedure TForm595.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum595;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj595_List0 := TMyObj595_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj595_List1 := TMyObj595_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
