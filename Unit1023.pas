...
type
  ...
  TMyObj1023_List0 = TObjectList<TMyObj1023>;

  TMyObj1023_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1023_List1 = TObjectList<TMyObj1023_1>;
...
constructor TMyObj1023_1.Create;
begin
  inherited;
  FInt := 1023 * 3;
  FTest := 'Value: ' + Random(210232).ToString + Random(102300).ToString;
end;

procedure TForm1023.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1023;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1023_List0 := TMyObj1023_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1023_List1 := TMyObj1023_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
