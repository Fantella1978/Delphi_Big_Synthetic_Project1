...
type
  ...
  TMyObj857_List0 = TObjectList<TMyObj857>;

  TMyObj857_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj857_List1 = TObjectList<TMyObj857_1>;
...
constructor TMyObj857_1.Create;
begin
  inherited;
  FInt := 857 * 3;
  FTest := 'Value: ' + Random(28572).ToString + Random(85700).ToString;
end;

procedure TForm857.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum857;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj857_List0 := TMyObj857_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj857_List1 := TMyObj857_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
