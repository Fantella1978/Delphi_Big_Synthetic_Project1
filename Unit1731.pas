...
type
  ...
  TMyObj1731_List0 = TObjectList<TMyObj1731>;

  TMyObj1731_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1731_List1 = TObjectList<TMyObj1731_1>;
...
constructor TMyObj1731_1.Create;
begin
  inherited;
  FInt := 1731 * 3;
  FTest := 'Value: ' + Random(217312).ToString + Random(173100).ToString;
end;

procedure TForm1731.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1731;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1731_List0 := TMyObj1731_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1731_List1 := TMyObj1731_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
