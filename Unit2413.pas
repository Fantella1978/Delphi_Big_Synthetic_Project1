...
type
  ...
  TMyObj2413_List0 = TObjectList<TMyObj2413>;

  TMyObj2413_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2413_List1 = TObjectList<TMyObj2413_1>;
...
constructor TMyObj2413_1.Create;
begin
  inherited;
  FInt := 2413 * 3;
  FTest := 'Value: ' + Random(224132).ToString + Random(241300).ToString;
end;

procedure TForm2413.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2413;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2413_List0 := TMyObj2413_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2413_List1 := TMyObj2413_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
