...
type
  ...
  TMyObj439_List0 = TObjectList<TMyObj439>;

  TMyObj439_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj439_List1 = TObjectList<TMyObj439_1>;
...
constructor TMyObj439_1.Create;
begin
  inherited;
  FInt := 439 * 3;
  FTest := 'Value: ' + Random(24392).ToString + Random(43900).ToString;
end;

procedure TForm439.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum439;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj439_List0 := TMyObj439_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj439_List1 := TMyObj439_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
