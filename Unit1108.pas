...
type
  ...
  TMyObj1108_List0 = TObjectList<TMyObj1108>;

  TMyObj1108_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1108_List1 = TObjectList<TMyObj1108_1>;
...
constructor TMyObj1108_1.Create;
begin
  inherited;
  FInt := 1108 * 3;
  FTest := 'Value: ' + Random(211082).ToString + Random(110800).ToString;
end;

procedure TForm1108.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1108;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1108_List0 := TMyObj1108_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1108_List1 := TMyObj1108_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
