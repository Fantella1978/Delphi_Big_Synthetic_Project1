...
type
  ...
  TMyObj2300_List0 = TObjectList<TMyObj2300>;

  TMyObj2300_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2300_List1 = TObjectList<TMyObj2300_1>;
...
constructor TMyObj2300_1.Create;
begin
  inherited;
  FInt := 2300 * 3;
  FTest := 'Value: ' + Random(223002).ToString + Random(230000).ToString;
end;

procedure TForm2300.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2300;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2300_List0 := TMyObj2300_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2300_List1 := TMyObj2300_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
