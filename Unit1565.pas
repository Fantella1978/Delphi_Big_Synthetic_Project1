...
type
  ...
  TMyObj1565_List0 = TObjectList<TMyObj1565>;

  TMyObj1565_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1565_List1 = TObjectList<TMyObj1565_1>;
...
constructor TMyObj1565_1.Create;
begin
  inherited;
  FInt := 1565 * 3;
  FTest := 'Value: ' + Random(215652).ToString + Random(156500).ToString;
end;

procedure TForm1565.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1565;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1565_List0 := TMyObj1565_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1565_List1 := TMyObj1565_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
