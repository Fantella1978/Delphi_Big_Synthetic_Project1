...
type
  ...
  TMyObj1359_List0 = TObjectList<TMyObj1359>;

  TMyObj1359_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1359_List1 = TObjectList<TMyObj1359_1>;
...
constructor TMyObj1359_1.Create;
begin
  inherited;
  FInt := 1359 * 3;
  FTest := 'Value: ' + Random(213592).ToString + Random(135900).ToString;
end;

procedure TForm1359.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1359;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1359_List0 := TMyObj1359_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1359_List1 := TMyObj1359_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
