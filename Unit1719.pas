...
type
  ...
  TMyObj1719_List0 = TObjectList<TMyObj1719>;

  TMyObj1719_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1719_List1 = TObjectList<TMyObj1719_1>;
...
constructor TMyObj1719_1.Create;
begin
  inherited;
  FInt := 1719 * 3;
  FTest := 'Value: ' + Random(217192).ToString + Random(171900).ToString;
end;

procedure TForm1719.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1719;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1719_List0 := TMyObj1719_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1719_List1 := TMyObj1719_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
