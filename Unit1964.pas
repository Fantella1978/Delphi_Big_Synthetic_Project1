...
type
  ...
  TMyObj1964_List0 = TObjectList<TMyObj1964>;

  TMyObj1964_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1964_List1 = TObjectList<TMyObj1964_1>;
...
constructor TMyObj1964_1.Create;
begin
  inherited;
  FInt := 1964 * 3;
  FTest := 'Value: ' + Random(219642).ToString + Random(196400).ToString;
end;

procedure TForm1964.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1964;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1964_List0 := TMyObj1964_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1964_List1 := TMyObj1964_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
