...
type
  ...
  TMyObj2229_List0 = TObjectList<TMyObj2229>;

  TMyObj2229_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2229_List1 = TObjectList<TMyObj2229_1>;
...
constructor TMyObj2229_1.Create;
begin
  inherited;
  FInt := 2229 * 3;
  FTest := 'Value: ' + Random(222292).ToString + Random(222900).ToString;
end;

procedure TForm2229.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2229;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2229_List0 := TMyObj2229_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2229_List1 := TMyObj2229_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
