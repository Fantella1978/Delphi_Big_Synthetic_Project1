...
type
  ...
  TMyObj944_List0 = TObjectList<TMyObj944>;

  TMyObj944_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj944_List1 = TObjectList<TMyObj944_1>;
...
constructor TMyObj944_1.Create;
begin
  inherited;
  FInt := 944 * 3;
  FTest := 'Value: ' + Random(29442).ToString + Random(94400).ToString;
end;

procedure TForm944.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum944;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj944_List0 := TMyObj944_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj944_List1 := TMyObj944_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
