...
type
  ...
  TMyObj1474_List0 = TObjectList<TMyObj1474>;

  TMyObj1474_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1474_List1 = TObjectList<TMyObj1474_1>;
...
constructor TMyObj1474_1.Create;
begin
  inherited;
  FInt := 1474 * 3;
  FTest := 'Value: ' + Random(214742).ToString + Random(147400).ToString;
end;

procedure TForm1474.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1474;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1474_List0 := TMyObj1474_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1474_List1 := TMyObj1474_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
