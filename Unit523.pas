...
type
  ...
  TMyObj523_List0 = TObjectList<TMyObj523>;

  TMyObj523_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj523_List1 = TObjectList<TMyObj523_1>;
...
constructor TMyObj523_1.Create;
begin
  inherited;
  FInt := 523 * 3;
  FTest := 'Value: ' + Random(25232).ToString + Random(52300).ToString;
end;

procedure TForm523.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum523;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj523_List0 := TMyObj523_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj523_List1 := TMyObj523_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
