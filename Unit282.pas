...
type
  ...
  TMyObj282_List0 = TObjectList<TMyObj282>;

  TMyObj282_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj282_List1 = TObjectList<TMyObj282_1>;
...
constructor TMyObj282_1.Create;
begin
  inherited;
  FInt := 282 * 3;
  FTest := 'Value: ' + Random(22822).ToString + Random(28200).ToString;
end;

procedure TForm282.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum282;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj282_List0 := TMyObj282_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj282_List1 := TMyObj282_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
