...
type
  ...
  TMyObj410_List0 = TObjectList<TMyObj410>;

  TMyObj410_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj410_List1 = TObjectList<TMyObj410_1>;
...
constructor TMyObj410_1.Create;
begin
  inherited;
  FInt := 410 * 3;
  FTest := 'Value: ' + Random(24102).ToString + Random(41000).ToString;
end;

procedure TForm410.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum410;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj410_List0 := TMyObj410_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj410_List1 := TMyObj410_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
