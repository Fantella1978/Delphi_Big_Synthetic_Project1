...
type
  ...
  TMyObj1670_List0 = TObjectList<TMyObj1670>;

  TMyObj1670_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1670_List1 = TObjectList<TMyObj1670_1>;
...
constructor TMyObj1670_1.Create;
begin
  inherited;
  FInt := 1670 * 3;
  FTest := 'Value: ' + Random(216702).ToString + Random(167000).ToString;
end;

procedure TForm1670.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1670;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1670_List0 := TMyObj1670_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1670_List1 := TMyObj1670_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
