...
type
  ...
  TMyObj514_List0 = TObjectList<TMyObj514>;

  TMyObj514_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj514_List1 = TObjectList<TMyObj514_1>;
...
constructor TMyObj514_1.Create;
begin
  inherited;
  FInt := 514 * 3;
  FTest := 'Value: ' + Random(25142).ToString + Random(51400).ToString;
end;

procedure TForm514.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum514;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj514_List0 := TMyObj514_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj514_List1 := TMyObj514_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
