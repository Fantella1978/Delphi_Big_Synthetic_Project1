...
type
  ...
  TMyObj2303_List0 = TObjectList<TMyObj2303>;

  TMyObj2303_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2303_List1 = TObjectList<TMyObj2303_1>;
...
constructor TMyObj2303_1.Create;
begin
  inherited;
  FInt := 2303 * 3;
  FTest := 'Value: ' + Random(223032).ToString + Random(230300).ToString;
end;

procedure TForm2303.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2303;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2303_List0 := TMyObj2303_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2303_List1 := TMyObj2303_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
