...
type
  ...
  TMyObj224_List0 = TObjectList<TMyObj224>;

  TMyObj224_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj224_List1 = TObjectList<TMyObj224_1>;
...
constructor TMyObj224_1.Create;
begin
  inherited;
  FInt := 224 * 3;
  FTest := 'Value: ' + Random(22242).ToString + Random(22400).ToString;
end;

procedure TForm224.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum224;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj224_List0 := TMyObj224_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj224_List1 := TMyObj224_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
