...
type
  ...
  TMyObj830_List0 = TObjectList<TMyObj830>;

  TMyObj830_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj830_List1 = TObjectList<TMyObj830_1>;
...
constructor TMyObj830_1.Create;
begin
  inherited;
  FInt := 830 * 3;
  FTest := 'Value: ' + Random(28302).ToString + Random(83000).ToString;
end;

procedure TForm830.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum830;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj830_List0 := TMyObj830_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj830_List1 := TMyObj830_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
