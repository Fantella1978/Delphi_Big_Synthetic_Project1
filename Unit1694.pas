...
type
  ...
  TMyObj1694_List0 = TObjectList<TMyObj1694>;

  TMyObj1694_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1694_List1 = TObjectList<TMyObj1694_1>;
...
constructor TMyObj1694_1.Create;
begin
  inherited;
  FInt := 1694 * 3;
  FTest := 'Value: ' + Random(216942).ToString + Random(169400).ToString;
end;

procedure TForm1694.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1694;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1694_List0 := TMyObj1694_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1694_List1 := TMyObj1694_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
