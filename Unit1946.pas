...
type
  ...
  TMyObj1946_List0 = TObjectList<TMyObj1946>;

  TMyObj1946_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1946_List1 = TObjectList<TMyObj1946_1>;
...
constructor TMyObj1946_1.Create;
begin
  inherited;
  FInt := 1946 * 3;
  FTest := 'Value: ' + Random(219462).ToString + Random(194600).ToString;
end;

procedure TForm1946.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1946;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1946_List0 := TMyObj1946_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1946_List1 := TMyObj1946_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
