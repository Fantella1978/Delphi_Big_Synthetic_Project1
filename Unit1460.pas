...
type
  ...
  TMyObj1460_List0 = TObjectList<TMyObj1460>;

  TMyObj1460_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1460_List1 = TObjectList<TMyObj1460_1>;
...
constructor TMyObj1460_1.Create;
begin
  inherited;
  FInt := 1460 * 3;
  FTest := 'Value: ' + Random(214602).ToString + Random(146000).ToString;
end;

procedure TForm1460.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1460;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1460_List0 := TMyObj1460_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1460_List1 := TMyObj1460_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
