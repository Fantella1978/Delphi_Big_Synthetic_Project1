...
type
  ...
  TMyObj289_List0 = TObjectList<TMyObj289>;

  TMyObj289_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj289_List1 = TObjectList<TMyObj289_1>;
...
constructor TMyObj289_1.Create;
begin
  inherited;
  FInt := 289 * 3;
  FTest := 'Value: ' + Random(22892).ToString + Random(28900).ToString;
end;

procedure TForm289.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum289;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj289_List0 := TMyObj289_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj289_List1 := TMyObj289_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
