...
type
  ...
  TMyObj2241_List0 = TObjectList<TMyObj2241>;

  TMyObj2241_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2241_List1 = TObjectList<TMyObj2241_1>;
...
constructor TMyObj2241_1.Create;
begin
  inherited;
  FInt := 2241 * 3;
  FTest := 'Value: ' + Random(222412).ToString + Random(224100).ToString;
end;

procedure TForm2241.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2241;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2241_List0 := TMyObj2241_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2241_List1 := TMyObj2241_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
