...
type
  ...
  TMyObj2055_List0 = TObjectList<TMyObj2055>;

  TMyObj2055_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2055_List1 = TObjectList<TMyObj2055_1>;
...
constructor TMyObj2055_1.Create;
begin
  inherited;
  FInt := 2055 * 3;
  FTest := 'Value: ' + Random(220552).ToString + Random(205500).ToString;
end;

procedure TForm2055.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2055;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2055_List0 := TMyObj2055_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2055_List1 := TMyObj2055_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
