...
type
  ...
  TMyObj1019_List0 = TObjectList<TMyObj1019>;

  TMyObj1019_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1019_List1 = TObjectList<TMyObj1019_1>;
...
constructor TMyObj1019_1.Create;
begin
  inherited;
  FInt := 1019 * 3;
  FTest := 'Value: ' + Random(210192).ToString + Random(101900).ToString;
end;

procedure TForm1019.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1019;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1019_List0 := TMyObj1019_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1019_List1 := TMyObj1019_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
