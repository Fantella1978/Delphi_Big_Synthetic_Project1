...
type
  ...
  TMyObj2063_List0 = TObjectList<TMyObj2063>;

  TMyObj2063_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2063_List1 = TObjectList<TMyObj2063_1>;
...
constructor TMyObj2063_1.Create;
begin
  inherited;
  FInt := 2063 * 3;
  FTest := 'Value: ' + Random(220632).ToString + Random(206300).ToString;
end;

procedure TForm2063.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2063;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2063_List0 := TMyObj2063_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2063_List1 := TMyObj2063_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
