...
type
  ...
  TMyObj166_List0 = TObjectList<TMyObj166>;

  TMyObj166_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj166_List1 = TObjectList<TMyObj166_1>;
...
constructor TMyObj166_1.Create;
begin
  inherited;
  FInt := 166 * 3;
  FTest := 'Value: ' + Random(21662).ToString + Random(16600).ToString;
end;

procedure TForm166.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum166;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj166_List0 := TMyObj166_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj166_List1 := TMyObj166_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
