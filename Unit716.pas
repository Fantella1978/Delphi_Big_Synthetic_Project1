...
type
  ...
  TMyObj716_List0 = TObjectList<TMyObj716>;

  TMyObj716_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj716_List1 = TObjectList<TMyObj716_1>;
...
constructor TMyObj716_1.Create;
begin
  inherited;
  FInt := 716 * 3;
  FTest := 'Value: ' + Random(27162).ToString + Random(71600).ToString;
end;

procedure TForm716.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum716;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj716_List0 := TMyObj716_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj716_List1 := TMyObj716_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
