...
type
  ...
  TMyObj2123_List0 = TObjectList<TMyObj2123>;

  TMyObj2123_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2123_List1 = TObjectList<TMyObj2123_1>;
...
constructor TMyObj2123_1.Create;
begin
  inherited;
  FInt := 2123 * 3;
  FTest := 'Value: ' + Random(221232).ToString + Random(212300).ToString;
end;

procedure TForm2123.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2123;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2123_List0 := TMyObj2123_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2123_List1 := TMyObj2123_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
