...
type
  ...
  TMyObj1889_List0 = TObjectList<TMyObj1889>;

  TMyObj1889_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1889_List1 = TObjectList<TMyObj1889_1>;
...
constructor TMyObj1889_1.Create;
begin
  inherited;
  FInt := 1889 * 3;
  FTest := 'Value: ' + Random(218892).ToString + Random(188900).ToString;
end;

procedure TForm1889.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1889;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1889_List0 := TMyObj1889_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1889_List1 := TMyObj1889_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
