...
type
  ...
  TMyObj1426_List0 = TObjectList<TMyObj1426>;

  TMyObj1426_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1426_List1 = TObjectList<TMyObj1426_1>;
...
constructor TMyObj1426_1.Create;
begin
  inherited;
  FInt := 1426 * 3;
  FTest := 'Value: ' + Random(214262).ToString + Random(142600).ToString;
end;

procedure TForm1426.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1426;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1426_List0 := TMyObj1426_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1426_List1 := TMyObj1426_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
