...
type
  ...
  TMyObj232_List0 = TObjectList<TMyObj232>;

  TMyObj232_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj232_List1 = TObjectList<TMyObj232_1>;
...
constructor TMyObj232_1.Create;
begin
  inherited;
  FInt := 232 * 3;
  FTest := 'Value: ' + Random(22322).ToString + Random(23200).ToString;
end;

procedure TForm232.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum232;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj232_List0 := TMyObj232_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj232_List1 := TMyObj232_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
