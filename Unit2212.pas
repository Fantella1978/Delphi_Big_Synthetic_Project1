...
type
  ...
  TMyObj2212_List0 = TObjectList<TMyObj2212>;

  TMyObj2212_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2212_List1 = TObjectList<TMyObj2212_1>;
...
constructor TMyObj2212_1.Create;
begin
  inherited;
  FInt := 2212 * 3;
  FTest := 'Value: ' + Random(222122).ToString + Random(221200).ToString;
end;

procedure TForm2212.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2212;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2212_List0 := TMyObj2212_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2212_List1 := TMyObj2212_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
