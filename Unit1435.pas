...
type
  ...
  TMyObj1435_List0 = TObjectList<TMyObj1435>;

  TMyObj1435_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1435_List1 = TObjectList<TMyObj1435_1>;
...
constructor TMyObj1435_1.Create;
begin
  inherited;
  FInt := 1435 * 3;
  FTest := 'Value: ' + Random(214352).ToString + Random(143500).ToString;
end;

procedure TForm1435.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1435;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1435_List0 := TMyObj1435_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1435_List1 := TMyObj1435_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
