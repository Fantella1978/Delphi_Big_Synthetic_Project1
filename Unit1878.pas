...
type
  ...
  TMyObj1878_List0 = TObjectList<TMyObj1878>;

  TMyObj1878_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1878_List1 = TObjectList<TMyObj1878_1>;
...
constructor TMyObj1878_1.Create;
begin
  inherited;
  FInt := 1878 * 3;
  FTest := 'Value: ' + Random(218782).ToString + Random(187800).ToString;
end;

procedure TForm1878.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1878;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1878_List0 := TMyObj1878_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1878_List1 := TMyObj1878_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
