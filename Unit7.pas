...
type
  ...
  TMyObj7_List0 = TObjectList<TMyObj7>;

  TMyObj7_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj7_List1 = TObjectList<TMyObj7_1>;
...
constructor TMyObj7_1.Create;
begin
  inherited;
  FInt := 7 * 3;
  FTest := 'Value: ' + Random(272).ToString + Random(700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(70).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(75).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(77).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj7_List0 := TMyObj7_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj7_List1 := TMyObj7_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
