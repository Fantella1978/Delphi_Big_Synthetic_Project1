...
type
  ...
  TMyObj1609_List0 = TObjectList<TMyObj1609>;

  TMyObj1609_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1609_List1 = TObjectList<TMyObj1609_1>;
...
constructor TMyObj1609_1.Create;
begin
  inherited;
  FInt := 1609 * 3;
  FTest := 'Value: ' + Random(216092).ToString + Random(160900).ToString;
end;

procedure TForm1609.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1609;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1609_List0 := TMyObj1609_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1609_List1 := TMyObj1609_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
