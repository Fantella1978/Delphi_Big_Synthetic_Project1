...
type
  ...
  TMyObj1086_List0 = TObjectList<TMyObj1086>;

  TMyObj1086_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1086_List1 = TObjectList<TMyObj1086_1>;
...
constructor TMyObj1086_1.Create;
begin
  inherited;
  FInt := 1086 * 3;
  FTest := 'Value: ' + Random(210862).ToString + Random(108600).ToString;
end;

procedure TForm1086.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1086;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1086_List0 := TMyObj1086_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1086_List1 := TMyObj1086_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
