...
type
  ...
  TMyObj1164_List0 = TObjectList<TMyObj1164>;

  TMyObj1164_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1164_List1 = TObjectList<TMyObj1164_1>;
...
constructor TMyObj1164_1.Create;
begin
  inherited;
  FInt := 1164 * 3;
  FTest := 'Value: ' + Random(211642).ToString + Random(116400).ToString;
end;

procedure TForm1164.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1164;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1164_List0 := TMyObj1164_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1164_List1 := TMyObj1164_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
