...
type
  ...
  TMyObj1314_List0 = TObjectList<TMyObj1314>;

  TMyObj1314_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1314_List1 = TObjectList<TMyObj1314_1>;
...
constructor TMyObj1314_1.Create;
begin
  inherited;
  FInt := 1314 * 3;
  FTest := 'Value: ' + Random(213142).ToString + Random(131400).ToString;
end;

procedure TForm1314.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1314;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1314_List0 := TMyObj1314_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1314_List1 := TMyObj1314_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
