...
type
  ...
  TMyObj1457_List0 = TObjectList<TMyObj1457>;

  TMyObj1457_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1457_List1 = TObjectList<TMyObj1457_1>;
...
constructor TMyObj1457_1.Create;
begin
  inherited;
  FInt := 1457 * 3;
  FTest := 'Value: ' + Random(214572).ToString + Random(145700).ToString;
end;

procedure TForm1457.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1457;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1457_List0 := TMyObj1457_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1457_List1 := TMyObj1457_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
