...
type
  ...
  TMyObj631_List0 = TObjectList<TMyObj631>;

  TMyObj631_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj631_List1 = TObjectList<TMyObj631_1>;
...
constructor TMyObj631_1.Create;
begin
  inherited;
  FInt := 631 * 3;
  FTest := 'Value: ' + Random(26312).ToString + Random(63100).ToString;
end;

procedure TForm631.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum631;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj631_List0 := TMyObj631_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj631_List1 := TMyObj631_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
