...
type
  ...
  TMyObj162_List0 = TObjectList<TMyObj162>;

  TMyObj162_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj162_List1 = TObjectList<TMyObj162_1>;
...
constructor TMyObj162_1.Create;
begin
  inherited;
  FInt := 162 * 3;
  FTest := 'Value: ' + Random(21622).ToString + Random(16200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj162_List0 := TMyObj162_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj162_List1 := TMyObj162_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
