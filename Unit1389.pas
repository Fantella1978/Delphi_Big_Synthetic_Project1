...
type
  ...
  TMyObj1389_List0 = TObjectList<TMyObj1389>;

  TMyObj1389_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1389_List1 = TObjectList<TMyObj1389_1>;
...
constructor TMyObj1389_1.Create;
begin
  inherited;
  FInt := 1389 * 3;
  FTest := 'Value: ' + Random(213892).ToString + Random(138900).ToString;
end;

procedure TForm1389.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1389;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1389_List0 := TMyObj1389_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1389_List1 := TMyObj1389_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
