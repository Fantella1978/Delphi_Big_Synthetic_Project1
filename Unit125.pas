...
type
  ...
  TMyObj125_List0 = TObjectList<TMyObj125>;

  TMyObj125_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj125_List1 = TObjectList<TMyObj125_1>;
...
constructor TMyObj125_1.Create;
begin
  inherited;
  FInt := 125 * 3;
  FTest := 'Value: ' + Random(21252).ToString + Random(12500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj125_List0 := TMyObj125_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj125_List1 := TMyObj125_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
