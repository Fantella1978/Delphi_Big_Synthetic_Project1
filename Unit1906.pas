...
type
  ...
  TMyObj1906_List0 = TObjectList<TMyObj1906>;

  TMyObj1906_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1906_List1 = TObjectList<TMyObj1906_1>;
...
constructor TMyObj1906_1.Create;
begin
  inherited;
  FInt := 1906 * 3;
  FTest := 'Value: ' + Random(219062).ToString + Random(190600).ToString;
end;

procedure TForm1906.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1906;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1906_List0 := TMyObj1906_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1906_List1 := TMyObj1906_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
