...
type
  ...
  TMyObj2470_List0 = TObjectList<TMyObj2470>;

  TMyObj2470_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2470_List1 = TObjectList<TMyObj2470_1>;
...
constructor TMyObj2470_1.Create;
begin
  inherited;
  FInt := 2470 * 3;
  FTest := 'Value: ' + Random(224702).ToString + Random(247000).ToString;
end;

procedure TForm2470.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2470;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2470_List0 := TMyObj2470_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2470_List1 := TMyObj2470_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
