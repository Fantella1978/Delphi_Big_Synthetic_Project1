...
type
  ...
  TMyObj1930_List0 = TObjectList<TMyObj1930>;

  TMyObj1930_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1930_List1 = TObjectList<TMyObj1930_1>;
...
constructor TMyObj1930_1.Create;
begin
  inherited;
  FInt := 1930 * 3;
  FTest := 'Value: ' + Random(219302).ToString + Random(193000).ToString;
end;

procedure TForm1930.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1930;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1930_List0 := TMyObj1930_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1930_List1 := TMyObj1930_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
