...
type
  ...
  TMyObj26_List0 = TObjectList<TMyObj26>;

  TMyObj26_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj26_List1 = TObjectList<TMyObj26_1>;
...
constructor TMyObj26_1.Create;
begin
  inherited;
  FInt := 26 * 3;
  FTest := 'Value: ' + Random(2262).ToString + Random(2600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj26_List0 := TMyObj26_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj26_List1 := TMyObj26_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
