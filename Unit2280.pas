...
type
  ...
  TMyObj2280_List0 = TObjectList<TMyObj2280>;

  TMyObj2280_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2280_List1 = TObjectList<TMyObj2280_1>;
...
constructor TMyObj2280_1.Create;
begin
  inherited;
  FInt := 2280 * 3;
  FTest := 'Value: ' + Random(222802).ToString + Random(228000).ToString;
end;

procedure TForm2280.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2280;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2280_List0 := TMyObj2280_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2280_List1 := TMyObj2280_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
