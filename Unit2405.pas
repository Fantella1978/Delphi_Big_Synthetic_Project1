...
type
  ...
  TMyObj2405_List0 = TObjectList<TMyObj2405>;

  TMyObj2405_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2405_List1 = TObjectList<TMyObj2405_1>;
...
constructor TMyObj2405_1.Create;
begin
  inherited;
  FInt := 2405 * 3;
  FTest := 'Value: ' + Random(224052).ToString + Random(240500).ToString;
end;

procedure TForm2405.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2405;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2405_List0 := TMyObj2405_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2405_List1 := TMyObj2405_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
