...
type
  ...
  TMyObj53_List0 = TObjectList<TMyObj53>;

  TMyObj53_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj53_List1 = TObjectList<TMyObj53_1>;
...
constructor TMyObj53_1.Create;
begin
  inherited;
  FInt := 53 * 3;
  FTest := 'Value: ' + Random(2532).ToString + Random(5300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj53_List0 := TMyObj53_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj53_List1 := TMyObj53_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
