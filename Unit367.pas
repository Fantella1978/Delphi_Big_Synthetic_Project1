...
type
  ...
  TMyObj367_List0 = TObjectList<TMyObj367>;

  TMyObj367_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj367_List1 = TObjectList<TMyObj367_1>;
...
constructor TMyObj367_1.Create;
begin
  inherited;
  FInt := 367 * 3;
  FTest := 'Value: ' + Random(23672).ToString + Random(36700).ToString;
end;

procedure TForm367.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum367;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj367_List0 := TMyObj367_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj367_List1 := TMyObj367_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
