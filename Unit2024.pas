...
type
  ...
  TMyObj2024_List0 = TObjectList<TMyObj2024>;

  TMyObj2024_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2024_List1 = TObjectList<TMyObj2024_1>;
...
constructor TMyObj2024_1.Create;
begin
  inherited;
  FInt := 2024 * 3;
  FTest := 'Value: ' + Random(220242).ToString + Random(202400).ToString;
end;

procedure TForm2024.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2024;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2024_List0 := TMyObj2024_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2024_List1 := TMyObj2024_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
