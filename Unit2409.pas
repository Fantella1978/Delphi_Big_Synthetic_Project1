...
type
  ...
  TMyObj2409_List0 = TObjectList<TMyObj2409>;

  TMyObj2409_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2409_List1 = TObjectList<TMyObj2409_1>;
...
constructor TMyObj2409_1.Create;
begin
  inherited;
  FInt := 2409 * 3;
  FTest := 'Value: ' + Random(224092).ToString + Random(240900).ToString;
end;

procedure TForm2409.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2409;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2409_List0 := TMyObj2409_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2409_List1 := TMyObj2409_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
