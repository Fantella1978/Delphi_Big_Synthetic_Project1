...
type
  ...
  TMyObj263_List0 = TObjectList<TMyObj263>;

  TMyObj263_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj263_List1 = TObjectList<TMyObj263_1>;
...
constructor TMyObj263_1.Create;
begin
  inherited;
  FInt := 263 * 3;
  FTest := 'Value: ' + Random(22632).ToString + Random(26300).ToString;
end;

procedure TForm263.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum263;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj263_List0 := TMyObj263_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj263_List1 := TMyObj263_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
