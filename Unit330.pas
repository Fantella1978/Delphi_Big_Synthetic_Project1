...
type
  ...
  TMyObj330_List0 = TObjectList<TMyObj330>;

  TMyObj330_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj330_List1 = TObjectList<TMyObj330_1>;
...
constructor TMyObj330_1.Create;
begin
  inherited;
  FInt := 330 * 3;
  FTest := 'Value: ' + Random(23302).ToString + Random(33000).ToString;
end;

procedure TForm330.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum330;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj330_List0 := TMyObj330_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj330_List1 := TMyObj330_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
