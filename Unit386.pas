...
type
  ...
  TMyObj386_List0 = TObjectList<TMyObj386>;

  TMyObj386_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj386_List1 = TObjectList<TMyObj386_1>;
...
constructor TMyObj386_1.Create;
begin
  inherited;
  FInt := 386 * 3;
  FTest := 'Value: ' + Random(23862).ToString + Random(38600).ToString;
end;

procedure TForm386.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum386;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj386_List0 := TMyObj386_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj386_List1 := TMyObj386_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
