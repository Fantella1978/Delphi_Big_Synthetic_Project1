...
type
  ...
  TMyObj988_List0 = TObjectList<TMyObj988>;

  TMyObj988_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj988_List1 = TObjectList<TMyObj988_1>;
...
constructor TMyObj988_1.Create;
begin
  inherited;
  FInt := 988 * 3;
  FTest := 'Value: ' + Random(29882).ToString + Random(98800).ToString;
end;

procedure TForm988.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum988;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj988_List0 := TMyObj988_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj988_List1 := TMyObj988_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
