...
type
  ...
  TMyObj632_List0 = TObjectList<TMyObj632>;

  TMyObj632_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj632_List1 = TObjectList<TMyObj632_1>;
...
constructor TMyObj632_1.Create;
begin
  inherited;
  FInt := 632 * 3;
  FTest := 'Value: ' + Random(26322).ToString + Random(63200).ToString;
end;

procedure TForm632.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum632;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj632_List0 := TMyObj632_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj632_List1 := TMyObj632_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
