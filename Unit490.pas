...
type
  ...
  TMyObj490_List0 = TObjectList<TMyObj490>;

  TMyObj490_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj490_List1 = TObjectList<TMyObj490_1>;
...
constructor TMyObj490_1.Create;
begin
  inherited;
  FInt := 490 * 3;
  FTest := 'Value: ' + Random(24902).ToString + Random(49000).ToString;
end;

procedure TForm490.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum490;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj490_List0 := TMyObj490_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj490_List1 := TMyObj490_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
