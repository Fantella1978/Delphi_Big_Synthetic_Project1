...
type
  ...
  TMyObj1069_List0 = TObjectList<TMyObj1069>;

  TMyObj1069_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1069_List1 = TObjectList<TMyObj1069_1>;
...
constructor TMyObj1069_1.Create;
begin
  inherited;
  FInt := 1069 * 3;
  FTest := 'Value: ' + Random(210692).ToString + Random(106900).ToString;
end;

procedure TForm1069.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1069;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1069_List0 := TMyObj1069_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1069_List1 := TMyObj1069_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
