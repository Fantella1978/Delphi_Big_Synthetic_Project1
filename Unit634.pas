...
type
  ...
  TMyObj634_List0 = TObjectList<TMyObj634>;

  TMyObj634_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj634_List1 = TObjectList<TMyObj634_1>;
...
constructor TMyObj634_1.Create;
begin
  inherited;
  FInt := 634 * 3;
  FTest := 'Value: ' + Random(26342).ToString + Random(63400).ToString;
end;

procedure TForm634.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum634;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj634_List0 := TMyObj634_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj634_List1 := TMyObj634_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
