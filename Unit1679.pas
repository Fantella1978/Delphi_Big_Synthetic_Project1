...
type
  ...
  TMyObj1679_List0 = TObjectList<TMyObj1679>;

  TMyObj1679_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1679_List1 = TObjectList<TMyObj1679_1>;
...
constructor TMyObj1679_1.Create;
begin
  inherited;
  FInt := 1679 * 3;
  FTest := 'Value: ' + Random(216792).ToString + Random(167900).ToString;
end;

procedure TForm1679.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1679;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1679_List0 := TMyObj1679_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1679_List1 := TMyObj1679_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
