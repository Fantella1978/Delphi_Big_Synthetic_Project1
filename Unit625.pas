...
type
  ...
  TMyObj625_List0 = TObjectList<TMyObj625>;

  TMyObj625_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj625_List1 = TObjectList<TMyObj625_1>;
...
constructor TMyObj625_1.Create;
begin
  inherited;
  FInt := 625 * 3;
  FTest := 'Value: ' + Random(26252).ToString + Random(62500).ToString;
end;

procedure TForm625.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum625;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj625_List0 := TMyObj625_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj625_List1 := TMyObj625_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
