...
type
  ...
  TMyObj1269_List0 = TObjectList<TMyObj1269>;

  TMyObj1269_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1269_List1 = TObjectList<TMyObj1269_1>;
...
constructor TMyObj1269_1.Create;
begin
  inherited;
  FInt := 1269 * 3;
  FTest := 'Value: ' + Random(212692).ToString + Random(126900).ToString;
end;

procedure TForm1269.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1269;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1269_List0 := TMyObj1269_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1269_List1 := TMyObj1269_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
