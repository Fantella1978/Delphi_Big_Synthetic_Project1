...
type
  ...
  TMyObj1480_List0 = TObjectList<TMyObj1480>;

  TMyObj1480_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1480_List1 = TObjectList<TMyObj1480_1>;
...
constructor TMyObj1480_1.Create;
begin
  inherited;
  FInt := 1480 * 3;
  FTest := 'Value: ' + Random(214802).ToString + Random(148000).ToString;
end;

procedure TForm1480.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1480;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1480_List0 := TMyObj1480_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1480_List1 := TMyObj1480_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
