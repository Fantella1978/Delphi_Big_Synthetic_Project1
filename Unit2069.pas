...
type
  ...
  TMyObj2069_List0 = TObjectList<TMyObj2069>;

  TMyObj2069_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2069_List1 = TObjectList<TMyObj2069_1>;
...
constructor TMyObj2069_1.Create;
begin
  inherited;
  FInt := 2069 * 3;
  FTest := 'Value: ' + Random(220692).ToString + Random(206900).ToString;
end;

procedure TForm2069.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2069;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2069_List0 := TMyObj2069_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2069_List1 := TMyObj2069_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
