...
type
  ...
  TMyObj196_List0 = TObjectList<TMyObj196>;

  TMyObj196_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj196_List1 = TObjectList<TMyObj196_1>;
...
constructor TMyObj196_1.Create;
begin
  inherited;
  FInt := 196 * 3;
  FTest := 'Value: ' + Random(21962).ToString + Random(19600).ToString;
end;

procedure TForm196.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum196;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj196_List0 := TMyObj196_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj196_List1 := TMyObj196_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
