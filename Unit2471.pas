...
type
  ...
  TMyObj2471_List0 = TObjectList<TMyObj2471>;

  TMyObj2471_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2471_List1 = TObjectList<TMyObj2471_1>;
...
constructor TMyObj2471_1.Create;
begin
  inherited;
  FInt := 2471 * 3;
  FTest := 'Value: ' + Random(224712).ToString + Random(247100).ToString;
end;

procedure TForm2471.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2471;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2471_List0 := TMyObj2471_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2471_List1 := TMyObj2471_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
