...
type
  ...
  TMyObj1400_List0 = TObjectList<TMyObj1400>;

  TMyObj1400_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1400_List1 = TObjectList<TMyObj1400_1>;
...
constructor TMyObj1400_1.Create;
begin
  inherited;
  FInt := 1400 * 3;
  FTest := 'Value: ' + Random(214002).ToString + Random(140000).ToString;
end;

procedure TForm1400.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1400;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1400_List0 := TMyObj1400_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1400_List1 := TMyObj1400_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
