...
type
  ...
  TMyObj18_List0 = TObjectList<TMyObj18>;

  TMyObj18_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj18_List1 = TObjectList<TMyObj18_1>;
...
constructor TMyObj18_1.Create;
begin
  inherited;
  FInt := 18 * 3;
  FTest := 'Value: ' + Random(2182).ToString + Random(1800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj18_List0 := TMyObj18_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj18_List1 := TMyObj18_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
