...
type
  ...
  TMyObj1064_List0 = TObjectList<TMyObj1064>;

  TMyObj1064_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1064_List1 = TObjectList<TMyObj1064_1>;
...
constructor TMyObj1064_1.Create;
begin
  inherited;
  FInt := 1064 * 3;
  FTest := 'Value: ' + Random(210642).ToString + Random(106400).ToString;
end;

procedure TForm1064.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1064;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1064_List0 := TMyObj1064_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1064_List1 := TMyObj1064_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
