...
type
  ...
  TMyObj364_List0 = TObjectList<TMyObj364>;

  TMyObj364_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj364_List1 = TObjectList<TMyObj364_1>;
...
constructor TMyObj364_1.Create;
begin
  inherited;
  FInt := 364 * 3;
  FTest := 'Value: ' + Random(23642).ToString + Random(36400).ToString;
end;

procedure TForm364.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum364;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj364_List0 := TMyObj364_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj364_List1 := TMyObj364_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
