...
type
  ...
  TMyObj1978_List0 = TObjectList<TMyObj1978>;

  TMyObj1978_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1978_List1 = TObjectList<TMyObj1978_1>;
...
constructor TMyObj1978_1.Create;
begin
  inherited;
  FInt := 1978 * 3;
  FTest := 'Value: ' + Random(219782).ToString + Random(197800).ToString;
end;

procedure TForm1978.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1978;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1978_List0 := TMyObj1978_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1978_List1 := TMyObj1978_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
