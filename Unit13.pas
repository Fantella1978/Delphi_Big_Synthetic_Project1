...
type
  ...
  TMyObj13_List0 = TObjectList<TMyObj13>;

  TMyObj13_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj13_List1 = TObjectList<TMyObj13_1>;
...
constructor TMyObj13_1.Create;
begin
  inherited;
  FInt := 13 * 3;
  FTest := 'Value: ' + Random(2132).ToString + Random(1300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj13_List0 := TMyObj13_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj13_List1 := TMyObj13_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
