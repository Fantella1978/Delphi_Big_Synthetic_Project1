...
type
  ...
  TMyObj1051_List0 = TObjectList<TMyObj1051>;

  TMyObj1051_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1051_List1 = TObjectList<TMyObj1051_1>;
...
constructor TMyObj1051_1.Create;
begin
  inherited;
  FInt := 1051 * 3;
  FTest := 'Value: ' + Random(210512).ToString + Random(105100).ToString;
end;

procedure TForm1051.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1051;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1051_List0 := TMyObj1051_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1051_List1 := TMyObj1051_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
