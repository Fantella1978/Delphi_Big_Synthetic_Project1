...
type
  ...
  TMyObj866_List0 = TObjectList<TMyObj866>;

  TMyObj866_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj866_List1 = TObjectList<TMyObj866_1>;
...
constructor TMyObj866_1.Create;
begin
  inherited;
  FInt := 866 * 3;
  FTest := 'Value: ' + Random(28662).ToString + Random(86600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj866_List0 := TMyObj866_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj866_List1 := TMyObj866_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
