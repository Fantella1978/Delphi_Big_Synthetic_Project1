...
type
  ...
  TMyObj355_List0 = TObjectList<TMyObj355>;

  TMyObj355_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj355_List1 = TObjectList<TMyObj355_1>;
...
constructor TMyObj355_1.Create;
begin
  inherited;
  FInt := 355 * 3;
  FTest := 'Value: ' + Random(23552).ToString + Random(35500).ToString;
end;

procedure TForm355.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum355;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj355_List0 := TMyObj355_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj355_List1 := TMyObj355_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
