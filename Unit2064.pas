...
type
  ...
  TMyObj2064_List0 = TObjectList<TMyObj2064>;

  TMyObj2064_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2064_List1 = TObjectList<TMyObj2064_1>;
...
constructor TMyObj2064_1.Create;
begin
  inherited;
  FInt := 2064 * 3;
  FTest := 'Value: ' + Random(220642).ToString + Random(206400).ToString;
end;

procedure TForm2064.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2064;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2064_List0 := TMyObj2064_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2064_List1 := TMyObj2064_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
