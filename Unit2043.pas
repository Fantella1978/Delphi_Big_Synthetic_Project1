...
type
  ...
  TMyObj2043_List0 = TObjectList<TMyObj2043>;

  TMyObj2043_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2043_List1 = TObjectList<TMyObj2043_1>;
...
constructor TMyObj2043_1.Create;
begin
  inherited;
  FInt := 2043 * 3;
  FTest := 'Value: ' + Random(220432).ToString + Random(204300).ToString;
end;

procedure TForm2043.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2043;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2043_List0 := TMyObj2043_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2043_List1 := TMyObj2043_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
