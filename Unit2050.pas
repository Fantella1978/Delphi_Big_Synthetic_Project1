...
type
  ...
  TMyObj2050_List0 = TObjectList<TMyObj2050>;

  TMyObj2050_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2050_List1 = TObjectList<TMyObj2050_1>;
...
constructor TMyObj2050_1.Create;
begin
  inherited;
  FInt := 2050 * 3;
  FTest := 'Value: ' + Random(220502).ToString + Random(205000).ToString;
end;

procedure TForm2050.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2050;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2050_List0 := TMyObj2050_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2050_List1 := TMyObj2050_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
