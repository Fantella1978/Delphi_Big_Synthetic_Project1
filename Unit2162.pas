...
type
  ...
  TMyObj2162_List0 = TObjectList<TMyObj2162>;

  TMyObj2162_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2162_List1 = TObjectList<TMyObj2162_1>;
...
constructor TMyObj2162_1.Create;
begin
  inherited;
  FInt := 2162 * 3;
  FTest := 'Value: ' + Random(221622).ToString + Random(216200).ToString;
end;

procedure TForm2162.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2162;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2162_List0 := TMyObj2162_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2162_List1 := TMyObj2162_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
