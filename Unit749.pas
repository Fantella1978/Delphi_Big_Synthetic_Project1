...
type
  ...
  TMyObj749_List0 = TObjectList<TMyObj749>;

  TMyObj749_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj749_List1 = TObjectList<TMyObj749_1>;
...
constructor TMyObj749_1.Create;
begin
  inherited;
  FInt := 749 * 3;
  FTest := 'Value: ' + Random(27492).ToString + Random(74900).ToString;
end;

procedure TForm749.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum749;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj749_List0 := TMyObj749_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj749_List1 := TMyObj749_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
