...
type
  ...
  TMyObj2248_List0 = TObjectList<TMyObj2248>;

  TMyObj2248_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2248_List1 = TObjectList<TMyObj2248_1>;
...
constructor TMyObj2248_1.Create;
begin
  inherited;
  FInt := 2248 * 3;
  FTest := 'Value: ' + Random(222482).ToString + Random(224800).ToString;
end;

procedure TForm2248.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2248;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2248_List0 := TMyObj2248_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2248_List1 := TMyObj2248_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
