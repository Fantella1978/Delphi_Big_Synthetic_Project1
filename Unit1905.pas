...
type
  ...
  TMyObj1905_List0 = TObjectList<TMyObj1905>;

  TMyObj1905_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1905_List1 = TObjectList<TMyObj1905_1>;
...
constructor TMyObj1905_1.Create;
begin
  inherited;
  FInt := 1905 * 3;
  FTest := 'Value: ' + Random(219052).ToString + Random(190500).ToString;
end;

procedure TForm1905.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1905;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1905_List0 := TMyObj1905_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1905_List1 := TMyObj1905_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
