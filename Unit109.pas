...
type
  ...
  TMyObj109_List0 = TObjectList<TMyObj109>;

  TMyObj109_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj109_List1 = TObjectList<TMyObj109_1>;
...
constructor TMyObj109_1.Create;
begin
  inherited;
  FInt := 109 * 3;
  FTest := 'Value: ' + Random(21092).ToString + Random(10900).ToString;
end;

procedure TForm109.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum109;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj109_List0 := TMyObj109_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj109_List1 := TMyObj109_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
