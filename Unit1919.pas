...
type
  ...
  TMyObj1919_List0 = TObjectList<TMyObj1919>;

  TMyObj1919_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1919_List1 = TObjectList<TMyObj1919_1>;
...
constructor TMyObj1919_1.Create;
begin
  inherited;
  FInt := 1919 * 3;
  FTest := 'Value: ' + Random(219192).ToString + Random(191900).ToString;
end;

procedure TForm1919.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1919;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1919_List0 := TMyObj1919_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1919_List1 := TMyObj1919_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
