...
type
  ...
  TMyObj832_List0 = TObjectList<TMyObj832>;

  TMyObj832_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj832_List1 = TObjectList<TMyObj832_1>;
...
constructor TMyObj832_1.Create;
begin
  inherited;
  FInt := 832 * 3;
  FTest := 'Value: ' + Random(28322).ToString + Random(83200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj832_List0 := TMyObj832_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj832_List1 := TMyObj832_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
