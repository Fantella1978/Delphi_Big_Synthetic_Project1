...
type
  ...
  TMyObj2236_List0 = TObjectList<TMyObj2236>;

  TMyObj2236_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2236_List1 = TObjectList<TMyObj2236_1>;
...
constructor TMyObj2236_1.Create;
begin
  inherited;
  FInt := 2236 * 3;
  FTest := 'Value: ' + Random(222362).ToString + Random(223600).ToString;
end;

procedure TForm2236.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2236;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2236_List0 := TMyObj2236_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2236_List1 := TMyObj2236_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
