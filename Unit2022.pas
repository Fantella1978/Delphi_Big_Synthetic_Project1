...
type
  ...
  TMyObj2022_List0 = TObjectList<TMyObj2022>;

  TMyObj2022_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2022_List1 = TObjectList<TMyObj2022_1>;
...
constructor TMyObj2022_1.Create;
begin
  inherited;
  FInt := 2022 * 3;
  FTest := 'Value: ' + Random(220222).ToString + Random(202200).ToString;
end;

procedure TForm2022.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2022;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2022_List0 := TMyObj2022_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2022_List1 := TMyObj2022_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
