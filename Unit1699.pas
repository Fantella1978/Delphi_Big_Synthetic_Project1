...
type
  ...
  TMyObj1699_List0 = TObjectList<TMyObj1699>;

  TMyObj1699_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1699_List1 = TObjectList<TMyObj1699_1>;
...
constructor TMyObj1699_1.Create;
begin
  inherited;
  FInt := 1699 * 3;
  FTest := 'Value: ' + Random(216992).ToString + Random(169900).ToString;
end;

procedure TForm1699.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1699;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1699_List0 := TMyObj1699_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1699_List1 := TMyObj1699_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
