...
type
  ...
  TMyObj335_List0 = TObjectList<TMyObj335>;

  TMyObj335_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj335_List1 = TObjectList<TMyObj335_1>;
...
constructor TMyObj335_1.Create;
begin
  inherited;
  FInt := 335 * 3;
  FTest := 'Value: ' + Random(23352).ToString + Random(33500).ToString;
end;

procedure TForm335.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum335;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj335_List0 := TMyObj335_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj335_List1 := TMyObj335_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
