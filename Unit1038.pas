...
type
  ...
  TMyObj1038_List0 = TObjectList<TMyObj1038>;

  TMyObj1038_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1038_List1 = TObjectList<TMyObj1038_1>;
...
constructor TMyObj1038_1.Create;
begin
  inherited;
  FInt := 1038 * 3;
  FTest := 'Value: ' + Random(210382).ToString + Random(103800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1038_List0 := TMyObj1038_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1038_List1 := TMyObj1038_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
