...
type
  ...
  TMyObj19_List0 = TObjectList<TMyObj19>;

  TMyObj19_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj19_List1 = TObjectList<TMyObj19_1>;
...
constructor TMyObj19_1.Create;
begin
  inherited;
  FInt := 19 * 3;
  FTest := 'Value: ' + Random(2192).ToString + Random(1900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj19_List0 := TMyObj19_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj19_List1 := TMyObj19_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
