...
type
  ...
  TMyObj1912_List0 = TObjectList<TMyObj1912>;

  TMyObj1912_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1912_List1 = TObjectList<TMyObj1912_1>;
...
constructor TMyObj1912_1.Create;
begin
  inherited;
  FInt := 1912 * 3;
  FTest := 'Value: ' + Random(219122).ToString + Random(191200).ToString;
end;

procedure TForm1912.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1912;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1912_List0 := TMyObj1912_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1912_List1 := TMyObj1912_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
