...
type
  ...
  TMyObj2270_List0 = TObjectList<TMyObj2270>;

  TMyObj2270_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2270_List1 = TObjectList<TMyObj2270_1>;
...
constructor TMyObj2270_1.Create;
begin
  inherited;
  FInt := 2270 * 3;
  FTest := 'Value: ' + Random(222702).ToString + Random(227000).ToString;
end;

procedure TForm2270.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2270;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2270_List0 := TMyObj2270_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2270_List1 := TMyObj2270_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
