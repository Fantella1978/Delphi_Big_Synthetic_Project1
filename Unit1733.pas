...
type
  ...
  TMyObj1733_List0 = TObjectList<TMyObj1733>;

  TMyObj1733_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1733_List1 = TObjectList<TMyObj1733_1>;
...
constructor TMyObj1733_1.Create;
begin
  inherited;
  FInt := 1733 * 3;
  FTest := 'Value: ' + Random(217332).ToString + Random(173300).ToString;
end;

procedure TForm1733.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1733;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1733_List0 := TMyObj1733_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1733_List1 := TMyObj1733_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
