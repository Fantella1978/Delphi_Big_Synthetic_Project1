...
type
  ...
  TMyObj567_List0 = TObjectList<TMyObj567>;

  TMyObj567_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj567_List1 = TObjectList<TMyObj567_1>;
...
constructor TMyObj567_1.Create;
begin
  inherited;
  FInt := 567 * 3;
  FTest := 'Value: ' + Random(25672).ToString + Random(56700).ToString;
end;

procedure TForm567.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum567;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj567_List0 := TMyObj567_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj567_List1 := TMyObj567_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
