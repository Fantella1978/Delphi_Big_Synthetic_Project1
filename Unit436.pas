...
type
  ...
  TMyObj436_List0 = TObjectList<TMyObj436>;

  TMyObj436_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj436_List1 = TObjectList<TMyObj436_1>;
...
constructor TMyObj436_1.Create;
begin
  inherited;
  FInt := 436 * 3;
  FTest := 'Value: ' + Random(24362).ToString + Random(43600).ToString;
end;

procedure TForm436.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum436;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj436_List0 := TMyObj436_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj436_List1 := TMyObj436_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
