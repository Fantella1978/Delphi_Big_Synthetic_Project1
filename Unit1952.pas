...
type
  ...
  TMyObj1952_List0 = TObjectList<TMyObj1952>;

  TMyObj1952_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1952_List1 = TObjectList<TMyObj1952_1>;
...
constructor TMyObj1952_1.Create;
begin
  inherited;
  FInt := 1952 * 3;
  FTest := 'Value: ' + Random(219522).ToString + Random(195200).ToString;
end;

procedure TForm1952.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1952;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1952_List0 := TMyObj1952_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1952_List1 := TMyObj1952_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
