...
type
  ...
  TMyObj1845_List0 = TObjectList<TMyObj1845>;

  TMyObj1845_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1845_List1 = TObjectList<TMyObj1845_1>;
...
constructor TMyObj1845_1.Create;
begin
  inherited;
  FInt := 1845 * 3;
  FTest := 'Value: ' + Random(218452).ToString + Random(184500).ToString;
end;

procedure TForm1845.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1845;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1845_List0 := TMyObj1845_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1845_List1 := TMyObj1845_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
