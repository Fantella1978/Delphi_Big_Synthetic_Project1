...
type
  ...
  TMyObj827_List0 = TObjectList<TMyObj827>;

  TMyObj827_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj827_List1 = TObjectList<TMyObj827_1>;
...
constructor TMyObj827_1.Create;
begin
  inherited;
  FInt := 827 * 3;
  FTest := 'Value: ' + Random(28272).ToString + Random(82700).ToString;
end;

procedure TForm827.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum827;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj827_List0 := TMyObj827_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj827_List1 := TMyObj827_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
