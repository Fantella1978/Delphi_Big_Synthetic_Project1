...
type
  ...
  TMyObj1969_List0 = TObjectList<TMyObj1969>;

  TMyObj1969_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1969_List1 = TObjectList<TMyObj1969_1>;
...
constructor TMyObj1969_1.Create;
begin
  inherited;
  FInt := 1969 * 3;
  FTest := 'Value: ' + Random(219692).ToString + Random(196900).ToString;
end;

procedure TForm1969.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1969;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1969_List0 := TMyObj1969_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1969_List1 := TMyObj1969_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
