...
type
  ...
  TMyObj2151_List0 = TObjectList<TMyObj2151>;

  TMyObj2151_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2151_List1 = TObjectList<TMyObj2151_1>;
...
constructor TMyObj2151_1.Create;
begin
  inherited;
  FInt := 2151 * 3;
  FTest := 'Value: ' + Random(221512).ToString + Random(215100).ToString;
end;

procedure TForm2151.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2151;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2151_List0 := TMyObj2151_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2151_List1 := TMyObj2151_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
