...
type
  ...
  TMyObj2386_List0 = TObjectList<TMyObj2386>;

  TMyObj2386_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2386_List1 = TObjectList<TMyObj2386_1>;
...
constructor TMyObj2386_1.Create;
begin
  inherited;
  FInt := 2386 * 3;
  FTest := 'Value: ' + Random(223862).ToString + Random(238600).ToString;
end;

procedure TForm2386.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2386;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2386_List0 := TMyObj2386_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2386_List1 := TMyObj2386_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
