...
type
  ...
  TMyObj2062_List0 = TObjectList<TMyObj2062>;

  TMyObj2062_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2062_List1 = TObjectList<TMyObj2062_1>;
...
constructor TMyObj2062_1.Create;
begin
  inherited;
  FInt := 2062 * 3;
  FTest := 'Value: ' + Random(220622).ToString + Random(206200).ToString;
end;

procedure TForm2062.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2062;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2062_List0 := TMyObj2062_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2062_List1 := TMyObj2062_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
