...
type
  ...
  TMyObj1941_List0 = TObjectList<TMyObj1941>;

  TMyObj1941_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1941_List1 = TObjectList<TMyObj1941_1>;
...
constructor TMyObj1941_1.Create;
begin
  inherited;
  FInt := 1941 * 3;
  FTest := 'Value: ' + Random(219412).ToString + Random(194100).ToString;
end;

procedure TForm1941.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1941;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1941_List0 := TMyObj1941_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1941_List1 := TMyObj1941_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
