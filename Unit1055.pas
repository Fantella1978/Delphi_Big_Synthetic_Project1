...
type
  ...
  TMyObj1055_List0 = TObjectList<TMyObj1055>;

  TMyObj1055_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1055_List1 = TObjectList<TMyObj1055_1>;
...
constructor TMyObj1055_1.Create;
begin
  inherited;
  FInt := 1055 * 3;
  FTest := 'Value: ' + Random(210552).ToString + Random(105500).ToString;
end;

procedure TForm1055.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1055;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1055_List0 := TMyObj1055_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1055_List1 := TMyObj1055_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
