...
type
  ...
  TMyObj1675_List0 = TObjectList<TMyObj1675>;

  TMyObj1675_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1675_List1 = TObjectList<TMyObj1675_1>;
...
constructor TMyObj1675_1.Create;
begin
  inherited;
  FInt := 1675 * 3;
  FTest := 'Value: ' + Random(216752).ToString + Random(167500).ToString;
end;

procedure TForm1675.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1675;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1675_List0 := TMyObj1675_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1675_List1 := TMyObj1675_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
