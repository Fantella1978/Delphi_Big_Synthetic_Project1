...
type
  ...
  TMyObj479_List0 = TObjectList<TMyObj479>;

  TMyObj479_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj479_List1 = TObjectList<TMyObj479_1>;
...
constructor TMyObj479_1.Create;
begin
  inherited;
  FInt := 479 * 3;
  FTest := 'Value: ' + Random(24792).ToString + Random(47900).ToString;
end;

procedure TForm479.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum479;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj479_List0 := TMyObj479_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj479_List1 := TMyObj479_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
