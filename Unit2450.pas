...
type
  ...
  TMyObj2450_List0 = TObjectList<TMyObj2450>;

  TMyObj2450_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2450_List1 = TObjectList<TMyObj2450_1>;
...
constructor TMyObj2450_1.Create;
begin
  inherited;
  FInt := 2450 * 3;
  FTest := 'Value: ' + Random(224502).ToString + Random(245000).ToString;
end;

procedure TForm2450.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2450;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2450_List0 := TMyObj2450_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2450_List1 := TMyObj2450_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
