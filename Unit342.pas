...
type
  ...
  TMyObj342_List0 = TObjectList<TMyObj342>;

  TMyObj342_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj342_List1 = TObjectList<TMyObj342_1>;
...
constructor TMyObj342_1.Create;
begin
  inherited;
  FInt := 342 * 3;
  FTest := 'Value: ' + Random(23422).ToString + Random(34200).ToString;
end;

procedure TForm342.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum342;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj342_List0 := TMyObj342_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj342_List1 := TMyObj342_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
