...
type
  ...
  TMyObj643_List0 = TObjectList<TMyObj643>;

  TMyObj643_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj643_List1 = TObjectList<TMyObj643_1>;
...
constructor TMyObj643_1.Create;
begin
  inherited;
  FInt := 643 * 3;
  FTest := 'Value: ' + Random(26432).ToString + Random(64300).ToString;
end;

procedure TForm643.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum643;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj643_List0 := TMyObj643_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj643_List1 := TMyObj643_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
