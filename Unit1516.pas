...
type
  ...
  TMyObj1516_List0 = TObjectList<TMyObj1516>;

  TMyObj1516_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1516_List1 = TObjectList<TMyObj1516_1>;
...
constructor TMyObj1516_1.Create;
begin
  inherited;
  FInt := 1516 * 3;
  FTest := 'Value: ' + Random(215162).ToString + Random(151600).ToString;
end;

procedure TForm1516.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1516;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1516_List0 := TMyObj1516_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1516_List1 := TMyObj1516_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
