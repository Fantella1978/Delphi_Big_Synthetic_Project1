...
type
  ...
  TMyObj1725_List0 = TObjectList<TMyObj1725>;

  TMyObj1725_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1725_List1 = TObjectList<TMyObj1725_1>;
...
constructor TMyObj1725_1.Create;
begin
  inherited;
  FInt := 1725 * 3;
  FTest := 'Value: ' + Random(217252).ToString + Random(172500).ToString;
end;

procedure TForm1725.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1725;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1725_List0 := TMyObj1725_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1725_List1 := TMyObj1725_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
