...
type
  ...
  TMyObj1629_List0 = TObjectList<TMyObj1629>;

  TMyObj1629_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1629_List1 = TObjectList<TMyObj1629_1>;
...
constructor TMyObj1629_1.Create;
begin
  inherited;
  FInt := 1629 * 3;
  FTest := 'Value: ' + Random(216292).ToString + Random(162900).ToString;
end;

procedure TForm1629.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1629;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1629_List0 := TMyObj1629_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1629_List1 := TMyObj1629_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
