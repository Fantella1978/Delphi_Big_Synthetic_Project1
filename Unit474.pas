...
type
  ...
  TMyObj474_List0 = TObjectList<TMyObj474>;

  TMyObj474_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj474_List1 = TObjectList<TMyObj474_1>;
...
constructor TMyObj474_1.Create;
begin
  inherited;
  FInt := 474 * 3;
  FTest := 'Value: ' + Random(24742).ToString + Random(47400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj474_List0 := TMyObj474_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj474_List1 := TMyObj474_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
