...
type
  ...
  TMyObj828_List0 = TObjectList<TMyObj828>;

  TMyObj828_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj828_List1 = TObjectList<TMyObj828_1>;
...
constructor TMyObj828_1.Create;
begin
  inherited;
  FInt := 828 * 3;
  FTest := 'Value: ' + Random(28282).ToString + Random(82800).ToString;
end;

procedure TForm828.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum828;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj828_List0 := TMyObj828_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj828_List1 := TMyObj828_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
