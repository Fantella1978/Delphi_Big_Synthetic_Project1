...
type
  ...
  TMyObj1299_List0 = TObjectList<TMyObj1299>;

  TMyObj1299_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1299_List1 = TObjectList<TMyObj1299_1>;
...
constructor TMyObj1299_1.Create;
begin
  inherited;
  FInt := 1299 * 3;
  FTest := 'Value: ' + Random(212992).ToString + Random(129900).ToString;
end;

procedure TForm1299.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1299;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1299_List0 := TMyObj1299_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1299_List1 := TMyObj1299_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
