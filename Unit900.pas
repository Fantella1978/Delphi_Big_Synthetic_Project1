...
type
  ...
  TMyObj900_List0 = TObjectList<TMyObj900>;

  TMyObj900_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj900_List1 = TObjectList<TMyObj900_1>;
...
constructor TMyObj900_1.Create;
begin
  inherited;
  FInt := 900 * 3;
  FTest := 'Value: ' + Random(29002).ToString + Random(90000).ToString;
end;

procedure TForm900.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum900;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj900_List0 := TMyObj900_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj900_List1 := TMyObj900_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
