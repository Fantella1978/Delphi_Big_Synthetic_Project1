...
type
  ...
  TMyObj93_List0 = TObjectList<TMyObj93>;

  TMyObj93_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj93_List1 = TObjectList<TMyObj93_1>;
...
constructor TMyObj93_1.Create;
begin
  inherited;
  FInt := 93 * 3;
  FTest := 'Value: ' + Random(2932).ToString + Random(9300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj93_List0 := TMyObj93_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj93_List1 := TMyObj93_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
