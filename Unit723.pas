...
type
  ...
  TMyObj723_List0 = TObjectList<TMyObj723>;

  TMyObj723_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj723_List1 = TObjectList<TMyObj723_1>;
...
constructor TMyObj723_1.Create;
begin
  inherited;
  FInt := 723 * 3;
  FTest := 'Value: ' + Random(27232).ToString + Random(72300).ToString;
end;

procedure TForm723.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum723;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj723_List0 := TMyObj723_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj723_List1 := TMyObj723_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
