...
type
  ...
  TMyObj1298_List0 = TObjectList<TMyObj1298>;

  TMyObj1298_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1298_List1 = TObjectList<TMyObj1298_1>;
...
constructor TMyObj1298_1.Create;
begin
  inherited;
  FInt := 1298 * 3;
  FTest := 'Value: ' + Random(212982).ToString + Random(129800).ToString;
end;

procedure TForm1298.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1298;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1298_List0 := TMyObj1298_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1298_List1 := TMyObj1298_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
