...
type
  ...
  TMyObj76_List0 = TObjectList<TMyObj76>;

  TMyObj76_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj76_List1 = TObjectList<TMyObj76_1>;
...
constructor TMyObj76_1.Create;
begin
  inherited;
  FInt := 76 * 3;
  FTest := 'Value: ' + Random(2762).ToString + Random(7600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj76_List0 := TMyObj76_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj76_List1 := TMyObj76_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
