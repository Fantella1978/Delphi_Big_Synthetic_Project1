...
type
  ...
  TMyObj1606_List0 = TObjectList<TMyObj1606>;

  TMyObj1606_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1606_List1 = TObjectList<TMyObj1606_1>;
...
constructor TMyObj1606_1.Create;
begin
  inherited;
  FInt := 1606 * 3;
  FTest := 'Value: ' + Random(216062).ToString + Random(160600).ToString;
end;

procedure TForm1606.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1606;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1606_List0 := TMyObj1606_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1606_List1 := TMyObj1606_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
