...
type
  ...
  TMyObj2298_List0 = TObjectList<TMyObj2298>;

  TMyObj2298_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2298_List1 = TObjectList<TMyObj2298_1>;
...
constructor TMyObj2298_1.Create;
begin
  inherited;
  FInt := 2298 * 3;
  FTest := 'Value: ' + Random(222982).ToString + Random(229800).ToString;
end;

procedure TForm2298.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2298;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2298_List0 := TMyObj2298_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2298_List1 := TMyObj2298_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
