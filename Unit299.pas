...
type
  ...
  TMyObj299_List0 = TObjectList<TMyObj299>;

  TMyObj299_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj299_List1 = TObjectList<TMyObj299_1>;
...
constructor TMyObj299_1.Create;
begin
  inherited;
  FInt := 299 * 3;
  FTest := 'Value: ' + Random(22992).ToString + Random(29900).ToString;
end;

procedure TForm299.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum299;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj299_List0 := TMyObj299_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj299_List1 := TMyObj299_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
