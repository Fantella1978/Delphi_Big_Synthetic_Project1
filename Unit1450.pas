...
type
  ...
  TMyObj1450_List0 = TObjectList<TMyObj1450>;

  TMyObj1450_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1450_List1 = TObjectList<TMyObj1450_1>;
...
constructor TMyObj1450_1.Create;
begin
  inherited;
  FInt := 1450 * 3;
  FTest := 'Value: ' + Random(214502).ToString + Random(145000).ToString;
end;

procedure TForm1450.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1450;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1450_List0 := TMyObj1450_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1450_List1 := TMyObj1450_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
