...
type
  ...
  TMyObj1758_List0 = TObjectList<TMyObj1758>;

  TMyObj1758_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1758_List1 = TObjectList<TMyObj1758_1>;
...
constructor TMyObj1758_1.Create;
begin
  inherited;
  FInt := 1758 * 3;
  FTest := 'Value: ' + Random(217582).ToString + Random(175800).ToString;
end;

procedure TForm1758.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1758;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1758_List0 := TMyObj1758_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1758_List1 := TMyObj1758_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
