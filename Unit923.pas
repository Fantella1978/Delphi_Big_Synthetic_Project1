...
type
  ...
  TMyObj923_List0 = TObjectList<TMyObj923>;

  TMyObj923_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj923_List1 = TObjectList<TMyObj923_1>;
...
constructor TMyObj923_1.Create;
begin
  inherited;
  FInt := 923 * 3;
  FTest := 'Value: ' + Random(29232).ToString + Random(92300).ToString;
end;

procedure TForm923.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum923;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj923_List0 := TMyObj923_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj923_List1 := TMyObj923_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
