...
type
  ...
  TMyObj167_List0 = TObjectList<TMyObj167>;

  TMyObj167_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj167_List1 = TObjectList<TMyObj167_1>;
...
constructor TMyObj167_1.Create;
begin
  inherited;
  FInt := 167 * 3;
  FTest := 'Value: ' + Random(21672).ToString + Random(16700).ToString;
end;

procedure TForm167.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum167;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj167_List0 := TMyObj167_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj167_List1 := TMyObj167_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
