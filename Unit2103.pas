...
type
  ...
  TMyObj2103_List0 = TObjectList<TMyObj2103>;

  TMyObj2103_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2103_List1 = TObjectList<TMyObj2103_1>;
...
constructor TMyObj2103_1.Create;
begin
  inherited;
  FInt := 2103 * 3;
  FTest := 'Value: ' + Random(221032).ToString + Random(210300).ToString;
end;

procedure TForm2103.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2103;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2103_List0 := TMyObj2103_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2103_List1 := TMyObj2103_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
