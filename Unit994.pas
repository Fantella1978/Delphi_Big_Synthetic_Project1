...
type
  ...
  TMyObj994_List0 = TObjectList<TMyObj994>;

  TMyObj994_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj994_List1 = TObjectList<TMyObj994_1>;
...
constructor TMyObj994_1.Create;
begin
  inherited;
  FInt := 994 * 3;
  FTest := 'Value: ' + Random(29942).ToString + Random(99400).ToString;
end;

procedure TForm994.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum994;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj994_List0 := TMyObj994_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj994_List1 := TMyObj994_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
