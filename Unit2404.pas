...
type
  ...
  TMyObj2404_List0 = TObjectList<TMyObj2404>;

  TMyObj2404_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2404_List1 = TObjectList<TMyObj2404_1>;
...
constructor TMyObj2404_1.Create;
begin
  inherited;
  FInt := 2404 * 3;
  FTest := 'Value: ' + Random(224042).ToString + Random(240400).ToString;
end;

procedure TForm2404.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2404;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2404_List0 := TMyObj2404_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2404_List1 := TMyObj2404_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
