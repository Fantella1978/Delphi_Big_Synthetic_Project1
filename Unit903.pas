...
type
  ...
  TMyObj903_List0 = TObjectList<TMyObj903>;

  TMyObj903_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj903_List1 = TObjectList<TMyObj903_1>;
...
constructor TMyObj903_1.Create;
begin
  inherited;
  FInt := 903 * 3;
  FTest := 'Value: ' + Random(29032).ToString + Random(90300).ToString;
end;

procedure TForm903.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum903;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj903_List0 := TMyObj903_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj903_List1 := TMyObj903_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
