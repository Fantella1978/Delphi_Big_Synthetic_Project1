...
type
  ...
  TMyObj775_List0 = TObjectList<TMyObj775>;

  TMyObj775_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj775_List1 = TObjectList<TMyObj775_1>;
...
constructor TMyObj775_1.Create;
begin
  inherited;
  FInt := 775 * 3;
  FTest := 'Value: ' + Random(27752).ToString + Random(77500).ToString;
end;

procedure TForm775.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum775;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj775_List0 := TMyObj775_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj775_List1 := TMyObj775_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
