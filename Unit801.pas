...
type
  ...
  TMyObj801_List0 = TObjectList<TMyObj801>;

  TMyObj801_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj801_List1 = TObjectList<TMyObj801_1>;
...
constructor TMyObj801_1.Create;
begin
  inherited;
  FInt := 801 * 3;
  FTest := 'Value: ' + Random(28012).ToString + Random(80100).ToString;
end;

procedure TForm801.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum801;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj801_List0 := TMyObj801_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj801_List1 := TMyObj801_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
