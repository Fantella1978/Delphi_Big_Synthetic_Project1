...
type
  ...
  TMyObj1602_List0 = TObjectList<TMyObj1602>;

  TMyObj1602_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1602_List1 = TObjectList<TMyObj1602_1>;
...
constructor TMyObj1602_1.Create;
begin
  inherited;
  FInt := 1602 * 3;
  FTest := 'Value: ' + Random(216022).ToString + Random(160200).ToString;
end;

procedure TForm1602.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1602;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1602_List0 := TMyObj1602_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1602_List1 := TMyObj1602_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
