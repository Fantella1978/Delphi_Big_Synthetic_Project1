...
type
  ...
  TMyObj1583_List0 = TObjectList<TMyObj1583>;

  TMyObj1583_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1583_List1 = TObjectList<TMyObj1583_1>;
...
constructor TMyObj1583_1.Create;
begin
  inherited;
  FInt := 1583 * 3;
  FTest := 'Value: ' + Random(215832).ToString + Random(158300).ToString;
end;

procedure TForm1583.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1583;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1583_List0 := TMyObj1583_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1583_List1 := TMyObj1583_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
