...
type
  ...
  TMyObj1044_List0 = TObjectList<TMyObj1044>;

  TMyObj1044_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1044_List1 = TObjectList<TMyObj1044_1>;
...
constructor TMyObj1044_1.Create;
begin
  inherited;
  FInt := 1044 * 3;
  FTest := 'Value: ' + Random(210442).ToString + Random(104400).ToString;
end;

procedure TForm1044.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1044;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1044_List0 := TMyObj1044_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1044_List1 := TMyObj1044_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
