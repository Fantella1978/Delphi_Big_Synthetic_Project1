...
type
  ...
  TMyObj763_List0 = TObjectList<TMyObj763>;

  TMyObj763_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj763_List1 = TObjectList<TMyObj763_1>;
...
constructor TMyObj763_1.Create;
begin
  inherited;
  FInt := 763 * 3;
  FTest := 'Value: ' + Random(27632).ToString + Random(76300).ToString;
end;

procedure TForm763.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum763;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj763_List0 := TMyObj763_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj763_List1 := TMyObj763_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
