...
type
  ...
  TMyObj653_List0 = TObjectList<TMyObj653>;

  TMyObj653_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj653_List1 = TObjectList<TMyObj653_1>;
...
constructor TMyObj653_1.Create;
begin
  inherited;
  FInt := 653 * 3;
  FTest := 'Value: ' + Random(26532).ToString + Random(65300).ToString;
end;

procedure TForm653.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum653;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj653_List0 := TMyObj653_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj653_List1 := TMyObj653_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
