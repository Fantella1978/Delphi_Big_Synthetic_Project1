...
type
  ...
  TMyObj2052_List0 = TObjectList<TMyObj2052>;

  TMyObj2052_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2052_List1 = TObjectList<TMyObj2052_1>;
...
constructor TMyObj2052_1.Create;
begin
  inherited;
  FInt := 2052 * 3;
  FTest := 'Value: ' + Random(220522).ToString + Random(205200).ToString;
end;

procedure TForm2052.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2052;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2052_List0 := TMyObj2052_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2052_List1 := TMyObj2052_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
