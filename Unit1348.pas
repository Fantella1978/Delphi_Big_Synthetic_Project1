...
type
  ...
  TMyObj1348_List0 = TObjectList<TMyObj1348>;

  TMyObj1348_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1348_List1 = TObjectList<TMyObj1348_1>;
...
constructor TMyObj1348_1.Create;
begin
  inherited;
  FInt := 1348 * 3;
  FTest := 'Value: ' + Random(213482).ToString + Random(134800).ToString;
end;

procedure TForm1348.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1348;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1348_List0 := TMyObj1348_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1348_List1 := TMyObj1348_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
