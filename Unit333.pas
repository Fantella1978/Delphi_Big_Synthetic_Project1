...
type
  ...
  TMyObj333_List0 = TObjectList<TMyObj333>;

  TMyObj333_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj333_List1 = TObjectList<TMyObj333_1>;
...
constructor TMyObj333_1.Create;
begin
  inherited;
  FInt := 333 * 3;
  FTest := 'Value: ' + Random(23332).ToString + Random(33300).ToString;
end;

procedure TForm333.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum333;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj333_List0 := TMyObj333_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj333_List1 := TMyObj333_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
