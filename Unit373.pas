...
type
  ...
  TMyObj373_List0 = TObjectList<TMyObj373>;

  TMyObj373_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj373_List1 = TObjectList<TMyObj373_1>;
...
constructor TMyObj373_1.Create;
begin
  inherited;
  FInt := 373 * 3;
  FTest := 'Value: ' + Random(23732).ToString + Random(37300).ToString;
end;

procedure TForm373.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum373;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj373_List0 := TMyObj373_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj373_List1 := TMyObj373_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
