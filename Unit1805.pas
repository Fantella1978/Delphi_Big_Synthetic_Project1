...
type
  ...
  TMyObj1805_List0 = TObjectList<TMyObj1805>;

  TMyObj1805_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1805_List1 = TObjectList<TMyObj1805_1>;
...
constructor TMyObj1805_1.Create;
begin
  inherited;
  FInt := 1805 * 3;
  FTest := 'Value: ' + Random(218052).ToString + Random(180500).ToString;
end;

procedure TForm1805.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1805;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1805_List0 := TMyObj1805_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1805_List1 := TMyObj1805_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
