...
type
  ...
  TMyObj1798_List0 = TObjectList<TMyObj1798>;

  TMyObj1798_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1798_List1 = TObjectList<TMyObj1798_1>;
...
constructor TMyObj1798_1.Create;
begin
  inherited;
  FInt := 1798 * 3;
  FTest := 'Value: ' + Random(217982).ToString + Random(179800).ToString;
end;

procedure TForm1798.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1798;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1798_List0 := TMyObj1798_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1798_List1 := TMyObj1798_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
