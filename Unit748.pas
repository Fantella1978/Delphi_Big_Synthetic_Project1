...
type
  ...
  TMyObj748_List0 = TObjectList<TMyObj748>;

  TMyObj748_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj748_List1 = TObjectList<TMyObj748_1>;
...
constructor TMyObj748_1.Create;
begin
  inherited;
  FInt := 748 * 3;
  FTest := 'Value: ' + Random(27482).ToString + Random(74800).ToString;
end;

procedure TForm748.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum748;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj748_List0 := TMyObj748_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj748_List1 := TMyObj748_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
