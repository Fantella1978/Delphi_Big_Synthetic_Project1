...
type
  ...
  TMyObj2447_List0 = TObjectList<TMyObj2447>;

  TMyObj2447_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2447_List1 = TObjectList<TMyObj2447_1>;
...
constructor TMyObj2447_1.Create;
begin
  inherited;
  FInt := 2447 * 3;
  FTest := 'Value: ' + Random(224472).ToString + Random(244700).ToString;
end;

procedure TForm2447.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2447;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2447_List0 := TMyObj2447_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2447_List1 := TMyObj2447_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
