...
type
  ...
  TMyObj780_List0 = TObjectList<TMyObj780>;

  TMyObj780_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj780_List1 = TObjectList<TMyObj780_1>;
...
constructor TMyObj780_1.Create;
begin
  inherited;
  FInt := 780 * 3;
  FTest := 'Value: ' + Random(27802).ToString + Random(78000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj780_List0 := TMyObj780_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj780_List1 := TMyObj780_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
