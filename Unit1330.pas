...
type
  ...
  TMyObj1330_List0 = TObjectList<TMyObj1330>;

  TMyObj1330_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1330_List1 = TObjectList<TMyObj1330_1>;
...
constructor TMyObj1330_1.Create;
begin
  inherited;
  FInt := 1330 * 3;
  FTest := 'Value: ' + Random(213302).ToString + Random(133000).ToString;
end;

procedure TForm1330.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1330;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1330_List0 := TMyObj1330_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1330_List1 := TMyObj1330_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
