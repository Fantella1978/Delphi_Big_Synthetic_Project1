...
type
  ...
  TMyObj25_List0 = TObjectList<TMyObj25>;

  TMyObj25_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj25_List1 = TObjectList<TMyObj25_1>;
...
constructor TMyObj25_1.Create;
begin
  inherited;
  FInt := 25 * 3;
  FTest := 'Value: ' + Random(2252).ToString + Random(2500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj25_List0 := TMyObj25_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj25_List1 := TMyObj25_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
