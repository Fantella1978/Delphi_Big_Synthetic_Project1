...
type
  ...
  TMyObj1271_List0 = TObjectList<TMyObj1271>;

  TMyObj1271_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1271_List1 = TObjectList<TMyObj1271_1>;
...
constructor TMyObj1271_1.Create;
begin
  inherited;
  FInt := 1271 * 3;
  FTest := 'Value: ' + Random(212712).ToString + Random(127100).ToString;
end;

procedure TForm1271.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1271;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1271_List0 := TMyObj1271_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1271_List1 := TMyObj1271_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
