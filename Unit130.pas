...
type
  ...
  TMyObj130_List0 = TObjectList<TMyObj130>;

  TMyObj130_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj130_List1 = TObjectList<TMyObj130_1>;
...
constructor TMyObj130_1.Create;
begin
  inherited;
  FInt := 130 * 3;
  FTest := 'Value: ' + Random(21302).ToString + Random(13000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj130_List0 := TMyObj130_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj130_List1 := TMyObj130_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
