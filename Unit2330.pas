...
type
  ...
  TMyObj2330_List0 = TObjectList<TMyObj2330>;

  TMyObj2330_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2330_List1 = TObjectList<TMyObj2330_1>;
...
constructor TMyObj2330_1.Create;
begin
  inherited;
  FInt := 2330 * 3;
  FTest := 'Value: ' + Random(223302).ToString + Random(233000).ToString;
end;

procedure TForm2330.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2330;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2330_List0 := TMyObj2330_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2330_List1 := TMyObj2330_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
