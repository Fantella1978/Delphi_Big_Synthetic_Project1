...
type
  ...
  TMyObj2042_List0 = TObjectList<TMyObj2042>;

  TMyObj2042_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2042_List1 = TObjectList<TMyObj2042_1>;
...
constructor TMyObj2042_1.Create;
begin
  inherited;
  FInt := 2042 * 3;
  FTest := 'Value: ' + Random(220422).ToString + Random(204200).ToString;
end;

procedure TForm2042.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2042;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2042_List0 := TMyObj2042_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2042_List1 := TMyObj2042_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
