...
type
  ...
  TMyObj97_List0 = TObjectList<TMyObj97>;

  TMyObj97_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj97_List1 = TObjectList<TMyObj97_1>;
...
constructor TMyObj97_1.Create;
begin
  inherited;
  FInt := 97 * 3;
  FTest := 'Value: ' + Random(2972).ToString + Random(9700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj97_List0 := TMyObj97_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj97_List1 := TMyObj97_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
