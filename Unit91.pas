...
type
  ...
  TMyObj91_List0 = TObjectList<TMyObj91>;

  TMyObj91_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj91_List1 = TObjectList<TMyObj91_1>;
...
constructor TMyObj91_1.Create;
begin
  inherited;
  FInt := 91 * 3;
  FTest := 'Value: ' + Random(2912).ToString + Random(9100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj91_List0 := TMyObj91_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj91_List1 := TMyObj91_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
