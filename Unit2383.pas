...
type
  ...
  TMyObj2383_List0 = TObjectList<TMyObj2383>;

  TMyObj2383_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2383_List1 = TObjectList<TMyObj2383_1>;
...
constructor TMyObj2383_1.Create;
begin
  inherited;
  FInt := 2383 * 3;
  FTest := 'Value: ' + Random(223832).ToString + Random(238300).ToString;
end;

procedure TForm2383.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2383;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2383_List0 := TMyObj2383_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2383_List1 := TMyObj2383_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
