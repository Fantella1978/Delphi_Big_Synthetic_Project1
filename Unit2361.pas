...
type
  ...
  TMyObj2361_List0 = TObjectList<TMyObj2361>;

  TMyObj2361_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2361_List1 = TObjectList<TMyObj2361_1>;
...
constructor TMyObj2361_1.Create;
begin
  inherited;
  FInt := 2361 * 3;
  FTest := 'Value: ' + Random(223612).ToString + Random(236100).ToString;
end;

procedure TForm2361.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2361;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2361_List0 := TMyObj2361_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2361_List1 := TMyObj2361_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
