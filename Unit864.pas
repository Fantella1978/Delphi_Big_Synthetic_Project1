...
type
  ...
  TMyObj864_List0 = TObjectList<TMyObj864>;

  TMyObj864_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj864_List1 = TObjectList<TMyObj864_1>;
...
constructor TMyObj864_1.Create;
begin
  inherited;
  FInt := 864 * 3;
  FTest := 'Value: ' + Random(28642).ToString + Random(86400).ToString;
end;

procedure TForm864.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum864;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj864_List0 := TMyObj864_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj864_List1 := TMyObj864_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
