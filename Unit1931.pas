...
type
  ...
  TMyObj1931_List0 = TObjectList<TMyObj1931>;

  TMyObj1931_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1931_List1 = TObjectList<TMyObj1931_1>;
...
constructor TMyObj1931_1.Create;
begin
  inherited;
  FInt := 1931 * 3;
  FTest := 'Value: ' + Random(219312).ToString + Random(193100).ToString;
end;

procedure TForm1931.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1931;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1931_List0 := TMyObj1931_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1931_List1 := TMyObj1931_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
