...
type
  ...
  TMyObj614_List0 = TObjectList<TMyObj614>;

  TMyObj614_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj614_List1 = TObjectList<TMyObj614_1>;
...
constructor TMyObj614_1.Create;
begin
  inherited;
  FInt := 614 * 3;
  FTest := 'Value: ' + Random(26142).ToString + Random(61400).ToString;
end;

procedure TForm614.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum614;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj614_List0 := TMyObj614_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj614_List1 := TMyObj614_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
