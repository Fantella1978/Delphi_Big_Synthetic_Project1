...
type
  ...
  TMyObj1934_List0 = TObjectList<TMyObj1934>;

  TMyObj1934_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1934_List1 = TObjectList<TMyObj1934_1>;
...
constructor TMyObj1934_1.Create;
begin
  inherited;
  FInt := 1934 * 3;
  FTest := 'Value: ' + Random(219342).ToString + Random(193400).ToString;
end;

procedure TForm1934.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1934;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1934_List0 := TMyObj1934_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1934_List1 := TMyObj1934_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
