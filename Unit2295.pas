...
type
  ...
  TMyObj2295_List0 = TObjectList<TMyObj2295>;

  TMyObj2295_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2295_List1 = TObjectList<TMyObj2295_1>;
...
constructor TMyObj2295_1.Create;
begin
  inherited;
  FInt := 2295 * 3;
  FTest := 'Value: ' + Random(222952).ToString + Random(229500).ToString;
end;

procedure TForm2295.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2295;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2295_List0 := TMyObj2295_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2295_List1 := TMyObj2295_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
