...
type
  ...
  TMyObj2225_List0 = TObjectList<TMyObj2225>;

  TMyObj2225_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2225_List1 = TObjectList<TMyObj2225_1>;
...
constructor TMyObj2225_1.Create;
begin
  inherited;
  FInt := 2225 * 3;
  FTest := 'Value: ' + Random(222252).ToString + Random(222500).ToString;
end;

procedure TForm2225.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2225;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2225_List0 := TMyObj2225_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2225_List1 := TMyObj2225_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
