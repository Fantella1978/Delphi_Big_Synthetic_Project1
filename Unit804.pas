...
type
  ...
  TMyObj804_List0 = TObjectList<TMyObj804>;

  TMyObj804_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj804_List1 = TObjectList<TMyObj804_1>;
...
constructor TMyObj804_1.Create;
begin
  inherited;
  FInt := 804 * 3;
  FTest := 'Value: ' + Random(28042).ToString + Random(80400).ToString;
end;

procedure TForm804.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum804;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj804_List0 := TMyObj804_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj804_List1 := TMyObj804_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
