...
type
  ...
  TMyObj2117_List0 = TObjectList<TMyObj2117>;

  TMyObj2117_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2117_List1 = TObjectList<TMyObj2117_1>;
...
constructor TMyObj2117_1.Create;
begin
  inherited;
  FInt := 2117 * 3;
  FTest := 'Value: ' + Random(221172).ToString + Random(211700).ToString;
end;

procedure TForm2117.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2117;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2117_List0 := TMyObj2117_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2117_List1 := TMyObj2117_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
