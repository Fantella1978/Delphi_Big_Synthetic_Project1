...
type
  ...
  TMyObj1356_List0 = TObjectList<TMyObj1356>;

  TMyObj1356_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1356_List1 = TObjectList<TMyObj1356_1>;
...
constructor TMyObj1356_1.Create;
begin
  inherited;
  FInt := 1356 * 3;
  FTest := 'Value: ' + Random(213562).ToString + Random(135600).ToString;
end;

procedure TForm1356.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1356;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1356_List0 := TMyObj1356_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1356_List1 := TMyObj1356_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
