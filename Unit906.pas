...
type
  ...
  TMyObj906_List0 = TObjectList<TMyObj906>;

  TMyObj906_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj906_List1 = TObjectList<TMyObj906_1>;
...
constructor TMyObj906_1.Create;
begin
  inherited;
  FInt := 906 * 3;
  FTest := 'Value: ' + Random(29062).ToString + Random(90600).ToString;
end;

procedure TForm906.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum906;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj906_List0 := TMyObj906_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj906_List1 := TMyObj906_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
