...
type
  ...
  TMyObj1439_List0 = TObjectList<TMyObj1439>;

  TMyObj1439_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1439_List1 = TObjectList<TMyObj1439_1>;
...
constructor TMyObj1439_1.Create;
begin
  inherited;
  FInt := 1439 * 3;
  FTest := 'Value: ' + Random(214392).ToString + Random(143900).ToString;
end;

procedure TForm1439.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1439;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1439_List0 := TMyObj1439_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1439_List1 := TMyObj1439_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
