...
type
  ...
  TMyObj1504_List0 = TObjectList<TMyObj1504>;

  TMyObj1504_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1504_List1 = TObjectList<TMyObj1504_1>;
...
constructor TMyObj1504_1.Create;
begin
  inherited;
  FInt := 1504 * 3;
  FTest := 'Value: ' + Random(215042).ToString + Random(150400).ToString;
end;

procedure TForm1504.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1504;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1504_List0 := TMyObj1504_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1504_List1 := TMyObj1504_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
