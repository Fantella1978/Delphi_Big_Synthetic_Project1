...
type
  ...
  TMyObj1790_List0 = TObjectList<TMyObj1790>;

  TMyObj1790_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1790_List1 = TObjectList<TMyObj1790_1>;
...
constructor TMyObj1790_1.Create;
begin
  inherited;
  FInt := 1790 * 3;
  FTest := 'Value: ' + Random(217902).ToString + Random(179000).ToString;
end;

procedure TForm1790.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1790;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1790_List0 := TMyObj1790_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1790_List1 := TMyObj1790_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
