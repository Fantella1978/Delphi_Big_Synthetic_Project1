...
type
  ...
  TMyObj1528_List0 = TObjectList<TMyObj1528>;

  TMyObj1528_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1528_List1 = TObjectList<TMyObj1528_1>;
...
constructor TMyObj1528_1.Create;
begin
  inherited;
  FInt := 1528 * 3;
  FTest := 'Value: ' + Random(215282).ToString + Random(152800).ToString;
end;

procedure TForm1528.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1528;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1528_List0 := TMyObj1528_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1528_List1 := TMyObj1528_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
