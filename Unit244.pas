...
type
  ...
  TMyObj244_List0 = TObjectList<TMyObj244>;

  TMyObj244_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj244_List1 = TObjectList<TMyObj244_1>;
...
constructor TMyObj244_1.Create;
begin
  inherited;
  FInt := 244 * 3;
  FTest := 'Value: ' + Random(22442).ToString + Random(24400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj244_List0 := TMyObj244_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj244_List1 := TMyObj244_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
