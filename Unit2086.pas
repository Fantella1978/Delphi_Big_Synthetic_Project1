...
type
  ...
  TMyObj2086_List0 = TObjectList<TMyObj2086>;

  TMyObj2086_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2086_List1 = TObjectList<TMyObj2086_1>;
...
constructor TMyObj2086_1.Create;
begin
  inherited;
  FInt := 2086 * 3;
  FTest := 'Value: ' + Random(220862).ToString + Random(208600).ToString;
end;

procedure TForm2086.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2086;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2086_List0 := TMyObj2086_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2086_List1 := TMyObj2086_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
