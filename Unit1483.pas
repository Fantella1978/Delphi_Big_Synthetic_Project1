...
type
  ...
  TMyObj1483_List0 = TObjectList<TMyObj1483>;

  TMyObj1483_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1483_List1 = TObjectList<TMyObj1483_1>;
...
constructor TMyObj1483_1.Create;
begin
  inherited;
  FInt := 1483 * 3;
  FTest := 'Value: ' + Random(214832).ToString + Random(148300).ToString;
end;

procedure TForm1483.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1483;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1483_List0 := TMyObj1483_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1483_List1 := TMyObj1483_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
