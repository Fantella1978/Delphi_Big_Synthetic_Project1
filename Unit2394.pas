...
type
  ...
  TMyObj2394_List0 = TObjectList<TMyObj2394>;

  TMyObj2394_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2394_List1 = TObjectList<TMyObj2394_1>;
...
constructor TMyObj2394_1.Create;
begin
  inherited;
  FInt := 2394 * 3;
  FTest := 'Value: ' + Random(223942).ToString + Random(239400).ToString;
end;

procedure TForm2394.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2394;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2394_List0 := TMyObj2394_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2394_List1 := TMyObj2394_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
