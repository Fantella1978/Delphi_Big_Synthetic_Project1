...
type
  ...
  TMyObj1126_List0 = TObjectList<TMyObj1126>;

  TMyObj1126_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1126_List1 = TObjectList<TMyObj1126_1>;
...
constructor TMyObj1126_1.Create;
begin
  inherited;
  FInt := 1126 * 3;
  FTest := 'Value: ' + Random(211262).ToString + Random(112600).ToString;
end;

procedure TForm1126.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1126;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1126_List0 := TMyObj1126_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1126_List1 := TMyObj1126_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
