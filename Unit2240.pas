...
type
  ...
  TMyObj2240_List0 = TObjectList<TMyObj2240>;

  TMyObj2240_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2240_List1 = TObjectList<TMyObj2240_1>;
...
constructor TMyObj2240_1.Create;
begin
  inherited;
  FInt := 2240 * 3;
  FTest := 'Value: ' + Random(222402).ToString + Random(224000).ToString;
end;

procedure TForm2240.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2240;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2240_List0 := TMyObj2240_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2240_List1 := TMyObj2240_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
