...
type
  ...
  TMyObj914_List0 = TObjectList<TMyObj914>;

  TMyObj914_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj914_List1 = TObjectList<TMyObj914_1>;
...
constructor TMyObj914_1.Create;
begin
  inherited;
  FInt := 914 * 3;
  FTest := 'Value: ' + Random(29142).ToString + Random(91400).ToString;
end;

procedure TForm914.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum914;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj914_List0 := TMyObj914_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj914_List1 := TMyObj914_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
