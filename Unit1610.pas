...
type
  ...
  TMyObj1610_List0 = TObjectList<TMyObj1610>;

  TMyObj1610_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1610_List1 = TObjectList<TMyObj1610_1>;
...
constructor TMyObj1610_1.Create;
begin
  inherited;
  FInt := 1610 * 3;
  FTest := 'Value: ' + Random(216102).ToString + Random(161000).ToString;
end;

procedure TForm1610.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1610;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1610_List0 := TMyObj1610_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1610_List1 := TMyObj1610_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
