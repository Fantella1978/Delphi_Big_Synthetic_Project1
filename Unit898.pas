...
type
  ...
  TMyObj898_List0 = TObjectList<TMyObj898>;

  TMyObj898_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj898_List1 = TObjectList<TMyObj898_1>;
...
constructor TMyObj898_1.Create;
begin
  inherited;
  FInt := 898 * 3;
  FTest := 'Value: ' + Random(28982).ToString + Random(89800).ToString;
end;

procedure TForm898.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum898;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj898_List0 := TMyObj898_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj898_List1 := TMyObj898_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
