...
type
  ...
  TMyObj536_List0 = TObjectList<TMyObj536>;

  TMyObj536_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj536_List1 = TObjectList<TMyObj536_1>;
...
constructor TMyObj536_1.Create;
begin
  inherited;
  FInt := 536 * 3;
  FTest := 'Value: ' + Random(25362).ToString + Random(53600).ToString;
end;

procedure TForm536.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum536;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj536_List0 := TMyObj536_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj536_List1 := TMyObj536_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
