...
type
  ...
  TMyObj2097_List0 = TObjectList<TMyObj2097>;

  TMyObj2097_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2097_List1 = TObjectList<TMyObj2097_1>;
...
constructor TMyObj2097_1.Create;
begin
  inherited;
  FInt := 2097 * 3;
  FTest := 'Value: ' + Random(220972).ToString + Random(209700).ToString;
end;

procedure TForm2097.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2097;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2097_List0 := TMyObj2097_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2097_List1 := TMyObj2097_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
