...
type
  ...
  TMyObj1645_List0 = TObjectList<TMyObj1645>;

  TMyObj1645_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1645_List1 = TObjectList<TMyObj1645_1>;
...
constructor TMyObj1645_1.Create;
begin
  inherited;
  FInt := 1645 * 3;
  FTest := 'Value: ' + Random(216452).ToString + Random(164500).ToString;
end;

procedure TForm1645.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1645;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1645_List0 := TMyObj1645_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1645_List1 := TMyObj1645_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
