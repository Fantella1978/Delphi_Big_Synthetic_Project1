...
type
  ...
  TMyObj1849_List0 = TObjectList<TMyObj1849>;

  TMyObj1849_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1849_List1 = TObjectList<TMyObj1849_1>;
...
constructor TMyObj1849_1.Create;
begin
  inherited;
  FInt := 1849 * 3;
  FTest := 'Value: ' + Random(218492).ToString + Random(184900).ToString;
end;

procedure TForm1849.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1849;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1849_List0 := TMyObj1849_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1849_List1 := TMyObj1849_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
