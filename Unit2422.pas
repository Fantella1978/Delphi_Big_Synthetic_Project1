...
type
  ...
  TMyObj2422_List0 = TObjectList<TMyObj2422>;

  TMyObj2422_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2422_List1 = TObjectList<TMyObj2422_1>;
...
constructor TMyObj2422_1.Create;
begin
  inherited;
  FInt := 2422 * 3;
  FTest := 'Value: ' + Random(224222).ToString + Random(242200).ToString;
end;

procedure TForm2422.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2422;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2422_List0 := TMyObj2422_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2422_List1 := TMyObj2422_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
