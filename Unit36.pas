...
type
  ...
  TMyObj36_List0 = TObjectList<TMyObj36>;

  TMyObj36_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj36_List1 = TObjectList<TMyObj36_1>;
...
constructor TMyObj36_1.Create;
begin
  inherited;
  FInt := 36 * 3;
  FTest := 'Value: ' + Random(2362).ToString + Random(3600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj36_List0 := TMyObj36_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj36_List1 := TMyObj36_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
