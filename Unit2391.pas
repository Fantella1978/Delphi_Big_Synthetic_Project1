...
type
  ...
  TMyObj2391_List0 = TObjectList<TMyObj2391>;

  TMyObj2391_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2391_List1 = TObjectList<TMyObj2391_1>;
...
constructor TMyObj2391_1.Create;
begin
  inherited;
  FInt := 2391 * 3;
  FTest := 'Value: ' + Random(223912).ToString + Random(239100).ToString;
end;

procedure TForm2391.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2391;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2391_List0 := TMyObj2391_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2391_List1 := TMyObj2391_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
