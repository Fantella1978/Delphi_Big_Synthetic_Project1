...
type
  ...
  TMyObj967_List0 = TObjectList<TMyObj967>;

  TMyObj967_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj967_List1 = TObjectList<TMyObj967_1>;
...
constructor TMyObj967_1.Create;
begin
  inherited;
  FInt := 967 * 3;
  FTest := 'Value: ' + Random(29672).ToString + Random(96700).ToString;
end;

procedure TForm967.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum967;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj967_List0 := TMyObj967_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj967_List1 := TMyObj967_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
