...
type
  ...
  TMyObj52_List0 = TObjectList<TMyObj52>;

  TMyObj52_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj52_List1 = TObjectList<TMyObj52_1>;
...
constructor TMyObj52_1.Create;
begin
  inherited;
  FInt := 52 * 3;
  FTest := 'Value: ' + Random(2522).ToString + Random(5200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj52_List0 := TMyObj52_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj52_List1 := TMyObj52_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
