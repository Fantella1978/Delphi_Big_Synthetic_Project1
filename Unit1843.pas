...
type
  ...
  TMyObj1843_List0 = TObjectList<TMyObj1843>;

  TMyObj1843_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1843_List1 = TObjectList<TMyObj1843_1>;
...
constructor TMyObj1843_1.Create;
begin
  inherited;
  FInt := 1843 * 3;
  FTest := 'Value: ' + Random(218432).ToString + Random(184300).ToString;
end;

procedure TForm1843.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1843;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1843_List0 := TMyObj1843_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1843_List1 := TMyObj1843_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
