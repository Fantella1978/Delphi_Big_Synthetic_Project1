...
type
  ...
  TMyObj150_List0 = TObjectList<TMyObj150>;

  TMyObj150_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj150_List1 = TObjectList<TMyObj150_1>;
...
constructor TMyObj150_1.Create;
begin
  inherited;
  FInt := 150 * 3;
  FTest := 'Value: ' + Random(21502).ToString + Random(15000).ToString;
end;

procedure TForm150.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum150;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj150_List0 := TMyObj150_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj150_List1 := TMyObj150_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
