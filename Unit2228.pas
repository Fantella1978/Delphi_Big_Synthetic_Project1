...
type
  ...
  TMyObj2228_List0 = TObjectList<TMyObj2228>;

  TMyObj2228_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2228_List1 = TObjectList<TMyObj2228_1>;
...
constructor TMyObj2228_1.Create;
begin
  inherited;
  FInt := 2228 * 3;
  FTest := 'Value: ' + Random(222282).ToString + Random(222800).ToString;
end;

procedure TForm2228.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2228;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2228_List0 := TMyObj2228_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2228_List1 := TMyObj2228_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
