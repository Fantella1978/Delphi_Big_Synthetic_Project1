...
type
  ...
  TMyObj419_List0 = TObjectList<TMyObj419>;

  TMyObj419_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj419_List1 = TObjectList<TMyObj419_1>;
...
constructor TMyObj419_1.Create;
begin
  inherited;
  FInt := 419 * 3;
  FTest := 'Value: ' + Random(24192).ToString + Random(41900).ToString;
end;

procedure TForm419.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum419;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj419_List0 := TMyObj419_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj419_List1 := TMyObj419_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
