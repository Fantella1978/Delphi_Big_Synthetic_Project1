...
type
  ...
  TMyObj704_List0 = TObjectList<TMyObj704>;

  TMyObj704_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj704_List1 = TObjectList<TMyObj704_1>;
...
constructor TMyObj704_1.Create;
begin
  inherited;
  FInt := 704 * 3;
  FTest := 'Value: ' + Random(27042).ToString + Random(70400).ToString;
end;

procedure TForm704.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum704;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj704_List0 := TMyObj704_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj704_List1 := TMyObj704_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
