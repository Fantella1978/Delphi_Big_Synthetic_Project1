...
type
  ...
  TMyObj142_List0 = TObjectList<TMyObj142>;

  TMyObj142_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj142_List1 = TObjectList<TMyObj142_1>;
...
constructor TMyObj142_1.Create;
begin
  inherited;
  FInt := 142 * 3;
  FTest := 'Value: ' + Random(21422).ToString + Random(14200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj142_List0 := TMyObj142_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj142_List1 := TMyObj142_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
