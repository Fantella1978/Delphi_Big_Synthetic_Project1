...
type
  ...
  TMyObj501_List0 = TObjectList<TMyObj501>;

  TMyObj501_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj501_List1 = TObjectList<TMyObj501_1>;
...
constructor TMyObj501_1.Create;
begin
  inherited;
  FInt := 501 * 3;
  FTest := 'Value: ' + Random(25012).ToString + Random(50100).ToString;
end;

procedure TForm501.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum501;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj501_List0 := TMyObj501_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj501_List1 := TMyObj501_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
