...
type
  ...
  TMyObj712_List0 = TObjectList<TMyObj712>;

  TMyObj712_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj712_List1 = TObjectList<TMyObj712_1>;
...
constructor TMyObj712_1.Create;
begin
  inherited;
  FInt := 712 * 3;
  FTest := 'Value: ' + Random(27122).ToString + Random(71200).ToString;
end;

procedure TForm712.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum712;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj712_List0 := TMyObj712_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj712_List1 := TMyObj712_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
