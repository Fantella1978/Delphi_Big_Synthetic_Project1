...
type
  ...
  TMyObj1655_List0 = TObjectList<TMyObj1655>;

  TMyObj1655_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1655_List1 = TObjectList<TMyObj1655_1>;
...
constructor TMyObj1655_1.Create;
begin
  inherited;
  FInt := 1655 * 3;
  FTest := 'Value: ' + Random(216552).ToString + Random(165500).ToString;
end;

procedure TForm1655.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1655;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1655_List0 := TMyObj1655_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1655_List1 := TMyObj1655_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
