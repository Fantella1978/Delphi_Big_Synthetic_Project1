...
type
  ...
  TMyObj744_List0 = TObjectList<TMyObj744>;

  TMyObj744_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj744_List1 = TObjectList<TMyObj744_1>;
...
constructor TMyObj744_1.Create;
begin
  inherited;
  FInt := 744 * 3;
  FTest := 'Value: ' + Random(27442).ToString + Random(74400).ToString;
end;

procedure TForm744.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum744;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj744_List0 := TMyObj744_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj744_List1 := TMyObj744_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
