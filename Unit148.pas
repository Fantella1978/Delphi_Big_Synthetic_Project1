...
type
  ...
  TMyObj148_List0 = TObjectList<TMyObj148>;

  TMyObj148_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj148_List1 = TObjectList<TMyObj148_1>;
...
constructor TMyObj148_1.Create;
begin
  inherited;
  FInt := 148 * 3;
  FTest := 'Value: ' + Random(21482).ToString + Random(14800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj148_List0 := TMyObj148_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj148_List1 := TMyObj148_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
