...
type
  ...
  TMyObj647_List0 = TObjectList<TMyObj647>;

  TMyObj647_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj647_List1 = TObjectList<TMyObj647_1>;
...
constructor TMyObj647_1.Create;
begin
  inherited;
  FInt := 647 * 3;
  FTest := 'Value: ' + Random(26472).ToString + Random(64700).ToString;
end;

procedure TForm647.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum647;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj647_List0 := TMyObj647_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj647_List1 := TMyObj647_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
