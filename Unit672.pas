...
type
  ...
  TMyObj672_List0 = TObjectList<TMyObj672>;

  TMyObj672_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj672_List1 = TObjectList<TMyObj672_1>;
...
constructor TMyObj672_1.Create;
begin
  inherited;
  FInt := 672 * 3;
  FTest := 'Value: ' + Random(26722).ToString + Random(67200).ToString;
end;

procedure TForm672.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum672;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj672_List0 := TMyObj672_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj672_List1 := TMyObj672_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
