...
type
  ...
  TMyObj1346_List0 = TObjectList<TMyObj1346>;

  TMyObj1346_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1346_List1 = TObjectList<TMyObj1346_1>;
...
constructor TMyObj1346_1.Create;
begin
  inherited;
  FInt := 1346 * 3;
  FTest := 'Value: ' + Random(213462).ToString + Random(134600).ToString;
end;

procedure TForm1346.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1346;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1346_List0 := TMyObj1346_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1346_List1 := TMyObj1346_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
