...
type
  ...
  TMyObj2078_List0 = TObjectList<TMyObj2078>;

  TMyObj2078_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2078_List1 = TObjectList<TMyObj2078_1>;
...
constructor TMyObj2078_1.Create;
begin
  inherited;
  FInt := 2078 * 3;
  FTest := 'Value: ' + Random(220782).ToString + Random(207800).ToString;
end;

procedure TForm2078.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2078;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2078_List0 := TMyObj2078_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2078_List1 := TMyObj2078_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
