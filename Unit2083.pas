...
type
  ...
  TMyObj2083_List0 = TObjectList<TMyObj2083>;

  TMyObj2083_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2083_List1 = TObjectList<TMyObj2083_1>;
...
constructor TMyObj2083_1.Create;
begin
  inherited;
  FInt := 2083 * 3;
  FTest := 'Value: ' + Random(220832).ToString + Random(208300).ToString;
end;

procedure TForm2083.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2083;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2083_List0 := TMyObj2083_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2083_List1 := TMyObj2083_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
