...
type
  ...
  TMyObj1238_List0 = TObjectList<TMyObj1238>;

  TMyObj1238_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1238_List1 = TObjectList<TMyObj1238_1>;
...
constructor TMyObj1238_1.Create;
begin
  inherited;
  FInt := 1238 * 3;
  FTest := 'Value: ' + Random(212382).ToString + Random(123800).ToString;
end;

procedure TForm1238.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1238;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1238_List0 := TMyObj1238_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1238_List1 := TMyObj1238_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
