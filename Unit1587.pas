...
type
  ...
  TMyObj1587_List0 = TObjectList<TMyObj1587>;

  TMyObj1587_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1587_List1 = TObjectList<TMyObj1587_1>;
...
constructor TMyObj1587_1.Create;
begin
  inherited;
  FInt := 1587 * 3;
  FTest := 'Value: ' + Random(215872).ToString + Random(158700).ToString;
end;

procedure TForm1587.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1587;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1587_List0 := TMyObj1587_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1587_List1 := TMyObj1587_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
