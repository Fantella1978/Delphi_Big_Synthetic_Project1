...
type
  ...
  TMyObj2118_List0 = TObjectList<TMyObj2118>;

  TMyObj2118_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2118_List1 = TObjectList<TMyObj2118_1>;
...
constructor TMyObj2118_1.Create;
begin
  inherited;
  FInt := 2118 * 3;
  FTest := 'Value: ' + Random(221182).ToString + Random(211800).ToString;
end;

procedure TForm2118.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2118;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2118_List0 := TMyObj2118_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2118_List1 := TMyObj2118_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
