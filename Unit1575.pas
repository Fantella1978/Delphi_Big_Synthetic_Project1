...
type
  ...
  TMyObj1575_List0 = TObjectList<TMyObj1575>;

  TMyObj1575_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1575_List1 = TObjectList<TMyObj1575_1>;
...
constructor TMyObj1575_1.Create;
begin
  inherited;
  FInt := 1575 * 3;
  FTest := 'Value: ' + Random(215752).ToString + Random(157500).ToString;
end;

procedure TForm1575.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1575;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1575_List0 := TMyObj1575_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1575_List1 := TMyObj1575_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
