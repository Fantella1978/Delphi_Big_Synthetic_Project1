...
type
  ...
  TMyObj1125_List0 = TObjectList<TMyObj1125>;

  TMyObj1125_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1125_List1 = TObjectList<TMyObj1125_1>;
...
constructor TMyObj1125_1.Create;
begin
  inherited;
  FInt := 1125 * 3;
  FTest := 'Value: ' + Random(211252).ToString + Random(112500).ToString;
end;

procedure TForm1125.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1125;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1125_List0 := TMyObj1125_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1125_List1 := TMyObj1125_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
