...
type
  ...
  TMyObj2142_List0 = TObjectList<TMyObj2142>;

  TMyObj2142_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2142_List1 = TObjectList<TMyObj2142_1>;
...
constructor TMyObj2142_1.Create;
begin
  inherited;
  FInt := 2142 * 3;
  FTest := 'Value: ' + Random(221422).ToString + Random(214200).ToString;
end;

procedure TForm2142.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2142;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2142_List0 := TMyObj2142_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2142_List1 := TMyObj2142_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
