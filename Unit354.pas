...
type
  ...
  TMyObj354_List0 = TObjectList<TMyObj354>;

  TMyObj354_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj354_List1 = TObjectList<TMyObj354_1>;
...
constructor TMyObj354_1.Create;
begin
  inherited;
  FInt := 354 * 3;
  FTest := 'Value: ' + Random(23542).ToString + Random(35400).ToString;
end;

procedure TForm354.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum354;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj354_List0 := TMyObj354_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj354_List1 := TMyObj354_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
