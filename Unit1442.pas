...
type
  ...
  TMyObj1442_List0 = TObjectList<TMyObj1442>;

  TMyObj1442_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1442_List1 = TObjectList<TMyObj1442_1>;
...
constructor TMyObj1442_1.Create;
begin
  inherited;
  FInt := 1442 * 3;
  FTest := 'Value: ' + Random(214422).ToString + Random(144200).ToString;
end;

procedure TForm1442.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1442;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1442_List0 := TMyObj1442_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1442_List1 := TMyObj1442_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
