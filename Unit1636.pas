...
type
  ...
  TMyObj1636_List0 = TObjectList<TMyObj1636>;

  TMyObj1636_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1636_List1 = TObjectList<TMyObj1636_1>;
...
constructor TMyObj1636_1.Create;
begin
  inherited;
  FInt := 1636 * 3;
  FTest := 'Value: ' + Random(216362).ToString + Random(163600).ToString;
end;

procedure TForm1636.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1636;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1636_List0 := TMyObj1636_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1636_List1 := TMyObj1636_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
