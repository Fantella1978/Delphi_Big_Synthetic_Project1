...
type
  ...
  TMyObj434_List0 = TObjectList<TMyObj434>;

  TMyObj434_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj434_List1 = TObjectList<TMyObj434_1>;
...
constructor TMyObj434_1.Create;
begin
  inherited;
  FInt := 434 * 3;
  FTest := 'Value: ' + Random(24342).ToString + Random(43400).ToString;
end;

procedure TForm434.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum434;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj434_List0 := TMyObj434_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj434_List1 := TMyObj434_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
