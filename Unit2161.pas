...
type
  ...
  TMyObj2161_List0 = TObjectList<TMyObj2161>;

  TMyObj2161_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2161_List1 = TObjectList<TMyObj2161_1>;
...
constructor TMyObj2161_1.Create;
begin
  inherited;
  FInt := 2161 * 3;
  FTest := 'Value: ' + Random(221612).ToString + Random(216100).ToString;
end;

procedure TForm2161.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2161;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2161_List0 := TMyObj2161_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2161_List1 := TMyObj2161_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
