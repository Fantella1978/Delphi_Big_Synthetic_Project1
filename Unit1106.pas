...
type
  ...
  TMyObj1106_List0 = TObjectList<TMyObj1106>;

  TMyObj1106_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1106_List1 = TObjectList<TMyObj1106_1>;
...
constructor TMyObj1106_1.Create;
begin
  inherited;
  FInt := 1106 * 3;
  FTest := 'Value: ' + Random(211062).ToString + Random(110600).ToString;
end;

procedure TForm1106.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1106;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1106_List0 := TMyObj1106_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1106_List1 := TMyObj1106_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
