...
type
  ...
  TMyObj1789_List0 = TObjectList<TMyObj1789>;

  TMyObj1789_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1789_List1 = TObjectList<TMyObj1789_1>;
...
constructor TMyObj1789_1.Create;
begin
  inherited;
  FInt := 1789 * 3;
  FTest := 'Value: ' + Random(217892).ToString + Random(178900).ToString;
end;

procedure TForm1789.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1789;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1789_List0 := TMyObj1789_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1789_List1 := TMyObj1789_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
