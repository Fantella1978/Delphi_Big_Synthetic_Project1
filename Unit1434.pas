...
type
  ...
  TMyObj1434_List0 = TObjectList<TMyObj1434>;

  TMyObj1434_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1434_List1 = TObjectList<TMyObj1434_1>;
...
constructor TMyObj1434_1.Create;
begin
  inherited;
  FInt := 1434 * 3;
  FTest := 'Value: ' + Random(214342).ToString + Random(143400).ToString;
end;

procedure TForm1434.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1434;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1434_List0 := TMyObj1434_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1434_List1 := TMyObj1434_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
