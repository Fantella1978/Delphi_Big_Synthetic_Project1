...
type
  ...
  TMyObj2085_List0 = TObjectList<TMyObj2085>;

  TMyObj2085_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2085_List1 = TObjectList<TMyObj2085_1>;
...
constructor TMyObj2085_1.Create;
begin
  inherited;
  FInt := 2085 * 3;
  FTest := 'Value: ' + Random(220852).ToString + Random(208500).ToString;
end;

procedure TForm2085.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2085;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2085_List0 := TMyObj2085_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2085_List1 := TMyObj2085_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
