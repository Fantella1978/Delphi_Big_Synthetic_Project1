...
type
  ...
  TMyObj1202_List0 = TObjectList<TMyObj1202>;

  TMyObj1202_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1202_List1 = TObjectList<TMyObj1202_1>;
...
constructor TMyObj1202_1.Create;
begin
  inherited;
  FInt := 1202 * 3;
  FTest := 'Value: ' + Random(212022).ToString + Random(120200).ToString;
end;

procedure TForm1202.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1202;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1202_List0 := TMyObj1202_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1202_List1 := TMyObj1202_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
