...
type
  ...
  TMyObj2152_List0 = TObjectList<TMyObj2152>;

  TMyObj2152_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2152_List1 = TObjectList<TMyObj2152_1>;
...
constructor TMyObj2152_1.Create;
begin
  inherited;
  FInt := 2152 * 3;
  FTest := 'Value: ' + Random(221522).ToString + Random(215200).ToString;
end;

procedure TForm2152.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2152;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2152_List0 := TMyObj2152_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2152_List1 := TMyObj2152_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
