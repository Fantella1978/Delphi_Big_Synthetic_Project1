...
type
  ...
  TMyObj1287_List0 = TObjectList<TMyObj1287>;

  TMyObj1287_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1287_List1 = TObjectList<TMyObj1287_1>;
...
constructor TMyObj1287_1.Create;
begin
  inherited;
  FInt := 1287 * 3;
  FTest := 'Value: ' + Random(212872).ToString + Random(128700).ToString;
end;

procedure TForm1287.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1287;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1287_List0 := TMyObj1287_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1287_List1 := TMyObj1287_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
