...
type
  ...
  TMyObj324_List0 = TObjectList<TMyObj324>;

  TMyObj324_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj324_List1 = TObjectList<TMyObj324_1>;
...
constructor TMyObj324_1.Create;
begin
  inherited;
  FInt := 324 * 3;
  FTest := 'Value: ' + Random(23242).ToString + Random(32400).ToString;
end;

procedure TForm324.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum324;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj324_List0 := TMyObj324_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj324_List1 := TMyObj324_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
