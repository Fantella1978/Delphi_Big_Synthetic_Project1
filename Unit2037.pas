...
type
  ...
  TMyObj2037_List0 = TObjectList<TMyObj2037>;

  TMyObj2037_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2037_List1 = TObjectList<TMyObj2037_1>;
...
constructor TMyObj2037_1.Create;
begin
  inherited;
  FInt := 2037 * 3;
  FTest := 'Value: ' + Random(220372).ToString + Random(203700).ToString;
end;

procedure TForm2037.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2037;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2037_List0 := TMyObj2037_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2037_List1 := TMyObj2037_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
