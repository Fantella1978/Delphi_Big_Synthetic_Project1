...
type
  ...
  TMyObj188_List0 = TObjectList<TMyObj188>;

  TMyObj188_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj188_List1 = TObjectList<TMyObj188_1>;
...
constructor TMyObj188_1.Create;
begin
  inherited;
  FInt := 188 * 3;
  FTest := 'Value: ' + Random(21882).ToString + Random(18800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj188_List0 := TMyObj188_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj188_List1 := TMyObj188_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
