...
type
  ...
  TMyObj1361_List0 = TObjectList<TMyObj1361>;

  TMyObj1361_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1361_List1 = TObjectList<TMyObj1361_1>;
...
constructor TMyObj1361_1.Create;
begin
  inherited;
  FInt := 1361 * 3;
  FTest := 'Value: ' + Random(213612).ToString + Random(136100).ToString;
end;

procedure TForm1361.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1361;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1361_List0 := TMyObj1361_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1361_List1 := TMyObj1361_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
