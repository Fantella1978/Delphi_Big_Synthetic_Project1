...
type
  ...
  TMyObj1865_List0 = TObjectList<TMyObj1865>;

  TMyObj1865_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1865_List1 = TObjectList<TMyObj1865_1>;
...
constructor TMyObj1865_1.Create;
begin
  inherited;
  FInt := 1865 * 3;
  FTest := 'Value: ' + Random(218652).ToString + Random(186500).ToString;
end;

procedure TForm1865.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1865;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1865_List0 := TMyObj1865_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1865_List1 := TMyObj1865_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
