...
type
  ...
  TMyObj2193_List0 = TObjectList<TMyObj2193>;

  TMyObj2193_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2193_List1 = TObjectList<TMyObj2193_1>;
...
constructor TMyObj2193_1.Create;
begin
  inherited;
  FInt := 2193 * 3;
  FTest := 'Value: ' + Random(221932).ToString + Random(219300).ToString;
end;

procedure TForm2193.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2193;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2193_List0 := TMyObj2193_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2193_List1 := TMyObj2193_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
