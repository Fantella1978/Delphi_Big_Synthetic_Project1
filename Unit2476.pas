...
type
  ...
  TMyObj2476_List0 = TObjectList<TMyObj2476>;

  TMyObj2476_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2476_List1 = TObjectList<TMyObj2476_1>;
...
constructor TMyObj2476_1.Create;
begin
  inherited;
  FInt := 2476 * 3;
  FTest := 'Value: ' + Random(224762).ToString + Random(247600).ToString;
end;

procedure TForm2476.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2476;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2476_List0 := TMyObj2476_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2476_List1 := TMyObj2476_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
