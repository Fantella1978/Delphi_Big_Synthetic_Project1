...
type
  ...
  TMyObj1228_List0 = TObjectList<TMyObj1228>;

  TMyObj1228_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1228_List1 = TObjectList<TMyObj1228_1>;
...
constructor TMyObj1228_1.Create;
begin
  inherited;
  FInt := 1228 * 3;
  FTest := 'Value: ' + Random(212282).ToString + Random(122800).ToString;
end;

procedure TForm1228.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1228;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1228_List0 := TMyObj1228_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1228_List1 := TMyObj1228_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
