...
type
  ...
  TMyObj2184_List0 = TObjectList<TMyObj2184>;

  TMyObj2184_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2184_List1 = TObjectList<TMyObj2184_1>;
...
constructor TMyObj2184_1.Create;
begin
  inherited;
  FInt := 2184 * 3;
  FTest := 'Value: ' + Random(221842).ToString + Random(218400).ToString;
end;

procedure TForm2184.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2184;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2184_List0 := TMyObj2184_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2184_List1 := TMyObj2184_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
