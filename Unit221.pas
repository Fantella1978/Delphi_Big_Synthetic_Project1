...
type
  ...
  TMyObj221_List0 = TObjectList<TMyObj221>;

  TMyObj221_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj221_List1 = TObjectList<TMyObj221_1>;
...
constructor TMyObj221_1.Create;
begin
  inherited;
  FInt := 221 * 3;
  FTest := 'Value: ' + Random(22212).ToString + Random(22100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj221_List0 := TMyObj221_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj221_List1 := TMyObj221_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
