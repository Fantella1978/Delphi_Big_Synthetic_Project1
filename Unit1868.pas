...
type
  ...
  TMyObj1868_List0 = TObjectList<TMyObj1868>;

  TMyObj1868_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1868_List1 = TObjectList<TMyObj1868_1>;
...
constructor TMyObj1868_1.Create;
begin
  inherited;
  FInt := 1868 * 3;
  FTest := 'Value: ' + Random(218682).ToString + Random(186800).ToString;
end;

procedure TForm1868.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1868;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1868_List0 := TMyObj1868_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1868_List1 := TMyObj1868_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
