...
type
  ...
  TMyObj428_List0 = TObjectList<TMyObj428>;

  TMyObj428_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj428_List1 = TObjectList<TMyObj428_1>;
...
constructor TMyObj428_1.Create;
begin
  inherited;
  FInt := 428 * 3;
  FTest := 'Value: ' + Random(24282).ToString + Random(42800).ToString;
end;

procedure TForm428.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum428;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj428_List0 := TMyObj428_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj428_List1 := TMyObj428_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
