...
type
  ...
  TMyObj1542_List0 = TObjectList<TMyObj1542>;

  TMyObj1542_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1542_List1 = TObjectList<TMyObj1542_1>;
...
constructor TMyObj1542_1.Create;
begin
  inherited;
  FInt := 1542 * 3;
  FTest := 'Value: ' + Random(215422).ToString + Random(154200).ToString;
end;

procedure TForm1542.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1542;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1542_List0 := TMyObj1542_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1542_List1 := TMyObj1542_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
