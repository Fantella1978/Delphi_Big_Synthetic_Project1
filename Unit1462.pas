...
type
  ...
  TMyObj1462_List0 = TObjectList<TMyObj1462>;

  TMyObj1462_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1462_List1 = TObjectList<TMyObj1462_1>;
...
constructor TMyObj1462_1.Create;
begin
  inherited;
  FInt := 1462 * 3;
  FTest := 'Value: ' + Random(214622).ToString + Random(146200).ToString;
end;

procedure TForm1462.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1462;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1462_List0 := TMyObj1462_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1462_List1 := TMyObj1462_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
