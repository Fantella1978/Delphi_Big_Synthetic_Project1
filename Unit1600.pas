...
type
  ...
  TMyObj1600_List0 = TObjectList<TMyObj1600>;

  TMyObj1600_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1600_List1 = TObjectList<TMyObj1600_1>;
...
constructor TMyObj1600_1.Create;
begin
  inherited;
  FInt := 1600 * 3;
  FTest := 'Value: ' + Random(216002).ToString + Random(160000).ToString;
end;

procedure TForm1600.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1600;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1600_List0 := TMyObj1600_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1600_List1 := TMyObj1600_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
