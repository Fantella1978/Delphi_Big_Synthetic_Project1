...
type
  ...
  TMyObj2379_List0 = TObjectList<TMyObj2379>;

  TMyObj2379_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2379_List1 = TObjectList<TMyObj2379_1>;
...
constructor TMyObj2379_1.Create;
begin
  inherited;
  FInt := 2379 * 3;
  FTest := 'Value: ' + Random(223792).ToString + Random(237900).ToString;
end;

procedure TForm2379.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2379;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2379_List0 := TMyObj2379_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2379_List1 := TMyObj2379_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
