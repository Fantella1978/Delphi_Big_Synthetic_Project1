...
type
  ...
  TMyObj1053_List0 = TObjectList<TMyObj1053>;

  TMyObj1053_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1053_List1 = TObjectList<TMyObj1053_1>;
...
constructor TMyObj1053_1.Create;
begin
  inherited;
  FInt := 1053 * 3;
  FTest := 'Value: ' + Random(210532).ToString + Random(105300).ToString;
end;

procedure TForm1053.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1053;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1053_List0 := TMyObj1053_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1053_List1 := TMyObj1053_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
