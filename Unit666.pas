...
type
  ...
  TMyObj666_List0 = TObjectList<TMyObj666>;

  TMyObj666_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj666_List1 = TObjectList<TMyObj666_1>;
...
constructor TMyObj666_1.Create;
begin
  inherited;
  FInt := 666 * 3;
  FTest := 'Value: ' + Random(26662).ToString + Random(66600).ToString;
end;

procedure TForm666.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum666;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj666_List0 := TMyObj666_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj666_List1 := TMyObj666_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
