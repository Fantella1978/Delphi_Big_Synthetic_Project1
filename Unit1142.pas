...
type
  ...
  TMyObj1142_List0 = TObjectList<TMyObj1142>;

  TMyObj1142_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1142_List1 = TObjectList<TMyObj1142_1>;
...
constructor TMyObj1142_1.Create;
begin
  inherited;
  FInt := 1142 * 3;
  FTest := 'Value: ' + Random(211422).ToString + Random(114200).ToString;
end;

procedure TForm1142.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1142;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1142_List0 := TMyObj1142_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1142_List1 := TMyObj1142_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
