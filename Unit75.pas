...
type
  ...
  TMyObj75_List0 = TObjectList<TMyObj75>;

  TMyObj75_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj75_List1 = TObjectList<TMyObj75_1>;
...
constructor TMyObj75_1.Create;
begin
  inherited;
  FInt := 75 * 3;
  FTest := 'Value: ' + Random(2752).ToString + Random(7500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj75_List0 := TMyObj75_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj75_List1 := TMyObj75_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
