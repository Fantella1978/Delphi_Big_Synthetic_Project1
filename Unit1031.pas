...
type
  ...
  TMyObj1031_List0 = TObjectList<TMyObj1031>;

  TMyObj1031_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1031_List1 = TObjectList<TMyObj1031_1>;
...
constructor TMyObj1031_1.Create;
begin
  inherited;
  FInt := 1031 * 3;
  FTest := 'Value: ' + Random(210312).ToString + Random(103100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1031_List0 := TMyObj1031_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1031_List1 := TMyObj1031_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
