...
type
  ...
  TMyObj812_List0 = TObjectList<TMyObj812>;

  TMyObj812_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj812_List1 = TObjectList<TMyObj812_1>;
...
constructor TMyObj812_1.Create;
begin
  inherited;
  FInt := 812 * 3;
  FTest := 'Value: ' + Random(28122).ToString + Random(81200).ToString;
end;

procedure TForm812.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum812;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj812_List0 := TMyObj812_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj812_List1 := TMyObj812_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
