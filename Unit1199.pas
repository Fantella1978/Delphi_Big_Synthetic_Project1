...
type
  ...
  TMyObj1199_List0 = TObjectList<TMyObj1199>;

  TMyObj1199_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1199_List1 = TObjectList<TMyObj1199_1>;
...
constructor TMyObj1199_1.Create;
begin
  inherited;
  FInt := 1199 * 3;
  FTest := 'Value: ' + Random(211992).ToString + Random(119900).ToString;
end;

procedure TForm1199.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1199;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1199_List0 := TMyObj1199_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1199_List1 := TMyObj1199_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
