...
type
  ...
  TMyObj199_List0 = TObjectList<TMyObj199>;

  TMyObj199_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj199_List1 = TObjectList<TMyObj199_1>;
...
constructor TMyObj199_1.Create;
begin
  inherited;
  FInt := 199 * 3;
  FTest := 'Value: ' + Random(21992).ToString + Random(19900).ToString;
end;

procedure TForm199.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum199;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj199_List0 := TMyObj199_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj199_List1 := TMyObj199_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
