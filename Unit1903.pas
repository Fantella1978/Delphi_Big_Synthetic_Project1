...
type
  ...
  TMyObj1903_List0 = TObjectList<TMyObj1903>;

  TMyObj1903_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1903_List1 = TObjectList<TMyObj1903_1>;
...
constructor TMyObj1903_1.Create;
begin
  inherited;
  FInt := 1903 * 3;
  FTest := 'Value: ' + Random(219032).ToString + Random(190300).ToString;
end;

procedure TForm1903.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1903;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1903_List0 := TMyObj1903_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1903_List1 := TMyObj1903_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
