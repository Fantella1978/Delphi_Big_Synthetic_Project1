...
type
  ...
  TMyObj1128_List0 = TObjectList<TMyObj1128>;

  TMyObj1128_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1128_List1 = TObjectList<TMyObj1128_1>;
...
constructor TMyObj1128_1.Create;
begin
  inherited;
  FInt := 1128 * 3;
  FTest := 'Value: ' + Random(211282).ToString + Random(112800).ToString;
end;

procedure TForm1128.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1128;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1128_List0 := TMyObj1128_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1128_List1 := TMyObj1128_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
