...
type
  ...
  TMyObj554_List0 = TObjectList<TMyObj554>;

  TMyObj554_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj554_List1 = TObjectList<TMyObj554_1>;
...
constructor TMyObj554_1.Create;
begin
  inherited;
  FInt := 554 * 3;
  FTest := 'Value: ' + Random(25542).ToString + Random(55400).ToString;
end;

procedure TForm554.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum554;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj554_List0 := TMyObj554_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj554_List1 := TMyObj554_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
