...
type
  ...
  TMyObj440_List0 = TObjectList<TMyObj440>;

  TMyObj440_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj440_List1 = TObjectList<TMyObj440_1>;
...
constructor TMyObj440_1.Create;
begin
  inherited;
  FInt := 440 * 3;
  FTest := 'Value: ' + Random(24402).ToString + Random(44000).ToString;
end;

procedure TForm440.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum440;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj440_List0 := TMyObj440_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj440_List1 := TMyObj440_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
