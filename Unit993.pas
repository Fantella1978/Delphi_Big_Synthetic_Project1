...
type
  ...
  TMyObj993_List0 = TObjectList<TMyObj993>;

  TMyObj993_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj993_List1 = TObjectList<TMyObj993_1>;
...
constructor TMyObj993_1.Create;
begin
  inherited;
  FInt := 993 * 3;
  FTest := 'Value: ' + Random(29932).ToString + Random(99300).ToString;
end;

procedure TForm993.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum993;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj993_List0 := TMyObj993_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj993_List1 := TMyObj993_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
