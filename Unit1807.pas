...
type
  ...
  TMyObj1807_List0 = TObjectList<TMyObj1807>;

  TMyObj1807_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1807_List1 = TObjectList<TMyObj1807_1>;
...
constructor TMyObj1807_1.Create;
begin
  inherited;
  FInt := 1807 * 3;
  FTest := 'Value: ' + Random(218072).ToString + Random(180700).ToString;
end;

procedure TForm1807.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1807;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1807_List0 := TMyObj1807_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1807_List1 := TMyObj1807_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
