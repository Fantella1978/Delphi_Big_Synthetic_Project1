...
type
  ...
  TMyObj562_List0 = TObjectList<TMyObj562>;

  TMyObj562_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj562_List1 = TObjectList<TMyObj562_1>;
...
constructor TMyObj562_1.Create;
begin
  inherited;
  FInt := 562 * 3;
  FTest := 'Value: ' + Random(25622).ToString + Random(56200).ToString;
end;

procedure TForm562.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum562;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj562_List0 := TMyObj562_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj562_List1 := TMyObj562_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
