...
type
  ...
  TMyObj916_List0 = TObjectList<TMyObj916>;

  TMyObj916_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj916_List1 = TObjectList<TMyObj916_1>;
...
constructor TMyObj916_1.Create;
begin
  inherited;
  FInt := 916 * 3;
  FTest := 'Value: ' + Random(29162).ToString + Random(91600).ToString;
end;

procedure TForm916.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum916;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj916_List0 := TMyObj916_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj916_List1 := TMyObj916_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
