...
type
  ...
  TMyObj2145_List0 = TObjectList<TMyObj2145>;

  TMyObj2145_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2145_List1 = TObjectList<TMyObj2145_1>;
...
constructor TMyObj2145_1.Create;
begin
  inherited;
  FInt := 2145 * 3;
  FTest := 'Value: ' + Random(221452).ToString + Random(214500).ToString;
end;

procedure TForm2145.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2145;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2145_List0 := TMyObj2145_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2145_List1 := TMyObj2145_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
