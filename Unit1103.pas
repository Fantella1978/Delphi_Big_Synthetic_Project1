...
type
  ...
  TMyObj1103_List0 = TObjectList<TMyObj1103>;

  TMyObj1103_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1103_List1 = TObjectList<TMyObj1103_1>;
...
constructor TMyObj1103_1.Create;
begin
  inherited;
  FInt := 1103 * 3;
  FTest := 'Value: ' + Random(211032).ToString + Random(110300).ToString;
end;

procedure TForm1103.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1103;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1103_List0 := TMyObj1103_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1103_List1 := TMyObj1103_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
