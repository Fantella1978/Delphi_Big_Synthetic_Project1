...
type
  ...
  TMyObj2251_List0 = TObjectList<TMyObj2251>;

  TMyObj2251_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2251_List1 = TObjectList<TMyObj2251_1>;
...
constructor TMyObj2251_1.Create;
begin
  inherited;
  FInt := 2251 * 3;
  FTest := 'Value: ' + Random(222512).ToString + Random(225100).ToString;
end;

procedure TForm2251.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2251;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2251_List0 := TMyObj2251_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2251_List1 := TMyObj2251_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
