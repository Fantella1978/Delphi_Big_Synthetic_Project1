...
type
  ...
  TMyObj485_List0 = TObjectList<TMyObj485>;

  TMyObj485_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj485_List1 = TObjectList<TMyObj485_1>;
...
constructor TMyObj485_1.Create;
begin
  inherited;
  FInt := 485 * 3;
  FTest := 'Value: ' + Random(24852).ToString + Random(48500).ToString;
end;

procedure TForm485.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum485;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj485_List0 := TMyObj485_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj485_List1 := TMyObj485_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
