...
type
  ...
  TMyObj1747_List0 = TObjectList<TMyObj1747>;

  TMyObj1747_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1747_List1 = TObjectList<TMyObj1747_1>;
...
constructor TMyObj1747_1.Create;
begin
  inherited;
  FInt := 1747 * 3;
  FTest := 'Value: ' + Random(217472).ToString + Random(174700).ToString;
end;

procedure TForm1747.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1747;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1747_List0 := TMyObj1747_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1747_List1 := TMyObj1747_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
