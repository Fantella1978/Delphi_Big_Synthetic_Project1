...
type
  ...
  TMyObj760_List0 = TObjectList<TMyObj760>;

  TMyObj760_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj760_List1 = TObjectList<TMyObj760_1>;
...
constructor TMyObj760_1.Create;
begin
  inherited;
  FInt := 760 * 3;
  FTest := 'Value: ' + Random(27602).ToString + Random(76000).ToString;
end;

procedure TForm760.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum760;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj760_List0 := TMyObj760_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj760_List1 := TMyObj760_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
