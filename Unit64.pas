...
type
  ...
  TMyObj64_List0 = TObjectList<TMyObj64>;

  TMyObj64_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj64_List1 = TObjectList<TMyObj64_1>;
...
constructor TMyObj64_1.Create;
begin
  inherited;
  FInt := 64 * 3;
  FTest := 'Value: ' + Random(2642).ToString + Random(6400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj64_List0 := TMyObj64_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj64_List1 := TMyObj64_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
