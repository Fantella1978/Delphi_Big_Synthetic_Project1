...
type
  ...
  TMyObj2425_List0 = TObjectList<TMyObj2425>;

  TMyObj2425_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2425_List1 = TObjectList<TMyObj2425_1>;
...
constructor TMyObj2425_1.Create;
begin
  inherited;
  FInt := 2425 * 3;
  FTest := 'Value: ' + Random(224252).ToString + Random(242500).ToString;
end;

procedure TForm2425.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2425;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2425_List0 := TMyObj2425_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2425_List1 := TMyObj2425_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
