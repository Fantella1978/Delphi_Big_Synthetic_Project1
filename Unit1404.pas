...
type
  ...
  TMyObj1404_List0 = TObjectList<TMyObj1404>;

  TMyObj1404_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1404_List1 = TObjectList<TMyObj1404_1>;
...
constructor TMyObj1404_1.Create;
begin
  inherited;
  FInt := 1404 * 3;
  FTest := 'Value: ' + Random(214042).ToString + Random(140400).ToString;
end;

procedure TForm1404.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1404;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1404_List0 := TMyObj1404_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1404_List1 := TMyObj1404_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
