...
type
  ...
  TMyObj691_List0 = TObjectList<TMyObj691>;

  TMyObj691_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj691_List1 = TObjectList<TMyObj691_1>;
...
constructor TMyObj691_1.Create;
begin
  inherited;
  FInt := 691 * 3;
  FTest := 'Value: ' + Random(26912).ToString + Random(69100).ToString;
end;

procedure TForm691.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum691;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj691_List0 := TMyObj691_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj691_List1 := TMyObj691_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
