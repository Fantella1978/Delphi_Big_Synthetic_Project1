...
type
  ...
  TMyObj1021_List0 = TObjectList<TMyObj1021>;

  TMyObj1021_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1021_List1 = TObjectList<TMyObj1021_1>;
...
constructor TMyObj1021_1.Create;
begin
  inherited;
  FInt := 1021 * 3;
  FTest := 'Value: ' + Random(210212).ToString + Random(102100).ToString;
end;

procedure TForm1021.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1021;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1021_List0 := TMyObj1021_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1021_List1 := TMyObj1021_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
