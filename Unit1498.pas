...
type
  ...
  TMyObj1498_List0 = TObjectList<TMyObj1498>;

  TMyObj1498_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1498_List1 = TObjectList<TMyObj1498_1>;
...
constructor TMyObj1498_1.Create;
begin
  inherited;
  FInt := 1498 * 3;
  FTest := 'Value: ' + Random(214982).ToString + Random(149800).ToString;
end;

procedure TForm1498.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1498;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1498_List0 := TMyObj1498_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1498_List1 := TMyObj1498_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
