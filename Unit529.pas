...
type
  ...
  TMyObj529_List0 = TObjectList<TMyObj529>;

  TMyObj529_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj529_List1 = TObjectList<TMyObj529_1>;
...
constructor TMyObj529_1.Create;
begin
  inherited;
  FInt := 529 * 3;
  FTest := 'Value: ' + Random(25292).ToString + Random(52900).ToString;
end;

procedure TForm529.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum529;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj529_List0 := TMyObj529_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj529_List1 := TMyObj529_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
