...
type
  ...
  TMyObj430_List0 = TObjectList<TMyObj430>;

  TMyObj430_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj430_List1 = TObjectList<TMyObj430_1>;
...
constructor TMyObj430_1.Create;
begin
  inherited;
  FInt := 430 * 3;
  FTest := 'Value: ' + Random(24302).ToString + Random(43000).ToString;
end;

procedure TForm430.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum430;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj430_List0 := TMyObj430_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj430_List1 := TMyObj430_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
