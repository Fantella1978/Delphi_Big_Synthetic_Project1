...
type
  ...
  TMyObj207_List0 = TObjectList<TMyObj207>;

  TMyObj207_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj207_List1 = TObjectList<TMyObj207_1>;
...
constructor TMyObj207_1.Create;
begin
  inherited;
  FInt := 207 * 3;
  FTest := 'Value: ' + Random(22072).ToString + Random(20700).ToString;
end;

procedure TForm207.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum207;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj207_List0 := TMyObj207_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj207_List1 := TMyObj207_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
