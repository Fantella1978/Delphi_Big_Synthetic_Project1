...
type
  ...
  TMyObj2005_List0 = TObjectList<TMyObj2005>;

  TMyObj2005_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2005_List1 = TObjectList<TMyObj2005_1>;
...
constructor TMyObj2005_1.Create;
begin
  inherited;
  FInt := 2005 * 3;
  FTest := 'Value: ' + Random(220052).ToString + Random(200500).ToString;
end;

procedure TForm2005.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2005;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2005_List0 := TMyObj2005_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2005_List1 := TMyObj2005_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
