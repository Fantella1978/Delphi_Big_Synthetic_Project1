...
type
  ...
  TMyObj2483_List0 = TObjectList<TMyObj2483>;

  TMyObj2483_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2483_List1 = TObjectList<TMyObj2483_1>;
...
constructor TMyObj2483_1.Create;
begin
  inherited;
  FInt := 2483 * 3;
  FTest := 'Value: ' + Random(224832).ToString + Random(248300).ToString;
end;

procedure TForm2483.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2483;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2483_List0 := TMyObj2483_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2483_List1 := TMyObj2483_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
