...
type
  ...
  TMyObj654_List0 = TObjectList<TMyObj654>;

  TMyObj654_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj654_List1 = TObjectList<TMyObj654_1>;
...
constructor TMyObj654_1.Create;
begin
  inherited;
  FInt := 654 * 3;
  FTest := 'Value: ' + Random(26542).ToString + Random(65400).ToString;
end;

procedure TForm654.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum654;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj654_List0 := TMyObj654_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj654_List1 := TMyObj654_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
