...
type
  ...
  TMyObj462_List0 = TObjectList<TMyObj462>;

  TMyObj462_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj462_List1 = TObjectList<TMyObj462_1>;
...
constructor TMyObj462_1.Create;
begin
  inherited;
  FInt := 462 * 3;
  FTest := 'Value: ' + Random(24622).ToString + Random(46200).ToString;
end;

procedure TForm462.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum462;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj462_List0 := TMyObj462_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj462_List1 := TMyObj462_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
