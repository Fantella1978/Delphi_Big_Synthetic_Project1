...
type
  ...
  TMyObj1058_List0 = TObjectList<TMyObj1058>;

  TMyObj1058_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1058_List1 = TObjectList<TMyObj1058_1>;
...
constructor TMyObj1058_1.Create;
begin
  inherited;
  FInt := 1058 * 3;
  FTest := 'Value: ' + Random(210582).ToString + Random(105800).ToString;
end;

procedure TForm1058.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1058;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1058_List0 := TMyObj1058_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1058_List1 := TMyObj1058_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
