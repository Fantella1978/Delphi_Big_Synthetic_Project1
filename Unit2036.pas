...
type
  ...
  TMyObj2036_List0 = TObjectList<TMyObj2036>;

  TMyObj2036_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2036_List1 = TObjectList<TMyObj2036_1>;
...
constructor TMyObj2036_1.Create;
begin
  inherited;
  FInt := 2036 * 3;
  FTest := 'Value: ' + Random(220362).ToString + Random(203600).ToString;
end;

procedure TForm2036.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2036;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2036_List0 := TMyObj2036_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2036_List1 := TMyObj2036_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
