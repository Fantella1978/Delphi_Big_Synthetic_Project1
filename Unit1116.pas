...
type
  ...
  TMyObj1116_List0 = TObjectList<TMyObj1116>;

  TMyObj1116_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1116_List1 = TObjectList<TMyObj1116_1>;
...
constructor TMyObj1116_1.Create;
begin
  inherited;
  FInt := 1116 * 3;
  FTest := 'Value: ' + Random(211162).ToString + Random(111600).ToString;
end;

procedure TForm1116.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1116;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1116_List0 := TMyObj1116_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1116_List1 := TMyObj1116_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
