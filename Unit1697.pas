...
type
  ...
  TMyObj1697_List0 = TObjectList<TMyObj1697>;

  TMyObj1697_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1697_List1 = TObjectList<TMyObj1697_1>;
...
constructor TMyObj1697_1.Create;
begin
  inherited;
  FInt := 1697 * 3;
  FTest := 'Value: ' + Random(216972).ToString + Random(169700).ToString;
end;

procedure TForm1697.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1697;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1697_List0 := TMyObj1697_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1697_List1 := TMyObj1697_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
