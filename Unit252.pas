...
type
  ...
  TMyObj252_List0 = TObjectList<TMyObj252>;

  TMyObj252_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj252_List1 = TObjectList<TMyObj252_1>;
...
constructor TMyObj252_1.Create;
begin
  inherited;
  FInt := 252 * 3;
  FTest := 'Value: ' + Random(22522).ToString + Random(25200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj252_List0 := TMyObj252_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj252_List1 := TMyObj252_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
