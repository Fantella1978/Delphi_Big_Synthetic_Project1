...
type
  ...
  TMyObj2353_List0 = TObjectList<TMyObj2353>;

  TMyObj2353_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2353_List1 = TObjectList<TMyObj2353_1>;
...
constructor TMyObj2353_1.Create;
begin
  inherited;
  FInt := 2353 * 3;
  FTest := 'Value: ' + Random(223532).ToString + Random(235300).ToString;
end;

procedure TForm2353.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2353;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2353_List0 := TMyObj2353_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2353_List1 := TMyObj2353_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
