...
type
  ...
  TMyObj376_List0 = TObjectList<TMyObj376>;

  TMyObj376_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj376_List1 = TObjectList<TMyObj376_1>;
...
constructor TMyObj376_1.Create;
begin
  inherited;
  FInt := 376 * 3;
  FTest := 'Value: ' + Random(23762).ToString + Random(37600).ToString;
end;

procedure TForm376.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum376;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj376_List0 := TMyObj376_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj376_List1 := TMyObj376_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
