...
type
  ...
  TMyObj734_List0 = TObjectList<TMyObj734>;

  TMyObj734_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj734_List1 = TObjectList<TMyObj734_1>;
...
constructor TMyObj734_1.Create;
begin
  inherited;
  FInt := 734 * 3;
  FTest := 'Value: ' + Random(27342).ToString + Random(73400).ToString;
end;

procedure TForm734.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum734;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj734_List0 := TMyObj734_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj734_List1 := TMyObj734_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
