...
type
  ...
  TMyObj2183_List0 = TObjectList<TMyObj2183>;

  TMyObj2183_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2183_List1 = TObjectList<TMyObj2183_1>;
...
constructor TMyObj2183_1.Create;
begin
  inherited;
  FInt := 2183 * 3;
  FTest := 'Value: ' + Random(221832).ToString + Random(218300).ToString;
end;

procedure TForm2183.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2183;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2183_List0 := TMyObj2183_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2183_List1 := TMyObj2183_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
