...
type
  ...
  TMyObj1741_List0 = TObjectList<TMyObj1741>;

  TMyObj1741_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1741_List1 = TObjectList<TMyObj1741_1>;
...
constructor TMyObj1741_1.Create;
begin
  inherited;
  FInt := 1741 * 3;
  FTest := 'Value: ' + Random(217412).ToString + Random(174100).ToString;
end;

procedure TForm1741.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1741;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1741_List0 := TMyObj1741_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1741_List1 := TMyObj1741_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
