...
type
  ...
  TMyObj1821_List0 = TObjectList<TMyObj1821>;

  TMyObj1821_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1821_List1 = TObjectList<TMyObj1821_1>;
...
constructor TMyObj1821_1.Create;
begin
  inherited;
  FInt := 1821 * 3;
  FTest := 'Value: ' + Random(218212).ToString + Random(182100).ToString;
end;

procedure TForm1821.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1821;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1821_List0 := TMyObj1821_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1821_List1 := TMyObj1821_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
