...
type
  ...
  TMyObj1627_List0 = TObjectList<TMyObj1627>;

  TMyObj1627_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1627_List1 = TObjectList<TMyObj1627_1>;
...
constructor TMyObj1627_1.Create;
begin
  inherited;
  FInt := 1627 * 3;
  FTest := 'Value: ' + Random(216272).ToString + Random(162700).ToString;
end;

procedure TForm1627.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1627;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1627_List0 := TMyObj1627_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1627_List1 := TMyObj1627_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
