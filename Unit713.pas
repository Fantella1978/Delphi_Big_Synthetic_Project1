...
type
  ...
  TMyObj713_List0 = TObjectList<TMyObj713>;

  TMyObj713_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj713_List1 = TObjectList<TMyObj713_1>;
...
constructor TMyObj713_1.Create;
begin
  inherited;
  FInt := 713 * 3;
  FTest := 'Value: ' + Random(27132).ToString + Random(71300).ToString;
end;

procedure TForm713.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum713;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj713_List0 := TMyObj713_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj713_List1 := TMyObj713_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
