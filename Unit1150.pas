...
type
  ...
  TMyObj1150_List0 = TObjectList<TMyObj1150>;

  TMyObj1150_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1150_List1 = TObjectList<TMyObj1150_1>;
...
constructor TMyObj1150_1.Create;
begin
  inherited;
  FInt := 1150 * 3;
  FTest := 'Value: ' + Random(211502).ToString + Random(115000).ToString;
end;

procedure TForm1150.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1150;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1150_List0 := TMyObj1150_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1150_List1 := TMyObj1150_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
