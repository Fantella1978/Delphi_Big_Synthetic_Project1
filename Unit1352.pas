...
type
  ...
  TMyObj1352_List0 = TObjectList<TMyObj1352>;

  TMyObj1352_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1352_List1 = TObjectList<TMyObj1352_1>;
...
constructor TMyObj1352_1.Create;
begin
  inherited;
  FInt := 1352 * 3;
  FTest := 'Value: ' + Random(213522).ToString + Random(135200).ToString;
end;

procedure TForm1352.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1352;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1352_List0 := TMyObj1352_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1352_List1 := TMyObj1352_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
