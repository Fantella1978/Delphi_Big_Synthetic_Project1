...
type
  ...
  TMyObj895_List0 = TObjectList<TMyObj895>;

  TMyObj895_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj895_List1 = TObjectList<TMyObj895_1>;
...
constructor TMyObj895_1.Create;
begin
  inherited;
  FInt := 895 * 3;
  FTest := 'Value: ' + Random(28952).ToString + Random(89500).ToString;
end;

procedure TForm895.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum895;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj895_List0 := TMyObj895_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj895_List1 := TMyObj895_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
