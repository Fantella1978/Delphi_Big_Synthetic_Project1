...
type
  ...
  TMyObj1891_List0 = TObjectList<TMyObj1891>;

  TMyObj1891_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1891_List1 = TObjectList<TMyObj1891_1>;
...
constructor TMyObj1891_1.Create;
begin
  inherited;
  FInt := 1891 * 3;
  FTest := 'Value: ' + Random(218912).ToString + Random(189100).ToString;
end;

procedure TForm1891.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1891;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1891_List0 := TMyObj1891_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1891_List1 := TMyObj1891_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
