...
type
  ...
  TMyObj396_List0 = TObjectList<TMyObj396>;

  TMyObj396_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj396_List1 = TObjectList<TMyObj396_1>;
...
constructor TMyObj396_1.Create;
begin
  inherited;
  FInt := 396 * 3;
  FTest := 'Value: ' + Random(23962).ToString + Random(39600).ToString;
end;

procedure TForm396.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum396;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj396_List0 := TMyObj396_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj396_List1 := TMyObj396_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
