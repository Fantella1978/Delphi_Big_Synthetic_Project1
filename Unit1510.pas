...
type
  ...
  TMyObj1510_List0 = TObjectList<TMyObj1510>;

  TMyObj1510_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1510_List1 = TObjectList<TMyObj1510_1>;
...
constructor TMyObj1510_1.Create;
begin
  inherited;
  FInt := 1510 * 3;
  FTest := 'Value: ' + Random(215102).ToString + Random(151000).ToString;
end;

procedure TForm1510.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1510;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1510_List0 := TMyObj1510_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1510_List1 := TMyObj1510_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
