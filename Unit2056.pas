...
type
  ...
  TMyObj2056_List0 = TObjectList<TMyObj2056>;

  TMyObj2056_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2056_List1 = TObjectList<TMyObj2056_1>;
...
constructor TMyObj2056_1.Create;
begin
  inherited;
  FInt := 2056 * 3;
  FTest := 'Value: ' + Random(220562).ToString + Random(205600).ToString;
end;

procedure TForm2056.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2056;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2056_List0 := TMyObj2056_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2056_List1 := TMyObj2056_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
