...
type
  ...
  TMyObj1111_List0 = TObjectList<TMyObj1111>;

  TMyObj1111_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1111_List1 = TObjectList<TMyObj1111_1>;
...
constructor TMyObj1111_1.Create;
begin
  inherited;
  FInt := 1111 * 3;
  FTest := 'Value: ' + Random(211112).ToString + Random(111100).ToString;
end;

procedure TForm1111.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1111;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1111_List0 := TMyObj1111_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1111_List1 := TMyObj1111_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
