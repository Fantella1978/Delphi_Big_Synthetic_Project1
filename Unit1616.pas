...
type
  ...
  TMyObj1616_List0 = TObjectList<TMyObj1616>;

  TMyObj1616_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1616_List1 = TObjectList<TMyObj1616_1>;
...
constructor TMyObj1616_1.Create;
begin
  inherited;
  FInt := 1616 * 3;
  FTest := 'Value: ' + Random(216162).ToString + Random(161600).ToString;
end;

procedure TForm1616.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1616;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1616_List0 := TMyObj1616_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1616_List1 := TMyObj1616_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
