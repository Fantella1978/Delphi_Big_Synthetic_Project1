...
type
  ...
  TMyObj1833_List0 = TObjectList<TMyObj1833>;

  TMyObj1833_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1833_List1 = TObjectList<TMyObj1833_1>;
...
constructor TMyObj1833_1.Create;
begin
  inherited;
  FInt := 1833 * 3;
  FTest := 'Value: ' + Random(218332).ToString + Random(183300).ToString;
end;

procedure TForm1833.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1833;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1833_List0 := TMyObj1833_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1833_List1 := TMyObj1833_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
