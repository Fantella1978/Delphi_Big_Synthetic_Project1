...
type
  ...
  TMyObj51_List0 = TObjectList<TMyObj51>;

  TMyObj51_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj51_List1 = TObjectList<TMyObj51_1>;
...
constructor TMyObj51_1.Create;
begin
  inherited;
  FInt := 51 * 3;
  FTest := 'Value: ' + Random(2512).ToString + Random(5100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj51_List0 := TMyObj51_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj51_List1 := TMyObj51_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
