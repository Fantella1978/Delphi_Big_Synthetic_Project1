...
type
  ...
  TMyObj1231_List0 = TObjectList<TMyObj1231>;

  TMyObj1231_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1231_List1 = TObjectList<TMyObj1231_1>;
...
constructor TMyObj1231_1.Create;
begin
  inherited;
  FInt := 1231 * 3;
  FTest := 'Value: ' + Random(212312).ToString + Random(123100).ToString;
end;

procedure TForm1231.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1231;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1231_List0 := TMyObj1231_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1231_List1 := TMyObj1231_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
