...
type
  ...
  TMyObj756_List0 = TObjectList<TMyObj756>;

  TMyObj756_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj756_List1 = TObjectList<TMyObj756_1>;
...
constructor TMyObj756_1.Create;
begin
  inherited;
  FInt := 756 * 3;
  FTest := 'Value: ' + Random(27562).ToString + Random(75600).ToString;
end;

procedure TForm756.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum756;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj756_List0 := TMyObj756_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj756_List1 := TMyObj756_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
