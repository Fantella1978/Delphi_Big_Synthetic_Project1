...
type
  ...
  TMyObj1423_List0 = TObjectList<TMyObj1423>;

  TMyObj1423_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1423_List1 = TObjectList<TMyObj1423_1>;
...
constructor TMyObj1423_1.Create;
begin
  inherited;
  FInt := 1423 * 3;
  FTest := 'Value: ' + Random(214232).ToString + Random(142300).ToString;
end;

procedure TForm1423.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1423;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1423_List0 := TMyObj1423_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1423_List1 := TMyObj1423_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
