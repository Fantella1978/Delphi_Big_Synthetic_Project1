...
type
  ...
  TMyObj65_List0 = TObjectList<TMyObj65>;

  TMyObj65_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj65_List1 = TObjectList<TMyObj65_1>;
...
constructor TMyObj65_1.Create;
begin
  inherited;
  FInt := 65 * 3;
  FTest := 'Value: ' + Random(2652).ToString + Random(6500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj65_List0 := TMyObj65_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj65_List1 := TMyObj65_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
