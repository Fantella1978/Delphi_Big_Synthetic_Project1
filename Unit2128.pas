...
type
  ...
  TMyObj2128_List0 = TObjectList<TMyObj2128>;

  TMyObj2128_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2128_List1 = TObjectList<TMyObj2128_1>;
...
constructor TMyObj2128_1.Create;
begin
  inherited;
  FInt := 2128 * 3;
  FTest := 'Value: ' + Random(221282).ToString + Random(212800).ToString;
end;

procedure TForm2128.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2128;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2128_List0 := TMyObj2128_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2128_List1 := TMyObj2128_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
