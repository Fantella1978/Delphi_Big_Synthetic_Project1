...
type
  ...
  TMyObj392_List0 = TObjectList<TMyObj392>;

  TMyObj392_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj392_List1 = TObjectList<TMyObj392_1>;
...
constructor TMyObj392_1.Create;
begin
  inherited;
  FInt := 392 * 3;
  FTest := 'Value: ' + Random(23922).ToString + Random(39200).ToString;
end;

procedure TForm392.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum392;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj392_List0 := TMyObj392_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj392_List1 := TMyObj392_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
