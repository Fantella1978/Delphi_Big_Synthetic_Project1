...
type
  ...
  TMyObj1947_List0 = TObjectList<TMyObj1947>;

  TMyObj1947_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1947_List1 = TObjectList<TMyObj1947_1>;
...
constructor TMyObj1947_1.Create;
begin
  inherited;
  FInt := 1947 * 3;
  FTest := 'Value: ' + Random(219472).ToString + Random(194700).ToString;
end;

procedure TForm1947.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1947;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1947_List0 := TMyObj1947_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1947_List1 := TMyObj1947_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
