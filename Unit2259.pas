...
type
  ...
  TMyObj2259_List0 = TObjectList<TMyObj2259>;

  TMyObj2259_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2259_List1 = TObjectList<TMyObj2259_1>;
...
constructor TMyObj2259_1.Create;
begin
  inherited;
  FInt := 2259 * 3;
  FTest := 'Value: ' + Random(222592).ToString + Random(225900).ToString;
end;

procedure TForm2259.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2259;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2259_List0 := TMyObj2259_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2259_List1 := TMyObj2259_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
