...
type
  ...
  TMyObj542_List0 = TObjectList<TMyObj542>;

  TMyObj542_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj542_List1 = TObjectList<TMyObj542_1>;
...
constructor TMyObj542_1.Create;
begin
  inherited;
  FInt := 542 * 3;
  FTest := 'Value: ' + Random(25422).ToString + Random(54200).ToString;
end;

procedure TForm542.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum542;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj542_List0 := TMyObj542_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj542_List1 := TMyObj542_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
