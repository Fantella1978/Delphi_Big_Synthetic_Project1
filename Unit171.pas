...
type
  ...
  TMyObj171_List0 = TObjectList<TMyObj171>;

  TMyObj171_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj171_List1 = TObjectList<TMyObj171_1>;
...
constructor TMyObj171_1.Create;
begin
  inherited;
  FInt := 171 * 3;
  FTest := 'Value: ' + Random(21712).ToString + Random(17100).ToString;
end;

procedure TForm171.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum171;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj171_List0 := TMyObj171_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj171_List1 := TMyObj171_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
