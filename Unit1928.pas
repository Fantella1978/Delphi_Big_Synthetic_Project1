...
type
  ...
  TMyObj1928_List0 = TObjectList<TMyObj1928>;

  TMyObj1928_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1928_List1 = TObjectList<TMyObj1928_1>;
...
constructor TMyObj1928_1.Create;
begin
  inherited;
  FInt := 1928 * 3;
  FTest := 'Value: ' + Random(219282).ToString + Random(192800).ToString;
end;

procedure TForm1928.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1928;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1928_List0 := TMyObj1928_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1928_List1 := TMyObj1928_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
