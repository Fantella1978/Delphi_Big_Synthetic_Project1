...
type
  ...
  TMyObj255_List0 = TObjectList<TMyObj255>;

  TMyObj255_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj255_List1 = TObjectList<TMyObj255_1>;
...
constructor TMyObj255_1.Create;
begin
  inherited;
  FInt := 255 * 3;
  FTest := 'Value: ' + Random(22552).ToString + Random(25500).ToString;
end;

procedure TForm255.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum255;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj255_List0 := TMyObj255_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj255_List1 := TMyObj255_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
