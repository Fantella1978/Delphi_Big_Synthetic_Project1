...
type
  ...
  TMyObj2469_List0 = TObjectList<TMyObj2469>;

  TMyObj2469_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2469_List1 = TObjectList<TMyObj2469_1>;
...
constructor TMyObj2469_1.Create;
begin
  inherited;
  FInt := 2469 * 3;
  FTest := 'Value: ' + Random(224692).ToString + Random(246900).ToString;
end;

procedure TForm2469.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2469;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2469_List0 := TMyObj2469_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2469_List1 := TMyObj2469_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
