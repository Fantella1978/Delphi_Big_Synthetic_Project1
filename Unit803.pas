...
type
  ...
  TMyObj803_List0 = TObjectList<TMyObj803>;

  TMyObj803_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj803_List1 = TObjectList<TMyObj803_1>;
...
constructor TMyObj803_1.Create;
begin
  inherited;
  FInt := 803 * 3;
  FTest := 'Value: ' + Random(28032).ToString + Random(80300).ToString;
end;

procedure TForm803.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum803;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj803_List0 := TMyObj803_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj803_List1 := TMyObj803_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
