...
type
  ...
  TMyObj1815_List0 = TObjectList<TMyObj1815>;

  TMyObj1815_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1815_List1 = TObjectList<TMyObj1815_1>;
...
constructor TMyObj1815_1.Create;
begin
  inherited;
  FInt := 1815 * 3;
  FTest := 'Value: ' + Random(218152).ToString + Random(181500).ToString;
end;

procedure TForm1815.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1815;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1815_List0 := TMyObj1815_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1815_List1 := TMyObj1815_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
