...
type
  ...
  TMyObj1572_List0 = TObjectList<TMyObj1572>;

  TMyObj1572_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1572_List1 = TObjectList<TMyObj1572_1>;
...
constructor TMyObj1572_1.Create;
begin
  inherited;
  FInt := 1572 * 3;
  FTest := 'Value: ' + Random(215722).ToString + Random(157200).ToString;
end;

procedure TForm1572.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1572;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1572_List0 := TMyObj1572_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1572_List1 := TMyObj1572_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
