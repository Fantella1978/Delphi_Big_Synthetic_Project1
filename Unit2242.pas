...
type
  ...
  TMyObj2242_List0 = TObjectList<TMyObj2242>;

  TMyObj2242_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2242_List1 = TObjectList<TMyObj2242_1>;
...
constructor TMyObj2242_1.Create;
begin
  inherited;
  FInt := 2242 * 3;
  FTest := 'Value: ' + Random(222422).ToString + Random(224200).ToString;
end;

procedure TForm2242.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2242;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2242_List0 := TMyObj2242_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2242_List1 := TMyObj2242_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
