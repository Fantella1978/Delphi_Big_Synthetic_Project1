...
type
  ...
  TMyObj288_List0 = TObjectList<TMyObj288>;

  TMyObj288_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj288_List1 = TObjectList<TMyObj288_1>;
...
constructor TMyObj288_1.Create;
begin
  inherited;
  FInt := 288 * 3;
  FTest := 'Value: ' + Random(22882).ToString + Random(28800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj288_List0 := TMyObj288_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj288_List1 := TMyObj288_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
