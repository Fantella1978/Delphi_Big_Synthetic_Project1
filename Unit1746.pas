...
type
  ...
  TMyObj1746_List0 = TObjectList<TMyObj1746>;

  TMyObj1746_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1746_List1 = TObjectList<TMyObj1746_1>;
...
constructor TMyObj1746_1.Create;
begin
  inherited;
  FInt := 1746 * 3;
  FTest := 'Value: ' + Random(217462).ToString + Random(174600).ToString;
end;

procedure TForm1746.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1746;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1746_List0 := TMyObj1746_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1746_List1 := TMyObj1746_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
