...
type
  ...
  TMyObj2420_List0 = TObjectList<TMyObj2420>;

  TMyObj2420_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2420_List1 = TObjectList<TMyObj2420_1>;
...
constructor TMyObj2420_1.Create;
begin
  inherited;
  FInt := 2420 * 3;
  FTest := 'Value: ' + Random(224202).ToString + Random(242000).ToString;
end;

procedure TForm2420.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2420;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2420_List0 := TMyObj2420_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2420_List1 := TMyObj2420_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
