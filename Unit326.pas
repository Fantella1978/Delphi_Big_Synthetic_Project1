...
type
  ...
  TMyObj326_List0 = TObjectList<TMyObj326>;

  TMyObj326_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj326_List1 = TObjectList<TMyObj326_1>;
...
constructor TMyObj326_1.Create;
begin
  inherited;
  FInt := 326 * 3;
  FTest := 'Value: ' + Random(23262).ToString + Random(32600).ToString;
end;

procedure TForm326.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum326;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj326_List0 := TMyObj326_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj326_List1 := TMyObj326_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
