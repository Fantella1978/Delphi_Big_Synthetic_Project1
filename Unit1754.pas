...
type
  ...
  TMyObj1754_List0 = TObjectList<TMyObj1754>;

  TMyObj1754_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1754_List1 = TObjectList<TMyObj1754_1>;
...
constructor TMyObj1754_1.Create;
begin
  inherited;
  FInt := 1754 * 3;
  FTest := 'Value: ' + Random(217542).ToString + Random(175400).ToString;
end;

procedure TForm1754.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1754;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1754_List0 := TMyObj1754_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1754_List1 := TMyObj1754_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
