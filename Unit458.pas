...
type
  ...
  TMyObj458_List0 = TObjectList<TMyObj458>;

  TMyObj458_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj458_List1 = TObjectList<TMyObj458_1>;
...
constructor TMyObj458_1.Create;
begin
  inherited;
  FInt := 458 * 3;
  FTest := 'Value: ' + Random(24582).ToString + Random(45800).ToString;
end;

procedure TForm458.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum458;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj458_List0 := TMyObj458_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj458_List1 := TMyObj458_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
