...
type
  ...
  TMyObj972_List0 = TObjectList<TMyObj972>;

  TMyObj972_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj972_List1 = TObjectList<TMyObj972_1>;
...
constructor TMyObj972_1.Create;
begin
  inherited;
  FInt := 972 * 3;
  FTest := 'Value: ' + Random(29722).ToString + Random(97200).ToString;
end;

procedure TForm972.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum972;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj972_List0 := TMyObj972_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj972_List1 := TMyObj972_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
