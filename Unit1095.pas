...
type
  ...
  TMyObj1095_List0 = TObjectList<TMyObj1095>;

  TMyObj1095_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1095_List1 = TObjectList<TMyObj1095_1>;
...
constructor TMyObj1095_1.Create;
begin
  inherited;
  FInt := 1095 * 3;
  FTest := 'Value: ' + Random(210952).ToString + Random(109500).ToString;
end;

procedure TForm1095.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1095;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1095_List0 := TMyObj1095_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1095_List1 := TMyObj1095_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
