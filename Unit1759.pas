...
type
  ...
  TMyObj1759_List0 = TObjectList<TMyObj1759>;

  TMyObj1759_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1759_List1 = TObjectList<TMyObj1759_1>;
...
constructor TMyObj1759_1.Create;
begin
  inherited;
  FInt := 1759 * 3;
  FTest := 'Value: ' + Random(217592).ToString + Random(175900).ToString;
end;

procedure TForm1759.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1759;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1759_List0 := TMyObj1759_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1759_List1 := TMyObj1759_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
