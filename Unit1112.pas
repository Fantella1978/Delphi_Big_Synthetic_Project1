...
type
  ...
  TMyObj1112_List0 = TObjectList<TMyObj1112>;

  TMyObj1112_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1112_List1 = TObjectList<TMyObj1112_1>;
...
constructor TMyObj1112_1.Create;
begin
  inherited;
  FInt := 1112 * 3;
  FTest := 'Value: ' + Random(211122).ToString + Random(111200).ToString;
end;

procedure TForm1112.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1112;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1112_List0 := TMyObj1112_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1112_List1 := TMyObj1112_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
