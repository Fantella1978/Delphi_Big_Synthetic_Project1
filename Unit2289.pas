...
type
  ...
  TMyObj2289_List0 = TObjectList<TMyObj2289>;

  TMyObj2289_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2289_List1 = TObjectList<TMyObj2289_1>;
...
constructor TMyObj2289_1.Create;
begin
  inherited;
  FInt := 2289 * 3;
  FTest := 'Value: ' + Random(222892).ToString + Random(228900).ToString;
end;

procedure TForm2289.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2289;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2289_List0 := TMyObj2289_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2289_List1 := TMyObj2289_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
