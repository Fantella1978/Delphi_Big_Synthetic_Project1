...
type
  ...
  TMyObj1938_List0 = TObjectList<TMyObj1938>;

  TMyObj1938_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1938_List1 = TObjectList<TMyObj1938_1>;
...
constructor TMyObj1938_1.Create;
begin
  inherited;
  FInt := 1938 * 3;
  FTest := 'Value: ' + Random(219382).ToString + Random(193800).ToString;
end;

procedure TForm1938.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1938;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1938_List0 := TMyObj1938_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1938_List1 := TMyObj1938_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
