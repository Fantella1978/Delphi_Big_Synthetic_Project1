...
type
  ...
  TMyObj1901_List0 = TObjectList<TMyObj1901>;

  TMyObj1901_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1901_List1 = TObjectList<TMyObj1901_1>;
...
constructor TMyObj1901_1.Create;
begin
  inherited;
  FInt := 1901 * 3;
  FTest := 'Value: ' + Random(219012).ToString + Random(190100).ToString;
end;

procedure TForm1901.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1901;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1901_List0 := TMyObj1901_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1901_List1 := TMyObj1901_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
