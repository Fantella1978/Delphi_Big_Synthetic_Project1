...
type
  ...
  TMyObj2_List0 = TObjectList<TMyObj2>;

  TMyObj2_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2_List1 = TObjectList<TMyObj2_1>;
...
constructor TMyObj2_1.Create;
begin
  inherited;
  FInt := 2 * 3;
  FTest := 'Value: ' + Random(222).ToString + Random(200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(25).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(27).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2_List0 := TMyObj2_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2_List1 := TMyObj2_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
