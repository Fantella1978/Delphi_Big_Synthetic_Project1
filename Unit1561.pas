...
type
  ...
  TMyObj1561_List0 = TObjectList<TMyObj1561>;

  TMyObj1561_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1561_List1 = TObjectList<TMyObj1561_1>;
...
constructor TMyObj1561_1.Create;
begin
  inherited;
  FInt := 1561 * 3;
  FTest := 'Value: ' + Random(215612).ToString + Random(156100).ToString;
end;

procedure TForm1561.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1561;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1561_List0 := TMyObj1561_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1561_List1 := TMyObj1561_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
