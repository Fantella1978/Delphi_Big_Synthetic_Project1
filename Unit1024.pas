...
type
  ...
  TMyObj1024_List0 = TObjectList<TMyObj1024>;

  TMyObj1024_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1024_List1 = TObjectList<TMyObj1024_1>;
...
constructor TMyObj1024_1.Create;
begin
  inherited;
  FInt := 1024 * 3;
  FTest := 'Value: ' + Random(210242).ToString + Random(102400).ToString;
end;

procedure TForm1024.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1024;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1024_List0 := TMyObj1024_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1024_List1 := TMyObj1024_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
