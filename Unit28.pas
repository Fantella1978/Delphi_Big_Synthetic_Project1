...
type
  ...
  TMyObj28_List0 = TObjectList<TMyObj28>;

  TMyObj28_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj28_List1 = TObjectList<TMyObj28_1>;
...
constructor TMyObj28_1.Create;
begin
  inherited;
  FInt := 28 * 3;
  FTest := 'Value: ' + Random(2282).ToString + Random(2800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj28_List0 := TMyObj28_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj28_List1 := TMyObj28_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
