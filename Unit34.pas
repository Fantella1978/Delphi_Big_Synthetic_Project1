...
type
  ...
  TMyObj34_List0 = TObjectList<TMyObj34>;

  TMyObj34_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj34_List1 = TObjectList<TMyObj34_1>;
...
constructor TMyObj34_1.Create;
begin
  inherited;
  FInt := 34 * 3;
  FTest := 'Value: ' + Random(2342).ToString + Random(3400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj34_List0 := TMyObj34_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj34_List1 := TMyObj34_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
