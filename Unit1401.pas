...
type
  ...
  TMyObj1401_List0 = TObjectList<TMyObj1401>;

  TMyObj1401_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1401_List1 = TObjectList<TMyObj1401_1>;
...
constructor TMyObj1401_1.Create;
begin
  inherited;
  FInt := 1401 * 3;
  FTest := 'Value: ' + Random(214012).ToString + Random(140100).ToString;
end;

procedure TForm1401.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1401;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1401_List0 := TMyObj1401_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1401_List1 := TMyObj1401_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
