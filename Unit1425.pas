...
type
  ...
  TMyObj1425_List0 = TObjectList<TMyObj1425>;

  TMyObj1425_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1425_List1 = TObjectList<TMyObj1425_1>;
...
constructor TMyObj1425_1.Create;
begin
  inherited;
  FInt := 1425 * 3;
  FTest := 'Value: ' + Random(214252).ToString + Random(142500).ToString;
end;

procedure TForm1425.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1425;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1425_List0 := TMyObj1425_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1425_List1 := TMyObj1425_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
