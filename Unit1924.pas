...
type
  ...
  TMyObj1924_List0 = TObjectList<TMyObj1924>;

  TMyObj1924_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1924_List1 = TObjectList<TMyObj1924_1>;
...
constructor TMyObj1924_1.Create;
begin
  inherited;
  FInt := 1924 * 3;
  FTest := 'Value: ' + Random(219242).ToString + Random(192400).ToString;
end;

procedure TForm1924.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1924;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1924_List0 := TMyObj1924_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1924_List1 := TMyObj1924_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
