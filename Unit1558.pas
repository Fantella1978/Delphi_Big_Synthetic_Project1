...
type
  ...
  TMyObj1558_List0 = TObjectList<TMyObj1558>;

  TMyObj1558_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1558_List1 = TObjectList<TMyObj1558_1>;
...
constructor TMyObj1558_1.Create;
begin
  inherited;
  FInt := 1558 * 3;
  FTest := 'Value: ' + Random(215582).ToString + Random(155800).ToString;
end;

procedure TForm1558.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1558;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1558_List0 := TMyObj1558_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1558_List1 := TMyObj1558_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
