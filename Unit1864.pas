...
type
  ...
  TMyObj1864_List0 = TObjectList<TMyObj1864>;

  TMyObj1864_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1864_List1 = TObjectList<TMyObj1864_1>;
...
constructor TMyObj1864_1.Create;
begin
  inherited;
  FInt := 1864 * 3;
  FTest := 'Value: ' + Random(218642).ToString + Random(186400).ToString;
end;

procedure TForm1864.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1864;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1864_List0 := TMyObj1864_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1864_List1 := TMyObj1864_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
