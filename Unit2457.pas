...
type
  ...
  TMyObj2457_List0 = TObjectList<TMyObj2457>;

  TMyObj2457_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2457_List1 = TObjectList<TMyObj2457_1>;
...
constructor TMyObj2457_1.Create;
begin
  inherited;
  FInt := 2457 * 3;
  FTest := 'Value: ' + Random(224572).ToString + Random(245700).ToString;
end;

procedure TForm2457.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2457;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2457_List0 := TMyObj2457_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2457_List1 := TMyObj2457_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
