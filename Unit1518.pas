...
type
  ...
  TMyObj1518_List0 = TObjectList<TMyObj1518>;

  TMyObj1518_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1518_List1 = TObjectList<TMyObj1518_1>;
...
constructor TMyObj1518_1.Create;
begin
  inherited;
  FInt := 1518 * 3;
  FTest := 'Value: ' + Random(215182).ToString + Random(151800).ToString;
end;

procedure TForm1518.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1518;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1518_List0 := TMyObj1518_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1518_List1 := TMyObj1518_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
