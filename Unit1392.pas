...
type
  ...
  TMyObj1392_List0 = TObjectList<TMyObj1392>;

  TMyObj1392_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1392_List1 = TObjectList<TMyObj1392_1>;
...
constructor TMyObj1392_1.Create;
begin
  inherited;
  FInt := 1392 * 3;
  FTest := 'Value: ' + Random(213922).ToString + Random(139200).ToString;
end;

procedure TForm1392.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1392;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1392_List0 := TMyObj1392_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1392_List1 := TMyObj1392_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
