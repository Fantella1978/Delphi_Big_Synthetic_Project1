...
type
  ...
  TMyObj769_List0 = TObjectList<TMyObj769>;

  TMyObj769_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj769_List1 = TObjectList<TMyObj769_1>;
...
constructor TMyObj769_1.Create;
begin
  inherited;
  FInt := 769 * 3;
  FTest := 'Value: ' + Random(27692).ToString + Random(76900).ToString;
end;

procedure TForm769.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum769;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj769_List0 := TMyObj769_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj769_List1 := TMyObj769_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
