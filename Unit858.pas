...
type
  ...
  TMyObj858_List0 = TObjectList<TMyObj858>;

  TMyObj858_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj858_List1 = TObjectList<TMyObj858_1>;
...
constructor TMyObj858_1.Create;
begin
  inherited;
  FInt := 858 * 3;
  FTest := 'Value: ' + Random(28582).ToString + Random(85800).ToString;
end;

procedure TForm858.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum858;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj858_List0 := TMyObj858_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj858_List1 := TMyObj858_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
