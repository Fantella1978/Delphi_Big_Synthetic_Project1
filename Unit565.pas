...
type
  ...
  TMyObj565_List0 = TObjectList<TMyObj565>;

  TMyObj565_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj565_List1 = TObjectList<TMyObj565_1>;
...
constructor TMyObj565_1.Create;
begin
  inherited;
  FInt := 565 * 3;
  FTest := 'Value: ' + Random(25652).ToString + Random(56500).ToString;
end;

procedure TForm565.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum565;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj565_List0 := TMyObj565_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj565_List1 := TMyObj565_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
