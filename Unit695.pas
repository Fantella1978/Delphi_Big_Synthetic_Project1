...
type
  ...
  TMyObj695_List0 = TObjectList<TMyObj695>;

  TMyObj695_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj695_List1 = TObjectList<TMyObj695_1>;
...
constructor TMyObj695_1.Create;
begin
  inherited;
  FInt := 695 * 3;
  FTest := 'Value: ' + Random(26952).ToString + Random(69500).ToString;
end;

procedure TForm695.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum695;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj695_List0 := TMyObj695_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj695_List1 := TMyObj695_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
