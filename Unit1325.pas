...
type
  ...
  TMyObj1325_List0 = TObjectList<TMyObj1325>;

  TMyObj1325_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1325_List1 = TObjectList<TMyObj1325_1>;
...
constructor TMyObj1325_1.Create;
begin
  inherited;
  FInt := 1325 * 3;
  FTest := 'Value: ' + Random(213252).ToString + Random(132500).ToString;
end;

procedure TForm1325.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1325;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1325_List0 := TMyObj1325_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1325_List1 := TMyObj1325_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
