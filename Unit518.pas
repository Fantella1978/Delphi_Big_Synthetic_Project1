...
type
  ...
  TMyObj518_List0 = TObjectList<TMyObj518>;

  TMyObj518_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj518_List1 = TObjectList<TMyObj518_1>;
...
constructor TMyObj518_1.Create;
begin
  inherited;
  FInt := 518 * 3;
  FTest := 'Value: ' + Random(25182).ToString + Random(51800).ToString;
end;

procedure TForm518.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum518;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj518_List0 := TMyObj518_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj518_List1 := TMyObj518_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
