...
type
  ...
  TMyObj459_List0 = TObjectList<TMyObj459>;

  TMyObj459_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj459_List1 = TObjectList<TMyObj459_1>;
...
constructor TMyObj459_1.Create;
begin
  inherited;
  FInt := 459 * 3;
  FTest := 'Value: ' + Random(24592).ToString + Random(45900).ToString;
end;

procedure TForm459.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum459;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj459_List0 := TMyObj459_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj459_List1 := TMyObj459_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
