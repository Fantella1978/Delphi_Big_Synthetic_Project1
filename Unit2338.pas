...
type
  ...
  TMyObj2338_List0 = TObjectList<TMyObj2338>;

  TMyObj2338_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2338_List1 = TObjectList<TMyObj2338_1>;
...
constructor TMyObj2338_1.Create;
begin
  inherited;
  FInt := 2338 * 3;
  FTest := 'Value: ' + Random(223382).ToString + Random(233800).ToString;
end;

procedure TForm2338.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2338;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2338_List0 := TMyObj2338_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2338_List1 := TMyObj2338_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
