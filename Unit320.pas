...
type
  ...
  TMyObj320_List0 = TObjectList<TMyObj320>;

  TMyObj320_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj320_List1 = TObjectList<TMyObj320_1>;
...
constructor TMyObj320_1.Create;
begin
  inherited;
  FInt := 320 * 3;
  FTest := 'Value: ' + Random(23202).ToString + Random(32000).ToString;
end;

procedure TForm320.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum320;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj320_List0 := TMyObj320_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj320_List1 := TMyObj320_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
