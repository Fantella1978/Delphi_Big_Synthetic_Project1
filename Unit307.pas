...
type
  ...
  TMyObj307_List0 = TObjectList<TMyObj307>;

  TMyObj307_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj307_List1 = TObjectList<TMyObj307_1>;
...
constructor TMyObj307_1.Create;
begin
  inherited;
  FInt := 307 * 3;
  FTest := 'Value: ' + Random(23072).ToString + Random(30700).ToString;
end;

procedure TForm307.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum307;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj307_List0 := TMyObj307_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj307_List1 := TMyObj307_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
