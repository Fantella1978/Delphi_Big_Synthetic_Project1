...
type
  ...
  TMyObj495_List0 = TObjectList<TMyObj495>;

  TMyObj495_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj495_List1 = TObjectList<TMyObj495_1>;
...
constructor TMyObj495_1.Create;
begin
  inherited;
  FInt := 495 * 3;
  FTest := 'Value: ' + Random(24952).ToString + Random(49500).ToString;
end;

procedure TForm495.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum495;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj495_List0 := TMyObj495_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj495_List1 := TMyObj495_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
