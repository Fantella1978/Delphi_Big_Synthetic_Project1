...
type
  ...
  TMyObj1198_List0 = TObjectList<TMyObj1198>;

  TMyObj1198_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1198_List1 = TObjectList<TMyObj1198_1>;
...
constructor TMyObj1198_1.Create;
begin
  inherited;
  FInt := 1198 * 3;
  FTest := 'Value: ' + Random(211982).ToString + Random(119800).ToString;
end;

procedure TForm1198.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1198;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1198_List0 := TMyObj1198_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1198_List1 := TMyObj1198_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
