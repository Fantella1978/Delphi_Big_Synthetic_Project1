...
type
  ...
  TMyObj1869_List0 = TObjectList<TMyObj1869>;

  TMyObj1869_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1869_List1 = TObjectList<TMyObj1869_1>;
...
constructor TMyObj1869_1.Create;
begin
  inherited;
  FInt := 1869 * 3;
  FTest := 'Value: ' + Random(218692).ToString + Random(186900).ToString;
end;

procedure TForm1869.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1869;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1869_List0 := TMyObj1869_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1869_List1 := TMyObj1869_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
