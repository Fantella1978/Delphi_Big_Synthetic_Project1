...
type
  ...
  TMyObj1597_List0 = TObjectList<TMyObj1597>;

  TMyObj1597_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1597_List1 = TObjectList<TMyObj1597_1>;
...
constructor TMyObj1597_1.Create;
begin
  inherited;
  FInt := 1597 * 3;
  FTest := 'Value: ' + Random(215972).ToString + Random(159700).ToString;
end;

procedure TForm1597.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1597;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1597_List0 := TMyObj1597_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1597_List1 := TMyObj1597_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
