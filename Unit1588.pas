...
type
  ...
  TMyObj1588_List0 = TObjectList<TMyObj1588>;

  TMyObj1588_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1588_List1 = TObjectList<TMyObj1588_1>;
...
constructor TMyObj1588_1.Create;
begin
  inherited;
  FInt := 1588 * 3;
  FTest := 'Value: ' + Random(215882).ToString + Random(158800).ToString;
end;

procedure TForm1588.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1588;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1588_List0 := TMyObj1588_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1588_List1 := TMyObj1588_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
