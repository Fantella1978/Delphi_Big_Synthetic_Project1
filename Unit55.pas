...
type
  ...
  TMyObj55_List0 = TObjectList<TMyObj55>;

  TMyObj55_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj55_List1 = TObjectList<TMyObj55_1>;
...
constructor TMyObj55_1.Create;
begin
  inherited;
  FInt := 55 * 3;
  FTest := 'Value: ' + Random(2552).ToString + Random(5500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj55_List0 := TMyObj55_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj55_List1 := TMyObj55_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
