...
type
  ...
  TMyObj1040_List0 = TObjectList<TMyObj1040>;

  TMyObj1040_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1040_List1 = TObjectList<TMyObj1040_1>;
...
constructor TMyObj1040_1.Create;
begin
  inherited;
  FInt := 1040 * 3;
  FTest := 'Value: ' + Random(210402).ToString + Random(104000).ToString;
end;

procedure TForm1040.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1040;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1040_List0 := TMyObj1040_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1040_List1 := TMyObj1040_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
