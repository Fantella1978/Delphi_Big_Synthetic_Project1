...
type
  ...
  TMyObj1748_List0 = TObjectList<TMyObj1748>;

  TMyObj1748_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1748_List1 = TObjectList<TMyObj1748_1>;
...
constructor TMyObj1748_1.Create;
begin
  inherited;
  FInt := 1748 * 3;
  FTest := 'Value: ' + Random(217482).ToString + Random(174800).ToString;
end;

procedure TForm1748.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1748;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1748_List0 := TMyObj1748_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1748_List1 := TMyObj1748_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
