...
type
  ...
  TMyObj1641_List0 = TObjectList<TMyObj1641>;

  TMyObj1641_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1641_List1 = TObjectList<TMyObj1641_1>;
...
constructor TMyObj1641_1.Create;
begin
  inherited;
  FInt := 1641 * 3;
  FTest := 'Value: ' + Random(216412).ToString + Random(164100).ToString;
end;

procedure TForm1641.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1641;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1641_List0 := TMyObj1641_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1641_List1 := TMyObj1641_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
