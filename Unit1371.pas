...
type
  ...
  TMyObj1371_List0 = TObjectList<TMyObj1371>;

  TMyObj1371_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1371_List1 = TObjectList<TMyObj1371_1>;
...
constructor TMyObj1371_1.Create;
begin
  inherited;
  FInt := 1371 * 3;
  FTest := 'Value: ' + Random(213712).ToString + Random(137100).ToString;
end;

procedure TForm1371.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1371;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1371_List0 := TMyObj1371_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1371_List1 := TMyObj1371_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
