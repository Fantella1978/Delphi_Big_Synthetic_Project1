...
type
  ...
  TMyObj563_List0 = TObjectList<TMyObj563>;

  TMyObj563_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj563_List1 = TObjectList<TMyObj563_1>;
...
constructor TMyObj563_1.Create;
begin
  inherited;
  FInt := 563 * 3;
  FTest := 'Value: ' + Random(25632).ToString + Random(56300).ToString;
end;

procedure TForm563.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum563;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj563_List0 := TMyObj563_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj563_List1 := TMyObj563_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
