...
type
  ...
  TMyObj961_List0 = TObjectList<TMyObj961>;

  TMyObj961_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj961_List1 = TObjectList<TMyObj961_1>;
...
constructor TMyObj961_1.Create;
begin
  inherited;
  FInt := 961 * 3;
  FTest := 'Value: ' + Random(29612).ToString + Random(96100).ToString;
end;

procedure TForm961.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum961;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj961_List0 := TMyObj961_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj961_List1 := TMyObj961_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
