...
type
  ...
  TMyObj2265_List0 = TObjectList<TMyObj2265>;

  TMyObj2265_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2265_List1 = TObjectList<TMyObj2265_1>;
...
constructor TMyObj2265_1.Create;
begin
  inherited;
  FInt := 2265 * 3;
  FTest := 'Value: ' + Random(222652).ToString + Random(226500).ToString;
end;

procedure TForm2265.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2265;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2265_List0 := TMyObj2265_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2265_List1 := TMyObj2265_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
