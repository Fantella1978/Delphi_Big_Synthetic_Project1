...
type
  ...
  TMyObj1902_List0 = TObjectList<TMyObj1902>;

  TMyObj1902_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1902_List1 = TObjectList<TMyObj1902_1>;
...
constructor TMyObj1902_1.Create;
begin
  inherited;
  FInt := 1902 * 3;
  FTest := 'Value: ' + Random(219022).ToString + Random(190200).ToString;
end;

procedure TForm1902.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1902;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1902_List0 := TMyObj1902_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1902_List1 := TMyObj1902_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
