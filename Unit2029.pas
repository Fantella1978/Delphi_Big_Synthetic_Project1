...
type
  ...
  TMyObj2029_List0 = TObjectList<TMyObj2029>;

  TMyObj2029_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2029_List1 = TObjectList<TMyObj2029_1>;
...
constructor TMyObj2029_1.Create;
begin
  inherited;
  FInt := 2029 * 3;
  FTest := 'Value: ' + Random(220292).ToString + Random(202900).ToString;
end;

procedure TForm2029.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2029;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2029_List0 := TMyObj2029_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2029_List1 := TMyObj2029_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
