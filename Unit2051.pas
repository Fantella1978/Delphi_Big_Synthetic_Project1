...
type
  ...
  TMyObj2051_List0 = TObjectList<TMyObj2051>;

  TMyObj2051_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2051_List1 = TObjectList<TMyObj2051_1>;
...
constructor TMyObj2051_1.Create;
begin
  inherited;
  FInt := 2051 * 3;
  FTest := 'Value: ' + Random(220512).ToString + Random(205100).ToString;
end;

procedure TForm2051.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2051;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2051_List0 := TMyObj2051_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2051_List1 := TMyObj2051_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
