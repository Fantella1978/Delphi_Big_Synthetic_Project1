...
type
  ...
  TMyObj839_List0 = TObjectList<TMyObj839>;

  TMyObj839_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj839_List1 = TObjectList<TMyObj839_1>;
...
constructor TMyObj839_1.Create;
begin
  inherited;
  FInt := 839 * 3;
  FTest := 'Value: ' + Random(28392).ToString + Random(83900).ToString;
end;

procedure TForm839.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum839;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj839_List0 := TMyObj839_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj839_List1 := TMyObj839_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
