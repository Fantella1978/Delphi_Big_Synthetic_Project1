...
type
  ...
  TMyObj2023_List0 = TObjectList<TMyObj2023>;

  TMyObj2023_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2023_List1 = TObjectList<TMyObj2023_1>;
...
constructor TMyObj2023_1.Create;
begin
  inherited;
  FInt := 2023 * 3;
  FTest := 'Value: ' + Random(220232).ToString + Random(202300).ToString;
end;

procedure TForm2023.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2023;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2023_List0 := TMyObj2023_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2023_List1 := TMyObj2023_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
