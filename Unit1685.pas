...
type
  ...
  TMyObj1685_List0 = TObjectList<TMyObj1685>;

  TMyObj1685_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1685_List1 = TObjectList<TMyObj1685_1>;
...
constructor TMyObj1685_1.Create;
begin
  inherited;
  FInt := 1685 * 3;
  FTest := 'Value: ' + Random(216852).ToString + Random(168500).ToString;
end;

procedure TForm1685.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1685;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1685_List0 := TMyObj1685_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1685_List1 := TMyObj1685_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
