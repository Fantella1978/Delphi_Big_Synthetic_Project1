...
type
  ...
  TMyObj94_List0 = TObjectList<TMyObj94>;

  TMyObj94_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj94_List1 = TObjectList<TMyObj94_1>;
...
constructor TMyObj94_1.Create;
begin
  inherited;
  FInt := 94 * 3;
  FTest := 'Value: ' + Random(2942).ToString + Random(9400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj94_List0 := TMyObj94_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj94_List1 := TMyObj94_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
