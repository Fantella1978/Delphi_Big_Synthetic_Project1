...
type
  ...
  TMyObj1082_List0 = TObjectList<TMyObj1082>;

  TMyObj1082_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1082_List1 = TObjectList<TMyObj1082_1>;
...
constructor TMyObj1082_1.Create;
begin
  inherited;
  FInt := 1082 * 3;
  FTest := 'Value: ' + Random(210822).ToString + Random(108200).ToString;
end;

procedure TForm1082.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1082;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1082_List0 := TMyObj1082_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1082_List1 := TMyObj1082_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
