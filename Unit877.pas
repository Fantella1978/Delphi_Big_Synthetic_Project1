...
type
  ...
  TMyObj877_List0 = TObjectList<TMyObj877>;

  TMyObj877_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj877_List1 = TObjectList<TMyObj877_1>;
...
constructor TMyObj877_1.Create;
begin
  inherited;
  FInt := 877 * 3;
  FTest := 'Value: ' + Random(28772).ToString + Random(87700).ToString;
end;

procedure TForm877.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum877;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj877_List0 := TMyObj877_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj877_List1 := TMyObj877_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
