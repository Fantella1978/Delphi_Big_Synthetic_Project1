...
type
  ...
  TMyObj1158_List0 = TObjectList<TMyObj1158>;

  TMyObj1158_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1158_List1 = TObjectList<TMyObj1158_1>;
...
constructor TMyObj1158_1.Create;
begin
  inherited;
  FInt := 1158 * 3;
  FTest := 'Value: ' + Random(211582).ToString + Random(115800).ToString;
end;

procedure TForm1158.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1158;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1158_List0 := TMyObj1158_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1158_List1 := TMyObj1158_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
