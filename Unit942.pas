...
type
  ...
  TMyObj942_List0 = TObjectList<TMyObj942>;

  TMyObj942_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj942_List1 = TObjectList<TMyObj942_1>;
...
constructor TMyObj942_1.Create;
begin
  inherited;
  FInt := 942 * 3;
  FTest := 'Value: ' + Random(29422).ToString + Random(94200).ToString;
end;

procedure TForm942.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum942;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj942_List0 := TMyObj942_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj942_List1 := TMyObj942_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
