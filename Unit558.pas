...
type
  ...
  TMyObj558_List0 = TObjectList<TMyObj558>;

  TMyObj558_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj558_List1 = TObjectList<TMyObj558_1>;
...
constructor TMyObj558_1.Create;
begin
  inherited;
  FInt := 558 * 3;
  FTest := 'Value: ' + Random(25582).ToString + Random(55800).ToString;
end;

procedure TForm558.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum558;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj558_List0 := TMyObj558_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj558_List1 := TMyObj558_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
