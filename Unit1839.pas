...
type
  ...
  TMyObj1839_List0 = TObjectList<TMyObj1839>;

  TMyObj1839_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1839_List1 = TObjectList<TMyObj1839_1>;
...
constructor TMyObj1839_1.Create;
begin
  inherited;
  FInt := 1839 * 3;
  FTest := 'Value: ' + Random(218392).ToString + Random(183900).ToString;
end;

procedure TForm1839.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1839;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1839_List0 := TMyObj1839_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1839_List1 := TMyObj1839_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
