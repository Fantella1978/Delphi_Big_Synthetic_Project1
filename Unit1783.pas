...
type
  ...
  TMyObj1783_List0 = TObjectList<TMyObj1783>;

  TMyObj1783_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1783_List1 = TObjectList<TMyObj1783_1>;
...
constructor TMyObj1783_1.Create;
begin
  inherited;
  FInt := 1783 * 3;
  FTest := 'Value: ' + Random(217832).ToString + Random(178300).ToString;
end;

procedure TForm1783.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1783;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1783_List0 := TMyObj1783_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1783_List1 := TMyObj1783_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
