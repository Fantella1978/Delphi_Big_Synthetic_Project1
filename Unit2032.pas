...
type
  ...
  TMyObj2032_List0 = TObjectList<TMyObj2032>;

  TMyObj2032_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2032_List1 = TObjectList<TMyObj2032_1>;
...
constructor TMyObj2032_1.Create;
begin
  inherited;
  FInt := 2032 * 3;
  FTest := 'Value: ' + Random(220322).ToString + Random(203200).ToString;
end;

procedure TForm2032.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2032;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2032_List0 := TMyObj2032_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2032_List1 := TMyObj2032_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
