...
type
  ...
  TMyObj341_List0 = TObjectList<TMyObj341>;

  TMyObj341_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj341_List1 = TObjectList<TMyObj341_1>;
...
constructor TMyObj341_1.Create;
begin
  inherited;
  FInt := 341 * 3;
  FTest := 'Value: ' + Random(23412).ToString + Random(34100).ToString;
end;

procedure TForm341.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum341;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj341_List0 := TMyObj341_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj341_List1 := TMyObj341_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
