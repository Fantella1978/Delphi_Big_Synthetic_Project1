...
type
  ...
  TMyObj239_List0 = TObjectList<TMyObj239>;

  TMyObj239_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj239_List1 = TObjectList<TMyObj239_1>;
...
constructor TMyObj239_1.Create;
begin
  inherited;
  FInt := 239 * 3;
  FTest := 'Value: ' + Random(22392).ToString + Random(23900).ToString;
end;

procedure TForm239.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum239;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj239_List0 := TMyObj239_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj239_List1 := TMyObj239_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
