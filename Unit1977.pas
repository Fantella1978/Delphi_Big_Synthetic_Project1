...
type
  ...
  TMyObj1977_List0 = TObjectList<TMyObj1977>;

  TMyObj1977_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1977_List1 = TObjectList<TMyObj1977_1>;
...
constructor TMyObj1977_1.Create;
begin
  inherited;
  FInt := 1977 * 3;
  FTest := 'Value: ' + Random(219772).ToString + Random(197700).ToString;
end;

procedure TForm1977.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1977;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1977_List0 := TMyObj1977_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1977_List1 := TMyObj1977_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
