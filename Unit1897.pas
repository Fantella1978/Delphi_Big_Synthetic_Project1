...
type
  ...
  TMyObj1897_List0 = TObjectList<TMyObj1897>;

  TMyObj1897_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1897_List1 = TObjectList<TMyObj1897_1>;
...
constructor TMyObj1897_1.Create;
begin
  inherited;
  FInt := 1897 * 3;
  FTest := 'Value: ' + Random(218972).ToString + Random(189700).ToString;
end;

procedure TForm1897.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1897;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1897_List0 := TMyObj1897_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1897_List1 := TMyObj1897_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
