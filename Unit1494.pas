...
type
  ...
  TMyObj1494_List0 = TObjectList<TMyObj1494>;

  TMyObj1494_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1494_List1 = TObjectList<TMyObj1494_1>;
...
constructor TMyObj1494_1.Create;
begin
  inherited;
  FInt := 1494 * 3;
  FTest := 'Value: ' + Random(214942).ToString + Random(149400).ToString;
end;

procedure TForm1494.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1494;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1494_List0 := TMyObj1494_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1494_List1 := TMyObj1494_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
