...
type
  ...
  TMyObj817_List0 = TObjectList<TMyObj817>;

  TMyObj817_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj817_List1 = TObjectList<TMyObj817_1>;
...
constructor TMyObj817_1.Create;
begin
  inherited;
  FInt := 817 * 3;
  FTest := 'Value: ' + Random(28172).ToString + Random(81700).ToString;
end;

procedure TForm817.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum817;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj817_List0 := TMyObj817_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj817_List1 := TMyObj817_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
