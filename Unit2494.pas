...
type
  ...
  TMyObj2494_List0 = TObjectList<TMyObj2494>;

  TMyObj2494_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2494_List1 = TObjectList<TMyObj2494_1>;
...
constructor TMyObj2494_1.Create;
begin
  inherited;
  FInt := 2494 * 3;
  FTest := 'Value: ' + Random(224942).ToString + Random(249400).ToString;
end;

procedure TForm2494.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2494;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2494_List0 := TMyObj2494_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2494_List1 := TMyObj2494_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
