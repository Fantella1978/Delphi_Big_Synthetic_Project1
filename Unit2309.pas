...
type
  ...
  TMyObj2309_List0 = TObjectList<TMyObj2309>;

  TMyObj2309_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2309_List1 = TObjectList<TMyObj2309_1>;
...
constructor TMyObj2309_1.Create;
begin
  inherited;
  FInt := 2309 * 3;
  FTest := 'Value: ' + Random(223092).ToString + Random(230900).ToString;
end;

procedure TForm2309.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2309;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2309_List0 := TMyObj2309_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2309_List1 := TMyObj2309_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
