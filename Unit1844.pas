...
type
  ...
  TMyObj1844_List0 = TObjectList<TMyObj1844>;

  TMyObj1844_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1844_List1 = TObjectList<TMyObj1844_1>;
...
constructor TMyObj1844_1.Create;
begin
  inherited;
  FInt := 1844 * 3;
  FTest := 'Value: ' + Random(218442).ToString + Random(184400).ToString;
end;

procedure TForm1844.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1844;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1844_List0 := TMyObj1844_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1844_List1 := TMyObj1844_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
