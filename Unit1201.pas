...
type
  ...
  TMyObj1201_List0 = TObjectList<TMyObj1201>;

  TMyObj1201_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1201_List1 = TObjectList<TMyObj1201_1>;
...
constructor TMyObj1201_1.Create;
begin
  inherited;
  FInt := 1201 * 3;
  FTest := 'Value: ' + Random(212012).ToString + Random(120100).ToString;
end;

procedure TForm1201.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1201;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1201_List0 := TMyObj1201_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1201_List1 := TMyObj1201_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
