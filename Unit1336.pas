...
type
  ...
  TMyObj1336_List0 = TObjectList<TMyObj1336>;

  TMyObj1336_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1336_List1 = TObjectList<TMyObj1336_1>;
...
constructor TMyObj1336_1.Create;
begin
  inherited;
  FInt := 1336 * 3;
  FTest := 'Value: ' + Random(213362).ToString + Random(133600).ToString;
end;

procedure TForm1336.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1336;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1336_List0 := TMyObj1336_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1336_List1 := TMyObj1336_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
