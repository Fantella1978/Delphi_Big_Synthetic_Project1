...
type
  ...
  TMyObj1961_List0 = TObjectList<TMyObj1961>;

  TMyObj1961_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1961_List1 = TObjectList<TMyObj1961_1>;
...
constructor TMyObj1961_1.Create;
begin
  inherited;
  FInt := 1961 * 3;
  FTest := 'Value: ' + Random(219612).ToString + Random(196100).ToString;
end;

procedure TForm1961.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1961;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1961_List0 := TMyObj1961_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1961_List1 := TMyObj1961_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
