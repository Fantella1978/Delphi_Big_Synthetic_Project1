...
type
  ...
  TMyObj950_List0 = TObjectList<TMyObj950>;

  TMyObj950_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj950_List1 = TObjectList<TMyObj950_1>;
...
constructor TMyObj950_1.Create;
begin
  inherited;
  FInt := 950 * 3;
  FTest := 'Value: ' + Random(29502).ToString + Random(95000).ToString;
end;

procedure TForm950.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum950;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj950_List0 := TMyObj950_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj950_List1 := TMyObj950_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
