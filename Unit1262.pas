...
type
  ...
  TMyObj1262_List0 = TObjectList<TMyObj1262>;

  TMyObj1262_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1262_List1 = TObjectList<TMyObj1262_1>;
...
constructor TMyObj1262_1.Create;
begin
  inherited;
  FInt := 1262 * 3;
  FTest := 'Value: ' + Random(212622).ToString + Random(126200).ToString;
end;

procedure TForm1262.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1262;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1262_List0 := TMyObj1262_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1262_List1 := TMyObj1262_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
