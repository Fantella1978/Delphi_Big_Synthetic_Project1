...
type
  ...
  TMyObj1766_List0 = TObjectList<TMyObj1766>;

  TMyObj1766_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1766_List1 = TObjectList<TMyObj1766_1>;
...
constructor TMyObj1766_1.Create;
begin
  inherited;
  FInt := 1766 * 3;
  FTest := 'Value: ' + Random(217662).ToString + Random(176600).ToString;
end;

procedure TForm1766.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1766;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1766_List0 := TMyObj1766_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1766_List1 := TMyObj1766_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
