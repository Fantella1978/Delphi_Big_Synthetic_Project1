...
type
  ...
  TMyObj2007_List0 = TObjectList<TMyObj2007>;

  TMyObj2007_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2007_List1 = TObjectList<TMyObj2007_1>;
...
constructor TMyObj2007_1.Create;
begin
  inherited;
  FInt := 2007 * 3;
  FTest := 'Value: ' + Random(220072).ToString + Random(200700).ToString;
end;

procedure TForm2007.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2007;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2007_List0 := TMyObj2007_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2007_List1 := TMyObj2007_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
