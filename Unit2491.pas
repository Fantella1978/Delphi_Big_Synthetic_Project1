...
type
  ...
  TMyObj2491_List0 = TObjectList<TMyObj2491>;

  TMyObj2491_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2491_List1 = TObjectList<TMyObj2491_1>;
...
constructor TMyObj2491_1.Create;
begin
  inherited;
  FInt := 2491 * 3;
  FTest := 'Value: ' + Random(224912).ToString + Random(249100).ToString;
end;

procedure TForm2491.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2491;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2491_List0 := TMyObj2491_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2491_List1 := TMyObj2491_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
