...
type
  ...
  TMyObj685_List0 = TObjectList<TMyObj685>;

  TMyObj685_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj685_List1 = TObjectList<TMyObj685_1>;
...
constructor TMyObj685_1.Create;
begin
  inherited;
  FInt := 685 * 3;
  FTest := 'Value: ' + Random(26852).ToString + Random(68500).ToString;
end;

procedure TForm685.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum685;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj685_List0 := TMyObj685_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj685_List1 := TMyObj685_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
