...
type
  ...
  TMyObj2126_List0 = TObjectList<TMyObj2126>;

  TMyObj2126_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2126_List1 = TObjectList<TMyObj2126_1>;
...
constructor TMyObj2126_1.Create;
begin
  inherited;
  FInt := 2126 * 3;
  FTest := 'Value: ' + Random(221262).ToString + Random(212600).ToString;
end;

procedure TForm2126.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2126;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2126_List0 := TMyObj2126_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2126_List1 := TMyObj2126_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
