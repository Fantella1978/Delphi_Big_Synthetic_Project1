...
type
  ...
  TMyObj1074_List0 = TObjectList<TMyObj1074>;

  TMyObj1074_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1074_List1 = TObjectList<TMyObj1074_1>;
...
constructor TMyObj1074_1.Create;
begin
  inherited;
  FInt := 1074 * 3;
  FTest := 'Value: ' + Random(210742).ToString + Random(107400).ToString;
end;

procedure TForm1074.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1074;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1074_List0 := TMyObj1074_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1074_List1 := TMyObj1074_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
