...
type
  ...
  TMyObj57_List0 = TObjectList<TMyObj57>;

  TMyObj57_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj57_List1 = TObjectList<TMyObj57_1>;
...
constructor TMyObj57_1.Create;
begin
  inherited;
  FInt := 57 * 3;
  FTest := 'Value: ' + Random(2572).ToString + Random(5700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj57_List0 := TMyObj57_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj57_List1 := TMyObj57_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
