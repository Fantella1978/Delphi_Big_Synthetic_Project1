...
type
  ...
  TMyObj225_List0 = TObjectList<TMyObj225>;

  TMyObj225_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj225_List1 = TObjectList<TMyObj225_1>;
...
constructor TMyObj225_1.Create;
begin
  inherited;
  FInt := 225 * 3;
  FTest := 'Value: ' + Random(22252).ToString + Random(22500).ToString;
end;

procedure TForm225.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum225;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj225_List0 := TMyObj225_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj225_List1 := TMyObj225_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
