...
type
  ...
  TMyObj1819_List0 = TObjectList<TMyObj1819>;

  TMyObj1819_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1819_List1 = TObjectList<TMyObj1819_1>;
...
constructor TMyObj1819_1.Create;
begin
  inherited;
  FInt := 1819 * 3;
  FTest := 'Value: ' + Random(218192).ToString + Random(181900).ToString;
end;

procedure TForm1819.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1819;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1819_List0 := TMyObj1819_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1819_List1 := TMyObj1819_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
