...
type
  ...
  TMyObj2249_List0 = TObjectList<TMyObj2249>;

  TMyObj2249_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2249_List1 = TObjectList<TMyObj2249_1>;
...
constructor TMyObj2249_1.Create;
begin
  inherited;
  FInt := 2249 * 3;
  FTest := 'Value: ' + Random(222492).ToString + Random(224900).ToString;
end;

procedure TForm2249.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2249;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2249_List0 := TMyObj2249_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2249_List1 := TMyObj2249_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
