...
type
  ...
  TMyObj904_List0 = TObjectList<TMyObj904>;

  TMyObj904_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj904_List1 = TObjectList<TMyObj904_1>;
...
constructor TMyObj904_1.Create;
begin
  inherited;
  FInt := 904 * 3;
  FTest := 'Value: ' + Random(29042).ToString + Random(90400).ToString;
end;

procedure TForm904.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum904;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj904_List0 := TMyObj904_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj904_List1 := TMyObj904_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
