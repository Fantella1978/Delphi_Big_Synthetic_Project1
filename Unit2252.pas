...
type
  ...
  TMyObj2252_List0 = TObjectList<TMyObj2252>;

  TMyObj2252_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2252_List1 = TObjectList<TMyObj2252_1>;
...
constructor TMyObj2252_1.Create;
begin
  inherited;
  FInt := 2252 * 3;
  FTest := 'Value: ' + Random(222522).ToString + Random(225200).ToString;
end;

procedure TForm2252.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2252;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2252_List0 := TMyObj2252_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2252_List1 := TMyObj2252_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
