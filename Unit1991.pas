...
type
  ...
  TMyObj1991_List0 = TObjectList<TMyObj1991>;

  TMyObj1991_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1991_List1 = TObjectList<TMyObj1991_1>;
...
constructor TMyObj1991_1.Create;
begin
  inherited;
  FInt := 1991 * 3;
  FTest := 'Value: ' + Random(219912).ToString + Random(199100).ToString;
end;

procedure TForm1991.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1991;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1991_List0 := TMyObj1991_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1991_List1 := TMyObj1991_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
