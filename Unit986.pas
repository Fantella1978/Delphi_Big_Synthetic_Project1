...
type
  ...
  TMyObj986_List0 = TObjectList<TMyObj986>;

  TMyObj986_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj986_List1 = TObjectList<TMyObj986_1>;
...
constructor TMyObj986_1.Create;
begin
  inherited;
  FInt := 986 * 3;
  FTest := 'Value: ' + Random(29862).ToString + Random(98600).ToString;
end;

procedure TForm986.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum986;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj986_List0 := TMyObj986_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj986_List1 := TMyObj986_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
