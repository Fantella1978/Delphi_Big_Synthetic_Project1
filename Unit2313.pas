...
type
  ...
  TMyObj2313_List0 = TObjectList<TMyObj2313>;

  TMyObj2313_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2313_List1 = TObjectList<TMyObj2313_1>;
...
constructor TMyObj2313_1.Create;
begin
  inherited;
  FInt := 2313 * 3;
  FTest := 'Value: ' + Random(223132).ToString + Random(231300).ToString;
end;

procedure TForm2313.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2313;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2313_List0 := TMyObj2313_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2313_List1 := TMyObj2313_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
