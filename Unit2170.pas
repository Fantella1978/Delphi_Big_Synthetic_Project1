...
type
  ...
  TMyObj2170_List0 = TObjectList<TMyObj2170>;

  TMyObj2170_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2170_List1 = TObjectList<TMyObj2170_1>;
...
constructor TMyObj2170_1.Create;
begin
  inherited;
  FInt := 2170 * 3;
  FTest := 'Value: ' + Random(221702).ToString + Random(217000).ToString;
end;

procedure TForm2170.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2170;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2170_List0 := TMyObj2170_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2170_List1 := TMyObj2170_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
