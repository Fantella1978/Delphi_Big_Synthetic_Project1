...
type
  ...
  TMyObj1451_List0 = TObjectList<TMyObj1451>;

  TMyObj1451_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1451_List1 = TObjectList<TMyObj1451_1>;
...
constructor TMyObj1451_1.Create;
begin
  inherited;
  FInt := 1451 * 3;
  FTest := 'Value: ' + Random(214512).ToString + Random(145100).ToString;
end;

procedure TForm1451.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1451;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1451_List0 := TMyObj1451_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1451_List1 := TMyObj1451_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
