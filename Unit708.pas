...
type
  ...
  TMyObj708_List0 = TObjectList<TMyObj708>;

  TMyObj708_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj708_List1 = TObjectList<TMyObj708_1>;
...
constructor TMyObj708_1.Create;
begin
  inherited;
  FInt := 708 * 3;
  FTest := 'Value: ' + Random(27082).ToString + Random(70800).ToString;
end;

procedure TForm708.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum708;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj708_List0 := TMyObj708_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj708_List1 := TMyObj708_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
