...
type
  ...
  TMyObj2287_List0 = TObjectList<TMyObj2287>;

  TMyObj2287_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2287_List1 = TObjectList<TMyObj2287_1>;
...
constructor TMyObj2287_1.Create;
begin
  inherited;
  FInt := 2287 * 3;
  FTest := 'Value: ' + Random(222872).ToString + Random(228700).ToString;
end;

procedure TForm2287.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2287;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2287_List0 := TMyObj2287_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2287_List1 := TMyObj2287_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
