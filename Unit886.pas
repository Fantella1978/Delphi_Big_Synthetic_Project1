...
type
  ...
  TMyObj886_List0 = TObjectList<TMyObj886>;

  TMyObj886_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj886_List1 = TObjectList<TMyObj886_1>;
...
constructor TMyObj886_1.Create;
begin
  inherited;
  FInt := 886 * 3;
  FTest := 'Value: ' + Random(28862).ToString + Random(88600).ToString;
end;

procedure TForm886.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum886;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj886_List0 := TMyObj886_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj886_List1 := TMyObj886_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
