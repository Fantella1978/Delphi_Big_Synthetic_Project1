...
type
  ...
  TMyObj2392_List0 = TObjectList<TMyObj2392>;

  TMyObj2392_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2392_List1 = TObjectList<TMyObj2392_1>;
...
constructor TMyObj2392_1.Create;
begin
  inherited;
  FInt := 2392 * 3;
  FTest := 'Value: ' + Random(223922).ToString + Random(239200).ToString;
end;

procedure TForm2392.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2392;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2392_List0 := TMyObj2392_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2392_List1 := TMyObj2392_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
