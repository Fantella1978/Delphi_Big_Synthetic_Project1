...
type
  ...
  TMyObj195_List0 = TObjectList<TMyObj195>;

  TMyObj195_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj195_List1 = TObjectList<TMyObj195_1>;
...
constructor TMyObj195_1.Create;
begin
  inherited;
  FInt := 195 * 3;
  FTest := 'Value: ' + Random(21952).ToString + Random(19500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj195_List0 := TMyObj195_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj195_List1 := TMyObj195_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
