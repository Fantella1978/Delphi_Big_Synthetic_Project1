...
type
  ...
  TMyObj546_List0 = TObjectList<TMyObj546>;

  TMyObj546_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj546_List1 = TObjectList<TMyObj546_1>;
...
constructor TMyObj546_1.Create;
begin
  inherited;
  FInt := 546 * 3;
  FTest := 'Value: ' + Random(25462).ToString + Random(54600).ToString;
end;

procedure TForm546.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum546;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj546_List0 := TMyObj546_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj546_List1 := TMyObj546_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
