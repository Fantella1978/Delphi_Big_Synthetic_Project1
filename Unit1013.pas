...
type
  ...
  TMyObj1013_List0 = TObjectList<TMyObj1013>;

  TMyObj1013_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1013_List1 = TObjectList<TMyObj1013_1>;
...
constructor TMyObj1013_1.Create;
begin
  inherited;
  FInt := 1013 * 3;
  FTest := 'Value: ' + Random(210132).ToString + Random(101300).ToString;
end;

procedure TForm1013.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1013;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1013_List0 := TMyObj1013_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1013_List1 := TMyObj1013_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
