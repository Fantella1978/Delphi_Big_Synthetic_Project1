...
type
  ...
  TMyObj574_List0 = TObjectList<TMyObj574>;

  TMyObj574_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj574_List1 = TObjectList<TMyObj574_1>;
...
constructor TMyObj574_1.Create;
begin
  inherited;
  FInt := 574 * 3;
  FTest := 'Value: ' + Random(25742).ToString + Random(57400).ToString;
end;

procedure TForm574.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum574;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj574_List0 := TMyObj574_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj574_List1 := TMyObj574_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
