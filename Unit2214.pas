...
type
  ...
  TMyObj2214_List0 = TObjectList<TMyObj2214>;

  TMyObj2214_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2214_List1 = TObjectList<TMyObj2214_1>;
...
constructor TMyObj2214_1.Create;
begin
  inherited;
  FInt := 2214 * 3;
  FTest := 'Value: ' + Random(222142).ToString + Random(221400).ToString;
end;

procedure TForm2214.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2214;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2214_List0 := TMyObj2214_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2214_List1 := TMyObj2214_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
