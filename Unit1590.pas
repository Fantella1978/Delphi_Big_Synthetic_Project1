...
type
  ...
  TMyObj1590_List0 = TObjectList<TMyObj1590>;

  TMyObj1590_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1590_List1 = TObjectList<TMyObj1590_1>;
...
constructor TMyObj1590_1.Create;
begin
  inherited;
  FInt := 1590 * 3;
  FTest := 'Value: ' + Random(215902).ToString + Random(159000).ToString;
end;

procedure TForm1590.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1590;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1590_List0 := TMyObj1590_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1590_List1 := TMyObj1590_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
