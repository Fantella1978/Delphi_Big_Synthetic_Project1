...
type
  ...
  TMyObj406_List0 = TObjectList<TMyObj406>;

  TMyObj406_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj406_List1 = TObjectList<TMyObj406_1>;
...
constructor TMyObj406_1.Create;
begin
  inherited;
  FInt := 406 * 3;
  FTest := 'Value: ' + Random(24062).ToString + Random(40600).ToString;
end;

procedure TForm406.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum406;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj406_List0 := TMyObj406_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj406_List1 := TMyObj406_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
