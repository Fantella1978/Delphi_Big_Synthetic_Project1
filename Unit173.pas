...
type
  ...
  TMyObj173_List0 = TObjectList<TMyObj173>;

  TMyObj173_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj173_List1 = TObjectList<TMyObj173_1>;
...
constructor TMyObj173_1.Create;
begin
  inherited;
  FInt := 173 * 3;
  FTest := 'Value: ' + Random(21732).ToString + Random(17300).ToString;
end;

procedure TForm173.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum173;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj173_List0 := TMyObj173_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj173_List1 := TMyObj173_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
