...
type
  ...
  TMyObj107_List0 = TObjectList<TMyObj107>;

  TMyObj107_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj107_List1 = TObjectList<TMyObj107_1>;
...
constructor TMyObj107_1.Create;
begin
  inherited;
  FInt := 107 * 3;
  FTest := 'Value: ' + Random(21072).ToString + Random(10700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj107_List0 := TMyObj107_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj107_List1 := TMyObj107_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
