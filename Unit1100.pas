...
type
  ...
  TMyObj1100_List0 = TObjectList<TMyObj1100>;

  TMyObj1100_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1100_List1 = TObjectList<TMyObj1100_1>;
...
constructor TMyObj1100_1.Create;
begin
  inherited;
  FInt := 1100 * 3;
  FTest := 'Value: ' + Random(211002).ToString + Random(110000).ToString;
end;

procedure TForm1100.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1100;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1100_List0 := TMyObj1100_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1100_List1 := TMyObj1100_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
