...
type
  ...
  TMyObj2443_List0 = TObjectList<TMyObj2443>;

  TMyObj2443_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2443_List1 = TObjectList<TMyObj2443_1>;
...
constructor TMyObj2443_1.Create;
begin
  inherited;
  FInt := 2443 * 3;
  FTest := 'Value: ' + Random(224432).ToString + Random(244300).ToString;
end;

procedure TForm2443.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2443;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2443_List0 := TMyObj2443_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2443_List1 := TMyObj2443_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
