...
type
  ...
  TMyObj1742_List0 = TObjectList<TMyObj1742>;

  TMyObj1742_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1742_List1 = TObjectList<TMyObj1742_1>;
...
constructor TMyObj1742_1.Create;
begin
  inherited;
  FInt := 1742 * 3;
  FTest := 'Value: ' + Random(217422).ToString + Random(174200).ToString;
end;

procedure TForm1742.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1742;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1742_List0 := TMyObj1742_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1742_List1 := TMyObj1742_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
