...
type
  ...
  TMyObj2107_List0 = TObjectList<TMyObj2107>;

  TMyObj2107_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2107_List1 = TObjectList<TMyObj2107_1>;
...
constructor TMyObj2107_1.Create;
begin
  inherited;
  FInt := 2107 * 3;
  FTest := 'Value: ' + Random(221072).ToString + Random(210700).ToString;
end;

procedure TForm2107.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2107;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2107_List0 := TMyObj2107_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2107_List1 := TMyObj2107_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
