...
type
  ...
  TMyObj1581_List0 = TObjectList<TMyObj1581>;

  TMyObj1581_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1581_List1 = TObjectList<TMyObj1581_1>;
...
constructor TMyObj1581_1.Create;
begin
  inherited;
  FInt := 1581 * 3;
  FTest := 'Value: ' + Random(215812).ToString + Random(158100).ToString;
end;

procedure TForm1581.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1581;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1581_List0 := TMyObj1581_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1581_List1 := TMyObj1581_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
