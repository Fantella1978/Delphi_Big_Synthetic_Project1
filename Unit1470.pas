...
type
  ...
  TMyObj1470_List0 = TObjectList<TMyObj1470>;

  TMyObj1470_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1470_List1 = TObjectList<TMyObj1470_1>;
...
constructor TMyObj1470_1.Create;
begin
  inherited;
  FInt := 1470 * 3;
  FTest := 'Value: ' + Random(214702).ToString + Random(147000).ToString;
end;

procedure TForm1470.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1470;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1470_List0 := TMyObj1470_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1470_List1 := TMyObj1470_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
