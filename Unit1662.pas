...
type
  ...
  TMyObj1662_List0 = TObjectList<TMyObj1662>;

  TMyObj1662_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1662_List1 = TObjectList<TMyObj1662_1>;
...
constructor TMyObj1662_1.Create;
begin
  inherited;
  FInt := 1662 * 3;
  FTest := 'Value: ' + Random(216622).ToString + Random(166200).ToString;
end;

procedure TForm1662.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1662;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1662_List0 := TMyObj1662_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1662_List1 := TMyObj1662_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
