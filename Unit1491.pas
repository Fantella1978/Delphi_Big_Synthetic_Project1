...
type
  ...
  TMyObj1491_List0 = TObjectList<TMyObj1491>;

  TMyObj1491_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1491_List1 = TObjectList<TMyObj1491_1>;
...
constructor TMyObj1491_1.Create;
begin
  inherited;
  FInt := 1491 * 3;
  FTest := 'Value: ' + Random(214912).ToString + Random(149100).ToString;
end;

procedure TForm1491.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1491;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1491_List0 := TMyObj1491_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1491_List1 := TMyObj1491_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
