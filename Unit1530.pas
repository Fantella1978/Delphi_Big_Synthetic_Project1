...
type
  ...
  TMyObj1530_List0 = TObjectList<TMyObj1530>;

  TMyObj1530_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1530_List1 = TObjectList<TMyObj1530_1>;
...
constructor TMyObj1530_1.Create;
begin
  inherited;
  FInt := 1530 * 3;
  FTest := 'Value: ' + Random(215302).ToString + Random(153000).ToString;
end;

procedure TForm1530.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1530;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1530_List0 := TMyObj1530_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1530_List1 := TMyObj1530_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
