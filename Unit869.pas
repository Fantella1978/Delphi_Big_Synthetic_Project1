...
type
  ...
  TMyObj869_List0 = TObjectList<TMyObj869>;

  TMyObj869_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj869_List1 = TObjectList<TMyObj869_1>;
...
constructor TMyObj869_1.Create;
begin
  inherited;
  FInt := 869 * 3;
  FTest := 'Value: ' + Random(28692).ToString + Random(86900).ToString;
end;

procedure TForm869.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum869;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj869_List0 := TMyObj869_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj869_List1 := TMyObj869_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
