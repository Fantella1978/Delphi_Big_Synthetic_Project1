...
type
  ...
  TMyObj1459_List0 = TObjectList<TMyObj1459>;

  TMyObj1459_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1459_List1 = TObjectList<TMyObj1459_1>;
...
constructor TMyObj1459_1.Create;
begin
  inherited;
  FInt := 1459 * 3;
  FTest := 'Value: ' + Random(214592).ToString + Random(145900).ToString;
end;

procedure TForm1459.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1459;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1459_List0 := TMyObj1459_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1459_List1 := TMyObj1459_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
