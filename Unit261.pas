...
type
  ...
  TMyObj261_List0 = TObjectList<TMyObj261>;

  TMyObj261_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj261_List1 = TObjectList<TMyObj261_1>;
...
constructor TMyObj261_1.Create;
begin
  inherited;
  FInt := 261 * 3;
  FTest := 'Value: ' + Random(22612).ToString + Random(26100).ToString;
end;

procedure TForm261.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum261;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj261_List0 := TMyObj261_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj261_List1 := TMyObj261_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
