...
type
  ...
  TMyObj1284_List0 = TObjectList<TMyObj1284>;

  TMyObj1284_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1284_List1 = TObjectList<TMyObj1284_1>;
...
constructor TMyObj1284_1.Create;
begin
  inherited;
  FInt := 1284 * 3;
  FTest := 'Value: ' + Random(212842).ToString + Random(128400).ToString;
end;

procedure TForm1284.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1284;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1284_List0 := TMyObj1284_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1284_List1 := TMyObj1284_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
