...
type
  ...
  TMyObj674_List0 = TObjectList<TMyObj674>;

  TMyObj674_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj674_List1 = TObjectList<TMyObj674_1>;
...
constructor TMyObj674_1.Create;
begin
  inherited;
  FInt := 674 * 3;
  FTest := 'Value: ' + Random(26742).ToString + Random(67400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj674_List0 := TMyObj674_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj674_List1 := TMyObj674_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
