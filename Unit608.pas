...
type
  ...
  TMyObj608_List0 = TObjectList<TMyObj608>;

  TMyObj608_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj608_List1 = TObjectList<TMyObj608_1>;
...
constructor TMyObj608_1.Create;
begin
  inherited;
  FInt := 608 * 3;
  FTest := 'Value: ' + Random(26082).ToString + Random(60800).ToString;
end;

procedure TForm608.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum608;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj608_List0 := TMyObj608_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj608_List1 := TMyObj608_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
