...
type
  ...
  TMyObj1110_List0 = TObjectList<TMyObj1110>;

  TMyObj1110_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1110_List1 = TObjectList<TMyObj1110_1>;
...
constructor TMyObj1110_1.Create;
begin
  inherited;
  FInt := 1110 * 3;
  FTest := 'Value: ' + Random(211102).ToString + Random(111000).ToString;
end;

procedure TForm1110.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1110;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1110_List0 := TMyObj1110_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1110_List1 := TMyObj1110_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
