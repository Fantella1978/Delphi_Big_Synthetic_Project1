...
type
  ...
  TMyObj480_List0 = TObjectList<TMyObj480>;

  TMyObj480_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj480_List1 = TObjectList<TMyObj480_1>;
...
constructor TMyObj480_1.Create;
begin
  inherited;
  FInt := 480 * 3;
  FTest := 'Value: ' + Random(24802).ToString + Random(48000).ToString;
end;

procedure TForm480.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum480;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj480_List0 := TMyObj480_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj480_List1 := TMyObj480_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
