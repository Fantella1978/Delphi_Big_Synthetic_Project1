...
type
  ...
  TMyObj2440_List0 = TObjectList<TMyObj2440>;

  TMyObj2440_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2440_List1 = TObjectList<TMyObj2440_1>;
...
constructor TMyObj2440_1.Create;
begin
  inherited;
  FInt := 2440 * 3;
  FTest := 'Value: ' + Random(224402).ToString + Random(244000).ToString;
end;

procedure TForm2440.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2440;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2440_List0 := TMyObj2440_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2440_List1 := TMyObj2440_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
