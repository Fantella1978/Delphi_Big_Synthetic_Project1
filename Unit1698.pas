...
type
  ...
  TMyObj1698_List0 = TObjectList<TMyObj1698>;

  TMyObj1698_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1698_List1 = TObjectList<TMyObj1698_1>;
...
constructor TMyObj1698_1.Create;
begin
  inherited;
  FInt := 1698 * 3;
  FTest := 'Value: ' + Random(216982).ToString + Random(169800).ToString;
end;

procedure TForm1698.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1698;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1698_List0 := TMyObj1698_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1698_List1 := TMyObj1698_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
