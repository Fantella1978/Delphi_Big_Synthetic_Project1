...
type
  ...
  TMyObj1143_List0 = TObjectList<TMyObj1143>;

  TMyObj1143_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1143_List1 = TObjectList<TMyObj1143_1>;
...
constructor TMyObj1143_1.Create;
begin
  inherited;
  FInt := 1143 * 3;
  FTest := 'Value: ' + Random(211432).ToString + Random(114300).ToString;
end;

procedure TForm1143.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1143;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1143_List0 := TMyObj1143_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1143_List1 := TMyObj1143_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
