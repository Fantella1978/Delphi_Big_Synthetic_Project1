...
type
  ...
  TMyObj83_List0 = TObjectList<TMyObj83>;

  TMyObj83_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj83_List1 = TObjectList<TMyObj83_1>;
...
constructor TMyObj83_1.Create;
begin
  inherited;
  FInt := 83 * 3;
  FTest := 'Value: ' + Random(2832).ToString + Random(8300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj83_List0 := TMyObj83_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj83_List1 := TMyObj83_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
