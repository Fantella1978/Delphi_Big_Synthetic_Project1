...
type
  ...
  TMyObj1603_List0 = TObjectList<TMyObj1603>;

  TMyObj1603_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1603_List1 = TObjectList<TMyObj1603_1>;
...
constructor TMyObj1603_1.Create;
begin
  inherited;
  FInt := 1603 * 3;
  FTest := 'Value: ' + Random(216032).ToString + Random(160300).ToString;
end;

procedure TForm1603.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1603;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1603_List0 := TMyObj1603_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1603_List1 := TMyObj1603_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
