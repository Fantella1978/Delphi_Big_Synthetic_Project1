...
type
  ...
  TMyObj129_List0 = TObjectList<TMyObj129>;

  TMyObj129_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj129_List1 = TObjectList<TMyObj129_1>;
...
constructor TMyObj129_1.Create;
begin
  inherited;
  FInt := 129 * 3;
  FTest := 'Value: ' + Random(21292).ToString + Random(12900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj129_List0 := TMyObj129_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj129_List1 := TMyObj129_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
