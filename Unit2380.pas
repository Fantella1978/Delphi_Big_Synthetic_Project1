...
type
  ...
  TMyObj2380_List0 = TObjectList<TMyObj2380>;

  TMyObj2380_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2380_List1 = TObjectList<TMyObj2380_1>;
...
constructor TMyObj2380_1.Create;
begin
  inherited;
  FInt := 2380 * 3;
  FTest := 'Value: ' + Random(223802).ToString + Random(238000).ToString;
end;

procedure TForm2380.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2380;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2380_List0 := TMyObj2380_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2380_List1 := TMyObj2380_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
