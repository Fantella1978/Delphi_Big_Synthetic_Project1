...
type
  ...
  TMyObj732_List0 = TObjectList<TMyObj732>;

  TMyObj732_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj732_List1 = TObjectList<TMyObj732_1>;
...
constructor TMyObj732_1.Create;
begin
  inherited;
  FInt := 732 * 3;
  FTest := 'Value: ' + Random(27322).ToString + Random(73200).ToString;
end;

procedure TForm732.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum732;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj732_List0 := TMyObj732_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj732_List1 := TMyObj732_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
