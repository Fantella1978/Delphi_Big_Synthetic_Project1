...
type
  ...
  TMyObj1920_List0 = TObjectList<TMyObj1920>;

  TMyObj1920_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1920_List1 = TObjectList<TMyObj1920_1>;
...
constructor TMyObj1920_1.Create;
begin
  inherited;
  FInt := 1920 * 3;
  FTest := 'Value: ' + Random(219202).ToString + Random(192000).ToString;
end;

procedure TForm1920.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1920;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1920_List0 := TMyObj1920_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1920_List1 := TMyObj1920_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
