...
type
  ...
  TMyObj2072_List0 = TObjectList<TMyObj2072>;

  TMyObj2072_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2072_List1 = TObjectList<TMyObj2072_1>;
...
constructor TMyObj2072_1.Create;
begin
  inherited;
  FInt := 2072 * 3;
  FTest := 'Value: ' + Random(220722).ToString + Random(207200).ToString;
end;

procedure TForm2072.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2072;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2072_List0 := TMyObj2072_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2072_List1 := TMyObj2072_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
