...
type
  ...
  TMyObj1137_List0 = TObjectList<TMyObj1137>;

  TMyObj1137_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1137_List1 = TObjectList<TMyObj1137_1>;
...
constructor TMyObj1137_1.Create;
begin
  inherited;
  FInt := 1137 * 3;
  FTest := 'Value: ' + Random(211372).ToString + Random(113700).ToString;
end;

procedure TForm1137.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1137;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1137_List0 := TMyObj1137_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1137_List1 := TMyObj1137_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
