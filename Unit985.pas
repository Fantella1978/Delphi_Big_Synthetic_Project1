...
type
  ...
  TMyObj985_List0 = TObjectList<TMyObj985>;

  TMyObj985_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj985_List1 = TObjectList<TMyObj985_1>;
...
constructor TMyObj985_1.Create;
begin
  inherited;
  FInt := 985 * 3;
  FTest := 'Value: ' + Random(29852).ToString + Random(98500).ToString;
end;

procedure TForm985.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum985;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj985_List0 := TMyObj985_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj985_List1 := TMyObj985_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
