...
type
  ...
  TMyObj879_List0 = TObjectList<TMyObj879>;

  TMyObj879_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj879_List1 = TObjectList<TMyObj879_1>;
...
constructor TMyObj879_1.Create;
begin
  inherited;
  FInt := 879 * 3;
  FTest := 'Value: ' + Random(28792).ToString + Random(87900).ToString;
end;

procedure TForm879.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum879;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj879_List0 := TMyObj879_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj879_List1 := TMyObj879_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
