...
type
  ...
  TMyObj1113_List0 = TObjectList<TMyObj1113>;

  TMyObj1113_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1113_List1 = TObjectList<TMyObj1113_1>;
...
constructor TMyObj1113_1.Create;
begin
  inherited;
  FInt := 1113 * 3;
  FTest := 'Value: ' + Random(211132).ToString + Random(111300).ToString;
end;

procedure TForm1113.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1113;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1113_List0 := TMyObj1113_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1113_List1 := TMyObj1113_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
