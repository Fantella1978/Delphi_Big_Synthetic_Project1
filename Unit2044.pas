...
type
  ...
  TMyObj2044_List0 = TObjectList<TMyObj2044>;

  TMyObj2044_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2044_List1 = TObjectList<TMyObj2044_1>;
...
constructor TMyObj2044_1.Create;
begin
  inherited;
  FInt := 2044 * 3;
  FTest := 'Value: ' + Random(220442).ToString + Random(204400).ToString;
end;

procedure TForm2044.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2044;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2044_List0 := TMyObj2044_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2044_List1 := TMyObj2044_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
