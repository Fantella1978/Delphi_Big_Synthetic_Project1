...
type
  ...
  TMyObj620_List0 = TObjectList<TMyObj620>;

  TMyObj620_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj620_List1 = TObjectList<TMyObj620_1>;
...
constructor TMyObj620_1.Create;
begin
  inherited;
  FInt := 620 * 3;
  FTest := 'Value: ' + Random(26202).ToString + Random(62000).ToString;
end;

procedure TForm620.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum620;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj620_List0 := TMyObj620_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj620_List1 := TMyObj620_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
