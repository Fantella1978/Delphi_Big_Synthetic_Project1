...
type
  ...
  TMyObj1556_List0 = TObjectList<TMyObj1556>;

  TMyObj1556_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1556_List1 = TObjectList<TMyObj1556_1>;
...
constructor TMyObj1556_1.Create;
begin
  inherited;
  FInt := 1556 * 3;
  FTest := 'Value: ' + Random(215562).ToString + Random(155600).ToString;
end;

procedure TForm1556.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1556;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1556_List0 := TMyObj1556_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1556_List1 := TMyObj1556_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
