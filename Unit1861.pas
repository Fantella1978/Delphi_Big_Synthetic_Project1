...
type
  ...
  TMyObj1861_List0 = TObjectList<TMyObj1861>;

  TMyObj1861_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1861_List1 = TObjectList<TMyObj1861_1>;
...
constructor TMyObj1861_1.Create;
begin
  inherited;
  FInt := 1861 * 3;
  FTest := 'Value: ' + Random(218612).ToString + Random(186100).ToString;
end;

procedure TForm1861.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1861;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1861_List0 := TMyObj1861_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1861_List1 := TMyObj1861_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
