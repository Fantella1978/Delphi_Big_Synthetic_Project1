...
type
  ...
  TMyObj2415_List0 = TObjectList<TMyObj2415>;

  TMyObj2415_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2415_List1 = TObjectList<TMyObj2415_1>;
...
constructor TMyObj2415_1.Create;
begin
  inherited;
  FInt := 2415 * 3;
  FTest := 'Value: ' + Random(224152).ToString + Random(241500).ToString;
end;

procedure TForm2415.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2415;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2415_List0 := TMyObj2415_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2415_List1 := TMyObj2415_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
