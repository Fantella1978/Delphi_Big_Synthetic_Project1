...
type
  ...
  TMyObj815_List0 = TObjectList<TMyObj815>;

  TMyObj815_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj815_List1 = TObjectList<TMyObj815_1>;
...
constructor TMyObj815_1.Create;
begin
  inherited;
  FInt := 815 * 3;
  FTest := 'Value: ' + Random(28152).ToString + Random(81500).ToString;
end;

procedure TForm815.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum815;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj815_List0 := TMyObj815_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj815_List1 := TMyObj815_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
