...
type
  ...
  TMyObj265_List0 = TObjectList<TMyObj265>;

  TMyObj265_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj265_List1 = TObjectList<TMyObj265_1>;
...
constructor TMyObj265_1.Create;
begin
  inherited;
  FInt := 265 * 3;
  FTest := 'Value: ' + Random(22652).ToString + Random(26500).ToString;
end;

procedure TForm265.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum265;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj265_List0 := TMyObj265_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj265_List1 := TMyObj265_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
