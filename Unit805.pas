...
type
  ...
  TMyObj805_List0 = TObjectList<TMyObj805>;

  TMyObj805_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj805_List1 = TObjectList<TMyObj805_1>;
...
constructor TMyObj805_1.Create;
begin
  inherited;
  FInt := 805 * 3;
  FTest := 'Value: ' + Random(28052).ToString + Random(80500).ToString;
end;

procedure TForm805.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum805;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj805_List0 := TMyObj805_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj805_List1 := TMyObj805_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
