...
type
  ...
  TMyObj2156_List0 = TObjectList<TMyObj2156>;

  TMyObj2156_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2156_List1 = TObjectList<TMyObj2156_1>;
...
constructor TMyObj2156_1.Create;
begin
  inherited;
  FInt := 2156 * 3;
  FTest := 'Value: ' + Random(221562).ToString + Random(215600).ToString;
end;

procedure TForm2156.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2156;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2156_List0 := TMyObj2156_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2156_List1 := TMyObj2156_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
