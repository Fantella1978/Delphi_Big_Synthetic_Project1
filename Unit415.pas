...
type
  ...
  TMyObj415_List0 = TObjectList<TMyObj415>;

  TMyObj415_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj415_List1 = TObjectList<TMyObj415_1>;
...
constructor TMyObj415_1.Create;
begin
  inherited;
  FInt := 415 * 3;
  FTest := 'Value: ' + Random(24152).ToString + Random(41500).ToString;
end;

procedure TForm415.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum415;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj415_List0 := TMyObj415_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj415_List1 := TMyObj415_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
