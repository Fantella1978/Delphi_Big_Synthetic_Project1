...
type
  ...
  TMyObj2277_List0 = TObjectList<TMyObj2277>;

  TMyObj2277_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2277_List1 = TObjectList<TMyObj2277_1>;
...
constructor TMyObj2277_1.Create;
begin
  inherited;
  FInt := 2277 * 3;
  FTest := 'Value: ' + Random(222772).ToString + Random(227700).ToString;
end;

procedure TForm2277.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2277;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2277_List0 := TMyObj2277_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2277_List1 := TMyObj2277_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
