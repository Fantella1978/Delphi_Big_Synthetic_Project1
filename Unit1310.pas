...
type
  ...
  TMyObj1310_List0 = TObjectList<TMyObj1310>;

  TMyObj1310_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1310_List1 = TObjectList<TMyObj1310_1>;
...
constructor TMyObj1310_1.Create;
begin
  inherited;
  FInt := 1310 * 3;
  FTest := 'Value: ' + Random(213102).ToString + Random(131000).ToString;
end;

procedure TForm1310.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1310;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1310_List0 := TMyObj1310_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1310_List1 := TMyObj1310_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
