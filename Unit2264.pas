...
type
  ...
  TMyObj2264_List0 = TObjectList<TMyObj2264>;

  TMyObj2264_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2264_List1 = TObjectList<TMyObj2264_1>;
...
constructor TMyObj2264_1.Create;
begin
  inherited;
  FInt := 2264 * 3;
  FTest := 'Value: ' + Random(222642).ToString + Random(226400).ToString;
end;

procedure TForm2264.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2264;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2264_List0 := TMyObj2264_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2264_List1 := TMyObj2264_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
