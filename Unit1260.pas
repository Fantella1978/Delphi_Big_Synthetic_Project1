...
type
  ...
  TMyObj1260_List0 = TObjectList<TMyObj1260>;

  TMyObj1260_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1260_List1 = TObjectList<TMyObj1260_1>;
...
constructor TMyObj1260_1.Create;
begin
  inherited;
  FInt := 1260 * 3;
  FTest := 'Value: ' + Random(212602).ToString + Random(126000).ToString;
end;

procedure TForm1260.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1260;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1260_List0 := TMyObj1260_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1260_List1 := TMyObj1260_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
