...
type
  ...
  TMyObj2348_List0 = TObjectList<TMyObj2348>;

  TMyObj2348_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2348_List1 = TObjectList<TMyObj2348_1>;
...
constructor TMyObj2348_1.Create;
begin
  inherited;
  FInt := 2348 * 3;
  FTest := 'Value: ' + Random(223482).ToString + Random(234800).ToString;
end;

procedure TForm2348.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2348;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2348_List0 := TMyObj2348_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2348_List1 := TMyObj2348_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
