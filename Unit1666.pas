...
type
  ...
  TMyObj1666_List0 = TObjectList<TMyObj1666>;

  TMyObj1666_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1666_List1 = TObjectList<TMyObj1666_1>;
...
constructor TMyObj1666_1.Create;
begin
  inherited;
  FInt := 1666 * 3;
  FTest := 'Value: ' + Random(216662).ToString + Random(166600).ToString;
end;

procedure TForm1666.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1666;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1666_List0 := TMyObj1666_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1666_List1 := TMyObj1666_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
