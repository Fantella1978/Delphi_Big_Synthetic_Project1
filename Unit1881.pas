...
type
  ...
  TMyObj1881_List0 = TObjectList<TMyObj1881>;

  TMyObj1881_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1881_List1 = TObjectList<TMyObj1881_1>;
...
constructor TMyObj1881_1.Create;
begin
  inherited;
  FInt := 1881 * 3;
  FTest := 'Value: ' + Random(218812).ToString + Random(188100).ToString;
end;

procedure TForm1881.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1881;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1881_List0 := TMyObj1881_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1881_List1 := TMyObj1881_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
