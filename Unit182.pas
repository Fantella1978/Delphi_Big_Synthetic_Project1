...
type
  ...
  TMyObj182_List0 = TObjectList<TMyObj182>;

  TMyObj182_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj182_List1 = TObjectList<TMyObj182_1>;
...
constructor TMyObj182_1.Create;
begin
  inherited;
  FInt := 182 * 3;
  FTest := 'Value: ' + Random(21822).ToString + Random(18200).ToString;
end;

procedure TForm182.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum182;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj182_List0 := TMyObj182_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj182_List1 := TMyObj182_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
