...
type
  ...
  TMyObj875_List0 = TObjectList<TMyObj875>;

  TMyObj875_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj875_List1 = TObjectList<TMyObj875_1>;
...
constructor TMyObj875_1.Create;
begin
  inherited;
  FInt := 875 * 3;
  FTest := 'Value: ' + Random(28752).ToString + Random(87500).ToString;
end;

procedure TForm875.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum875;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj875_List0 := TMyObj875_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj875_List1 := TMyObj875_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
