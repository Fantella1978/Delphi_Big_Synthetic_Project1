...
type
  ...
  TMyObj1412_List0 = TObjectList<TMyObj1412>;

  TMyObj1412_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1412_List1 = TObjectList<TMyObj1412_1>;
...
constructor TMyObj1412_1.Create;
begin
  inherited;
  FInt := 1412 * 3;
  FTest := 'Value: ' + Random(214122).ToString + Random(141200).ToString;
end;

procedure TForm1412.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1412;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1412_List0 := TMyObj1412_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1412_List1 := TMyObj1412_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
