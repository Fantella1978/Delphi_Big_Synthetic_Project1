...
type
  ...
  TMyObj2159_List0 = TObjectList<TMyObj2159>;

  TMyObj2159_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2159_List1 = TObjectList<TMyObj2159_1>;
...
constructor TMyObj2159_1.Create;
begin
  inherited;
  FInt := 2159 * 3;
  FTest := 'Value: ' + Random(221592).ToString + Random(215900).ToString;
end;

procedure TForm2159.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2159;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2159_List0 := TMyObj2159_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2159_List1 := TMyObj2159_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
