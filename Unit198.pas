...
type
  ...
  TMyObj198_List0 = TObjectList<TMyObj198>;

  TMyObj198_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj198_List1 = TObjectList<TMyObj198_1>;
...
constructor TMyObj198_1.Create;
begin
  inherited;
  FInt := 198 * 3;
  FTest := 'Value: ' + Random(21982).ToString + Random(19800).ToString;
end;

procedure TForm198.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum198;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj198_List0 := TMyObj198_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj198_List1 := TMyObj198_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
