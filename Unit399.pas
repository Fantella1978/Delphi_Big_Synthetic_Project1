...
type
  ...
  TMyObj399_List0 = TObjectList<TMyObj399>;

  TMyObj399_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj399_List1 = TObjectList<TMyObj399_1>;
...
constructor TMyObj399_1.Create;
begin
  inherited;
  FInt := 399 * 3;
  FTest := 'Value: ' + Random(23992).ToString + Random(39900).ToString;
end;

procedure TForm399.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum399;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj399_List0 := TMyObj399_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj399_List1 := TMyObj399_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
