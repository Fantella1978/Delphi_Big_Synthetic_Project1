...
type
  ...
  TMyObj1929_List0 = TObjectList<TMyObj1929>;

  TMyObj1929_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1929_List1 = TObjectList<TMyObj1929_1>;
...
constructor TMyObj1929_1.Create;
begin
  inherited;
  FInt := 1929 * 3;
  FTest := 'Value: ' + Random(219292).ToString + Random(192900).ToString;
end;

procedure TForm1929.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1929;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1929_List0 := TMyObj1929_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1929_List1 := TMyObj1929_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
