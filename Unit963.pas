...
type
  ...
  TMyObj963_List0 = TObjectList<TMyObj963>;

  TMyObj963_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj963_List1 = TObjectList<TMyObj963_1>;
...
constructor TMyObj963_1.Create;
begin
  inherited;
  FInt := 963 * 3;
  FTest := 'Value: ' + Random(29632).ToString + Random(96300).ToString;
end;

procedure TForm963.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum963;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj963_List0 := TMyObj963_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj963_List1 := TMyObj963_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
