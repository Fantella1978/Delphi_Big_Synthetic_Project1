...
type
  ...
  TMyObj938_List0 = TObjectList<TMyObj938>;

  TMyObj938_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj938_List1 = TObjectList<TMyObj938_1>;
...
constructor TMyObj938_1.Create;
begin
  inherited;
  FInt := 938 * 3;
  FTest := 'Value: ' + Random(29382).ToString + Random(93800).ToString;
end;

procedure TForm938.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum938;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj938_List0 := TMyObj938_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj938_List1 := TMyObj938_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
