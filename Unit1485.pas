...
type
  ...
  TMyObj1485_List0 = TObjectList<TMyObj1485>;

  TMyObj1485_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1485_List1 = TObjectList<TMyObj1485_1>;
...
constructor TMyObj1485_1.Create;
begin
  inherited;
  FInt := 1485 * 3;
  FTest := 'Value: ' + Random(214852).ToString + Random(148500).ToString;
end;

procedure TForm1485.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1485;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1485_List0 := TMyObj1485_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1485_List1 := TMyObj1485_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
