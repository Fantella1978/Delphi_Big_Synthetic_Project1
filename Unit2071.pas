...
type
  ...
  TMyObj2071_List0 = TObjectList<TMyObj2071>;

  TMyObj2071_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2071_List1 = TObjectList<TMyObj2071_1>;
...
constructor TMyObj2071_1.Create;
begin
  inherited;
  FInt := 2071 * 3;
  FTest := 'Value: ' + Random(220712).ToString + Random(207100).ToString;
end;

procedure TForm2071.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2071;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2071_List0 := TMyObj2071_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2071_List1 := TMyObj2071_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
