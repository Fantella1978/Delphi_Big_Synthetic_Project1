...
type
  ...
  TMyObj1028_List0 = TObjectList<TMyObj1028>;

  TMyObj1028_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1028_List1 = TObjectList<TMyObj1028_1>;
...
constructor TMyObj1028_1.Create;
begin
  inherited;
  FInt := 1028 * 3;
  FTest := 'Value: ' + Random(210282).ToString + Random(102800).ToString;
end;

procedure TForm1028.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1028;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1028_List0 := TMyObj1028_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1028_List1 := TMyObj1028_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
