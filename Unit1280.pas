...
type
  ...
  TMyObj1280_List0 = TObjectList<TMyObj1280>;

  TMyObj1280_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1280_List1 = TObjectList<TMyObj1280_1>;
...
constructor TMyObj1280_1.Create;
begin
  inherited;
  FInt := 1280 * 3;
  FTest := 'Value: ' + Random(212802).ToString + Random(128000).ToString;
end;

procedure TForm1280.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1280;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1280_List0 := TMyObj1280_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1280_List1 := TMyObj1280_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
