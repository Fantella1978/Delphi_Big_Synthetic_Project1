...
type
  ...
  TMyObj1594_List0 = TObjectList<TMyObj1594>;

  TMyObj1594_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1594_List1 = TObjectList<TMyObj1594_1>;
...
constructor TMyObj1594_1.Create;
begin
  inherited;
  FInt := 1594 * 3;
  FTest := 'Value: ' + Random(215942).ToString + Random(159400).ToString;
end;

procedure TForm1594.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1594;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1594_List0 := TMyObj1594_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1594_List1 := TMyObj1594_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
