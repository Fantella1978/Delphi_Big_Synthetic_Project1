...
type
  ...
  TMyObj2273_List0 = TObjectList<TMyObj2273>;

  TMyObj2273_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2273_List1 = TObjectList<TMyObj2273_1>;
...
constructor TMyObj2273_1.Create;
begin
  inherited;
  FInt := 2273 * 3;
  FTest := 'Value: ' + Random(222732).ToString + Random(227300).ToString;
end;

procedure TForm2273.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2273;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2273_List0 := TMyObj2273_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2273_List1 := TMyObj2273_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
