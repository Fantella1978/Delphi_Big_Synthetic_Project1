...
type
  ...
  TMyObj276_List0 = TObjectList<TMyObj276>;

  TMyObj276_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj276_List1 = TObjectList<TMyObj276_1>;
...
constructor TMyObj276_1.Create;
begin
  inherited;
  FInt := 276 * 3;
  FTest := 'Value: ' + Random(22762).ToString + Random(27600).ToString;
end;

procedure TForm276.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum276;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj276_List0 := TMyObj276_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj276_List1 := TMyObj276_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
