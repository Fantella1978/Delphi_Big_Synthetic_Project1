...
type
  ...
  TMyObj189_List0 = TObjectList<TMyObj189>;

  TMyObj189_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj189_List1 = TObjectList<TMyObj189_1>;
...
constructor TMyObj189_1.Create;
begin
  inherited;
  FInt := 189 * 3;
  FTest := 'Value: ' + Random(21892).ToString + Random(18900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj189_List0 := TMyObj189_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj189_List1 := TMyObj189_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
