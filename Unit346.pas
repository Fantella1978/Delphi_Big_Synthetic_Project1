...
type
  ...
  TMyObj346_List0 = TObjectList<TMyObj346>;

  TMyObj346_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj346_List1 = TObjectList<TMyObj346_1>;
...
constructor TMyObj346_1.Create;
begin
  inherited;
  FInt := 346 * 3;
  FTest := 'Value: ' + Random(23462).ToString + Random(34600).ToString;
end;

procedure TForm346.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum346;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj346_List0 := TMyObj346_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj346_List1 := TMyObj346_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
