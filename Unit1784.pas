...
type
  ...
  TMyObj1784_List0 = TObjectList<TMyObj1784>;

  TMyObj1784_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1784_List1 = TObjectList<TMyObj1784_1>;
...
constructor TMyObj1784_1.Create;
begin
  inherited;
  FInt := 1784 * 3;
  FTest := 'Value: ' + Random(217842).ToString + Random(178400).ToString;
end;

procedure TForm1784.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1784;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1784_List0 := TMyObj1784_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1784_List1 := TMyObj1784_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
