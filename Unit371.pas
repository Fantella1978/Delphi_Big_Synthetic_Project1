...
type
  ...
  TMyObj371_List0 = TObjectList<TMyObj371>;

  TMyObj371_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj371_List1 = TObjectList<TMyObj371_1>;
...
constructor TMyObj371_1.Create;
begin
  inherited;
  FInt := 371 * 3;
  FTest := 'Value: ' + Random(23712).ToString + Random(37100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj371_List0 := TMyObj371_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj371_List1 := TMyObj371_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
