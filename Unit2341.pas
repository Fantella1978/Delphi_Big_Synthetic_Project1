...
type
  ...
  TMyObj2341_List0 = TObjectList<TMyObj2341>;

  TMyObj2341_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2341_List1 = TObjectList<TMyObj2341_1>;
...
constructor TMyObj2341_1.Create;
begin
  inherited;
  FInt := 2341 * 3;
  FTest := 'Value: ' + Random(223412).ToString + Random(234100).ToString;
end;

procedure TForm2341.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2341;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2341_List0 := TMyObj2341_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2341_List1 := TMyObj2341_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
