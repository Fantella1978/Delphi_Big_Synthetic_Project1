...
type
  ...
  TMyObj2327_List0 = TObjectList<TMyObj2327>;

  TMyObj2327_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2327_List1 = TObjectList<TMyObj2327_1>;
...
constructor TMyObj2327_1.Create;
begin
  inherited;
  FInt := 2327 * 3;
  FTest := 'Value: ' + Random(223272).ToString + Random(232700).ToString;
end;

procedure TForm2327.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2327;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2327_List0 := TMyObj2327_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2327_List1 := TMyObj2327_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
