...
type
  ...
  TMyObj588_List0 = TObjectList<TMyObj588>;

  TMyObj588_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj588_List1 = TObjectList<TMyObj588_1>;
...
constructor TMyObj588_1.Create;
begin
  inherited;
  FInt := 588 * 3;
  FTest := 'Value: ' + Random(25882).ToString + Random(58800).ToString;
end;

procedure TForm588.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum588;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj588_List0 := TMyObj588_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj588_List1 := TMyObj588_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
