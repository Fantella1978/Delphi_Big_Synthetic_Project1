...
type
  ...
  TMyObj527_List0 = TObjectList<TMyObj527>;

  TMyObj527_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj527_List1 = TObjectList<TMyObj527_1>;
...
constructor TMyObj527_1.Create;
begin
  inherited;
  FInt := 527 * 3;
  FTest := 'Value: ' + Random(25272).ToString + Random(52700).ToString;
end;

procedure TForm527.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum527;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj527_List0 := TMyObj527_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj527_List1 := TMyObj527_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
