...
type
  ...
  TMyObj1273_List0 = TObjectList<TMyObj1273>;

  TMyObj1273_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1273_List1 = TObjectList<TMyObj1273_1>;
...
constructor TMyObj1273_1.Create;
begin
  inherited;
  FInt := 1273 * 3;
  FTest := 'Value: ' + Random(212732).ToString + Random(127300).ToString;
end;

procedure TForm1273.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1273;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1273_List0 := TMyObj1273_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1273_List1 := TMyObj1273_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
