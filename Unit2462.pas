...
type
  ...
  TMyObj2462_List0 = TObjectList<TMyObj2462>;

  TMyObj2462_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2462_List1 = TObjectList<TMyObj2462_1>;
...
constructor TMyObj2462_1.Create;
begin
  inherited;
  FInt := 2462 * 3;
  FTest := 'Value: ' + Random(224622).ToString + Random(246200).ToString;
end;

procedure TForm2462.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2462;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2462_List0 := TMyObj2462_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2462_List1 := TMyObj2462_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
