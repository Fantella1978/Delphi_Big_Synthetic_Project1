...
type
  ...
  TMyObj1468_List0 = TObjectList<TMyObj1468>;

  TMyObj1468_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1468_List1 = TObjectList<TMyObj1468_1>;
...
constructor TMyObj1468_1.Create;
begin
  inherited;
  FInt := 1468 * 3;
  FTest := 'Value: ' + Random(214682).ToString + Random(146800).ToString;
end;

procedure TForm1468.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1468;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1468_List0 := TMyObj1468_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1468_List1 := TMyObj1468_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
