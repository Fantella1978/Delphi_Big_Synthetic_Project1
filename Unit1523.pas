...
type
  ...
  TMyObj1523_List0 = TObjectList<TMyObj1523>;

  TMyObj1523_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1523_List1 = TObjectList<TMyObj1523_1>;
...
constructor TMyObj1523_1.Create;
begin
  inherited;
  FInt := 1523 * 3;
  FTest := 'Value: ' + Random(215232).ToString + Random(152300).ToString;
end;

procedure TForm1523.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1523;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1523_List0 := TMyObj1523_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1523_List1 := TMyObj1523_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
