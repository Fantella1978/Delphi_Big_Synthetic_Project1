...
type
  ...
  TMyObj2150_List0 = TObjectList<TMyObj2150>;

  TMyObj2150_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2150_List1 = TObjectList<TMyObj2150_1>;
...
constructor TMyObj2150_1.Create;
begin
  inherited;
  FInt := 2150 * 3;
  FTest := 'Value: ' + Random(221502).ToString + Random(215000).ToString;
end;

procedure TForm2150.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2150;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2150_List0 := TMyObj2150_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2150_List1 := TMyObj2150_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
