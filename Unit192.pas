...
type
  ...
  TMyObj192_List0 = TObjectList<TMyObj192>;

  TMyObj192_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj192_List1 = TObjectList<TMyObj192_1>;
...
constructor TMyObj192_1.Create;
begin
  inherited;
  FInt := 192 * 3;
  FTest := 'Value: ' + Random(21922).ToString + Random(19200).ToString;
end;

procedure TForm192.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum192;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj192_List0 := TMyObj192_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj192_List1 := TMyObj192_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
