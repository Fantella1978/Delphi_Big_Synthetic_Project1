...
type
  ...
  TMyObj1461_List0 = TObjectList<TMyObj1461>;

  TMyObj1461_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1461_List1 = TObjectList<TMyObj1461_1>;
...
constructor TMyObj1461_1.Create;
begin
  inherited;
  FInt := 1461 * 3;
  FTest := 'Value: ' + Random(214612).ToString + Random(146100).ToString;
end;

procedure TForm1461.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1461;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1461_List0 := TMyObj1461_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1461_List1 := TMyObj1461_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
