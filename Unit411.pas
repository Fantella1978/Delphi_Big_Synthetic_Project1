...
type
  ...
  TMyObj411_List0 = TObjectList<TMyObj411>;

  TMyObj411_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj411_List1 = TObjectList<TMyObj411_1>;
...
constructor TMyObj411_1.Create;
begin
  inherited;
  FInt := 411 * 3;
  FTest := 'Value: ' + Random(24112).ToString + Random(41100).ToString;
end;

procedure TForm411.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum411;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj411_List0 := TMyObj411_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj411_List1 := TMyObj411_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
