...
type
  ...
  TMyObj1490_List0 = TObjectList<TMyObj1490>;

  TMyObj1490_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1490_List1 = TObjectList<TMyObj1490_1>;
...
constructor TMyObj1490_1.Create;
begin
  inherited;
  FInt := 1490 * 3;
  FTest := 'Value: ' + Random(214902).ToString + Random(149000).ToString;
end;

procedure TForm1490.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1490;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1490_List0 := TMyObj1490_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1490_List1 := TMyObj1490_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
