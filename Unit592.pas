...
type
  ...
  TMyObj592_List0 = TObjectList<TMyObj592>;

  TMyObj592_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj592_List1 = TObjectList<TMyObj592_1>;
...
constructor TMyObj592_1.Create;
begin
  inherited;
  FInt := 592 * 3;
  FTest := 'Value: ' + Random(25922).ToString + Random(59200).ToString;
end;

procedure TForm592.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum592;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj592_List0 := TMyObj592_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj592_List1 := TMyObj592_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
