...
type
  ...
  TMyObj509_List0 = TObjectList<TMyObj509>;

  TMyObj509_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj509_List1 = TObjectList<TMyObj509_1>;
...
constructor TMyObj509_1.Create;
begin
  inherited;
  FInt := 509 * 3;
  FTest := 'Value: ' + Random(25092).ToString + Random(50900).ToString;
end;

procedure TForm509.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum509;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj509_List0 := TMyObj509_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj509_List1 := TMyObj509_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
