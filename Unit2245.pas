...
type
  ...
  TMyObj2245_List0 = TObjectList<TMyObj2245>;

  TMyObj2245_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2245_List1 = TObjectList<TMyObj2245_1>;
...
constructor TMyObj2245_1.Create;
begin
  inherited;
  FInt := 2245 * 3;
  FTest := 'Value: ' + Random(222452).ToString + Random(224500).ToString;
end;

procedure TForm2245.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2245;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2245_List0 := TMyObj2245_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2245_List1 := TMyObj2245_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
