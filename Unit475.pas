...
type
  ...
  TMyObj475_List0 = TObjectList<TMyObj475>;

  TMyObj475_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj475_List1 = TObjectList<TMyObj475_1>;
...
constructor TMyObj475_1.Create;
begin
  inherited;
  FInt := 475 * 3;
  FTest := 'Value: ' + Random(24752).ToString + Random(47500).ToString;
end;

procedure TForm475.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum475;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj475_List0 := TMyObj475_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj475_List1 := TMyObj475_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
