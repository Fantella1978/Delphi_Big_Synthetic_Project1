...
type
  ...
  TMyObj1756_List0 = TObjectList<TMyObj1756>;

  TMyObj1756_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1756_List1 = TObjectList<TMyObj1756_1>;
...
constructor TMyObj1756_1.Create;
begin
  inherited;
  FInt := 1756 * 3;
  FTest := 'Value: ' + Random(217562).ToString + Random(175600).ToString;
end;

procedure TForm1756.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1756;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1756_List0 := TMyObj1756_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1756_List1 := TMyObj1756_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
