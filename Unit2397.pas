...
type
  ...
  TMyObj2397_List0 = TObjectList<TMyObj2397>;

  TMyObj2397_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2397_List1 = TObjectList<TMyObj2397_1>;
...
constructor TMyObj2397_1.Create;
begin
  inherited;
  FInt := 2397 * 3;
  FTest := 'Value: ' + Random(223972).ToString + Random(239700).ToString;
end;

procedure TForm2397.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2397;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2397_List0 := TMyObj2397_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2397_List1 := TMyObj2397_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
