...
type
  ...
  TMyObj98_List0 = TObjectList<TMyObj98>;

  TMyObj98_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj98_List1 = TObjectList<TMyObj98_1>;
...
constructor TMyObj98_1.Create;
begin
  inherited;
  FInt := 98 * 3;
  FTest := 'Value: ' + Random(2982).ToString + Random(9800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj98_List0 := TMyObj98_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj98_List1 := TMyObj98_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
