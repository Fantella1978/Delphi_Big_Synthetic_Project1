...
type
  ...
  TMyObj785_List0 = TObjectList<TMyObj785>;

  TMyObj785_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj785_List1 = TObjectList<TMyObj785_1>;
...
constructor TMyObj785_1.Create;
begin
  inherited;
  FInt := 785 * 3;
  FTest := 'Value: ' + Random(27852).ToString + Random(78500).ToString;
end;

procedure TForm785.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum785;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj785_List0 := TMyObj785_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj785_List1 := TMyObj785_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
