...
type
  ...
  TMyObj184_List0 = TObjectList<TMyObj184>;

  TMyObj184_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj184_List1 = TObjectList<TMyObj184_1>;
...
constructor TMyObj184_1.Create;
begin
  inherited;
  FInt := 184 * 3;
  FTest := 'Value: ' + Random(21842).ToString + Random(18400).ToString;
end;

procedure TForm184.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum184;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj184_List0 := TMyObj184_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj184_List1 := TMyObj184_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
