...
type
  ...
  TMyObj2157_List0 = TObjectList<TMyObj2157>;

  TMyObj2157_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2157_List1 = TObjectList<TMyObj2157_1>;
...
constructor TMyObj2157_1.Create;
begin
  inherited;
  FInt := 2157 * 3;
  FTest := 'Value: ' + Random(221572).ToString + Random(215700).ToString;
end;

procedure TForm2157.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2157;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2157_List0 := TMyObj2157_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2157_List1 := TMyObj2157_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
