...
type
  ...
  TMyObj1651_List0 = TObjectList<TMyObj1651>;

  TMyObj1651_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1651_List1 = TObjectList<TMyObj1651_1>;
...
constructor TMyObj1651_1.Create;
begin
  inherited;
  FInt := 1651 * 3;
  FTest := 'Value: ' + Random(216512).ToString + Random(165100).ToString;
end;

procedure TForm1651.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1651;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1651_List0 := TMyObj1651_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1651_List1 := TMyObj1651_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
