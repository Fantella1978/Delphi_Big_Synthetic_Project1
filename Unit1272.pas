...
type
  ...
  TMyObj1272_List0 = TObjectList<TMyObj1272>;

  TMyObj1272_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1272_List1 = TObjectList<TMyObj1272_1>;
...
constructor TMyObj1272_1.Create;
begin
  inherited;
  FInt := 1272 * 3;
  FTest := 'Value: ' + Random(212722).ToString + Random(127200).ToString;
end;

procedure TForm1272.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1272;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1272_List0 := TMyObj1272_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1272_List1 := TMyObj1272_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
