...
type
  ...
  TMyObj2226_List0 = TObjectList<TMyObj2226>;

  TMyObj2226_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2226_List1 = TObjectList<TMyObj2226_1>;
...
constructor TMyObj2226_1.Create;
begin
  inherited;
  FInt := 2226 * 3;
  FTest := 'Value: ' + Random(222262).ToString + Random(222600).ToString;
end;

procedure TForm2226.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2226;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2226_List0 := TMyObj2226_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2226_List1 := TMyObj2226_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
