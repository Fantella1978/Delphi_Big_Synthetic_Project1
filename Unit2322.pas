...
type
  ...
  TMyObj2322_List0 = TObjectList<TMyObj2322>;

  TMyObj2322_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2322_List1 = TObjectList<TMyObj2322_1>;
...
constructor TMyObj2322_1.Create;
begin
  inherited;
  FInt := 2322 * 3;
  FTest := 'Value: ' + Random(223222).ToString + Random(232200).ToString;
end;

procedure TForm2322.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2322;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2322_List0 := TMyObj2322_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2322_List1 := TMyObj2322_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
