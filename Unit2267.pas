...
type
  ...
  TMyObj2267_List0 = TObjectList<TMyObj2267>;

  TMyObj2267_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2267_List1 = TObjectList<TMyObj2267_1>;
...
constructor TMyObj2267_1.Create;
begin
  inherited;
  FInt := 2267 * 3;
  FTest := 'Value: ' + Random(222672).ToString + Random(226700).ToString;
end;

procedure TForm2267.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2267;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2267_List0 := TMyObj2267_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2267_List1 := TMyObj2267_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
