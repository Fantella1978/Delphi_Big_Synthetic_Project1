...
type
  ...
  TMyObj578_List0 = TObjectList<TMyObj578>;

  TMyObj578_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj578_List1 = TObjectList<TMyObj578_1>;
...
constructor TMyObj578_1.Create;
begin
  inherited;
  FInt := 578 * 3;
  FTest := 'Value: ' + Random(25782).ToString + Random(57800).ToString;
end;

procedure TForm578.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum578;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj578_List0 := TMyObj578_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj578_List1 := TMyObj578_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
