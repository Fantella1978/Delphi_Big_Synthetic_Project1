...
type
  ...
  TMyObj467_List0 = TObjectList<TMyObj467>;

  TMyObj467_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj467_List1 = TObjectList<TMyObj467_1>;
...
constructor TMyObj467_1.Create;
begin
  inherited;
  FInt := 467 * 3;
  FTest := 'Value: ' + Random(24672).ToString + Random(46700).ToString;
end;

procedure TForm467.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum467;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj467_List0 := TMyObj467_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj467_List1 := TMyObj467_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
