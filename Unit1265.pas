...
type
  ...
  TMyObj1265_List0 = TObjectList<TMyObj1265>;

  TMyObj1265_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1265_List1 = TObjectList<TMyObj1265_1>;
...
constructor TMyObj1265_1.Create;
begin
  inherited;
  FInt := 1265 * 3;
  FTest := 'Value: ' + Random(212652).ToString + Random(126500).ToString;
end;

procedure TForm1265.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1265;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1265_List0 := TMyObj1265_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1265_List1 := TMyObj1265_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
