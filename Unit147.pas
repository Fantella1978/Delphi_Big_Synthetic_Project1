...
type
  ...
  TMyObj147_List0 = TObjectList<TMyObj147>;

  TMyObj147_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj147_List1 = TObjectList<TMyObj147_1>;
...
constructor TMyObj147_1.Create;
begin
  inherited;
  FInt := 147 * 3;
  FTest := 'Value: ' + Random(21472).ToString + Random(14700).ToString;
end;

procedure TForm147.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum147;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj147_List0 := TMyObj147_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj147_List1 := TMyObj147_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
