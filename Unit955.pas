...
type
  ...
  TMyObj955_List0 = TObjectList<TMyObj955>;

  TMyObj955_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj955_List1 = TObjectList<TMyObj955_1>;
...
constructor TMyObj955_1.Create;
begin
  inherited;
  FInt := 955 * 3;
  FTest := 'Value: ' + Random(29552).ToString + Random(95500).ToString;
end;

procedure TForm955.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum955;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj955_List0 := TMyObj955_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj955_List1 := TMyObj955_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
