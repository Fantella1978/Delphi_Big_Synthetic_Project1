...
type
  ...
  TMyObj1061_List0 = TObjectList<TMyObj1061>;

  TMyObj1061_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1061_List1 = TObjectList<TMyObj1061_1>;
...
constructor TMyObj1061_1.Create;
begin
  inherited;
  FInt := 1061 * 3;
  FTest := 'Value: ' + Random(210612).ToString + Random(106100).ToString;
end;

procedure TForm1061.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1061;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1061_List0 := TMyObj1061_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1061_List1 := TMyObj1061_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
