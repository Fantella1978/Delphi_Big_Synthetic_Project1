...
type
  ...
  TMyObj2009_List0 = TObjectList<TMyObj2009>;

  TMyObj2009_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2009_List1 = TObjectList<TMyObj2009_1>;
...
constructor TMyObj2009_1.Create;
begin
  inherited;
  FInt := 2009 * 3;
  FTest := 'Value: ' + Random(220092).ToString + Random(200900).ToString;
end;

procedure TForm2009.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2009;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2009_List0 := TMyObj2009_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2009_List1 := TMyObj2009_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
