...
type
  ...
  TMyObj1445_List0 = TObjectList<TMyObj1445>;

  TMyObj1445_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1445_List1 = TObjectList<TMyObj1445_1>;
...
constructor TMyObj1445_1.Create;
begin
  inherited;
  FInt := 1445 * 3;
  FTest := 'Value: ' + Random(214452).ToString + Random(144500).ToString;
end;

procedure TForm1445.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1445;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1445_List0 := TMyObj1445_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1445_List1 := TMyObj1445_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
