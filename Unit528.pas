...
type
  ...
  TMyObj528_List0 = TObjectList<TMyObj528>;

  TMyObj528_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj528_List1 = TObjectList<TMyObj528_1>;
...
constructor TMyObj528_1.Create;
begin
  inherited;
  FInt := 528 * 3;
  FTest := 'Value: ' + Random(25282).ToString + Random(52800).ToString;
end;

procedure TForm528.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum528;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj528_List0 := TMyObj528_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj528_List1 := TMyObj528_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
