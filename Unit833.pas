...
type
  ...
  TMyObj833_List0 = TObjectList<TMyObj833>;

  TMyObj833_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj833_List1 = TObjectList<TMyObj833_1>;
...
constructor TMyObj833_1.Create;
begin
  inherited;
  FInt := 833 * 3;
  FTest := 'Value: ' + Random(28332).ToString + Random(83300).ToString;
end;

procedure TForm833.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum833;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj833_List0 := TMyObj833_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj833_List1 := TMyObj833_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
