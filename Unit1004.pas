...
type
  ...
  TMyObj1004_List0 = TObjectList<TMyObj1004>;

  TMyObj1004_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1004_List1 = TObjectList<TMyObj1004_1>;
...
constructor TMyObj1004_1.Create;
begin
  inherited;
  FInt := 1004 * 3;
  FTest := 'Value: ' + Random(210042).ToString + Random(100400).ToString;
end;

procedure TForm1004.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1004;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1004_List0 := TMyObj1004_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1004_List1 := TMyObj1004_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
