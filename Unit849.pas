...
type
  ...
  TMyObj849_List0 = TObjectList<TMyObj849>;

  TMyObj849_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj849_List1 = TObjectList<TMyObj849_1>;
...
constructor TMyObj849_1.Create;
begin
  inherited;
  FInt := 849 * 3;
  FTest := 'Value: ' + Random(28492).ToString + Random(84900).ToString;
end;

procedure TForm849.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum849;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj849_List0 := TMyObj849_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj849_List1 := TMyObj849_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
