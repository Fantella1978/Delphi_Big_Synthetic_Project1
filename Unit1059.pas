...
type
  ...
  TMyObj1059_List0 = TObjectList<TMyObj1059>;

  TMyObj1059_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1059_List1 = TObjectList<TMyObj1059_1>;
...
constructor TMyObj1059_1.Create;
begin
  inherited;
  FInt := 1059 * 3;
  FTest := 'Value: ' + Random(210592).ToString + Random(105900).ToString;
end;

procedure TForm1059.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1059;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1059_List0 := TMyObj1059_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1059_List1 := TMyObj1059_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
