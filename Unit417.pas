...
type
  ...
  TMyObj417_List0 = TObjectList<TMyObj417>;

  TMyObj417_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj417_List1 = TObjectList<TMyObj417_1>;
...
constructor TMyObj417_1.Create;
begin
  inherited;
  FInt := 417 * 3;
  FTest := 'Value: ' + Random(24172).ToString + Random(41700).ToString;
end;

procedure TForm417.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum417;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj417_List0 := TMyObj417_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj417_List1 := TMyObj417_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
