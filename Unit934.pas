...
type
  ...
  TMyObj934_List0 = TObjectList<TMyObj934>;

  TMyObj934_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj934_List1 = TObjectList<TMyObj934_1>;
...
constructor TMyObj934_1.Create;
begin
  inherited;
  FInt := 934 * 3;
  FTest := 'Value: ' + Random(29342).ToString + Random(93400).ToString;
end;

procedure TForm934.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum934;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj934_List0 := TMyObj934_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj934_List1 := TMyObj934_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
