...
type
  ...
  TMyObj1003_List0 = TObjectList<TMyObj1003>;

  TMyObj1003_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1003_List1 = TObjectList<TMyObj1003_1>;
...
constructor TMyObj1003_1.Create;
begin
  inherited;
  FInt := 1003 * 3;
  FTest := 'Value: ' + Random(210032).ToString + Random(100300).ToString;
end;

procedure TForm1003.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1003;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1003_List0 := TMyObj1003_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1003_List1 := TMyObj1003_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
