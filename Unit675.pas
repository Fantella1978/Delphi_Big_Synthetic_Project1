...
type
  ...
  TMyObj675_List0 = TObjectList<TMyObj675>;

  TMyObj675_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj675_List1 = TObjectList<TMyObj675_1>;
...
constructor TMyObj675_1.Create;
begin
  inherited;
  FInt := 675 * 3;
  FTest := 'Value: ' + Random(26752).ToString + Random(67500).ToString;
end;

procedure TForm675.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum675;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj675_List0 := TMyObj675_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj675_List1 := TMyObj675_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
