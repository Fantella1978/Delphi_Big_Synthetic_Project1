...
type
  ...
  TMyObj726_List0 = TObjectList<TMyObj726>;

  TMyObj726_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj726_List1 = TObjectList<TMyObj726_1>;
...
constructor TMyObj726_1.Create;
begin
  inherited;
  FInt := 726 * 3;
  FTest := 'Value: ' + Random(27262).ToString + Random(72600).ToString;
end;

procedure TForm726.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum726;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj726_List0 := TMyObj726_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj726_List1 := TMyObj726_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
