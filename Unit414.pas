...
type
  ...
  TMyObj414_List0 = TObjectList<TMyObj414>;

  TMyObj414_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj414_List1 = TObjectList<TMyObj414_1>;
...
constructor TMyObj414_1.Create;
begin
  inherited;
  FInt := 414 * 3;
  FTest := 'Value: ' + Random(24142).ToString + Random(41400).ToString;
end;

procedure TForm414.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum414;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj414_List0 := TMyObj414_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj414_List1 := TMyObj414_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
