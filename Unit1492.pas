...
type
  ...
  TMyObj1492_List0 = TObjectList<TMyObj1492>;

  TMyObj1492_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1492_List1 = TObjectList<TMyObj1492_1>;
...
constructor TMyObj1492_1.Create;
begin
  inherited;
  FInt := 1492 * 3;
  FTest := 'Value: ' + Random(214922).ToString + Random(149200).ToString;
end;

procedure TForm1492.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1492;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1492_List0 := TMyObj1492_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1492_List1 := TMyObj1492_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
