...
type
  ...
  TMyObj2416_List0 = TObjectList<TMyObj2416>;

  TMyObj2416_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2416_List1 = TObjectList<TMyObj2416_1>;
...
constructor TMyObj2416_1.Create;
begin
  inherited;
  FInt := 2416 * 3;
  FTest := 'Value: ' + Random(224162).ToString + Random(241600).ToString;
end;

procedure TForm2416.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2416;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2416_List0 := TMyObj2416_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2416_List1 := TMyObj2416_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
