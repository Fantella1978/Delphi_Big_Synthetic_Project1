...
type
  ...
  TMyObj711_List0 = TObjectList<TMyObj711>;

  TMyObj711_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj711_List1 = TObjectList<TMyObj711_1>;
...
constructor TMyObj711_1.Create;
begin
  inherited;
  FInt := 711 * 3;
  FTest := 'Value: ' + Random(27112).ToString + Random(71100).ToString;
end;

procedure TForm711.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum711;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj711_List0 := TMyObj711_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj711_List1 := TMyObj711_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
