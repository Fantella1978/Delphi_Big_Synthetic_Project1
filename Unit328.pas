...
type
  ...
  TMyObj328_List0 = TObjectList<TMyObj328>;

  TMyObj328_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj328_List1 = TObjectList<TMyObj328_1>;
...
constructor TMyObj328_1.Create;
begin
  inherited;
  FInt := 328 * 3;
  FTest := 'Value: ' + Random(23282).ToString + Random(32800).ToString;
end;

procedure TForm328.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum328;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj328_List0 := TMyObj328_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj328_List1 := TMyObj328_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
