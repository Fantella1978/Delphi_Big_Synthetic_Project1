...
type
  ...
  TMyObj556_List0 = TObjectList<TMyObj556>;

  TMyObj556_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj556_List1 = TObjectList<TMyObj556_1>;
...
constructor TMyObj556_1.Create;
begin
  inherited;
  FInt := 556 * 3;
  FTest := 'Value: ' + Random(25562).ToString + Random(55600).ToString;
end;

procedure TForm556.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum556;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj556_List0 := TMyObj556_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj556_List1 := TMyObj556_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
