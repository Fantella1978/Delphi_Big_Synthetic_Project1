...
type
  ...
  TMyObj1832_List0 = TObjectList<TMyObj1832>;

  TMyObj1832_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1832_List1 = TObjectList<TMyObj1832_1>;
...
constructor TMyObj1832_1.Create;
begin
  inherited;
  FInt := 1832 * 3;
  FTest := 'Value: ' + Random(218322).ToString + Random(183200).ToString;
end;

procedure TForm1832.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1832;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1832_List0 := TMyObj1832_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1832_List1 := TMyObj1832_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
