...
type
  ...
  TMyObj1300_List0 = TObjectList<TMyObj1300>;

  TMyObj1300_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1300_List1 = TObjectList<TMyObj1300_1>;
...
constructor TMyObj1300_1.Create;
begin
  inherited;
  FInt := 1300 * 3;
  FTest := 'Value: ' + Random(213002).ToString + Random(130000).ToString;
end;

procedure TForm1300.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1300;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1300_List0 := TMyObj1300_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1300_List1 := TMyObj1300_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
