...
type
  ...
  TMyObj1993_List0 = TObjectList<TMyObj1993>;

  TMyObj1993_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1993_List1 = TObjectList<TMyObj1993_1>;
...
constructor TMyObj1993_1.Create;
begin
  inherited;
  FInt := 1993 * 3;
  FTest := 'Value: ' + Random(219932).ToString + Random(199300).ToString;
end;

procedure TForm1993.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1993;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1993_List0 := TMyObj1993_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1993_List1 := TMyObj1993_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
