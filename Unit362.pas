...
type
  ...
  TMyObj362_List0 = TObjectList<TMyObj362>;

  TMyObj362_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj362_List1 = TObjectList<TMyObj362_1>;
...
constructor TMyObj362_1.Create;
begin
  inherited;
  FInt := 362 * 3;
  FTest := 'Value: ' + Random(23622).ToString + Random(36200).ToString;
end;

procedure TForm362.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum362;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj362_List0 := TMyObj362_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj362_List1 := TMyObj362_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
