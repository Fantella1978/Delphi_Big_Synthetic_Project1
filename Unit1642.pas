...
type
  ...
  TMyObj1642_List0 = TObjectList<TMyObj1642>;

  TMyObj1642_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1642_List1 = TObjectList<TMyObj1642_1>;
...
constructor TMyObj1642_1.Create;
begin
  inherited;
  FInt := 1642 * 3;
  FTest := 'Value: ' + Random(216422).ToString + Random(164200).ToString;
end;

procedure TForm1642.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1642;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1642_List0 := TMyObj1642_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1642_List1 := TMyObj1642_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
