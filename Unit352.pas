...
type
  ...
  TMyObj352_List0 = TObjectList<TMyObj352>;

  TMyObj352_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj352_List1 = TObjectList<TMyObj352_1>;
...
constructor TMyObj352_1.Create;
begin
  inherited;
  FInt := 352 * 3;
  FTest := 'Value: ' + Random(23522).ToString + Random(35200).ToString;
end;

procedure TForm352.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum352;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj352_List0 := TMyObj352_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj352_List1 := TMyObj352_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
