...
type
  ...
  TMyObj2231_List0 = TObjectList<TMyObj2231>;

  TMyObj2231_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2231_List1 = TObjectList<TMyObj2231_1>;
...
constructor TMyObj2231_1.Create;
begin
  inherited;
  FInt := 2231 * 3;
  FTest := 'Value: ' + Random(222312).ToString + Random(223100).ToString;
end;

procedure TForm2231.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2231;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2231_List0 := TMyObj2231_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2231_List1 := TMyObj2231_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
