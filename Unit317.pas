...
type
  ...
  TMyObj317_List0 = TObjectList<TMyObj317>;

  TMyObj317_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj317_List1 = TObjectList<TMyObj317_1>;
...
constructor TMyObj317_1.Create;
begin
  inherited;
  FInt := 317 * 3;
  FTest := 'Value: ' + Random(23172).ToString + Random(31700).ToString;
end;

procedure TForm317.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum317;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj317_List0 := TMyObj317_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj317_List1 := TMyObj317_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
