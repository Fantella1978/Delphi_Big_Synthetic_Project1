...
type
  ...
  TMyObj784_List0 = TObjectList<TMyObj784>;

  TMyObj784_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj784_List1 = TObjectList<TMyObj784_1>;
...
constructor TMyObj784_1.Create;
begin
  inherited;
  FInt := 784 * 3;
  FTest := 'Value: ' + Random(27842).ToString + Random(78400).ToString;
end;

procedure TForm784.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum784;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj784_List0 := TMyObj784_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj784_List1 := TMyObj784_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
