...
type
  ...
  TMyObj2398_List0 = TObjectList<TMyObj2398>;

  TMyObj2398_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2398_List1 = TObjectList<TMyObj2398_1>;
...
constructor TMyObj2398_1.Create;
begin
  inherited;
  FInt := 2398 * 3;
  FTest := 'Value: ' + Random(223982).ToString + Random(239800).ToString;
end;

procedure TForm2398.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2398;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2398_List0 := TMyObj2398_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2398_List1 := TMyObj2398_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
