...
type
  ...
  TMyObj522_List0 = TObjectList<TMyObj522>;

  TMyObj522_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj522_List1 = TObjectList<TMyObj522_1>;
...
constructor TMyObj522_1.Create;
begin
  inherited;
  FInt := 522 * 3;
  FTest := 'Value: ' + Random(25222).ToString + Random(52200).ToString;
end;

procedure TForm522.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum522;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj522_List0 := TMyObj522_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj522_List1 := TMyObj522_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
