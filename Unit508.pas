...
type
  ...
  TMyObj508_List0 = TObjectList<TMyObj508>;

  TMyObj508_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj508_List1 = TObjectList<TMyObj508_1>;
...
constructor TMyObj508_1.Create;
begin
  inherited;
  FInt := 508 * 3;
  FTest := 'Value: ' + Random(25082).ToString + Random(50800).ToString;
end;

procedure TForm508.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum508;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj508_List0 := TMyObj508_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj508_List1 := TMyObj508_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
