...
type
  ...
  TMyObj1171_List0 = TObjectList<TMyObj1171>;

  TMyObj1171_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1171_List1 = TObjectList<TMyObj1171_1>;
...
constructor TMyObj1171_1.Create;
begin
  inherited;
  FInt := 1171 * 3;
  FTest := 'Value: ' + Random(211712).ToString + Random(117100).ToString;
end;

procedure TForm1171.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1171;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1171_List0 := TMyObj1171_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1171_List1 := TMyObj1171_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
