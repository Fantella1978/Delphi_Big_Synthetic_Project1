...
type
  ...
  TMyObj48_List0 = TObjectList<TMyObj48>;

  TMyObj48_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj48_List1 = TObjectList<TMyObj48_1>;
...
constructor TMyObj48_1.Create;
begin
  inherited;
  FInt := 48 * 3;
  FTest := 'Value: ' + Random(2482).ToString + Random(4800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj48_List0 := TMyObj48_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj48_List1 := TMyObj48_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
