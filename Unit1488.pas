...
type
  ...
  TMyObj1488_List0 = TObjectList<TMyObj1488>;

  TMyObj1488_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1488_List1 = TObjectList<TMyObj1488_1>;
...
constructor TMyObj1488_1.Create;
begin
  inherited;
  FInt := 1488 * 3;
  FTest := 'Value: ' + Random(214882).ToString + Random(148800).ToString;
end;

procedure TForm1488.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1488;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1488_List0 := TMyObj1488_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1488_List1 := TMyObj1488_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
