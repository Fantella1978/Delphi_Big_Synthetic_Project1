...
type
  ...
  TMyObj1407_List0 = TObjectList<TMyObj1407>;

  TMyObj1407_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1407_List1 = TObjectList<TMyObj1407_1>;
...
constructor TMyObj1407_1.Create;
begin
  inherited;
  FInt := 1407 * 3;
  FTest := 'Value: ' + Random(214072).ToString + Random(140700).ToString;
end;

procedure TForm1407.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1407;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1407_List0 := TMyObj1407_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1407_List1 := TMyObj1407_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
