...
type
  ...
  TMyObj952_List0 = TObjectList<TMyObj952>;

  TMyObj952_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj952_List1 = TObjectList<TMyObj952_1>;
...
constructor TMyObj952_1.Create;
begin
  inherited;
  FInt := 952 * 3;
  FTest := 'Value: ' + Random(29522).ToString + Random(95200).ToString;
end;

procedure TForm952.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum952;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj952_List0 := TMyObj952_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj952_List1 := TMyObj952_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
