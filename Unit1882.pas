...
type
  ...
  TMyObj1882_List0 = TObjectList<TMyObj1882>;

  TMyObj1882_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1882_List1 = TObjectList<TMyObj1882_1>;
...
constructor TMyObj1882_1.Create;
begin
  inherited;
  FInt := 1882 * 3;
  FTest := 'Value: ' + Random(218822).ToString + Random(188200).ToString;
end;

procedure TForm1882.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1882;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1882_List0 := TMyObj1882_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1882_List1 := TMyObj1882_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
