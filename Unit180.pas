...
type
  ...
  TMyObj180_List0 = TObjectList<TMyObj180>;

  TMyObj180_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj180_List1 = TObjectList<TMyObj180_1>;
...
constructor TMyObj180_1.Create;
begin
  inherited;
  FInt := 180 * 3;
  FTest := 'Value: ' + Random(21802).ToString + Random(18000).ToString;
end;

procedure TForm180.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum180;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj180_List0 := TMyObj180_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj180_List1 := TMyObj180_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
