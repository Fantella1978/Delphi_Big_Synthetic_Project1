...
type
  ...
  TMyObj1472_List0 = TObjectList<TMyObj1472>;

  TMyObj1472_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1472_List1 = TObjectList<TMyObj1472_1>;
...
constructor TMyObj1472_1.Create;
begin
  inherited;
  FInt := 1472 * 3;
  FTest := 'Value: ' + Random(214722).ToString + Random(147200).ToString;
end;

procedure TForm1472.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1472;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1472_List0 := TMyObj1472_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1472_List1 := TMyObj1472_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
