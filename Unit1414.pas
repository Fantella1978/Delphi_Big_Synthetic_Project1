...
type
  ...
  TMyObj1414_List0 = TObjectList<TMyObj1414>;

  TMyObj1414_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1414_List1 = TObjectList<TMyObj1414_1>;
...
constructor TMyObj1414_1.Create;
begin
  inherited;
  FInt := 1414 * 3;
  FTest := 'Value: ' + Random(214142).ToString + Random(141400).ToString;
end;

procedure TForm1414.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1414;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1414_List0 := TMyObj1414_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1414_List1 := TMyObj1414_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
