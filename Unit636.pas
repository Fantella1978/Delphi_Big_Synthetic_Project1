...
type
  ...
  TMyObj636_List0 = TObjectList<TMyObj636>;

  TMyObj636_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj636_List1 = TObjectList<TMyObj636_1>;
...
constructor TMyObj636_1.Create;
begin
  inherited;
  FInt := 636 * 3;
  FTest := 'Value: ' + Random(26362).ToString + Random(63600).ToString;
end;

procedure TForm636.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum636;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj636_List0 := TMyObj636_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj636_List1 := TMyObj636_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
