...
type
  ...
  TMyObj559_List0 = TObjectList<TMyObj559>;

  TMyObj559_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj559_List1 = TObjectList<TMyObj559_1>;
...
constructor TMyObj559_1.Create;
begin
  inherited;
  FInt := 559 * 3;
  FTest := 'Value: ' + Random(25592).ToString + Random(55900).ToString;
end;

procedure TForm559.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum559;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj559_List0 := TMyObj559_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj559_List1 := TMyObj559_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
