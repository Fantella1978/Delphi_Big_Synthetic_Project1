...
type
  ...
  TMyObj465_List0 = TObjectList<TMyObj465>;

  TMyObj465_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj465_List1 = TObjectList<TMyObj465_1>;
...
constructor TMyObj465_1.Create;
begin
  inherited;
  FInt := 465 * 3;
  FTest := 'Value: ' + Random(24652).ToString + Random(46500).ToString;
end;

procedure TForm465.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum465;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj465_List0 := TMyObj465_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj465_List1 := TMyObj465_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
