...
type
  ...
  TMyObj2388_List0 = TObjectList<TMyObj2388>;

  TMyObj2388_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2388_List1 = TObjectList<TMyObj2388_1>;
...
constructor TMyObj2388_1.Create;
begin
  inherited;
  FInt := 2388 * 3;
  FTest := 'Value: ' + Random(223882).ToString + Random(238800).ToString;
end;

procedure TForm2388.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2388;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2388_List0 := TMyObj2388_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2388_List1 := TMyObj2388_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
