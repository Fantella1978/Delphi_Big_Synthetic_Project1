...
type
  ...
  TMyObj1033_List0 = TObjectList<TMyObj1033>;

  TMyObj1033_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1033_List1 = TObjectList<TMyObj1033_1>;
...
constructor TMyObj1033_1.Create;
begin
  inherited;
  FInt := 1033 * 3;
  FTest := 'Value: ' + Random(210332).ToString + Random(103300).ToString;
end;

procedure TForm1033.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1033;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1033_List0 := TMyObj1033_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1033_List1 := TMyObj1033_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
