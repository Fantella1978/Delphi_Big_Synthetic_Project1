...
type
  ...
  TMyObj894_List0 = TObjectList<TMyObj894>;

  TMyObj894_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj894_List1 = TObjectList<TMyObj894_1>;
...
constructor TMyObj894_1.Create;
begin
  inherited;
  FInt := 894 * 3;
  FTest := 'Value: ' + Random(28942).ToString + Random(89400).ToString;
end;

procedure TForm894.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum894;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj894_List0 := TMyObj894_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj894_List1 := TMyObj894_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
