...
type
  ...
  TMyObj492_List0 = TObjectList<TMyObj492>;

  TMyObj492_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj492_List1 = TObjectList<TMyObj492_1>;
...
constructor TMyObj492_1.Create;
begin
  inherited;
  FInt := 492 * 3;
  FTest := 'Value: ' + Random(24922).ToString + Random(49200).ToString;
end;

procedure TForm492.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum492;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj492_List0 := TMyObj492_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj492_List1 := TMyObj492_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
