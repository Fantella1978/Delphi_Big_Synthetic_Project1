...
type
  ...
  TMyObj1933_List0 = TObjectList<TMyObj1933>;

  TMyObj1933_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1933_List1 = TObjectList<TMyObj1933_1>;
...
constructor TMyObj1933_1.Create;
begin
  inherited;
  FInt := 1933 * 3;
  FTest := 'Value: ' + Random(219332).ToString + Random(193300).ToString;
end;

procedure TForm1933.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1933;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1933_List0 := TMyObj1933_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1933_List1 := TMyObj1933_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
