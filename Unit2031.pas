...
type
  ...
  TMyObj2031_List0 = TObjectList<TMyObj2031>;

  TMyObj2031_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2031_List1 = TObjectList<TMyObj2031_1>;
...
constructor TMyObj2031_1.Create;
begin
  inherited;
  FInt := 2031 * 3;
  FTest := 'Value: ' + Random(220312).ToString + Random(203100).ToString;
end;

procedure TForm2031.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2031;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2031_List0 := TMyObj2031_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2031_List1 := TMyObj2031_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
