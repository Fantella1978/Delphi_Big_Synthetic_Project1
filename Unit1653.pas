...
type
  ...
  TMyObj1653_List0 = TObjectList<TMyObj1653>;

  TMyObj1653_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1653_List1 = TObjectList<TMyObj1653_1>;
...
constructor TMyObj1653_1.Create;
begin
  inherited;
  FInt := 1653 * 3;
  FTest := 'Value: ' + Random(216532).ToString + Random(165300).ToString;
end;

procedure TForm1653.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1653;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1653_List0 := TMyObj1653_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1653_List1 := TMyObj1653_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
