...
type
  ...
  TMyObj1996_List0 = TObjectList<TMyObj1996>;

  TMyObj1996_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1996_List1 = TObjectList<TMyObj1996_1>;
...
constructor TMyObj1996_1.Create;
begin
  inherited;
  FInt := 1996 * 3;
  FTest := 'Value: ' + Random(219962).ToString + Random(199600).ToString;
end;

procedure TForm1996.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1996;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1996_List0 := TMyObj1996_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1996_List1 := TMyObj1996_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
