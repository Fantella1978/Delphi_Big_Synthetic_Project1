...
type
  ...
  TMyObj840_List0 = TObjectList<TMyObj840>;

  TMyObj840_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj840_List1 = TObjectList<TMyObj840_1>;
...
constructor TMyObj840_1.Create;
begin
  inherited;
  FInt := 840 * 3;
  FTest := 'Value: ' + Random(28402).ToString + Random(84000).ToString;
end;

procedure TForm840.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum840;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj840_List0 := TMyObj840_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj840_List1 := TMyObj840_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
