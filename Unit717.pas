...
type
  ...
  TMyObj717_List0 = TObjectList<TMyObj717>;

  TMyObj717_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj717_List1 = TObjectList<TMyObj717_1>;
...
constructor TMyObj717_1.Create;
begin
  inherited;
  FInt := 717 * 3;
  FTest := 'Value: ' + Random(27172).ToString + Random(71700).ToString;
end;

procedure TForm717.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum717;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj717_List0 := TMyObj717_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj717_List1 := TMyObj717_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
