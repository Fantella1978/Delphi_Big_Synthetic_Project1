...
type
  ...
  TMyObj1585_List0 = TObjectList<TMyObj1585>;

  TMyObj1585_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1585_List1 = TObjectList<TMyObj1585_1>;
...
constructor TMyObj1585_1.Create;
begin
  inherited;
  FInt := 1585 * 3;
  FTest := 'Value: ' + Random(215852).ToString + Random(158500).ToString;
end;

procedure TForm1585.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1585;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1585_List0 := TMyObj1585_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1585_List1 := TMyObj1585_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
