...
type
  ...
  TMyObj641_List0 = TObjectList<TMyObj641>;

  TMyObj641_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj641_List1 = TObjectList<TMyObj641_1>;
...
constructor TMyObj641_1.Create;
begin
  inherited;
  FInt := 641 * 3;
  FTest := 'Value: ' + Random(26412).ToString + Random(64100).ToString;
end;

procedure TForm641.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum641;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj641_List0 := TMyObj641_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj641_List1 := TMyObj641_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
