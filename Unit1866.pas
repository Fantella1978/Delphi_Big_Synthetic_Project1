...
type
  ...
  TMyObj1866_List0 = TObjectList<TMyObj1866>;

  TMyObj1866_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1866_List1 = TObjectList<TMyObj1866_1>;
...
constructor TMyObj1866_1.Create;
begin
  inherited;
  FInt := 1866 * 3;
  FTest := 'Value: ' + Random(218662).ToString + Random(186600).ToString;
end;

procedure TForm1866.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1866;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1866_List0 := TMyObj1866_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1866_List1 := TMyObj1866_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
