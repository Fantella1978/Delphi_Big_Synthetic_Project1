...
type
  ...
  TMyObj676_List0 = TObjectList<TMyObj676>;

  TMyObj676_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj676_List1 = TObjectList<TMyObj676_1>;
...
constructor TMyObj676_1.Create;
begin
  inherited;
  FInt := 676 * 3;
  FTest := 'Value: ' + Random(26762).ToString + Random(67600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj676_List0 := TMyObj676_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj676_List1 := TMyObj676_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
