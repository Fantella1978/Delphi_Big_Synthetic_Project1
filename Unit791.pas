...
type
  ...
  TMyObj791_List0 = TObjectList<TMyObj791>;

  TMyObj791_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj791_List1 = TObjectList<TMyObj791_1>;
...
constructor TMyObj791_1.Create;
begin
  inherited;
  FInt := 791 * 3;
  FTest := 'Value: ' + Random(27912).ToString + Random(79100).ToString;
end;

procedure TForm791.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum791;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj791_List0 := TMyObj791_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj791_List1 := TMyObj791_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
