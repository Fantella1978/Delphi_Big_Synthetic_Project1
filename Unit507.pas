...
type
  ...
  TMyObj507_List0 = TObjectList<TMyObj507>;

  TMyObj507_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj507_List1 = TObjectList<TMyObj507_1>;
...
constructor TMyObj507_1.Create;
begin
  inherited;
  FInt := 507 * 3;
  FTest := 'Value: ' + Random(25072).ToString + Random(50700).ToString;
end;

procedure TForm507.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum507;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj507_List0 := TMyObj507_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj507_List1 := TMyObj507_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
