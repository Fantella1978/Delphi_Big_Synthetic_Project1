...
type
  ...
  TMyObj1776_List0 = TObjectList<TMyObj1776>;

  TMyObj1776_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1776_List1 = TObjectList<TMyObj1776_1>;
...
constructor TMyObj1776_1.Create;
begin
  inherited;
  FInt := 1776 * 3;
  FTest := 'Value: ' + Random(217762).ToString + Random(177600).ToString;
end;

procedure TForm1776.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1776;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1776_List0 := TMyObj1776_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1776_List1 := TMyObj1776_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
