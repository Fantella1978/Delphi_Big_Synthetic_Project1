...
type
  ...
  TMyObj883_List0 = TObjectList<TMyObj883>;

  TMyObj883_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj883_List1 = TObjectList<TMyObj883_1>;
...
constructor TMyObj883_1.Create;
begin
  inherited;
  FInt := 883 * 3;
  FTest := 'Value: ' + Random(28832).ToString + Random(88300).ToString;
end;

procedure TForm883.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum883;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj883_List0 := TMyObj883_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj883_List1 := TMyObj883_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
