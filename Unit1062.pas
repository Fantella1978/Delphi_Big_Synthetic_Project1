...
type
  ...
  TMyObj1062_List0 = TObjectList<TMyObj1062>;

  TMyObj1062_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1062_List1 = TObjectList<TMyObj1062_1>;
...
constructor TMyObj1062_1.Create;
begin
  inherited;
  FInt := 1062 * 3;
  FTest := 'Value: ' + Random(210622).ToString + Random(106200).ToString;
end;

procedure TForm1062.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1062;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1062_List0 := TMyObj1062_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1062_List1 := TMyObj1062_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
