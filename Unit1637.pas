...
type
  ...
  TMyObj1637_List0 = TObjectList<TMyObj1637>;

  TMyObj1637_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1637_List1 = TObjectList<TMyObj1637_1>;
...
constructor TMyObj1637_1.Create;
begin
  inherited;
  FInt := 1637 * 3;
  FTest := 'Value: ' + Random(216372).ToString + Random(163700).ToString;
end;

procedure TForm1637.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1637;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1637_List0 := TMyObj1637_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1637_List1 := TMyObj1637_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
