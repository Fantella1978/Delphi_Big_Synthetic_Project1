...
type
  ...
  TMyObj640_List0 = TObjectList<TMyObj640>;

  TMyObj640_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj640_List1 = TObjectList<TMyObj640_1>;
...
constructor TMyObj640_1.Create;
begin
  inherited;
  FInt := 640 * 3;
  FTest := 'Value: ' + Random(26402).ToString + Random(64000).ToString;
end;

procedure TForm640.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum640;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj640_List0 := TMyObj640_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj640_List1 := TMyObj640_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
