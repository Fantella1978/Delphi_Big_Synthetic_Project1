...
type
  ...
  TMyObj242_List0 = TObjectList<TMyObj242>;

  TMyObj242_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj242_List1 = TObjectList<TMyObj242_1>;
...
constructor TMyObj242_1.Create;
begin
  inherited;
  FInt := 242 * 3;
  FTest := 'Value: ' + Random(22422).ToString + Random(24200).ToString;
end;

procedure TForm242.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum242;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj242_List0 := TMyObj242_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj242_List1 := TMyObj242_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
