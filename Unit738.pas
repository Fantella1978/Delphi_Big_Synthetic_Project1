...
type
  ...
  TMyObj738_List0 = TObjectList<TMyObj738>;

  TMyObj738_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj738_List1 = TObjectList<TMyObj738_1>;
...
constructor TMyObj738_1.Create;
begin
  inherited;
  FInt := 738 * 3;
  FTest := 'Value: ' + Random(27382).ToString + Random(73800).ToString;
end;

procedure TForm738.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum738;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj738_List0 := TMyObj738_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj738_List1 := TMyObj738_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
