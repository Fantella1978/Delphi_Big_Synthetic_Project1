...
type
  ...
  TMyObj398_List0 = TObjectList<TMyObj398>;

  TMyObj398_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj398_List1 = TObjectList<TMyObj398_1>;
...
constructor TMyObj398_1.Create;
begin
  inherited;
  FInt := 398 * 3;
  FTest := 'Value: ' + Random(23982).ToString + Random(39800).ToString;
end;

procedure TForm398.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum398;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj398_List0 := TMyObj398_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj398_List1 := TMyObj398_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
