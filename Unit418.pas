...
type
  ...
  TMyObj418_List0 = TObjectList<TMyObj418>;

  TMyObj418_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj418_List1 = TObjectList<TMyObj418_1>;
...
constructor TMyObj418_1.Create;
begin
  inherited;
  FInt := 418 * 3;
  FTest := 'Value: ' + Random(24182).ToString + Random(41800).ToString;
end;

procedure TForm418.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum418;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj418_List0 := TMyObj418_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj418_List1 := TMyObj418_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
