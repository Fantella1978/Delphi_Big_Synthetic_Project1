...
type
  ...
  TMyObj208_List0 = TObjectList<TMyObj208>;

  TMyObj208_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj208_List1 = TObjectList<TMyObj208_1>;
...
constructor TMyObj208_1.Create;
begin
  inherited;
  FInt := 208 * 3;
  FTest := 'Value: ' + Random(22082).ToString + Random(20800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj208_List0 := TMyObj208_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj208_List1 := TMyObj208_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
