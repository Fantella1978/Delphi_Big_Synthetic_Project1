...
type
  ...
  TMyObj1529_List0 = TObjectList<TMyObj1529>;

  TMyObj1529_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1529_List1 = TObjectList<TMyObj1529_1>;
...
constructor TMyObj1529_1.Create;
begin
  inherited;
  FInt := 1529 * 3;
  FTest := 'Value: ' + Random(215292).ToString + Random(152900).ToString;
end;

procedure TForm1529.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1529;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1529_List0 := TMyObj1529_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1529_List1 := TMyObj1529_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
