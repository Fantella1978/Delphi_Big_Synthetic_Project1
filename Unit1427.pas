...
type
  ...
  TMyObj1427_List0 = TObjectList<TMyObj1427>;

  TMyObj1427_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1427_List1 = TObjectList<TMyObj1427_1>;
...
constructor TMyObj1427_1.Create;
begin
  inherited;
  FInt := 1427 * 3;
  FTest := 'Value: ' + Random(214272).ToString + Random(142700).ToString;
end;

procedure TForm1427.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1427;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1427_List0 := TMyObj1427_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1427_List1 := TMyObj1427_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
