...
type
  ...
  TMyObj1851_List0 = TObjectList<TMyObj1851>;

  TMyObj1851_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1851_List1 = TObjectList<TMyObj1851_1>;
...
constructor TMyObj1851_1.Create;
begin
  inherited;
  FInt := 1851 * 3;
  FTest := 'Value: ' + Random(218512).ToString + Random(185100).ToString;
end;

procedure TForm1851.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1851;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1851_List0 := TMyObj1851_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1851_List1 := TMyObj1851_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
