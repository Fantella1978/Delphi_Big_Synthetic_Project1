...
type
  ...
  TMyObj2387_List0 = TObjectList<TMyObj2387>;

  TMyObj2387_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2387_List1 = TObjectList<TMyObj2387_1>;
...
constructor TMyObj2387_1.Create;
begin
  inherited;
  FInt := 2387 * 3;
  FTest := 'Value: ' + Random(223872).ToString + Random(238700).ToString;
end;

procedure TForm2387.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2387;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2387_List0 := TMyObj2387_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2387_List1 := TMyObj2387_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
