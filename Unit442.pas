...
type
  ...
  TMyObj442_List0 = TObjectList<TMyObj442>;

  TMyObj442_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj442_List1 = TObjectList<TMyObj442_1>;
...
constructor TMyObj442_1.Create;
begin
  inherited;
  FInt := 442 * 3;
  FTest := 'Value: ' + Random(24422).ToString + Random(44200).ToString;
end;

procedure TForm442.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum442;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj442_List0 := TMyObj442_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj442_List1 := TMyObj442_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
