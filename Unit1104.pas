...
type
  ...
  TMyObj1104_List0 = TObjectList<TMyObj1104>;

  TMyObj1104_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1104_List1 = TObjectList<TMyObj1104_1>;
...
constructor TMyObj1104_1.Create;
begin
  inherited;
  FInt := 1104 * 3;
  FTest := 'Value: ' + Random(211042).ToString + Random(110400).ToString;
end;

procedure TForm1104.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1104;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1104_List0 := TMyObj1104_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1104_List1 := TMyObj1104_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
