...
type
  ...
  TMyObj1654_List0 = TObjectList<TMyObj1654>;

  TMyObj1654_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1654_List1 = TObjectList<TMyObj1654_1>;
...
constructor TMyObj1654_1.Create;
begin
  inherited;
  FInt := 1654 * 3;
  FTest := 'Value: ' + Random(216542).ToString + Random(165400).ToString;
end;

procedure TForm1654.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1654;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1654_List0 := TMyObj1654_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1654_List1 := TMyObj1654_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
