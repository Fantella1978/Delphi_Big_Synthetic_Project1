...
type
  ...
  TMyObj1724_List0 = TObjectList<TMyObj1724>;

  TMyObj1724_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1724_List1 = TObjectList<TMyObj1724_1>;
...
constructor TMyObj1724_1.Create;
begin
  inherited;
  FInt := 1724 * 3;
  FTest := 'Value: ' + Random(217242).ToString + Random(172400).ToString;
end;

procedure TForm1724.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1724;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1724_List0 := TMyObj1724_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1724_List1 := TMyObj1724_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
