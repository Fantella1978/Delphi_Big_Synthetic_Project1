...
type
  ...
  TMyObj1680_List0 = TObjectList<TMyObj1680>;

  TMyObj1680_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1680_List1 = TObjectList<TMyObj1680_1>;
...
constructor TMyObj1680_1.Create;
begin
  inherited;
  FInt := 1680 * 3;
  FTest := 'Value: ' + Random(216802).ToString + Random(168000).ToString;
end;

procedure TForm1680.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1680;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1680_List0 := TMyObj1680_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1680_List1 := TMyObj1680_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
