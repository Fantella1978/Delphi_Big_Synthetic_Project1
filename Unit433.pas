...
type
  ...
  TMyObj433_List0 = TObjectList<TMyObj433>;

  TMyObj433_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj433_List1 = TObjectList<TMyObj433_1>;
...
constructor TMyObj433_1.Create;
begin
  inherited;
  FInt := 433 * 3;
  FTest := 'Value: ' + Random(24332).ToString + Random(43300).ToString;
end;

procedure TForm433.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum433;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj433_List0 := TMyObj433_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj433_List1 := TMyObj433_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
