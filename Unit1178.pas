...
type
  ...
  TMyObj1178_List0 = TObjectList<TMyObj1178>;

  TMyObj1178_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1178_List1 = TObjectList<TMyObj1178_1>;
...
constructor TMyObj1178_1.Create;
begin
  inherited;
  FInt := 1178 * 3;
  FTest := 'Value: ' + Random(211782).ToString + Random(117800).ToString;
end;

procedure TForm1178.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1178;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1178_List0 := TMyObj1178_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1178_List1 := TMyObj1178_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
