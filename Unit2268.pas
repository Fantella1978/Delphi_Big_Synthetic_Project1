...
type
  ...
  TMyObj2268_List0 = TObjectList<TMyObj2268>;

  TMyObj2268_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2268_List1 = TObjectList<TMyObj2268_1>;
...
constructor TMyObj2268_1.Create;
begin
  inherited;
  FInt := 2268 * 3;
  FTest := 'Value: ' + Random(222682).ToString + Random(226800).ToString;
end;

procedure TForm2268.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2268;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2268_List0 := TMyObj2268_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2268_List1 := TMyObj2268_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
