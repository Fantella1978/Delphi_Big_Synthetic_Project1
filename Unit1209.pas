...
type
  ...
  TMyObj1209_List0 = TObjectList<TMyObj1209>;

  TMyObj1209_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1209_List1 = TObjectList<TMyObj1209_1>;
...
constructor TMyObj1209_1.Create;
begin
  inherited;
  FInt := 1209 * 3;
  FTest := 'Value: ' + Random(212092).ToString + Random(120900).ToString;
end;

procedure TForm1209.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1209;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1209_List0 := TMyObj1209_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1209_List1 := TMyObj1209_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
