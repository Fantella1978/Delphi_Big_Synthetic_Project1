...
type
  ...
  TMyObj1847_List0 = TObjectList<TMyObj1847>;

  TMyObj1847_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1847_List1 = TObjectList<TMyObj1847_1>;
...
constructor TMyObj1847_1.Create;
begin
  inherited;
  FInt := 1847 * 3;
  FTest := 'Value: ' + Random(218472).ToString + Random(184700).ToString;
end;

procedure TForm1847.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1847;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1847_List0 := TMyObj1847_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1847_List1 := TMyObj1847_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
