...
type
  ...
  TMyObj911_List0 = TObjectList<TMyObj911>;

  TMyObj911_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj911_List1 = TObjectList<TMyObj911_1>;
...
constructor TMyObj911_1.Create;
begin
  inherited;
  FInt := 911 * 3;
  FTest := 'Value: ' + Random(29112).ToString + Random(91100).ToString;
end;

procedure TForm911.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum911;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj911_List0 := TMyObj911_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj911_List1 := TMyObj911_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
