...
type
  ...
  TMyObj2020_List0 = TObjectList<TMyObj2020>;

  TMyObj2020_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2020_List1 = TObjectList<TMyObj2020_1>;
...
constructor TMyObj2020_1.Create;
begin
  inherited;
  FInt := 2020 * 3;
  FTest := 'Value: ' + Random(220202).ToString + Random(202000).ToString;
end;

procedure TForm2020.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2020;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2020_List0 := TMyObj2020_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2020_List1 := TMyObj2020_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
