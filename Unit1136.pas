...
type
  ...
  TMyObj1136_List0 = TObjectList<TMyObj1136>;

  TMyObj1136_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1136_List1 = TObjectList<TMyObj1136_1>;
...
constructor TMyObj1136_1.Create;
begin
  inherited;
  FInt := 1136 * 3;
  FTest := 'Value: ' + Random(211362).ToString + Random(113600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1136_List0 := TMyObj1136_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1136_List1 := TMyObj1136_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
