...
type
  ...
  TMyObj280_List0 = TObjectList<TMyObj280>;

  TMyObj280_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj280_List1 = TObjectList<TMyObj280_1>;
...
constructor TMyObj280_1.Create;
begin
  inherited;
  FInt := 280 * 3;
  FTest := 'Value: ' + Random(22802).ToString + Random(28000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj280_List0 := TMyObj280_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj280_List1 := TMyObj280_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
