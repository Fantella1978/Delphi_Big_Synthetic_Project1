...
type
  ...
  TMyObj14_List0 = TObjectList<TMyObj14>;

  TMyObj14_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj14_List1 = TObjectList<TMyObj14_1>;
...
constructor TMyObj14_1.Create;
begin
  inherited;
  FInt := 14 * 3;
  FTest := 'Value: ' + Random(2142).ToString + Random(1400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj14_List0 := TMyObj14_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj14_List1 := TMyObj14_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
