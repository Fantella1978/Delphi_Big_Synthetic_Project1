...
type
  ...
  TMyObj1478_List0 = TObjectList<TMyObj1478>;

  TMyObj1478_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1478_List1 = TObjectList<TMyObj1478_1>;
...
constructor TMyObj1478_1.Create;
begin
  inherited;
  FInt := 1478 * 3;
  FTest := 'Value: ' + Random(214782).ToString + Random(147800).ToString;
end;

procedure TForm1478.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1478;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1478_List0 := TMyObj1478_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1478_List1 := TMyObj1478_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
