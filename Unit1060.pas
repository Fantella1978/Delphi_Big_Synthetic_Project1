...
type
  ...
  TMyObj1060_List0 = TObjectList<TMyObj1060>;

  TMyObj1060_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1060_List1 = TObjectList<TMyObj1060_1>;
...
constructor TMyObj1060_1.Create;
begin
  inherited;
  FInt := 1060 * 3;
  FTest := 'Value: ' + Random(210602).ToString + Random(106000).ToString;
end;

procedure TForm1060.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1060;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1060_List0 := TMyObj1060_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1060_List1 := TMyObj1060_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
