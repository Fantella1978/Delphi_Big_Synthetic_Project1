...
type
  ...
  TMyObj1030_List0 = TObjectList<TMyObj1030>;

  TMyObj1030_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1030_List1 = TObjectList<TMyObj1030_1>;
...
constructor TMyObj1030_1.Create;
begin
  inherited;
  FInt := 1030 * 3;
  FTest := 'Value: ' + Random(210302).ToString + Random(103000).ToString;
end;

procedure TForm1030.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1030;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1030_List0 := TMyObj1030_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1030_List1 := TMyObj1030_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
