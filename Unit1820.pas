...
type
  ...
  TMyObj1820_List0 = TObjectList<TMyObj1820>;

  TMyObj1820_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1820_List1 = TObjectList<TMyObj1820_1>;
...
constructor TMyObj1820_1.Create;
begin
  inherited;
  FInt := 1820 * 3;
  FTest := 'Value: ' + Random(218202).ToString + Random(182000).ToString;
end;

procedure TForm1820.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1820;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1820_List0 := TMyObj1820_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1820_List1 := TMyObj1820_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
