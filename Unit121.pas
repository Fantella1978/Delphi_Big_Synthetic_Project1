...
type
  ...
  TMyObj121_List0 = TObjectList<TMyObj121>;

  TMyObj121_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj121_List1 = TObjectList<TMyObj121_1>;
...
constructor TMyObj121_1.Create;
begin
  inherited;
  FInt := 121 * 3;
  FTest := 'Value: ' + Random(21212).ToString + Random(12100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj121_List0 := TMyObj121_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj121_List1 := TMyObj121_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
