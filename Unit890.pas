...
type
  ...
  TMyObj890_List0 = TObjectList<TMyObj890>;

  TMyObj890_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj890_List1 = TObjectList<TMyObj890_1>;
...
constructor TMyObj890_1.Create;
begin
  inherited;
  FInt := 890 * 3;
  FTest := 'Value: ' + Random(28902).ToString + Random(89000).ToString;
end;

procedure TForm890.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum890;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj890_List0 := TMyObj890_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj890_List1 := TMyObj890_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
