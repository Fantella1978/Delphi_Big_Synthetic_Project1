...
type
  ...
  TMyObj2209_List0 = TObjectList<TMyObj2209>;

  TMyObj2209_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2209_List1 = TObjectList<TMyObj2209_1>;
...
constructor TMyObj2209_1.Create;
begin
  inherited;
  FInt := 2209 * 3;
  FTest := 'Value: ' + Random(222092).ToString + Random(220900).ToString;
end;

procedure TForm2209.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2209;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2209_List0 := TMyObj2209_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2209_List1 := TMyObj2209_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
