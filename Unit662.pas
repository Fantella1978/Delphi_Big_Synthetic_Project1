...
type
  ...
  TMyObj662_List0 = TObjectList<TMyObj662>;

  TMyObj662_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj662_List1 = TObjectList<TMyObj662_1>;
...
constructor TMyObj662_1.Create;
begin
  inherited;
  FInt := 662 * 3;
  FTest := 'Value: ' + Random(26622).ToString + Random(66200).ToString;
end;

procedure TForm662.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum662;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj662_List0 := TMyObj662_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj662_List1 := TMyObj662_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
