...
type
  ...
  TMyObj2497_List0 = TObjectList<TMyObj2497>;

  TMyObj2497_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2497_List1 = TObjectList<TMyObj2497_1>;
...
constructor TMyObj2497_1.Create;
begin
  inherited;
  FInt := 2497 * 3;
  FTest := 'Value: ' + Random(224972).ToString + Random(249700).ToString;
end;

procedure TForm2497.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2497;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2497_List0 := TMyObj2497_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2497_List1 := TMyObj2497_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
