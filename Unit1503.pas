...
type
  ...
  TMyObj1503_List0 = TObjectList<TMyObj1503>;

  TMyObj1503_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1503_List1 = TObjectList<TMyObj1503_1>;
...
constructor TMyObj1503_1.Create;
begin
  inherited;
  FInt := 1503 * 3;
  FTest := 'Value: ' + Random(215032).ToString + Random(150300).ToString;
end;

procedure TForm1503.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1503;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1503_List0 := TMyObj1503_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1503_List1 := TMyObj1503_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
