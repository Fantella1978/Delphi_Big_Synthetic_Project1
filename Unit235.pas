...
type
  ...
  TMyObj235_List0 = TObjectList<TMyObj235>;

  TMyObj235_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj235_List1 = TObjectList<TMyObj235_1>;
...
constructor TMyObj235_1.Create;
begin
  inherited;
  FInt := 235 * 3;
  FTest := 'Value: ' + Random(22352).ToString + Random(23500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj235_List0 := TMyObj235_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj235_List1 := TMyObj235_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
