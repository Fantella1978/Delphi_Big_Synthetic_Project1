...
type
  ...
  TMyObj1117_List0 = TObjectList<TMyObj1117>;

  TMyObj1117_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1117_List1 = TObjectList<TMyObj1117_1>;
...
constructor TMyObj1117_1.Create;
begin
  inherited;
  FInt := 1117 * 3;
  FTest := 'Value: ' + Random(211172).ToString + Random(111700).ToString;
end;

procedure TForm1117.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1117;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1117_List0 := TMyObj1117_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1117_List1 := TMyObj1117_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
