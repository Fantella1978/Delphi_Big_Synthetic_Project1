...
type
  ...
  TMyObj1249_List0 = TObjectList<TMyObj1249>;

  TMyObj1249_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1249_List1 = TObjectList<TMyObj1249_1>;
...
constructor TMyObj1249_1.Create;
begin
  inherited;
  FInt := 1249 * 3;
  FTest := 'Value: ' + Random(212492).ToString + Random(124900).ToString;
end;

procedure TForm1249.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1249;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1249_List0 := TMyObj1249_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1249_List1 := TMyObj1249_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
