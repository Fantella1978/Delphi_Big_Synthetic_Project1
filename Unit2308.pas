...
type
  ...
  TMyObj2308_List0 = TObjectList<TMyObj2308>;

  TMyObj2308_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2308_List1 = TObjectList<TMyObj2308_1>;
...
constructor TMyObj2308_1.Create;
begin
  inherited;
  FInt := 2308 * 3;
  FTest := 'Value: ' + Random(223082).ToString + Random(230800).ToString;
end;

procedure TForm2308.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2308;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2308_List0 := TMyObj2308_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2308_List1 := TMyObj2308_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
