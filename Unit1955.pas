...
type
  ...
  TMyObj1955_List0 = TObjectList<TMyObj1955>;

  TMyObj1955_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1955_List1 = TObjectList<TMyObj1955_1>;
...
constructor TMyObj1955_1.Create;
begin
  inherited;
  FInt := 1955 * 3;
  FTest := 'Value: ' + Random(219552).ToString + Random(195500).ToString;
end;

procedure TForm1955.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1955;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1955_List0 := TMyObj1955_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1955_List1 := TMyObj1955_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
