...
type
  ...
  TMyObj1634_List0 = TObjectList<TMyObj1634>;

  TMyObj1634_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1634_List1 = TObjectList<TMyObj1634_1>;
...
constructor TMyObj1634_1.Create;
begin
  inherited;
  FInt := 1634 * 3;
  FTest := 'Value: ' + Random(216342).ToString + Random(163400).ToString;
end;

procedure TForm1634.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1634;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1634_List0 := TMyObj1634_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1634_List1 := TMyObj1634_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
