...
type
  ...
  TMyObj1122_List0 = TObjectList<TMyObj1122>;

  TMyObj1122_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1122_List1 = TObjectList<TMyObj1122_1>;
...
constructor TMyObj1122_1.Create;
begin
  inherited;
  FInt := 1122 * 3;
  FTest := 'Value: ' + Random(211222).ToString + Random(112200).ToString;
end;

procedure TForm1122.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1122;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1122_List0 := TMyObj1122_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1122_List1 := TMyObj1122_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
