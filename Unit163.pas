...
type
  ...
  TMyObj163_List0 = TObjectList<TMyObj163>;

  TMyObj163_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj163_List1 = TObjectList<TMyObj163_1>;
...
constructor TMyObj163_1.Create;
begin
  inherited;
  FInt := 163 * 3;
  FTest := 'Value: ' + Random(21632).ToString + Random(16300).ToString;
end;

procedure TForm163.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum163;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj163_List0 := TMyObj163_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj163_List1 := TMyObj163_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
