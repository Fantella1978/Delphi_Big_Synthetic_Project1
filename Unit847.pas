...
type
  ...
  TMyObj847_List0 = TObjectList<TMyObj847>;

  TMyObj847_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj847_List1 = TObjectList<TMyObj847_1>;
...
constructor TMyObj847_1.Create;
begin
  inherited;
  FInt := 847 * 3;
  FTest := 'Value: ' + Random(28472).ToString + Random(84700).ToString;
end;

procedure TForm847.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum847;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj847_List0 := TMyObj847_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj847_List1 := TMyObj847_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
