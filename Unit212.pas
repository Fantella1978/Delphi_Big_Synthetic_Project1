...
type
  ...
  TMyObj212_List0 = TObjectList<TMyObj212>;

  TMyObj212_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj212_List1 = TObjectList<TMyObj212_1>;
...
constructor TMyObj212_1.Create;
begin
  inherited;
  FInt := 212 * 3;
  FTest := 'Value: ' + Random(22122).ToString + Random(21200).ToString;
end;

procedure TForm212.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum212;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj212_List0 := TMyObj212_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj212_List1 := TMyObj212_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
