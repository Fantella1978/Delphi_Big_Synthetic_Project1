...
type
  ...
  TMyObj1410_List0 = TObjectList<TMyObj1410>;

  TMyObj1410_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1410_List1 = TObjectList<TMyObj1410_1>;
...
constructor TMyObj1410_1.Create;
begin
  inherited;
  FInt := 1410 * 3;
  FTest := 'Value: ' + Random(214102).ToString + Random(141000).ToString;
end;

procedure TForm1410.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1410;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1410_List0 := TMyObj1410_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1410_List1 := TMyObj1410_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
