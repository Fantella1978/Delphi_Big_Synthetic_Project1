...
type
  ...
  TMyObj2286_List0 = TObjectList<TMyObj2286>;

  TMyObj2286_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2286_List1 = TObjectList<TMyObj2286_1>;
...
constructor TMyObj2286_1.Create;
begin
  inherited;
  FInt := 2286 * 3;
  FTest := 'Value: ' + Random(222862).ToString + Random(228600).ToString;
end;

procedure TForm2286.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2286;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2286_List0 := TMyObj2286_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2286_List1 := TMyObj2286_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
