...
type
  ...
  TMyObj765_List0 = TObjectList<TMyObj765>;

  TMyObj765_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj765_List1 = TObjectList<TMyObj765_1>;
...
constructor TMyObj765_1.Create;
begin
  inherited;
  FInt := 765 * 3;
  FTest := 'Value: ' + Random(27652).ToString + Random(76500).ToString;
end;

procedure TForm765.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum765;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj765_List0 := TMyObj765_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj765_List1 := TMyObj765_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
