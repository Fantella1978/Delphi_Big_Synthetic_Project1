...
type
  ...
  TMyObj2319_List0 = TObjectList<TMyObj2319>;

  TMyObj2319_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2319_List1 = TObjectList<TMyObj2319_1>;
...
constructor TMyObj2319_1.Create;
begin
  inherited;
  FInt := 2319 * 3;
  FTest := 'Value: ' + Random(223192).ToString + Random(231900).ToString;
end;

procedure TForm2319.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2319;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2319_List0 := TMyObj2319_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2319_List1 := TMyObj2319_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
