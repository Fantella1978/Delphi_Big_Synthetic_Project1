...
type
  ...
  TMyObj2340_List0 = TObjectList<TMyObj2340>;

  TMyObj2340_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2340_List1 = TObjectList<TMyObj2340_1>;
...
constructor TMyObj2340_1.Create;
begin
  inherited;
  FInt := 2340 * 3;
  FTest := 'Value: ' + Random(223402).ToString + Random(234000).ToString;
end;

procedure TForm2340.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2340;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2340_List0 := TMyObj2340_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2340_List1 := TMyObj2340_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
