...
type
  ...
  TMyObj2034_List0 = TObjectList<TMyObj2034>;

  TMyObj2034_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2034_List1 = TObjectList<TMyObj2034_1>;
...
constructor TMyObj2034_1.Create;
begin
  inherited;
  FInt := 2034 * 3;
  FTest := 'Value: ' + Random(220342).ToString + Random(203400).ToString;
end;

procedure TForm2034.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2034;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2034_List0 := TMyObj2034_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2034_List1 := TMyObj2034_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
