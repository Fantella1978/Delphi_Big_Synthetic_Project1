...
type
  ...
  TMyObj1519_List0 = TObjectList<TMyObj1519>;

  TMyObj1519_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1519_List1 = TObjectList<TMyObj1519_1>;
...
constructor TMyObj1519_1.Create;
begin
  inherited;
  FInt := 1519 * 3;
  FTest := 'Value: ' + Random(215192).ToString + Random(151900).ToString;
end;

procedure TForm1519.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1519;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1519_List0 := TMyObj1519_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1519_List1 := TMyObj1519_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
