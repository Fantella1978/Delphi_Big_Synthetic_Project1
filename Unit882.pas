...
type
  ...
  TMyObj882_List0 = TObjectList<TMyObj882>;

  TMyObj882_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj882_List1 = TObjectList<TMyObj882_1>;
...
constructor TMyObj882_1.Create;
begin
  inherited;
  FInt := 882 * 3;
  FTest := 'Value: ' + Random(28822).ToString + Random(88200).ToString;
end;

procedure TForm882.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum882;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj882_List0 := TMyObj882_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj882_List1 := TMyObj882_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
