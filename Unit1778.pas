...
type
  ...
  TMyObj1778_List0 = TObjectList<TMyObj1778>;

  TMyObj1778_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1778_List1 = TObjectList<TMyObj1778_1>;
...
constructor TMyObj1778_1.Create;
begin
  inherited;
  FInt := 1778 * 3;
  FTest := 'Value: ' + Random(217782).ToString + Random(177800).ToString;
end;

procedure TForm1778.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1778;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1778_List0 := TMyObj1778_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1778_List1 := TMyObj1778_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
