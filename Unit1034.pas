...
type
  ...
  TMyObj1034_List0 = TObjectList<TMyObj1034>;

  TMyObj1034_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1034_List1 = TObjectList<TMyObj1034_1>;
...
constructor TMyObj1034_1.Create;
begin
  inherited;
  FInt := 1034 * 3;
  FTest := 'Value: ' + Random(210342).ToString + Random(103400).ToString;
end;

procedure TForm1034.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1034;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1034_List0 := TMyObj1034_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1034_List1 := TMyObj1034_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
