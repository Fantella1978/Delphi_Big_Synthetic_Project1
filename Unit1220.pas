...
type
  ...
  TMyObj1220_List0 = TObjectList<TMyObj1220>;

  TMyObj1220_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1220_List1 = TObjectList<TMyObj1220_1>;
...
constructor TMyObj1220_1.Create;
begin
  inherited;
  FInt := 1220 * 3;
  FTest := 'Value: ' + Random(212202).ToString + Random(122000).ToString;
end;

procedure TForm1220.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1220;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1220_List0 := TMyObj1220_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1220_List1 := TMyObj1220_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
