...
type
  ...
  TMyObj579_List0 = TObjectList<TMyObj579>;

  TMyObj579_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj579_List1 = TObjectList<TMyObj579_1>;
...
constructor TMyObj579_1.Create;
begin
  inherited;
  FInt := 579 * 3;
  FTest := 'Value: ' + Random(25792).ToString + Random(57900).ToString;
end;

procedure TForm579.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum579;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj579_List0 := TMyObj579_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj579_List1 := TMyObj579_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
