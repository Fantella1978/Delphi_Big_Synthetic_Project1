...
type
  ...
  TMyObj576_List0 = TObjectList<TMyObj576>;

  TMyObj576_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj576_List1 = TObjectList<TMyObj576_1>;
...
constructor TMyObj576_1.Create;
begin
  inherited;
  FInt := 576 * 3;
  FTest := 'Value: ' + Random(25762).ToString + Random(57600).ToString;
end;

procedure TForm576.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum576;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj576_List0 := TMyObj576_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj576_List1 := TMyObj576_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
