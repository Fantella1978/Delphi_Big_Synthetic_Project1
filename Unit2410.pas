...
type
  ...
  TMyObj2410_List0 = TObjectList<TMyObj2410>;

  TMyObj2410_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2410_List1 = TObjectList<TMyObj2410_1>;
...
constructor TMyObj2410_1.Create;
begin
  inherited;
  FInt := 2410 * 3;
  FTest := 'Value: ' + Random(224102).ToString + Random(241000).ToString;
end;

procedure TForm2410.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2410;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2410_List0 := TMyObj2410_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2410_List1 := TMyObj2410_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
