...
type
  ...
  TMyObj1259_List0 = TObjectList<TMyObj1259>;

  TMyObj1259_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1259_List1 = TObjectList<TMyObj1259_1>;
...
constructor TMyObj1259_1.Create;
begin
  inherited;
  FInt := 1259 * 3;
  FTest := 'Value: ' + Random(212592).ToString + Random(125900).ToString;
end;

procedure TForm1259.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1259;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1259_List0 := TMyObj1259_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1259_List1 := TMyObj1259_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
