...
type
  ...
  TMyObj194_List0 = TObjectList<TMyObj194>;

  TMyObj194_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj194_List1 = TObjectList<TMyObj194_1>;
...
constructor TMyObj194_1.Create;
begin
  inherited;
  FInt := 194 * 3;
  FTest := 'Value: ' + Random(21942).ToString + Random(19400).ToString;
end;

procedure TForm194.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum194;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj194_List0 := TMyObj194_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj194_List1 := TMyObj194_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
