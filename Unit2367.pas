...
type
  ...
  TMyObj2367_List0 = TObjectList<TMyObj2367>;

  TMyObj2367_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2367_List1 = TObjectList<TMyObj2367_1>;
...
constructor TMyObj2367_1.Create;
begin
  inherited;
  FInt := 2367 * 3;
  FTest := 'Value: ' + Random(223672).ToString + Random(236700).ToString;
end;

procedure TForm2367.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2367;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2367_List0 := TMyObj2367_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2367_List1 := TMyObj2367_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
