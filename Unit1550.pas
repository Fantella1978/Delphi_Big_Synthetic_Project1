...
type
  ...
  TMyObj1550_List0 = TObjectList<TMyObj1550>;

  TMyObj1550_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1550_List1 = TObjectList<TMyObj1550_1>;
...
constructor TMyObj1550_1.Create;
begin
  inherited;
  FInt := 1550 * 3;
  FTest := 'Value: ' + Random(215502).ToString + Random(155000).ToString;
end;

procedure TForm1550.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1550;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1550_List0 := TMyObj1550_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1550_List1 := TMyObj1550_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
