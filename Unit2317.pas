...
type
  ...
  TMyObj2317_List0 = TObjectList<TMyObj2317>;

  TMyObj2317_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2317_List1 = TObjectList<TMyObj2317_1>;
...
constructor TMyObj2317_1.Create;
begin
  inherited;
  FInt := 2317 * 3;
  FTest := 'Value: ' + Random(223172).ToString + Random(231700).ToString;
end;

procedure TForm2317.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2317;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2317_List0 := TMyObj2317_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2317_List1 := TMyObj2317_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
