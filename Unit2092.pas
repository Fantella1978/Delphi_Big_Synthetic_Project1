...
type
  ...
  TMyObj2092_List0 = TObjectList<TMyObj2092>;

  TMyObj2092_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2092_List1 = TObjectList<TMyObj2092_1>;
...
constructor TMyObj2092_1.Create;
begin
  inherited;
  FInt := 2092 * 3;
  FTest := 'Value: ' + Random(220922).ToString + Random(209200).ToString;
end;

procedure TForm2092.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2092;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2092_List0 := TMyObj2092_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2092_List1 := TMyObj2092_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
