...
type
  ...
  TMyObj2358_List0 = TObjectList<TMyObj2358>;

  TMyObj2358_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2358_List1 = TObjectList<TMyObj2358_1>;
...
constructor TMyObj2358_1.Create;
begin
  inherited;
  FInt := 2358 * 3;
  FTest := 'Value: ' + Random(223582).ToString + Random(235800).ToString;
end;

procedure TForm2358.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2358;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2358_List0 := TMyObj2358_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2358_List1 := TMyObj2358_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
