...
type
  ...
  TMyObj1571_List0 = TObjectList<TMyObj1571>;

  TMyObj1571_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1571_List1 = TObjectList<TMyObj1571_1>;
...
constructor TMyObj1571_1.Create;
begin
  inherited;
  FInt := 1571 * 3;
  FTest := 'Value: ' + Random(215712).ToString + Random(157100).ToString;
end;

procedure TForm1571.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1571;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1571_List0 := TMyObj1571_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1571_List1 := TMyObj1571_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
