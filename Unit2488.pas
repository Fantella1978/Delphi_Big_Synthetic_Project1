...
type
  ...
  TMyObj2488_List0 = TObjectList<TMyObj2488>;

  TMyObj2488_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2488_List1 = TObjectList<TMyObj2488_1>;
...
constructor TMyObj2488_1.Create;
begin
  inherited;
  FInt := 2488 * 3;
  FTest := 'Value: ' + Random(224882).ToString + Random(248800).ToString;
end;

procedure TForm2488.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2488;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2488_List0 := TMyObj2488_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2488_List1 := TMyObj2488_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
