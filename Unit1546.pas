...
type
  ...
  TMyObj1546_List0 = TObjectList<TMyObj1546>;

  TMyObj1546_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1546_List1 = TObjectList<TMyObj1546_1>;
...
constructor TMyObj1546_1.Create;
begin
  inherited;
  FInt := 1546 * 3;
  FTest := 'Value: ' + Random(215462).ToString + Random(154600).ToString;
end;

procedure TForm1546.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1546;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1546_List0 := TMyObj1546_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1546_List1 := TMyObj1546_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
