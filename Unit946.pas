...
type
  ...
  TMyObj946_List0 = TObjectList<TMyObj946>;

  TMyObj946_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj946_List1 = TObjectList<TMyObj946_1>;
...
constructor TMyObj946_1.Create;
begin
  inherited;
  FInt := 946 * 3;
  FTest := 'Value: ' + Random(29462).ToString + Random(94600).ToString;
end;

procedure TForm946.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum946;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj946_List0 := TMyObj946_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj946_List1 := TMyObj946_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
