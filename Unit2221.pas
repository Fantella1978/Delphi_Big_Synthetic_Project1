...
type
  ...
  TMyObj2221_List0 = TObjectList<TMyObj2221>;

  TMyObj2221_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2221_List1 = TObjectList<TMyObj2221_1>;
...
constructor TMyObj2221_1.Create;
begin
  inherited;
  FInt := 2221 * 3;
  FTest := 'Value: ' + Random(222212).ToString + Random(222100).ToString;
end;

procedure TForm2221.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2221;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2221_List0 := TMyObj2221_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2221_List1 := TMyObj2221_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
