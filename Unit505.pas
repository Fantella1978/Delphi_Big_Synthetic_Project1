...
type
  ...
  TMyObj505_List0 = TObjectList<TMyObj505>;

  TMyObj505_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj505_List1 = TObjectList<TMyObj505_1>;
...
constructor TMyObj505_1.Create;
begin
  inherited;
  FInt := 505 * 3;
  FTest := 'Value: ' + Random(25052).ToString + Random(50500).ToString;
end;

procedure TForm505.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum505;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj505_List0 := TMyObj505_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj505_List1 := TMyObj505_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
