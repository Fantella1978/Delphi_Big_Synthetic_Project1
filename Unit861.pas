...
type
  ...
  TMyObj861_List0 = TObjectList<TMyObj861>;

  TMyObj861_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj861_List1 = TObjectList<TMyObj861_1>;
...
constructor TMyObj861_1.Create;
begin
  inherited;
  FInt := 861 * 3;
  FTest := 'Value: ' + Random(28612).ToString + Random(86100).ToString;
end;

procedure TForm861.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum861;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj861_List0 := TMyObj861_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj861_List1 := TMyObj861_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
