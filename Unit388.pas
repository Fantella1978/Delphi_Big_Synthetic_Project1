...
type
  ...
  TMyObj388_List0 = TObjectList<TMyObj388>;

  TMyObj388_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj388_List1 = TObjectList<TMyObj388_1>;
...
constructor TMyObj388_1.Create;
begin
  inherited;
  FInt := 388 * 3;
  FTest := 'Value: ' + Random(23882).ToString + Random(38800).ToString;
end;

procedure TForm388.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum388;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj388_List0 := TMyObj388_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj388_List1 := TMyObj388_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
