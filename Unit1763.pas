...
type
  ...
  TMyObj1763_List0 = TObjectList<TMyObj1763>;

  TMyObj1763_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1763_List1 = TObjectList<TMyObj1763_1>;
...
constructor TMyObj1763_1.Create;
begin
  inherited;
  FInt := 1763 * 3;
  FTest := 'Value: ' + Random(217632).ToString + Random(176300).ToString;
end;

procedure TForm1763.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1763;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1763_List0 := TMyObj1763_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1763_List1 := TMyObj1763_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
