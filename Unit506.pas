...
type
  ...
  TMyObj506_List0 = TObjectList<TMyObj506>;

  TMyObj506_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj506_List1 = TObjectList<TMyObj506_1>;
...
constructor TMyObj506_1.Create;
begin
  inherited;
  FInt := 506 * 3;
  FTest := 'Value: ' + Random(25062).ToString + Random(50600).ToString;
end;

procedure TForm506.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum506;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj506_List0 := TMyObj506_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj506_List1 := TMyObj506_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
