...
type
  ...
  TMyObj1052_List0 = TObjectList<TMyObj1052>;

  TMyObj1052_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1052_List1 = TObjectList<TMyObj1052_1>;
...
constructor TMyObj1052_1.Create;
begin
  inherited;
  FInt := 1052 * 3;
  FTest := 'Value: ' + Random(210522).ToString + Random(105200).ToString;
end;

procedure TForm1052.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1052;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1052_List0 := TMyObj1052_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1052_List1 := TMyObj1052_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
