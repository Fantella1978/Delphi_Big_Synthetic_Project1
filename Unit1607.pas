...
type
  ...
  TMyObj1607_List0 = TObjectList<TMyObj1607>;

  TMyObj1607_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1607_List1 = TObjectList<TMyObj1607_1>;
...
constructor TMyObj1607_1.Create;
begin
  inherited;
  FInt := 1607 * 3;
  FTest := 'Value: ' + Random(216072).ToString + Random(160700).ToString;
end;

procedure TForm1607.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1607;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1607_List0 := TMyObj1607_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1607_List1 := TMyObj1607_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
