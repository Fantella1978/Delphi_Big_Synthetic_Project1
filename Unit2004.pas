...
type
  ...
  TMyObj2004_List0 = TObjectList<TMyObj2004>;

  TMyObj2004_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2004_List1 = TObjectList<TMyObj2004_1>;
...
constructor TMyObj2004_1.Create;
begin
  inherited;
  FInt := 2004 * 3;
  FTest := 'Value: ' + Random(220042).ToString + Random(200400).ToString;
end;

procedure TForm2004.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2004;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2004_List0 := TMyObj2004_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2004_List1 := TMyObj2004_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
