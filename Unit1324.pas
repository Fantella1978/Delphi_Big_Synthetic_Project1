...
type
  ...
  TMyObj1324_List0 = TObjectList<TMyObj1324>;

  TMyObj1324_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1324_List1 = TObjectList<TMyObj1324_1>;
...
constructor TMyObj1324_1.Create;
begin
  inherited;
  FInt := 1324 * 3;
  FTest := 'Value: ' + Random(213242).ToString + Random(132400).ToString;
end;

procedure TForm1324.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1324;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1324_List0 := TMyObj1324_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1324_List1 := TMyObj1324_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
