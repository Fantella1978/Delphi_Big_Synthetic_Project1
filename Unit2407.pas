...
type
  ...
  TMyObj2407_List0 = TObjectList<TMyObj2407>;

  TMyObj2407_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2407_List1 = TObjectList<TMyObj2407_1>;
...
constructor TMyObj2407_1.Create;
begin
  inherited;
  FInt := 2407 * 3;
  FTest := 'Value: ' + Random(224072).ToString + Random(240700).ToString;
end;

procedure TForm2407.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2407;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2407_List0 := TMyObj2407_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2407_List1 := TMyObj2407_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
