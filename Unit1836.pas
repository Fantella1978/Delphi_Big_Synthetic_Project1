...
type
  ...
  TMyObj1836_List0 = TObjectList<TMyObj1836>;

  TMyObj1836_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1836_List1 = TObjectList<TMyObj1836_1>;
...
constructor TMyObj1836_1.Create;
begin
  inherited;
  FInt := 1836 * 3;
  FTest := 'Value: ' + Random(218362).ToString + Random(183600).ToString;
end;

procedure TForm1836.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1836;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1836_List0 := TMyObj1836_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1836_List1 := TMyObj1836_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
