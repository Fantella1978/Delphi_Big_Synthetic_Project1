...
type
  ...
  TMyObj126_List0 = TObjectList<TMyObj126>;

  TMyObj126_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj126_List1 = TObjectList<TMyObj126_1>;
...
constructor TMyObj126_1.Create;
begin
  inherited;
  FInt := 126 * 3;
  FTest := 'Value: ' + Random(21262).ToString + Random(12600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj126_List0 := TMyObj126_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj126_List1 := TMyObj126_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
