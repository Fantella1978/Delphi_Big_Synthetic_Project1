...
type
  ...
  TMyObj891_List0 = TObjectList<TMyObj891>;

  TMyObj891_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj891_List1 = TObjectList<TMyObj891_1>;
...
constructor TMyObj891_1.Create;
begin
  inherited;
  FInt := 891 * 3;
  FTest := 'Value: ' + Random(28912).ToString + Random(89100).ToString;
end;

procedure TForm891.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum891;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj891_List0 := TMyObj891_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj891_List1 := TMyObj891_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
