...
type
  ...
  TMyObj597_List0 = TObjectList<TMyObj597>;

  TMyObj597_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj597_List1 = TObjectList<TMyObj597_1>;
...
constructor TMyObj597_1.Create;
begin
  inherited;
  FInt := 597 * 3;
  FTest := 'Value: ' + Random(25972).ToString + Random(59700).ToString;
end;

procedure TForm597.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum597;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj597_List0 := TMyObj597_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj597_List1 := TMyObj597_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
