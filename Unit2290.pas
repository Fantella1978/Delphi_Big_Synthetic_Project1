...
type
  ...
  TMyObj2290_List0 = TObjectList<TMyObj2290>;

  TMyObj2290_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2290_List1 = TObjectList<TMyObj2290_1>;
...
constructor TMyObj2290_1.Create;
begin
  inherited;
  FInt := 2290 * 3;
  FTest := 'Value: ' + Random(222902).ToString + Random(229000).ToString;
end;

procedure TForm2290.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2290;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2290_List0 := TMyObj2290_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2290_List1 := TMyObj2290_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
