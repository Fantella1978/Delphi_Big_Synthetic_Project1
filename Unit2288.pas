...
type
  ...
  TMyObj2288_List0 = TObjectList<TMyObj2288>;

  TMyObj2288_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2288_List1 = TObjectList<TMyObj2288_1>;
...
constructor TMyObj2288_1.Create;
begin
  inherited;
  FInt := 2288 * 3;
  FTest := 'Value: ' + Random(222882).ToString + Random(228800).ToString;
end;

procedure TForm2288.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2288;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2288_List0 := TMyObj2288_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2288_List1 := TMyObj2288_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
