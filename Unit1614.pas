...
type
  ...
  TMyObj1614_List0 = TObjectList<TMyObj1614>;

  TMyObj1614_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1614_List1 = TObjectList<TMyObj1614_1>;
...
constructor TMyObj1614_1.Create;
begin
  inherited;
  FInt := 1614 * 3;
  FTest := 'Value: ' + Random(216142).ToString + Random(161400).ToString;
end;

procedure TForm1614.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1614;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1614_List0 := TMyObj1614_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1614_List1 := TMyObj1614_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
