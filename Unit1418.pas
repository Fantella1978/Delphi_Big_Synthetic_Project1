...
type
  ...
  TMyObj1418_List0 = TObjectList<TMyObj1418>;

  TMyObj1418_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1418_List1 = TObjectList<TMyObj1418_1>;
...
constructor TMyObj1418_1.Create;
begin
  inherited;
  FInt := 1418 * 3;
  FTest := 'Value: ' + Random(214182).ToString + Random(141800).ToString;
end;

procedure TForm1418.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1418;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1418_List0 := TMyObj1418_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1418_List1 := TMyObj1418_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
