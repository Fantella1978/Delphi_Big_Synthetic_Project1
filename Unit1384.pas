...
type
  ...
  TMyObj1384_List0 = TObjectList<TMyObj1384>;

  TMyObj1384_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1384_List1 = TObjectList<TMyObj1384_1>;
...
constructor TMyObj1384_1.Create;
begin
  inherited;
  FInt := 1384 * 3;
  FTest := 'Value: ' + Random(213842).ToString + Random(138400).ToString;
end;

procedure TForm1384.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1384;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1384_List0 := TMyObj1384_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1384_List1 := TMyObj1384_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
