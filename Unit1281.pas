...
type
  ...
  TMyObj1281_List0 = TObjectList<TMyObj1281>;

  TMyObj1281_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1281_List1 = TObjectList<TMyObj1281_1>;
...
constructor TMyObj1281_1.Create;
begin
  inherited;
  FInt := 1281 * 3;
  FTest := 'Value: ' + Random(212812).ToString + Random(128100).ToString;
end;

procedure TForm1281.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1281;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1281_List0 := TMyObj1281_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1281_List1 := TMyObj1281_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
