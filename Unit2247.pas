...
type
  ...
  TMyObj2247_List0 = TObjectList<TMyObj2247>;

  TMyObj2247_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2247_List1 = TObjectList<TMyObj2247_1>;
...
constructor TMyObj2247_1.Create;
begin
  inherited;
  FInt := 2247 * 3;
  FTest := 'Value: ' + Random(222472).ToString + Random(224700).ToString;
end;

procedure TForm2247.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2247;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2247_List0 := TMyObj2247_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2247_List1 := TMyObj2247_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
