...
type
  ...
  TMyObj1261_List0 = TObjectList<TMyObj1261>;

  TMyObj1261_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1261_List1 = TObjectList<TMyObj1261_1>;
...
constructor TMyObj1261_1.Create;
begin
  inherited;
  FInt := 1261 * 3;
  FTest := 'Value: ' + Random(212612).ToString + Random(126100).ToString;
end;

procedure TForm1261.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1261;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1261_List0 := TMyObj1261_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1261_List1 := TMyObj1261_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
