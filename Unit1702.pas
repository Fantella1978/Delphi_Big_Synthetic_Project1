...
type
  ...
  TMyObj1702_List0 = TObjectList<TMyObj1702>;

  TMyObj1702_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1702_List1 = TObjectList<TMyObj1702_1>;
...
constructor TMyObj1702_1.Create;
begin
  inherited;
  FInt := 1702 * 3;
  FTest := 'Value: ' + Random(217022).ToString + Random(170200).ToString;
end;

procedure TForm1702.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1702;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1702_List0 := TMyObj1702_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1702_List1 := TMyObj1702_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
