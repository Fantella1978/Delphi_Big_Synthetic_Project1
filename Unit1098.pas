...
type
  ...
  TMyObj1098_List0 = TObjectList<TMyObj1098>;

  TMyObj1098_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1098_List1 = TObjectList<TMyObj1098_1>;
...
constructor TMyObj1098_1.Create;
begin
  inherited;
  FInt := 1098 * 3;
  FTest := 'Value: ' + Random(210982).ToString + Random(109800).ToString;
end;

procedure TForm1098.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1098;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1098_List0 := TMyObj1098_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1098_List1 := TMyObj1098_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
