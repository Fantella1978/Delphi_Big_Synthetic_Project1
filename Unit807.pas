...
type
  ...
  TMyObj807_List0 = TObjectList<TMyObj807>;

  TMyObj807_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj807_List1 = TObjectList<TMyObj807_1>;
...
constructor TMyObj807_1.Create;
begin
  inherited;
  FInt := 807 * 3;
  FTest := 'Value: ' + Random(28072).ToString + Random(80700).ToString;
end;

procedure TForm807.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum807;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj807_List0 := TMyObj807_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj807_List1 := TMyObj807_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
