...
type
  ...
  TMyObj2246_List0 = TObjectList<TMyObj2246>;

  TMyObj2246_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2246_List1 = TObjectList<TMyObj2246_1>;
...
constructor TMyObj2246_1.Create;
begin
  inherited;
  FInt := 2246 * 3;
  FTest := 'Value: ' + Random(222462).ToString + Random(224600).ToString;
end;

procedure TForm2246.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2246;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2246_List0 := TMyObj2246_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2246_List1 := TMyObj2246_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
