...
type
  ...
  TMyObj2427_List0 = TObjectList<TMyObj2427>;

  TMyObj2427_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2427_List1 = TObjectList<TMyObj2427_1>;
...
constructor TMyObj2427_1.Create;
begin
  inherited;
  FInt := 2427 * 3;
  FTest := 'Value: ' + Random(224272).ToString + Random(242700).ToString;
end;

procedure TForm2427.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2427;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2427_List0 := TMyObj2427_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2427_List1 := TMyObj2427_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
