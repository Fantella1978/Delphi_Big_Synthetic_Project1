...
type
  ...
  TMyObj1124_List0 = TObjectList<TMyObj1124>;

  TMyObj1124_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1124_List1 = TObjectList<TMyObj1124_1>;
...
constructor TMyObj1124_1.Create;
begin
  inherited;
  FInt := 1124 * 3;
  FTest := 'Value: ' + Random(211242).ToString + Random(112400).ToString;
end;

procedure TForm1124.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1124;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1124_List0 := TMyObj1124_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1124_List1 := TMyObj1124_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
