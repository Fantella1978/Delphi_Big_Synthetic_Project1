...
type
  ...
  TMyObj2127_List0 = TObjectList<TMyObj2127>;

  TMyObj2127_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2127_List1 = TObjectList<TMyObj2127_1>;
...
constructor TMyObj2127_1.Create;
begin
  inherited;
  FInt := 2127 * 3;
  FTest := 'Value: ' + Random(221272).ToString + Random(212700).ToString;
end;

procedure TForm2127.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2127;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2127_List0 := TMyObj2127_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2127_List1 := TMyObj2127_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
