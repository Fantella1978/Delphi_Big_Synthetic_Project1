...
type
  ...
  TMyObj374_List0 = TObjectList<TMyObj374>;

  TMyObj374_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj374_List1 = TObjectList<TMyObj374_1>;
...
constructor TMyObj374_1.Create;
begin
  inherited;
  FInt := 374 * 3;
  FTest := 'Value: ' + Random(23742).ToString + Random(37400).ToString;
end;

procedure TForm374.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum374;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj374_List0 := TMyObj374_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj374_List1 := TMyObj374_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
