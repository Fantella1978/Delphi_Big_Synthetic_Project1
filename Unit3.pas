...
type
  ...
  TMyObj3_List0 = TObjectList<TMyObj3>;

  TMyObj3_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj3_List1 = TObjectList<TMyObj3_1>;
...
constructor TMyObj3_1.Create;
begin
  inherited;
  FInt := 3 * 3;
  FTest := 'Value: ' + Random(232).ToString + Random(300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(30).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(35).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(37).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj3_List0 := TMyObj3_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj3_List1 := TMyObj3_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
