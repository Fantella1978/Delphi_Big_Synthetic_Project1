...
type
  ...
  TMyObj2250_List0 = TObjectList<TMyObj2250>;

  TMyObj2250_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2250_List1 = TObjectList<TMyObj2250_1>;
...
constructor TMyObj2250_1.Create;
begin
  inherited;
  FInt := 2250 * 3;
  FTest := 'Value: ' + Random(222502).ToString + Random(225000).ToString;
end;

procedure TForm2250.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2250;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2250_List0 := TMyObj2250_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2250_List1 := TMyObj2250_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
