...
type
  ...
  TMyObj256_List0 = TObjectList<TMyObj256>;

  TMyObj256_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj256_List1 = TObjectList<TMyObj256_1>;
...
constructor TMyObj256_1.Create;
begin
  inherited;
  FInt := 256 * 3;
  FTest := 'Value: ' + Random(22562).ToString + Random(25600).ToString;
end;

procedure TForm256.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum256;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj256_List0 := TMyObj256_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj256_List1 := TMyObj256_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
