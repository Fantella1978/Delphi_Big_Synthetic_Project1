...
type
  ...
  TMyObj1077_List0 = TObjectList<TMyObj1077>;

  TMyObj1077_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1077_List1 = TObjectList<TMyObj1077_1>;
...
constructor TMyObj1077_1.Create;
begin
  inherited;
  FInt := 1077 * 3;
  FTest := 'Value: ' + Random(210772).ToString + Random(107700).ToString;
end;

procedure TForm1077.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1077;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1077_List0 := TMyObj1077_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1077_List1 := TMyObj1077_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
