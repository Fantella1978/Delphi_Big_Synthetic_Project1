...
type
  ...
  TMyObj291_List0 = TObjectList<TMyObj291>;

  TMyObj291_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj291_List1 = TObjectList<TMyObj291_1>;
...
constructor TMyObj291_1.Create;
begin
  inherited;
  FInt := 291 * 3;
  FTest := 'Value: ' + Random(22912).ToString + Random(29100).ToString;
end;

procedure TForm291.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum291;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj291_List0 := TMyObj291_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj291_List1 := TMyObj291_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
