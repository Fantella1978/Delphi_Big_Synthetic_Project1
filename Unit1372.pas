...
type
  ...
  TMyObj1372_List0 = TObjectList<TMyObj1372>;

  TMyObj1372_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1372_List1 = TObjectList<TMyObj1372_1>;
...
constructor TMyObj1372_1.Create;
begin
  inherited;
  FInt := 1372 * 3;
  FTest := 'Value: ' + Random(213722).ToString + Random(137200).ToString;
end;

procedure TForm1372.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1372;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1372_List0 := TMyObj1372_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1372_List1 := TMyObj1372_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
