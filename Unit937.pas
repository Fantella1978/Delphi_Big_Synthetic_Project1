...
type
  ...
  TMyObj937_List0 = TObjectList<TMyObj937>;

  TMyObj937_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj937_List1 = TObjectList<TMyObj937_1>;
...
constructor TMyObj937_1.Create;
begin
  inherited;
  FInt := 937 * 3;
  FTest := 'Value: ' + Random(29372).ToString + Random(93700).ToString;
end;

procedure TForm937.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum937;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj937_List0 := TMyObj937_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj937_List1 := TMyObj937_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
