...
type
  ...
  TMyObj1579_List0 = TObjectList<TMyObj1579>;

  TMyObj1579_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1579_List1 = TObjectList<TMyObj1579_1>;
...
constructor TMyObj1579_1.Create;
begin
  inherited;
  FInt := 1579 * 3;
  FTest := 'Value: ' + Random(215792).ToString + Random(157900).ToString;
end;

procedure TForm1579.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1579;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1579_List0 := TMyObj1579_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1579_List1 := TMyObj1579_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
