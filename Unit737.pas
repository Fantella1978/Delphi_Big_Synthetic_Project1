...
type
  ...
  TMyObj737_List0 = TObjectList<TMyObj737>;

  TMyObj737_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj737_List1 = TObjectList<TMyObj737_1>;
...
constructor TMyObj737_1.Create;
begin
  inherited;
  FInt := 737 * 3;
  FTest := 'Value: ' + Random(27372).ToString + Random(73700).ToString;
end;

procedure TForm737.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum737;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj737_List0 := TMyObj737_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj737_List1 := TMyObj737_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
