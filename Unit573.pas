...
type
  ...
  TMyObj573_List0 = TObjectList<TMyObj573>;

  TMyObj573_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj573_List1 = TObjectList<TMyObj573_1>;
...
constructor TMyObj573_1.Create;
begin
  inherited;
  FInt := 573 * 3;
  FTest := 'Value: ' + Random(25732).ToString + Random(57300).ToString;
end;

procedure TForm573.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum573;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj573_List0 := TMyObj573_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj573_List1 := TMyObj573_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
