...
type
  ...
  TMyObj2220_List0 = TObjectList<TMyObj2220>;

  TMyObj2220_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2220_List1 = TObjectList<TMyObj2220_1>;
...
constructor TMyObj2220_1.Create;
begin
  inherited;
  FInt := 2220 * 3;
  FTest := 'Value: ' + Random(222202).ToString + Random(222000).ToString;
end;

procedure TForm2220.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2220;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2220_List0 := TMyObj2220_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2220_List1 := TMyObj2220_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
