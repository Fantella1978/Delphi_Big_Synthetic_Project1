...
type
  ...
  TMyObj2019_List0 = TObjectList<TMyObj2019>;

  TMyObj2019_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2019_List1 = TObjectList<TMyObj2019_1>;
...
constructor TMyObj2019_1.Create;
begin
  inherited;
  FInt := 2019 * 3;
  FTest := 'Value: ' + Random(220192).ToString + Random(201900).ToString;
end;

procedure TForm2019.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2019;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2019_List0 := TMyObj2019_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2019_List1 := TMyObj2019_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
