...
type
  ...
  TMyObj600_List0 = TObjectList<TMyObj600>;

  TMyObj600_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj600_List1 = TObjectList<TMyObj600_1>;
...
constructor TMyObj600_1.Create;
begin
  inherited;
  FInt := 600 * 3;
  FTest := 'Value: ' + Random(26002).ToString + Random(60000).ToString;
end;

procedure TForm600.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum600;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj600_List0 := TMyObj600_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj600_List1 := TMyObj600_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
