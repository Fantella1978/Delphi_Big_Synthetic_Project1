...
type
  ...
  TMyObj996_List0 = TObjectList<TMyObj996>;

  TMyObj996_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj996_List1 = TObjectList<TMyObj996_1>;
...
constructor TMyObj996_1.Create;
begin
  inherited;
  FInt := 996 * 3;
  FTest := 'Value: ' + Random(29962).ToString + Random(99600).ToString;
end;

procedure TForm996.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum996;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj996_List0 := TMyObj996_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj996_List1 := TMyObj996_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
