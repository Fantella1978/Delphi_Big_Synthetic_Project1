...
type
  ...
  TMyObj1088_List0 = TObjectList<TMyObj1088>;

  TMyObj1088_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1088_List1 = TObjectList<TMyObj1088_1>;
...
constructor TMyObj1088_1.Create;
begin
  inherited;
  FInt := 1088 * 3;
  FTest := 'Value: ' + Random(210882).ToString + Random(108800).ToString;
end;

procedure TForm1088.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1088;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1088_List0 := TMyObj1088_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1088_List1 := TMyObj1088_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
