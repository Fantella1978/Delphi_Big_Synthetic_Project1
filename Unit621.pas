...
type
  ...
  TMyObj621_List0 = TObjectList<TMyObj621>;

  TMyObj621_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj621_List1 = TObjectList<TMyObj621_1>;
...
constructor TMyObj621_1.Create;
begin
  inherited;
  FInt := 621 * 3;
  FTest := 'Value: ' + Random(26212).ToString + Random(62100).ToString;
end;

procedure TForm621.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum621;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj621_List0 := TMyObj621_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj621_List1 := TMyObj621_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
