...
type
  ...
  TMyObj1913_List0 = TObjectList<TMyObj1913>;

  TMyObj1913_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1913_List1 = TObjectList<TMyObj1913_1>;
...
constructor TMyObj1913_1.Create;
begin
  inherited;
  FInt := 1913 * 3;
  FTest := 'Value: ' + Random(219132).ToString + Random(191300).ToString;
end;

procedure TForm1913.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1913;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1913_List0 := TMyObj1913_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1913_List1 := TMyObj1913_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
