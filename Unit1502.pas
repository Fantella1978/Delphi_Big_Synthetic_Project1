...
type
  ...
  TMyObj1502_List0 = TObjectList<TMyObj1502>;

  TMyObj1502_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1502_List1 = TObjectList<TMyObj1502_1>;
...
constructor TMyObj1502_1.Create;
begin
  inherited;
  FInt := 1502 * 3;
  FTest := 'Value: ' + Random(215022).ToString + Random(150200).ToString;
end;

procedure TForm1502.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1502;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1502_List0 := TMyObj1502_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1502_List1 := TMyObj1502_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
