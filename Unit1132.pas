...
type
  ...
  TMyObj1132_List0 = TObjectList<TMyObj1132>;

  TMyObj1132_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1132_List1 = TObjectList<TMyObj1132_1>;
...
constructor TMyObj1132_1.Create;
begin
  inherited;
  FInt := 1132 * 3;
  FTest := 'Value: ' + Random(211322).ToString + Random(113200).ToString;
end;

procedure TForm1132.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1132;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1132_List0 := TMyObj1132_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1132_List1 := TMyObj1132_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
