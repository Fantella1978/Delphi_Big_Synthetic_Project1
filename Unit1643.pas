...
type
  ...
  TMyObj1643_List0 = TObjectList<TMyObj1643>;

  TMyObj1643_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1643_List1 = TObjectList<TMyObj1643_1>;
...
constructor TMyObj1643_1.Create;
begin
  inherited;
  FInt := 1643 * 3;
  FTest := 'Value: ' + Random(216432).ToString + Random(164300).ToString;
end;

procedure TForm1643.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1643;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1643_List0 := TMyObj1643_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1643_List1 := TMyObj1643_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
