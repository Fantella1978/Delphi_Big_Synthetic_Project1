...
type
  ...
  TMyObj81_List0 = TObjectList<TMyObj81>;

  TMyObj81_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj81_List1 = TObjectList<TMyObj81_1>;
...
constructor TMyObj81_1.Create;
begin
  inherited;
  FInt := 81 * 3;
  FTest := 'Value: ' + Random(2812).ToString + Random(8100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj81_List0 := TMyObj81_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj81_List1 := TMyObj81_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
