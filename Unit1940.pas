...
type
  ...
  TMyObj1940_List0 = TObjectList<TMyObj1940>;

  TMyObj1940_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1940_List1 = TObjectList<TMyObj1940_1>;
...
constructor TMyObj1940_1.Create;
begin
  inherited;
  FInt := 1940 * 3;
  FTest := 'Value: ' + Random(219402).ToString + Random(194000).ToString;
end;

procedure TForm1940.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1940;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1940_List0 := TMyObj1940_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1940_List1 := TMyObj1940_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
