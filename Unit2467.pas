...
type
  ...
  TMyObj2467_List0 = TObjectList<TMyObj2467>;

  TMyObj2467_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2467_List1 = TObjectList<TMyObj2467_1>;
...
constructor TMyObj2467_1.Create;
begin
  inherited;
  FInt := 2467 * 3;
  FTest := 'Value: ' + Random(224672).ToString + Random(246700).ToString;
end;

procedure TForm2467.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2467;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2467_List0 := TMyObj2467_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2467_List1 := TMyObj2467_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
