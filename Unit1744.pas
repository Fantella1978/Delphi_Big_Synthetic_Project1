...
type
  ...
  TMyObj1744_List0 = TObjectList<TMyObj1744>;

  TMyObj1744_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1744_List1 = TObjectList<TMyObj1744_1>;
...
constructor TMyObj1744_1.Create;
begin
  inherited;
  FInt := 1744 * 3;
  FTest := 'Value: ' + Random(217442).ToString + Random(174400).ToString;
end;

procedure TForm1744.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1744;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1744_List0 := TMyObj1744_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1744_List1 := TMyObj1744_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
