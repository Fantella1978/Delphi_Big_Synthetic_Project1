...
type
  ...
  TMyObj197_List0 = TObjectList<TMyObj197>;

  TMyObj197_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj197_List1 = TObjectList<TMyObj197_1>;
...
constructor TMyObj197_1.Create;
begin
  inherited;
  FInt := 197 * 3;
  FTest := 'Value: ' + Random(21972).ToString + Random(19700).ToString;
end;

procedure TForm197.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum197;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj197_List0 := TMyObj197_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj197_List1 := TMyObj197_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
