...
type
  ...
  TMyObj1042_List0 = TObjectList<TMyObj1042>;

  TMyObj1042_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1042_List1 = TObjectList<TMyObj1042_1>;
...
constructor TMyObj1042_1.Create;
begin
  inherited;
  FInt := 1042 * 3;
  FTest := 'Value: ' + Random(210422).ToString + Random(104200).ToString;
end;

procedure TForm1042.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1042;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1042_List0 := TMyObj1042_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1042_List1 := TMyObj1042_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
