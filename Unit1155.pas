...
type
  ...
  TMyObj1155_List0 = TObjectList<TMyObj1155>;

  TMyObj1155_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1155_List1 = TObjectList<TMyObj1155_1>;
...
constructor TMyObj1155_1.Create;
begin
  inherited;
  FInt := 1155 * 3;
  FTest := 'Value: ' + Random(211552).ToString + Random(115500).ToString;
end;

procedure TForm1155.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1155;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1155_List0 := TMyObj1155_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1155_List1 := TMyObj1155_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
