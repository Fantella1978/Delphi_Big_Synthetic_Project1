...
type
  ...
  TMyObj2030_List0 = TObjectList<TMyObj2030>;

  TMyObj2030_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2030_List1 = TObjectList<TMyObj2030_1>;
...
constructor TMyObj2030_1.Create;
begin
  inherited;
  FInt := 2030 * 3;
  FTest := 'Value: ' + Random(220302).ToString + Random(203000).ToString;
end;

procedure TForm2030.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2030;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2030_List0 := TMyObj2030_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2030_List1 := TMyObj2030_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
