...
type
  ...
  TMyObj286_List0 = TObjectList<TMyObj286>;

  TMyObj286_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj286_List1 = TObjectList<TMyObj286_1>;
...
constructor TMyObj286_1.Create;
begin
  inherited;
  FInt := 286 * 3;
  FTest := 'Value: ' + Random(22862).ToString + Random(28600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj286_List0 := TMyObj286_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj286_List1 := TMyObj286_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
