...
type
  ...
  TMyObj951_List0 = TObjectList<TMyObj951>;

  TMyObj951_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj951_List1 = TObjectList<TMyObj951_1>;
...
constructor TMyObj951_1.Create;
begin
  inherited;
  FInt := 951 * 3;
  FTest := 'Value: ' + Random(29512).ToString + Random(95100).ToString;
end;

procedure TForm951.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum951;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj951_List0 := TMyObj951_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj951_List1 := TMyObj951_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
