...
type
  ...
  TMyObj1543_List0 = TObjectList<TMyObj1543>;

  TMyObj1543_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1543_List1 = TObjectList<TMyObj1543_1>;
...
constructor TMyObj1543_1.Create;
begin
  inherited;
  FInt := 1543 * 3;
  FTest := 'Value: ' + Random(215432).ToString + Random(154300).ToString;
end;

procedure TForm1543.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1543;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1543_List0 := TMyObj1543_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1543_List1 := TMyObj1543_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
