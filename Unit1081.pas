...
type
  ...
  TMyObj1081_List0 = TObjectList<TMyObj1081>;

  TMyObj1081_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1081_List1 = TObjectList<TMyObj1081_1>;
...
constructor TMyObj1081_1.Create;
begin
  inherited;
  FInt := 1081 * 3;
  FTest := 'Value: ' + Random(210812).ToString + Random(108100).ToString;
end;

procedure TForm1081.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1081;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1081_List0 := TMyObj1081_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1081_List1 := TMyObj1081_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
