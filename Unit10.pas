...
type
  ...
  TMyObj10_List0 = TObjectList<TMyObj10>;

  TMyObj10_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj10_List1 = TObjectList<TMyObj10_1>;
...
constructor TMyObj10_1.Create;
begin
  inherited;
  FInt := 10 * 3;
  FTest := 'Value: ' + Random(2102).ToString + Random(1000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj10_List0 := TMyObj10_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj10_List1 := TMyObj10_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
