...
type
  ...
  TMyObj2119_List0 = TObjectList<TMyObj2119>;

  TMyObj2119_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2119_List1 = TObjectList<TMyObj2119_1>;
...
constructor TMyObj2119_1.Create;
begin
  inherited;
  FInt := 2119 * 3;
  FTest := 'Value: ' + Random(221192).ToString + Random(211900).ToString;
end;

procedure TForm2119.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2119;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2119_List0 := TMyObj2119_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2119_List1 := TMyObj2119_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
