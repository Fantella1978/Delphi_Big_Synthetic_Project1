...
type
  ...
  TMyObj1017_List0 = TObjectList<TMyObj1017>;

  TMyObj1017_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1017_List1 = TObjectList<TMyObj1017_1>;
...
constructor TMyObj1017_1.Create;
begin
  inherited;
  FInt := 1017 * 3;
  FTest := 'Value: ' + Random(210172).ToString + Random(101700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1017_List0 := TMyObj1017_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1017_List1 := TMyObj1017_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
