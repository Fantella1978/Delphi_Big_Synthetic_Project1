...
type
  ...
  TMyObj949_List0 = TObjectList<TMyObj949>;

  TMyObj949_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj949_List1 = TObjectList<TMyObj949_1>;
...
constructor TMyObj949_1.Create;
begin
  inherited;
  FInt := 949 * 3;
  FTest := 'Value: ' + Random(29492).ToString + Random(94900).ToString;
end;

procedure TForm949.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum949;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj949_List0 := TMyObj949_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj949_List1 := TMyObj949_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
