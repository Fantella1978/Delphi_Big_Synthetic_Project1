...
type
  ...
  TMyObj1402_List0 = TObjectList<TMyObj1402>;

  TMyObj1402_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1402_List1 = TObjectList<TMyObj1402_1>;
...
constructor TMyObj1402_1.Create;
begin
  inherited;
  FInt := 1402 * 3;
  FTest := 'Value: ' + Random(214022).ToString + Random(140200).ToString;
end;

procedure TForm1402.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1402;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1402_List0 := TMyObj1402_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1402_List1 := TMyObj1402_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
