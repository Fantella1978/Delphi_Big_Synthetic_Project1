...
type
  ...
  TMyObj1599_List0 = TObjectList<TMyObj1599>;

  TMyObj1599_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1599_List1 = TObjectList<TMyObj1599_1>;
...
constructor TMyObj1599_1.Create;
begin
  inherited;
  FInt := 1599 * 3;
  FTest := 'Value: ' + Random(215992).ToString + Random(159900).ToString;
end;

procedure TForm1599.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1599;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1599_List0 := TMyObj1599_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1599_List1 := TMyObj1599_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
