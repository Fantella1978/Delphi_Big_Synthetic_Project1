...
type
  ...
  TMyObj2070_List0 = TObjectList<TMyObj2070>;

  TMyObj2070_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2070_List1 = TObjectList<TMyObj2070_1>;
...
constructor TMyObj2070_1.Create;
begin
  inherited;
  FInt := 2070 * 3;
  FTest := 'Value: ' + Random(220702).ToString + Random(207000).ToString;
end;

procedure TForm2070.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2070;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2070_List0 := TMyObj2070_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2070_List1 := TMyObj2070_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
