...
type
  ...
  TMyObj43_List0 = TObjectList<TMyObj43>;

  TMyObj43_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj43_List1 = TObjectList<TMyObj43_1>;
...
constructor TMyObj43_1.Create;
begin
  inherited;
  FInt := 43 * 3;
  FTest := 'Value: ' + Random(2432).ToString + Random(4300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj43_List0 := TMyObj43_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj43_List1 := TMyObj43_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
