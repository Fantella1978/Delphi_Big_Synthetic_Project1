...
type
  ...
  TMyObj2276_List0 = TObjectList<TMyObj2276>;

  TMyObj2276_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2276_List1 = TObjectList<TMyObj2276_1>;
...
constructor TMyObj2276_1.Create;
begin
  inherited;
  FInt := 2276 * 3;
  FTest := 'Value: ' + Random(222762).ToString + Random(227600).ToString;
end;

procedure TForm2276.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2276;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2276_List0 := TMyObj2276_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2276_List1 := TMyObj2276_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
