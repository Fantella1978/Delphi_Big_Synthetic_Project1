...
type
  ...
  TMyObj1706_List0 = TObjectList<TMyObj1706>;

  TMyObj1706_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1706_List1 = TObjectList<TMyObj1706_1>;
...
constructor TMyObj1706_1.Create;
begin
  inherited;
  FInt := 1706 * 3;
  FTest := 'Value: ' + Random(217062).ToString + Random(170600).ToString;
end;

procedure TForm1706.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1706;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1706_List0 := TMyObj1706_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1706_List1 := TMyObj1706_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
