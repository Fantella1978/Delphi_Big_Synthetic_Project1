...
type
  ...
  TMyObj2147_List0 = TObjectList<TMyObj2147>;

  TMyObj2147_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2147_List1 = TObjectList<TMyObj2147_1>;
...
constructor TMyObj2147_1.Create;
begin
  inherited;
  FInt := 2147 * 3;
  FTest := 'Value: ' + Random(221472).ToString + Random(214700).ToString;
end;

procedure TForm2147.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2147;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2147_List0 := TMyObj2147_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2147_List1 := TMyObj2147_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
