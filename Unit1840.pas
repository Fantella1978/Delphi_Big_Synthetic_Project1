...
type
  ...
  TMyObj1840_List0 = TObjectList<TMyObj1840>;

  TMyObj1840_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1840_List1 = TObjectList<TMyObj1840_1>;
...
constructor TMyObj1840_1.Create;
begin
  inherited;
  FInt := 1840 * 3;
  FTest := 'Value: ' + Random(218402).ToString + Random(184000).ToString;
end;

procedure TForm1840.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1840;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1840_List0 := TMyObj1840_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1840_List1 := TMyObj1840_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
