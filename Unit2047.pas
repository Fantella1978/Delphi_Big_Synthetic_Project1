...
type
  ...
  TMyObj2047_List0 = TObjectList<TMyObj2047>;

  TMyObj2047_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2047_List1 = TObjectList<TMyObj2047_1>;
...
constructor TMyObj2047_1.Create;
begin
  inherited;
  FInt := 2047 * 3;
  FTest := 'Value: ' + Random(220472).ToString + Random(204700).ToString;
end;

procedure TForm2047.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2047;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2047_List0 := TMyObj2047_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2047_List1 := TMyObj2047_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
