...
type
  ...
  TMyObj116_List0 = TObjectList<TMyObj116>;

  TMyObj116_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj116_List1 = TObjectList<TMyObj116_1>;
...
constructor TMyObj116_1.Create;
begin
  inherited;
  FInt := 116 * 3;
  FTest := 'Value: ' + Random(21162).ToString + Random(11600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj116_List0 := TMyObj116_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj116_List1 := TMyObj116_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
