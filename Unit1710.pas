...
type
  ...
  TMyObj1710_List0 = TObjectList<TMyObj1710>;

  TMyObj1710_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1710_List1 = TObjectList<TMyObj1710_1>;
...
constructor TMyObj1710_1.Create;
begin
  inherited;
  FInt := 1710 * 3;
  FTest := 'Value: ' + Random(217102).ToString + Random(171000).ToString;
end;

procedure TForm1710.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1710;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1710_List0 := TMyObj1710_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1710_List1 := TMyObj1710_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
