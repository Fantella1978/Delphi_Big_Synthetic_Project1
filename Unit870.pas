...
type
  ...
  TMyObj870_List0 = TObjectList<TMyObj870>;

  TMyObj870_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj870_List1 = TObjectList<TMyObj870_1>;
...
constructor TMyObj870_1.Create;
begin
  inherited;
  FInt := 870 * 3;
  FTest := 'Value: ' + Random(28702).ToString + Random(87000).ToString;
end;

procedure TForm870.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum870;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj870_List0 := TMyObj870_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj870_List1 := TMyObj870_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
