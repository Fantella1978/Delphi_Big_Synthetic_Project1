...
type
  ...
  TMyObj270_List0 = TObjectList<TMyObj270>;

  TMyObj270_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj270_List1 = TObjectList<TMyObj270_1>;
...
constructor TMyObj270_1.Create;
begin
  inherited;
  FInt := 270 * 3;
  FTest := 'Value: ' + Random(22702).ToString + Random(27000).ToString;
end;

procedure TForm270.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum270;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj270_List0 := TMyObj270_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj270_List1 := TMyObj270_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
