...
type
  ...
  TMyObj2459_List0 = TObjectList<TMyObj2459>;

  TMyObj2459_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2459_List1 = TObjectList<TMyObj2459_1>;
...
constructor TMyObj2459_1.Create;
begin
  inherited;
  FInt := 2459 * 3;
  FTest := 'Value: ' + Random(224592).ToString + Random(245900).ToString;
end;

procedure TForm2459.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2459;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2459_List0 := TMyObj2459_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2459_List1 := TMyObj2459_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
