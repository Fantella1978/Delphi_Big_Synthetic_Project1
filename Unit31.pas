...
type
  ...
  TMyObj31_List0 = TObjectList<TMyObj31>;

  TMyObj31_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj31_List1 = TObjectList<TMyObj31_1>;
...
constructor TMyObj31_1.Create;
begin
  inherited;
  FInt := 31 * 3;
  FTest := 'Value: ' + Random(2312).ToString + Random(3100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj31_List0 := TMyObj31_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj31_List1 := TMyObj31_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
