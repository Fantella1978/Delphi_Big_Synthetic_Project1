...
type
  ...
  TMyObj2301_List0 = TObjectList<TMyObj2301>;

  TMyObj2301_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2301_List1 = TObjectList<TMyObj2301_1>;
...
constructor TMyObj2301_1.Create;
begin
  inherited;
  FInt := 2301 * 3;
  FTest := 'Value: ' + Random(223012).ToString + Random(230100).ToString;
end;

procedure TForm2301.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2301;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2301_List0 := TMyObj2301_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2301_List1 := TMyObj2301_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
