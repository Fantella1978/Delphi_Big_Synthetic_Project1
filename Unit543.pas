...
type
  ...
  TMyObj543_List0 = TObjectList<TMyObj543>;

  TMyObj543_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj543_List1 = TObjectList<TMyObj543_1>;
...
constructor TMyObj543_1.Create;
begin
  inherited;
  FInt := 543 * 3;
  FTest := 'Value: ' + Random(25432).ToString + Random(54300).ToString;
end;

procedure TForm543.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum543;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj543_List0 := TMyObj543_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj543_List1 := TMyObj543_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
