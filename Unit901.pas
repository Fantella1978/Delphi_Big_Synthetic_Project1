...
type
  ...
  TMyObj901_List0 = TObjectList<TMyObj901>;

  TMyObj901_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj901_List1 = TObjectList<TMyObj901_1>;
...
constructor TMyObj901_1.Create;
begin
  inherited;
  FInt := 901 * 3;
  FTest := 'Value: ' + Random(29012).ToString + Random(90100).ToString;
end;

procedure TForm901.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum901;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj901_List0 := TMyObj901_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj901_List1 := TMyObj901_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
