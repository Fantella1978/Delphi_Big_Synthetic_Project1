...
type
  ...
  TMyObj178_List0 = TObjectList<TMyObj178>;

  TMyObj178_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj178_List1 = TObjectList<TMyObj178_1>;
...
constructor TMyObj178_1.Create;
begin
  inherited;
  FInt := 178 * 3;
  FTest := 'Value: ' + Random(21782).ToString + Random(17800).ToString;
end;

procedure TForm178.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum178;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj178_List0 := TMyObj178_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj178_List1 := TMyObj178_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
