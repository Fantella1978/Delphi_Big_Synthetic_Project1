...
type
  ...
  TMyObj1486_List0 = TObjectList<TMyObj1486>;

  TMyObj1486_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1486_List1 = TObjectList<TMyObj1486_1>;
...
constructor TMyObj1486_1.Create;
begin
  inherited;
  FInt := 1486 * 3;
  FTest := 'Value: ' + Random(214862).ToString + Random(148600).ToString;
end;

procedure TForm1486.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1486;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1486_List0 := TMyObj1486_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1486_List1 := TMyObj1486_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
