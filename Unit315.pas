...
type
  ...
  TMyObj315_List0 = TObjectList<TMyObj315>;

  TMyObj315_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj315_List1 = TObjectList<TMyObj315_1>;
...
constructor TMyObj315_1.Create;
begin
  inherited;
  FInt := 315 * 3;
  FTest := 'Value: ' + Random(23152).ToString + Random(31500).ToString;
end;

procedure TForm315.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum315;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj315_List0 := TMyObj315_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj315_List1 := TMyObj315_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
