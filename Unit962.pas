...
type
  ...
  TMyObj962_List0 = TObjectList<TMyObj962>;

  TMyObj962_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj962_List1 = TObjectList<TMyObj962_1>;
...
constructor TMyObj962_1.Create;
begin
  inherited;
  FInt := 962 * 3;
  FTest := 'Value: ' + Random(29622).ToString + Random(96200).ToString;
end;

procedure TForm962.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum962;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj962_List0 := TMyObj962_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj962_List1 := TMyObj962_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
