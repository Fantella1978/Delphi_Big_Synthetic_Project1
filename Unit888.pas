...
type
  ...
  TMyObj888_List0 = TObjectList<TMyObj888>;

  TMyObj888_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj888_List1 = TObjectList<TMyObj888_1>;
...
constructor TMyObj888_1.Create;
begin
  inherited;
  FInt := 888 * 3;
  FTest := 'Value: ' + Random(28882).ToString + Random(88800).ToString;
end;

procedure TForm888.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum888;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj888_List0 := TMyObj888_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj888_List1 := TMyObj888_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
