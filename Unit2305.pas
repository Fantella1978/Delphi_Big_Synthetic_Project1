...
type
  ...
  TMyObj2305_List0 = TObjectList<TMyObj2305>;

  TMyObj2305_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2305_List1 = TObjectList<TMyObj2305_1>;
...
constructor TMyObj2305_1.Create;
begin
  inherited;
  FInt := 2305 * 3;
  FTest := 'Value: ' + Random(223052).ToString + Random(230500).ToString;
end;

procedure TForm2305.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2305;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2305_List0 := TMyObj2305_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2305_List1 := TMyObj2305_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
