...
type
  ...
  TMyObj584_List0 = TObjectList<TMyObj584>;

  TMyObj584_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj584_List1 = TObjectList<TMyObj584_1>;
...
constructor TMyObj584_1.Create;
begin
  inherited;
  FInt := 584 * 3;
  FTest := 'Value: ' + Random(25842).ToString + Random(58400).ToString;
end;

procedure TForm584.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum584;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj584_List0 := TMyObj584_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj584_List1 := TMyObj584_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
