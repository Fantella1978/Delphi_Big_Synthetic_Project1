...
type
  ...
  TMyObj2329_List0 = TObjectList<TMyObj2329>;

  TMyObj2329_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2329_List1 = TObjectList<TMyObj2329_1>;
...
constructor TMyObj2329_1.Create;
begin
  inherited;
  FInt := 2329 * 3;
  FTest := 'Value: ' + Random(223292).ToString + Random(232900).ToString;
end;

procedure TForm2329.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2329;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2329_List0 := TMyObj2329_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2329_List1 := TMyObj2329_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
