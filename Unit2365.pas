...
type
  ...
  TMyObj2365_List0 = TObjectList<TMyObj2365>;

  TMyObj2365_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2365_List1 = TObjectList<TMyObj2365_1>;
...
constructor TMyObj2365_1.Create;
begin
  inherited;
  FInt := 2365 * 3;
  FTest := 'Value: ' + Random(223652).ToString + Random(236500).ToString;
end;

procedure TForm2365.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2365;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2365_List0 := TMyObj2365_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2365_List1 := TMyObj2365_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
