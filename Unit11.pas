...
type
  ...
  TMyObj11_List0 = TObjectList<TMyObj11>;

  TMyObj11_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj11_List1 = TObjectList<TMyObj11_1>;
...
constructor TMyObj11_1.Create;
begin
  inherited;
  FInt := 11 * 3;
  FTest := 'Value: ' + Random(2112).ToString + Random(1100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj11_List0 := TMyObj11_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj11_List1 := TMyObj11_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
