...
type
  ...
  TMyObj797_List0 = TObjectList<TMyObj797>;

  TMyObj797_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj797_List1 = TObjectList<TMyObj797_1>;
...
constructor TMyObj797_1.Create;
begin
  inherited;
  FInt := 797 * 3;
  FTest := 'Value: ' + Random(27972).ToString + Random(79700).ToString;
end;

procedure TForm797.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum797;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj797_List0 := TMyObj797_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj797_List1 := TMyObj797_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
