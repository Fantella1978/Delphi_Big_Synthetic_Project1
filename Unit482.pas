...
type
  ...
  TMyObj482_List0 = TObjectList<TMyObj482>;

  TMyObj482_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj482_List1 = TObjectList<TMyObj482_1>;
...
constructor TMyObj482_1.Create;
begin
  inherited;
  FInt := 482 * 3;
  FTest := 'Value: ' + Random(24822).ToString + Random(48200).ToString;
end;

procedure TForm482.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum482;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj482_List0 := TMyObj482_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj482_List1 := TMyObj482_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
