...
type
  ...
  TMyObj409_List0 = TObjectList<TMyObj409>;

  TMyObj409_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj409_List1 = TObjectList<TMyObj409_1>;
...
constructor TMyObj409_1.Create;
begin
  inherited;
  FInt := 409 * 3;
  FTest := 'Value: ' + Random(24092).ToString + Random(40900).ToString;
end;

procedure TForm409.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum409;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj409_List0 := TMyObj409_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj409_List1 := TMyObj409_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
