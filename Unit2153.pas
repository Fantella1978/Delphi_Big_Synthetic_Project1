...
type
  ...
  TMyObj2153_List0 = TObjectList<TMyObj2153>;

  TMyObj2153_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2153_List1 = TObjectList<TMyObj2153_1>;
...
constructor TMyObj2153_1.Create;
begin
  inherited;
  FInt := 2153 * 3;
  FTest := 'Value: ' + Random(221532).ToString + Random(215300).ToString;
end;

procedure TForm2153.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2153;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2153_List0 := TMyObj2153_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2153_List1 := TMyObj2153_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
