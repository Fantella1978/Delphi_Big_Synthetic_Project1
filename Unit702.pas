...
type
  ...
  TMyObj702_List0 = TObjectList<TMyObj702>;

  TMyObj702_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj702_List1 = TObjectList<TMyObj702_1>;
...
constructor TMyObj702_1.Create;
begin
  inherited;
  FInt := 702 * 3;
  FTest := 'Value: ' + Random(27022).ToString + Random(70200).ToString;
end;

procedure TForm702.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum702;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj702_List0 := TMyObj702_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj702_List1 := TMyObj702_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
