...
type
  ...
  TMyObj90_List0 = TObjectList<TMyObj90>;

  TMyObj90_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj90_List1 = TObjectList<TMyObj90_1>;
...
constructor TMyObj90_1.Create;
begin
  inherited;
  FInt := 90 * 3;
  FTest := 'Value: ' + Random(2902).ToString + Random(9000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj90_List0 := TMyObj90_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj90_List1 := TMyObj90_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
