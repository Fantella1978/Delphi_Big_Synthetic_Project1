...
type
  ...
  TMyObj111_List0 = TObjectList<TMyObj111>;

  TMyObj111_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj111_List1 = TObjectList<TMyObj111_1>;
...
constructor TMyObj111_1.Create;
begin
  inherited;
  FInt := 111 * 3;
  FTest := 'Value: ' + Random(21112).ToString + Random(11100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj111_List0 := TMyObj111_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj111_List1 := TMyObj111_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
