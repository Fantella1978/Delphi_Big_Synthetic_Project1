...
type
  ...
  TMyObj2131_List0 = TObjectList<TMyObj2131>;

  TMyObj2131_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2131_List1 = TObjectList<TMyObj2131_1>;
...
constructor TMyObj2131_1.Create;
begin
  inherited;
  FInt := 2131 * 3;
  FTest := 'Value: ' + Random(221312).ToString + Random(213100).ToString;
end;

procedure TForm2131.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2131;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2131_List0 := TMyObj2131_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2131_List1 := TMyObj2131_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
