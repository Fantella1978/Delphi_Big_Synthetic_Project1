...
type
  ...
  TMyObj601_List0 = TObjectList<TMyObj601>;

  TMyObj601_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj601_List1 = TObjectList<TMyObj601_1>;
...
constructor TMyObj601_1.Create;
begin
  inherited;
  FInt := 601 * 3;
  FTest := 'Value: ' + Random(26012).ToString + Random(60100).ToString;
end;

procedure TForm601.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum601;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj601_List0 := TMyObj601_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj601_List1 := TMyObj601_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
