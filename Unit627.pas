...
type
  ...
  TMyObj627_List0 = TObjectList<TMyObj627>;

  TMyObj627_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj627_List1 = TObjectList<TMyObj627_1>;
...
constructor TMyObj627_1.Create;
begin
  inherited;
  FInt := 627 * 3;
  FTest := 'Value: ' + Random(26272).ToString + Random(62700).ToString;
end;

procedure TForm627.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum627;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj627_List0 := TMyObj627_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj627_List1 := TMyObj627_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
