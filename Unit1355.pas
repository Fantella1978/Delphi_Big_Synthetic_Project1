...
type
  ...
  TMyObj1355_List0 = TObjectList<TMyObj1355>;

  TMyObj1355_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1355_List1 = TObjectList<TMyObj1355_1>;
...
constructor TMyObj1355_1.Create;
begin
  inherited;
  FInt := 1355 * 3;
  FTest := 'Value: ' + Random(213552).ToString + Random(135500).ToString;
end;

procedure TForm1355.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1355;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1355_List0 := TMyObj1355_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1355_List1 := TMyObj1355_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
