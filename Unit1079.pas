...
type
  ...
  TMyObj1079_List0 = TObjectList<TMyObj1079>;

  TMyObj1079_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1079_List1 = TObjectList<TMyObj1079_1>;
...
constructor TMyObj1079_1.Create;
begin
  inherited;
  FInt := 1079 * 3;
  FTest := 'Value: ' + Random(210792).ToString + Random(107900).ToString;
end;

procedure TForm1079.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1079;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1079_List0 := TMyObj1079_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1079_List1 := TMyObj1079_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
