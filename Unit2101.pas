...
type
  ...
  TMyObj2101_List0 = TObjectList<TMyObj2101>;

  TMyObj2101_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2101_List1 = TObjectList<TMyObj2101_1>;
...
constructor TMyObj2101_1.Create;
begin
  inherited;
  FInt := 2101 * 3;
  FTest := 'Value: ' + Random(221012).ToString + Random(210100).ToString;
end;

procedure TForm2101.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2101;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2101_List0 := TMyObj2101_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2101_List1 := TMyObj2101_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
