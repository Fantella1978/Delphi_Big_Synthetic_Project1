...
type
  ...
  TMyObj2018_List0 = TObjectList<TMyObj2018>;

  TMyObj2018_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2018_List1 = TObjectList<TMyObj2018_1>;
...
constructor TMyObj2018_1.Create;
begin
  inherited;
  FInt := 2018 * 3;
  FTest := 'Value: ' + Random(220182).ToString + Random(201800).ToString;
end;

procedure TForm2018.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2018;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2018_List0 := TMyObj2018_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2018_List1 := TMyObj2018_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
