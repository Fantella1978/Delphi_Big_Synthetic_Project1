...
type
  ...
  TMyObj2176_List0 = TObjectList<TMyObj2176>;

  TMyObj2176_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2176_List1 = TObjectList<TMyObj2176_1>;
...
constructor TMyObj2176_1.Create;
begin
  inherited;
  FInt := 2176 * 3;
  FTest := 'Value: ' + Random(221762).ToString + Random(217600).ToString;
end;

procedure TForm2176.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2176;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2176_List0 := TMyObj2176_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2176_List1 := TMyObj2176_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
