...
type
  ...
  TMyObj2003_List0 = TObjectList<TMyObj2003>;

  TMyObj2003_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2003_List1 = TObjectList<TMyObj2003_1>;
...
constructor TMyObj2003_1.Create;
begin
  inherited;
  FInt := 2003 * 3;
  FTest := 'Value: ' + Random(220032).ToString + Random(200300).ToString;
end;

procedure TForm2003.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2003;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2003_List0 := TMyObj2003_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2003_List1 := TMyObj2003_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
