...
type
  ...
  TMyObj686_List0 = TObjectList<TMyObj686>;

  TMyObj686_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj686_List1 = TObjectList<TMyObj686_1>;
...
constructor TMyObj686_1.Create;
begin
  inherited;
  FInt := 686 * 3;
  FTest := 'Value: ' + Random(26862).ToString + Random(68600).ToString;
end;

procedure TForm686.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum686;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj686_List0 := TMyObj686_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj686_List1 := TMyObj686_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
