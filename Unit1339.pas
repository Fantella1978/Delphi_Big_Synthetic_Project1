...
type
  ...
  TMyObj1339_List0 = TObjectList<TMyObj1339>;

  TMyObj1339_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1339_List1 = TObjectList<TMyObj1339_1>;
...
constructor TMyObj1339_1.Create;
begin
  inherited;
  FInt := 1339 * 3;
  FTest := 'Value: ' + Random(213392).ToString + Random(133900).ToString;
end;

procedure TForm1339.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1339;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1339_List0 := TMyObj1339_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1339_List1 := TMyObj1339_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
