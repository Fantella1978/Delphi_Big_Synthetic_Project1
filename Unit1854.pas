...
type
  ...
  TMyObj1854_List0 = TObjectList<TMyObj1854>;

  TMyObj1854_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1854_List1 = TObjectList<TMyObj1854_1>;
...
constructor TMyObj1854_1.Create;
begin
  inherited;
  FInt := 1854 * 3;
  FTest := 'Value: ' + Random(218542).ToString + Random(185400).ToString;
end;

procedure TForm1854.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1854;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1854_List0 := TMyObj1854_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1854_List1 := TMyObj1854_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
