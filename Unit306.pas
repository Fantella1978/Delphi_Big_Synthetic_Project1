...
type
  ...
  TMyObj306_List0 = TObjectList<TMyObj306>;

  TMyObj306_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj306_List1 = TObjectList<TMyObj306_1>;
...
constructor TMyObj306_1.Create;
begin
  inherited;
  FInt := 306 * 3;
  FTest := 'Value: ' + Random(23062).ToString + Random(30600).ToString;
end;

procedure TForm306.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum306;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj306_List0 := TMyObj306_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj306_List1 := TMyObj306_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
