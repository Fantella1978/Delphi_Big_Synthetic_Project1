...
type
  ...
  TMyObj1235_List0 = TObjectList<TMyObj1235>;

  TMyObj1235_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1235_List1 = TObjectList<TMyObj1235_1>;
...
constructor TMyObj1235_1.Create;
begin
  inherited;
  FInt := 1235 * 3;
  FTest := 'Value: ' + Random(212352).ToString + Random(123500).ToString;
end;

procedure TForm1235.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1235;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1235_List0 := TMyObj1235_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1235_List1 := TMyObj1235_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
