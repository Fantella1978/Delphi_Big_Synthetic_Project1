...
type
  ...
  TMyObj1311_List0 = TObjectList<TMyObj1311>;

  TMyObj1311_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1311_List1 = TObjectList<TMyObj1311_1>;
...
constructor TMyObj1311_1.Create;
begin
  inherited;
  FInt := 1311 * 3;
  FTest := 'Value: ' + Random(213112).ToString + Random(131100).ToString;
end;

procedure TForm1311.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1311;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1311_List0 := TMyObj1311_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1311_List1 := TMyObj1311_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
