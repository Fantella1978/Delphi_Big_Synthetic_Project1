...
type
  ...
  TMyObj533_List0 = TObjectList<TMyObj533>;

  TMyObj533_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj533_List1 = TObjectList<TMyObj533_1>;
...
constructor TMyObj533_1.Create;
begin
  inherited;
  FInt := 533 * 3;
  FTest := 'Value: ' + Random(25332).ToString + Random(53300).ToString;
end;

procedure TForm533.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum533;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj533_List0 := TMyObj533_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj533_List1 := TMyObj533_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
