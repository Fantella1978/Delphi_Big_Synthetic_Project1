...
type
  ...
  TMyObj1986_List0 = TObjectList<TMyObj1986>;

  TMyObj1986_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1986_List1 = TObjectList<TMyObj1986_1>;
...
constructor TMyObj1986_1.Create;
begin
  inherited;
  FInt := 1986 * 3;
  FTest := 'Value: ' + Random(219862).ToString + Random(198600).ToString;
end;

procedure TForm1986.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1986;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1986_List0 := TMyObj1986_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1986_List1 := TMyObj1986_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
