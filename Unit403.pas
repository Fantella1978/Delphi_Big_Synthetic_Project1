...
type
  ...
  TMyObj403_List0 = TObjectList<TMyObj403>;

  TMyObj403_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj403_List1 = TObjectList<TMyObj403_1>;
...
constructor TMyObj403_1.Create;
begin
  inherited;
  FInt := 403 * 3;
  FTest := 'Value: ' + Random(24032).ToString + Random(40300).ToString;
end;

procedure TForm403.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum403;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj403_List0 := TMyObj403_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj403_List1 := TMyObj403_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
