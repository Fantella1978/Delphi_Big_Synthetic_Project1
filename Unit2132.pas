...
type
  ...
  TMyObj2132_List0 = TObjectList<TMyObj2132>;

  TMyObj2132_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2132_List1 = TObjectList<TMyObj2132_1>;
...
constructor TMyObj2132_1.Create;
begin
  inherited;
  FInt := 2132 * 3;
  FTest := 'Value: ' + Random(221322).ToString + Random(213200).ToString;
end;

procedure TForm2132.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2132;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2132_List0 := TMyObj2132_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2132_List1 := TMyObj2132_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
