...
type
  ...
  TMyObj1146_List0 = TObjectList<TMyObj1146>;

  TMyObj1146_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1146_List1 = TObjectList<TMyObj1146_1>;
...
constructor TMyObj1146_1.Create;
begin
  inherited;
  FInt := 1146 * 3;
  FTest := 'Value: ' + Random(211462).ToString + Random(114600).ToString;
end;

procedure TForm1146.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1146;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1146_List0 := TMyObj1146_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1146_List1 := TMyObj1146_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
