...
type
  ...
  TMyObj774_List0 = TObjectList<TMyObj774>;

  TMyObj774_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj774_List1 = TObjectList<TMyObj774_1>;
...
constructor TMyObj774_1.Create;
begin
  inherited;
  FInt := 774 * 3;
  FTest := 'Value: ' + Random(27742).ToString + Random(77400).ToString;
end;

procedure TForm774.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum774;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj774_List0 := TMyObj774_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj774_List1 := TMyObj774_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
