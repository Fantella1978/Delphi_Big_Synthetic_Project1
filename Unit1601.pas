...
type
  ...
  TMyObj1601_List0 = TObjectList<TMyObj1601>;

  TMyObj1601_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1601_List1 = TObjectList<TMyObj1601_1>;
...
constructor TMyObj1601_1.Create;
begin
  inherited;
  FInt := 1601 * 3;
  FTest := 'Value: ' + Random(216012).ToString + Random(160100).ToString;
end;

procedure TForm1601.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1601;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1601_List0 := TMyObj1601_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1601_List1 := TMyObj1601_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
