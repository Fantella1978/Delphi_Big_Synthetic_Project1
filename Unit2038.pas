...
type
  ...
  TMyObj2038_List0 = TObjectList<TMyObj2038>;

  TMyObj2038_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2038_List1 = TObjectList<TMyObj2038_1>;
...
constructor TMyObj2038_1.Create;
begin
  inherited;
  FInt := 2038 * 3;
  FTest := 'Value: ' + Random(220382).ToString + Random(203800).ToString;
end;

procedure TForm2038.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2038;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2038_List0 := TMyObj2038_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2038_List1 := TMyObj2038_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
