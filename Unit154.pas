...
type
  ...
  TMyObj154_List0 = TObjectList<TMyObj154>;

  TMyObj154_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj154_List1 = TObjectList<TMyObj154_1>;
...
constructor TMyObj154_1.Create;
begin
  inherited;
  FInt := 154 * 3;
  FTest := 'Value: ' + Random(21542).ToString + Random(15400).ToString;
end;

procedure TForm154.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum154;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj154_List0 := TMyObj154_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj154_List1 := TMyObj154_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
