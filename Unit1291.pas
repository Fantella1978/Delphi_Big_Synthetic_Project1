...
type
  ...
  TMyObj1291_List0 = TObjectList<TMyObj1291>;

  TMyObj1291_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1291_List1 = TObjectList<TMyObj1291_1>;
...
constructor TMyObj1291_1.Create;
begin
  inherited;
  FInt := 1291 * 3;
  FTest := 'Value: ' + Random(212912).ToString + Random(129100).ToString;
end;

procedure TForm1291.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1291;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1291_List0 := TMyObj1291_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1291_List1 := TMyObj1291_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
