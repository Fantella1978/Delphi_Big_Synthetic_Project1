...
type
  ...
  TMyObj2464_List0 = TObjectList<TMyObj2464>;

  TMyObj2464_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2464_List1 = TObjectList<TMyObj2464_1>;
...
constructor TMyObj2464_1.Create;
begin
  inherited;
  FInt := 2464 * 3;
  FTest := 'Value: ' + Random(224642).ToString + Random(246400).ToString;
end;

procedure TForm2464.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2464;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2464_List0 := TMyObj2464_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2464_List1 := TMyObj2464_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
