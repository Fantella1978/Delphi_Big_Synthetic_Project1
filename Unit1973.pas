...
type
  ...
  TMyObj1973_List0 = TObjectList<TMyObj1973>;

  TMyObj1973_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1973_List1 = TObjectList<TMyObj1973_1>;
...
constructor TMyObj1973_1.Create;
begin
  inherited;
  FInt := 1973 * 3;
  FTest := 'Value: ' + Random(219732).ToString + Random(197300).ToString;
end;

procedure TForm1973.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1973;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1973_List0 := TMyObj1973_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1973_List1 := TMyObj1973_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
