...
type
  ...
  TMyObj2084_List0 = TObjectList<TMyObj2084>;

  TMyObj2084_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2084_List1 = TObjectList<TMyObj2084_1>;
...
constructor TMyObj2084_1.Create;
begin
  inherited;
  FInt := 2084 * 3;
  FTest := 'Value: ' + Random(220842).ToString + Random(208400).ToString;
end;

procedure TForm2084.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2084;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2084_List0 := TMyObj2084_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2084_List1 := TMyObj2084_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
