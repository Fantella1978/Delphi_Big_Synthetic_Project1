...
type
  ...
  TMyObj1378_List0 = TObjectList<TMyObj1378>;

  TMyObj1378_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1378_List1 = TObjectList<TMyObj1378_1>;
...
constructor TMyObj1378_1.Create;
begin
  inherited;
  FInt := 1378 * 3;
  FTest := 'Value: ' + Random(213782).ToString + Random(137800).ToString;
end;

procedure TForm1378.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1378;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1378_List0 := TMyObj1378_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1378_List1 := TMyObj1378_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
