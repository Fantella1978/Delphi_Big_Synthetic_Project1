...
type
  ...
  TMyObj1777_List0 = TObjectList<TMyObj1777>;

  TMyObj1777_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1777_List1 = TObjectList<TMyObj1777_1>;
...
constructor TMyObj1777_1.Create;
begin
  inherited;
  FInt := 1777 * 3;
  FTest := 'Value: ' + Random(217772).ToString + Random(177700).ToString;
end;

procedure TForm1777.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1777;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1777_List0 := TMyObj1777_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1777_List1 := TMyObj1777_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
