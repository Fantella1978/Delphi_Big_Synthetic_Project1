...
type
  ...
  TMyObj1174_List0 = TObjectList<TMyObj1174>;

  TMyObj1174_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1174_List1 = TObjectList<TMyObj1174_1>;
...
constructor TMyObj1174_1.Create;
begin
  inherited;
  FInt := 1174 * 3;
  FTest := 'Value: ' + Random(211742).ToString + Random(117400).ToString;
end;

procedure TForm1174.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1174;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1174_List0 := TMyObj1174_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1174_List1 := TMyObj1174_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
