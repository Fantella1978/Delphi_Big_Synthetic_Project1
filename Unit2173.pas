...
type
  ...
  TMyObj2173_List0 = TObjectList<TMyObj2173>;

  TMyObj2173_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2173_List1 = TObjectList<TMyObj2173_1>;
...
constructor TMyObj2173_1.Create;
begin
  inherited;
  FInt := 2173 * 3;
  FTest := 'Value: ' + Random(221732).ToString + Random(217300).ToString;
end;

procedure TForm2173.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2173;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2173_List0 := TMyObj2173_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2173_List1 := TMyObj2173_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
