...
type
  ...
  TMyObj1205_List0 = TObjectList<TMyObj1205>;

  TMyObj1205_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1205_List1 = TObjectList<TMyObj1205_1>;
...
constructor TMyObj1205_1.Create;
begin
  inherited;
  FInt := 1205 * 3;
  FTest := 'Value: ' + Random(212052).ToString + Random(120500).ToString;
end;

procedure TForm1205.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1205;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1205_List0 := TMyObj1205_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1205_List1 := TMyObj1205_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
