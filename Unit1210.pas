...
type
  ...
  TMyObj1210_List0 = TObjectList<TMyObj1210>;

  TMyObj1210_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1210_List1 = TObjectList<TMyObj1210_1>;
...
constructor TMyObj1210_1.Create;
begin
  inherited;
  FInt := 1210 * 3;
  FTest := 'Value: ' + Random(212102).ToString + Random(121000).ToString;
end;

procedure TForm1210.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1210;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1210_List0 := TMyObj1210_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1210_List1 := TMyObj1210_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
