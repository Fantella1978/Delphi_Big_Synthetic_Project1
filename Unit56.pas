...
type
  ...
  TMyObj56_List0 = TObjectList<TMyObj56>;

  TMyObj56_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj56_List1 = TObjectList<TMyObj56_1>;
...
constructor TMyObj56_1.Create;
begin
  inherited;
  FInt := 56 * 3;
  FTest := 'Value: ' + Random(2562).ToString + Random(5600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj56_List0 := TMyObj56_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj56_List1 := TMyObj56_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
