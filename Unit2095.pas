...
type
  ...
  TMyObj2095_List0 = TObjectList<TMyObj2095>;

  TMyObj2095_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2095_List1 = TObjectList<TMyObj2095_1>;
...
constructor TMyObj2095_1.Create;
begin
  inherited;
  FInt := 2095 * 3;
  FTest := 'Value: ' + Random(220952).ToString + Random(209500).ToString;
end;

procedure TForm2095.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2095;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2095_List0 := TMyObj2095_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2095_List1 := TMyObj2095_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
