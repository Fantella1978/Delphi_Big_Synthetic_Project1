...
type
  ...
  TMyObj2323_List0 = TObjectList<TMyObj2323>;

  TMyObj2323_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2323_List1 = TObjectList<TMyObj2323_1>;
...
constructor TMyObj2323_1.Create;
begin
  inherited;
  FInt := 2323 * 3;
  FTest := 'Value: ' + Random(223232).ToString + Random(232300).ToString;
end;

procedure TForm2323.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2323;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2323_List0 := TMyObj2323_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2323_List1 := TMyObj2323_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
