...
type
  ...
  TMyObj1029_List0 = TObjectList<TMyObj1029>;

  TMyObj1029_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1029_List1 = TObjectList<TMyObj1029_1>;
...
constructor TMyObj1029_1.Create;
begin
  inherited;
  FInt := 1029 * 3;
  FTest := 'Value: ' + Random(210292).ToString + Random(102900).ToString;
end;

procedure TForm1029.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1029;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1029_List0 := TMyObj1029_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1029_List1 := TMyObj1029_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
