...
type
  ...
  TMyObj977_List0 = TObjectList<TMyObj977>;

  TMyObj977_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj977_List1 = TObjectList<TMyObj977_1>;
...
constructor TMyObj977_1.Create;
begin
  inherited;
  FInt := 977 * 3;
  FTest := 'Value: ' + Random(29772).ToString + Random(97700).ToString;
end;

procedure TForm977.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum977;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj977_List0 := TMyObj977_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj977_List1 := TMyObj977_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
