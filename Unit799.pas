...
type
  ...
  TMyObj799_List0 = TObjectList<TMyObj799>;

  TMyObj799_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj799_List1 = TObjectList<TMyObj799_1>;
...
constructor TMyObj799_1.Create;
begin
  inherited;
  FInt := 799 * 3;
  FTest := 'Value: ' + Random(27992).ToString + Random(79900).ToString;
end;

procedure TForm799.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum799;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj799_List0 := TMyObj799_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj799_List1 := TMyObj799_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
