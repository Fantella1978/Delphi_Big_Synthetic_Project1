...
type
  ...
  TMyObj727_List0 = TObjectList<TMyObj727>;

  TMyObj727_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj727_List1 = TObjectList<TMyObj727_1>;
...
constructor TMyObj727_1.Create;
begin
  inherited;
  FInt := 727 * 3;
  FTest := 'Value: ' + Random(27272).ToString + Random(72700).ToString;
end;

procedure TForm727.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum727;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj727_List0 := TMyObj727_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj727_List1 := TMyObj727_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
