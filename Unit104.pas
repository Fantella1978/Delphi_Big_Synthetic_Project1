...
type
  ...
  TMyObj104_List0 = TObjectList<TMyObj104>;

  TMyObj104_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj104_List1 = TObjectList<TMyObj104_1>;
...
constructor TMyObj104_1.Create;
begin
  inherited;
  FInt := 104 * 3;
  FTest := 'Value: ' + Random(21042).ToString + Random(10400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj104_List0 := TMyObj104_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj104_List1 := TMyObj104_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
