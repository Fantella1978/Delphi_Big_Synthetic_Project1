...
type
  ...
  TMyObj140_List0 = TObjectList<TMyObj140>;

  TMyObj140_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj140_List1 = TObjectList<TMyObj140_1>;
...
constructor TMyObj140_1.Create;
begin
  inherited;
  FInt := 140 * 3;
  FTest := 'Value: ' + Random(21402).ToString + Random(14000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj140_List0 := TMyObj140_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj140_List1 := TMyObj140_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
