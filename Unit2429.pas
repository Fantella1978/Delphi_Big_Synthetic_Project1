...
type
  ...
  TMyObj2429_List0 = TObjectList<TMyObj2429>;

  TMyObj2429_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2429_List1 = TObjectList<TMyObj2429_1>;
...
constructor TMyObj2429_1.Create;
begin
  inherited;
  FInt := 2429 * 3;
  FTest := 'Value: ' + Random(224292).ToString + Random(242900).ToString;
end;

procedure TForm2429.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2429;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2429_List0 := TMyObj2429_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2429_List1 := TMyObj2429_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
