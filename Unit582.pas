...
type
  ...
  TMyObj582_List0 = TObjectList<TMyObj582>;

  TMyObj582_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj582_List1 = TObjectList<TMyObj582_1>;
...
constructor TMyObj582_1.Create;
begin
  inherited;
  FInt := 582 * 3;
  FTest := 'Value: ' + Random(25822).ToString + Random(58200).ToString;
end;

procedure TForm582.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum582;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj582_List0 := TMyObj582_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj582_List1 := TMyObj582_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
