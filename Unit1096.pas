...
type
  ...
  TMyObj1096_List0 = TObjectList<TMyObj1096>;

  TMyObj1096_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1096_List1 = TObjectList<TMyObj1096_1>;
...
constructor TMyObj1096_1.Create;
begin
  inherited;
  FInt := 1096 * 3;
  FTest := 'Value: ' + Random(210962).ToString + Random(109600).ToString;
end;

procedure TForm1096.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1096;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1096_List0 := TMyObj1096_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1096_List1 := TMyObj1096_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
