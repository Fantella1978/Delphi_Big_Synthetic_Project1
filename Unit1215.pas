...
type
  ...
  TMyObj1215_List0 = TObjectList<TMyObj1215>;

  TMyObj1215_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1215_List1 = TObjectList<TMyObj1215_1>;
...
constructor TMyObj1215_1.Create;
begin
  inherited;
  FInt := 1215 * 3;
  FTest := 'Value: ' + Random(212152).ToString + Random(121500).ToString;
end;

procedure TForm1215.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1215;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1215_List0 := TMyObj1215_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1215_List1 := TMyObj1215_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
