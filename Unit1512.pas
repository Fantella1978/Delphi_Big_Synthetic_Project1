...
type
  ...
  TMyObj1512_List0 = TObjectList<TMyObj1512>;

  TMyObj1512_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1512_List1 = TObjectList<TMyObj1512_1>;
...
constructor TMyObj1512_1.Create;
begin
  inherited;
  FInt := 1512 * 3;
  FTest := 'Value: ' + Random(215122).ToString + Random(151200).ToString;
end;

procedure TForm1512.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1512;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1512_List0 := TMyObj1512_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1512_List1 := TMyObj1512_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
