...
type
  ...
  TMyObj266_List0 = TObjectList<TMyObj266>;

  TMyObj266_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj266_List1 = TObjectList<TMyObj266_1>;
...
constructor TMyObj266_1.Create;
begin
  inherited;
  FInt := 266 * 3;
  FTest := 'Value: ' + Random(22662).ToString + Random(26600).ToString;
end;

procedure TForm266.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum266;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj266_List0 := TMyObj266_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj266_List1 := TMyObj266_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
