...
type
  ...
  TMyObj331_List0 = TObjectList<TMyObj331>;

  TMyObj331_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj331_List1 = TObjectList<TMyObj331_1>;
...
constructor TMyObj331_1.Create;
begin
  inherited;
  FInt := 331 * 3;
  FTest := 'Value: ' + Random(23312).ToString + Random(33100).ToString;
end;

procedure TForm331.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum331;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj331_List0 := TMyObj331_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj331_List1 := TMyObj331_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
