...
type
  ...
  TMyObj204_List0 = TObjectList<TMyObj204>;

  TMyObj204_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj204_List1 = TObjectList<TMyObj204_1>;
...
constructor TMyObj204_1.Create;
begin
  inherited;
  FInt := 204 * 3;
  FTest := 'Value: ' + Random(22042).ToString + Random(20400).ToString;
end;

procedure TForm204.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum204;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj204_List0 := TMyObj204_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj204_List1 := TMyObj204_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
