...
type
  ...
  TMyObj1755_List0 = TObjectList<TMyObj1755>;

  TMyObj1755_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1755_List1 = TObjectList<TMyObj1755_1>;
...
constructor TMyObj1755_1.Create;
begin
  inherited;
  FInt := 1755 * 3;
  FTest := 'Value: ' + Random(217552).ToString + Random(175500).ToString;
end;

procedure TForm1755.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1755;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1755_List0 := TMyObj1755_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1755_List1 := TMyObj1755_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
