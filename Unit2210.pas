...
type
  ...
  TMyObj2210_List0 = TObjectList<TMyObj2210>;

  TMyObj2210_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2210_List1 = TObjectList<TMyObj2210_1>;
...
constructor TMyObj2210_1.Create;
begin
  inherited;
  FInt := 2210 * 3;
  FTest := 'Value: ' + Random(222102).ToString + Random(221000).ToString;
end;

procedure TForm2210.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2210;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2210_List0 := TMyObj2210_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2210_List1 := TMyObj2210_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
