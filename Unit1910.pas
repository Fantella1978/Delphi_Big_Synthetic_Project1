...
type
  ...
  TMyObj1910_List0 = TObjectList<TMyObj1910>;

  TMyObj1910_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1910_List1 = TObjectList<TMyObj1910_1>;
...
constructor TMyObj1910_1.Create;
begin
  inherited;
  FInt := 1910 * 3;
  FTest := 'Value: ' + Random(219102).ToString + Random(191000).ToString;
end;

procedure TForm1910.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1910;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1910_List0 := TMyObj1910_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1910_List1 := TMyObj1910_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
