...
type
  ...
  TMyObj391_List0 = TObjectList<TMyObj391>;

  TMyObj391_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj391_List1 = TObjectList<TMyObj391_1>;
...
constructor TMyObj391_1.Create;
begin
  inherited;
  FInt := 391 * 3;
  FTest := 'Value: ' + Random(23912).ToString + Random(39100).ToString;
end;

procedure TForm391.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum391;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj391_List0 := TMyObj391_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj391_List1 := TMyObj391_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
