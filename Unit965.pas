...
type
  ...
  TMyObj965_List0 = TObjectList<TMyObj965>;

  TMyObj965_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj965_List1 = TObjectList<TMyObj965_1>;
...
constructor TMyObj965_1.Create;
begin
  inherited;
  FInt := 965 * 3;
  FTest := 'Value: ' + Random(29652).ToString + Random(96500).ToString;
end;

procedure TForm965.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum965;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj965_List0 := TMyObj965_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj965_List1 := TMyObj965_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
