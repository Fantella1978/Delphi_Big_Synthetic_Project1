...
type
  ...
  TMyObj591_List0 = TObjectList<TMyObj591>;

  TMyObj591_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj591_List1 = TObjectList<TMyObj591_1>;
...
constructor TMyObj591_1.Create;
begin
  inherited;
  FInt := 591 * 3;
  FTest := 'Value: ' + Random(25912).ToString + Random(59100).ToString;
end;

procedure TForm591.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum591;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj591_List0 := TMyObj591_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj591_List1 := TMyObj591_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
