...
type
  ...
  TMyObj23_List0 = TObjectList<TMyObj23>;

  TMyObj23_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj23_List1 = TObjectList<TMyObj23_1>;
...
constructor TMyObj23_1.Create;
begin
  inherited;
  FInt := 23 * 3;
  FTest := 'Value: ' + Random(2232).ToString + Random(2300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj23_List0 := TMyObj23_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj23_List1 := TMyObj23_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
