...
type
  ...
  TMyObj1932_List0 = TObjectList<TMyObj1932>;

  TMyObj1932_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1932_List1 = TObjectList<TMyObj1932_1>;
...
constructor TMyObj1932_1.Create;
begin
  inherited;
  FInt := 1932 * 3;
  FTest := 'Value: ' + Random(219322).ToString + Random(193200).ToString;
end;

procedure TForm1932.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1932;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1932_List0 := TMyObj1932_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1932_List1 := TMyObj1932_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
