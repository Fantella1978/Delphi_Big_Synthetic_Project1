...
type
  ...
  TMyObj635_List0 = TObjectList<TMyObj635>;

  TMyObj635_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj635_List1 = TObjectList<TMyObj635_1>;
...
constructor TMyObj635_1.Create;
begin
  inherited;
  FInt := 635 * 3;
  FTest := 'Value: ' + Random(26352).ToString + Random(63500).ToString;
end;

procedure TForm635.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum635;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj635_List0 := TMyObj635_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj635_List1 := TMyObj635_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
