...
type
  ...
  TMyObj751_List0 = TObjectList<TMyObj751>;

  TMyObj751_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj751_List1 = TObjectList<TMyObj751_1>;
...
constructor TMyObj751_1.Create;
begin
  inherited;
  FInt := 751 * 3;
  FTest := 'Value: ' + Random(27512).ToString + Random(75100).ToString;
end;

procedure TForm751.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum751;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj751_List0 := TMyObj751_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj751_List1 := TMyObj751_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
