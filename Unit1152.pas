...
type
  ...
  TMyObj1152_List0 = TObjectList<TMyObj1152>;

  TMyObj1152_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1152_List1 = TObjectList<TMyObj1152_1>;
...
constructor TMyObj1152_1.Create;
begin
  inherited;
  FInt := 1152 * 3;
  FTest := 'Value: ' + Random(211522).ToString + Random(115200).ToString;
end;

procedure TForm1152.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1152;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1152_List0 := TMyObj1152_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1152_List1 := TMyObj1152_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
