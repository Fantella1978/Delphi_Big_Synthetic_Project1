...
type
  ...
  TMyObj49_List0 = TObjectList<TMyObj49>;

  TMyObj49_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj49_List1 = TObjectList<TMyObj49_1>;
...
constructor TMyObj49_1.Create;
begin
  inherited;
  FInt := 49 * 3;
  FTest := 'Value: ' + Random(2492).ToString + Random(4900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj49_List0 := TMyObj49_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj49_List1 := TMyObj49_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
