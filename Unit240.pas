...
type
  ...
  TMyObj240_List0 = TObjectList<TMyObj240>;

  TMyObj240_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj240_List1 = TObjectList<TMyObj240_1>;
...
constructor TMyObj240_1.Create;
begin
  inherited;
  FInt := 240 * 3;
  FTest := 'Value: ' + Random(22402).ToString + Random(24000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj240_List0 := TMyObj240_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj240_List1 := TMyObj240_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
