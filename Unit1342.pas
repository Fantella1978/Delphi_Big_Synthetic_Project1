...
type
  ...
  TMyObj1342_List0 = TObjectList<TMyObj1342>;

  TMyObj1342_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1342_List1 = TObjectList<TMyObj1342_1>;
...
constructor TMyObj1342_1.Create;
begin
  inherited;
  FInt := 1342 * 3;
  FTest := 'Value: ' + Random(213422).ToString + Random(134200).ToString;
end;

procedure TForm1342.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1342;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1342_List0 := TMyObj1342_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1342_List1 := TMyObj1342_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
