...
type
  ...
  TMyObj2285_List0 = TObjectList<TMyObj2285>;

  TMyObj2285_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2285_List1 = TObjectList<TMyObj2285_1>;
...
constructor TMyObj2285_1.Create;
begin
  inherited;
  FInt := 2285 * 3;
  FTest := 'Value: ' + Random(222852).ToString + Random(228500).ToString;
end;

procedure TForm2285.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2285;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2285_List0 := TMyObj2285_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2285_List1 := TMyObj2285_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
