...
type
  ...
  TMyObj429_List0 = TObjectList<TMyObj429>;

  TMyObj429_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj429_List1 = TObjectList<TMyObj429_1>;
...
constructor TMyObj429_1.Create;
begin
  inherited;
  FInt := 429 * 3;
  FTest := 'Value: ' + Random(24292).ToString + Random(42900).ToString;
end;

procedure TForm429.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum429;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj429_List0 := TMyObj429_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj429_List1 := TMyObj429_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
