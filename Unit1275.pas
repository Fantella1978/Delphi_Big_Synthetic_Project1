...
type
  ...
  TMyObj1275_List0 = TObjectList<TMyObj1275>;

  TMyObj1275_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1275_List1 = TObjectList<TMyObj1275_1>;
...
constructor TMyObj1275_1.Create;
begin
  inherited;
  FInt := 1275 * 3;
  FTest := 'Value: ' + Random(212752).ToString + Random(127500).ToString;
end;

procedure TForm1275.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1275;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1275_List0 := TMyObj1275_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1275_List1 := TMyObj1275_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
