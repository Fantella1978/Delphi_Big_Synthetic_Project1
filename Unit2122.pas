...
type
  ...
  TMyObj2122_List0 = TObjectList<TMyObj2122>;

  TMyObj2122_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2122_List1 = TObjectList<TMyObj2122_1>;
...
constructor TMyObj2122_1.Create;
begin
  inherited;
  FInt := 2122 * 3;
  FTest := 'Value: ' + Random(221222).ToString + Random(212200).ToString;
end;

procedure TForm2122.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2122;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2122_List0 := TMyObj2122_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2122_List1 := TMyObj2122_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
