...
type
  ...
  TMyObj1331_List0 = TObjectList<TMyObj1331>;

  TMyObj1331_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1331_List1 = TObjectList<TMyObj1331_1>;
...
constructor TMyObj1331_1.Create;
begin
  inherited;
  FInt := 1331 * 3;
  FTest := 'Value: ' + Random(213312).ToString + Random(133100).ToString;
end;

procedure TForm1331.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1331;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1331_List0 := TMyObj1331_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1331_List1 := TMyObj1331_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
