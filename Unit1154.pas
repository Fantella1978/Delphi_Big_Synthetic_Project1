...
type
  ...
  TMyObj1154_List0 = TObjectList<TMyObj1154>;

  TMyObj1154_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1154_List1 = TObjectList<TMyObj1154_1>;
...
constructor TMyObj1154_1.Create;
begin
  inherited;
  FInt := 1154 * 3;
  FTest := 'Value: ' + Random(211542).ToString + Random(115400).ToString;
end;

procedure TForm1154.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1154;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1154_List0 := TMyObj1154_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1154_List1 := TMyObj1154_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
