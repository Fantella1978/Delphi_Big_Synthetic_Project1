...
type
  ...
  TMyObj2041_List0 = TObjectList<TMyObj2041>;

  TMyObj2041_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2041_List1 = TObjectList<TMyObj2041_1>;
...
constructor TMyObj2041_1.Create;
begin
  inherited;
  FInt := 2041 * 3;
  FTest := 'Value: ' + Random(220412).ToString + Random(204100).ToString;
end;

procedure TForm2041.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2041;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2041_List0 := TMyObj2041_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2041_List1 := TMyObj2041_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
