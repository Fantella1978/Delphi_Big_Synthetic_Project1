...
type
  ...
  TMyObj468_List0 = TObjectList<TMyObj468>;

  TMyObj468_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj468_List1 = TObjectList<TMyObj468_1>;
...
constructor TMyObj468_1.Create;
begin
  inherited;
  FInt := 468 * 3;
  FTest := 'Value: ' + Random(24682).ToString + Random(46800).ToString;
end;

procedure TForm468.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum468;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj468_List0 := TMyObj468_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj468_List1 := TMyObj468_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
