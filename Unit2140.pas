...
type
  ...
  TMyObj2140_List0 = TObjectList<TMyObj2140>;

  TMyObj2140_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2140_List1 = TObjectList<TMyObj2140_1>;
...
constructor TMyObj2140_1.Create;
begin
  inherited;
  FInt := 2140 * 3;
  FTest := 'Value: ' + Random(221402).ToString + Random(214000).ToString;
end;

procedure TForm2140.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2140;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2140_List0 := TMyObj2140_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2140_List1 := TMyObj2140_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
