...
type
  ...
  TMyObj1172_List0 = TObjectList<TMyObj1172>;

  TMyObj1172_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1172_List1 = TObjectList<TMyObj1172_1>;
...
constructor TMyObj1172_1.Create;
begin
  inherited;
  FInt := 1172 * 3;
  FTest := 'Value: ' + Random(211722).ToString + Random(117200).ToString;
end;

procedure TForm1172.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1172;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1172_List0 := TMyObj1172_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1172_List1 := TMyObj1172_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
