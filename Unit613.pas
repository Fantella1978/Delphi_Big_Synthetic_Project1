...
type
  ...
  TMyObj613_List0 = TObjectList<TMyObj613>;

  TMyObj613_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj613_List1 = TObjectList<TMyObj613_1>;
...
constructor TMyObj613_1.Create;
begin
  inherited;
  FInt := 613 * 3;
  FTest := 'Value: ' + Random(26132).ToString + Random(61300).ToString;
end;

procedure TForm613.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum613;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj613_List0 := TMyObj613_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj613_List1 := TMyObj613_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
