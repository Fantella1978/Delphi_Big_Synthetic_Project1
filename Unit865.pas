...
type
  ...
  TMyObj865_List0 = TObjectList<TMyObj865>;

  TMyObj865_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj865_List1 = TObjectList<TMyObj865_1>;
...
constructor TMyObj865_1.Create;
begin
  inherited;
  FInt := 865 * 3;
  FTest := 'Value: ' + Random(28652).ToString + Random(86500).ToString;
end;

procedure TForm865.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum865;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj865_List0 := TMyObj865_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj865_List1 := TMyObj865_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
