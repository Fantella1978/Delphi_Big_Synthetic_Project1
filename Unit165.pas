...
type
  ...
  TMyObj165_List0 = TObjectList<TMyObj165>;

  TMyObj165_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj165_List1 = TObjectList<TMyObj165_1>;
...
constructor TMyObj165_1.Create;
begin
  inherited;
  FInt := 165 * 3;
  FTest := 'Value: ' + Random(21652).ToString + Random(16500).ToString;
end;

procedure TForm165.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum165;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj165_List0 := TMyObj165_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj165_List1 := TMyObj165_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
