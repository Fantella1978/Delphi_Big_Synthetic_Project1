...
type
  ...
  TMyObj703_List0 = TObjectList<TMyObj703>;

  TMyObj703_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj703_List1 = TObjectList<TMyObj703_1>;
...
constructor TMyObj703_1.Create;
begin
  inherited;
  FInt := 703 * 3;
  FTest := 'Value: ' + Random(27032).ToString + Random(70300).ToString;
end;

procedure TForm703.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum703;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj703_List0 := TMyObj703_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj703_List1 := TMyObj703_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
