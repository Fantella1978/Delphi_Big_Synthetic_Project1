...
type
  ...
  TMyObj1239_List0 = TObjectList<TMyObj1239>;

  TMyObj1239_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1239_List1 = TObjectList<TMyObj1239_1>;
...
constructor TMyObj1239_1.Create;
begin
  inherited;
  FInt := 1239 * 3;
  FTest := 'Value: ' + Random(212392).ToString + Random(123900).ToString;
end;

procedure TForm1239.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1239;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1239_List0 := TMyObj1239_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1239_List1 := TMyObj1239_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
