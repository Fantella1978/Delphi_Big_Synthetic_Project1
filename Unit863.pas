...
type
  ...
  TMyObj863_List0 = TObjectList<TMyObj863>;

  TMyObj863_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj863_List1 = TObjectList<TMyObj863_1>;
...
constructor TMyObj863_1.Create;
begin
  inherited;
  FInt := 863 * 3;
  FTest := 'Value: ' + Random(28632).ToString + Random(86300).ToString;
end;

procedure TForm863.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum863;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj863_List0 := TMyObj863_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj863_List1 := TMyObj863_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
