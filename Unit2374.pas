...
type
  ...
  TMyObj2374_List0 = TObjectList<TMyObj2374>;

  TMyObj2374_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2374_List1 = TObjectList<TMyObj2374_1>;
...
constructor TMyObj2374_1.Create;
begin
  inherited;
  FInt := 2374 * 3;
  FTest := 'Value: ' + Random(223742).ToString + Random(237400).ToString;
end;

procedure TForm2374.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2374;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2374_List0 := TMyObj2374_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2374_List1 := TMyObj2374_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
