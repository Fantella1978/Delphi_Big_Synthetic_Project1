...
type
  ...
  TMyObj617_List0 = TObjectList<TMyObj617>;

  TMyObj617_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj617_List1 = TObjectList<TMyObj617_1>;
...
constructor TMyObj617_1.Create;
begin
  inherited;
  FInt := 617 * 3;
  FTest := 'Value: ' + Random(26172).ToString + Random(61700).ToString;
end;

procedure TForm617.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum617;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj617_List0 := TMyObj617_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj617_List1 := TMyObj617_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
