...
type
  ...
  TMyObj838_List0 = TObjectList<TMyObj838>;

  TMyObj838_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj838_List1 = TObjectList<TMyObj838_1>;
...
constructor TMyObj838_1.Create;
begin
  inherited;
  FInt := 838 * 3;
  FTest := 'Value: ' + Random(28382).ToString + Random(83800).ToString;
end;

procedure TForm838.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum838;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj838_List0 := TMyObj838_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj838_List1 := TMyObj838_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
