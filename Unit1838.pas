...
type
  ...
  TMyObj1838_List0 = TObjectList<TMyObj1838>;

  TMyObj1838_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1838_List1 = TObjectList<TMyObj1838_1>;
...
constructor TMyObj1838_1.Create;
begin
  inherited;
  FInt := 1838 * 3;
  FTest := 'Value: ' + Random(218382).ToString + Random(183800).ToString;
end;

procedure TForm1838.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1838;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1838_List0 := TMyObj1838_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1838_List1 := TMyObj1838_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
