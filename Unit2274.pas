...
type
  ...
  TMyObj2274_List0 = TObjectList<TMyObj2274>;

  TMyObj2274_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2274_List1 = TObjectList<TMyObj2274_1>;
...
constructor TMyObj2274_1.Create;
begin
  inherited;
  FInt := 2274 * 3;
  FTest := 'Value: ' + Random(222742).ToString + Random(227400).ToString;
end;

procedure TForm2274.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2274;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2274_List0 := TMyObj2274_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2274_List1 := TMyObj2274_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
