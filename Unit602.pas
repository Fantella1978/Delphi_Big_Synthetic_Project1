...
type
  ...
  TMyObj602_List0 = TObjectList<TMyObj602>;

  TMyObj602_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj602_List1 = TObjectList<TMyObj602_1>;
...
constructor TMyObj602_1.Create;
begin
  inherited;
  FInt := 602 * 3;
  FTest := 'Value: ' + Random(26022).ToString + Random(60200).ToString;
end;

procedure TForm602.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum602;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj602_List0 := TMyObj602_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj602_List1 := TMyObj602_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
