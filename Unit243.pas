...
type
  ...
  TMyObj243_List0 = TObjectList<TMyObj243>;

  TMyObj243_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj243_List1 = TObjectList<TMyObj243_1>;
...
constructor TMyObj243_1.Create;
begin
  inherited;
  FInt := 243 * 3;
  FTest := 'Value: ' + Random(22432).ToString + Random(24300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj243_List0 := TMyObj243_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj243_List1 := TMyObj243_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
