...
type
  ...
  TMyObj496_List0 = TObjectList<TMyObj496>;

  TMyObj496_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj496_List1 = TObjectList<TMyObj496_1>;
...
constructor TMyObj496_1.Create;
begin
  inherited;
  FInt := 496 * 3;
  FTest := 'Value: ' + Random(24962).ToString + Random(49600).ToString;
end;

procedure TForm496.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum496;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj496_List0 := TMyObj496_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj496_List1 := TMyObj496_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
