...
type
  ...
  TMyObj577_List0 = TObjectList<TMyObj577>;

  TMyObj577_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj577_List1 = TObjectList<TMyObj577_1>;
...
constructor TMyObj577_1.Create;
begin
  inherited;
  FInt := 577 * 3;
  FTest := 'Value: ' + Random(25772).ToString + Random(57700).ToString;
end;

procedure TForm577.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum577;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj577_List0 := TMyObj577_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj577_List1 := TMyObj577_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
