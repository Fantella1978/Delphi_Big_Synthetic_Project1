...
type
  ...
  TMyObj1362_List0 = TObjectList<TMyObj1362>;

  TMyObj1362_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1362_List1 = TObjectList<TMyObj1362_1>;
...
constructor TMyObj1362_1.Create;
begin
  inherited;
  FInt := 1362 * 3;
  FTest := 'Value: ' + Random(213622).ToString + Random(136200).ToString;
end;

procedure TForm1362.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1362;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1362_List0 := TMyObj1362_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1362_List1 := TMyObj1362_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
