...
type
  ...
  TMyObj1872_List0 = TObjectList<TMyObj1872>;

  TMyObj1872_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1872_List1 = TObjectList<TMyObj1872_1>;
...
constructor TMyObj1872_1.Create;
begin
  inherited;
  FInt := 1872 * 3;
  FTest := 'Value: ' + Random(218722).ToString + Random(187200).ToString;
end;

procedure TForm1872.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1872;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1872_List0 := TMyObj1872_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1872_List1 := TMyObj1872_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
