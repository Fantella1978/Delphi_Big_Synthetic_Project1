...
type
  ...
  TMyObj1990_List0 = TObjectList<TMyObj1990>;

  TMyObj1990_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1990_List1 = TObjectList<TMyObj1990_1>;
...
constructor TMyObj1990_1.Create;
begin
  inherited;
  FInt := 1990 * 3;
  FTest := 'Value: ' + Random(219902).ToString + Random(199000).ToString;
end;

procedure TForm1990.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1990;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1990_List0 := TMyObj1990_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1990_List1 := TMyObj1990_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
