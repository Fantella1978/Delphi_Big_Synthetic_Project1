...
type
  ...
  TMyObj402_List0 = TObjectList<TMyObj402>;

  TMyObj402_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj402_List1 = TObjectList<TMyObj402_1>;
...
constructor TMyObj402_1.Create;
begin
  inherited;
  FInt := 402 * 3;
  FTest := 'Value: ' + Random(24022).ToString + Random(40200).ToString;
end;

procedure TForm402.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum402;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj402_List0 := TMyObj402_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj402_List1 := TMyObj402_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
