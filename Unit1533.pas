...
type
  ...
  TMyObj1533_List0 = TObjectList<TMyObj1533>;

  TMyObj1533_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1533_List1 = TObjectList<TMyObj1533_1>;
...
constructor TMyObj1533_1.Create;
begin
  inherited;
  FInt := 1533 * 3;
  FTest := 'Value: ' + Random(215332).ToString + Random(153300).ToString;
end;

procedure TForm1533.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1533;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1533_List0 := TMyObj1533_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1533_List1 := TMyObj1533_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
