...
type
  ...
  TMyObj1633_List0 = TObjectList<TMyObj1633>;

  TMyObj1633_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1633_List1 = TObjectList<TMyObj1633_1>;
...
constructor TMyObj1633_1.Create;
begin
  inherited;
  FInt := 1633 * 3;
  FTest := 'Value: ' + Random(216332).ToString + Random(163300).ToString;
end;

procedure TForm1633.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1633;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1633_List0 := TMyObj1633_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1633_List1 := TMyObj1633_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
