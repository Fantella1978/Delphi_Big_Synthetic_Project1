...
type
  ...
  TMyObj1646_List0 = TObjectList<TMyObj1646>;

  TMyObj1646_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1646_List1 = TObjectList<TMyObj1646_1>;
...
constructor TMyObj1646_1.Create;
begin
  inherited;
  FInt := 1646 * 3;
  FTest := 'Value: ' + Random(216462).ToString + Random(164600).ToString;
end;

procedure TForm1646.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1646;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1646_List0 := TMyObj1646_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1646_List1 := TMyObj1646_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
