...
type
  ...
  TMyObj626_List0 = TObjectList<TMyObj626>;

  TMyObj626_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj626_List1 = TObjectList<TMyObj626_1>;
...
constructor TMyObj626_1.Create;
begin
  inherited;
  FInt := 626 * 3;
  FTest := 'Value: ' + Random(26262).ToString + Random(62600).ToString;
end;

procedure TForm626.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum626;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj626_List0 := TMyObj626_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj626_List1 := TMyObj626_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
