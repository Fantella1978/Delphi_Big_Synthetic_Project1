...
type
  ...
  TMyObj1036_List0 = TObjectList<TMyObj1036>;

  TMyObj1036_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1036_List1 = TObjectList<TMyObj1036_1>;
...
constructor TMyObj1036_1.Create;
begin
  inherited;
  FInt := 1036 * 3;
  FTest := 'Value: ' + Random(210362).ToString + Random(103600).ToString;
end;

procedure TForm1036.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1036;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1036_List0 := TMyObj1036_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1036_List1 := TMyObj1036_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
