...
type
  ...
  TMyObj345_List0 = TObjectList<TMyObj345>;

  TMyObj345_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj345_List1 = TObjectList<TMyObj345_1>;
...
constructor TMyObj345_1.Create;
begin
  inherited;
  FInt := 345 * 3;
  FTest := 'Value: ' + Random(23452).ToString + Random(34500).ToString;
end;

procedure TForm345.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum345;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj345_List0 := TMyObj345_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj345_List1 := TMyObj345_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
