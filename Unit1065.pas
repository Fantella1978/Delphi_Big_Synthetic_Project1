...
type
  ...
  TMyObj1065_List0 = TObjectList<TMyObj1065>;

  TMyObj1065_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1065_List1 = TObjectList<TMyObj1065_1>;
...
constructor TMyObj1065_1.Create;
begin
  inherited;
  FInt := 1065 * 3;
  FTest := 'Value: ' + Random(210652).ToString + Random(106500).ToString;
end;

procedure TForm1065.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1065;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1065_List0 := TMyObj1065_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1065_List1 := TMyObj1065_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
