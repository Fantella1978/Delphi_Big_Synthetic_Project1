...
type
  ...
  TMyObj2461_List0 = TObjectList<TMyObj2461>;

  TMyObj2461_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2461_List1 = TObjectList<TMyObj2461_1>;
...
constructor TMyObj2461_1.Create;
begin
  inherited;
  FInt := 2461 * 3;
  FTest := 'Value: ' + Random(224612).ToString + Random(246100).ToString;
end;

procedure TForm2461.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2461;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2461_List0 := TMyObj2461_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2461_List1 := TMyObj2461_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
