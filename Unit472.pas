...
type
  ...
  TMyObj472_List0 = TObjectList<TMyObj472>;

  TMyObj472_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj472_List1 = TObjectList<TMyObj472_1>;
...
constructor TMyObj472_1.Create;
begin
  inherited;
  FInt := 472 * 3;
  FTest := 'Value: ' + Random(24722).ToString + Random(47200).ToString;
end;

procedure TForm472.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum472;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj472_List0 := TMyObj472_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj472_List1 := TMyObj472_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
