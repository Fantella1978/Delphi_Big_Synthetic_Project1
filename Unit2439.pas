...
type
  ...
  TMyObj2439_List0 = TObjectList<TMyObj2439>;

  TMyObj2439_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2439_List1 = TObjectList<TMyObj2439_1>;
...
constructor TMyObj2439_1.Create;
begin
  inherited;
  FInt := 2439 * 3;
  FTest := 'Value: ' + Random(224392).ToString + Random(243900).ToString;
end;

procedure TForm2439.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2439;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2439_List0 := TMyObj2439_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2439_List1 := TMyObj2439_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
