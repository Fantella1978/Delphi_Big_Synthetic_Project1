...
type
  ...
  TMyObj2315_List0 = TObjectList<TMyObj2315>;

  TMyObj2315_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2315_List1 = TObjectList<TMyObj2315_1>;
...
constructor TMyObj2315_1.Create;
begin
  inherited;
  FInt := 2315 * 3;
  FTest := 'Value: ' + Random(223152).ToString + Random(231500).ToString;
end;

procedure TForm2315.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2315;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2315_List0 := TMyObj2315_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2315_List1 := TMyObj2315_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
