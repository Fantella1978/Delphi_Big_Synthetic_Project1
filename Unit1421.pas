...
type
  ...
  TMyObj1421_List0 = TObjectList<TMyObj1421>;

  TMyObj1421_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1421_List1 = TObjectList<TMyObj1421_1>;
...
constructor TMyObj1421_1.Create;
begin
  inherited;
  FInt := 1421 * 3;
  FTest := 'Value: ' + Random(214212).ToString + Random(142100).ToString;
end;

procedure TForm1421.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1421;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1421_List0 := TMyObj1421_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1421_List1 := TMyObj1421_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
