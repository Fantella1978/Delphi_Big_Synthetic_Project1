...
type
  ...
  TMyObj2381_List0 = TObjectList<TMyObj2381>;

  TMyObj2381_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2381_List1 = TObjectList<TMyObj2381_1>;
...
constructor TMyObj2381_1.Create;
begin
  inherited;
  FInt := 2381 * 3;
  FTest := 'Value: ' + Random(223812).ToString + Random(238100).ToString;
end;

procedure TForm2381.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2381;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2381_List0 := TMyObj2381_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2381_List1 := TMyObj2381_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
