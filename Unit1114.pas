...
type
  ...
  TMyObj1114_List0 = TObjectList<TMyObj1114>;

  TMyObj1114_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1114_List1 = TObjectList<TMyObj1114_1>;
...
constructor TMyObj1114_1.Create;
begin
  inherited;
  FInt := 1114 * 3;
  FTest := 'Value: ' + Random(211142).ToString + Random(111400).ToString;
end;

procedure TForm1114.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1114;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1114_List0 := TMyObj1114_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1114_List1 := TMyObj1114_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
