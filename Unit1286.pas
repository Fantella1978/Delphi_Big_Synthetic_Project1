...
type
  ...
  TMyObj1286_List0 = TObjectList<TMyObj1286>;

  TMyObj1286_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1286_List1 = TObjectList<TMyObj1286_1>;
...
constructor TMyObj1286_1.Create;
begin
  inherited;
  FInt := 1286 * 3;
  FTest := 'Value: ' + Random(212862).ToString + Random(128600).ToString;
end;

procedure TForm1286.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1286;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1286_List0 := TMyObj1286_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1286_List1 := TMyObj1286_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
