...
type
  ...
  TMyObj1997_List0 = TObjectList<TMyObj1997>;

  TMyObj1997_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1997_List1 = TObjectList<TMyObj1997_1>;
...
constructor TMyObj1997_1.Create;
begin
  inherited;
  FInt := 1997 * 3;
  FTest := 'Value: ' + Random(219972).ToString + Random(199700).ToString;
end;

procedure TForm1997.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1997;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1997_List0 := TMyObj1997_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1997_List1 := TMyObj1997_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
