...
type
  ...
  TMyObj1156_List0 = TObjectList<TMyObj1156>;

  TMyObj1156_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1156_List1 = TObjectList<TMyObj1156_1>;
...
constructor TMyObj1156_1.Create;
begin
  inherited;
  FInt := 1156 * 3;
  FTest := 'Value: ' + Random(211562).ToString + Random(115600).ToString;
end;

procedure TForm1156.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1156;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1156_List0 := TMyObj1156_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1156_List1 := TMyObj1156_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
