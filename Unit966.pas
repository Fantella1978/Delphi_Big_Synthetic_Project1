...
type
  ...
  TMyObj966_List0 = TObjectList<TMyObj966>;

  TMyObj966_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj966_List1 = TObjectList<TMyObj966_1>;
...
constructor TMyObj966_1.Create;
begin
  inherited;
  FInt := 966 * 3;
  FTest := 'Value: ' + Random(29662).ToString + Random(96600).ToString;
end;

procedure TForm966.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum966;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj966_List0 := TMyObj966_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj966_List1 := TMyObj966_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
