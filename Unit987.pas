...
type
  ...
  TMyObj987_List0 = TObjectList<TMyObj987>;

  TMyObj987_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj987_List1 = TObjectList<TMyObj987_1>;
...
constructor TMyObj987_1.Create;
begin
  inherited;
  FInt := 987 * 3;
  FTest := 'Value: ' + Random(29872).ToString + Random(98700).ToString;
end;

procedure TForm987.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum987;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj987_List0 := TMyObj987_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj987_List1 := TMyObj987_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
