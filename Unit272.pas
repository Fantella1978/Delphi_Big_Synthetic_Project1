...
type
  ...
  TMyObj272_List0 = TObjectList<TMyObj272>;

  TMyObj272_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj272_List1 = TObjectList<TMyObj272_1>;
...
constructor TMyObj272_1.Create;
begin
  inherited;
  FInt := 272 * 3;
  FTest := 'Value: ' + Random(22722).ToString + Random(27200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj272_List0 := TMyObj272_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj272_List1 := TMyObj272_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
