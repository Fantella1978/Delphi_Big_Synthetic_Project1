...
type
  ...
  TMyObj1447_List0 = TObjectList<TMyObj1447>;

  TMyObj1447_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1447_List1 = TObjectList<TMyObj1447_1>;
...
constructor TMyObj1447_1.Create;
begin
  inherited;
  FInt := 1447 * 3;
  FTest := 'Value: ' + Random(214472).ToString + Random(144700).ToString;
end;

procedure TForm1447.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1447;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1447_List0 := TMyObj1447_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1447_List1 := TMyObj1447_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
