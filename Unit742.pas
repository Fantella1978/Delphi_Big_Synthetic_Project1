...
type
  ...
  TMyObj742_List0 = TObjectList<TMyObj742>;

  TMyObj742_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj742_List1 = TObjectList<TMyObj742_1>;
...
constructor TMyObj742_1.Create;
begin
  inherited;
  FInt := 742 * 3;
  FTest := 'Value: ' + Random(27422).ToString + Random(74200).ToString;
end;

procedure TForm742.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum742;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj742_List0 := TMyObj742_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj742_List1 := TMyObj742_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
