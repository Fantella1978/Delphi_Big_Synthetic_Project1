...
type
  ...
  TMyObj1293_List0 = TObjectList<TMyObj1293>;

  TMyObj1293_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1293_List1 = TObjectList<TMyObj1293_1>;
...
constructor TMyObj1293_1.Create;
begin
  inherited;
  FInt := 1293 * 3;
  FTest := 'Value: ' + Random(212932).ToString + Random(129300).ToString;
end;

procedure TForm1293.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1293;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1293_List0 := TMyObj1293_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1293_List1 := TMyObj1293_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
