...
type
  ...
  TMyObj2204_List0 = TObjectList<TMyObj2204>;

  TMyObj2204_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2204_List1 = TObjectList<TMyObj2204_1>;
...
constructor TMyObj2204_1.Create;
begin
  inherited;
  FInt := 2204 * 3;
  FTest := 'Value: ' + Random(222042).ToString + Random(220400).ToString;
end;

procedure TForm2204.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2204;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2204_List0 := TMyObj2204_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2204_List1 := TMyObj2204_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
