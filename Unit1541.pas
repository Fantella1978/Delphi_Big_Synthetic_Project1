...
type
  ...
  TMyObj1541_List0 = TObjectList<TMyObj1541>;

  TMyObj1541_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1541_List1 = TObjectList<TMyObj1541_1>;
...
constructor TMyObj1541_1.Create;
begin
  inherited;
  FInt := 1541 * 3;
  FTest := 'Value: ' + Random(215412).ToString + Random(154100).ToString;
end;

procedure TForm1541.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1541;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1541_List0 := TMyObj1541_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1541_List1 := TMyObj1541_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
