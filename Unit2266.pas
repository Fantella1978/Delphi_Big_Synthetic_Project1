...
type
  ...
  TMyObj2266_List0 = TObjectList<TMyObj2266>;

  TMyObj2266_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2266_List1 = TObjectList<TMyObj2266_1>;
...
constructor TMyObj2266_1.Create;
begin
  inherited;
  FInt := 2266 * 3;
  FTest := 'Value: ' + Random(222662).ToString + Random(226600).ToString;
end;

procedure TForm2266.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2266;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2266_List0 := TMyObj2266_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2266_List1 := TMyObj2266_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
