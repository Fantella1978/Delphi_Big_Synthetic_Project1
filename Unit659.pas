...
type
  ...
  TMyObj659_List0 = TObjectList<TMyObj659>;

  TMyObj659_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj659_List1 = TObjectList<TMyObj659_1>;
...
constructor TMyObj659_1.Create;
begin
  inherited;
  FInt := 659 * 3;
  FTest := 'Value: ' + Random(26592).ToString + Random(65900).ToString;
end;

procedure TForm659.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum659;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj659_List0 := TMyObj659_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj659_List1 := TMyObj659_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
