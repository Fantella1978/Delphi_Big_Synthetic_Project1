...
type
  ...
  TMyObj368_List0 = TObjectList<TMyObj368>;

  TMyObj368_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj368_List1 = TObjectList<TMyObj368_1>;
...
constructor TMyObj368_1.Create;
begin
  inherited;
  FInt := 368 * 3;
  FTest := 'Value: ' + Random(23682).ToString + Random(36800).ToString;
end;

procedure TForm368.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum368;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj368_List0 := TMyObj368_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj368_List1 := TMyObj368_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
