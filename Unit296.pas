...
type
  ...
  TMyObj296_List0 = TObjectList<TMyObj296>;

  TMyObj296_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj296_List1 = TObjectList<TMyObj296_1>;
...
constructor TMyObj296_1.Create;
begin
  inherited;
  FInt := 296 * 3;
  FTest := 'Value: ' + Random(22962).ToString + Random(29600).ToString;
end;

procedure TForm296.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum296;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj296_List0 := TMyObj296_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj296_List1 := TMyObj296_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
