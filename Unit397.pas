...
type
  ...
  TMyObj397_List0 = TObjectList<TMyObj397>;

  TMyObj397_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj397_List1 = TObjectList<TMyObj397_1>;
...
constructor TMyObj397_1.Create;
begin
  inherited;
  FInt := 397 * 3;
  FTest := 'Value: ' + Random(23972).ToString + Random(39700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj397_List0 := TMyObj397_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj397_List1 := TMyObj397_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
