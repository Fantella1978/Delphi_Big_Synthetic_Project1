...
type
  ...
  TMyObj2371_List0 = TObjectList<TMyObj2371>;

  TMyObj2371_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2371_List1 = TObjectList<TMyObj2371_1>;
...
constructor TMyObj2371_1.Create;
begin
  inherited;
  FInt := 2371 * 3;
  FTest := 'Value: ' + Random(223712).ToString + Random(237100).ToString;
end;

procedure TForm2371.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2371;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2371_List0 := TMyObj2371_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2371_List1 := TMyObj2371_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
