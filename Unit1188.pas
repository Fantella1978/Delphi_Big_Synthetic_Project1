...
type
  ...
  TMyObj1188_List0 = TObjectList<TMyObj1188>;

  TMyObj1188_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1188_List1 = TObjectList<TMyObj1188_1>;
...
constructor TMyObj1188_1.Create;
begin
  inherited;
  FInt := 1188 * 3;
  FTest := 'Value: ' + Random(211882).ToString + Random(118800).ToString;
end;

procedure TForm1188.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1188;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1188_List0 := TMyObj1188_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1188_List1 := TMyObj1188_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
