...
type
  ...
  TMyObj1743_List0 = TObjectList<TMyObj1743>;

  TMyObj1743_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1743_List1 = TObjectList<TMyObj1743_1>;
...
constructor TMyObj1743_1.Create;
begin
  inherited;
  FInt := 1743 * 3;
  FTest := 'Value: ' + Random(217432).ToString + Random(174300).ToString;
end;

procedure TForm1743.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1743;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1743_List0 := TMyObj1743_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1743_List1 := TMyObj1743_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
