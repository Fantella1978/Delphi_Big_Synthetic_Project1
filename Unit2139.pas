...
type
  ...
  TMyObj2139_List0 = TObjectList<TMyObj2139>;

  TMyObj2139_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2139_List1 = TObjectList<TMyObj2139_1>;
...
constructor TMyObj2139_1.Create;
begin
  inherited;
  FInt := 2139 * 3;
  FTest := 'Value: ' + Random(221392).ToString + Random(213900).ToString;
end;

procedure TForm2139.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2139;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2139_List0 := TMyObj2139_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2139_List1 := TMyObj2139_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
