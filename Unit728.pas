...
type
  ...
  TMyObj728_List0 = TObjectList<TMyObj728>;

  TMyObj728_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj728_List1 = TObjectList<TMyObj728_1>;
...
constructor TMyObj728_1.Create;
begin
  inherited;
  FInt := 728 * 3;
  FTest := 'Value: ' + Random(27282).ToString + Random(72800).ToString;
end;

procedure TForm728.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum728;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj728_List0 := TMyObj728_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj728_List1 := TMyObj728_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
