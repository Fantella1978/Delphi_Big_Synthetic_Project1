...
type
  ...
  TMyObj2182_List0 = TObjectList<TMyObj2182>;

  TMyObj2182_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2182_List1 = TObjectList<TMyObj2182_1>;
...
constructor TMyObj2182_1.Create;
begin
  inherited;
  FInt := 2182 * 3;
  FTest := 'Value: ' + Random(221822).ToString + Random(218200).ToString;
end;

procedure TForm2182.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2182;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2182_List0 := TMyObj2182_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2182_List1 := TMyObj2182_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
