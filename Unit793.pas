...
type
  ...
  TMyObj793_List0 = TObjectList<TMyObj793>;

  TMyObj793_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj793_List1 = TObjectList<TMyObj793_1>;
...
constructor TMyObj793_1.Create;
begin
  inherited;
  FInt := 793 * 3;
  FTest := 'Value: ' + Random(27932).ToString + Random(79300).ToString;
end;

procedure TForm793.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum793;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj793_List0 := TMyObj793_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj793_List1 := TMyObj793_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
