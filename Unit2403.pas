...
type
  ...
  TMyObj2403_List0 = TObjectList<TMyObj2403>;

  TMyObj2403_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2403_List1 = TObjectList<TMyObj2403_1>;
...
constructor TMyObj2403_1.Create;
begin
  inherited;
  FInt := 2403 * 3;
  FTest := 'Value: ' + Random(224032).ToString + Random(240300).ToString;
end;

procedure TForm2403.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2403;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2403_List0 := TMyObj2403_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2403_List1 := TMyObj2403_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
