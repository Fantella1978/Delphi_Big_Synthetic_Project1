...
type
  ...
  TMyObj1316_List0 = TObjectList<TMyObj1316>;

  TMyObj1316_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1316_List1 = TObjectList<TMyObj1316_1>;
...
constructor TMyObj1316_1.Create;
begin
  inherited;
  FInt := 1316 * 3;
  FTest := 'Value: ' + Random(213162).ToString + Random(131600).ToString;
end;

procedure TForm1316.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1316;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1316_List0 := TMyObj1316_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1316_List1 := TMyObj1316_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
