...
type
  ...
  TMyObj1057_List0 = TObjectList<TMyObj1057>;

  TMyObj1057_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1057_List1 = TObjectList<TMyObj1057_1>;
...
constructor TMyObj1057_1.Create;
begin
  inherited;
  FInt := 1057 * 3;
  FTest := 'Value: ' + Random(210572).ToString + Random(105700).ToString;
end;

procedure TForm1057.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1057;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1057_List0 := TMyObj1057_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1057_List1 := TMyObj1057_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
