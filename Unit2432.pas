...
type
  ...
  TMyObj2432_List0 = TObjectList<TMyObj2432>;

  TMyObj2432_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2432_List1 = TObjectList<TMyObj2432_1>;
...
constructor TMyObj2432_1.Create;
begin
  inherited;
  FInt := 2432 * 3;
  FTest := 'Value: ' + Random(224322).ToString + Random(243200).ToString;
end;

procedure TForm2432.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2432;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2432_List0 := TMyObj2432_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2432_List1 := TMyObj2432_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
