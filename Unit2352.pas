...
type
  ...
  TMyObj2352_List0 = TObjectList<TMyObj2352>;

  TMyObj2352_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2352_List1 = TObjectList<TMyObj2352_1>;
...
constructor TMyObj2352_1.Create;
begin
  inherited;
  FInt := 2352 * 3;
  FTest := 'Value: ' + Random(223522).ToString + Random(235200).ToString;
end;

procedure TForm2352.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2352;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2352_List0 := TMyObj2352_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2352_List1 := TMyObj2352_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
