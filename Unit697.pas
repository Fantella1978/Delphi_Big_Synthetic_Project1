...
type
  ...
  TMyObj697_List0 = TObjectList<TMyObj697>;

  TMyObj697_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj697_List1 = TObjectList<TMyObj697_1>;
...
constructor TMyObj697_1.Create;
begin
  inherited;
  FInt := 697 * 3;
  FTest := 'Value: ' + Random(26972).ToString + Random(69700).ToString;
end;

procedure TForm697.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum697;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj697_List0 := TMyObj697_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj697_List1 := TMyObj697_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
