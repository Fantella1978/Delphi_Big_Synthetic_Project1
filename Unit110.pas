...
type
  ...
  TMyObj110_List0 = TObjectList<TMyObj110>;

  TMyObj110_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj110_List1 = TObjectList<TMyObj110_1>;
...
constructor TMyObj110_1.Create;
begin
  inherited;
  FInt := 110 * 3;
  FTest := 'Value: ' + Random(21102).ToString + Random(11000).ToString;
end;

procedure TForm110.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum110;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj110_List0 := TMyObj110_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj110_List1 := TMyObj110_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
