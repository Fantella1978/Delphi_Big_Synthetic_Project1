...
type
  ...
  TMyObj1501_List0 = TObjectList<TMyObj1501>;

  TMyObj1501_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1501_List1 = TObjectList<TMyObj1501_1>;
...
constructor TMyObj1501_1.Create;
begin
  inherited;
  FInt := 1501 * 3;
  FTest := 'Value: ' + Random(215012).ToString + Random(150100).ToString;
end;

procedure TForm1501.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1501;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1501_List0 := TMyObj1501_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1501_List1 := TMyObj1501_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
