...
type
  ...
  TMyObj2369_List0 = TObjectList<TMyObj2369>;

  TMyObj2369_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2369_List1 = TObjectList<TMyObj2369_1>;
...
constructor TMyObj2369_1.Create;
begin
  inherited;
  FInt := 2369 * 3;
  FTest := 'Value: ' + Random(223692).ToString + Random(236900).ToString;
end;

procedure TForm2369.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2369;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2369_List0 := TMyObj2369_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2369_List1 := TMyObj2369_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
