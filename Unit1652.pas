...
type
  ...
  TMyObj1652_List0 = TObjectList<TMyObj1652>;

  TMyObj1652_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1652_List1 = TObjectList<TMyObj1652_1>;
...
constructor TMyObj1652_1.Create;
begin
  inherited;
  FInt := 1652 * 3;
  FTest := 'Value: ' + Random(216522).ToString + Random(165200).ToString;
end;

procedure TForm1652.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1652;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1652_List0 := TMyObj1652_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1652_List1 := TMyObj1652_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
