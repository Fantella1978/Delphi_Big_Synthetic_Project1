...
type
  ...
  TMyObj2192_List0 = TObjectList<TMyObj2192>;

  TMyObj2192_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2192_List1 = TObjectList<TMyObj2192_1>;
...
constructor TMyObj2192_1.Create;
begin
  inherited;
  FInt := 2192 * 3;
  FTest := 'Value: ' + Random(221922).ToString + Random(219200).ToString;
end;

procedure TForm2192.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2192;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2192_List0 := TMyObj2192_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2192_List1 := TMyObj2192_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
