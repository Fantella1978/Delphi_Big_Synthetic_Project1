...
type
  ...
  TMyObj844_List0 = TObjectList<TMyObj844>;

  TMyObj844_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj844_List1 = TObjectList<TMyObj844_1>;
...
constructor TMyObj844_1.Create;
begin
  inherited;
  FInt := 844 * 3;
  FTest := 'Value: ' + Random(28442).ToString + Random(84400).ToString;
end;

procedure TForm844.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum844;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj844_List0 := TMyObj844_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj844_List1 := TMyObj844_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
