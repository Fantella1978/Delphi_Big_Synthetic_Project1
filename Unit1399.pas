...
type
  ...
  TMyObj1399_List0 = TObjectList<TMyObj1399>;

  TMyObj1399_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1399_List1 = TObjectList<TMyObj1399_1>;
...
constructor TMyObj1399_1.Create;
begin
  inherited;
  FInt := 1399 * 3;
  FTest := 'Value: ' + Random(213992).ToString + Random(139900).ToString;
end;

procedure TForm1399.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1399;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1399_List0 := TMyObj1399_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1399_List1 := TMyObj1399_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
