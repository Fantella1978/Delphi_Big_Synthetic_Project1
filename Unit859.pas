...
type
  ...
  TMyObj859_List0 = TObjectList<TMyObj859>;

  TMyObj859_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj859_List1 = TObjectList<TMyObj859_1>;
...
constructor TMyObj859_1.Create;
begin
  inherited;
  FInt := 859 * 3;
  FTest := 'Value: ' + Random(28592).ToString + Random(85900).ToString;
end;

procedure TForm859.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum859;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj859_List0 := TMyObj859_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj859_List1 := TMyObj859_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
