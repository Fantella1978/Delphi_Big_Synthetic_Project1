...
type
  ...
  TMyObj2479_List0 = TObjectList<TMyObj2479>;

  TMyObj2479_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2479_List1 = TObjectList<TMyObj2479_1>;
...
constructor TMyObj2479_1.Create;
begin
  inherited;
  FInt := 2479 * 3;
  FTest := 'Value: ' + Random(224792).ToString + Random(247900).ToString;
end;

procedure TForm2479.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2479;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2479_List0 := TMyObj2479_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2479_List1 := TMyObj2479_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
