...
type
  ...
  TMyObj831_List0 = TObjectList<TMyObj831>;

  TMyObj831_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj831_List1 = TObjectList<TMyObj831_1>;
...
constructor TMyObj831_1.Create;
begin
  inherited;
  FInt := 831 * 3;
  FTest := 'Value: ' + Random(28312).ToString + Random(83100).ToString;
end;

procedure TForm831.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum831;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj831_List0 := TMyObj831_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj831_List1 := TMyObj831_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
