...
type
  ...
  TMyObj1394_List0 = TObjectList<TMyObj1394>;

  TMyObj1394_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1394_List1 = TObjectList<TMyObj1394_1>;
...
constructor TMyObj1394_1.Create;
begin
  inherited;
  FInt := 1394 * 3;
  FTest := 'Value: ' + Random(213942).ToString + Random(139400).ToString;
end;

procedure TForm1394.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1394;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1394_List0 := TMyObj1394_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1394_List1 := TMyObj1394_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
