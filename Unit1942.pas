...
type
  ...
  TMyObj1942_List0 = TObjectList<TMyObj1942>;

  TMyObj1942_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1942_List1 = TObjectList<TMyObj1942_1>;
...
constructor TMyObj1942_1.Create;
begin
  inherited;
  FInt := 1942 * 3;
  FTest := 'Value: ' + Random(219422).ToString + Random(194200).ToString;
end;

procedure TForm1942.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1942;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1942_List0 := TMyObj1942_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1942_List1 := TMyObj1942_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
