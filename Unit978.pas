...
type
  ...
  TMyObj978_List0 = TObjectList<TMyObj978>;

  TMyObj978_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj978_List1 = TObjectList<TMyObj978_1>;
...
constructor TMyObj978_1.Create;
begin
  inherited;
  FInt := 978 * 3;
  FTest := 'Value: ' + Random(29782).ToString + Random(97800).ToString;
end;

procedure TForm978.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum978;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj978_List0 := TMyObj978_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj978_List1 := TMyObj978_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
