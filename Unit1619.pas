...
type
  ...
  TMyObj1619_List0 = TObjectList<TMyObj1619>;

  TMyObj1619_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1619_List1 = TObjectList<TMyObj1619_1>;
...
constructor TMyObj1619_1.Create;
begin
  inherited;
  FInt := 1619 * 3;
  FTest := 'Value: ' + Random(216192).ToString + Random(161900).ToString;
end;

procedure TForm1619.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1619;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1619_List0 := TMyObj1619_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1619_List1 := TMyObj1619_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
