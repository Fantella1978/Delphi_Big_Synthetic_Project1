...
type
  ...
  TMyObj1429_List0 = TObjectList<TMyObj1429>;

  TMyObj1429_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1429_List1 = TObjectList<TMyObj1429_1>;
...
constructor TMyObj1429_1.Create;
begin
  inherited;
  FInt := 1429 * 3;
  FTest := 'Value: ' + Random(214292).ToString + Random(142900).ToString;
end;

procedure TForm1429.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1429;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1429_List0 := TMyObj1429_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1429_List1 := TMyObj1429_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
