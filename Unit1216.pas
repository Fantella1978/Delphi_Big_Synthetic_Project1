...
type
  ...
  TMyObj1216_List0 = TObjectList<TMyObj1216>;

  TMyObj1216_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1216_List1 = TObjectList<TMyObj1216_1>;
...
constructor TMyObj1216_1.Create;
begin
  inherited;
  FInt := 1216 * 3;
  FTest := 'Value: ' + Random(212162).ToString + Random(121600).ToString;
end;

procedure TForm1216.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1216;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1216_List0 := TMyObj1216_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1216_List1 := TMyObj1216_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
