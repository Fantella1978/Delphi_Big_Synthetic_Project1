...
type
  ...
  TMyObj1927_List0 = TObjectList<TMyObj1927>;

  TMyObj1927_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1927_List1 = TObjectList<TMyObj1927_1>;
...
constructor TMyObj1927_1.Create;
begin
  inherited;
  FInt := 1927 * 3;
  FTest := 'Value: ' + Random(219272).ToString + Random(192700).ToString;
end;

procedure TForm1927.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1927;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1927_List0 := TMyObj1927_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1927_List1 := TMyObj1927_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
