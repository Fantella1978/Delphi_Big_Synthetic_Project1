...
type
  ...
  TMyObj619_List0 = TObjectList<TMyObj619>;

  TMyObj619_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj619_List1 = TObjectList<TMyObj619_1>;
...
constructor TMyObj619_1.Create;
begin
  inherited;
  FInt := 619 * 3;
  FTest := 'Value: ' + Random(26192).ToString + Random(61900).ToString;
end;

procedure TForm619.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum619;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj619_List0 := TMyObj619_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj619_List1 := TMyObj619_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
