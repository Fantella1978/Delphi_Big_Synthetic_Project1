...
type
  ...
  TMyObj489_List0 = TObjectList<TMyObj489>;

  TMyObj489_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj489_List1 = TObjectList<TMyObj489_1>;
...
constructor TMyObj489_1.Create;
begin
  inherited;
  FInt := 489 * 3;
  FTest := 'Value: ' + Random(24892).ToString + Random(48900).ToString;
end;

procedure TForm489.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum489;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj489_List0 := TMyObj489_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj489_List1 := TMyObj489_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
