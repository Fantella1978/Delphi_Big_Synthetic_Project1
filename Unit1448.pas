...
type
  ...
  TMyObj1448_List0 = TObjectList<TMyObj1448>;

  TMyObj1448_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1448_List1 = TObjectList<TMyObj1448_1>;
...
constructor TMyObj1448_1.Create;
begin
  inherited;
  FInt := 1448 * 3;
  FTest := 'Value: ' + Random(214482).ToString + Random(144800).ToString;
end;

procedure TForm1448.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1448;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1448_List0 := TMyObj1448_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1448_List1 := TMyObj1448_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
