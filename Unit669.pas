...
type
  ...
  TMyObj669_List0 = TObjectList<TMyObj669>;

  TMyObj669_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj669_List1 = TObjectList<TMyObj669_1>;
...
constructor TMyObj669_1.Create;
begin
  inherited;
  FInt := 669 * 3;
  FTest := 'Value: ' + Random(26692).ToString + Random(66900).ToString;
end;

procedure TForm669.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum669;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj669_List0 := TMyObj669_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj669_List1 := TMyObj669_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
