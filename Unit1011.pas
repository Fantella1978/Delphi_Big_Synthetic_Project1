...
type
  ...
  TMyObj1011_List0 = TObjectList<TMyObj1011>;

  TMyObj1011_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1011_List1 = TObjectList<TMyObj1011_1>;
...
constructor TMyObj1011_1.Create;
begin
  inherited;
  FInt := 1011 * 3;
  FTest := 'Value: ' + Random(210112).ToString + Random(101100).ToString;
end;

procedure TForm1011.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1011;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1011_List0 := TMyObj1011_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1011_List1 := TMyObj1011_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
