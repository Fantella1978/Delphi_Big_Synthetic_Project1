...
type
  ...
  TMyObj2366_List0 = TObjectList<TMyObj2366>;

  TMyObj2366_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2366_List1 = TObjectList<TMyObj2366_1>;
...
constructor TMyObj2366_1.Create;
begin
  inherited;
  FInt := 2366 * 3;
  FTest := 'Value: ' + Random(223662).ToString + Random(236600).ToString;
end;

procedure TForm2366.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2366;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2366_List0 := TMyObj2366_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2366_List1 := TMyObj2366_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
