...
type
  ...
  TMyObj1858_List0 = TObjectList<TMyObj1858>;

  TMyObj1858_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1858_List1 = TObjectList<TMyObj1858_1>;
...
constructor TMyObj1858_1.Create;
begin
  inherited;
  FInt := 1858 * 3;
  FTest := 'Value: ' + Random(218582).ToString + Random(185800).ToString;
end;

procedure TForm1858.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1858;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1858_List0 := TMyObj1858_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1858_List1 := TMyObj1858_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
