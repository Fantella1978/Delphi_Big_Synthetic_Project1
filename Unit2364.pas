...
type
  ...
  TMyObj2364_List0 = TObjectList<TMyObj2364>;

  TMyObj2364_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2364_List1 = TObjectList<TMyObj2364_1>;
...
constructor TMyObj2364_1.Create;
begin
  inherited;
  FInt := 2364 * 3;
  FTest := 'Value: ' + Random(223642).ToString + Random(236400).ToString;
end;

procedure TForm2364.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2364;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2364_List0 := TMyObj2364_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2364_List1 := TMyObj2364_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
