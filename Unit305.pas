...
type
  ...
  TMyObj305_List0 = TObjectList<TMyObj305>;

  TMyObj305_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj305_List1 = TObjectList<TMyObj305_1>;
...
constructor TMyObj305_1.Create;
begin
  inherited;
  FInt := 305 * 3;
  FTest := 'Value: ' + Random(23052).ToString + Random(30500).ToString;
end;

procedure TForm305.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum305;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj305_List0 := TMyObj305_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj305_List1 := TMyObj305_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
