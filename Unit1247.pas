...
type
  ...
  TMyObj1247_List0 = TObjectList<TMyObj1247>;

  TMyObj1247_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1247_List1 = TObjectList<TMyObj1247_1>;
...
constructor TMyObj1247_1.Create;
begin
  inherited;
  FInt := 1247 * 3;
  FTest := 'Value: ' + Random(212472).ToString + Random(124700).ToString;
end;

procedure TForm1247.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1247;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1247_List0 := TMyObj1247_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1247_List1 := TMyObj1247_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
