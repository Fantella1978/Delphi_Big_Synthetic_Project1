...
type
  ...
  TMyObj123_List0 = TObjectList<TMyObj123>;

  TMyObj123_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj123_List1 = TObjectList<TMyObj123_1>;
...
constructor TMyObj123_1.Create;
begin
  inherited;
  FInt := 123 * 3;
  FTest := 'Value: ' + Random(21232).ToString + Random(12300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj123_List0 := TMyObj123_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj123_List1 := TMyObj123_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
