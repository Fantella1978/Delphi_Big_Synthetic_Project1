...
type
  ...
  TMyObj1277_List0 = TObjectList<TMyObj1277>;

  TMyObj1277_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1277_List1 = TObjectList<TMyObj1277_1>;
...
constructor TMyObj1277_1.Create;
begin
  inherited;
  FInt := 1277 * 3;
  FTest := 'Value: ' + Random(212772).ToString + Random(127700).ToString;
end;

procedure TForm1277.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1277;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1277_List0 := TMyObj1277_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1277_List1 := TMyObj1277_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
