...
type
  ...
  TMyObj970_List0 = TObjectList<TMyObj970>;

  TMyObj970_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj970_List1 = TObjectList<TMyObj970_1>;
...
constructor TMyObj970_1.Create;
begin
  inherited;
  FInt := 970 * 3;
  FTest := 'Value: ' + Random(29702).ToString + Random(97000).ToString;
end;

procedure TForm970.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum970;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj970_List0 := TMyObj970_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj970_List1 := TMyObj970_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
