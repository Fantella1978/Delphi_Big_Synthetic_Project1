...
type
  ...
  TMyObj1432_List0 = TObjectList<TMyObj1432>;

  TMyObj1432_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1432_List1 = TObjectList<TMyObj1432_1>;
...
constructor TMyObj1432_1.Create;
begin
  inherited;
  FInt := 1432 * 3;
  FTest := 'Value: ' + Random(214322).ToString + Random(143200).ToString;
end;

procedure TForm1432.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1432;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1432_List0 := TMyObj1432_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1432_List1 := TMyObj1432_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
