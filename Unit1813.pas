...
type
  ...
  TMyObj1813_List0 = TObjectList<TMyObj1813>;

  TMyObj1813_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1813_List1 = TObjectList<TMyObj1813_1>;
...
constructor TMyObj1813_1.Create;
begin
  inherited;
  FInt := 1813 * 3;
  FTest := 'Value: ' + Random(218132).ToString + Random(181300).ToString;
end;

procedure TForm1813.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1813;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1813_List0 := TMyObj1813_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1813_List1 := TMyObj1813_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
