...
type
  ...
  TMyObj1809_List0 = TObjectList<TMyObj1809>;

  TMyObj1809_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1809_List1 = TObjectList<TMyObj1809_1>;
...
constructor TMyObj1809_1.Create;
begin
  inherited;
  FInt := 1809 * 3;
  FTest := 'Value: ' + Random(218092).ToString + Random(180900).ToString;
end;

procedure TForm1809.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1809;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1809_List0 := TMyObj1809_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1809_List1 := TMyObj1809_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
