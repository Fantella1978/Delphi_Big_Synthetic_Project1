...
type
  ...
  TMyObj821_List0 = TObjectList<TMyObj821>;

  TMyObj821_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj821_List1 = TObjectList<TMyObj821_1>;
...
constructor TMyObj821_1.Create;
begin
  inherited;
  FInt := 821 * 3;
  FTest := 'Value: ' + Random(28212).ToString + Random(82100).ToString;
end;

procedure TForm821.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum821;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj821_List0 := TMyObj821_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj821_List1 := TMyObj821_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
