...
type
  ...
  TMyObj1308_List0 = TObjectList<TMyObj1308>;

  TMyObj1308_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1308_List1 = TObjectList<TMyObj1308_1>;
...
constructor TMyObj1308_1.Create;
begin
  inherited;
  FInt := 1308 * 3;
  FTest := 'Value: ' + Random(213082).ToString + Random(130800).ToString;
end;

procedure TForm1308.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1308;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1308_List0 := TMyObj1308_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1308_List1 := TMyObj1308_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
