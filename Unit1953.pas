...
type
  ...
  TMyObj1953_List0 = TObjectList<TMyObj1953>;

  TMyObj1953_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1953_List1 = TObjectList<TMyObj1953_1>;
...
constructor TMyObj1953_1.Create;
begin
  inherited;
  FInt := 1953 * 3;
  FTest := 'Value: ' + Random(219532).ToString + Random(195300).ToString;
end;

procedure TForm1953.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1953;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1953_List0 := TMyObj1953_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1953_List1 := TMyObj1953_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
