...
type
  ...
  TMyObj1708_List0 = TObjectList<TMyObj1708>;

  TMyObj1708_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1708_List1 = TObjectList<TMyObj1708_1>;
...
constructor TMyObj1708_1.Create;
begin
  inherited;
  FInt := 1708 * 3;
  FTest := 'Value: ' + Random(217082).ToString + Random(170800).ToString;
end;

procedure TForm1708.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1708;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1708_List0 := TMyObj1708_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1708_List1 := TMyObj1708_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
