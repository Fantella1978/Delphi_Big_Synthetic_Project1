...
type
  ...
  TMyObj2296_List0 = TObjectList<TMyObj2296>;

  TMyObj2296_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2296_List1 = TObjectList<TMyObj2296_1>;
...
constructor TMyObj2296_1.Create;
begin
  inherited;
  FInt := 2296 * 3;
  FTest := 'Value: ' + Random(222962).ToString + Random(229600).ToString;
end;

procedure TForm2296.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2296;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2296_List0 := TMyObj2296_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2296_List1 := TMyObj2296_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
