...
type
  ...
  TMyObj54_List0 = TObjectList<TMyObj54>;

  TMyObj54_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj54_List1 = TObjectList<TMyObj54_1>;
...
constructor TMyObj54_1.Create;
begin
  inherited;
  FInt := 54 * 3;
  FTest := 'Value: ' + Random(2542).ToString + Random(5400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj54_List0 := TMyObj54_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj54_List1 := TMyObj54_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
