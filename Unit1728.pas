...
type
  ...
  TMyObj1728_List0 = TObjectList<TMyObj1728>;

  TMyObj1728_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1728_List1 = TObjectList<TMyObj1728_1>;
...
constructor TMyObj1728_1.Create;
begin
  inherited;
  FInt := 1728 * 3;
  FTest := 'Value: ' + Random(217282).ToString + Random(172800).ToString;
end;

procedure TForm1728.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1728;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1728_List0 := TMyObj1728_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1728_List1 := TMyObj1728_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
