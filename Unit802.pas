...
type
  ...
  TMyObj802_List0 = TObjectList<TMyObj802>;

  TMyObj802_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj802_List1 = TObjectList<TMyObj802_1>;
...
constructor TMyObj802_1.Create;
begin
  inherited;
  FInt := 802 * 3;
  FTest := 'Value: ' + Random(28022).ToString + Random(80200).ToString;
end;

procedure TForm802.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum802;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj802_List0 := TMyObj802_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj802_List1 := TMyObj802_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
