...
type
  ...
  TMyObj820_List0 = TObjectList<TMyObj820>;

  TMyObj820_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj820_List1 = TObjectList<TMyObj820_1>;
...
constructor TMyObj820_1.Create;
begin
  inherited;
  FInt := 820 * 3;
  FTest := 'Value: ' + Random(28202).ToString + Random(82000).ToString;
end;

procedure TForm820.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum820;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj820_List0 := TMyObj820_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj820_List1 := TMyObj820_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
