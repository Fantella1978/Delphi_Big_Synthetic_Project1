...
type
  ...
  TMyObj343_List0 = TObjectList<TMyObj343>;

  TMyObj343_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj343_List1 = TObjectList<TMyObj343_1>;
...
constructor TMyObj343_1.Create;
begin
  inherited;
  FInt := 343 * 3;
  FTest := 'Value: ' + Random(23432).ToString + Random(34300).ToString;
end;

procedure TForm343.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum343;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj343_List0 := TMyObj343_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj343_List1 := TMyObj343_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
