...
type
  ...
  TMyObj1495_List0 = TObjectList<TMyObj1495>;

  TMyObj1495_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1495_List1 = TObjectList<TMyObj1495_1>;
...
constructor TMyObj1495_1.Create;
begin
  inherited;
  FInt := 1495 * 3;
  FTest := 'Value: ' + Random(214952).ToString + Random(149500).ToString;
end;

procedure TForm1495.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1495;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1495_List0 := TMyObj1495_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1495_List1 := TMyObj1495_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
