...
type
  ...
  TMyObj58_List0 = TObjectList<TMyObj58>;

  TMyObj58_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj58_List1 = TObjectList<TMyObj58_1>;
...
constructor TMyObj58_1.Create;
begin
  inherited;
  FInt := 58 * 3;
  FTest := 'Value: ' + Random(2582).ToString + Random(5800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj58_List0 := TMyObj58_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj58_List1 := TMyObj58_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
