...
type
  ...
  TMyObj80_List0 = TObjectList<TMyObj80>;

  TMyObj80_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj80_List1 = TObjectList<TMyObj80_1>;
...
constructor TMyObj80_1.Create;
begin
  inherited;
  FInt := 80 * 3;
  FTest := 'Value: ' + Random(2802).ToString + Random(8000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj80_List0 := TMyObj80_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj80_List1 := TMyObj80_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
