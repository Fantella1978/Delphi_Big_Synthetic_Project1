...
type
  ...
  TMyObj155_List0 = TObjectList<TMyObj155>;

  TMyObj155_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj155_List1 = TObjectList<TMyObj155_1>;
...
constructor TMyObj155_1.Create;
begin
  inherited;
  FInt := 155 * 3;
  FTest := 'Value: ' + Random(21552).ToString + Random(15500).ToString;
end;

procedure TForm155.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum155;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj155_List0 := TMyObj155_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj155_List1 := TMyObj155_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
