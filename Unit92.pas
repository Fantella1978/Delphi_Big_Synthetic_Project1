...
type
  ...
  TMyObj92_List0 = TObjectList<TMyObj92>;

  TMyObj92_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj92_List1 = TObjectList<TMyObj92_1>;
...
constructor TMyObj92_1.Create;
begin
  inherited;
  FInt := 92 * 3;
  FTest := 'Value: ' + Random(2922).ToString + Random(9200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj92_List0 := TMyObj92_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj92_List1 := TMyObj92_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
