...
type
  ...
  TMyObj1307_List0 = TObjectList<TMyObj1307>;

  TMyObj1307_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1307_List1 = TObjectList<TMyObj1307_1>;
...
constructor TMyObj1307_1.Create;
begin
  inherited;
  FInt := 1307 * 3;
  FTest := 'Value: ' + Random(213072).ToString + Random(130700).ToString;
end;

procedure TForm1307.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1307;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1307_List0 := TMyObj1307_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1307_List1 := TMyObj1307_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
