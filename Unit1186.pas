...
type
  ...
  TMyObj1186_List0 = TObjectList<TMyObj1186>;

  TMyObj1186_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1186_List1 = TObjectList<TMyObj1186_1>;
...
constructor TMyObj1186_1.Create;
begin
  inherited;
  FInt := 1186 * 3;
  FTest := 'Value: ' + Random(211862).ToString + Random(118600).ToString;
end;

procedure TForm1186.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1186;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1186_List0 := TMyObj1186_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1186_List1 := TMyObj1186_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
