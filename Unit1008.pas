...
type
  ...
  TMyObj1008_List0 = TObjectList<TMyObj1008>;

  TMyObj1008_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1008_List1 = TObjectList<TMyObj1008_1>;
...
constructor TMyObj1008_1.Create;
begin
  inherited;
  FInt := 1008 * 3;
  FTest := 'Value: ' + Random(210082).ToString + Random(100800).ToString;
end;

procedure TForm1008.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1008;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1008_List0 := TMyObj1008_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1008_List1 := TMyObj1008_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
