...
type
  ...
  TMyObj534_List0 = TObjectList<TMyObj534>;

  TMyObj534_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj534_List1 = TObjectList<TMyObj534_1>;
...
constructor TMyObj534_1.Create;
begin
  inherited;
  FInt := 534 * 3;
  FTest := 'Value: ' + Random(25342).ToString + Random(53400).ToString;
end;

procedure TForm534.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum534;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj534_List0 := TMyObj534_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj534_List1 := TMyObj534_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
