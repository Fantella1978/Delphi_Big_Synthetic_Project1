...
type
  ...
  TMyObj2346_List0 = TObjectList<TMyObj2346>;

  TMyObj2346_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2346_List1 = TObjectList<TMyObj2346_1>;
...
constructor TMyObj2346_1.Create;
begin
  inherited;
  FInt := 2346 * 3;
  FTest := 'Value: ' + Random(223462).ToString + Random(234600).ToString;
end;

procedure TForm2346.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2346;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2346_List0 := TMyObj2346_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2346_List1 := TMyObj2346_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
