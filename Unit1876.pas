...
type
  ...
  TMyObj1876_List0 = TObjectList<TMyObj1876>;

  TMyObj1876_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1876_List1 = TObjectList<TMyObj1876_1>;
...
constructor TMyObj1876_1.Create;
begin
  inherited;
  FInt := 1876 * 3;
  FTest := 'Value: ' + Random(218762).ToString + Random(187600).ToString;
end;

procedure TForm1876.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1876;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1876_List0 := TMyObj1876_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1876_List1 := TMyObj1876_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
