...
type
  ...
  TMyObj2053_List0 = TObjectList<TMyObj2053>;

  TMyObj2053_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2053_List1 = TObjectList<TMyObj2053_1>;
...
constructor TMyObj2053_1.Create;
begin
  inherited;
  FInt := 2053 * 3;
  FTest := 'Value: ' + Random(220532).ToString + Random(205300).ToString;
end;

procedure TForm2053.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2053;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2053_List0 := TMyObj2053_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2053_List1 := TMyObj2053_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
