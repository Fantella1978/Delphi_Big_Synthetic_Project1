...
type
  ...
  TMyObj550_List0 = TObjectList<TMyObj550>;

  TMyObj550_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj550_List1 = TObjectList<TMyObj550_1>;
...
constructor TMyObj550_1.Create;
begin
  inherited;
  FInt := 550 * 3;
  FTest := 'Value: ' + Random(25502).ToString + Random(55000).ToString;
end;

procedure TForm550.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum550;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj550_List0 := TMyObj550_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj550_List1 := TMyObj550_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
