...
type
  ...
  TMyObj2013_List0 = TObjectList<TMyObj2013>;

  TMyObj2013_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2013_List1 = TObjectList<TMyObj2013_1>;
...
constructor TMyObj2013_1.Create;
begin
  inherited;
  FInt := 2013 * 3;
  FTest := 'Value: ' + Random(220132).ToString + Random(201300).ToString;
end;

procedure TForm2013.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2013;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2013_List0 := TMyObj2013_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2013_List1 := TMyObj2013_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
