...
type
  ...
  TMyObj1329_List0 = TObjectList<TMyObj1329>;

  TMyObj1329_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1329_List1 = TObjectList<TMyObj1329_1>;
...
constructor TMyObj1329_1.Create;
begin
  inherited;
  FInt := 1329 * 3;
  FTest := 'Value: ' + Random(213292).ToString + Random(132900).ToString;
end;

procedure TForm1329.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1329;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1329_List0 := TMyObj1329_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1329_List1 := TMyObj1329_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
