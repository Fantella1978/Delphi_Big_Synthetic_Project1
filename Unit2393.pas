...
type
  ...
  TMyObj2393_List0 = TObjectList<TMyObj2393>;

  TMyObj2393_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2393_List1 = TObjectList<TMyObj2393_1>;
...
constructor TMyObj2393_1.Create;
begin
  inherited;
  FInt := 2393 * 3;
  FTest := 'Value: ' + Random(223932).ToString + Random(239300).ToString;
end;

procedure TForm2393.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2393;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2393_List0 := TMyObj2393_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2393_List1 := TMyObj2393_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
