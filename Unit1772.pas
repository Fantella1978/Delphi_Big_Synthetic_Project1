...
type
  ...
  TMyObj1772_List0 = TObjectList<TMyObj1772>;

  TMyObj1772_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1772_List1 = TObjectList<TMyObj1772_1>;
...
constructor TMyObj1772_1.Create;
begin
  inherited;
  FInt := 1772 * 3;
  FTest := 'Value: ' + Random(217722).ToString + Random(177200).ToString;
end;

procedure TForm1772.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1772;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1772_List0 := TMyObj1772_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1772_List1 := TMyObj1772_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
