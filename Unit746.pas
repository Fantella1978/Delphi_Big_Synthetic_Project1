...
type
  ...
  TMyObj746_List0 = TObjectList<TMyObj746>;

  TMyObj746_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj746_List1 = TObjectList<TMyObj746_1>;
...
constructor TMyObj746_1.Create;
begin
  inherited;
  FInt := 746 * 3;
  FTest := 'Value: ' + Random(27462).ToString + Random(74600).ToString;
end;

procedure TForm746.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum746;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj746_List0 := TMyObj746_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj746_List1 := TMyObj746_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
