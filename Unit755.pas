...
type
  ...
  TMyObj755_List0 = TObjectList<TMyObj755>;

  TMyObj755_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj755_List1 = TObjectList<TMyObj755_1>;
...
constructor TMyObj755_1.Create;
begin
  inherited;
  FInt := 755 * 3;
  FTest := 'Value: ' + Random(27552).ToString + Random(75500).ToString;
end;

procedure TForm755.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum755;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj755_List0 := TMyObj755_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj755_List1 := TMyObj755_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
