...
type
  ...
  TMyObj850_List0 = TObjectList<TMyObj850>;

  TMyObj850_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj850_List1 = TObjectList<TMyObj850_1>;
...
constructor TMyObj850_1.Create;
begin
  inherited;
  FInt := 850 * 3;
  FTest := 'Value: ' + Random(28502).ToString + Random(85000).ToString;
end;

procedure TForm850.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum850;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj850_List0 := TMyObj850_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj850_List1 := TMyObj850_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
