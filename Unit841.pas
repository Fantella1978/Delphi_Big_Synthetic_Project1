...
type
  ...
  TMyObj841_List0 = TObjectList<TMyObj841>;

  TMyObj841_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj841_List1 = TObjectList<TMyObj841_1>;
...
constructor TMyObj841_1.Create;
begin
  inherited;
  FInt := 841 * 3;
  FTest := 'Value: ' + Random(28412).ToString + Random(84100).ToString;
end;

procedure TForm841.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum841;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj841_List0 := TMyObj841_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj841_List1 := TMyObj841_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
