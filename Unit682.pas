...
type
  ...
  TMyObj682_List0 = TObjectList<TMyObj682>;

  TMyObj682_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj682_List1 = TObjectList<TMyObj682_1>;
...
constructor TMyObj682_1.Create;
begin
  inherited;
  FInt := 682 * 3;
  FTest := 'Value: ' + Random(26822).ToString + Random(68200).ToString;
end;

procedure TForm682.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum682;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj682_List0 := TMyObj682_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj682_List1 := TMyObj682_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
