...
type
  ...
  TMyObj1751_List0 = TObjectList<TMyObj1751>;

  TMyObj1751_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1751_List1 = TObjectList<TMyObj1751_1>;
...
constructor TMyObj1751_1.Create;
begin
  inherited;
  FInt := 1751 * 3;
  FTest := 'Value: ' + Random(217512).ToString + Random(175100).ToString;
end;

procedure TForm1751.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1751;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1751_List0 := TMyObj1751_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1751_List1 := TMyObj1751_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
