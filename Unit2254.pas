...
type
  ...
  TMyObj2254_List0 = TObjectList<TMyObj2254>;

  TMyObj2254_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2254_List1 = TObjectList<TMyObj2254_1>;
...
constructor TMyObj2254_1.Create;
begin
  inherited;
  FInt := 2254 * 3;
  FTest := 'Value: ' + Random(222542).ToString + Random(225400).ToString;
end;

procedure TForm2254.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2254;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2254_List0 := TMyObj2254_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2254_List1 := TMyObj2254_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
