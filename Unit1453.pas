...
type
  ...
  TMyObj1453_List0 = TObjectList<TMyObj1453>;

  TMyObj1453_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1453_List1 = TObjectList<TMyObj1453_1>;
...
constructor TMyObj1453_1.Create;
begin
  inherited;
  FInt := 1453 * 3;
  FTest := 'Value: ' + Random(214532).ToString + Random(145300).ToString;
end;

procedure TForm1453.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1453;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1453_List0 := TMyObj1453_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1453_List1 := TMyObj1453_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
