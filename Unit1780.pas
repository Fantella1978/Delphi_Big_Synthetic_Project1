...
type
  ...
  TMyObj1780_List0 = TObjectList<TMyObj1780>;

  TMyObj1780_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1780_List1 = TObjectList<TMyObj1780_1>;
...
constructor TMyObj1780_1.Create;
begin
  inherited;
  FInt := 1780 * 3;
  FTest := 'Value: ' + Random(217802).ToString + Random(178000).ToString;
end;

procedure TForm1780.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1780;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1780_List0 := TMyObj1780_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1780_List1 := TMyObj1780_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
