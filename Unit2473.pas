...
type
  ...
  TMyObj2473_List0 = TObjectList<TMyObj2473>;

  TMyObj2473_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2473_List1 = TObjectList<TMyObj2473_1>;
...
constructor TMyObj2473_1.Create;
begin
  inherited;
  FInt := 2473 * 3;
  FTest := 'Value: ' + Random(224732).ToString + Random(247300).ToString;
end;

procedure TForm2473.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2473;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2473_List0 := TMyObj2473_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2473_List1 := TMyObj2473_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
