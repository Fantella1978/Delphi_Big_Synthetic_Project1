...
type
  ...
  TMyObj1119_List0 = TObjectList<TMyObj1119>;

  TMyObj1119_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1119_List1 = TObjectList<TMyObj1119_1>;
...
constructor TMyObj1119_1.Create;
begin
  inherited;
  FInt := 1119 * 3;
  FTest := 'Value: ' + Random(211192).ToString + Random(111900).ToString;
end;

procedure TForm1119.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1119;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1119_List0 := TMyObj1119_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1119_List1 := TMyObj1119_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
