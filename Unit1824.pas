...
type
  ...
  TMyObj1824_List0 = TObjectList<TMyObj1824>;

  TMyObj1824_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1824_List1 = TObjectList<TMyObj1824_1>;
...
constructor TMyObj1824_1.Create;
begin
  inherited;
  FInt := 1824 * 3;
  FTest := 'Value: ' + Random(218242).ToString + Random(182400).ToString;
end;

procedure TForm1824.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1824;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1824_List0 := TMyObj1824_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1824_List1 := TMyObj1824_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
