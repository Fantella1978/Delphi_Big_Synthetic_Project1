...
type
  ...
  TMyObj1035_List0 = TObjectList<TMyObj1035>;

  TMyObj1035_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1035_List1 = TObjectList<TMyObj1035_1>;
...
constructor TMyObj1035_1.Create;
begin
  inherited;
  FInt := 1035 * 3;
  FTest := 'Value: ' + Random(210352).ToString + Random(103500).ToString;
end;

procedure TForm1035.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1035;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1035_List0 := TMyObj1035_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1035_List1 := TMyObj1035_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
