...
type
  ...
  TMyObj366_List0 = TObjectList<TMyObj366>;

  TMyObj366_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj366_List1 = TObjectList<TMyObj366_1>;
...
constructor TMyObj366_1.Create;
begin
  inherited;
  FInt := 366 * 3;
  FTest := 'Value: ' + Random(23662).ToString + Random(36600).ToString;
end;

procedure TForm366.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum366;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj366_List0 := TMyObj366_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj366_List1 := TMyObj366_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
