...
type
  ...
  TMyObj1730_List0 = TObjectList<TMyObj1730>;

  TMyObj1730_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1730_List1 = TObjectList<TMyObj1730_1>;
...
constructor TMyObj1730_1.Create;
begin
  inherited;
  FInt := 1730 * 3;
  FTest := 'Value: ' + Random(217302).ToString + Random(173000).ToString;
end;

procedure TForm1730.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1730;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1730_List0 := TMyObj1730_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1730_List1 := TMyObj1730_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
