...
type
  ...
  TMyObj1656_List0 = TObjectList<TMyObj1656>;

  TMyObj1656_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1656_List1 = TObjectList<TMyObj1656_1>;
...
constructor TMyObj1656_1.Create;
begin
  inherited;
  FInt := 1656 * 3;
  FTest := 'Value: ' + Random(216562).ToString + Random(165600).ToString;
end;

procedure TForm1656.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1656;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1656_List0 := TMyObj1656_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1656_List1 := TMyObj1656_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
