...
type
  ...
  TMyObj1303_List0 = TObjectList<TMyObj1303>;

  TMyObj1303_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1303_List1 = TObjectList<TMyObj1303_1>;
...
constructor TMyObj1303_1.Create;
begin
  inherited;
  FInt := 1303 * 3;
  FTest := 'Value: ' + Random(213032).ToString + Random(130300).ToString;
end;

procedure TForm1303.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1303;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1303_List0 := TMyObj1303_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1303_List1 := TMyObj1303_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
