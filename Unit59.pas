...
type
  ...
  TMyObj59_List0 = TObjectList<TMyObj59>;

  TMyObj59_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj59_List1 = TObjectList<TMyObj59_1>;
...
constructor TMyObj59_1.Create;
begin
  inherited;
  FInt := 59 * 3;
  FTest := 'Value: ' + Random(2592).ToString + Random(5900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj59_List0 := TMyObj59_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj59_List1 := TMyObj59_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
