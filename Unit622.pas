...
type
  ...
  TMyObj622_List0 = TObjectList<TMyObj622>;

  TMyObj622_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj622_List1 = TObjectList<TMyObj622_1>;
...
constructor TMyObj622_1.Create;
begin
  inherited;
  FInt := 622 * 3;
  FTest := 'Value: ' + Random(26222).ToString + Random(62200).ToString;
end;

procedure TForm622.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum622;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj622_List0 := TMyObj622_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj622_List1 := TMyObj622_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
