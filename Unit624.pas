...
type
  ...
  TMyObj624_List0 = TObjectList<TMyObj624>;

  TMyObj624_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj624_List1 = TObjectList<TMyObj624_1>;
...
constructor TMyObj624_1.Create;
begin
  inherited;
  FInt := 624 * 3;
  FTest := 'Value: ' + Random(26242).ToString + Random(62400).ToString;
end;

procedure TForm624.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum624;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj624_List0 := TMyObj624_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj624_List1 := TMyObj624_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
