...
type
  ...
  TMyObj1735_List0 = TObjectList<TMyObj1735>;

  TMyObj1735_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1735_List1 = TObjectList<TMyObj1735_1>;
...
constructor TMyObj1735_1.Create;
begin
  inherited;
  FInt := 1735 * 3;
  FTest := 'Value: ' + Random(217352).ToString + Random(173500).ToString;
end;

procedure TForm1735.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1735;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1735_List0 := TMyObj1735_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1735_List1 := TMyObj1735_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
