...
type
  ...
  TMyObj457_List0 = TObjectList<TMyObj457>;

  TMyObj457_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj457_List1 = TObjectList<TMyObj457_1>;
...
constructor TMyObj457_1.Create;
begin
  inherited;
  FInt := 457 * 3;
  FTest := 'Value: ' + Random(24572).ToString + Random(45700).ToString;
end;

procedure TForm457.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum457;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj457_List0 := TMyObj457_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj457_List1 := TMyObj457_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
