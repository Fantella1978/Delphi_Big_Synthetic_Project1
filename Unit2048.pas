...
type
  ...
  TMyObj2048_List0 = TObjectList<TMyObj2048>;

  TMyObj2048_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2048_List1 = TObjectList<TMyObj2048_1>;
...
constructor TMyObj2048_1.Create;
begin
  inherited;
  FInt := 2048 * 3;
  FTest := 'Value: ' + Random(220482).ToString + Random(204800).ToString;
end;

procedure TForm2048.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2048;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2048_List0 := TMyObj2048_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2048_List1 := TMyObj2048_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
