...
type
  ...
  TMyObj596_List0 = TObjectList<TMyObj596>;

  TMyObj596_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj596_List1 = TObjectList<TMyObj596_1>;
...
constructor TMyObj596_1.Create;
begin
  inherited;
  FInt := 596 * 3;
  FTest := 'Value: ' + Random(25962).ToString + Random(59600).ToString;
end;

procedure TForm596.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum596;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj596_List0 := TMyObj596_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj596_List1 := TMyObj596_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
