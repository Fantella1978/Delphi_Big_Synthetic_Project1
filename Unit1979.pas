...
type
  ...
  TMyObj1979_List0 = TObjectList<TMyObj1979>;

  TMyObj1979_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1979_List1 = TObjectList<TMyObj1979_1>;
...
constructor TMyObj1979_1.Create;
begin
  inherited;
  FInt := 1979 * 3;
  FTest := 'Value: ' + Random(219792).ToString + Random(197900).ToString;
end;

procedure TForm1979.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1979;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1979_List0 := TMyObj1979_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1979_List1 := TMyObj1979_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
