...
type
  ...
  TMyObj2304_List0 = TObjectList<TMyObj2304>;

  TMyObj2304_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2304_List1 = TObjectList<TMyObj2304_1>;
...
constructor TMyObj2304_1.Create;
begin
  inherited;
  FInt := 2304 * 3;
  FTest := 'Value: ' + Random(223042).ToString + Random(230400).ToString;
end;

procedure TForm2304.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2304;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2304_List0 := TMyObj2304_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2304_List1 := TMyObj2304_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
