...
type
  ...
  TMyObj40_List0 = TObjectList<TMyObj40>;

  TMyObj40_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj40_List1 = TObjectList<TMyObj40_1>;
...
constructor TMyObj40_1.Create;
begin
  inherited;
  FInt := 40 * 3;
  FTest := 'Value: ' + Random(2402).ToString + Random(4000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj40_List0 := TMyObj40_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj40_List1 := TMyObj40_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
