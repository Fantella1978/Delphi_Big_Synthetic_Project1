...
type
  ...
  TMyObj1582_List0 = TObjectList<TMyObj1582>;

  TMyObj1582_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1582_List1 = TObjectList<TMyObj1582_1>;
...
constructor TMyObj1582_1.Create;
begin
  inherited;
  FInt := 1582 * 3;
  FTest := 'Value: ' + Random(215822).ToString + Random(158200).ToString;
end;

procedure TForm1582.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1582;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1582_List0 := TMyObj1582_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1582_List1 := TMyObj1582_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
