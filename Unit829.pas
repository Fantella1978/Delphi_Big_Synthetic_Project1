...
type
  ...
  TMyObj829_List0 = TObjectList<TMyObj829>;

  TMyObj829_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj829_List1 = TObjectList<TMyObj829_1>;
...
constructor TMyObj829_1.Create;
begin
  inherited;
  FInt := 829 * 3;
  FTest := 'Value: ' + Random(28292).ToString + Random(82900).ToString;
end;

procedure TForm829.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum829;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj829_List0 := TMyObj829_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj829_List1 := TMyObj829_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
