...
type
  ...
  TMyObj271_List0 = TObjectList<TMyObj271>;

  TMyObj271_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj271_List1 = TObjectList<TMyObj271_1>;
...
constructor TMyObj271_1.Create;
begin
  inherited;
  FInt := 271 * 3;
  FTest := 'Value: ' + Random(22712).ToString + Random(27100).ToString;
end;

procedure TForm271.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum271;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj271_List0 := TMyObj271_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj271_List1 := TMyObj271_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
