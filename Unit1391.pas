...
type
  ...
  TMyObj1391_List0 = TObjectList<TMyObj1391>;

  TMyObj1391_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1391_List1 = TObjectList<TMyObj1391_1>;
...
constructor TMyObj1391_1.Create;
begin
  inherited;
  FInt := 1391 * 3;
  FTest := 'Value: ' + Random(213912).ToString + Random(139100).ToString;
end;

procedure TForm1391.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1391;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1391_List0 := TMyObj1391_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1391_List1 := TMyObj1391_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
