...
type
  ...
  TMyObj68_List0 = TObjectList<TMyObj68>;

  TMyObj68_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj68_List1 = TObjectList<TMyObj68_1>;
...
constructor TMyObj68_1.Create;
begin
  inherited;
  FInt := 68 * 3;
  FTest := 'Value: ' + Random(2682).ToString + Random(6800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj68_List0 := TMyObj68_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj68_List1 := TMyObj68_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
