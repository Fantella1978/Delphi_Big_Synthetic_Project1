...
type
  ...
  TMyObj2421_List0 = TObjectList<TMyObj2421>;

  TMyObj2421_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2421_List1 = TObjectList<TMyObj2421_1>;
...
constructor TMyObj2421_1.Create;
begin
  inherited;
  FInt := 2421 * 3;
  FTest := 'Value: ' + Random(224212).ToString + Random(242100).ToString;
end;

procedure TForm2421.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2421;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2421_List0 := TMyObj2421_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2421_List1 := TMyObj2421_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
