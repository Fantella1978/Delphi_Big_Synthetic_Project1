...
type
  ...
  TMyObj268_List0 = TObjectList<TMyObj268>;

  TMyObj268_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj268_List1 = TObjectList<TMyObj268_1>;
...
constructor TMyObj268_1.Create;
begin
  inherited;
  FInt := 268 * 3;
  FTest := 'Value: ' + Random(22682).ToString + Random(26800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj268_List0 := TMyObj268_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj268_List1 := TMyObj268_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
