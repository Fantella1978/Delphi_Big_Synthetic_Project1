...
type
  ...
  TMyObj2026_List0 = TObjectList<TMyObj2026>;

  TMyObj2026_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2026_List1 = TObjectList<TMyObj2026_1>;
...
constructor TMyObj2026_1.Create;
begin
  inherited;
  FInt := 2026 * 3;
  FTest := 'Value: ' + Random(220262).ToString + Random(202600).ToString;
end;

procedure TForm2026.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2026;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2026_List0 := TMyObj2026_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2026_List1 := TMyObj2026_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
