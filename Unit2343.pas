...
type
  ...
  TMyObj2343_List0 = TObjectList<TMyObj2343>;

  TMyObj2343_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2343_List1 = TObjectList<TMyObj2343_1>;
...
constructor TMyObj2343_1.Create;
begin
  inherited;
  FInt := 2343 * 3;
  FTest := 'Value: ' + Random(223432).ToString + Random(234300).ToString;
end;

procedure TForm2343.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2343;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2343_List0 := TMyObj2343_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2343_List1 := TMyObj2343_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
