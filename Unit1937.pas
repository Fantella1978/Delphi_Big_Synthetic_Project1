...
type
  ...
  TMyObj1937_List0 = TObjectList<TMyObj1937>;

  TMyObj1937_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1937_List1 = TObjectList<TMyObj1937_1>;
...
constructor TMyObj1937_1.Create;
begin
  inherited;
  FInt := 1937 * 3;
  FTest := 'Value: ' + Random(219372).ToString + Random(193700).ToString;
end;

procedure TForm1937.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1937;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1937_List0 := TMyObj1937_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1937_List1 := TMyObj1937_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
