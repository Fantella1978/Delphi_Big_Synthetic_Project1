...
type
  ...
  TMyObj1083_List0 = TObjectList<TMyObj1083>;

  TMyObj1083_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1083_List1 = TObjectList<TMyObj1083_1>;
...
constructor TMyObj1083_1.Create;
begin
  inherited;
  FInt := 1083 * 3;
  FTest := 'Value: ' + Random(210832).ToString + Random(108300).ToString;
end;

procedure TForm1083.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1083;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1083_List0 := TMyObj1083_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1083_List1 := TMyObj1083_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
