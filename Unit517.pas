...
type
  ...
  TMyObj517_List0 = TObjectList<TMyObj517>;

  TMyObj517_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj517_List1 = TObjectList<TMyObj517_1>;
...
constructor TMyObj517_1.Create;
begin
  inherited;
  FInt := 517 * 3;
  FTest := 'Value: ' + Random(25172).ToString + Random(51700).ToString;
end;

procedure TForm517.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum517;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj517_List0 := TMyObj517_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj517_List1 := TMyObj517_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
