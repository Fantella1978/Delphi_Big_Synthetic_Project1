...
type
  ...
  TMyObj170_List0 = TObjectList<TMyObj170>;

  TMyObj170_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj170_List1 = TObjectList<TMyObj170_1>;
...
constructor TMyObj170_1.Create;
begin
  inherited;
  FInt := 170 * 3;
  FTest := 'Value: ' + Random(21702).ToString + Random(17000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj170_List0 := TMyObj170_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj170_List1 := TMyObj170_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
