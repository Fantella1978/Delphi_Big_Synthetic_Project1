...
type
  ...
  TMyObj1006_List0 = TObjectList<TMyObj1006>;

  TMyObj1006_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1006_List1 = TObjectList<TMyObj1006_1>;
...
constructor TMyObj1006_1.Create;
begin
  inherited;
  FInt := 1006 * 3;
  FTest := 'Value: ' + Random(210062).ToString + Random(100600).ToString;
end;

procedure TForm1006.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1006;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1006_List0 := TMyObj1006_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1006_List1 := TMyObj1006_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
