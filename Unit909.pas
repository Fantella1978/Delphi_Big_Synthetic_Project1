...
type
  ...
  TMyObj909_List0 = TObjectList<TMyObj909>;

  TMyObj909_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj909_List1 = TObjectList<TMyObj909_1>;
...
constructor TMyObj909_1.Create;
begin
  inherited;
  FInt := 909 * 3;
  FTest := 'Value: ' + Random(29092).ToString + Random(90900).ToString;
end;

procedure TForm909.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum909;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj909_List0 := TMyObj909_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj909_List1 := TMyObj909_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
