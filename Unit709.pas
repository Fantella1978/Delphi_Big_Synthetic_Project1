...
type
  ...
  TMyObj709_List0 = TObjectList<TMyObj709>;

  TMyObj709_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj709_List1 = TObjectList<TMyObj709_1>;
...
constructor TMyObj709_1.Create;
begin
  inherited;
  FInt := 709 * 3;
  FTest := 'Value: ' + Random(27092).ToString + Random(70900).ToString;
end;

procedure TForm709.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum709;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj709_List0 := TMyObj709_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj709_List1 := TMyObj709_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
