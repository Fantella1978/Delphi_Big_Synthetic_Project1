...
type
  ...
  TMyObj2258_List0 = TObjectList<TMyObj2258>;

  TMyObj2258_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2258_List1 = TObjectList<TMyObj2258_1>;
...
constructor TMyObj2258_1.Create;
begin
  inherited;
  FInt := 2258 * 3;
  FTest := 'Value: ' + Random(222582).ToString + Random(225800).ToString;
end;

procedure TForm2258.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2258;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2258_List0 := TMyObj2258_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2258_List1 := TMyObj2258_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
