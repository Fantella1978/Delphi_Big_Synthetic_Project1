...
type
  ...
  TMyObj32_List0 = TObjectList<TMyObj32>;

  TMyObj32_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj32_List1 = TObjectList<TMyObj32_1>;
...
constructor TMyObj32_1.Create;
begin
  inherited;
  FInt := 32 * 3;
  FTest := 'Value: ' + Random(2322).ToString + Random(3200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj32_List0 := TMyObj32_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj32_List1 := TMyObj32_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
