...
type
  ...
  TMyObj1016_List0 = TObjectList<TMyObj1016>;

  TMyObj1016_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1016_List1 = TObjectList<TMyObj1016_1>;
...
constructor TMyObj1016_1.Create;
begin
  inherited;
  FInt := 1016 * 3;
  FTest := 'Value: ' + Random(210162).ToString + Random(101600).ToString;
end;

procedure TForm1016.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1016;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1016_List0 := TMyObj1016_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1016_List1 := TMyObj1016_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
