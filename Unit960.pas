...
type
  ...
  TMyObj960_List0 = TObjectList<TMyObj960>;

  TMyObj960_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj960_List1 = TObjectList<TMyObj960_1>;
...
constructor TMyObj960_1.Create;
begin
  inherited;
  FInt := 960 * 3;
  FTest := 'Value: ' + Random(29602).ToString + Random(96000).ToString;
end;

procedure TForm960.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum960;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj960_List0 := TMyObj960_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj960_List1 := TMyObj960_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
