...
type
  ...
  TMyObj1506_List0 = TObjectList<TMyObj1506>;

  TMyObj1506_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1506_List1 = TObjectList<TMyObj1506_1>;
...
constructor TMyObj1506_1.Create;
begin
  inherited;
  FInt := 1506 * 3;
  FTest := 'Value: ' + Random(215062).ToString + Random(150600).ToString;
end;

procedure TForm1506.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1506;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1506_List0 := TMyObj1506_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1506_List1 := TMyObj1506_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
