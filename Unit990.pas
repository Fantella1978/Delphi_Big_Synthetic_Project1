...
type
  ...
  TMyObj990_List0 = TObjectList<TMyObj990>;

  TMyObj990_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj990_List1 = TObjectList<TMyObj990_1>;
...
constructor TMyObj990_1.Create;
begin
  inherited;
  FInt := 990 * 3;
  FTest := 'Value: ' + Random(29902).ToString + Random(99000).ToString;
end;

procedure TForm990.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum990;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj990_List0 := TMyObj990_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj990_List1 := TMyObj990_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
