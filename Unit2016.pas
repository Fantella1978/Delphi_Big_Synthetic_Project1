...
type
  ...
  TMyObj2016_List0 = TObjectList<TMyObj2016>;

  TMyObj2016_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2016_List1 = TObjectList<TMyObj2016_1>;
...
constructor TMyObj2016_1.Create;
begin
  inherited;
  FInt := 2016 * 3;
  FTest := 'Value: ' + Random(220162).ToString + Random(201600).ToString;
end;

procedure TForm2016.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2016;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2016_List0 := TMyObj2016_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2016_List1 := TMyObj2016_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
