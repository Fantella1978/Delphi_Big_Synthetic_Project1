...
type
  ...
  TMyObj1194_List0 = TObjectList<TMyObj1194>;

  TMyObj1194_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1194_List1 = TObjectList<TMyObj1194_1>;
...
constructor TMyObj1194_1.Create;
begin
  inherited;
  FInt := 1194 * 3;
  FTest := 'Value: ' + Random(211942).ToString + Random(119400).ToString;
end;

procedure TForm1194.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1194;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1194_List0 := TMyObj1194_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1194_List1 := TMyObj1194_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
