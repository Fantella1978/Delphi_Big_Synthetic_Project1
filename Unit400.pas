...
type
  ...
  TMyObj400_List0 = TObjectList<TMyObj400>;

  TMyObj400_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj400_List1 = TObjectList<TMyObj400_1>;
...
constructor TMyObj400_1.Create;
begin
  inherited;
  FInt := 400 * 3;
  FTest := 'Value: ' + Random(24002).ToString + Random(40000).ToString;
end;

procedure TForm400.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum400;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj400_List0 := TMyObj400_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj400_List1 := TMyObj400_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
