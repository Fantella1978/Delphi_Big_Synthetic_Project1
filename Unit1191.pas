...
type
  ...
  TMyObj1191_List0 = TObjectList<TMyObj1191>;

  TMyObj1191_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1191_List1 = TObjectList<TMyObj1191_1>;
...
constructor TMyObj1191_1.Create;
begin
  inherited;
  FInt := 1191 * 3;
  FTest := 'Value: ' + Random(211912).ToString + Random(119100).ToString;
end;

procedure TForm1191.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1191;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1191_List0 := TMyObj1191_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1191_List1 := TMyObj1191_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
