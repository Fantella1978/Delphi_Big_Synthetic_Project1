...
type
  ...
  TMyObj2238_List0 = TObjectList<TMyObj2238>;

  TMyObj2238_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2238_List1 = TObjectList<TMyObj2238_1>;
...
constructor TMyObj2238_1.Create;
begin
  inherited;
  FInt := 2238 * 3;
  FTest := 'Value: ' + Random(222382).ToString + Random(223800).ToString;
end;

procedure TForm2238.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2238;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2238_List0 := TMyObj2238_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2238_List1 := TMyObj2238_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
