...
type
  ...
  TMyObj2076_List0 = TObjectList<TMyObj2076>;

  TMyObj2076_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2076_List1 = TObjectList<TMyObj2076_1>;
...
constructor TMyObj2076_1.Create;
begin
  inherited;
  FInt := 2076 * 3;
  FTest := 'Value: ' + Random(220762).ToString + Random(207600).ToString;
end;

procedure TForm2076.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2076;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2076_List0 := TMyObj2076_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2076_List1 := TMyObj2076_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
