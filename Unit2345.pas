...
type
  ...
  TMyObj2345_List0 = TObjectList<TMyObj2345>;

  TMyObj2345_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2345_List1 = TObjectList<TMyObj2345_1>;
...
constructor TMyObj2345_1.Create;
begin
  inherited;
  FInt := 2345 * 3;
  FTest := 'Value: ' + Random(223452).ToString + Random(234500).ToString;
end;

procedure TForm2345.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2345;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2345_List0 := TMyObj2345_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2345_List1 := TMyObj2345_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
