...
type
  ...
  TMyObj918_List0 = TObjectList<TMyObj918>;

  TMyObj918_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj918_List1 = TObjectList<TMyObj918_1>;
...
constructor TMyObj918_1.Create;
begin
  inherited;
  FInt := 918 * 3;
  FTest := 'Value: ' + Random(29182).ToString + Random(91800).ToString;
end;

procedure TForm918.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum918;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj918_List0 := TMyObj918_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj918_List1 := TMyObj918_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
