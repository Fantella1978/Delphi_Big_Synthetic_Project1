...
type
  ...
  TMyObj2113_List0 = TObjectList<TMyObj2113>;

  TMyObj2113_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2113_List1 = TObjectList<TMyObj2113_1>;
...
constructor TMyObj2113_1.Create;
begin
  inherited;
  FInt := 2113 * 3;
  FTest := 'Value: ' + Random(221132).ToString + Random(211300).ToString;
end;

procedure TForm2113.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2113;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2113_List0 := TMyObj2113_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2113_List1 := TMyObj2113_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
