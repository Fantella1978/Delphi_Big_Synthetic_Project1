...
type
  ...
  TMyObj1592_List0 = TObjectList<TMyObj1592>;

  TMyObj1592_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1592_List1 = TObjectList<TMyObj1592_1>;
...
constructor TMyObj1592_1.Create;
begin
  inherited;
  FInt := 1592 * 3;
  FTest := 'Value: ' + Random(215922).ToString + Random(159200).ToString;
end;

procedure TForm1592.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1592;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1592_List0 := TMyObj1592_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1592_List1 := TMyObj1592_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
