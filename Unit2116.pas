...
type
  ...
  TMyObj2116_List0 = TObjectList<TMyObj2116>;

  TMyObj2116_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2116_List1 = TObjectList<TMyObj2116_1>;
...
constructor TMyObj2116_1.Create;
begin
  inherited;
  FInt := 2116 * 3;
  FTest := 'Value: ' + Random(221162).ToString + Random(211600).ToString;
end;

procedure TForm2116.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2116;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2116_List0 := TMyObj2116_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2116_List1 := TMyObj2116_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
