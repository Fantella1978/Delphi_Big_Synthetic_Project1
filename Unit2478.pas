...
type
  ...
  TMyObj2478_List0 = TObjectList<TMyObj2478>;

  TMyObj2478_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2478_List1 = TObjectList<TMyObj2478_1>;
...
constructor TMyObj2478_1.Create;
begin
  inherited;
  FInt := 2478 * 3;
  FTest := 'Value: ' + Random(224782).ToString + Random(247800).ToString;
end;

procedure TForm2478.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2478;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2478_List0 := TMyObj2478_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2478_List1 := TMyObj2478_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
