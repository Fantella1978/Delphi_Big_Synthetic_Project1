...
type
  ...
  TMyObj1440_List0 = TObjectList<TMyObj1440>;

  TMyObj1440_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1440_List1 = TObjectList<TMyObj1440_1>;
...
constructor TMyObj1440_1.Create;
begin
  inherited;
  FInt := 1440 * 3;
  FTest := 'Value: ' + Random(214402).ToString + Random(144000).ToString;
end;

procedure TForm1440.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1440;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1440_List0 := TMyObj1440_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1440_List1 := TMyObj1440_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
