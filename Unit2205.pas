...
type
  ...
  TMyObj2205_List0 = TObjectList<TMyObj2205>;

  TMyObj2205_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2205_List1 = TObjectList<TMyObj2205_1>;
...
constructor TMyObj2205_1.Create;
begin
  inherited;
  FInt := 2205 * 3;
  FTest := 'Value: ' + Random(222052).ToString + Random(220500).ToString;
end;

procedure TForm2205.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2205;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2205_List0 := TMyObj2205_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2205_List1 := TMyObj2205_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
