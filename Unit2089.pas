...
type
  ...
  TMyObj2089_List0 = TObjectList<TMyObj2089>;

  TMyObj2089_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2089_List1 = TObjectList<TMyObj2089_1>;
...
constructor TMyObj2089_1.Create;
begin
  inherited;
  FInt := 2089 * 3;
  FTest := 'Value: ' + Random(220892).ToString + Random(208900).ToString;
end;

procedure TForm2089.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2089;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2089_List0 := TMyObj2089_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2089_List1 := TMyObj2089_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
