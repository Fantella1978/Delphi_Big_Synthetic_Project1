...
type
  ...
  TMyObj2189_List0 = TObjectList<TMyObj2189>;

  TMyObj2189_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2189_List1 = TObjectList<TMyObj2189_1>;
...
constructor TMyObj2189_1.Create;
begin
  inherited;
  FInt := 2189 * 3;
  FTest := 'Value: ' + Random(221892).ToString + Random(218900).ToString;
end;

procedure TForm2189.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2189;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2189_List0 := TMyObj2189_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2189_List1 := TMyObj2189_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
