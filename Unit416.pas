...
type
  ...
  TMyObj416_List0 = TObjectList<TMyObj416>;

  TMyObj416_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj416_List1 = TObjectList<TMyObj416_1>;
...
constructor TMyObj416_1.Create;
begin
  inherited;
  FInt := 416 * 3;
  FTest := 'Value: ' + Random(24162).ToString + Random(41600).ToString;
end;

procedure TForm416.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum416;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj416_List0 := TMyObj416_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj416_List1 := TMyObj416_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
