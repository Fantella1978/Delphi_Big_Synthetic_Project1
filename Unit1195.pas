...
type
  ...
  TMyObj1195_List0 = TObjectList<TMyObj1195>;

  TMyObj1195_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1195_List1 = TObjectList<TMyObj1195_1>;
...
constructor TMyObj1195_1.Create;
begin
  inherited;
  FInt := 1195 * 3;
  FTest := 'Value: ' + Random(211952).ToString + Random(119500).ToString;
end;

procedure TForm1195.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1195;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1195_List0 := TMyObj1195_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1195_List1 := TMyObj1195_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
