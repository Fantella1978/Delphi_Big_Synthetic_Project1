...
type
  ...
  TMyObj88_List0 = TObjectList<TMyObj88>;

  TMyObj88_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj88_List1 = TObjectList<TMyObj88_1>;
...
constructor TMyObj88_1.Create;
begin
  inherited;
  FInt := 88 * 3;
  FTest := 'Value: ' + Random(2882).ToString + Random(8800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj88_List0 := TMyObj88_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj88_List1 := TMyObj88_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
