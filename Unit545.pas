...
type
  ...
  TMyObj545_List0 = TObjectList<TMyObj545>;

  TMyObj545_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj545_List1 = TObjectList<TMyObj545_1>;
...
constructor TMyObj545_1.Create;
begin
  inherited;
  FInt := 545 * 3;
  FTest := 'Value: ' + Random(25452).ToString + Random(54500).ToString;
end;

procedure TForm545.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum545;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj545_List0 := TMyObj545_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj545_List1 := TMyObj545_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
