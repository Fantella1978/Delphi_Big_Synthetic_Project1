...
type
  ...
  TMyObj871_List0 = TObjectList<TMyObj871>;

  TMyObj871_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj871_List1 = TObjectList<TMyObj871_1>;
...
constructor TMyObj871_1.Create;
begin
  inherited;
  FInt := 871 * 3;
  FTest := 'Value: ' + Random(28712).ToString + Random(87100).ToString;
end;

procedure TForm871.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum871;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj871_List0 := TMyObj871_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj871_List1 := TMyObj871_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
