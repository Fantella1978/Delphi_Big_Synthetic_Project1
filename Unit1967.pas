...
type
  ...
  TMyObj1967_List0 = TObjectList<TMyObj1967>;

  TMyObj1967_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1967_List1 = TObjectList<TMyObj1967_1>;
...
constructor TMyObj1967_1.Create;
begin
  inherited;
  FInt := 1967 * 3;
  FTest := 'Value: ' + Random(219672).ToString + Random(196700).ToString;
end;

procedure TForm1967.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1967;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1967_List0 := TMyObj1967_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1967_List1 := TMyObj1967_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
