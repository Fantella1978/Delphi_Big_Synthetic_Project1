...
type
  ...
  TMyObj757_List0 = TObjectList<TMyObj757>;

  TMyObj757_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj757_List1 = TObjectList<TMyObj757_1>;
...
constructor TMyObj757_1.Create;
begin
  inherited;
  FInt := 757 * 3;
  FTest := 'Value: ' + Random(27572).ToString + Random(75700).ToString;
end;

procedure TForm757.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum757;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj757_List0 := TMyObj757_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj757_List1 := TMyObj757_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
