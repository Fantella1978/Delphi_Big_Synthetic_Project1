...
type
  ...
  TMyObj96_List0 = TObjectList<TMyObj96>;

  TMyObj96_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj96_List1 = TObjectList<TMyObj96_1>;
...
constructor TMyObj96_1.Create;
begin
  inherited;
  FInt := 96 * 3;
  FTest := 'Value: ' + Random(2962).ToString + Random(9600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj96_List0 := TMyObj96_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj96_List1 := TMyObj96_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
