...
type
  ...
  TMyObj2235_List0 = TObjectList<TMyObj2235>;

  TMyObj2235_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2235_List1 = TObjectList<TMyObj2235_1>;
...
constructor TMyObj2235_1.Create;
begin
  inherited;
  FInt := 2235 * 3;
  FTest := 'Value: ' + Random(222352).ToString + Random(223500).ToString;
end;

procedure TForm2235.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2235;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2235_List0 := TMyObj2235_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2235_List1 := TMyObj2235_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
