...
type
  ...
  TMyObj1732_List0 = TObjectList<TMyObj1732>;

  TMyObj1732_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1732_List1 = TObjectList<TMyObj1732_1>;
...
constructor TMyObj1732_1.Create;
begin
  inherited;
  FInt := 1732 * 3;
  FTest := 'Value: ' + Random(217322).ToString + Random(173200).ToString;
end;

procedure TForm1732.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1732;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1732_List0 := TMyObj1732_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1732_List1 := TMyObj1732_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
