...
type
  ...
  TMyObj2275_List0 = TObjectList<TMyObj2275>;

  TMyObj2275_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2275_List1 = TObjectList<TMyObj2275_1>;
...
constructor TMyObj2275_1.Create;
begin
  inherited;
  FInt := 2275 * 3;
  FTest := 'Value: ' + Random(222752).ToString + Random(227500).ToString;
end;

procedure TForm2275.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2275;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2275_List0 := TMyObj2275_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2275_List1 := TMyObj2275_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
