...
type
  ...
  TMyObj646_List0 = TObjectList<TMyObj646>;

  TMyObj646_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj646_List1 = TObjectList<TMyObj646_1>;
...
constructor TMyObj646_1.Create;
begin
  inherited;
  FInt := 646 * 3;
  FTest := 'Value: ' + Random(26462).ToString + Random(64600).ToString;
end;

procedure TForm646.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum646;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj646_List0 := TMyObj646_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj646_List1 := TMyObj646_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
