...
type
  ...
  TMyObj1211_List0 = TObjectList<TMyObj1211>;

  TMyObj1211_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1211_List1 = TObjectList<TMyObj1211_1>;
...
constructor TMyObj1211_1.Create;
begin
  inherited;
  FInt := 1211 * 3;
  FTest := 'Value: ' + Random(212112).ToString + Random(121100).ToString;
end;

procedure TForm1211.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1211;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1211_List0 := TMyObj1211_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1211_List1 := TMyObj1211_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
