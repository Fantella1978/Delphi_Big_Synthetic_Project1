...
type
  ...
  TMyObj811_List0 = TObjectList<TMyObj811>;

  TMyObj811_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj811_List1 = TObjectList<TMyObj811_1>;
...
constructor TMyObj811_1.Create;
begin
  inherited;
  FInt := 811 * 3;
  FTest := 'Value: ' + Random(28112).ToString + Random(81100).ToString;
end;

procedure TForm811.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum811;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj811_List0 := TMyObj811_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj811_List1 := TMyObj811_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
