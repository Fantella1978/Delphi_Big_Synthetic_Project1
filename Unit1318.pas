...
type
  ...
  TMyObj1318_List0 = TObjectList<TMyObj1318>;

  TMyObj1318_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1318_List1 = TObjectList<TMyObj1318_1>;
...
constructor TMyObj1318_1.Create;
begin
  inherited;
  FInt := 1318 * 3;
  FTest := 'Value: ' + Random(213182).ToString + Random(131800).ToString;
end;

procedure TForm1318.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1318;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1318_List0 := TMyObj1318_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1318_List1 := TMyObj1318_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
