...
type
  ...
  TMyObj721_List0 = TObjectList<TMyObj721>;

  TMyObj721_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj721_List1 = TObjectList<TMyObj721_1>;
...
constructor TMyObj721_1.Create;
begin
  inherited;
  FInt := 721 * 3;
  FTest := 'Value: ' + Random(27212).ToString + Random(72100).ToString;
end;

procedure TForm721.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum721;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj721_List0 := TMyObj721_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj721_List1 := TMyObj721_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
