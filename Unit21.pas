...
type
  ...
  TMyObj21_List0 = TObjectList<TMyObj21>;

  TMyObj21_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj21_List1 = TObjectList<TMyObj21_1>;
...
constructor TMyObj21_1.Create;
begin
  inherited;
  FInt := 21 * 3;
  FTest := 'Value: ' + Random(2212).ToString + Random(2100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj21_List0 := TMyObj21_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj21_List1 := TMyObj21_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
