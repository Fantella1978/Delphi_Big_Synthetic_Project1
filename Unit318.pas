...
type
  ...
  TMyObj318_List0 = TObjectList<TMyObj318>;

  TMyObj318_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj318_List1 = TObjectList<TMyObj318_1>;
...
constructor TMyObj318_1.Create;
begin
  inherited;
  FInt := 318 * 3;
  FTest := 'Value: ' + Random(23182).ToString + Random(31800).ToString;
end;

procedure TForm318.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum318;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj318_List0 := TMyObj318_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj318_List1 := TMyObj318_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
