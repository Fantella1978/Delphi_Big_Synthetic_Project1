...
type
  ...
  TMyObj642_List0 = TObjectList<TMyObj642>;

  TMyObj642_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj642_List1 = TObjectList<TMyObj642_1>;
...
constructor TMyObj642_1.Create;
begin
  inherited;
  FInt := 642 * 3;
  FTest := 'Value: ' + Random(26422).ToString + Random(64200).ToString;
end;

procedure TForm642.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum642;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj642_List0 := TMyObj642_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj642_List1 := TMyObj642_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
