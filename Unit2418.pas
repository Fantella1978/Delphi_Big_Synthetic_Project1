...
type
  ...
  TMyObj2418_List0 = TObjectList<TMyObj2418>;

  TMyObj2418_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2418_List1 = TObjectList<TMyObj2418_1>;
...
constructor TMyObj2418_1.Create;
begin
  inherited;
  FInt := 2418 * 3;
  FTest := 'Value: ' + Random(224182).ToString + Random(241800).ToString;
end;

procedure TForm2418.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2418;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2418_List0 := TMyObj2418_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2418_List1 := TMyObj2418_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
