...
type
  ...
  TMyObj2134_List0 = TObjectList<TMyObj2134>;

  TMyObj2134_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2134_List1 = TObjectList<TMyObj2134_1>;
...
constructor TMyObj2134_1.Create;
begin
  inherited;
  FInt := 2134 * 3;
  FTest := 'Value: ' + Random(221342).ToString + Random(213400).ToString;
end;

procedure TForm2134.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2134;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2134_List0 := TMyObj2134_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2134_List1 := TMyObj2134_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
