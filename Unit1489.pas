...
type
  ...
  TMyObj1489_List0 = TObjectList<TMyObj1489>;

  TMyObj1489_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1489_List1 = TObjectList<TMyObj1489_1>;
...
constructor TMyObj1489_1.Create;
begin
  inherited;
  FInt := 1489 * 3;
  FTest := 'Value: ' + Random(214892).ToString + Random(148900).ToString;
end;

procedure TForm1489.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1489;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1489_List0 := TMyObj1489_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1489_List1 := TMyObj1489_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
