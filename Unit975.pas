...
type
  ...
  TMyObj975_List0 = TObjectList<TMyObj975>;

  TMyObj975_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj975_List1 = TObjectList<TMyObj975_1>;
...
constructor TMyObj975_1.Create;
begin
  inherited;
  FInt := 975 * 3;
  FTest := 'Value: ' + Random(29752).ToString + Random(97500).ToString;
end;

procedure TForm975.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum975;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj975_List0 := TMyObj975_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj975_List1 := TMyObj975_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
