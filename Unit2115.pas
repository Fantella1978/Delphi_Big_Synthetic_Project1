...
type
  ...
  TMyObj2115_List0 = TObjectList<TMyObj2115>;

  TMyObj2115_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2115_List1 = TObjectList<TMyObj2115_1>;
...
constructor TMyObj2115_1.Create;
begin
  inherited;
  FInt := 2115 * 3;
  FTest := 'Value: ' + Random(221152).ToString + Random(211500).ToString;
end;

procedure TForm2115.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2115;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2115_List0 := TMyObj2115_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2115_List1 := TMyObj2115_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
