...
type
  ...
  TMyObj1841_List0 = TObjectList<TMyObj1841>;

  TMyObj1841_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1841_List1 = TObjectList<TMyObj1841_1>;
...
constructor TMyObj1841_1.Create;
begin
  inherited;
  FInt := 1841 * 3;
  FTest := 'Value: ' + Random(218412).ToString + Random(184100).ToString;
end;

procedure TForm1841.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1841;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1841_List0 := TMyObj1841_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1841_List1 := TMyObj1841_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
