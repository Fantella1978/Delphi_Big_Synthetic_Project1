...
type
  ...
  TMyObj837_List0 = TObjectList<TMyObj837>;

  TMyObj837_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj837_List1 = TObjectList<TMyObj837_1>;
...
constructor TMyObj837_1.Create;
begin
  inherited;
  FInt := 837 * 3;
  FTest := 'Value: ' + Random(28372).ToString + Random(83700).ToString;
end;

procedure TForm837.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum837;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj837_List0 := TMyObj837_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj837_List1 := TMyObj837_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
