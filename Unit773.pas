...
type
  ...
  TMyObj773_List0 = TObjectList<TMyObj773>;

  TMyObj773_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj773_List1 = TObjectList<TMyObj773_1>;
...
constructor TMyObj773_1.Create;
begin
  inherited;
  FInt := 773 * 3;
  FTest := 'Value: ' + Random(27732).ToString + Random(77300).ToString;
end;

procedure TForm773.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum773;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj773_List0 := TMyObj773_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj773_List1 := TMyObj773_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
