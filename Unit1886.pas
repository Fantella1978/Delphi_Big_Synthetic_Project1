...
type
  ...
  TMyObj1886_List0 = TObjectList<TMyObj1886>;

  TMyObj1886_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1886_List1 = TObjectList<TMyObj1886_1>;
...
constructor TMyObj1886_1.Create;
begin
  inherited;
  FInt := 1886 * 3;
  FTest := 'Value: ' + Random(218862).ToString + Random(188600).ToString;
end;

procedure TForm1886.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1886;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1886_List0 := TMyObj1886_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1886_List1 := TMyObj1886_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
