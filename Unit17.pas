...
type
  ...
  TMyObj17_List0 = TObjectList<TMyObj17>;

  TMyObj17_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj17_List1 = TObjectList<TMyObj17_1>;
...
constructor TMyObj17_1.Create;
begin
  inherited;
  FInt := 17 * 3;
  FTest := 'Value: ' + Random(2172).ToString + Random(1700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj17_List0 := TMyObj17_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj17_List1 := TMyObj17_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
