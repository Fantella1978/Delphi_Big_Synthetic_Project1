...
type
  ...
  TMyObj764_List0 = TObjectList<TMyObj764>;

  TMyObj764_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj764_List1 = TObjectList<TMyObj764_1>;
...
constructor TMyObj764_1.Create;
begin
  inherited;
  FInt := 764 * 3;
  FTest := 'Value: ' + Random(27642).ToString + Random(76400).ToString;
end;

procedure TForm764.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum764;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj764_List0 := TMyObj764_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj764_List1 := TMyObj764_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
