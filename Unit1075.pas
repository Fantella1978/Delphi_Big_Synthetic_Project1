...
type
  ...
  TMyObj1075_List0 = TObjectList<TMyObj1075>;

  TMyObj1075_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1075_List1 = TObjectList<TMyObj1075_1>;
...
constructor TMyObj1075_1.Create;
begin
  inherited;
  FInt := 1075 * 3;
  FTest := 'Value: ' + Random(210752).ToString + Random(107500).ToString;
end;

procedure TForm1075.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1075;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1075_List0 := TMyObj1075_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1075_List1 := TMyObj1075_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
