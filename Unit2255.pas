...
type
  ...
  TMyObj2255_List0 = TObjectList<TMyObj2255>;

  TMyObj2255_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2255_List1 = TObjectList<TMyObj2255_1>;
...
constructor TMyObj2255_1.Create;
begin
  inherited;
  FInt := 2255 * 3;
  FTest := 'Value: ' + Random(222552).ToString + Random(225500).ToString;
end;

procedure TForm2255.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2255;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2255_List0 := TMyObj2255_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2255_List1 := TMyObj2255_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
