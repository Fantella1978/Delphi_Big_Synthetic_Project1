...
type
  ...
  TMyObj992_List0 = TObjectList<TMyObj992>;

  TMyObj992_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj992_List1 = TObjectList<TMyObj992_1>;
...
constructor TMyObj992_1.Create;
begin
  inherited;
  FInt := 992 * 3;
  FTest := 'Value: ' + Random(29922).ToString + Random(99200).ToString;
end;

procedure TForm992.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum992;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj992_List0 := TMyObj992_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj992_List1 := TMyObj992_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
