...
type
  ...
  TMyObj74_List0 = TObjectList<TMyObj74>;

  TMyObj74_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj74_List1 = TObjectList<TMyObj74_1>;
...
constructor TMyObj74_1.Create;
begin
  inherited;
  FInt := 74 * 3;
  FTest := 'Value: ' + Random(2742).ToString + Random(7400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj74_List0 := TMyObj74_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj74_List1 := TMyObj74_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
