...
type
  ...
  TMyObj1621_List0 = TObjectList<TMyObj1621>;

  TMyObj1621_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1621_List1 = TObjectList<TMyObj1621_1>;
...
constructor TMyObj1621_1.Create;
begin
  inherited;
  FInt := 1621 * 3;
  FTest := 'Value: ' + Random(216212).ToString + Random(162100).ToString;
end;

procedure TForm1621.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1621;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1621_List0 := TMyObj1621_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1621_List1 := TMyObj1621_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
