...
type
  ...
  TMyObj915_List0 = TObjectList<TMyObj915>;

  TMyObj915_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj915_List1 = TObjectList<TMyObj915_1>;
...
constructor TMyObj915_1.Create;
begin
  inherited;
  FInt := 915 * 3;
  FTest := 'Value: ' + Random(29152).ToString + Random(91500).ToString;
end;

procedure TForm915.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum915;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj915_List0 := TMyObj915_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj915_List1 := TMyObj915_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
