...
type
  ...
  TMyObj1166_List0 = TObjectList<TMyObj1166>;

  TMyObj1166_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1166_List1 = TObjectList<TMyObj1166_1>;
...
constructor TMyObj1166_1.Create;
begin
  inherited;
  FInt := 1166 * 3;
  FTest := 'Value: ' + Random(211662).ToString + Random(116600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1166_List0 := TMyObj1166_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1166_List1 := TMyObj1166_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
