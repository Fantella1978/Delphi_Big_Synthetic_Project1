...
type
  ...
  TMyObj1888_List0 = TObjectList<TMyObj1888>;

  TMyObj1888_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1888_List1 = TObjectList<TMyObj1888_1>;
...
constructor TMyObj1888_1.Create;
begin
  inherited;
  FInt := 1888 * 3;
  FTest := 'Value: ' + Random(218882).ToString + Random(188800).ToString;
end;

procedure TForm1888.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1888;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1888_List0 := TMyObj1888_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1888_List1 := TMyObj1888_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
