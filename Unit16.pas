...
type
  ...
  TMyObj16_List0 = TObjectList<TMyObj16>;

  TMyObj16_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj16_List1 = TObjectList<TMyObj16_1>;
...
constructor TMyObj16_1.Create;
begin
  inherited;
  FInt := 16 * 3;
  FTest := 'Value: ' + Random(2162).ToString + Random(1600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj16_List0 := TMyObj16_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj16_List1 := TMyObj16_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
