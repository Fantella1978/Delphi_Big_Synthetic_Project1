...
type
  ...
  TMyObj504_List0 = TObjectList<TMyObj504>;

  TMyObj504_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj504_List1 = TObjectList<TMyObj504_1>;
...
constructor TMyObj504_1.Create;
begin
  inherited;
  FInt := 504 * 3;
  FTest := 'Value: ' + Random(25042).ToString + Random(50400).ToString;
end;

procedure TForm504.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum504;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj504_List0 := TMyObj504_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj504_List1 := TMyObj504_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
