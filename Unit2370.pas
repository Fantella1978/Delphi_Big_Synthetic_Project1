...
type
  ...
  TMyObj2370_List0 = TObjectList<TMyObj2370>;

  TMyObj2370_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2370_List1 = TObjectList<TMyObj2370_1>;
...
constructor TMyObj2370_1.Create;
begin
  inherited;
  FInt := 2370 * 3;
  FTest := 'Value: ' + Random(223702).ToString + Random(237000).ToString;
end;

procedure TForm2370.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2370;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2370_List0 := TMyObj2370_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2370_List1 := TMyObj2370_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
