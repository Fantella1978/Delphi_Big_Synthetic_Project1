...
type
  ...
  TMyObj1846_List0 = TObjectList<TMyObj1846>;

  TMyObj1846_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1846_List1 = TObjectList<TMyObj1846_1>;
...
constructor TMyObj1846_1.Create;
begin
  inherited;
  FInt := 1846 * 3;
  FTest := 'Value: ' + Random(218462).ToString + Random(184600).ToString;
end;

procedure TForm1846.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1846;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1846_List0 := TMyObj1846_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1846_List1 := TMyObj1846_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
