...
type
  ...
  TMyObj412_List0 = TObjectList<TMyObj412>;

  TMyObj412_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj412_List1 = TObjectList<TMyObj412_1>;
...
constructor TMyObj412_1.Create;
begin
  inherited;
  FInt := 412 * 3;
  FTest := 'Value: ' + Random(24122).ToString + Random(41200).ToString;
end;

procedure TForm412.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum412;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj412_List0 := TMyObj412_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj412_List1 := TMyObj412_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
