...
type
  ...
  TMyObj302_List0 = TObjectList<TMyObj302>;

  TMyObj302_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj302_List1 = TObjectList<TMyObj302_1>;
...
constructor TMyObj302_1.Create;
begin
  inherited;
  FInt := 302 * 3;
  FTest := 'Value: ' + Random(23022).ToString + Random(30200).ToString;
end;

procedure TForm302.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum302;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj302_List0 := TMyObj302_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj302_List1 := TMyObj302_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
