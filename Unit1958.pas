...
type
  ...
  TMyObj1958_List0 = TObjectList<TMyObj1958>;

  TMyObj1958_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1958_List1 = TObjectList<TMyObj1958_1>;
...
constructor TMyObj1958_1.Create;
begin
  inherited;
  FInt := 1958 * 3;
  FTest := 'Value: ' + Random(219582).ToString + Random(195800).ToString;
end;

procedure TForm1958.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1958;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1958_List0 := TMyObj1958_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1958_List1 := TMyObj1958_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
