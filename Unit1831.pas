...
type
  ...
  TMyObj1831_List0 = TObjectList<TMyObj1831>;

  TMyObj1831_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1831_List1 = TObjectList<TMyObj1831_1>;
...
constructor TMyObj1831_1.Create;
begin
  inherited;
  FInt := 1831 * 3;
  FTest := 'Value: ' + Random(218312).ToString + Random(183100).ToString;
end;

procedure TForm1831.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1831;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1831_List0 := TMyObj1831_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1831_List1 := TMyObj1831_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
