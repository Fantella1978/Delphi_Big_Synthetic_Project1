...
type
  ...
  TMyObj798_List0 = TObjectList<TMyObj798>;

  TMyObj798_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj798_List1 = TObjectList<TMyObj798_1>;
...
constructor TMyObj798_1.Create;
begin
  inherited;
  FInt := 798 * 3;
  FTest := 'Value: ' + Random(27982).ToString + Random(79800).ToString;
end;

procedure TForm798.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum798;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj798_List0 := TMyObj798_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj798_List1 := TMyObj798_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
