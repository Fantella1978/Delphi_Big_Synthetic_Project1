...
type
  ...
  TMyObj169_List0 = TObjectList<TMyObj169>;

  TMyObj169_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj169_List1 = TObjectList<TMyObj169_1>;
...
constructor TMyObj169_1.Create;
begin
  inherited;
  FInt := 169 * 3;
  FTest := 'Value: ' + Random(21692).ToString + Random(16900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj169_List0 := TMyObj169_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj169_List1 := TMyObj169_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
