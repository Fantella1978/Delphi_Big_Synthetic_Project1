...
type
  ...
  TMyObj135_List0 = TObjectList<TMyObj135>;

  TMyObj135_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj135_List1 = TObjectList<TMyObj135_1>;
...
constructor TMyObj135_1.Create;
begin
  inherited;
  FInt := 135 * 3;
  FTest := 'Value: ' + Random(21352).ToString + Random(13500).ToString;
end;

procedure TForm135.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum135;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj135_List0 := TMyObj135_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj135_List1 := TMyObj135_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
