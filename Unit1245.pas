...
type
  ...
  TMyObj1245_List0 = TObjectList<TMyObj1245>;

  TMyObj1245_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1245_List1 = TObjectList<TMyObj1245_1>;
...
constructor TMyObj1245_1.Create;
begin
  inherited;
  FInt := 1245 * 3;
  FTest := 'Value: ' + Random(212452).ToString + Random(124500).ToString;
end;

procedure TForm1245.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1245;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1245_List0 := TMyObj1245_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1245_List1 := TMyObj1245_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
