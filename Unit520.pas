...
type
  ...
  TMyObj520_List0 = TObjectList<TMyObj520>;

  TMyObj520_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj520_List1 = TObjectList<TMyObj520_1>;
...
constructor TMyObj520_1.Create;
begin
  inherited;
  FInt := 520 * 3;
  FTest := 'Value: ' + Random(25202).ToString + Random(52000).ToString;
end;

procedure TForm520.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum520;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj520_List0 := TMyObj520_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj520_List1 := TMyObj520_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
