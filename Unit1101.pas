...
type
  ...
  TMyObj1101_List0 = TObjectList<TMyObj1101>;

  TMyObj1101_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1101_List1 = TObjectList<TMyObj1101_1>;
...
constructor TMyObj1101_1.Create;
begin
  inherited;
  FInt := 1101 * 3;
  FTest := 'Value: ' + Random(211012).ToString + Random(110100).ToString;
end;

procedure TForm1101.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1101;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1101_List0 := TMyObj1101_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1101_List1 := TMyObj1101_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
