...
type
  ...
  TMyObj1430_List0 = TObjectList<TMyObj1430>;

  TMyObj1430_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1430_List1 = TObjectList<TMyObj1430_1>;
...
constructor TMyObj1430_1.Create;
begin
  inherited;
  FInt := 1430 * 3;
  FTest := 'Value: ' + Random(214302).ToString + Random(143000).ToString;
end;

procedure TForm1430.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1430;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1430_List0 := TMyObj1430_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1430_List1 := TMyObj1430_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
