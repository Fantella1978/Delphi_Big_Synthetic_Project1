...
type
  ...
  TMyObj1204_List0 = TObjectList<TMyObj1204>;

  TMyObj1204_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1204_List1 = TObjectList<TMyObj1204_1>;
...
constructor TMyObj1204_1.Create;
begin
  inherited;
  FInt := 1204 * 3;
  FTest := 'Value: ' + Random(212042).ToString + Random(120400).ToString;
end;

procedure TForm1204.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1204;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1204_List0 := TMyObj1204_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1204_List1 := TMyObj1204_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
