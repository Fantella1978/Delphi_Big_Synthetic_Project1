...
type
  ...
  TMyObj89_List0 = TObjectList<TMyObj89>;

  TMyObj89_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj89_List1 = TObjectList<TMyObj89_1>;
...
constructor TMyObj89_1.Create;
begin
  inherited;
  FInt := 89 * 3;
  FTest := 'Value: ' + Random(2892).ToString + Random(8900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj89_List0 := TMyObj89_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj89_List1 := TMyObj89_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
