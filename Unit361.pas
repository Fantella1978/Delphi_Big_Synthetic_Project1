...
type
  ...
  TMyObj361_List0 = TObjectList<TMyObj361>;

  TMyObj361_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj361_List1 = TObjectList<TMyObj361_1>;
...
constructor TMyObj361_1.Create;
begin
  inherited;
  FInt := 361 * 3;
  FTest := 'Value: ' + Random(23612).ToString + Random(36100).ToString;
end;

procedure TForm361.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum361;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj361_List0 := TMyObj361_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj361_List1 := TMyObj361_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
