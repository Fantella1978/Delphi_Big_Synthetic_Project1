...
type
  ...
  TMyObj35_List0 = TObjectList<TMyObj35>;

  TMyObj35_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj35_List1 = TObjectList<TMyObj35_1>;
...
constructor TMyObj35_1.Create;
begin
  inherited;
  FInt := 35 * 3;
  FTest := 'Value: ' + Random(2352).ToString + Random(3500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj35_List0 := TMyObj35_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj35_List1 := TMyObj35_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
