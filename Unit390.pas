...
type
  ...
  TMyObj390_List0 = TObjectList<TMyObj390>;

  TMyObj390_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj390_List1 = TObjectList<TMyObj390_1>;
...
constructor TMyObj390_1.Create;
begin
  inherited;
  FInt := 390 * 3;
  FTest := 'Value: ' + Random(23902).ToString + Random(39000).ToString;
end;

procedure TForm390.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum390;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj390_List0 := TMyObj390_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj390_List1 := TMyObj390_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
