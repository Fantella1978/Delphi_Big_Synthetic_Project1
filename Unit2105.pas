...
type
  ...
  TMyObj2105_List0 = TObjectList<TMyObj2105>;

  TMyObj2105_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2105_List1 = TObjectList<TMyObj2105_1>;
...
constructor TMyObj2105_1.Create;
begin
  inherited;
  FInt := 2105 * 3;
  FTest := 'Value: ' + Random(221052).ToString + Random(210500).ToString;
end;

procedure TForm2105.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2105;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2105_List0 := TMyObj2105_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2105_List1 := TMyObj2105_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
