...
type
  ...
  TMyObj2399_List0 = TObjectList<TMyObj2399>;

  TMyObj2399_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2399_List1 = TObjectList<TMyObj2399_1>;
...
constructor TMyObj2399_1.Create;
begin
  inherited;
  FInt := 2399 * 3;
  FTest := 'Value: ' + Random(223992).ToString + Random(239900).ToString;
end;

procedure TForm2399.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2399;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2399_List0 := TMyObj2399_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2399_List1 := TMyObj2399_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
