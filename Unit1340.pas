...
type
  ...
  TMyObj1340_List0 = TObjectList<TMyObj1340>;

  TMyObj1340_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1340_List1 = TObjectList<TMyObj1340_1>;
...
constructor TMyObj1340_1.Create;
begin
  inherited;
  FInt := 1340 * 3;
  FTest := 'Value: ' + Random(213402).ToString + Random(134000).ToString;
end;

procedure TForm1340.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1340;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1340_List0 := TMyObj1340_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1340_List1 := TMyObj1340_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
