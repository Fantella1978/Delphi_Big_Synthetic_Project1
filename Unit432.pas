...
type
  ...
  TMyObj432_List0 = TObjectList<TMyObj432>;

  TMyObj432_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj432_List1 = TObjectList<TMyObj432_1>;
...
constructor TMyObj432_1.Create;
begin
  inherited;
  FInt := 432 * 3;
  FTest := 'Value: ' + Random(24322).ToString + Random(43200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj432_List0 := TMyObj432_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj432_List1 := TMyObj432_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
