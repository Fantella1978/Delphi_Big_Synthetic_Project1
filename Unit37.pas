...
type
  ...
  TMyObj37_List0 = TObjectList<TMyObj37>;

  TMyObj37_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj37_List1 = TObjectList<TMyObj37_1>;
...
constructor TMyObj37_1.Create;
begin
  inherited;
  FInt := 37 * 3;
  FTest := 'Value: ' + Random(2372).ToString + Random(3700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj37_List0 := TMyObj37_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj37_List1 := TMyObj37_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
