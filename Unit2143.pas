...
type
  ...
  TMyObj2143_List0 = TObjectList<TMyObj2143>;

  TMyObj2143_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2143_List1 = TObjectList<TMyObj2143_1>;
...
constructor TMyObj2143_1.Create;
begin
  inherited;
  FInt := 2143 * 3;
  FTest := 'Value: ' + Random(221432).ToString + Random(214300).ToString;
end;

procedure TForm2143.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2143;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2143_List0 := TMyObj2143_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2143_List1 := TMyObj2143_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
