...
type
  ...
  TMyObj2256_List0 = TObjectList<TMyObj2256>;

  TMyObj2256_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2256_List1 = TObjectList<TMyObj2256_1>;
...
constructor TMyObj2256_1.Create;
begin
  inherited;
  FInt := 2256 * 3;
  FTest := 'Value: ' + Random(222562).ToString + Random(225600).ToString;
end;

procedure TForm2256.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2256;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2256_List0 := TMyObj2256_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2256_List1 := TMyObj2256_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
