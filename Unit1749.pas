...
type
  ...
  TMyObj1749_List0 = TObjectList<TMyObj1749>;

  TMyObj1749_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1749_List1 = TObjectList<TMyObj1749_1>;
...
constructor TMyObj1749_1.Create;
begin
  inherited;
  FInt := 1749 * 3;
  FTest := 'Value: ' + Random(217492).ToString + Random(174900).ToString;
end;

procedure TForm1749.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1749;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1749_List0 := TMyObj1749_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1749_List1 := TMyObj1749_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
