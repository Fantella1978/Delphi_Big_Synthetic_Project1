...
type
  ...
  TMyObj1047_List0 = TObjectList<TMyObj1047>;

  TMyObj1047_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1047_List1 = TObjectList<TMyObj1047_1>;
...
constructor TMyObj1047_1.Create;
begin
  inherited;
  FInt := 1047 * 3;
  FTest := 'Value: ' + Random(210472).ToString + Random(104700).ToString;
end;

procedure TForm1047.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1047;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1047_List0 := TMyObj1047_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1047_List1 := TMyObj1047_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
