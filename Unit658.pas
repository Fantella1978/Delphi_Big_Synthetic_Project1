...
type
  ...
  TMyObj658_List0 = TObjectList<TMyObj658>;

  TMyObj658_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj658_List1 = TObjectList<TMyObj658_1>;
...
constructor TMyObj658_1.Create;
begin
  inherited;
  FInt := 658 * 3;
  FTest := 'Value: ' + Random(26582).ToString + Random(65800).ToString;
end;

procedure TForm658.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum658;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj658_List0 := TMyObj658_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj658_List1 := TMyObj658_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
