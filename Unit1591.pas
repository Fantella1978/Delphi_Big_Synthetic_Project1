...
type
  ...
  TMyObj1591_List0 = TObjectList<TMyObj1591>;

  TMyObj1591_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1591_List1 = TObjectList<TMyObj1591_1>;
...
constructor TMyObj1591_1.Create;
begin
  inherited;
  FInt := 1591 * 3;
  FTest := 'Value: ' + Random(215912).ToString + Random(159100).ToString;
end;

procedure TForm1591.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1591;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1591_List0 := TMyObj1591_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1591_List1 := TMyObj1591_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
