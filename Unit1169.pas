...
type
  ...
  TMyObj1169_List0 = TObjectList<TMyObj1169>;

  TMyObj1169_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1169_List1 = TObjectList<TMyObj1169_1>;
...
constructor TMyObj1169_1.Create;
begin
  inherited;
  FInt := 1169 * 3;
  FTest := 'Value: ' + Random(211692).ToString + Random(116900).ToString;
end;

procedure TForm1169.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1169;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1169_List0 := TMyObj1169_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1169_List1 := TMyObj1169_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
