...
type
  ...
  TMyObj1604_List0 = TObjectList<TMyObj1604>;

  TMyObj1604_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1604_List1 = TObjectList<TMyObj1604_1>;
...
constructor TMyObj1604_1.Create;
begin
  inherited;
  FInt := 1604 * 3;
  FTest := 'Value: ' + Random(216042).ToString + Random(160400).ToString;
end;

procedure TForm1604.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1604;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1604_List0 := TMyObj1604_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1604_List1 := TMyObj1604_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
