...
type
  ...
  TMyObj1240_List0 = TObjectList<TMyObj1240>;

  TMyObj1240_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1240_List1 = TObjectList<TMyObj1240_1>;
...
constructor TMyObj1240_1.Create;
begin
  inherited;
  FInt := 1240 * 3;
  FTest := 'Value: ' + Random(212402).ToString + Random(124000).ToString;
end;

procedure TForm1240.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1240;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1240_List0 := TMyObj1240_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1240_List1 := TMyObj1240_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
