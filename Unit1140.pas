...
type
  ...
  TMyObj1140_List0 = TObjectList<TMyObj1140>;

  TMyObj1140_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1140_List1 = TObjectList<TMyObj1140_1>;
...
constructor TMyObj1140_1.Create;
begin
  inherited;
  FInt := 1140 * 3;
  FTest := 'Value: ' + Random(211402).ToString + Random(114000).ToString;
end;

procedure TForm1140.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1140;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1140_List0 := TMyObj1140_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1140_List1 := TMyObj1140_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
