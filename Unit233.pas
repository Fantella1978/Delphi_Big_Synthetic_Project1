...
type
  ...
  TMyObj233_List0 = TObjectList<TMyObj233>;

  TMyObj233_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj233_List1 = TObjectList<TMyObj233_1>;
...
constructor TMyObj233_1.Create;
begin
  inherited;
  FInt := 233 * 3;
  FTest := 'Value: ' + Random(22332).ToString + Random(23300).ToString;
end;

procedure TForm233.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum233;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj233_List0 := TMyObj233_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj233_List1 := TMyObj233_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
