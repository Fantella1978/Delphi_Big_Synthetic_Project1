...
type
  ...
  TMyObj2376_List0 = TObjectList<TMyObj2376>;

  TMyObj2376_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2376_List1 = TObjectList<TMyObj2376_1>;
...
constructor TMyObj2376_1.Create;
begin
  inherited;
  FInt := 2376 * 3;
  FTest := 'Value: ' + Random(223762).ToString + Random(237600).ToString;
end;

procedure TForm2376.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2376;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2376_List0 := TMyObj2376_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2376_List1 := TMyObj2376_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
