...
type
  ...
  TMyObj1970_List0 = TObjectList<TMyObj1970>;

  TMyObj1970_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1970_List1 = TObjectList<TMyObj1970_1>;
...
constructor TMyObj1970_1.Create;
begin
  inherited;
  FInt := 1970 * 3;
  FTest := 'Value: ' + Random(219702).ToString + Random(197000).ToString;
end;

procedure TForm1970.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1970;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1970_List0 := TMyObj1970_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1970_List1 := TMyObj1970_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
