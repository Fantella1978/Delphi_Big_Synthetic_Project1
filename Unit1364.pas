...
type
  ...
  TMyObj1364_List0 = TObjectList<TMyObj1364>;

  TMyObj1364_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1364_List1 = TObjectList<TMyObj1364_1>;
...
constructor TMyObj1364_1.Create;
begin
  inherited;
  FInt := 1364 * 3;
  FTest := 'Value: ' + Random(213642).ToString + Random(136400).ToString;
end;

procedure TForm1364.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1364;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1364_List0 := TMyObj1364_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1364_List1 := TMyObj1364_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
