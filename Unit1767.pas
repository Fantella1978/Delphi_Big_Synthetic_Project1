...
type
  ...
  TMyObj1767_List0 = TObjectList<TMyObj1767>;

  TMyObj1767_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1767_List1 = TObjectList<TMyObj1767_1>;
...
constructor TMyObj1767_1.Create;
begin
  inherited;
  FInt := 1767 * 3;
  FTest := 'Value: ' + Random(217672).ToString + Random(176700).ToString;
end;

procedure TForm1767.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1767;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1767_List0 := TMyObj1767_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1767_List1 := TMyObj1767_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
