...
type
  ...
  TMyObj1190_List0 = TObjectList<TMyObj1190>;

  TMyObj1190_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1190_List1 = TObjectList<TMyObj1190_1>;
...
constructor TMyObj1190_1.Create;
begin
  inherited;
  FInt := 1190 * 3;
  FTest := 'Value: ' + Random(211902).ToString + Random(119000).ToString;
end;

procedure TForm1190.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1190;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1190_List0 := TMyObj1190_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1190_List1 := TMyObj1190_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
