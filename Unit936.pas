...
type
  ...
  TMyObj936_List0 = TObjectList<TMyObj936>;

  TMyObj936_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj936_List1 = TObjectList<TMyObj936_1>;
...
constructor TMyObj936_1.Create;
begin
  inherited;
  FInt := 936 * 3;
  FTest := 'Value: ' + Random(29362).ToString + Random(93600).ToString;
end;

procedure TForm936.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum936;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj936_List0 := TMyObj936_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj936_List1 := TMyObj936_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
