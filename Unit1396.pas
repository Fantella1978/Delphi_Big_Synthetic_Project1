...
type
  ...
  TMyObj1396_List0 = TObjectList<TMyObj1396>;

  TMyObj1396_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1396_List1 = TObjectList<TMyObj1396_1>;
...
constructor TMyObj1396_1.Create;
begin
  inherited;
  FInt := 1396 * 3;
  FTest := 'Value: ' + Random(213962).ToString + Random(139600).ToString;
end;

procedure TForm1396.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1396;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1396_List0 := TMyObj1396_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1396_List1 := TMyObj1396_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
