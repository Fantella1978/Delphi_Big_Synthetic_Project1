...
type
  ...
  TMyObj2455_List0 = TObjectList<TMyObj2455>;

  TMyObj2455_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2455_List1 = TObjectList<TMyObj2455_1>;
...
constructor TMyObj2455_1.Create;
begin
  inherited;
  FInt := 2455 * 3;
  FTest := 'Value: ' + Random(224552).ToString + Random(245500).ToString;
end;

procedure TForm2455.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2455;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2455_List0 := TMyObj2455_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2455_List1 := TMyObj2455_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
