...
type
  ...
  TMyObj2112_List0 = TObjectList<TMyObj2112>;

  TMyObj2112_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2112_List1 = TObjectList<TMyObj2112_1>;
...
constructor TMyObj2112_1.Create;
begin
  inherited;
  FInt := 2112 * 3;
  FTest := 'Value: ' + Random(221122).ToString + Random(211200).ToString;
end;

procedure TForm2112.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2112;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2112_List0 := TMyObj2112_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2112_List1 := TMyObj2112_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
