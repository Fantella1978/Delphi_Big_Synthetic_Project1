...
type
  ...
  TMyObj1814_List0 = TObjectList<TMyObj1814>;

  TMyObj1814_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1814_List1 = TObjectList<TMyObj1814_1>;
...
constructor TMyObj1814_1.Create;
begin
  inherited;
  FInt := 1814 * 3;
  FTest := 'Value: ' + Random(218142).ToString + Random(181400).ToString;
end;

procedure TForm1814.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1814;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1814_List0 := TMyObj1814_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1814_List1 := TMyObj1814_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
