...
type
  ...
  TMyObj1360_List0 = TObjectList<TMyObj1360>;

  TMyObj1360_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1360_List1 = TObjectList<TMyObj1360_1>;
...
constructor TMyObj1360_1.Create;
begin
  inherited;
  FInt := 1360 * 3;
  FTest := 'Value: ' + Random(213602).ToString + Random(136000).ToString;
end;

procedure TForm1360.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1360;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1360_List0 := TMyObj1360_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1360_List1 := TMyObj1360_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
