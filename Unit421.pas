...
type
  ...
  TMyObj421_List0 = TObjectList<TMyObj421>;

  TMyObj421_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj421_List1 = TObjectList<TMyObj421_1>;
...
constructor TMyObj421_1.Create;
begin
  inherited;
  FInt := 421 * 3;
  FTest := 'Value: ' + Random(24212).ToString + Random(42100).ToString;
end;

procedure TForm421.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum421;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj421_List0 := TMyObj421_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj421_List1 := TMyObj421_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
