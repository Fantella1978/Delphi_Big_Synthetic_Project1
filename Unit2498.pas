...
type
  ...
  TMyObj2498_List0 = TObjectList<TMyObj2498>;

  TMyObj2498_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2498_List1 = TObjectList<TMyObj2498_1>;
...
constructor TMyObj2498_1.Create;
begin
  inherited;
  FInt := 2498 * 3;
  FTest := 'Value: ' + Random(224982).ToString + Random(249800).ToString;
end;

procedure TForm2498.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2498;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2498_List0 := TMyObj2498_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2498_List1 := TMyObj2498_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
