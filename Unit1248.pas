...
type
  ...
  TMyObj1248_List0 = TObjectList<TMyObj1248>;

  TMyObj1248_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1248_List1 = TObjectList<TMyObj1248_1>;
...
constructor TMyObj1248_1.Create;
begin
  inherited;
  FInt := 1248 * 3;
  FTest := 'Value: ' + Random(212482).ToString + Random(124800).ToString;
end;

procedure TForm1248.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1248;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1248_List0 := TMyObj1248_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1248_List1 := TMyObj1248_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
