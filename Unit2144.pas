...
type
  ...
  TMyObj2144_List0 = TObjectList<TMyObj2144>;

  TMyObj2144_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2144_List1 = TObjectList<TMyObj2144_1>;
...
constructor TMyObj2144_1.Create;
begin
  inherited;
  FInt := 2144 * 3;
  FTest := 'Value: ' + Random(221442).ToString + Random(214400).ToString;
end;

procedure TForm2144.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2144;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2144_List0 := TMyObj2144_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2144_List1 := TMyObj2144_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
