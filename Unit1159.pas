...
type
  ...
  TMyObj1159_List0 = TObjectList<TMyObj1159>;

  TMyObj1159_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1159_List1 = TObjectList<TMyObj1159_1>;
...
constructor TMyObj1159_1.Create;
begin
  inherited;
  FInt := 1159 * 3;
  FTest := 'Value: ' + Random(211592).ToString + Random(115900).ToString;
end;

procedure TForm1159.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1159;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1159_List0 := TMyObj1159_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1159_List1 := TMyObj1159_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
