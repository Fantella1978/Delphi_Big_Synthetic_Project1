...
type
  ...
  TMyObj1107_List0 = TObjectList<TMyObj1107>;

  TMyObj1107_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1107_List1 = TObjectList<TMyObj1107_1>;
...
constructor TMyObj1107_1.Create;
begin
  inherited;
  FInt := 1107 * 3;
  FTest := 'Value: ' + Random(211072).ToString + Random(110700).ToString;
end;

procedure TForm1107.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1107;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1107_List0 := TMyObj1107_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1107_List1 := TMyObj1107_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
