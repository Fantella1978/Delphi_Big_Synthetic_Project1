...
type
  ...
  TMyObj1212_List0 = TObjectList<TMyObj1212>;

  TMyObj1212_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1212_List1 = TObjectList<TMyObj1212_1>;
...
constructor TMyObj1212_1.Create;
begin
  inherited;
  FInt := 1212 * 3;
  FTest := 'Value: ' + Random(212122).ToString + Random(121200).ToString;
end;

procedure TForm1212.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1212;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1212_List0 := TMyObj1212_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1212_List1 := TMyObj1212_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
