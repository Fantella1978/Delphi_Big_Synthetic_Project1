...
type
  ...
  TMyObj1975_List0 = TObjectList<TMyObj1975>;

  TMyObj1975_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1975_List1 = TObjectList<TMyObj1975_1>;
...
constructor TMyObj1975_1.Create;
begin
  inherited;
  FInt := 1975 * 3;
  FTest := 'Value: ' + Random(219752).ToString + Random(197500).ToString;
end;

procedure TForm1975.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1975;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1975_List0 := TMyObj1975_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1975_List1 := TMyObj1975_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
