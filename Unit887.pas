...
type
  ...
  TMyObj887_List0 = TObjectList<TMyObj887>;

  TMyObj887_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj887_List1 = TObjectList<TMyObj887_1>;
...
constructor TMyObj887_1.Create;
begin
  inherited;
  FInt := 887 * 3;
  FTest := 'Value: ' + Random(28872).ToString + Random(88700).ToString;
end;

procedure TForm887.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum887;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj887_List0 := TMyObj887_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj887_List1 := TMyObj887_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
