...
type
  ...
  TMyObj1179_List0 = TObjectList<TMyObj1179>;

  TMyObj1179_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1179_List1 = TObjectList<TMyObj1179_1>;
...
constructor TMyObj1179_1.Create;
begin
  inherited;
  FInt := 1179 * 3;
  FTest := 'Value: ' + Random(211792).ToString + Random(117900).ToString;
end;

procedure TForm1179.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1179;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1179_List0 := TMyObj1179_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1179_List1 := TMyObj1179_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
