...
type
  ...
  TMyObj701_List0 = TObjectList<TMyObj701>;

  TMyObj701_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj701_List1 = TObjectList<TMyObj701_1>;
...
constructor TMyObj701_1.Create;
begin
  inherited;
  FInt := 701 * 3;
  FTest := 'Value: ' + Random(27012).ToString + Random(70100).ToString;
end;

procedure TForm701.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum701;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj701_List0 := TMyObj701_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj701_List1 := TMyObj701_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
