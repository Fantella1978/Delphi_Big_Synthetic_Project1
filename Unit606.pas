...
type
  ...
  TMyObj606_List0 = TObjectList<TMyObj606>;

  TMyObj606_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj606_List1 = TObjectList<TMyObj606_1>;
...
constructor TMyObj606_1.Create;
begin
  inherited;
  FInt := 606 * 3;
  FTest := 'Value: ' + Random(26062).ToString + Random(60600).ToString;
end;

procedure TForm606.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum606;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj606_List0 := TMyObj606_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj606_List1 := TMyObj606_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
