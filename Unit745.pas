...
type
  ...
  TMyObj745_List0 = TObjectList<TMyObj745>;

  TMyObj745_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj745_List1 = TObjectList<TMyObj745_1>;
...
constructor TMyObj745_1.Create;
begin
  inherited;
  FInt := 745 * 3;
  FTest := 'Value: ' + Random(27452).ToString + Random(74500).ToString;
end;

procedure TForm745.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum745;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj745_List0 := TMyObj745_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj745_List1 := TMyObj745_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
