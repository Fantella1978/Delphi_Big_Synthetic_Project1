...
type
  ...
  TMyObj2054_List0 = TObjectList<TMyObj2054>;

  TMyObj2054_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2054_List1 = TObjectList<TMyObj2054_1>;
...
constructor TMyObj2054_1.Create;
begin
  inherited;
  FInt := 2054 * 3;
  FTest := 'Value: ' + Random(220542).ToString + Random(205400).ToString;
end;

procedure TForm2054.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2054;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2054_List0 := TMyObj2054_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2054_List1 := TMyObj2054_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
