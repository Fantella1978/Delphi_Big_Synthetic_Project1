...
type
  ...
  TMyObj2406_List0 = TObjectList<TMyObj2406>;

  TMyObj2406_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2406_List1 = TObjectList<TMyObj2406_1>;
...
constructor TMyObj2406_1.Create;
begin
  inherited;
  FInt := 2406 * 3;
  FTest := 'Value: ' + Random(224062).ToString + Random(240600).ToString;
end;

procedure TForm2406.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2406;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2406_List0 := TMyObj2406_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2406_List1 := TMyObj2406_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
