...
type
  ...
  TMyObj1224_List0 = TObjectList<TMyObj1224>;

  TMyObj1224_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1224_List1 = TObjectList<TMyObj1224_1>;
...
constructor TMyObj1224_1.Create;
begin
  inherited;
  FInt := 1224 * 3;
  FTest := 'Value: ' + Random(212242).ToString + Random(122400).ToString;
end;

procedure TForm1224.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1224;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1224_List0 := TMyObj1224_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1224_List1 := TMyObj1224_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
