...
type
  ...
  TMyObj719_List0 = TObjectList<TMyObj719>;

  TMyObj719_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj719_List1 = TObjectList<TMyObj719_1>;
...
constructor TMyObj719_1.Create;
begin
  inherited;
  FInt := 719 * 3;
  FTest := 'Value: ' + Random(27192).ToString + Random(71900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj719_List0 := TMyObj719_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj719_List1 := TMyObj719_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
