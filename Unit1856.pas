...
type
  ...
  TMyObj1856_List0 = TObjectList<TMyObj1856>;

  TMyObj1856_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1856_List1 = TObjectList<TMyObj1856_1>;
...
constructor TMyObj1856_1.Create;
begin
  inherited;
  FInt := 1856 * 3;
  FTest := 'Value: ' + Random(218562).ToString + Random(185600).ToString;
end;

procedure TForm1856.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1856;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1856_List0 := TMyObj1856_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1856_List1 := TMyObj1856_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
