...
type
  ...
  TMyObj1715_List0 = TObjectList<TMyObj1715>;

  TMyObj1715_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1715_List1 = TObjectList<TMyObj1715_1>;
...
constructor TMyObj1715_1.Create;
begin
  inherited;
  FInt := 1715 * 3;
  FTest := 'Value: ' + Random(217152).ToString + Random(171500).ToString;
end;

procedure TForm1715.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1715;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1715_List0 := TMyObj1715_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1715_List1 := TMyObj1715_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
