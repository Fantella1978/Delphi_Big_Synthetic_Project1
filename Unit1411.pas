...
type
  ...
  TMyObj1411_List0 = TObjectList<TMyObj1411>;

  TMyObj1411_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1411_List1 = TObjectList<TMyObj1411_1>;
...
constructor TMyObj1411_1.Create;
begin
  inherited;
  FInt := 1411 * 3;
  FTest := 'Value: ' + Random(214112).ToString + Random(141100).ToString;
end;

procedure TForm1411.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1411;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1411_List0 := TMyObj1411_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1411_List1 := TMyObj1411_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
