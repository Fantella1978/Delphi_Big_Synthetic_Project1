...
type
  ...
  TMyObj1377_List0 = TObjectList<TMyObj1377>;

  TMyObj1377_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1377_List1 = TObjectList<TMyObj1377_1>;
...
constructor TMyObj1377_1.Create;
begin
  inherited;
  FInt := 1377 * 3;
  FTest := 'Value: ' + Random(213772).ToString + Random(137700).ToString;
end;

procedure TForm1377.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1377;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1377_List0 := TMyObj1377_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1377_List1 := TMyObj1377_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
