...
type
  ...
  TMyObj1921_List0 = TObjectList<TMyObj1921>;

  TMyObj1921_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1921_List1 = TObjectList<TMyObj1921_1>;
...
constructor TMyObj1921_1.Create;
begin
  inherited;
  FInt := 1921 * 3;
  FTest := 'Value: ' + Random(219212).ToString + Random(192100).ToString;
end;

procedure TForm1921.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1921;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1921_List0 := TMyObj1921_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1921_List1 := TMyObj1921_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
