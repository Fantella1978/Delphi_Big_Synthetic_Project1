...
type
  ...
  TMyObj2368_List0 = TObjectList<TMyObj2368>;

  TMyObj2368_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2368_List1 = TObjectList<TMyObj2368_1>;
...
constructor TMyObj2368_1.Create;
begin
  inherited;
  FInt := 2368 * 3;
  FTest := 'Value: ' + Random(223682).ToString + Random(236800).ToString;
end;

procedure TForm2368.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2368;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2368_List0 := TMyObj2368_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2368_List1 := TMyObj2368_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
