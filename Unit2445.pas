...
type
  ...
  TMyObj2445_List0 = TObjectList<TMyObj2445>;

  TMyObj2445_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2445_List1 = TObjectList<TMyObj2445_1>;
...
constructor TMyObj2445_1.Create;
begin
  inherited;
  FInt := 2445 * 3;
  FTest := 'Value: ' + Random(224452).ToString + Random(244500).ToString;
end;

procedure TForm2445.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2445;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2445_List0 := TMyObj2445_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2445_List1 := TMyObj2445_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
