...
type
  ...
  TMyObj1279_List0 = TObjectList<TMyObj1279>;

  TMyObj1279_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1279_List1 = TObjectList<TMyObj1279_1>;
...
constructor TMyObj1279_1.Create;
begin
  inherited;
  FInt := 1279 * 3;
  FTest := 'Value: ' + Random(212792).ToString + Random(127900).ToString;
end;

procedure TForm1279.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1279;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1279_List0 := TMyObj1279_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1279_List1 := TMyObj1279_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
