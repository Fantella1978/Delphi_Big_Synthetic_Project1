...
type
  ...
  TMyObj2200_List0 = TObjectList<TMyObj2200>;

  TMyObj2200_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2200_List1 = TObjectList<TMyObj2200_1>;
...
constructor TMyObj2200_1.Create;
begin
  inherited;
  FInt := 2200 * 3;
  FTest := 'Value: ' + Random(222002).ToString + Random(220000).ToString;
end;

procedure TForm2200.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2200;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2200_List0 := TMyObj2200_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2200_List1 := TMyObj2200_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
