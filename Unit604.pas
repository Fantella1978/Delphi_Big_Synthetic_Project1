...
type
  ...
  TMyObj604_List0 = TObjectList<TMyObj604>;

  TMyObj604_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj604_List1 = TObjectList<TMyObj604_1>;
...
constructor TMyObj604_1.Create;
begin
  inherited;
  FInt := 604 * 3;
  FTest := 'Value: ' + Random(26042).ToString + Random(60400).ToString;
end;

procedure TForm604.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum604;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj604_List0 := TMyObj604_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj604_List1 := TMyObj604_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
