...
type
  ...
  TMyObj1416_List0 = TObjectList<TMyObj1416>;

  TMyObj1416_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1416_List1 = TObjectList<TMyObj1416_1>;
...
constructor TMyObj1416_1.Create;
begin
  inherited;
  FInt := 1416 * 3;
  FTest := 'Value: ' + Random(214162).ToString + Random(141600).ToString;
end;

procedure TForm1416.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1416;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1416_List0 := TMyObj1416_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1416_List1 := TMyObj1416_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
