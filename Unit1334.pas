...
type
  ...
  TMyObj1334_List0 = TObjectList<TMyObj1334>;

  TMyObj1334_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1334_List1 = TObjectList<TMyObj1334_1>;
...
constructor TMyObj1334_1.Create;
begin
  inherited;
  FInt := 1334 * 3;
  FTest := 'Value: ' + Random(213342).ToString + Random(133400).ToString;
end;

procedure TForm1334.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1334;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1334_List0 := TMyObj1334_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1334_List1 := TMyObj1334_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
