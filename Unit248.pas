...
type
  ...
  TMyObj248_List0 = TObjectList<TMyObj248>;

  TMyObj248_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj248_List1 = TObjectList<TMyObj248_1>;
...
constructor TMyObj248_1.Create;
begin
  inherited;
  FInt := 248 * 3;
  FTest := 'Value: ' + Random(22482).ToString + Random(24800).ToString;
end;

procedure TForm248.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum248;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj248_List0 := TMyObj248_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj248_List1 := TMyObj248_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
