...
type
  ...
  TMyObj2125_List0 = TObjectList<TMyObj2125>;

  TMyObj2125_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2125_List1 = TObjectList<TMyObj2125_1>;
...
constructor TMyObj2125_1.Create;
begin
  inherited;
  FInt := 2125 * 3;
  FTest := 'Value: ' + Random(221252).ToString + Random(212500).ToString;
end;

procedure TForm2125.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2125;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2125_List0 := TMyObj2125_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2125_List1 := TMyObj2125_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
