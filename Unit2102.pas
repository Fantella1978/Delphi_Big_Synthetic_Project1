...
type
  ...
  TMyObj2102_List0 = TObjectList<TMyObj2102>;

  TMyObj2102_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2102_List1 = TObjectList<TMyObj2102_1>;
...
constructor TMyObj2102_1.Create;
begin
  inherited;
  FInt := 2102 * 3;
  FTest := 'Value: ' + Random(221022).ToString + Random(210200).ToString;
end;

procedure TForm2102.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2102;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2102_List0 := TMyObj2102_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2102_List1 := TMyObj2102_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
