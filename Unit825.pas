...
type
  ...
  TMyObj825_List0 = TObjectList<TMyObj825>;

  TMyObj825_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj825_List1 = TObjectList<TMyObj825_1>;
...
constructor TMyObj825_1.Create;
begin
  inherited;
  FInt := 825 * 3;
  FTest := 'Value: ' + Random(28252).ToString + Random(82500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj825_List0 := TMyObj825_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj825_List1 := TMyObj825_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
