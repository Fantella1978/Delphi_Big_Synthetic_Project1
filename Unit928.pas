...
type
  ...
  TMyObj928_List0 = TObjectList<TMyObj928>;

  TMyObj928_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj928_List1 = TObjectList<TMyObj928_1>;
...
constructor TMyObj928_1.Create;
begin
  inherited;
  FInt := 928 * 3;
  FTest := 'Value: ' + Random(29282).ToString + Random(92800).ToString;
end;

procedure TForm928.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum928;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj928_List0 := TMyObj928_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj928_List1 := TMyObj928_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
