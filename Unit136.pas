...
type
  ...
  TMyObj136_List0 = TObjectList<TMyObj136>;

  TMyObj136_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj136_List1 = TObjectList<TMyObj136_1>;
...
constructor TMyObj136_1.Create;
begin
  inherited;
  FInt := 136 * 3;
  FTest := 'Value: ' + Random(21362).ToString + Random(13600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj136_List0 := TMyObj136_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj136_List1 := TMyObj136_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
