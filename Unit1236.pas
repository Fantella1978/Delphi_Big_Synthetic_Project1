...
type
  ...
  TMyObj1236_List0 = TObjectList<TMyObj1236>;

  TMyObj1236_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1236_List1 = TObjectList<TMyObj1236_1>;
...
constructor TMyObj1236_1.Create;
begin
  inherited;
  FInt := 1236 * 3;
  FTest := 'Value: ' + Random(212362).ToString + Random(123600).ToString;
end;

procedure TForm1236.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1236;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1236_List0 := TMyObj1236_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1236_List1 := TMyObj1236_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
