...
type
  ...
  TMyObj788_List0 = TObjectList<TMyObj788>;

  TMyObj788_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj788_List1 = TObjectList<TMyObj788_1>;
...
constructor TMyObj788_1.Create;
begin
  inherited;
  FInt := 788 * 3;
  FTest := 'Value: ' + Random(27882).ToString + Random(78800).ToString;
end;

procedure TForm788.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum788;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj788_List0 := TMyObj788_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj788_List1 := TMyObj788_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
