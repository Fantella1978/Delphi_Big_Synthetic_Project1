...
type
  ...
  TMyObj1080_List0 = TObjectList<TMyObj1080>;

  TMyObj1080_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1080_List1 = TObjectList<TMyObj1080_1>;
...
constructor TMyObj1080_1.Create;
begin
  inherited;
  FInt := 1080 * 3;
  FTest := 'Value: ' + Random(210802).ToString + Random(108000).ToString;
end;

procedure TForm1080.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1080;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1080_List0 := TMyObj1080_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1080_List1 := TMyObj1080_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
