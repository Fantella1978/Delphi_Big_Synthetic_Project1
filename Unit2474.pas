...
type
  ...
  TMyObj2474_List0 = TObjectList<TMyObj2474>;

  TMyObj2474_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2474_List1 = TObjectList<TMyObj2474_1>;
...
constructor TMyObj2474_1.Create;
begin
  inherited;
  FInt := 2474 * 3;
  FTest := 'Value: ' + Random(224742).ToString + Random(247400).ToString;
end;

procedure TForm2474.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2474;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2474_List0 := TMyObj2474_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2474_List1 := TMyObj2474_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
