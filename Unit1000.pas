...
type
  ...
  TMyObj1000_List0 = TObjectList<TMyObj1000>;

  TMyObj1000_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1000_List1 = TObjectList<TMyObj1000_1>;
...
constructor TMyObj1000_1.Create;
begin
  inherited;
  FInt := 1000 * 3;
  FTest := 'Value: ' + Random(210002).ToString + Random(100000).ToString;
end;

procedure TForm1000.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1000;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1000_List0 := TMyObj1000_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1000_List1 := TMyObj1000_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
