...
type
  ...
  TMyObj2408_List0 = TObjectList<TMyObj2408>;

  TMyObj2408_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2408_List1 = TObjectList<TMyObj2408_1>;
...
constructor TMyObj2408_1.Create;
begin
  inherited;
  FInt := 2408 * 3;
  FTest := 'Value: ' + Random(224082).ToString + Random(240800).ToString;
end;

procedure TForm2408.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2408;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2408_List0 := TMyObj2408_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2408_List1 := TMyObj2408_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
