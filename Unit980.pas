...
type
  ...
  TMyObj980_List0 = TObjectList<TMyObj980>;

  TMyObj980_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj980_List1 = TObjectList<TMyObj980_1>;
...
constructor TMyObj980_1.Create;
begin
  inherited;
  FInt := 980 * 3;
  FTest := 'Value: ' + Random(29802).ToString + Random(98000).ToString;
end;

procedure TForm980.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum980;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj980_List0 := TMyObj980_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj980_List1 := TMyObj980_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
