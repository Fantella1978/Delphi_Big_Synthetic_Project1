...
type
  ...
  TMyObj384_List0 = TObjectList<TMyObj384>;

  TMyObj384_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj384_List1 = TObjectList<TMyObj384_1>;
...
constructor TMyObj384_1.Create;
begin
  inherited;
  FInt := 384 * 3;
  FTest := 'Value: ' + Random(23842).ToString + Random(38400).ToString;
end;

procedure TForm384.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum384;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj384_List0 := TMyObj384_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj384_List1 := TMyObj384_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
