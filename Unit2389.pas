...
type
  ...
  TMyObj2389_List0 = TObjectList<TMyObj2389>;

  TMyObj2389_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2389_List1 = TObjectList<TMyObj2389_1>;
...
constructor TMyObj2389_1.Create;
begin
  inherited;
  FInt := 2389 * 3;
  FTest := 'Value: ' + Random(223892).ToString + Random(238900).ToString;
end;

procedure TForm2389.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2389;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2389_List0 := TMyObj2389_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2389_List1 := TMyObj2389_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
