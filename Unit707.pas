...
type
  ...
  TMyObj707_List0 = TObjectList<TMyObj707>;

  TMyObj707_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj707_List1 = TObjectList<TMyObj707_1>;
...
constructor TMyObj707_1.Create;
begin
  inherited;
  FInt := 707 * 3;
  FTest := 'Value: ' + Random(27072).ToString + Random(70700).ToString;
end;

procedure TForm707.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum707;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj707_List0 := TMyObj707_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj707_List1 := TMyObj707_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
