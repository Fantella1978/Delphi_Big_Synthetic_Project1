...
type
  ...
  TMyObj2171_List0 = TObjectList<TMyObj2171>;

  TMyObj2171_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2171_List1 = TObjectList<TMyObj2171_1>;
...
constructor TMyObj2171_1.Create;
begin
  inherited;
  FInt := 2171 * 3;
  FTest := 'Value: ' + Random(221712).ToString + Random(217100).ToString;
end;

procedure TForm2171.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2171;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2171_List0 := TMyObj2171_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2171_List1 := TMyObj2171_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
