...
type
  ...
  TMyObj153_List0 = TObjectList<TMyObj153>;

  TMyObj153_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj153_List1 = TObjectList<TMyObj153_1>;
...
constructor TMyObj153_1.Create;
begin
  inherited;
  FInt := 153 * 3;
  FTest := 'Value: ' + Random(21532).ToString + Random(15300).ToString;
end;

procedure TForm153.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum153;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj153_List0 := TMyObj153_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj153_List1 := TMyObj153_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
