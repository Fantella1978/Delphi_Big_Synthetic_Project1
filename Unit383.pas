...
type
  ...
  TMyObj383_List0 = TObjectList<TMyObj383>;

  TMyObj383_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj383_List1 = TObjectList<TMyObj383_1>;
...
constructor TMyObj383_1.Create;
begin
  inherited;
  FInt := 383 * 3;
  FTest := 'Value: ' + Random(23832).ToString + Random(38300).ToString;
end;

procedure TForm383.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum383;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj383_List0 := TMyObj383_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj383_List1 := TMyObj383_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
