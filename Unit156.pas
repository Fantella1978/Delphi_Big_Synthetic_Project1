...
type
  ...
  TMyObj156_List0 = TObjectList<TMyObj156>;

  TMyObj156_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj156_List1 = TObjectList<TMyObj156_1>;
...
constructor TMyObj156_1.Create;
begin
  inherited;
  FInt := 156 * 3;
  FTest := 'Value: ' + Random(21562).ToString + Random(15600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj156_List0 := TMyObj156_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj156_List1 := TMyObj156_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
