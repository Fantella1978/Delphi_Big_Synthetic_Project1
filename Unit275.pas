...
type
  ...
  TMyObj275_List0 = TObjectList<TMyObj275>;

  TMyObj275_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj275_List1 = TObjectList<TMyObj275_1>;
...
constructor TMyObj275_1.Create;
begin
  inherited;
  FInt := 275 * 3;
  FTest := 'Value: ' + Random(22752).ToString + Random(27500).ToString;
end;

procedure TForm275.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum275;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj275_List0 := TMyObj275_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj275_List1 := TMyObj275_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
