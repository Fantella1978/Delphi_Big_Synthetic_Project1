...
type
  ...
  TMyObj557_List0 = TObjectList<TMyObj557>;

  TMyObj557_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj557_List1 = TObjectList<TMyObj557_1>;
...
constructor TMyObj557_1.Create;
begin
  inherited;
  FInt := 557 * 3;
  FTest := 'Value: ' + Random(25572).ToString + Random(55700).ToString;
end;

procedure TForm557.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum557;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj557_List0 := TMyObj557_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj557_List1 := TMyObj557_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
