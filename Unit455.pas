...
type
  ...
  TMyObj455_List0 = TObjectList<TMyObj455>;

  TMyObj455_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj455_List1 = TObjectList<TMyObj455_1>;
...
constructor TMyObj455_1.Create;
begin
  inherited;
  FInt := 455 * 3;
  FTest := 'Value: ' + Random(24552).ToString + Random(45500).ToString;
end;

procedure TForm455.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum455;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj455_List0 := TMyObj455_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj455_List1 := TMyObj455_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
