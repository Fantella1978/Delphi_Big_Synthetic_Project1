...
type
  ...
  TMyObj868_List0 = TObjectList<TMyObj868>;

  TMyObj868_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj868_List1 = TObjectList<TMyObj868_1>;
...
constructor TMyObj868_1.Create;
begin
  inherited;
  FInt := 868 * 3;
  FTest := 'Value: ' + Random(28682).ToString + Random(86800).ToString;
end;

procedure TForm868.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum868;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj868_List0 := TMyObj868_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj868_List1 := TMyObj868_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
