...
type
  ...
  TMyObj44_List0 = TObjectList<TMyObj44>;

  TMyObj44_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj44_List1 = TObjectList<TMyObj44_1>;
...
constructor TMyObj44_1.Create;
begin
  inherited;
  FInt := 44 * 3;
  FTest := 'Value: ' + Random(2442).ToString + Random(4400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj44_List0 := TMyObj44_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj44_List1 := TMyObj44_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
