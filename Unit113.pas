...
type
  ...
  TMyObj113_List0 = TObjectList<TMyObj113>;

  TMyObj113_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj113_List1 = TObjectList<TMyObj113_1>;
...
constructor TMyObj113_1.Create;
begin
  inherited;
  FInt := 113 * 3;
  FTest := 'Value: ' + Random(21132).ToString + Random(11300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj113_List0 := TMyObj113_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj113_List1 := TMyObj113_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
