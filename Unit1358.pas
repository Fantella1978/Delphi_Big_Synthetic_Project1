...
type
  ...
  TMyObj1358_List0 = TObjectList<TMyObj1358>;

  TMyObj1358_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1358_List1 = TObjectList<TMyObj1358_1>;
...
constructor TMyObj1358_1.Create;
begin
  inherited;
  FInt := 1358 * 3;
  FTest := 'Value: ' + Random(213582).ToString + Random(135800).ToString;
end;

procedure TForm1358.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1358;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1358_List0 := TMyObj1358_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1358_List1 := TMyObj1358_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
