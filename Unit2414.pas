...
type
  ...
  TMyObj2414_List0 = TObjectList<TMyObj2414>;

  TMyObj2414_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2414_List1 = TObjectList<TMyObj2414_1>;
...
constructor TMyObj2414_1.Create;
begin
  inherited;
  FInt := 2414 * 3;
  FTest := 'Value: ' + Random(224142).ToString + Random(241400).ToString;
end;

procedure TForm2414.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2414;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2414_List0 := TMyObj2414_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2414_List1 := TMyObj2414_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
