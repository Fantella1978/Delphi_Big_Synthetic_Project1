...
type
  ...
  TMyObj30_List0 = TObjectList<TMyObj30>;

  TMyObj30_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj30_List1 = TObjectList<TMyObj30_1>;
...
constructor TMyObj30_1.Create;
begin
  inherited;
  FInt := 30 * 3;
  FTest := 'Value: ' + Random(2302).ToString + Random(3000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj30_List0 := TMyObj30_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj30_List1 := TMyObj30_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
