...
type
  ...
  TMyObj211_List0 = TObjectList<TMyObj211>;

  TMyObj211_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj211_List1 = TObjectList<TMyObj211_1>;
...
constructor TMyObj211_1.Create;
begin
  inherited;
  FInt := 211 * 3;
  FTest := 'Value: ' + Random(22112).ToString + Random(21100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj211_List0 := TMyObj211_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj211_List1 := TMyObj211_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
