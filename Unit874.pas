...
type
  ...
  TMyObj874_List0 = TObjectList<TMyObj874>;

  TMyObj874_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj874_List1 = TObjectList<TMyObj874_1>;
...
constructor TMyObj874_1.Create;
begin
  inherited;
  FInt := 874 * 3;
  FTest := 'Value: ' + Random(28742).ToString + Random(87400).ToString;
end;

procedure TForm874.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum874;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj874_List0 := TMyObj874_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj874_List1 := TMyObj874_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
