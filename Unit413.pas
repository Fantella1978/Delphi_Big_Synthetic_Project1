...
type
  ...
  TMyObj413_List0 = TObjectList<TMyObj413>;

  TMyObj413_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj413_List1 = TObjectList<TMyObj413_1>;
...
constructor TMyObj413_1.Create;
begin
  inherited;
  FInt := 413 * 3;
  FTest := 'Value: ' + Random(24132).ToString + Random(41300).ToString;
end;

procedure TForm413.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum413;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj413_List0 := TMyObj413_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj413_List1 := TMyObj413_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
