...
type
  ...
  TMyObj648_List0 = TObjectList<TMyObj648>;

  TMyObj648_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj648_List1 = TObjectList<TMyObj648_1>;
...
constructor TMyObj648_1.Create;
begin
  inherited;
  FInt := 648 * 3;
  FTest := 'Value: ' + Random(26482).ToString + Random(64800).ToString;
end;

procedure TForm648.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum648;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj648_List0 := TMyObj648_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj648_List1 := TMyObj648_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
