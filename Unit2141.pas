...
type
  ...
  TMyObj2141_List0 = TObjectList<TMyObj2141>;

  TMyObj2141_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2141_List1 = TObjectList<TMyObj2141_1>;
...
constructor TMyObj2141_1.Create;
begin
  inherited;
  FInt := 2141 * 3;
  FTest := 'Value: ' + Random(221412).ToString + Random(214100).ToString;
end;

procedure TForm2141.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2141;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2141_List0 := TMyObj2141_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2141_List1 := TMyObj2141_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
