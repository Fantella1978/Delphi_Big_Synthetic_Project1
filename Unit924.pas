...
type
  ...
  TMyObj924_List0 = TObjectList<TMyObj924>;

  TMyObj924_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj924_List1 = TObjectList<TMyObj924_1>;
...
constructor TMyObj924_1.Create;
begin
  inherited;
  FInt := 924 * 3;
  FTest := 'Value: ' + Random(29242).ToString + Random(92400).ToString;
end;

procedure TForm924.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum924;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj924_List0 := TMyObj924_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj924_List1 := TMyObj924_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
