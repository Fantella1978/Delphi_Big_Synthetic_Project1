...
type
  ...
  TMyObj969_List0 = TObjectList<TMyObj969>;

  TMyObj969_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj969_List1 = TObjectList<TMyObj969_1>;
...
constructor TMyObj969_1.Create;
begin
  inherited;
  FInt := 969 * 3;
  FTest := 'Value: ' + Random(29692).ToString + Random(96900).ToString;
end;

procedure TForm969.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum969;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj969_List0 := TMyObj969_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj969_List1 := TMyObj969_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
