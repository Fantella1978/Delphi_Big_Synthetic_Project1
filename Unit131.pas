...
type
  ...
  TMyObj131_List0 = TObjectList<TMyObj131>;

  TMyObj131_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj131_List1 = TObjectList<TMyObj131_1>;
...
constructor TMyObj131_1.Create;
begin
  inherited;
  FInt := 131 * 3;
  FTest := 'Value: ' + Random(21312).ToString + Random(13100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj131_List0 := TMyObj131_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj131_List1 := TMyObj131_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
