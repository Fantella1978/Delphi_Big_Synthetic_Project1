...
type
  ...
  TMyObj2310_List0 = TObjectList<TMyObj2310>;

  TMyObj2310_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2310_List1 = TObjectList<TMyObj2310_1>;
...
constructor TMyObj2310_1.Create;
begin
  inherited;
  FInt := 2310 * 3;
  FTest := 'Value: ' + Random(223102).ToString + Random(231000).ToString;
end;

procedure TForm2310.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2310;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2310_List0 := TMyObj2310_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2310_List1 := TMyObj2310_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
