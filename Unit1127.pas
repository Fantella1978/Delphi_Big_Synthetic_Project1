...
type
  ...
  TMyObj1127_List0 = TObjectList<TMyObj1127>;

  TMyObj1127_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1127_List1 = TObjectList<TMyObj1127_1>;
...
constructor TMyObj1127_1.Create;
begin
  inherited;
  FInt := 1127 * 3;
  FTest := 'Value: ' + Random(211272).ToString + Random(112700).ToString;
end;

procedure TForm1127.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1127;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1127_List0 := TMyObj1127_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1127_List1 := TMyObj1127_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
