...
type
  ...
  TMyObj725_List0 = TObjectList<TMyObj725>;

  TMyObj725_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj725_List1 = TObjectList<TMyObj725_1>;
...
constructor TMyObj725_1.Create;
begin
  inherited;
  FInt := 725 * 3;
  FTest := 'Value: ' + Random(27252).ToString + Random(72500).ToString;
end;

procedure TForm725.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum725;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj725_List0 := TMyObj725_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj725_List1 := TMyObj725_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
