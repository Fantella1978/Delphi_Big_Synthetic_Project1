...
type
  ...
  TMyObj2080_List0 = TObjectList<TMyObj2080>;

  TMyObj2080_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2080_List1 = TObjectList<TMyObj2080_1>;
...
constructor TMyObj2080_1.Create;
begin
  inherited;
  FInt := 2080 * 3;
  FTest := 'Value: ' + Random(220802).ToString + Random(208000).ToString;
end;

procedure TForm2080.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2080;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2080_List0 := TMyObj2080_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2080_List1 := TMyObj2080_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
