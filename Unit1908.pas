...
type
  ...
  TMyObj1908_List0 = TObjectList<TMyObj1908>;

  TMyObj1908_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1908_List1 = TObjectList<TMyObj1908_1>;
...
constructor TMyObj1908_1.Create;
begin
  inherited;
  FInt := 1908 * 3;
  FTest := 'Value: ' + Random(219082).ToString + Random(190800).ToString;
end;

procedure TForm1908.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1908;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1908_List0 := TMyObj1908_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1908_List1 := TMyObj1908_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
