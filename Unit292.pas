...
type
  ...
  TMyObj292_List0 = TObjectList<TMyObj292>;

  TMyObj292_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj292_List1 = TObjectList<TMyObj292_1>;
...
constructor TMyObj292_1.Create;
begin
  inherited;
  FInt := 292 * 3;
  FTest := 'Value: ' + Random(22922).ToString + Random(29200).ToString;
end;

procedure TForm292.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum292;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj292_List0 := TMyObj292_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj292_List1 := TMyObj292_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
