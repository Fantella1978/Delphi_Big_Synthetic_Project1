...
type
  ...
  TMyObj1200_List0 = TObjectList<TMyObj1200>;

  TMyObj1200_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1200_List1 = TObjectList<TMyObj1200_1>;
...
constructor TMyObj1200_1.Create;
begin
  inherited;
  FInt := 1200 * 3;
  FTest := 'Value: ' + Random(212002).ToString + Random(120000).ToString;
end;

procedure TForm1200.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1200;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1200_List0 := TMyObj1200_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1200_List1 := TMyObj1200_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
