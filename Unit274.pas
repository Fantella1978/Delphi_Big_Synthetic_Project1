...
type
  ...
  TMyObj274_List0 = TObjectList<TMyObj274>;

  TMyObj274_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj274_List1 = TObjectList<TMyObj274_1>;
...
constructor TMyObj274_1.Create;
begin
  inherited;
  FInt := 274 * 3;
  FTest := 'Value: ' + Random(22742).ToString + Random(27400).ToString;
end;

procedure TForm274.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum274;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj274_List0 := TMyObj274_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj274_List1 := TMyObj274_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
