...
type
  ...
  TMyObj1022_List0 = TObjectList<TMyObj1022>;

  TMyObj1022_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1022_List1 = TObjectList<TMyObj1022_1>;
...
constructor TMyObj1022_1.Create;
begin
  inherited;
  FInt := 1022 * 3;
  FTest := 'Value: ' + Random(210222).ToString + Random(102200).ToString;
end;

procedure TForm1022.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1022;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1022_List0 := TMyObj1022_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1022_List1 := TMyObj1022_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
