...
type
  ...
  TMyObj1405_List0 = TObjectList<TMyObj1405>;

  TMyObj1405_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1405_List1 = TObjectList<TMyObj1405_1>;
...
constructor TMyObj1405_1.Create;
begin
  inherited;
  FInt := 1405 * 3;
  FTest := 'Value: ' + Random(214052).ToString + Random(140500).ToString;
end;

procedure TForm1405.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1405;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1405_List0 := TMyObj1405_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1405_List1 := TMyObj1405_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
