...
type
  ...
  TMyObj1678_List0 = TObjectList<TMyObj1678>;

  TMyObj1678_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1678_List1 = TObjectList<TMyObj1678_1>;
...
constructor TMyObj1678_1.Create;
begin
  inherited;
  FInt := 1678 * 3;
  FTest := 'Value: ' + Random(216782).ToString + Random(167800).ToString;
end;

procedure TForm1678.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1678;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1678_List0 := TMyObj1678_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1678_List1 := TMyObj1678_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
