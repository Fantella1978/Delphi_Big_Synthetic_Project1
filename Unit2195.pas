...
type
  ...
  TMyObj2195_List0 = TObjectList<TMyObj2195>;

  TMyObj2195_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2195_List1 = TObjectList<TMyObj2195_1>;
...
constructor TMyObj2195_1.Create;
begin
  inherited;
  FInt := 2195 * 3;
  FTest := 'Value: ' + Random(221952).ToString + Random(219500).ToString;
end;

procedure TForm2195.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2195;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2195_List0 := TMyObj2195_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2195_List1 := TMyObj2195_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
