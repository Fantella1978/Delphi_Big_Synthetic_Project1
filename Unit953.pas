...
type
  ...
  TMyObj953_List0 = TObjectList<TMyObj953>;

  TMyObj953_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj953_List1 = TObjectList<TMyObj953_1>;
...
constructor TMyObj953_1.Create;
begin
  inherited;
  FInt := 953 * 3;
  FTest := 'Value: ' + Random(29532).ToString + Random(95300).ToString;
end;

procedure TForm953.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum953;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj953_List0 := TMyObj953_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj953_List1 := TMyObj953_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
