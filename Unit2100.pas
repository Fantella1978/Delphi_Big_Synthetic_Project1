...
type
  ...
  TMyObj2100_List0 = TObjectList<TMyObj2100>;

  TMyObj2100_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2100_List1 = TObjectList<TMyObj2100_1>;
...
constructor TMyObj2100_1.Create;
begin
  inherited;
  FInt := 2100 * 3;
  FTest := 'Value: ' + Random(221002).ToString + Random(210000).ToString;
end;

procedure TForm2100.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2100;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2100_List0 := TMyObj2100_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2100_List1 := TMyObj2100_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
