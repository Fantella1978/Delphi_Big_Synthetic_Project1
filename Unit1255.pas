...
type
  ...
  TMyObj1255_List0 = TObjectList<TMyObj1255>;

  TMyObj1255_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1255_List1 = TObjectList<TMyObj1255_1>;
...
constructor TMyObj1255_1.Create;
begin
  inherited;
  FInt := 1255 * 3;
  FTest := 'Value: ' + Random(212552).ToString + Random(125500).ToString;
end;

procedure TForm1255.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1255;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1255_List0 := TMyObj1255_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1255_List1 := TMyObj1255_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
