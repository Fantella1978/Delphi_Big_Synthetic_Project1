...
type
  ...
  TMyObj1341_List0 = TObjectList<TMyObj1341>;

  TMyObj1341_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1341_List1 = TObjectList<TMyObj1341_1>;
...
constructor TMyObj1341_1.Create;
begin
  inherited;
  FInt := 1341 * 3;
  FTest := 'Value: ' + Random(213412).ToString + Random(134100).ToString;
end;

procedure TForm1341.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1341;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1341_List0 := TMyObj1341_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1341_List1 := TMyObj1341_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
