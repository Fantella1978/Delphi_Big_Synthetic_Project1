...
type
  ...
  TMyObj1290_List0 = TObjectList<TMyObj1290>;

  TMyObj1290_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1290_List1 = TObjectList<TMyObj1290_1>;
...
constructor TMyObj1290_1.Create;
begin
  inherited;
  FInt := 1290 * 3;
  FTest := 'Value: ' + Random(212902).ToString + Random(129000).ToString;
end;

procedure TForm1290.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1290;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1290_List0 := TMyObj1290_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1290_List1 := TMyObj1290_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
