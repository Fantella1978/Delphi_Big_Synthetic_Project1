...
type
  ...
  TMyObj1810_List0 = TObjectList<TMyObj1810>;

  TMyObj1810_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1810_List1 = TObjectList<TMyObj1810_1>;
...
constructor TMyObj1810_1.Create;
begin
  inherited;
  FInt := 1810 * 3;
  FTest := 'Value: ' + Random(218102).ToString + Random(181000).ToString;
end;

procedure TForm1810.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1810;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1810_List0 := TMyObj1810_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1810_List1 := TMyObj1810_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
