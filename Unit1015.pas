...
type
  ...
  TMyObj1015_List0 = TObjectList<TMyObj1015>;

  TMyObj1015_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1015_List1 = TObjectList<TMyObj1015_1>;
...
constructor TMyObj1015_1.Create;
begin
  inherited;
  FInt := 1015 * 3;
  FTest := 'Value: ' + Random(210152).ToString + Random(101500).ToString;
end;

procedure TForm1015.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1015;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1015_List0 := TMyObj1015_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1015_List1 := TMyObj1015_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
