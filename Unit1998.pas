...
type
  ...
  TMyObj1998_List0 = TObjectList<TMyObj1998>;

  TMyObj1998_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1998_List1 = TObjectList<TMyObj1998_1>;
...
constructor TMyObj1998_1.Create;
begin
  inherited;
  FInt := 1998 * 3;
  FTest := 'Value: ' + Random(219982).ToString + Random(199800).ToString;
end;

procedure TForm1998.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1998;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1998_List0 := TMyObj1998_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1998_List1 := TMyObj1998_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
