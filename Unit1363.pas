...
type
  ...
  TMyObj1363_List0 = TObjectList<TMyObj1363>;

  TMyObj1363_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1363_List1 = TObjectList<TMyObj1363_1>;
...
constructor TMyObj1363_1.Create;
begin
  inherited;
  FInt := 1363 * 3;
  FTest := 'Value: ' + Random(213632).ToString + Random(136300).ToString;
end;

procedure TForm1363.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1363;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1363_List0 := TMyObj1363_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1363_List1 := TMyObj1363_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
