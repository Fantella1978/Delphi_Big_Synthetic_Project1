...
type
  ...
  TMyObj1753_List0 = TObjectList<TMyObj1753>;

  TMyObj1753_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1753_List1 = TObjectList<TMyObj1753_1>;
...
constructor TMyObj1753_1.Create;
begin
  inherited;
  FInt := 1753 * 3;
  FTest := 'Value: ' + Random(217532).ToString + Random(175300).ToString;
end;

procedure TForm1753.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1753;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1753_List0 := TMyObj1753_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1753_List1 := TMyObj1753_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
