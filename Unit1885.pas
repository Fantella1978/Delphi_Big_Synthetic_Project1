...
type
  ...
  TMyObj1885_List0 = TObjectList<TMyObj1885>;

  TMyObj1885_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1885_List1 = TObjectList<TMyObj1885_1>;
...
constructor TMyObj1885_1.Create;
begin
  inherited;
  FInt := 1885 * 3;
  FTest := 'Value: ' + Random(218852).ToString + Random(188500).ToString;
end;

procedure TForm1885.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1885;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1885_List0 := TMyObj1885_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1885_List1 := TMyObj1885_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
