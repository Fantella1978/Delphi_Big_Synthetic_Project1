...
type
  ...
  TMyObj332_List0 = TObjectList<TMyObj332>;

  TMyObj332_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj332_List1 = TObjectList<TMyObj332_1>;
...
constructor TMyObj332_1.Create;
begin
  inherited;
  FInt := 332 * 3;
  FTest := 'Value: ' + Random(23322).ToString + Random(33200).ToString;
end;

procedure TForm332.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum332;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj332_List0 := TMyObj332_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj332_List1 := TMyObj332_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
