...
type
  ...
  TMyObj2396_List0 = TObjectList<TMyObj2396>;

  TMyObj2396_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2396_List1 = TObjectList<TMyObj2396_1>;
...
constructor TMyObj2396_1.Create;
begin
  inherited;
  FInt := 2396 * 3;
  FTest := 'Value: ' + Random(223962).ToString + Random(239600).ToString;
end;

procedure TForm2396.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2396;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2396_List0 := TMyObj2396_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2396_List1 := TMyObj2396_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
