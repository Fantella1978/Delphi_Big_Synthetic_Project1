...
type
  ...
  TMyObj1923_List0 = TObjectList<TMyObj1923>;

  TMyObj1923_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1923_List1 = TObjectList<TMyObj1923_1>;
...
constructor TMyObj1923_1.Create;
begin
  inherited;
  FInt := 1923 * 3;
  FTest := 'Value: ' + Random(219232).ToString + Random(192300).ToString;
end;

procedure TForm1923.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1923;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1923_List0 := TMyObj1923_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1923_List1 := TMyObj1923_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
