...
type
  ...
  TMyObj350_List0 = TObjectList<TMyObj350>;

  TMyObj350_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj350_List1 = TObjectList<TMyObj350_1>;
...
constructor TMyObj350_1.Create;
begin
  inherited;
  FInt := 350 * 3;
  FTest := 'Value: ' + Random(23502).ToString + Random(35000).ToString;
end;

procedure TForm350.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum350;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj350_List0 := TMyObj350_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj350_List1 := TMyObj350_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
