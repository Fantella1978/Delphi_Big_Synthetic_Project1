...
type
  ...
  TMyObj249_List0 = TObjectList<TMyObj249>;

  TMyObj249_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj249_List1 = TObjectList<TMyObj249_1>;
...
constructor TMyObj249_1.Create;
begin
  inherited;
  FInt := 249 * 3;
  FTest := 'Value: ' + Random(22492).ToString + Random(24900).ToString;
end;

procedure TForm249.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum249;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj249_List0 := TMyObj249_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj249_List1 := TMyObj249_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
