...
type
  ...
  TMyObj1102_List0 = TObjectList<TMyObj1102>;

  TMyObj1102_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1102_List1 = TObjectList<TMyObj1102_1>;
...
constructor TMyObj1102_1.Create;
begin
  inherited;
  FInt := 1102 * 3;
  FTest := 'Value: ' + Random(211022).ToString + Random(110200).ToString;
end;

procedure TForm1102.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1102;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1102_List0 := TMyObj1102_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1102_List1 := TMyObj1102_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
