...
type
  ...
  TMyObj2154_List0 = TObjectList<TMyObj2154>;

  TMyObj2154_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2154_List1 = TObjectList<TMyObj2154_1>;
...
constructor TMyObj2154_1.Create;
begin
  inherited;
  FInt := 2154 * 3;
  FTest := 'Value: ' + Random(221542).ToString + Random(215400).ToString;
end;

procedure TForm2154.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2154;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2154_List0 := TMyObj2154_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2154_List1 := TMyObj2154_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
