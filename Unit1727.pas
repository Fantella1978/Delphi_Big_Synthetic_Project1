...
type
  ...
  TMyObj1727_List0 = TObjectList<TMyObj1727>;

  TMyObj1727_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1727_List1 = TObjectList<TMyObj1727_1>;
...
constructor TMyObj1727_1.Create;
begin
  inherited;
  FInt := 1727 * 3;
  FTest := 'Value: ' + Random(217272).ToString + Random(172700).ToString;
end;

procedure TForm1727.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1727;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1727_List0 := TMyObj1727_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1727_List1 := TMyObj1727_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
