...
type
  ...
  TMyObj424_List0 = TObjectList<TMyObj424>;

  TMyObj424_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj424_List1 = TObjectList<TMyObj424_1>;
...
constructor TMyObj424_1.Create;
begin
  inherited;
  FInt := 424 * 3;
  FTest := 'Value: ' + Random(24242).ToString + Random(42400).ToString;
end;

procedure TForm424.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum424;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj424_List0 := TMyObj424_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj424_List1 := TMyObj424_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
