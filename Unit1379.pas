...
type
  ...
  TMyObj1379_List0 = TObjectList<TMyObj1379>;

  TMyObj1379_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1379_List1 = TObjectList<TMyObj1379_1>;
...
constructor TMyObj1379_1.Create;
begin
  inherited;
  FInt := 1379 * 3;
  FTest := 'Value: ' + Random(213792).ToString + Random(137900).ToString;
end;

procedure TForm1379.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1379;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1379_List0 := TMyObj1379_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1379_List1 := TMyObj1379_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
