...
type
  ...
  TMyObj1477_List0 = TObjectList<TMyObj1477>;

  TMyObj1477_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1477_List1 = TObjectList<TMyObj1477_1>;
...
constructor TMyObj1477_1.Create;
begin
  inherited;
  FInt := 1477 * 3;
  FTest := 'Value: ' + Random(214772).ToString + Random(147700).ToString;
end;

procedure TForm1477.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1477;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1477_List0 := TMyObj1477_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1477_List1 := TMyObj1477_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
