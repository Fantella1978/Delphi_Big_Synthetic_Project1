...
type
  ...
  TMyObj1230_List0 = TObjectList<TMyObj1230>;

  TMyObj1230_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1230_List1 = TObjectList<TMyObj1230_1>;
...
constructor TMyObj1230_1.Create;
begin
  inherited;
  FInt := 1230 * 3;
  FTest := 'Value: ' + Random(212302).ToString + Random(123000).ToString;
end;

procedure TForm1230.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1230;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1230_List0 := TMyObj1230_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1230_List1 := TMyObj1230_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
