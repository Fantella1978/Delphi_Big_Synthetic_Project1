...
type
  ...
  TMyObj1687_List0 = TObjectList<TMyObj1687>;

  TMyObj1687_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1687_List1 = TObjectList<TMyObj1687_1>;
...
constructor TMyObj1687_1.Create;
begin
  inherited;
  FInt := 1687 * 3;
  FTest := 'Value: ' + Random(216872).ToString + Random(168700).ToString;
end;

procedure TForm1687.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1687;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1687_List0 := TMyObj1687_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1687_List1 := TMyObj1687_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
