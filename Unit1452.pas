...
type
  ...
  TMyObj1452_List0 = TObjectList<TMyObj1452>;

  TMyObj1452_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1452_List1 = TObjectList<TMyObj1452_1>;
...
constructor TMyObj1452_1.Create;
begin
  inherited;
  FInt := 1452 * 3;
  FTest := 'Value: ' + Random(214522).ToString + Random(145200).ToString;
end;

procedure TForm1452.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1452;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1452_List0 := TMyObj1452_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1452_List1 := TMyObj1452_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
