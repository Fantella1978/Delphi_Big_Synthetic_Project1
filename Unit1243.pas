...
type
  ...
  TMyObj1243_List0 = TObjectList<TMyObj1243>;

  TMyObj1243_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1243_List1 = TObjectList<TMyObj1243_1>;
...
constructor TMyObj1243_1.Create;
begin
  inherited;
  FInt := 1243 * 3;
  FTest := 'Value: ' + Random(212432).ToString + Random(124300).ToString;
end;

procedure TForm1243.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1243;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1243_List0 := TMyObj1243_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1243_List1 := TMyObj1243_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
