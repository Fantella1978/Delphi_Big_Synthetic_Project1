...
type
  ...
  TMyObj1945_List0 = TObjectList<TMyObj1945>;

  TMyObj1945_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1945_List1 = TObjectList<TMyObj1945_1>;
...
constructor TMyObj1945_1.Create;
begin
  inherited;
  FInt := 1945 * 3;
  FTest := 'Value: ' + Random(219452).ToString + Random(194500).ToString;
end;

procedure TForm1945.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1945;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1945_List0 := TMyObj1945_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1945_List1 := TMyObj1945_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
