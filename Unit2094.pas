...
type
  ...
  TMyObj2094_List0 = TObjectList<TMyObj2094>;

  TMyObj2094_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2094_List1 = TObjectList<TMyObj2094_1>;
...
constructor TMyObj2094_1.Create;
begin
  inherited;
  FInt := 2094 * 3;
  FTest := 'Value: ' + Random(220942).ToString + Random(209400).ToString;
end;

procedure TForm2094.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2094;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2094_List0 := TMyObj2094_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2094_List1 := TMyObj2094_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
