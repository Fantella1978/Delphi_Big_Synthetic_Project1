...
type
  ...
  TMyObj47_List0 = TObjectList<TMyObj47>;

  TMyObj47_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj47_List1 = TObjectList<TMyObj47_1>;
...
constructor TMyObj47_1.Create;
begin
  inherited;
  FInt := 47 * 3;
  FTest := 'Value: ' + Random(2472).ToString + Random(4700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj47_List0 := TMyObj47_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj47_List1 := TMyObj47_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
