...
type
  ...
  TMyObj158_List0 = TObjectList<TMyObj158>;

  TMyObj158_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj158_List1 = TObjectList<TMyObj158_1>;
...
constructor TMyObj158_1.Create;
begin
  inherited;
  FInt := 158 * 3;
  FTest := 'Value: ' + Random(21582).ToString + Random(15800).ToString;
end;

procedure TForm158.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum158;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj158_List0 := TMyObj158_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj158_List1 := TMyObj158_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
