...
type
  ...
  TMyObj273_List0 = TObjectList<TMyObj273>;

  TMyObj273_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj273_List1 = TObjectList<TMyObj273_1>;
...
constructor TMyObj273_1.Create;
begin
  inherited;
  FInt := 273 * 3;
  FTest := 'Value: ' + Random(22732).ToString + Random(27300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj273_List0 := TMyObj273_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj273_List1 := TMyObj273_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
