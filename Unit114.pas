...
type
  ...
  TMyObj114_List0 = TObjectList<TMyObj114>;

  TMyObj114_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj114_List1 = TObjectList<TMyObj114_1>;
...
constructor TMyObj114_1.Create;
begin
  inherited;
  FInt := 114 * 3;
  FTest := 'Value: ' + Random(21142).ToString + Random(11400).ToString;
end;

procedure TForm114.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum114;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj114_List0 := TMyObj114_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj114_List1 := TMyObj114_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
