...
type
  ...
  TMyObj2039_List0 = TObjectList<TMyObj2039>;

  TMyObj2039_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2039_List1 = TObjectList<TMyObj2039_1>;
...
constructor TMyObj2039_1.Create;
begin
  inherited;
  FInt := 2039 * 3;
  FTest := 'Value: ' + Random(220392).ToString + Random(203900).ToString;
end;

procedure TForm2039.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2039;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2039_List0 := TMyObj2039_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2039_List1 := TMyObj2039_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
