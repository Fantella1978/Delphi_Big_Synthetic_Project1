...
type
  ...
  TMyObj1374_List0 = TObjectList<TMyObj1374>;

  TMyObj1374_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1374_List1 = TObjectList<TMyObj1374_1>;
...
constructor TMyObj1374_1.Create;
begin
  inherited;
  FInt := 1374 * 3;
  FTest := 'Value: ' + Random(213742).ToString + Random(137400).ToString;
end;

procedure TForm1374.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1374;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1374_List0 := TMyObj1374_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1374_List1 := TMyObj1374_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
