...
type
  ...
  TMyObj334_List0 = TObjectList<TMyObj334>;

  TMyObj334_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj334_List1 = TObjectList<TMyObj334_1>;
...
constructor TMyObj334_1.Create;
begin
  inherited;
  FInt := 334 * 3;
  FTest := 'Value: ' + Random(23342).ToString + Random(33400).ToString;
end;

procedure TForm334.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum334;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj334_List0 := TMyObj334_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj334_List1 := TMyObj334_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
