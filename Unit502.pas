...
type
  ...
  TMyObj502_List0 = TObjectList<TMyObj502>;

  TMyObj502_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj502_List1 = TObjectList<TMyObj502_1>;
...
constructor TMyObj502_1.Create;
begin
  inherited;
  FInt := 502 * 3;
  FTest := 'Value: ' + Random(25022).ToString + Random(50200).ToString;
end;

procedure TForm502.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum502;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj502_List0 := TMyObj502_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj502_List1 := TMyObj502_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
