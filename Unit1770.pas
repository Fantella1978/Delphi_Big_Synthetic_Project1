...
type
  ...
  TMyObj1770_List0 = TObjectList<TMyObj1770>;

  TMyObj1770_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1770_List1 = TObjectList<TMyObj1770_1>;
...
constructor TMyObj1770_1.Create;
begin
  inherited;
  FInt := 1770 * 3;
  FTest := 'Value: ' + Random(217702).ToString + Random(177000).ToString;
end;

procedure TForm1770.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1770;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1770_List0 := TMyObj1770_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1770_List1 := TMyObj1770_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
