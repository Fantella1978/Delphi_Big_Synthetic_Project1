...
type
  ...
  TMyObj2058_List0 = TObjectList<TMyObj2058>;

  TMyObj2058_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2058_List1 = TObjectList<TMyObj2058_1>;
...
constructor TMyObj2058_1.Create;
begin
  inherited;
  FInt := 2058 * 3;
  FTest := 'Value: ' + Random(220582).ToString + Random(205800).ToString;
end;

procedure TForm2058.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2058;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2058_List0 := TMyObj2058_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2058_List1 := TMyObj2058_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
