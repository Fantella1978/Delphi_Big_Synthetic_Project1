...
type
  ...
  TMyObj630_List0 = TObjectList<TMyObj630>;

  TMyObj630_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj630_List1 = TObjectList<TMyObj630_1>;
...
constructor TMyObj630_1.Create;
begin
  inherited;
  FInt := 630 * 3;
  FTest := 'Value: ' + Random(26302).ToString + Random(63000).ToString;
end;

procedure TForm630.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum630;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj630_List0 := TMyObj630_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj630_List1 := TMyObj630_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
