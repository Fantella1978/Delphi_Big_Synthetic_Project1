...
type
  ...
  TMyObj2436_List0 = TObjectList<TMyObj2436>;

  TMyObj2436_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2436_List1 = TObjectList<TMyObj2436_1>;
...
constructor TMyObj2436_1.Create;
begin
  inherited;
  FInt := 2436 * 3;
  FTest := 'Value: ' + Random(224362).ToString + Random(243600).ToString;
end;

procedure TForm2436.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2436;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2436_List0 := TMyObj2436_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2436_List1 := TMyObj2436_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
