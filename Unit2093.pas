...
type
  ...
  TMyObj2093_List0 = TObjectList<TMyObj2093>;

  TMyObj2093_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2093_List1 = TObjectList<TMyObj2093_1>;
...
constructor TMyObj2093_1.Create;
begin
  inherited;
  FInt := 2093 * 3;
  FTest := 'Value: ' + Random(220932).ToString + Random(209300).ToString;
end;

procedure TForm2093.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2093;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2093_List0 := TMyObj2093_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2093_List1 := TMyObj2093_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
