...
type
  ...
  TMyObj78_List0 = TObjectList<TMyObj78>;

  TMyObj78_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj78_List1 = TObjectList<TMyObj78_1>;
...
constructor TMyObj78_1.Create;
begin
  inherited;
  FInt := 78 * 3;
  FTest := 'Value: ' + Random(2782).ToString + Random(7800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj78_List0 := TMyObj78_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj78_List1 := TMyObj78_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
