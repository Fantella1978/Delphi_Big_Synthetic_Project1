...
type
  ...
  TMyObj1985_List0 = TObjectList<TMyObj1985>;

  TMyObj1985_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1985_List1 = TObjectList<TMyObj1985_1>;
...
constructor TMyObj1985_1.Create;
begin
  inherited;
  FInt := 1985 * 3;
  FTest := 'Value: ' + Random(219852).ToString + Random(198500).ToString;
end;

procedure TForm1985.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1985;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1985_List0 := TMyObj1985_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1985_List1 := TMyObj1985_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
