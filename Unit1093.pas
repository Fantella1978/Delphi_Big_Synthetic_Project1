...
type
  ...
  TMyObj1093_List0 = TObjectList<TMyObj1093>;

  TMyObj1093_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1093_List1 = TObjectList<TMyObj1093_1>;
...
constructor TMyObj1093_1.Create;
begin
  inherited;
  FInt := 1093 * 3;
  FTest := 'Value: ' + Random(210932).ToString + Random(109300).ToString;
end;

procedure TForm1093.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1093;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1093_List0 := TMyObj1093_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1093_List1 := TMyObj1093_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
