...
type
  ...
  TMyObj823_List0 = TObjectList<TMyObj823>;

  TMyObj823_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj823_List1 = TObjectList<TMyObj823_1>;
...
constructor TMyObj823_1.Create;
begin
  inherited;
  FInt := 823 * 3;
  FTest := 'Value: ' + Random(28232).ToString + Random(82300).ToString;
end;

procedure TForm823.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum823;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj823_List0 := TMyObj823_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj823_List1 := TMyObj823_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
