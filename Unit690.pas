...
type
  ...
  TMyObj690_List0 = TObjectList<TMyObj690>;

  TMyObj690_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj690_List1 = TObjectList<TMyObj690_1>;
...
constructor TMyObj690_1.Create;
begin
  inherited;
  FInt := 690 * 3;
  FTest := 'Value: ' + Random(26902).ToString + Random(69000).ToString;
end;

procedure TForm690.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum690;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj690_List0 := TMyObj690_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj690_List1 := TMyObj690_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
