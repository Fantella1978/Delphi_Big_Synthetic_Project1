...
type
  ...
  TMyObj609_List0 = TObjectList<TMyObj609>;

  TMyObj609_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj609_List1 = TObjectList<TMyObj609_1>;
...
constructor TMyObj609_1.Create;
begin
  inherited;
  FInt := 609 * 3;
  FTest := 'Value: ' + Random(26092).ToString + Random(60900).ToString;
end;

procedure TForm609.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum609;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj609_List0 := TMyObj609_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj609_List1 := TMyObj609_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
