...
type
  ...
  TMyObj2232_List0 = TObjectList<TMyObj2232>;

  TMyObj2232_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2232_List1 = TObjectList<TMyObj2232_1>;
...
constructor TMyObj2232_1.Create;
begin
  inherited;
  FInt := 2232 * 3;
  FTest := 'Value: ' + Random(222322).ToString + Random(223200).ToString;
end;

procedure TForm2232.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2232;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2232_List0 := TMyObj2232_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2232_List1 := TMyObj2232_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
