...
type
  ...
  TMyObj1968_List0 = TObjectList<TMyObj1968>;

  TMyObj1968_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1968_List1 = TObjectList<TMyObj1968_1>;
...
constructor TMyObj1968_1.Create;
begin
  inherited;
  FInt := 1968 * 3;
  FTest := 'Value: ' + Random(219682).ToString + Random(196800).ToString;
end;

procedure TForm1968.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1968;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1968_List0 := TMyObj1968_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1968_List1 := TMyObj1968_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
