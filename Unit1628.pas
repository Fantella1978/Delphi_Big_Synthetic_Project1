...
type
  ...
  TMyObj1628_List0 = TObjectList<TMyObj1628>;

  TMyObj1628_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1628_List1 = TObjectList<TMyObj1628_1>;
...
constructor TMyObj1628_1.Create;
begin
  inherited;
  FInt := 1628 * 3;
  FTest := 'Value: ' + Random(216282).ToString + Random(162800).ToString;
end;

procedure TForm1628.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1628;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1628_List0 := TMyObj1628_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1628_List1 := TMyObj1628_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
