...
type
  ...
  TMyObj1296_List0 = TObjectList<TMyObj1296>;

  TMyObj1296_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1296_List1 = TObjectList<TMyObj1296_1>;
...
constructor TMyObj1296_1.Create;
begin
  inherited;
  FInt := 1296 * 3;
  FTest := 'Value: ' + Random(212962).ToString + Random(129600).ToString;
end;

procedure TForm1296.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1296;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1296_List0 := TMyObj1296_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1296_List1 := TMyObj1296_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
