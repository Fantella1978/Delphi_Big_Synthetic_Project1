...
type
  ...
  TMyObj705_List0 = TObjectList<TMyObj705>;

  TMyObj705_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj705_List1 = TObjectList<TMyObj705_1>;
...
constructor TMyObj705_1.Create;
begin
  inherited;
  FInt := 705 * 3;
  FTest := 'Value: ' + Random(27052).ToString + Random(70500).ToString;
end;

procedure TForm705.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum705;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj705_List0 := TMyObj705_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj705_List1 := TMyObj705_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
