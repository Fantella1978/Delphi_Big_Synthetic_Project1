...
type
  ...
  TMyObj85_List0 = TObjectList<TMyObj85>;

  TMyObj85_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj85_List1 = TObjectList<TMyObj85_1>;
...
constructor TMyObj85_1.Create;
begin
  inherited;
  FInt := 85 * 3;
  FTest := 'Value: ' + Random(2852).ToString + Random(8500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj85_List0 := TMyObj85_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj85_List1 := TMyObj85_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
