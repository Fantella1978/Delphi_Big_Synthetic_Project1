...
type
  ...
  TMyObj73_List0 = TObjectList<TMyObj73>;

  TMyObj73_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj73_List1 = TObjectList<TMyObj73_1>;
...
constructor TMyObj73_1.Create;
begin
  inherited;
  FInt := 73 * 3;
  FTest := 'Value: ' + Random(2732).ToString + Random(7300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj73_List0 := TMyObj73_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj73_List1 := TMyObj73_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
