...
type
  ...
  TMyObj1547_List0 = TObjectList<TMyObj1547>;

  TMyObj1547_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1547_List1 = TObjectList<TMyObj1547_1>;
...
constructor TMyObj1547_1.Create;
begin
  inherited;
  FInt := 1547 * 3;
  FTest := 'Value: ' + Random(215472).ToString + Random(154700).ToString;
end;

procedure TForm1547.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1547;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1547_List0 := TMyObj1547_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1547_List1 := TMyObj1547_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
