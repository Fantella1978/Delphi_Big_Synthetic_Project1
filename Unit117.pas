...
type
  ...
  TMyObj117_List0 = TObjectList<TMyObj117>;

  TMyObj117_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj117_List1 = TObjectList<TMyObj117_1>;
...
constructor TMyObj117_1.Create;
begin
  inherited;
  FInt := 117 * 3;
  FTest := 'Value: ' + Random(21172).ToString + Random(11700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj117_List0 := TMyObj117_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj117_List1 := TMyObj117_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
