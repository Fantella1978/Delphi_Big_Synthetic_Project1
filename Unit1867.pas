...
type
  ...
  TMyObj1867_List0 = TObjectList<TMyObj1867>;

  TMyObj1867_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1867_List1 = TObjectList<TMyObj1867_1>;
...
constructor TMyObj1867_1.Create;
begin
  inherited;
  FInt := 1867 * 3;
  FTest := 'Value: ' + Random(218672).ToString + Random(186700).ToString;
end;

procedure TForm1867.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1867;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1867_List0 := TMyObj1867_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1867_List1 := TMyObj1867_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
