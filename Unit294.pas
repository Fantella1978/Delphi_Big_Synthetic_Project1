...
type
  ...
  TMyObj294_List0 = TObjectList<TMyObj294>;

  TMyObj294_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj294_List1 = TObjectList<TMyObj294_1>;
...
constructor TMyObj294_1.Create;
begin
  inherited;
  FInt := 294 * 3;
  FTest := 'Value: ' + Random(22942).ToString + Random(29400).ToString;
end;

procedure TForm294.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum294;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj294_List0 := TMyObj294_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj294_List1 := TMyObj294_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
