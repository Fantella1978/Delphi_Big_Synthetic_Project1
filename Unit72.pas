...
type
  ...
  TMyObj72_List0 = TObjectList<TMyObj72>;

  TMyObj72_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj72_List1 = TObjectList<TMyObj72_1>;
...
constructor TMyObj72_1.Create;
begin
  inherited;
  FInt := 72 * 3;
  FTest := 'Value: ' + Random(2722).ToString + Random(7200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj72_List0 := TMyObj72_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj72_List1 := TMyObj72_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
