...
type
  ...
  TMyObj2499_List0 = TObjectList<TMyObj2499>;

  TMyObj2499_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2499_List1 = TObjectList<TMyObj2499_1>;
...
constructor TMyObj2499_1.Create;
begin
  inherited;
  FInt := 2499 * 3;
  FTest := 'Value: ' + Random(224992).ToString + Random(249900).ToString;
end;

procedure TForm2499.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2499;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2499_List0 := TMyObj2499_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2499_List1 := TMyObj2499_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
