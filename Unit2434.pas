...
type
  ...
  TMyObj2434_List0 = TObjectList<TMyObj2434>;

  TMyObj2434_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2434_List1 = TObjectList<TMyObj2434_1>;
...
constructor TMyObj2434_1.Create;
begin
  inherited;
  FInt := 2434 * 3;
  FTest := 'Value: ' + Random(224342).ToString + Random(243400).ToString;
end;

procedure TForm2434.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2434;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2434_List0 := TMyObj2434_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2434_List1 := TMyObj2434_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
