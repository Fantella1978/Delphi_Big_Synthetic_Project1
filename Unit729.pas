...
type
  ...
  TMyObj729_List0 = TObjectList<TMyObj729>;

  TMyObj729_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj729_List1 = TObjectList<TMyObj729_1>;
...
constructor TMyObj729_1.Create;
begin
  inherited;
  FInt := 729 * 3;
  FTest := 'Value: ' + Random(27292).ToString + Random(72900).ToString;
end;

procedure TForm729.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum729;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj729_List0 := TMyObj729_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj729_List1 := TMyObj729_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
