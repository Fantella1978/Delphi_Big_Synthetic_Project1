...
type
  ...
  TMyObj1433_List0 = TObjectList<TMyObj1433>;

  TMyObj1433_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1433_List1 = TObjectList<TMyObj1433_1>;
...
constructor TMyObj1433_1.Create;
begin
  inherited;
  FInt := 1433 * 3;
  FTest := 'Value: ' + Random(214332).ToString + Random(143300).ToString;
end;

procedure TForm1433.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1433;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1433_List0 := TMyObj1433_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1433_List1 := TMyObj1433_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
