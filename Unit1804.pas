...
type
  ...
  TMyObj1804_List0 = TObjectList<TMyObj1804>;

  TMyObj1804_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1804_List1 = TObjectList<TMyObj1804_1>;
...
constructor TMyObj1804_1.Create;
begin
  inherited;
  FInt := 1804 * 3;
  FTest := 'Value: ' + Random(218042).ToString + Random(180400).ToString;
end;

procedure TForm1804.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1804;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1804_List0 := TMyObj1804_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1804_List1 := TMyObj1804_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
