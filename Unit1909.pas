...
type
  ...
  TMyObj1909_List0 = TObjectList<TMyObj1909>;

  TMyObj1909_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1909_List1 = TObjectList<TMyObj1909_1>;
...
constructor TMyObj1909_1.Create;
begin
  inherited;
  FInt := 1909 * 3;
  FTest := 'Value: ' + Random(219092).ToString + Random(190900).ToString;
end;

procedure TForm1909.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1909;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1909_List0 := TMyObj1909_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1909_List1 := TMyObj1909_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
