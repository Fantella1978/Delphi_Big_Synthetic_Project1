...
type
  ...
  TMyObj2431_List0 = TObjectList<TMyObj2431>;

  TMyObj2431_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2431_List1 = TObjectList<TMyObj2431_1>;
...
constructor TMyObj2431_1.Create;
begin
  inherited;
  FInt := 2431 * 3;
  FTest := 'Value: ' + Random(224312).ToString + Random(243100).ToString;
end;

procedure TForm2431.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2431;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2431_List0 := TMyObj2431_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2431_List1 := TMyObj2431_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
