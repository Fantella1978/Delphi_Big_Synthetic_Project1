...
type
  ...
  TMyObj853_List0 = TObjectList<TMyObj853>;

  TMyObj853_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj853_List1 = TObjectList<TMyObj853_1>;
...
constructor TMyObj853_1.Create;
begin
  inherited;
  FInt := 853 * 3;
  FTest := 'Value: ' + Random(28532).ToString + Random(85300).ToString;
end;

procedure TForm853.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum853;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj853_List0 := TMyObj853_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj853_List1 := TMyObj853_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
