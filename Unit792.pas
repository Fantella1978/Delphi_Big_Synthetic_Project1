...
type
  ...
  TMyObj792_List0 = TObjectList<TMyObj792>;

  TMyObj792_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj792_List1 = TObjectList<TMyObj792_1>;
...
constructor TMyObj792_1.Create;
begin
  inherited;
  FInt := 792 * 3;
  FTest := 'Value: ' + Random(27922).ToString + Random(79200).ToString;
end;

procedure TForm792.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum792;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj792_List0 := TMyObj792_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj792_List1 := TMyObj792_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
