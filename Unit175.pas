...
type
  ...
  TMyObj175_List0 = TObjectList<TMyObj175>;

  TMyObj175_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj175_List1 = TObjectList<TMyObj175_1>;
...
constructor TMyObj175_1.Create;
begin
  inherited;
  FInt := 175 * 3;
  FTest := 'Value: ' + Random(21752).ToString + Random(17500).ToString;
end;

procedure TForm175.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum175;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj175_List0 := TMyObj175_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj175_List1 := TMyObj175_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
