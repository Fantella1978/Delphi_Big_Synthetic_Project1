...
type
  ...
  TMyObj389_List0 = TObjectList<TMyObj389>;

  TMyObj389_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj389_List1 = TObjectList<TMyObj389_1>;
...
constructor TMyObj389_1.Create;
begin
  inherited;
  FInt := 389 * 3;
  FTest := 'Value: ' + Random(23892).ToString + Random(38900).ToString;
end;

procedure TForm389.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum389;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj389_List0 := TMyObj389_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj389_List1 := TMyObj389_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
