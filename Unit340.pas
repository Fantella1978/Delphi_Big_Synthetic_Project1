...
type
  ...
  TMyObj340_List0 = TObjectList<TMyObj340>;

  TMyObj340_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj340_List1 = TObjectList<TMyObj340_1>;
...
constructor TMyObj340_1.Create;
begin
  inherited;
  FInt := 340 * 3;
  FTest := 'Value: ' + Random(23402).ToString + Random(34000).ToString;
end;

procedure TForm340.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum340;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj340_List0 := TMyObj340_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj340_List1 := TMyObj340_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
