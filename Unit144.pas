...
type
  ...
  TMyObj144_List0 = TObjectList<TMyObj144>;

  TMyObj144_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj144_List1 = TObjectList<TMyObj144_1>;
...
constructor TMyObj144_1.Create;
begin
  inherited;
  FInt := 144 * 3;
  FTest := 'Value: ' + Random(21442).ToString + Random(14400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj144_List0 := TMyObj144_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj144_List1 := TMyObj144_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
