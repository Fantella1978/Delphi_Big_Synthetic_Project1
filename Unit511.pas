...
type
  ...
  TMyObj511_List0 = TObjectList<TMyObj511>;

  TMyObj511_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj511_List1 = TObjectList<TMyObj511_1>;
...
constructor TMyObj511_1.Create;
begin
  inherited;
  FInt := 511 * 3;
  FTest := 'Value: ' + Random(25112).ToString + Random(51100).ToString;
end;

procedure TForm511.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum511;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj511_List0 := TMyObj511_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj511_List1 := TMyObj511_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
