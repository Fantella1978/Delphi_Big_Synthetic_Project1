...
type
  ...
  TMyObj431_List0 = TObjectList<TMyObj431>;

  TMyObj431_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj431_List1 = TObjectList<TMyObj431_1>;
...
constructor TMyObj431_1.Create;
begin
  inherited;
  FInt := 431 * 3;
  FTest := 'Value: ' + Random(24312).ToString + Random(43100).ToString;
end;

procedure TForm431.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum431;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj431_List0 := TMyObj431_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj431_List1 := TMyObj431_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
