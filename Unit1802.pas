...
type
  ...
  TMyObj1802_List0 = TObjectList<TMyObj1802>;

  TMyObj1802_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1802_List1 = TObjectList<TMyObj1802_1>;
...
constructor TMyObj1802_1.Create;
begin
  inherited;
  FInt := 1802 * 3;
  FTest := 'Value: ' + Random(218022).ToString + Random(180200).ToString;
end;

procedure TForm1802.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1802;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1802_List0 := TMyObj1802_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1802_List1 := TMyObj1802_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
