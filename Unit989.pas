...
type
  ...
  TMyObj989_List0 = TObjectList<TMyObj989>;

  TMyObj989_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj989_List1 = TObjectList<TMyObj989_1>;
...
constructor TMyObj989_1.Create;
begin
  inherited;
  FInt := 989 * 3;
  FTest := 'Value: ' + Random(29892).ToString + Random(98900).ToString;
end;

procedure TForm989.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum989;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj989_List0 := TMyObj989_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj989_List1 := TMyObj989_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
