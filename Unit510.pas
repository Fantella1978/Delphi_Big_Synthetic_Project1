...
type
  ...
  TMyObj510_List0 = TObjectList<TMyObj510>;

  TMyObj510_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj510_List1 = TObjectList<TMyObj510_1>;
...
constructor TMyObj510_1.Create;
begin
  inherited;
  FInt := 510 * 3;
  FTest := 'Value: ' + Random(25102).ToString + Random(51000).ToString;
end;

procedure TForm510.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum510;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj510_List0 := TMyObj510_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj510_List1 := TMyObj510_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
