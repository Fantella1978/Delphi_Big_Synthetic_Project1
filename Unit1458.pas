...
type
  ...
  TMyObj1458_List0 = TObjectList<TMyObj1458>;

  TMyObj1458_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1458_List1 = TObjectList<TMyObj1458_1>;
...
constructor TMyObj1458_1.Create;
begin
  inherited;
  FInt := 1458 * 3;
  FTest := 'Value: ' + Random(214582).ToString + Random(145800).ToString;
end;

procedure TForm1458.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1458;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1458_List0 := TMyObj1458_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1458_List1 := TMyObj1458_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
