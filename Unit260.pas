...
type
  ...
  TMyObj260_List0 = TObjectList<TMyObj260>;

  TMyObj260_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj260_List1 = TObjectList<TMyObj260_1>;
...
constructor TMyObj260_1.Create;
begin
  inherited;
  FInt := 260 * 3;
  FTest := 'Value: ' + Random(22602).ToString + Random(26000).ToString;
end;

procedure TForm260.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum260;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj260_List0 := TMyObj260_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj260_List1 := TMyObj260_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
