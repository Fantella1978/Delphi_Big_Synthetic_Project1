...
type
  ...
  TMyObj908_List0 = TObjectList<TMyObj908>;

  TMyObj908_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj908_List1 = TObjectList<TMyObj908_1>;
...
constructor TMyObj908_1.Create;
begin
  inherited;
  FInt := 908 * 3;
  FTest := 'Value: ' + Random(29082).ToString + Random(90800).ToString;
end;

procedure TForm908.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum908;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj908_List0 := TMyObj908_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj908_List1 := TMyObj908_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
