...
type
  ...
  TMyObj544_List0 = TObjectList<TMyObj544>;

  TMyObj544_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj544_List1 = TObjectList<TMyObj544_1>;
...
constructor TMyObj544_1.Create;
begin
  inherited;
  FInt := 544 * 3;
  FTest := 'Value: ' + Random(25442).ToString + Random(54400).ToString;
end;

procedure TForm544.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum544;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj544_List0 := TMyObj544_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj544_List1 := TMyObj544_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
