...
type
  ...
  TMyObj1338_List0 = TObjectList<TMyObj1338>;

  TMyObj1338_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1338_List1 = TObjectList<TMyObj1338_1>;
...
constructor TMyObj1338_1.Create;
begin
  inherited;
  FInt := 1338 * 3;
  FTest := 'Value: ' + Random(213382).ToString + Random(133800).ToString;
end;

procedure TForm1338.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1338;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1338_List0 := TMyObj1338_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1338_List1 := TMyObj1338_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
