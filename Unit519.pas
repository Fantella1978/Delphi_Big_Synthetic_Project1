...
type
  ...
  TMyObj519_List0 = TObjectList<TMyObj519>;

  TMyObj519_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj519_List1 = TObjectList<TMyObj519_1>;
...
constructor TMyObj519_1.Create;
begin
  inherited;
  FInt := 519 * 3;
  FTest := 'Value: ' + Random(25192).ToString + Random(51900).ToString;
end;

procedure TForm519.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum519;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj519_List0 := TMyObj519_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj519_List1 := TMyObj519_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
