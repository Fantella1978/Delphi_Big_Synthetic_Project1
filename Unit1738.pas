...
type
  ...
  TMyObj1738_List0 = TObjectList<TMyObj1738>;

  TMyObj1738_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1738_List1 = TObjectList<TMyObj1738_1>;
...
constructor TMyObj1738_1.Create;
begin
  inherited;
  FInt := 1738 * 3;
  FTest := 'Value: ' + Random(217382).ToString + Random(173800).ToString;
end;

procedure TForm1738.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1738;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1738_List0 := TMyObj1738_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1738_List1 := TMyObj1738_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
