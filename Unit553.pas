...
type
  ...
  TMyObj553_List0 = TObjectList<TMyObj553>;

  TMyObj553_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj553_List1 = TObjectList<TMyObj553_1>;
...
constructor TMyObj553_1.Create;
begin
  inherited;
  FInt := 553 * 3;
  FTest := 'Value: ' + Random(25532).ToString + Random(55300).ToString;
end;

procedure TForm553.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum553;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj553_List0 := TMyObj553_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj553_List1 := TMyObj553_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
