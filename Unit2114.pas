...
type
  ...
  TMyObj2114_List0 = TObjectList<TMyObj2114>;

  TMyObj2114_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2114_List1 = TObjectList<TMyObj2114_1>;
...
constructor TMyObj2114_1.Create;
begin
  inherited;
  FInt := 2114 * 3;
  FTest := 'Value: ' + Random(221142).ToString + Random(211400).ToString;
end;

procedure TForm2114.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2114;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2114_List0 := TMyObj2114_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2114_List1 := TMyObj2114_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
