...
type
  ...
  TMyObj251_List0 = TObjectList<TMyObj251>;

  TMyObj251_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj251_List1 = TObjectList<TMyObj251_1>;
...
constructor TMyObj251_1.Create;
begin
  inherited;
  FInt := 251 * 3;
  FTest := 'Value: ' + Random(22512).ToString + Random(25100).ToString;
end;

procedure TForm251.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum251;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj251_List0 := TMyObj251_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj251_List1 := TMyObj251_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
