...
type
  ...
  TMyObj2160_List0 = TObjectList<TMyObj2160>;

  TMyObj2160_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2160_List1 = TObjectList<TMyObj2160_1>;
...
constructor TMyObj2160_1.Create;
begin
  inherited;
  FInt := 2160 * 3;
  FTest := 'Value: ' + Random(221602).ToString + Random(216000).ToString;
end;

procedure TForm2160.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2160;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2160_List0 := TMyObj2160_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2160_List1 := TMyObj2160_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
