...
type
  ...
  TMyObj491_List0 = TObjectList<TMyObj491>;

  TMyObj491_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj491_List1 = TObjectList<TMyObj491_1>;
...
constructor TMyObj491_1.Create;
begin
  inherited;
  FInt := 491 * 3;
  FTest := 'Value: ' + Random(24912).ToString + Random(49100).ToString;
end;

procedure TForm491.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum491;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj491_List0 := TMyObj491_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj491_List1 := TMyObj491_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
