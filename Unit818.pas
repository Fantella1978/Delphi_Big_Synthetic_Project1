...
type
  ...
  TMyObj818_List0 = TObjectList<TMyObj818>;

  TMyObj818_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj818_List1 = TObjectList<TMyObj818_1>;
...
constructor TMyObj818_1.Create;
begin
  inherited;
  FInt := 818 * 3;
  FTest := 'Value: ' + Random(28182).ToString + Random(81800).ToString;
end;

procedure TForm818.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum818;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj818_List0 := TMyObj818_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj818_List1 := TMyObj818_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
