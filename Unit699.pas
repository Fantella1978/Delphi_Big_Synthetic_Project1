...
type
  ...
  TMyObj699_List0 = TObjectList<TMyObj699>;

  TMyObj699_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj699_List1 = TObjectList<TMyObj699_1>;
...
constructor TMyObj699_1.Create;
begin
  inherited;
  FInt := 699 * 3;
  FTest := 'Value: ' + Random(26992).ToString + Random(69900).ToString;
end;

procedure TForm699.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum699;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj699_List0 := TMyObj699_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj699_List1 := TMyObj699_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
