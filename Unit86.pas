...
type
  ...
  TMyObj86_List0 = TObjectList<TMyObj86>;

  TMyObj86_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj86_List1 = TObjectList<TMyObj86_1>;
...
constructor TMyObj86_1.Create;
begin
  inherited;
  FInt := 86 * 3;
  FTest := 'Value: ' + Random(2862).ToString + Random(8600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj86_List0 := TMyObj86_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj86_List1 := TMyObj86_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
