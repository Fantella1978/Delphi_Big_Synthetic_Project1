...
type
  ...
  TMyObj205_List0 = TObjectList<TMyObj205>;

  TMyObj205_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj205_List1 = TObjectList<TMyObj205_1>;
...
constructor TMyObj205_1.Create;
begin
  inherited;
  FInt := 205 * 3;
  FTest := 'Value: ' + Random(22052).ToString + Random(20500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj205_List0 := TMyObj205_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj205_List1 := TMyObj205_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
