...
type
  ...
  TMyObj446_List0 = TObjectList<TMyObj446>;

  TMyObj446_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj446_List1 = TObjectList<TMyObj446_1>;
...
constructor TMyObj446_1.Create;
begin
  inherited;
  FInt := 446 * 3;
  FTest := 'Value: ' + Random(24462).ToString + Random(44600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj446_List0 := TMyObj446_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj446_List1 := TMyObj446_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
