...
type
  ...
  TMyObj1043_List0 = TObjectList<TMyObj1043>;

  TMyObj1043_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1043_List1 = TObjectList<TMyObj1043_1>;
...
constructor TMyObj1043_1.Create;
begin
  inherited;
  FInt := 1043 * 3;
  FTest := 'Value: ' + Random(210432).ToString + Random(104300).ToString;
end;

procedure TForm1043.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1043;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1043_List0 := TMyObj1043_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1043_List1 := TMyObj1043_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
