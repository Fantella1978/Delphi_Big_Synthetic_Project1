...
type
  ...
  TMyObj959_List0 = TObjectList<TMyObj959>;

  TMyObj959_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj959_List1 = TObjectList<TMyObj959_1>;
...
constructor TMyObj959_1.Create;
begin
  inherited;
  FInt := 959 * 3;
  FTest := 'Value: ' + Random(29592).ToString + Random(95900).ToString;
end;

procedure TForm959.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum959;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj959_List0 := TMyObj959_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj959_List1 := TMyObj959_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
