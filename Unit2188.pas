...
type
  ...
  TMyObj2188_List0 = TObjectList<TMyObj2188>;

  TMyObj2188_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2188_List1 = TObjectList<TMyObj2188_1>;
...
constructor TMyObj2188_1.Create;
begin
  inherited;
  FInt := 2188 * 3;
  FTest := 'Value: ' + Random(221882).ToString + Random(218800).ToString;
end;

procedure TForm2188.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2188;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2188_List0 := TMyObj2188_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2188_List1 := TMyObj2188_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
