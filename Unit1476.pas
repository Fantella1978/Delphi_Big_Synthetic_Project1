...
type
  ...
  TMyObj1476_List0 = TObjectList<TMyObj1476>;

  TMyObj1476_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1476_List1 = TObjectList<TMyObj1476_1>;
...
constructor TMyObj1476_1.Create;
begin
  inherited;
  FInt := 1476 * 3;
  FTest := 'Value: ' + Random(214762).ToString + Random(147600).ToString;
end;

procedure TForm1476.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1476;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1476_List0 := TMyObj1476_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1476_List1 := TMyObj1476_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
