...
type
  ...
  TMyObj1295_List0 = TObjectList<TMyObj1295>;

  TMyObj1295_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1295_List1 = TObjectList<TMyObj1295_1>;
...
constructor TMyObj1295_1.Create;
begin
  inherited;
  FInt := 1295 * 3;
  FTest := 'Value: ' + Random(212952).ToString + Random(129500).ToString;
end;

procedure TForm1295.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1295;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1295_List0 := TMyObj1295_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1295_List1 := TMyObj1295_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
