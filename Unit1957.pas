...
type
  ...
  TMyObj1957_List0 = TObjectList<TMyObj1957>;

  TMyObj1957_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1957_List1 = TObjectList<TMyObj1957_1>;
...
constructor TMyObj1957_1.Create;
begin
  inherited;
  FInt := 1957 * 3;
  FTest := 'Value: ' + Random(219572).ToString + Random(195700).ToString;
end;

procedure TForm1957.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1957;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1957_List0 := TMyObj1957_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1957_List1 := TMyObj1957_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
