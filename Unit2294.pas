...
type
  ...
  TMyObj2294_List0 = TObjectList<TMyObj2294>;

  TMyObj2294_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2294_List1 = TObjectList<TMyObj2294_1>;
...
constructor TMyObj2294_1.Create;
begin
  inherited;
  FInt := 2294 * 3;
  FTest := 'Value: ' + Random(222942).ToString + Random(229400).ToString;
end;

procedure TForm2294.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2294;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2294_List0 := TMyObj2294_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2294_List1 := TMyObj2294_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
