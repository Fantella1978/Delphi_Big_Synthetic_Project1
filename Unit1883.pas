...
type
  ...
  TMyObj1883_List0 = TObjectList<TMyObj1883>;

  TMyObj1883_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1883_List1 = TObjectList<TMyObj1883_1>;
...
constructor TMyObj1883_1.Create;
begin
  inherited;
  FInt := 1883 * 3;
  FTest := 'Value: ' + Random(218832).ToString + Random(188300).ToString;
end;

procedure TForm1883.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1883;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1883_List0 := TMyObj1883_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1883_List1 := TMyObj1883_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
