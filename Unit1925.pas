...
type
  ...
  TMyObj1925_List0 = TObjectList<TMyObj1925>;

  TMyObj1925_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1925_List1 = TObjectList<TMyObj1925_1>;
...
constructor TMyObj1925_1.Create;
begin
  inherited;
  FInt := 1925 * 3;
  FTest := 'Value: ' + Random(219252).ToString + Random(192500).ToString;
end;

procedure TForm1925.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1925;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1925_List0 := TMyObj1925_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1925_List1 := TMyObj1925_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
