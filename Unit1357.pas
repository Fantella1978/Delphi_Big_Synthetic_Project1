...
type
  ...
  TMyObj1357_List0 = TObjectList<TMyObj1357>;

  TMyObj1357_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1357_List1 = TObjectList<TMyObj1357_1>;
...
constructor TMyObj1357_1.Create;
begin
  inherited;
  FInt := 1357 * 3;
  FTest := 'Value: ' + Random(213572).ToString + Random(135700).ToString;
end;

procedure TForm1357.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1357;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1357_List0 := TMyObj1357_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1357_List1 := TMyObj1357_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
