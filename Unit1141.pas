...
type
  ...
  TMyObj1141_List0 = TObjectList<TMyObj1141>;

  TMyObj1141_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1141_List1 = TObjectList<TMyObj1141_1>;
...
constructor TMyObj1141_1.Create;
begin
  inherited;
  FInt := 1141 * 3;
  FTest := 'Value: ' + Random(211412).ToString + Random(114100).ToString;
end;

procedure TForm1141.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1141;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1141_List0 := TMyObj1141_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1141_List1 := TMyObj1141_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
