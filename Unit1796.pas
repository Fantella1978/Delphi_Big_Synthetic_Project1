...
type
  ...
  TMyObj1796_List0 = TObjectList<TMyObj1796>;

  TMyObj1796_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1796_List1 = TObjectList<TMyObj1796_1>;
...
constructor TMyObj1796_1.Create;
begin
  inherited;
  FInt := 1796 * 3;
  FTest := 'Value: ' + Random(217962).ToString + Random(179600).ToString;
end;

procedure TForm1796.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1796;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1796_List0 := TMyObj1796_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1796_List1 := TMyObj1796_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
