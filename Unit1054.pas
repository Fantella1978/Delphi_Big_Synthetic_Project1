...
type
  ...
  TMyObj1054_List0 = TObjectList<TMyObj1054>;

  TMyObj1054_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1054_List1 = TObjectList<TMyObj1054_1>;
...
constructor TMyObj1054_1.Create;
begin
  inherited;
  FInt := 1054 * 3;
  FTest := 'Value: ' + Random(210542).ToString + Random(105400).ToString;
end;

procedure TForm1054.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1054;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1054_List0 := TMyObj1054_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1054_List1 := TMyObj1054_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
