...
type
  ...
  TMyObj2190_List0 = TObjectList<TMyObj2190>;

  TMyObj2190_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2190_List1 = TObjectList<TMyObj2190_1>;
...
constructor TMyObj2190_1.Create;
begin
  inherited;
  FInt := 2190 * 3;
  FTest := 'Value: ' + Random(221902).ToString + Random(219000).ToString;
end;

procedure TForm2190.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2190;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2190_List0 := TMyObj2190_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2190_List1 := TMyObj2190_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
