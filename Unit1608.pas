...
type
  ...
  TMyObj1608_List0 = TObjectList<TMyObj1608>;

  TMyObj1608_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1608_List1 = TObjectList<TMyObj1608_1>;
...
constructor TMyObj1608_1.Create;
begin
  inherited;
  FInt := 1608 * 3;
  FTest := 'Value: ' + Random(216082).ToString + Random(160800).ToString;
end;

procedure TForm1608.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1608;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1608_List0 := TMyObj1608_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1608_List1 := TMyObj1608_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
