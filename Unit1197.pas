...
type
  ...
  TMyObj1197_List0 = TObjectList<TMyObj1197>;

  TMyObj1197_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1197_List1 = TObjectList<TMyObj1197_1>;
...
constructor TMyObj1197_1.Create;
begin
  inherited;
  FInt := 1197 * 3;
  FTest := 'Value: ' + Random(211972).ToString + Random(119700).ToString;
end;

procedure TForm1197.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1197;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1197_List0 := TMyObj1197_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1197_List1 := TMyObj1197_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
