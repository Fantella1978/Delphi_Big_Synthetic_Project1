...
type
  ...
  TMyObj677_List0 = TObjectList<TMyObj677>;

  TMyObj677_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj677_List1 = TObjectList<TMyObj677_1>;
...
constructor TMyObj677_1.Create;
begin
  inherited;
  FInt := 677 * 3;
  FTest := 'Value: ' + Random(26772).ToString + Random(67700).ToString;
end;

procedure TForm677.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum677;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj677_List0 := TMyObj677_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj677_List1 := TMyObj677_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
