...
type
  ...
  TMyObj681_List0 = TObjectList<TMyObj681>;

  TMyObj681_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj681_List1 = TObjectList<TMyObj681_1>;
...
constructor TMyObj681_1.Create;
begin
  inherited;
  FInt := 681 * 3;
  FTest := 'Value: ' + Random(26812).ToString + Random(68100).ToString;
end;

procedure TForm681.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum681;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj681_List0 := TMyObj681_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj681_List1 := TMyObj681_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
