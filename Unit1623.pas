...
type
  ...
  TMyObj1623_List0 = TObjectList<TMyObj1623>;

  TMyObj1623_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1623_List1 = TObjectList<TMyObj1623_1>;
...
constructor TMyObj1623_1.Create;
begin
  inherited;
  FInt := 1623 * 3;
  FTest := 'Value: ' + Random(216232).ToString + Random(162300).ToString;
end;

procedure TForm1623.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1623;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1623_List0 := TMyObj1623_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1623_List1 := TMyObj1623_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
