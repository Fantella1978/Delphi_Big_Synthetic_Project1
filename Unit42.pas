...
type
  ...
  TMyObj42_List0 = TObjectList<TMyObj42>;

  TMyObj42_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj42_List1 = TObjectList<TMyObj42_1>;
...
constructor TMyObj42_1.Create;
begin
  inherited;
  FInt := 42 * 3;
  FTest := 'Value: ' + Random(2422).ToString + Random(4200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj42_List0 := TMyObj42_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj42_List1 := TMyObj42_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
