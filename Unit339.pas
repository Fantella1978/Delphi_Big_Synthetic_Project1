...
type
  ...
  TMyObj339_List0 = TObjectList<TMyObj339>;

  TMyObj339_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj339_List1 = TObjectList<TMyObj339_1>;
...
constructor TMyObj339_1.Create;
begin
  inherited;
  FInt := 339 * 3;
  FTest := 'Value: ' + Random(23392).ToString + Random(33900).ToString;
end;

procedure TForm339.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum339;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj339_List0 := TMyObj339_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj339_List1 := TMyObj339_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
