...
type
  ...
  TMyObj1014_List0 = TObjectList<TMyObj1014>;

  TMyObj1014_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1014_List1 = TObjectList<TMyObj1014_1>;
...
constructor TMyObj1014_1.Create;
begin
  inherited;
  FInt := 1014 * 3;
  FTest := 'Value: ' + Random(210142).ToString + Random(101400).ToString;
end;

procedure TForm1014.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1014;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1014_List0 := TMyObj1014_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1014_List1 := TMyObj1014_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
