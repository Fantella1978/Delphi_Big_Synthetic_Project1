...
type
  ...
  TMyObj1294_List0 = TObjectList<TMyObj1294>;

  TMyObj1294_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1294_List1 = TObjectList<TMyObj1294_1>;
...
constructor TMyObj1294_1.Create;
begin
  inherited;
  FInt := 1294 * 3;
  FTest := 'Value: ' + Random(212942).ToString + Random(129400).ToString;
end;

procedure TForm1294.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1294;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1294_List0 := TMyObj1294_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1294_List1 := TMyObj1294_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
