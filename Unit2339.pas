...
type
  ...
  TMyObj2339_List0 = TObjectList<TMyObj2339>;

  TMyObj2339_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2339_List1 = TObjectList<TMyObj2339_1>;
...
constructor TMyObj2339_1.Create;
begin
  inherited;
  FInt := 2339 * 3;
  FTest := 'Value: ' + Random(223392).ToString + Random(233900).ToString;
end;

procedure TForm2339.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2339;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2339_List0 := TMyObj2339_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2339_List1 := TMyObj2339_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
