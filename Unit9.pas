...
type
  ...
  TMyObj9_List0 = TObjectList<TMyObj9>;

  TMyObj9_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj9_List1 = TObjectList<TMyObj9_1>;
...
constructor TMyObj9_1.Create;
begin
  inherited;
  FInt := 9 * 3;
  FTest := 'Value: ' + Random(292).ToString + Random(900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(90).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(95).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(97).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj9_List0 := TMyObj9_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj9_List1 := TMyObj9_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
