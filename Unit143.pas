...
type
  ...
  TMyObj143_List0 = TObjectList<TMyObj143>;

  TMyObj143_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj143_List1 = TObjectList<TMyObj143_1>;
...
constructor TMyObj143_1.Create;
begin
  inherited;
  FInt := 143 * 3;
  FTest := 'Value: ' + Random(21432).ToString + Random(14300).ToString;
end;

procedure TForm143.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum143;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj143_List0 := TMyObj143_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj143_List1 := TMyObj143_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
