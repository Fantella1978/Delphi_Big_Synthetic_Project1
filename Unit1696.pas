...
type
  ...
  TMyObj1696_List0 = TObjectList<TMyObj1696>;

  TMyObj1696_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1696_List1 = TObjectList<TMyObj1696_1>;
...
constructor TMyObj1696_1.Create;
begin
  inherited;
  FInt := 1696 * 3;
  FTest := 'Value: ' + Random(216962).ToString + Random(169600).ToString;
end;

procedure TForm1696.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1696;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1696_List0 := TMyObj1696_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1696_List1 := TMyObj1696_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
