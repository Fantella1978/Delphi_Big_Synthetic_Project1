...
type
  ...
  TMyObj213_List0 = TObjectList<TMyObj213>;

  TMyObj213_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj213_List1 = TObjectList<TMyObj213_1>;
...
constructor TMyObj213_1.Create;
begin
  inherited;
  FInt := 213 * 3;
  FTest := 'Value: ' + Random(22132).ToString + Random(21300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj213_List0 := TMyObj213_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj213_List1 := TMyObj213_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
