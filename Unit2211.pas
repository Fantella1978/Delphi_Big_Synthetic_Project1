...
type
  ...
  TMyObj2211_List0 = TObjectList<TMyObj2211>;

  TMyObj2211_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2211_List1 = TObjectList<TMyObj2211_1>;
...
constructor TMyObj2211_1.Create;
begin
  inherited;
  FInt := 2211 * 3;
  FTest := 'Value: ' + Random(222112).ToString + Random(221100).ToString;
end;

procedure TForm2211.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2211;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2211_List0 := TMyObj2211_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2211_List1 := TMyObj2211_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
