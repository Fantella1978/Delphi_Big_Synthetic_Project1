...
type
  ...
  TMyObj1274_List0 = TObjectList<TMyObj1274>;

  TMyObj1274_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1274_List1 = TObjectList<TMyObj1274_1>;
...
constructor TMyObj1274_1.Create;
begin
  inherited;
  FInt := 1274 * 3;
  FTest := 'Value: ' + Random(212742).ToString + Random(127400).ToString;
end;

procedure TForm1274.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1274;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1274_List0 := TMyObj1274_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1274_List1 := TMyObj1274_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
