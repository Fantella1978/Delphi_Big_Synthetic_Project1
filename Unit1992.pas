...
type
  ...
  TMyObj1992_List0 = TObjectList<TMyObj1992>;

  TMyObj1992_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1992_List1 = TObjectList<TMyObj1992_1>;
...
constructor TMyObj1992_1.Create;
begin
  inherited;
  FInt := 1992 * 3;
  FTest := 'Value: ' + Random(219922).ToString + Random(199200).ToString;
end;

procedure TForm1992.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1992;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1992_List0 := TMyObj1992_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1992_List1 := TMyObj1992_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
