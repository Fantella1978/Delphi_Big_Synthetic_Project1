...
type
  ...
  TMyObj540_List0 = TObjectList<TMyObj540>;

  TMyObj540_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj540_List1 = TObjectList<TMyObj540_1>;
...
constructor TMyObj540_1.Create;
begin
  inherited;
  FInt := 540 * 3;
  FTest := 'Value: ' + Random(25402).ToString + Random(54000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj540_List0 := TMyObj540_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj540_List1 := TMyObj540_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
