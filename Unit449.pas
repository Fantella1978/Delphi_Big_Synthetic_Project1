...
type
  ...
  TMyObj449_List0 = TObjectList<TMyObj449>;

  TMyObj449_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj449_List1 = TObjectList<TMyObj449_1>;
...
constructor TMyObj449_1.Create;
begin
  inherited;
  FInt := 449 * 3;
  FTest := 'Value: ' + Random(24492).ToString + Random(44900).ToString;
end;

procedure TForm449.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum449;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj449_List0 := TMyObj449_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj449_List1 := TMyObj449_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
