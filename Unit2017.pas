...
type
  ...
  TMyObj2017_List0 = TObjectList<TMyObj2017>;

  TMyObj2017_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2017_List1 = TObjectList<TMyObj2017_1>;
...
constructor TMyObj2017_1.Create;
begin
  inherited;
  FInt := 2017 * 3;
  FTest := 'Value: ' + Random(220172).ToString + Random(201700).ToString;
end;

procedure TForm2017.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2017;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2017_List0 := TMyObj2017_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2017_List1 := TMyObj2017_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
