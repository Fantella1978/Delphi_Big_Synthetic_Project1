...
type
  ...
  TMyObj2428_List0 = TObjectList<TMyObj2428>;

  TMyObj2428_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2428_List1 = TObjectList<TMyObj2428_1>;
...
constructor TMyObj2428_1.Create;
begin
  inherited;
  FInt := 2428 * 3;
  FTest := 'Value: ' + Random(224282).ToString + Random(242800).ToString;
end;

procedure TForm2428.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2428;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2428_List0 := TMyObj2428_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2428_List1 := TMyObj2428_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
