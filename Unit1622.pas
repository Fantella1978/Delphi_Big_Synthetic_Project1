...
type
  ...
  TMyObj1622_List0 = TObjectList<TMyObj1622>;

  TMyObj1622_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1622_List1 = TObjectList<TMyObj1622_1>;
...
constructor TMyObj1622_1.Create;
begin
  inherited;
  FInt := 1622 * 3;
  FTest := 'Value: ' + Random(216222).ToString + Random(162200).ToString;
end;

procedure TForm1622.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1622;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1622_List0 := TMyObj1622_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1622_List1 := TMyObj1622_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
