...
type
  ...
  TMyObj810_List0 = TObjectList<TMyObj810>;

  TMyObj810_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj810_List1 = TObjectList<TMyObj810_1>;
...
constructor TMyObj810_1.Create;
begin
  inherited;
  FInt := 810 * 3;
  FTest := 'Value: ' + Random(28102).ToString + Random(81000).ToString;
end;

procedure TForm810.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum810;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj810_List0 := TMyObj810_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj810_List1 := TMyObj810_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
