...
type
  ...
  TMyObj1736_List0 = TObjectList<TMyObj1736>;

  TMyObj1736_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1736_List1 = TObjectList<TMyObj1736_1>;
...
constructor TMyObj1736_1.Create;
begin
  inherited;
  FInt := 1736 * 3;
  FTest := 'Value: ' + Random(217362).ToString + Random(173600).ToString;
end;

procedure TForm1736.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1736;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1736_List0 := TMyObj1736_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1736_List1 := TMyObj1736_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
