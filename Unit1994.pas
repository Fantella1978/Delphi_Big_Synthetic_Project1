...
type
  ...
  TMyObj1994_List0 = TObjectList<TMyObj1994>;

  TMyObj1994_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1994_List1 = TObjectList<TMyObj1994_1>;
...
constructor TMyObj1994_1.Create;
begin
  inherited;
  FInt := 1994 * 3;
  FTest := 'Value: ' + Random(219942).ToString + Random(199400).ToString;
end;

procedure TForm1994.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1994;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1994_List0 := TMyObj1994_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1994_List1 := TMyObj1994_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
