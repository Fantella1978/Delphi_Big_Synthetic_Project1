...
type
  ...
  TMyObj1729_List0 = TObjectList<TMyObj1729>;

  TMyObj1729_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1729_List1 = TObjectList<TMyObj1729_1>;
...
constructor TMyObj1729_1.Create;
begin
  inherited;
  FInt := 1729 * 3;
  FTest := 'Value: ' + Random(217292).ToString + Random(172900).ToString;
end;

procedure TForm1729.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1729;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1729_List0 := TMyObj1729_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1729_List1 := TMyObj1729_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
