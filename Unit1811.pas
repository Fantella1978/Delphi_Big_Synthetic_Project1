...
type
  ...
  TMyObj1811_List0 = TObjectList<TMyObj1811>;

  TMyObj1811_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1811_List1 = TObjectList<TMyObj1811_1>;
...
constructor TMyObj1811_1.Create;
begin
  inherited;
  FInt := 1811 * 3;
  FTest := 'Value: ' + Random(218112).ToString + Random(181100).ToString;
end;

procedure TForm1811.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1811;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1811_List0 := TMyObj1811_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1811_List1 := TMyObj1811_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
