...
type
  ...
  TMyObj1620_List0 = TObjectList<TMyObj1620>;

  TMyObj1620_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1620_List1 = TObjectList<TMyObj1620_1>;
...
constructor TMyObj1620_1.Create;
begin
  inherited;
  FInt := 1620 * 3;
  FTest := 'Value: ' + Random(216202).ToString + Random(162000).ToString;
end;

procedure TForm1620.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1620;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1620_List0 := TMyObj1620_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1620_List1 := TMyObj1620_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
