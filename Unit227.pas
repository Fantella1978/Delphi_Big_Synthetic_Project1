...
type
  ...
  TMyObj227_List0 = TObjectList<TMyObj227>;

  TMyObj227_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj227_List1 = TObjectList<TMyObj227_1>;
...
constructor TMyObj227_1.Create;
begin
  inherited;
  FInt := 227 * 3;
  FTest := 'Value: ' + Random(22272).ToString + Random(22700).ToString;
end;

procedure TForm227.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum227;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj227_List0 := TMyObj227_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj227_List1 := TMyObj227_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
