...
type
  ...
  TMyObj1552_List0 = TObjectList<TMyObj1552>;

  TMyObj1552_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1552_List1 = TObjectList<TMyObj1552_1>;
...
constructor TMyObj1552_1.Create;
begin
  inherited;
  FInt := 1552 * 3;
  FTest := 'Value: ' + Random(215522).ToString + Random(155200).ToString;
end;

procedure TForm1552.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1552;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1552_List0 := TMyObj1552_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1552_List1 := TMyObj1552_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
