...
type
  ...
  TMyObj1640_List0 = TObjectList<TMyObj1640>;

  TMyObj1640_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1640_List1 = TObjectList<TMyObj1640_1>;
...
constructor TMyObj1640_1.Create;
begin
  inherited;
  FInt := 1640 * 3;
  FTest := 'Value: ' + Random(216402).ToString + Random(164000).ToString;
end;

procedure TForm1640.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1640;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1640_List0 := TMyObj1640_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1640_List1 := TMyObj1640_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
