...
type
  ...
  TMyObj2006_List0 = TObjectList<TMyObj2006>;

  TMyObj2006_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2006_List1 = TObjectList<TMyObj2006_1>;
...
constructor TMyObj2006_1.Create;
begin
  inherited;
  FInt := 2006 * 3;
  FTest := 'Value: ' + Random(220062).ToString + Random(200600).ToString;
end;

procedure TForm2006.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2006;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2006_List0 := TMyObj2006_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2006_List1 := TMyObj2006_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
