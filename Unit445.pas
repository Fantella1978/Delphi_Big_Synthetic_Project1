...
type
  ...
  TMyObj445_List0 = TObjectList<TMyObj445>;

  TMyObj445_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj445_List1 = TObjectList<TMyObj445_1>;
...
constructor TMyObj445_1.Create;
begin
  inherited;
  FInt := 445 * 3;
  FTest := 'Value: ' + Random(24452).ToString + Random(44500).ToString;
end;

procedure TForm445.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum445;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj445_List0 := TMyObj445_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj445_List1 := TMyObj445_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
