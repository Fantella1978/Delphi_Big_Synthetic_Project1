...
type
  ...
  TMyObj1388_List0 = TObjectList<TMyObj1388>;

  TMyObj1388_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1388_List1 = TObjectList<TMyObj1388_1>;
...
constructor TMyObj1388_1.Create;
begin
  inherited;
  FInt := 1388 * 3;
  FTest := 'Value: ' + Random(213882).ToString + Random(138800).ToString;
end;

procedure TForm1388.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1388;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1388_List0 := TMyObj1388_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1388_List1 := TMyObj1388_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
