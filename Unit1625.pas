...
type
  ...
  TMyObj1625_List0 = TObjectList<TMyObj1625>;

  TMyObj1625_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1625_List1 = TObjectList<TMyObj1625_1>;
...
constructor TMyObj1625_1.Create;
begin
  inherited;
  FInt := 1625 * 3;
  FTest := 'Value: ' + Random(216252).ToString + Random(162500).ToString;
end;

procedure TForm1625.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1625;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1625_List0 := TMyObj1625_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1625_List1 := TMyObj1625_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
