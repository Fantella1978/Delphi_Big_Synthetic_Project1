...
type
  ...
  TMyObj2477_List0 = TObjectList<TMyObj2477>;

  TMyObj2477_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2477_List1 = TObjectList<TMyObj2477_1>;
...
constructor TMyObj2477_1.Create;
begin
  inherited;
  FInt := 2477 * 3;
  FTest := 'Value: ' + Random(224772).ToString + Random(247700).ToString;
end;

procedure TForm2477.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2477;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2477_List0 := TMyObj2477_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2477_List1 := TMyObj2477_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
