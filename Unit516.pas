...
type
  ...
  TMyObj516_List0 = TObjectList<TMyObj516>;

  TMyObj516_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj516_List1 = TObjectList<TMyObj516_1>;
...
constructor TMyObj516_1.Create;
begin
  inherited;
  FInt := 516 * 3;
  FTest := 'Value: ' + Random(25162).ToString + Random(51600).ToString;
end;

procedure TForm516.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum516;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj516_List0 := TMyObj516_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj516_List1 := TMyObj516_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
