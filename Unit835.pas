...
type
  ...
  TMyObj835_List0 = TObjectList<TMyObj835>;

  TMyObj835_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj835_List1 = TObjectList<TMyObj835_1>;
...
constructor TMyObj835_1.Create;
begin
  inherited;
  FInt := 835 * 3;
  FTest := 'Value: ' + Random(28352).ToString + Random(83500).ToString;
end;

procedure TForm835.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum835;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj835_List0 := TMyObj835_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj835_List1 := TMyObj835_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
