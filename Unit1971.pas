...
type
  ...
  TMyObj1971_List0 = TObjectList<TMyObj1971>;

  TMyObj1971_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1971_List1 = TObjectList<TMyObj1971_1>;
...
constructor TMyObj1971_1.Create;
begin
  inherited;
  FInt := 1971 * 3;
  FTest := 'Value: ' + Random(219712).ToString + Random(197100).ToString;
end;

procedure TForm1971.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1971;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1971_List0 := TMyObj1971_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1971_List1 := TMyObj1971_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
