...
type
  ...
  TMyObj425_List0 = TObjectList<TMyObj425>;

  TMyObj425_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj425_List1 = TObjectList<TMyObj425_1>;
...
constructor TMyObj425_1.Create;
begin
  inherited;
  FInt := 425 * 3;
  FTest := 'Value: ' + Random(24252).ToString + Random(42500).ToString;
end;

procedure TForm425.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum425;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj425_List0 := TMyObj425_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj425_List1 := TMyObj425_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
