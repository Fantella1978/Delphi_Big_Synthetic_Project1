...
type
  ...
  TMyObj1659_List0 = TObjectList<TMyObj1659>;

  TMyObj1659_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1659_List1 = TObjectList<TMyObj1659_1>;
...
constructor TMyObj1659_1.Create;
begin
  inherited;
  FInt := 1659 * 3;
  FTest := 'Value: ' + Random(216592).ToString + Random(165900).ToString;
end;

procedure TForm1659.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1659;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1659_List0 := TMyObj1659_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1659_List1 := TMyObj1659_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
