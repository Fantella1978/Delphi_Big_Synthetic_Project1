...
type
  ...
  TMyObj200_List0 = TObjectList<TMyObj200>;

  TMyObj200_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj200_List1 = TObjectList<TMyObj200_1>;
...
constructor TMyObj200_1.Create;
begin
  inherited;
  FInt := 200 * 3;
  FTest := 'Value: ' + Random(22002).ToString + Random(20000).ToString;
end;

procedure TForm200.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum200;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj200_List0 := TMyObj200_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj200_List1 := TMyObj200_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
