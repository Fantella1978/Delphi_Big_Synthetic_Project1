...
type
  ...
  TMyObj957_List0 = TObjectList<TMyObj957>;

  TMyObj957_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj957_List1 = TObjectList<TMyObj957_1>;
...
constructor TMyObj957_1.Create;
begin
  inherited;
  FInt := 957 * 3;
  FTest := 'Value: ' + Random(29572).ToString + Random(95700).ToString;
end;

procedure TForm957.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum957;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj957_List0 := TMyObj957_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj957_List1 := TMyObj957_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
