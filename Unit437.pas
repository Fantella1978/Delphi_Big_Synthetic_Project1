...
type
  ...
  TMyObj437_List0 = TObjectList<TMyObj437>;

  TMyObj437_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj437_List1 = TObjectList<TMyObj437_1>;
...
constructor TMyObj437_1.Create;
begin
  inherited;
  FInt := 437 * 3;
  FTest := 'Value: ' + Random(24372).ToString + Random(43700).ToString;
end;

procedure TForm437.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum437;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj437_List0 := TMyObj437_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj437_List1 := TMyObj437_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
