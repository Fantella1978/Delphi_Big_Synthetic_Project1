...
type
  ...
  TMyObj1677_List0 = TObjectList<TMyObj1677>;

  TMyObj1677_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1677_List1 = TObjectList<TMyObj1677_1>;
...
constructor TMyObj1677_1.Create;
begin
  inherited;
  FInt := 1677 * 3;
  FTest := 'Value: ' + Random(216772).ToString + Random(167700).ToString;
end;

procedure TForm1677.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1677;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1677_List0 := TMyObj1677_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1677_List1 := TMyObj1677_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
