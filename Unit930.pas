...
type
  ...
  TMyObj930_List0 = TObjectList<TMyObj930>;

  TMyObj930_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj930_List1 = TObjectList<TMyObj930_1>;
...
constructor TMyObj930_1.Create;
begin
  inherited;
  FInt := 930 * 3;
  FTest := 'Value: ' + Random(29302).ToString + Random(93000).ToString;
end;

procedure TForm930.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum930;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj930_List0 := TMyObj930_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj930_List1 := TMyObj930_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
