...
type
  ...
  TMyObj652_List0 = TObjectList<TMyObj652>;

  TMyObj652_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj652_List1 = TObjectList<TMyObj652_1>;
...
constructor TMyObj652_1.Create;
begin
  inherited;
  FInt := 652 * 3;
  FTest := 'Value: ' + Random(26522).ToString + Random(65200).ToString;
end;

procedure TForm652.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum652;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj652_List0 := TMyObj652_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj652_List1 := TMyObj652_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
