...
type
  ...
  TMyObj1092_List0 = TObjectList<TMyObj1092>;

  TMyObj1092_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1092_List1 = TObjectList<TMyObj1092_1>;
...
constructor TMyObj1092_1.Create;
begin
  inherited;
  FInt := 1092 * 3;
  FTest := 'Value: ' + Random(210922).ToString + Random(109200).ToString;
end;

procedure TForm1092.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1092;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1092_List0 := TMyObj1092_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1092_List1 := TMyObj1092_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
