...
type
  ...
  TMyObj750_List0 = TObjectList<TMyObj750>;

  TMyObj750_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj750_List1 = TObjectList<TMyObj750_1>;
...
constructor TMyObj750_1.Create;
begin
  inherited;
  FInt := 750 * 3;
  FTest := 'Value: ' + Random(27502).ToString + Random(75000).ToString;
end;

procedure TForm750.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum750;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj750_List0 := TMyObj750_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj750_List1 := TMyObj750_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
