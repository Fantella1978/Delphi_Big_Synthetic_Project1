...
type
  ...
  TMyObj2291_List0 = TObjectList<TMyObj2291>;

  TMyObj2291_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2291_List1 = TObjectList<TMyObj2291_1>;
...
constructor TMyObj2291_1.Create;
begin
  inherited;
  FInt := 2291 * 3;
  FTest := 'Value: ' + Random(222912).ToString + Random(229100).ToString;
end;

procedure TForm2291.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2291;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2291_List0 := TMyObj2291_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2291_List1 := TMyObj2291_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
