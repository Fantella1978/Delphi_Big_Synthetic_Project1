...
type
  ...
  TMyObj1170_List0 = TObjectList<TMyObj1170>;

  TMyObj1170_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1170_List1 = TObjectList<TMyObj1170_1>;
...
constructor TMyObj1170_1.Create;
begin
  inherited;
  FInt := 1170 * 3;
  FTest := 'Value: ' + Random(211702).ToString + Random(117000).ToString;
end;

procedure TForm1170.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1170;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1170_List0 := TMyObj1170_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1170_List1 := TMyObj1170_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
