...
type
  ...
  TMyObj95_List0 = TObjectList<TMyObj95>;

  TMyObj95_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj95_List1 = TObjectList<TMyObj95_1>;
...
constructor TMyObj95_1.Create;
begin
  inherited;
  FInt := 95 * 3;
  FTest := 'Value: ' + Random(2952).ToString + Random(9500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj95_List0 := TMyObj95_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj95_List1 := TMyObj95_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
