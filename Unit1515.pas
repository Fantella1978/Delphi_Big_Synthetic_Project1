...
type
  ...
  TMyObj1515_List0 = TObjectList<TMyObj1515>;

  TMyObj1515_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1515_List1 = TObjectList<TMyObj1515_1>;
...
constructor TMyObj1515_1.Create;
begin
  inherited;
  FInt := 1515 * 3;
  FTest := 'Value: ' + Random(215152).ToString + Random(151500).ToString;
end;

procedure TForm1515.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1515;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1515_List0 := TMyObj1515_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1515_List1 := TMyObj1515_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
