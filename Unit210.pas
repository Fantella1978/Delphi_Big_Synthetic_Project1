...
type
  ...
  TMyObj210_List0 = TObjectList<TMyObj210>;

  TMyObj210_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj210_List1 = TObjectList<TMyObj210_1>;
...
constructor TMyObj210_1.Create;
begin
  inherited;
  FInt := 210 * 3;
  FTest := 'Value: ' + Random(22102).ToString + Random(21000).ToString;
end;

procedure TForm210.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum210;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj210_List0 := TMyObj210_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj210_List1 := TMyObj210_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
