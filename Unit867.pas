...
type
  ...
  TMyObj867_List0 = TObjectList<TMyObj867>;

  TMyObj867_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj867_List1 = TObjectList<TMyObj867_1>;
...
constructor TMyObj867_1.Create;
begin
  inherited;
  FInt := 867 * 3;
  FTest := 'Value: ' + Random(28672).ToString + Random(86700).ToString;
end;

procedure TForm867.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum867;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj867_List0 := TMyObj867_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj867_List1 := TMyObj867_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
