...
type
  ...
  TMyObj2458_List0 = TObjectList<TMyObj2458>;

  TMyObj2458_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2458_List1 = TObjectList<TMyObj2458_1>;
...
constructor TMyObj2458_1.Create;
begin
  inherited;
  FInt := 2458 * 3;
  FTest := 'Value: ' + Random(224582).ToString + Random(245800).ToString;
end;

procedure TForm2458.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2458;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2458_List0 := TMyObj2458_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2458_List1 := TMyObj2458_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
