...
type
  ...
  TMyObj2073_List0 = TObjectList<TMyObj2073>;

  TMyObj2073_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2073_List1 = TObjectList<TMyObj2073_1>;
...
constructor TMyObj2073_1.Create;
begin
  inherited;
  FInt := 2073 * 3;
  FTest := 'Value: ' + Random(220732).ToString + Random(207300).ToString;
end;

procedure TForm2073.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2073;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2073_List0 := TMyObj2073_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2073_List1 := TMyObj2073_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
