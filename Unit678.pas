...
type
  ...
  TMyObj678_List0 = TObjectList<TMyObj678>;

  TMyObj678_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj678_List1 = TObjectList<TMyObj678_1>;
...
constructor TMyObj678_1.Create;
begin
  inherited;
  FInt := 678 * 3;
  FTest := 'Value: ' + Random(26782).ToString + Random(67800).ToString;
end;

procedure TForm678.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum678;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj678_List0 := TMyObj678_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj678_List1 := TMyObj678_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
