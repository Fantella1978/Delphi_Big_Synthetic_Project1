...
type
  ...
  TMyObj1225_List0 = TObjectList<TMyObj1225>;

  TMyObj1225_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1225_List1 = TObjectList<TMyObj1225_1>;
...
constructor TMyObj1225_1.Create;
begin
  inherited;
  FInt := 1225 * 3;
  FTest := 'Value: ' + Random(212252).ToString + Random(122500).ToString;
end;

procedure TForm1225.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1225;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1225_List0 := TMyObj1225_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1225_List1 := TMyObj1225_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
