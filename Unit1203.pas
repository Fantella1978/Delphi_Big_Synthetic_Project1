...
type
  ...
  TMyObj1203_List0 = TObjectList<TMyObj1203>;

  TMyObj1203_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1203_List1 = TObjectList<TMyObj1203_1>;
...
constructor TMyObj1203_1.Create;
begin
  inherited;
  FInt := 1203 * 3;
  FTest := 'Value: ' + Random(212032).ToString + Random(120300).ToString;
end;

procedure TForm1203.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1203;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1203_List0 := TMyObj1203_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1203_List1 := TMyObj1203_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
