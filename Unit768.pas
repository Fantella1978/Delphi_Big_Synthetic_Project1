...
type
  ...
  TMyObj768_List0 = TObjectList<TMyObj768>;

  TMyObj768_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj768_List1 = TObjectList<TMyObj768_1>;
...
constructor TMyObj768_1.Create;
begin
  inherited;
  FInt := 768 * 3;
  FTest := 'Value: ' + Random(27682).ToString + Random(76800).ToString;
end;

procedure TForm768.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum768;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj768_List0 := TMyObj768_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj768_List1 := TMyObj768_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
