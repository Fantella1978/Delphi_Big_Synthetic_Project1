...
type
  ...
  TMyObj115_List0 = TObjectList<TMyObj115>;

  TMyObj115_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj115_List1 = TObjectList<TMyObj115_1>;
...
constructor TMyObj115_1.Create;
begin
  inherited;
  FInt := 115 * 3;
  FTest := 'Value: ' + Random(21152).ToString + Random(11500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj115_List0 := TMyObj115_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj115_List1 := TMyObj115_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
