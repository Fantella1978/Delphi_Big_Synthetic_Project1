...
type
  ...
  TMyObj2106_List0 = TObjectList<TMyObj2106>;

  TMyObj2106_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2106_List1 = TObjectList<TMyObj2106_1>;
...
constructor TMyObj2106_1.Create;
begin
  inherited;
  FInt := 2106 * 3;
  FTest := 'Value: ' + Random(221062).ToString + Random(210600).ToString;
end;

procedure TForm2106.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2106;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2106_List0 := TMyObj2106_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2106_List1 := TMyObj2106_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
