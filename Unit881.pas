...
type
  ...
  TMyObj881_List0 = TObjectList<TMyObj881>;

  TMyObj881_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj881_List1 = TObjectList<TMyObj881_1>;
...
constructor TMyObj881_1.Create;
begin
  inherited;
  FInt := 881 * 3;
  FTest := 'Value: ' + Random(28812).ToString + Random(88100).ToString;
end;

procedure TForm881.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum881;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj881_List0 := TMyObj881_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj881_List1 := TMyObj881_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
