...
type
  ...
  TMyObj1007_List0 = TObjectList<TMyObj1007>;

  TMyObj1007_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1007_List1 = TObjectList<TMyObj1007_1>;
...
constructor TMyObj1007_1.Create;
begin
  inherited;
  FInt := 1007 * 3;
  FTest := 'Value: ' + Random(210072).ToString + Random(100700).ToString;
end;

procedure TForm1007.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1007;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1007_List0 := TMyObj1007_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1007_List1 := TMyObj1007_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
