...
type
  ...
  TMyObj1162_List0 = TObjectList<TMyObj1162>;

  TMyObj1162_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1162_List1 = TObjectList<TMyObj1162_1>;
...
constructor TMyObj1162_1.Create;
begin
  inherited;
  FInt := 1162 * 3;
  FTest := 'Value: ' + Random(211622).ToString + Random(116200).ToString;
end;

procedure TForm1162.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1162;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1162_List0 := TMyObj1162_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1162_List1 := TMyObj1162_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
