...
type
  ...
  TMyObj2316_List0 = TObjectList<TMyObj2316>;

  TMyObj2316_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2316_List1 = TObjectList<TMyObj2316_1>;
...
constructor TMyObj2316_1.Create;
begin
  inherited;
  FInt := 2316 * 3;
  FTest := 'Value: ' + Random(223162).ToString + Random(231600).ToString;
end;

procedure TForm2316.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2316;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2316_List0 := TMyObj2316_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2316_List1 := TMyObj2316_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
