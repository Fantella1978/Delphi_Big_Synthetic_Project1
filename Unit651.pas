...
type
  ...
  TMyObj651_List0 = TObjectList<TMyObj651>;

  TMyObj651_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj651_List1 = TObjectList<TMyObj651_1>;
...
constructor TMyObj651_1.Create;
begin
  inherited;
  FInt := 651 * 3;
  FTest := 'Value: ' + Random(26512).ToString + Random(65100).ToString;
end;

procedure TForm651.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum651;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj651_List0 := TMyObj651_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj651_List1 := TMyObj651_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
