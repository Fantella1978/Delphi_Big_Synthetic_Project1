...
type
  ...
  TMyObj1320_List0 = TObjectList<TMyObj1320>;

  TMyObj1320_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1320_List1 = TObjectList<TMyObj1320_1>;
...
constructor TMyObj1320_1.Create;
begin
  inherited;
  FInt := 1320 * 3;
  FTest := 'Value: ' + Random(213202).ToString + Random(132000).ToString;
end;

procedure TForm1320.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1320;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1320_List0 := TMyObj1320_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1320_List1 := TMyObj1320_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
