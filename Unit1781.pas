...
type
  ...
  TMyObj1781_List0 = TObjectList<TMyObj1781>;

  TMyObj1781_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1781_List1 = TObjectList<TMyObj1781_1>;
...
constructor TMyObj1781_1.Create;
begin
  inherited;
  FInt := 1781 * 3;
  FTest := 'Value: ' + Random(217812).ToString + Random(178100).ToString;
end;

procedure TForm1781.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1781;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1781_List0 := TMyObj1781_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1781_List1 := TMyObj1781_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
