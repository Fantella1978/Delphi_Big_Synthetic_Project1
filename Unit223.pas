...
type
  ...
  TMyObj223_List0 = TObjectList<TMyObj223>;

  TMyObj223_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj223_List1 = TObjectList<TMyObj223_1>;
...
constructor TMyObj223_1.Create;
begin
  inherited;
  FInt := 223 * 3;
  FTest := 'Value: ' + Random(22232).ToString + Random(22300).ToString;
end;

procedure TForm223.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum223;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj223_List0 := TMyObj223_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj223_List1 := TMyObj223_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
