...
type
  ...
  TMyObj940_List0 = TObjectList<TMyObj940>;

  TMyObj940_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj940_List1 = TObjectList<TMyObj940_1>;
...
constructor TMyObj940_1.Create;
begin
  inherited;
  FInt := 940 * 3;
  FTest := 'Value: ' + Random(29402).ToString + Random(94000).ToString;
end;

procedure TForm940.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum940;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj940_List0 := TMyObj940_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj940_List1 := TMyObj940_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
