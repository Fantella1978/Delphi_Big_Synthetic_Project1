...
type
  ...
  TMyObj1752_List0 = TObjectList<TMyObj1752>;

  TMyObj1752_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1752_List1 = TObjectList<TMyObj1752_1>;
...
constructor TMyObj1752_1.Create;
begin
  inherited;
  FInt := 1752 * 3;
  FTest := 'Value: ' + Random(217522).ToString + Random(175200).ToString;
end;

procedure TForm1752.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1752;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1752_List0 := TMyObj1752_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1752_List1 := TMyObj1752_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
