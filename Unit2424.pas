...
type
  ...
  TMyObj2424_List0 = TObjectList<TMyObj2424>;

  TMyObj2424_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2424_List1 = TObjectList<TMyObj2424_1>;
...
constructor TMyObj2424_1.Create;
begin
  inherited;
  FInt := 2424 * 3;
  FTest := 'Value: ' + Random(224242).ToString + Random(242400).ToString;
end;

procedure TForm2424.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2424;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2424_List0 := TMyObj2424_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2424_List1 := TMyObj2424_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
