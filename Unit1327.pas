...
type
  ...
  TMyObj1327_List0 = TObjectList<TMyObj1327>;

  TMyObj1327_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1327_List1 = TObjectList<TMyObj1327_1>;
...
constructor TMyObj1327_1.Create;
begin
  inherited;
  FInt := 1327 * 3;
  FTest := 'Value: ' + Random(213272).ToString + Random(132700).ToString;
end;

procedure TForm1327.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1327;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1327_List0 := TMyObj1327_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1327_List1 := TMyObj1327_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
