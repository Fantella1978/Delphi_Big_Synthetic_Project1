...
type
  ...
  TMyObj45_List0 = TObjectList<TMyObj45>;

  TMyObj45_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj45_List1 = TObjectList<TMyObj45_1>;
...
constructor TMyObj45_1.Create;
begin
  inherited;
  FInt := 45 * 3;
  FTest := 'Value: ' + Random(2452).ToString + Random(4500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj45_List0 := TMyObj45_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj45_List1 := TMyObj45_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
