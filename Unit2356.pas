...
type
  ...
  TMyObj2356_List0 = TObjectList<TMyObj2356>;

  TMyObj2356_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2356_List1 = TObjectList<TMyObj2356_1>;
...
constructor TMyObj2356_1.Create;
begin
  inherited;
  FInt := 2356 * 3;
  FTest := 'Value: ' + Random(223562).ToString + Random(235600).ToString;
end;

procedure TForm2356.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2356;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2356_List0 := TMyObj2356_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2356_List1 := TMyObj2356_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
