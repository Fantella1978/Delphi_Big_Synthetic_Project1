...
type
  ...
  TMyObj623_List0 = TObjectList<TMyObj623>;

  TMyObj623_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj623_List1 = TObjectList<TMyObj623_1>;
...
constructor TMyObj623_1.Create;
begin
  inherited;
  FInt := 623 * 3;
  FTest := 'Value: ' + Random(26232).ToString + Random(62300).ToString;
end;

procedure TForm623.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum623;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj623_List0 := TMyObj623_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj623_List1 := TMyObj623_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
