...
type
  ...
  TMyObj999_List0 = TObjectList<TMyObj999>;

  TMyObj999_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj999_List1 = TObjectList<TMyObj999_1>;
...
constructor TMyObj999_1.Create;
begin
  inherited;
  FInt := 999 * 3;
  FTest := 'Value: ' + Random(29992).ToString + Random(99900).ToString;
end;

procedure TForm999.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum999;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj999_List0 := TMyObj999_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj999_List1 := TMyObj999_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
