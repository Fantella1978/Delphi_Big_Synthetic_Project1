...
type
  ...
  TMyObj1039_List0 = TObjectList<TMyObj1039>;

  TMyObj1039_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1039_List1 = TObjectList<TMyObj1039_1>;
...
constructor TMyObj1039_1.Create;
begin
  inherited;
  FInt := 1039 * 3;
  FTest := 'Value: ' + Random(210392).ToString + Random(103900).ToString;
end;

procedure TForm1039.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1039;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1039_List0 := TMyObj1039_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1039_List1 := TMyObj1039_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
