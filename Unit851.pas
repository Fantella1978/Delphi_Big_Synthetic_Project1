...
type
  ...
  TMyObj851_List0 = TObjectList<TMyObj851>;

  TMyObj851_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj851_List1 = TObjectList<TMyObj851_1>;
...
constructor TMyObj851_1.Create;
begin
  inherited;
  FInt := 851 * 3;
  FTest := 'Value: ' + Random(28512).ToString + Random(85100).ToString;
end;

procedure TForm851.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum851;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj851_List0 := TMyObj851_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj851_List1 := TMyObj851_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
