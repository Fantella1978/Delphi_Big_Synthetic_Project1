...
type
  ...
  TMyObj1791_List0 = TObjectList<TMyObj1791>;

  TMyObj1791_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1791_List1 = TObjectList<TMyObj1791_1>;
...
constructor TMyObj1791_1.Create;
begin
  inherited;
  FInt := 1791 * 3;
  FTest := 'Value: ' + Random(217912).ToString + Random(179100).ToString;
end;

procedure TForm1791.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1791;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1791_List0 := TMyObj1791_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1791_List1 := TMyObj1791_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
