...
type
  ...
  TMyObj1624_List0 = TObjectList<TMyObj1624>;

  TMyObj1624_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1624_List1 = TObjectList<TMyObj1624_1>;
...
constructor TMyObj1624_1.Create;
begin
  inherited;
  FInt := 1624 * 3;
  FTest := 'Value: ' + Random(216242).ToString + Random(162400).ToString;
end;

procedure TForm1624.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1624;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1624_List0 := TMyObj1624_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1624_List1 := TMyObj1624_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
