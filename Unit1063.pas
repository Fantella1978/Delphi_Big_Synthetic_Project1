...
type
  ...
  TMyObj1063_List0 = TObjectList<TMyObj1063>;

  TMyObj1063_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1063_List1 = TObjectList<TMyObj1063_1>;
...
constructor TMyObj1063_1.Create;
begin
  inherited;
  FInt := 1063 * 3;
  FTest := 'Value: ' + Random(210632).ToString + Random(106300).ToString;
end;

procedure TForm1063.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1063;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1063_List0 := TMyObj1063_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1063_List1 := TMyObj1063_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
