...
type
  ...
  TMyObj1553_List0 = TObjectList<TMyObj1553>;

  TMyObj1553_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1553_List1 = TObjectList<TMyObj1553_1>;
...
constructor TMyObj1553_1.Create;
begin
  inherited;
  FInt := 1553 * 3;
  FTest := 'Value: ' + Random(215532).ToString + Random(155300).ToString;
end;

procedure TForm1553.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1553;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1553_List0 := TMyObj1553_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1553_List1 := TMyObj1553_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
