...
type
  ...
  TMyObj2257_List0 = TObjectList<TMyObj2257>;

  TMyObj2257_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2257_List1 = TObjectList<TMyObj2257_1>;
...
constructor TMyObj2257_1.Create;
begin
  inherited;
  FInt := 2257 * 3;
  FTest := 'Value: ' + Random(222572).ToString + Random(225700).ToString;
end;

procedure TForm2257.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2257;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2257_List0 := TMyObj2257_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2257_List1 := TMyObj2257_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
