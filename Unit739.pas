...
type
  ...
  TMyObj739_List0 = TObjectList<TMyObj739>;

  TMyObj739_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj739_List1 = TObjectList<TMyObj739_1>;
...
constructor TMyObj739_1.Create;
begin
  inherited;
  FInt := 739 * 3;
  FTest := 'Value: ' + Random(27392).ToString + Random(73900).ToString;
end;

procedure TForm739.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum739;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj739_List0 := TMyObj739_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj739_List1 := TMyObj739_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
