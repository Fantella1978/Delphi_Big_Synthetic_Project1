...
type
  ...
  TMyObj1163_List0 = TObjectList<TMyObj1163>;

  TMyObj1163_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1163_List1 = TObjectList<TMyObj1163_1>;
...
constructor TMyObj1163_1.Create;
begin
  inherited;
  FInt := 1163 * 3;
  FTest := 'Value: ' + Random(211632).ToString + Random(116300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1163_List0 := TMyObj1163_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1163_List1 := TMyObj1163_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
