...
type
  ...
  TMyObj295_List0 = TObjectList<TMyObj295>;

  TMyObj295_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj295_List1 = TObjectList<TMyObj295_1>;
...
constructor TMyObj295_1.Create;
begin
  inherited;
  FInt := 295 * 3;
  FTest := 'Value: ' + Random(22952).ToString + Random(29500).ToString;
end;

procedure TForm295.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum295;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj295_List0 := TMyObj295_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj295_List1 := TMyObj295_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
