...
type
  ...
  TMyObj20_List0 = TObjectList<TMyObj20>;

  TMyObj20_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj20_List1 = TObjectList<TMyObj20_1>;
...
constructor TMyObj20_1.Create;
begin
  inherited;
  FInt := 20 * 3;
  FTest := 'Value: ' + Random(2202).ToString + Random(2000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj20_List0 := TMyObj20_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj20_List1 := TMyObj20_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
