...
type
  ...
  TMyObj933_List0 = TObjectList<TMyObj933>;

  TMyObj933_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj933_List1 = TObjectList<TMyObj933_1>;
...
constructor TMyObj933_1.Create;
begin
  inherited;
  FInt := 933 * 3;
  FTest := 'Value: ' + Random(29332).ToString + Random(93300).ToString;
end;

procedure TForm933.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum933;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj933_List0 := TMyObj933_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj933_List1 := TMyObj933_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
