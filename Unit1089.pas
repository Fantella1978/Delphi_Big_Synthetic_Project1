...
type
  ...
  TMyObj1089_List0 = TObjectList<TMyObj1089>;

  TMyObj1089_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1089_List1 = TObjectList<TMyObj1089_1>;
...
constructor TMyObj1089_1.Create;
begin
  inherited;
  FInt := 1089 * 3;
  FTest := 'Value: ' + Random(210892).ToString + Random(108900).ToString;
end;

procedure TForm1089.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1089;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1089_List0 := TMyObj1089_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1089_List1 := TMyObj1089_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
