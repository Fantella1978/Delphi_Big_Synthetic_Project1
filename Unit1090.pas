...
type
  ...
  TMyObj1090_List0 = TObjectList<TMyObj1090>;

  TMyObj1090_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1090_List1 = TObjectList<TMyObj1090_1>;
...
constructor TMyObj1090_1.Create;
begin
  inherited;
  FInt := 1090 * 3;
  FTest := 'Value: ' + Random(210902).ToString + Random(109000).ToString;
end;

procedure TForm1090.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1090;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1090_List0 := TMyObj1090_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1090_List1 := TMyObj1090_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
