...
type
  ...
  TMyObj2163_List0 = TObjectList<TMyObj2163>;

  TMyObj2163_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2163_List1 = TObjectList<TMyObj2163_1>;
...
constructor TMyObj2163_1.Create;
begin
  inherited;
  FInt := 2163 * 3;
  FTest := 'Value: ' + Random(221632).ToString + Random(216300).ToString;
end;

procedure TForm2163.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2163;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2163_List0 := TMyObj2163_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2163_List1 := TMyObj2163_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
