...
type
  ...
  TMyObj2074_List0 = TObjectList<TMyObj2074>;

  TMyObj2074_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2074_List1 = TObjectList<TMyObj2074_1>;
...
constructor TMyObj2074_1.Create;
begin
  inherited;
  FInt := 2074 * 3;
  FTest := 'Value: ' + Random(220742).ToString + Random(207400).ToString;
end;

procedure TForm2074.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2074;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2074_List0 := TMyObj2074_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2074_List1 := TMyObj2074_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
