...
type
  ...
  TMyObj973_List0 = TObjectList<TMyObj973>;

  TMyObj973_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj973_List1 = TObjectList<TMyObj973_1>;
...
constructor TMyObj973_1.Create;
begin
  inherited;
  FInt := 973 * 3;
  FTest := 'Value: ' + Random(29732).ToString + Random(97300).ToString;
end;

procedure TForm973.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum973;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj973_List0 := TMyObj973_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj973_List1 := TMyObj973_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
