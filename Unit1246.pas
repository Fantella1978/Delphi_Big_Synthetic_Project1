...
type
  ...
  TMyObj1246_List0 = TObjectList<TMyObj1246>;

  TMyObj1246_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1246_List1 = TObjectList<TMyObj1246_1>;
...
constructor TMyObj1246_1.Create;
begin
  inherited;
  FInt := 1246 * 3;
  FTest := 'Value: ' + Random(212462).ToString + Random(124600).ToString;
end;

procedure TForm1246.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1246;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1246_List0 := TMyObj1246_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1246_List1 := TMyObj1246_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
