...
type
  ...
  TMyObj2057_List0 = TObjectList<TMyObj2057>;

  TMyObj2057_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2057_List1 = TObjectList<TMyObj2057_1>;
...
constructor TMyObj2057_1.Create;
begin
  inherited;
  FInt := 2057 * 3;
  FTest := 'Value: ' + Random(220572).ToString + Random(205700).ToString;
end;

procedure TForm2057.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2057;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2057_List0 := TMyObj2057_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2057_List1 := TMyObj2057_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
