...
type
  ...
  TMyObj357_List0 = TObjectList<TMyObj357>;

  TMyObj357_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj357_List1 = TObjectList<TMyObj357_1>;
...
constructor TMyObj357_1.Create;
begin
  inherited;
  FInt := 357 * 3;
  FTest := 'Value: ' + Random(23572).ToString + Random(35700).ToString;
end;

procedure TForm357.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum357;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj357_List0 := TMyObj357_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj357_List1 := TMyObj357_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
