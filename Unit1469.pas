...
type
  ...
  TMyObj1469_List0 = TObjectList<TMyObj1469>;

  TMyObj1469_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1469_List1 = TObjectList<TMyObj1469_1>;
...
constructor TMyObj1469_1.Create;
begin
  inherited;
  FInt := 1469 * 3;
  FTest := 'Value: ' + Random(214692).ToString + Random(146900).ToString;
end;

procedure TForm1469.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1469;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1469_List0 := TMyObj1469_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1469_List1 := TMyObj1469_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
