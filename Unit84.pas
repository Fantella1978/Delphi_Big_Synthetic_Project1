...
type
  ...
  TMyObj84_List0 = TObjectList<TMyObj84>;

  TMyObj84_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj84_List1 = TObjectList<TMyObj84_1>;
...
constructor TMyObj84_1.Create;
begin
  inherited;
  FInt := 84 * 3;
  FTest := 'Value: ' + Random(2842).ToString + Random(8400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj84_List0 := TMyObj84_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj84_List1 := TMyObj84_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
