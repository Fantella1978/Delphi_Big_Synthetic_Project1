...
type
  ...
  TMyObj1436_List0 = TObjectList<TMyObj1436>;

  TMyObj1436_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1436_List1 = TObjectList<TMyObj1436_1>;
...
constructor TMyObj1436_1.Create;
begin
  inherited;
  FInt := 1436 * 3;
  FTest := 'Value: ' + Random(214362).ToString + Random(143600).ToString;
end;

procedure TForm1436.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1436;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1436_List0 := TMyObj1436_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1436_List1 := TMyObj1436_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
