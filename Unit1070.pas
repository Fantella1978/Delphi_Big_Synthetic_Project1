...
type
  ...
  TMyObj1070_List0 = TObjectList<TMyObj1070>;

  TMyObj1070_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1070_List1 = TObjectList<TMyObj1070_1>;
...
constructor TMyObj1070_1.Create;
begin
  inherited;
  FInt := 1070 * 3;
  FTest := 'Value: ' + Random(210702).ToString + Random(107000).ToString;
end;

procedure TForm1070.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1070;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1070_List0 := TMyObj1070_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1070_List1 := TMyObj1070_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
