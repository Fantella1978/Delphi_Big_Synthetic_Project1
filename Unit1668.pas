...
type
  ...
  TMyObj1668_List0 = TObjectList<TMyObj1668>;

  TMyObj1668_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1668_List1 = TObjectList<TMyObj1668_1>;
...
constructor TMyObj1668_1.Create;
begin
  inherited;
  FInt := 1668 * 3;
  FTest := 'Value: ' + Random(216682).ToString + Random(166800).ToString;
end;

procedure TForm1668.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1668;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1668_List0 := TMyObj1668_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1668_List1 := TMyObj1668_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
