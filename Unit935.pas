...
type
  ...
  TMyObj935_List0 = TObjectList<TMyObj935>;

  TMyObj935_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj935_List1 = TObjectList<TMyObj935_1>;
...
constructor TMyObj935_1.Create;
begin
  inherited;
  FInt := 935 * 3;
  FTest := 'Value: ' + Random(29352).ToString + Random(93500).ToString;
end;

procedure TForm935.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum935;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj935_List0 := TMyObj935_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj935_List1 := TMyObj935_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
