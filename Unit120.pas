...
type
  ...
  TMyObj120_List0 = TObjectList<TMyObj120>;

  TMyObj120_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj120_List1 = TObjectList<TMyObj120_1>;
...
constructor TMyObj120_1.Create;
begin
  inherited;
  FInt := 120 * 3;
  FTest := 'Value: ' + Random(21202).ToString + Random(12000).ToString;
end;

procedure TForm120.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum120;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj120_List0 := TMyObj120_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj120_List1 := TMyObj120_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
