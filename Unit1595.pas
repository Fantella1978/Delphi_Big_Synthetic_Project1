...
type
  ...
  TMyObj1595_List0 = TObjectList<TMyObj1595>;

  TMyObj1595_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1595_List1 = TObjectList<TMyObj1595_1>;
...
constructor TMyObj1595_1.Create;
begin
  inherited;
  FInt := 1595 * 3;
  FTest := 'Value: ' + Random(215952).ToString + Random(159500).ToString;
end;

procedure TForm1595.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1595;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1595_List0 := TMyObj1595_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1595_List1 := TMyObj1595_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
