...
type
  ...
  TMyObj1782_List0 = TObjectList<TMyObj1782>;

  TMyObj1782_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1782_List1 = TObjectList<TMyObj1782_1>;
...
constructor TMyObj1782_1.Create;
begin
  inherited;
  FInt := 1782 * 3;
  FTest := 'Value: ' + Random(217822).ToString + Random(178200).ToString;
end;

procedure TForm1782.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1782;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1782_List0 := TMyObj1782_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1782_List1 := TMyObj1782_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
