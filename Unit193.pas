...
type
  ...
  TMyObj193_List0 = TObjectList<TMyObj193>;

  TMyObj193_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj193_List1 = TObjectList<TMyObj193_1>;
...
constructor TMyObj193_1.Create;
begin
  inherited;
  FInt := 193 * 3;
  FTest := 'Value: ' + Random(21932).ToString + Random(19300).ToString;
end;

procedure TForm193.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum193;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj193_List0 := TMyObj193_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj193_List1 := TMyObj193_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
