...
type
  ...
  TMyObj548_List0 = TObjectList<TMyObj548>;

  TMyObj548_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj548_List1 = TObjectList<TMyObj548_1>;
...
constructor TMyObj548_1.Create;
begin
  inherited;
  FInt := 548 * 3;
  FTest := 'Value: ' + Random(25482).ToString + Random(54800).ToString;
end;

procedure TForm548.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum548;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj548_List0 := TMyObj548_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj548_List1 := TMyObj548_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
