...
type
  ...
  TMyObj2218_List0 = TObjectList<TMyObj2218>;

  TMyObj2218_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2218_List1 = TObjectList<TMyObj2218_1>;
...
constructor TMyObj2218_1.Create;
begin
  inherited;
  FInt := 2218 * 3;
  FTest := 'Value: ' + Random(222182).ToString + Random(221800).ToString;
end;

procedure TForm2218.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2218;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2218_List0 := TMyObj2218_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2218_List1 := TMyObj2218_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
