...
type
  ...
  TMyObj1398_List0 = TObjectList<TMyObj1398>;

  TMyObj1398_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1398_List1 = TObjectList<TMyObj1398_1>;
...
constructor TMyObj1398_1.Create;
begin
  inherited;
  FInt := 1398 * 3;
  FTest := 'Value: ' + Random(213982).ToString + Random(139800).ToString;
end;

procedure TForm1398.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1398;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1398_List0 := TMyObj1398_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1398_List1 := TMyObj1398_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
