...
type
  ...
  TMyObj214_List0 = TObjectList<TMyObj214>;

  TMyObj214_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj214_List1 = TObjectList<TMyObj214_1>;
...
constructor TMyObj214_1.Create;
begin
  inherited;
  FInt := 214 * 3;
  FTest := 'Value: ' + Random(22142).ToString + Random(21400).ToString;
end;

procedure TForm214.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum214;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj214_List0 := TMyObj214_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj214_List1 := TMyObj214_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
