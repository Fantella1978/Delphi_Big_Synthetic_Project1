...
type
  ...
  TMyObj1701_List0 = TObjectList<TMyObj1701>;

  TMyObj1701_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1701_List1 = TObjectList<TMyObj1701_1>;
...
constructor TMyObj1701_1.Create;
begin
  inherited;
  FInt := 1701 * 3;
  FTest := 'Value: ' + Random(217012).ToString + Random(170100).ToString;
end;

procedure TForm1701.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1701;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1701_List0 := TMyObj1701_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1701_List1 := TMyObj1701_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
