...
type
  ...
  TMyObj1173_List0 = TObjectList<TMyObj1173>;

  TMyObj1173_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1173_List1 = TObjectList<TMyObj1173_1>;
...
constructor TMyObj1173_1.Create;
begin
  inherited;
  FInt := 1173 * 3;
  FTest := 'Value: ' + Random(211732).ToString + Random(117300).ToString;
end;

procedure TForm1173.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1173;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1173_List0 := TMyObj1173_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1173_List1 := TMyObj1173_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
