...
type
  ...
  TMyObj456_List0 = TObjectList<TMyObj456>;

  TMyObj456_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj456_List1 = TObjectList<TMyObj456_1>;
...
constructor TMyObj456_1.Create;
begin
  inherited;
  FInt := 456 * 3;
  FTest := 'Value: ' + Random(24562).ToString + Random(45600).ToString;
end;

procedure TForm456.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum456;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj456_List0 := TMyObj456_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj456_List1 := TMyObj456_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
