...
type
  ...
  TMyObj2244_List0 = TObjectList<TMyObj2244>;

  TMyObj2244_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2244_List1 = TObjectList<TMyObj2244_1>;
...
constructor TMyObj2244_1.Create;
begin
  inherited;
  FInt := 2244 * 3;
  FTest := 'Value: ' + Random(222442).ToString + Random(224400).ToString;
end;

procedure TForm2244.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2244;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2244_List0 := TMyObj2244_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2244_List1 := TMyObj2244_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
