...
type
  ...
  TMyObj2402_List0 = TObjectList<TMyObj2402>;

  TMyObj2402_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2402_List1 = TObjectList<TMyObj2402_1>;
...
constructor TMyObj2402_1.Create;
begin
  inherited;
  FInt := 2402 * 3;
  FTest := 'Value: ' + Random(224022).ToString + Random(240200).ToString;
end;

procedure TForm2402.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2402;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2402_List0 := TMyObj2402_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2402_List1 := TMyObj2402_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
