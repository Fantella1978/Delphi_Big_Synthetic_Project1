...
type
  ...
  TMyObj1068_List0 = TObjectList<TMyObj1068>;

  TMyObj1068_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1068_List1 = TObjectList<TMyObj1068_1>;
...
constructor TMyObj1068_1.Create;
begin
  inherited;
  FInt := 1068 * 3;
  FTest := 'Value: ' + Random(210682).ToString + Random(106800).ToString;
end;

procedure TForm1068.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1068;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1068_List0 := TMyObj1068_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1068_List1 := TMyObj1068_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
