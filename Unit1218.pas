...
type
  ...
  TMyObj1218_List0 = TObjectList<TMyObj1218>;

  TMyObj1218_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1218_List1 = TObjectList<TMyObj1218_1>;
...
constructor TMyObj1218_1.Create;
begin
  inherited;
  FInt := 1218 * 3;
  FTest := 'Value: ' + Random(212182).ToString + Random(121800).ToString;
end;

procedure TForm1218.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1218;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1218_List0 := TMyObj1218_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1218_List1 := TMyObj1218_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
