...
type
  ...
  TMyObj1775_List0 = TObjectList<TMyObj1775>;

  TMyObj1775_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1775_List1 = TObjectList<TMyObj1775_1>;
...
constructor TMyObj1775_1.Create;
begin
  inherited;
  FInt := 1775 * 3;
  FTest := 'Value: ' + Random(217752).ToString + Random(177500).ToString;
end;

procedure TForm1775.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1775;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1775_List0 := TMyObj1775_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1775_List1 := TMyObj1775_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
