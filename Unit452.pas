...
type
  ...
  TMyObj452_List0 = TObjectList<TMyObj452>;

  TMyObj452_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj452_List1 = TObjectList<TMyObj452_1>;
...
constructor TMyObj452_1.Create;
begin
  inherited;
  FInt := 452 * 3;
  FTest := 'Value: ' + Random(24522).ToString + Random(45200).ToString;
end;

procedure TForm452.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum452;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj452_List0 := TMyObj452_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj452_List1 := TMyObj452_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
