...
type
  ...
  TMyObj218_List0 = TObjectList<TMyObj218>;

  TMyObj218_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj218_List1 = TObjectList<TMyObj218_1>;
...
constructor TMyObj218_1.Create;
begin
  inherited;
  FInt := 218 * 3;
  FTest := 'Value: ' + Random(22182).ToString + Random(21800).ToString;
end;

procedure TForm218.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum218;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj218_List0 := TMyObj218_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj218_List1 := TMyObj218_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
