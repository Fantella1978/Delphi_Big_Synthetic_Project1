...
type
  ...
  TMyObj667_List0 = TObjectList<TMyObj667>;

  TMyObj667_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj667_List1 = TObjectList<TMyObj667_1>;
...
constructor TMyObj667_1.Create;
begin
  inherited;
  FInt := 667 * 3;
  FTest := 'Value: ' + Random(26672).ToString + Random(66700).ToString;
end;

procedure TForm667.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum667;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj667_List0 := TMyObj667_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj667_List1 := TMyObj667_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
