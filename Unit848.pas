...
type
  ...
  TMyObj848_List0 = TObjectList<TMyObj848>;

  TMyObj848_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj848_List1 = TObjectList<TMyObj848_1>;
...
constructor TMyObj848_1.Create;
begin
  inherited;
  FInt := 848 * 3;
  FTest := 'Value: ' + Random(28482).ToString + Random(84800).ToString;
end;

procedure TForm848.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum848;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj848_List0 := TMyObj848_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj848_List1 := TMyObj848_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
