...
type
  ...
  TMyObj668_List0 = TObjectList<TMyObj668>;

  TMyObj668_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj668_List1 = TObjectList<TMyObj668_1>;
...
constructor TMyObj668_1.Create;
begin
  inherited;
  FInt := 668 * 3;
  FTest := 'Value: ' + Random(26682).ToString + Random(66800).ToString;
end;

procedure TForm668.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum668;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj668_List0 := TMyObj668_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj668_List1 := TMyObj668_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
