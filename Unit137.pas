...
type
  ...
  TMyObj137_List0 = TObjectList<TMyObj137>;

  TMyObj137_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj137_List1 = TObjectList<TMyObj137_1>;
...
constructor TMyObj137_1.Create;
begin
  inherited;
  FInt := 137 * 3;
  FTest := 'Value: ' + Random(21372).ToString + Random(13700).ToString;
end;

procedure TForm137.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum137;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj137_List0 := TMyObj137_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj137_List1 := TMyObj137_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
