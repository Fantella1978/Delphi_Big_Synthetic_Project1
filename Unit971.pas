...
type
  ...
  TMyObj971_List0 = TObjectList<TMyObj971>;

  TMyObj971_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj971_List1 = TObjectList<TMyObj971_1>;
...
constructor TMyObj971_1.Create;
begin
  inherited;
  FInt := 971 * 3;
  FTest := 'Value: ' + Random(29712).ToString + Random(97100).ToString;
end;

procedure TForm971.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum971;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj971_List0 := TMyObj971_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj971_List1 := TMyObj971_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
