...
type
  ...
  TMyObj2224_List0 = TObjectList<TMyObj2224>;

  TMyObj2224_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2224_List1 = TObjectList<TMyObj2224_1>;
...
constructor TMyObj2224_1.Create;
begin
  inherited;
  FInt := 2224 * 3;
  FTest := 'Value: ' + Random(222242).ToString + Random(222400).ToString;
end;

procedure TForm2224.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2224;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2224_List0 := TMyObj2224_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2224_List1 := TMyObj2224_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
