...
type
  ...
  TMyObj1817_List0 = TObjectList<TMyObj1817>;

  TMyObj1817_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1817_List1 = TObjectList<TMyObj1817_1>;
...
constructor TMyObj1817_1.Create;
begin
  inherited;
  FInt := 1817 * 3;
  FTest := 'Value: ' + Random(218172).ToString + Random(181700).ToString;
end;

procedure TForm1817.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1817;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1817_List0 := TMyObj1817_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1817_List1 := TMyObj1817_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
