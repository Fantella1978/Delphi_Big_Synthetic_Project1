...
type
  ...
  TMyObj948_List0 = TObjectList<TMyObj948>;

  TMyObj948_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj948_List1 = TObjectList<TMyObj948_1>;
...
constructor TMyObj948_1.Create;
begin
  inherited;
  FInt := 948 * 3;
  FTest := 'Value: ' + Random(29482).ToString + Random(94800).ToString;
end;

procedure TForm948.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum948;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj948_List0 := TMyObj948_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj948_List1 := TMyObj948_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
