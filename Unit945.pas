...
type
  ...
  TMyObj945_List0 = TObjectList<TMyObj945>;

  TMyObj945_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj945_List1 = TObjectList<TMyObj945_1>;
...
constructor TMyObj945_1.Create;
begin
  inherited;
  FInt := 945 * 3;
  FTest := 'Value: ' + Random(29452).ToString + Random(94500).ToString;
end;

procedure TForm945.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum945;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj945_List0 := TMyObj945_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj945_List1 := TMyObj945_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
