...
type
  ...
  TMyObj348_List0 = TObjectList<TMyObj348>;

  TMyObj348_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj348_List1 = TObjectList<TMyObj348_1>;
...
constructor TMyObj348_1.Create;
begin
  inherited;
  FInt := 348 * 3;
  FTest := 'Value: ' + Random(23482).ToString + Random(34800).ToString;
end;

procedure TForm348.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum348;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj348_List0 := TMyObj348_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj348_List1 := TMyObj348_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
