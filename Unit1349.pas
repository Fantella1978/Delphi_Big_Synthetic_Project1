...
type
  ...
  TMyObj1349_List0 = TObjectList<TMyObj1349>;

  TMyObj1349_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1349_List1 = TObjectList<TMyObj1349_1>;
...
constructor TMyObj1349_1.Create;
begin
  inherited;
  FInt := 1349 * 3;
  FTest := 'Value: ' + Random(213492).ToString + Random(134900).ToString;
end;

procedure TForm1349.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1349;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1349_List0 := TMyObj1349_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1349_List1 := TMyObj1349_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
