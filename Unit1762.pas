...
type
  ...
  TMyObj1762_List0 = TObjectList<TMyObj1762>;

  TMyObj1762_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1762_List1 = TObjectList<TMyObj1762_1>;
...
constructor TMyObj1762_1.Create;
begin
  inherited;
  FInt := 1762 * 3;
  FTest := 'Value: ' + Random(217622).ToString + Random(176200).ToString;
end;

procedure TForm1762.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1762;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1762_List0 := TMyObj1762_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1762_List1 := TMyObj1762_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
