...
type
  ...
  TMyObj1337_List0 = TObjectList<TMyObj1337>;

  TMyObj1337_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1337_List1 = TObjectList<TMyObj1337_1>;
...
constructor TMyObj1337_1.Create;
begin
  inherited;
  FInt := 1337 * 3;
  FTest := 'Value: ' + Random(213372).ToString + Random(133700).ToString;
end;

procedure TForm1337.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1337;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1337_List0 := TMyObj1337_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1337_List1 := TMyObj1337_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
