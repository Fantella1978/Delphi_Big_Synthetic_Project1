...
type
  ...
  TMyObj470_List0 = TObjectList<TMyObj470>;

  TMyObj470_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj470_List1 = TObjectList<TMyObj470_1>;
...
constructor TMyObj470_1.Create;
begin
  inherited;
  FInt := 470 * 3;
  FTest := 'Value: ' + Random(24702).ToString + Random(47000).ToString;
end;

procedure TForm470.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum470;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj470_List0 := TMyObj470_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj470_List1 := TMyObj470_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
