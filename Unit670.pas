...
type
  ...
  TMyObj670_List0 = TObjectList<TMyObj670>;

  TMyObj670_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj670_List1 = TObjectList<TMyObj670_1>;
...
constructor TMyObj670_1.Create;
begin
  inherited;
  FInt := 670 * 3;
  FTest := 'Value: ' + Random(26702).ToString + Random(67000).ToString;
end;

procedure TForm670.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum670;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj670_List0 := TMyObj670_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj670_List1 := TMyObj670_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
