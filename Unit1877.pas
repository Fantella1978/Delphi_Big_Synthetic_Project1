...
type
  ...
  TMyObj1877_List0 = TObjectList<TMyObj1877>;

  TMyObj1877_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1877_List1 = TObjectList<TMyObj1877_1>;
...
constructor TMyObj1877_1.Create;
begin
  inherited;
  FInt := 1877 * 3;
  FTest := 'Value: ' + Random(218772).ToString + Random(187700).ToString;
end;

procedure TForm1877.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1877;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1877_List0 := TMyObj1877_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1877_List1 := TMyObj1877_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
