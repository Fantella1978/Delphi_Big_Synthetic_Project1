...
type
  ...
  TMyObj1959_List0 = TObjectList<TMyObj1959>;

  TMyObj1959_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1959_List1 = TObjectList<TMyObj1959_1>;
...
constructor TMyObj1959_1.Create;
begin
  inherited;
  FInt := 1959 * 3;
  FTest := 'Value: ' + Random(219592).ToString + Random(195900).ToString;
end;

procedure TForm1959.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1959;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1959_List0 := TMyObj1959_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1959_List1 := TMyObj1959_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
