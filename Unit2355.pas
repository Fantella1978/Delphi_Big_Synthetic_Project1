...
type
  ...
  TMyObj2355_List0 = TObjectList<TMyObj2355>;

  TMyObj2355_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2355_List1 = TObjectList<TMyObj2355_1>;
...
constructor TMyObj2355_1.Create;
begin
  inherited;
  FInt := 2355 * 3;
  FTest := 'Value: ' + Random(223552).ToString + Random(235500).ToString;
end;

procedure TForm2355.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2355;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2355_List0 := TMyObj2355_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2355_List1 := TMyObj2355_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
