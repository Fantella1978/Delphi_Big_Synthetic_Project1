...
type
  ...
  TMyObj2213_List0 = TObjectList<TMyObj2213>;

  TMyObj2213_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2213_List1 = TObjectList<TMyObj2213_1>;
...
constructor TMyObj2213_1.Create;
begin
  inherited;
  FInt := 2213 * 3;
  FTest := 'Value: ' + Random(222132).ToString + Random(221300).ToString;
end;

procedure TForm2213.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2213;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2213_List0 := TMyObj2213_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2213_List1 := TMyObj2213_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
