...
type
  ...
  TMyObj2121_List0 = TObjectList<TMyObj2121>;

  TMyObj2121_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2121_List1 = TObjectList<TMyObj2121_1>;
...
constructor TMyObj2121_1.Create;
begin
  inherited;
  FInt := 2121 * 3;
  FTest := 'Value: ' + Random(221212).ToString + Random(212100).ToString;
end;

procedure TForm2121.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2121;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2121_List0 := TMyObj2121_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2121_List1 := TMyObj2121_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
