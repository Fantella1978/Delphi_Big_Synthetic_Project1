...
type
  ...
  TMyObj629_List0 = TObjectList<TMyObj629>;

  TMyObj629_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj629_List1 = TObjectList<TMyObj629_1>;
...
constructor TMyObj629_1.Create;
begin
  inherited;
  FInt := 629 * 3;
  FTest := 'Value: ' + Random(26292).ToString + Random(62900).ToString;
end;

procedure TForm629.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum629;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj629_List0 := TMyObj629_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj629_List1 := TMyObj629_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
