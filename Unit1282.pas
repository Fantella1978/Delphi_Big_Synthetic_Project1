...
type
  ...
  TMyObj1282_List0 = TObjectList<TMyObj1282>;

  TMyObj1282_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1282_List1 = TObjectList<TMyObj1282_1>;
...
constructor TMyObj1282_1.Create;
begin
  inherited;
  FInt := 1282 * 3;
  FTest := 'Value: ' + Random(212822).ToString + Random(128200).ToString;
end;

procedure TForm1282.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1282;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1282_List0 := TMyObj1282_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1282_List1 := TMyObj1282_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
