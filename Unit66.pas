...
type
  ...
  TMyObj66_List0 = TObjectList<TMyObj66>;

  TMyObj66_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj66_List1 = TObjectList<TMyObj66_1>;
...
constructor TMyObj66_1.Create;
begin
  inherited;
  FInt := 66 * 3;
  FTest := 'Value: ' + Random(2662).ToString + Random(6600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj66_List0 := TMyObj66_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj66_List1 := TMyObj66_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
