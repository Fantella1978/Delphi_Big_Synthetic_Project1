...
type
  ...
  TMyObj1487_List0 = TObjectList<TMyObj1487>;

  TMyObj1487_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1487_List1 = TObjectList<TMyObj1487_1>;
...
constructor TMyObj1487_1.Create;
begin
  inherited;
  FInt := 1487 * 3;
  FTest := 'Value: ' + Random(214872).ToString + Random(148700).ToString;
end;

procedure TForm1487.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1487;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1487_List0 := TMyObj1487_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1487_List1 := TMyObj1487_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
