...
type
  ...
  TMyObj2237_List0 = TObjectList<TMyObj2237>;

  TMyObj2237_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2237_List1 = TObjectList<TMyObj2237_1>;
...
constructor TMyObj2237_1.Create;
begin
  inherited;
  FInt := 2237 * 3;
  FTest := 'Value: ' + Random(222372).ToString + Random(223700).ToString;
end;

procedure TForm2237.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2237;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2237_List0 := TMyObj2237_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2237_List1 := TMyObj2237_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
