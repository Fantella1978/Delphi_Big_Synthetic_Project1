...
type
  ...
  TMyObj2430_List0 = TObjectList<TMyObj2430>;

  TMyObj2430_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2430_List1 = TObjectList<TMyObj2430_1>;
...
constructor TMyObj2430_1.Create;
begin
  inherited;
  FInt := 2430 * 3;
  FTest := 'Value: ' + Random(224302).ToString + Random(243000).ToString;
end;

procedure TForm2430.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2430;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2430_List0 := TMyObj2430_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2430_List1 := TMyObj2430_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
