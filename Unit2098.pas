...
type
  ...
  TMyObj2098_List0 = TObjectList<TMyObj2098>;

  TMyObj2098_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2098_List1 = TObjectList<TMyObj2098_1>;
...
constructor TMyObj2098_1.Create;
begin
  inherited;
  FInt := 2098 * 3;
  FTest := 'Value: ' + Random(220982).ToString + Random(209800).ToString;
end;

procedure TForm2098.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2098;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2098_List0 := TMyObj2098_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2098_List1 := TMyObj2098_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
