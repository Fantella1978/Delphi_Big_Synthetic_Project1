...
type
  ...
  TMyObj1535_List0 = TObjectList<TMyObj1535>;

  TMyObj1535_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1535_List1 = TObjectList<TMyObj1535_1>;
...
constructor TMyObj1535_1.Create;
begin
  inherited;
  FInt := 1535 * 3;
  FTest := 'Value: ' + Random(215352).ToString + Random(153500).ToString;
end;

procedure TForm1535.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1535;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1535_List0 := TMyObj1535_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1535_List1 := TMyObj1535_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
