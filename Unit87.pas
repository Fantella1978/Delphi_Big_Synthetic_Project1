...
type
  ...
  TMyObj87_List0 = TObjectList<TMyObj87>;

  TMyObj87_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj87_List1 = TObjectList<TMyObj87_1>;
...
constructor TMyObj87_1.Create;
begin
  inherited;
  FInt := 87 * 3;
  FTest := 'Value: ' + Random(2872).ToString + Random(8700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj87_List0 := TMyObj87_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj87_List1 := TMyObj87_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
