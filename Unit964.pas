...
type
  ...
  TMyObj964_List0 = TObjectList<TMyObj964>;

  TMyObj964_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj964_List1 = TObjectList<TMyObj964_1>;
...
constructor TMyObj964_1.Create;
begin
  inherited;
  FInt := 964 * 3;
  FTest := 'Value: ' + Random(29642).ToString + Random(96400).ToString;
end;

procedure TForm964.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum964;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj964_List0 := TMyObj964_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj964_List1 := TMyObj964_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
