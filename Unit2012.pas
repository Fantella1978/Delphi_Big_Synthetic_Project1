...
type
  ...
  TMyObj2012_List0 = TObjectList<TMyObj2012>;

  TMyObj2012_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2012_List1 = TObjectList<TMyObj2012_1>;
...
constructor TMyObj2012_1.Create;
begin
  inherited;
  FInt := 2012 * 3;
  FTest := 'Value: ' + Random(220122).ToString + Random(201200).ToString;
end;

procedure TForm2012.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2012;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2012_List0 := TMyObj2012_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2012_List1 := TMyObj2012_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
