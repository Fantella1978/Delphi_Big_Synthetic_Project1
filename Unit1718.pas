...
type
  ...
  TMyObj1718_List0 = TObjectList<TMyObj1718>;

  TMyObj1718_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1718_List1 = TObjectList<TMyObj1718_1>;
...
constructor TMyObj1718_1.Create;
begin
  inherited;
  FInt := 1718 * 3;
  FTest := 'Value: ' + Random(217182).ToString + Random(171800).ToString;
end;

procedure TForm1718.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1718;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1718_List0 := TMyObj1718_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1718_List1 := TMyObj1718_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
