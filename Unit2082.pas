...
type
  ...
  TMyObj2082_List0 = TObjectList<TMyObj2082>;

  TMyObj2082_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2082_List1 = TObjectList<TMyObj2082_1>;
...
constructor TMyObj2082_1.Create;
begin
  inherited;
  FInt := 2082 * 3;
  FTest := 'Value: ' + Random(220822).ToString + Random(208200).ToString;
end;

procedure TForm2082.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2082;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2082_List0 := TMyObj2082_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2082_List1 := TMyObj2082_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
