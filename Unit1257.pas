...
type
  ...
  TMyObj1257_List0 = TObjectList<TMyObj1257>;

  TMyObj1257_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1257_List1 = TObjectList<TMyObj1257_1>;
...
constructor TMyObj1257_1.Create;
begin
  inherited;
  FInt := 1257 * 3;
  FTest := 'Value: ' + Random(212572).ToString + Random(125700).ToString;
end;

procedure TForm1257.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1257;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1257_List0 := TMyObj1257_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1257_List1 := TMyObj1257_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
