...
type
  ...
  TMyObj2292_List0 = TObjectList<TMyObj2292>;

  TMyObj2292_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2292_List1 = TObjectList<TMyObj2292_1>;
...
constructor TMyObj2292_1.Create;
begin
  inherited;
  FInt := 2292 * 3;
  FTest := 'Value: ' + Random(222922).ToString + Random(229200).ToString;
end;

procedure TForm2292.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2292;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2292_List0 := TMyObj2292_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2292_List1 := TMyObj2292_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
