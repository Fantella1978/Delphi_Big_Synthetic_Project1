...
type
  ...
  TMyObj539_List0 = TObjectList<TMyObj539>;

  TMyObj539_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj539_List1 = TObjectList<TMyObj539_1>;
...
constructor TMyObj539_1.Create;
begin
  inherited;
  FInt := 539 * 3;
  FTest := 'Value: ' + Random(25392).ToString + Random(53900).ToString;
end;

procedure TForm539.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum539;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj539_List0 := TMyObj539_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj539_List1 := TMyObj539_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
