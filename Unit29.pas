...
type
  ...
  TMyObj29_List0 = TObjectList<TMyObj29>;

  TMyObj29_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj29_List1 = TObjectList<TMyObj29_1>;
...
constructor TMyObj29_1.Create;
begin
  inherited;
  FInt := 29 * 3;
  FTest := 'Value: ' + Random(2292).ToString + Random(2900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj29_List0 := TMyObj29_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj29_List1 := TMyObj29_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
