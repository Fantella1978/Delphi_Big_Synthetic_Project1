...
type
  ...
  TMyObj1988_List0 = TObjectList<TMyObj1988>;

  TMyObj1988_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1988_List1 = TObjectList<TMyObj1988_1>;
...
constructor TMyObj1988_1.Create;
begin
  inherited;
  FInt := 1988 * 3;
  FTest := 'Value: ' + Random(219882).ToString + Random(198800).ToString;
end;

procedure TForm1988.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1988;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1988_List0 := TMyObj1988_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1988_List1 := TMyObj1988_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
