...
type
  ...
  TMyObj101_List0 = TObjectList<TMyObj101>;

  TMyObj101_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj101_List1 = TObjectList<TMyObj101_1>;
...
constructor TMyObj101_1.Create;
begin
  inherited;
  FInt := 101 * 3;
  FTest := 'Value: ' + Random(21012).ToString + Random(10100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj101_List0 := TMyObj101_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj101_List1 := TMyObj101_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
