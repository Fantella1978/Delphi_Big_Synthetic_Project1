...
type
  ...
  TMyObj661_List0 = TObjectList<TMyObj661>;

  TMyObj661_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj661_List1 = TObjectList<TMyObj661_1>;
...
constructor TMyObj661_1.Create;
begin
  inherited;
  FInt := 661 * 3;
  FTest := 'Value: ' + Random(26612).ToString + Random(66100).ToString;
end;

procedure TForm661.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum661;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj661_List0 := TMyObj661_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj661_List1 := TMyObj661_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
