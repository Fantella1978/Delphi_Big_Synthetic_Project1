...
type
  ...
  TMyObj2015_List0 = TObjectList<TMyObj2015>;

  TMyObj2015_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2015_List1 = TObjectList<TMyObj2015_1>;
...
constructor TMyObj2015_1.Create;
begin
  inherited;
  FInt := 2015 * 3;
  FTest := 'Value: ' + Random(220152).ToString + Random(201500).ToString;
end;

procedure TForm2015.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2015;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2015_List0 := TMyObj2015_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2015_List1 := TMyObj2015_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
