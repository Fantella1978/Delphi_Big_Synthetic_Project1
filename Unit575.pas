...
type
  ...
  TMyObj575_List0 = TObjectList<TMyObj575>;

  TMyObj575_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj575_List1 = TObjectList<TMyObj575_1>;
...
constructor TMyObj575_1.Create;
begin
  inherited;
  FInt := 575 * 3;
  FTest := 'Value: ' + Random(25752).ToString + Random(57500).ToString;
end;

procedure TForm575.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum575;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj575_List0 := TMyObj575_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj575_List1 := TMyObj575_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
