...
type
  ...
  TMyObj1288_List0 = TObjectList<TMyObj1288>;

  TMyObj1288_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1288_List1 = TObjectList<TMyObj1288_1>;
...
constructor TMyObj1288_1.Create;
begin
  inherited;
  FInt := 1288 * 3;
  FTest := 'Value: ' + Random(212882).ToString + Random(128800).ToString;
end;

procedure TForm1288.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1288;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1288_List0 := TMyObj1288_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1288_List1 := TMyObj1288_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
