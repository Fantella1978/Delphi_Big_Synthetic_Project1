...
type
  ...
  TMyObj2453_List0 = TObjectList<TMyObj2453>;

  TMyObj2453_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2453_List1 = TObjectList<TMyObj2453_1>;
...
constructor TMyObj2453_1.Create;
begin
  inherited;
  FInt := 2453 * 3;
  FTest := 'Value: ' + Random(224532).ToString + Random(245300).ToString;
end;

procedure TForm2453.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2453;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2453_List0 := TMyObj2453_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2453_List1 := TMyObj2453_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
