...
type
  ...
  TMyObj1682_List0 = TObjectList<TMyObj1682>;

  TMyObj1682_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1682_List1 = TObjectList<TMyObj1682_1>;
...
constructor TMyObj1682_1.Create;
begin
  inherited;
  FInt := 1682 * 3;
  FTest := 'Value: ' + Random(216822).ToString + Random(168200).ToString;
end;

procedure TForm1682.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1682;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1682_List0 := TMyObj1682_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1682_List1 := TMyObj1682_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
