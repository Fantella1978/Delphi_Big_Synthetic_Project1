...
type
  ...
  TMyObj1717_List0 = TObjectList<TMyObj1717>;

  TMyObj1717_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1717_List1 = TObjectList<TMyObj1717_1>;
...
constructor TMyObj1717_1.Create;
begin
  inherited;
  FInt := 1717 * 3;
  FTest := 'Value: ' + Random(217172).ToString + Random(171700).ToString;
end;

procedure TForm1717.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1717;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1717_List0 := TMyObj1717_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1717_List1 := TMyObj1717_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
