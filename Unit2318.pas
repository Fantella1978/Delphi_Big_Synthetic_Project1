...
type
  ...
  TMyObj2318_List0 = TObjectList<TMyObj2318>;

  TMyObj2318_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2318_List1 = TObjectList<TMyObj2318_1>;
...
constructor TMyObj2318_1.Create;
begin
  inherited;
  FInt := 2318 * 3;
  FTest := 'Value: ' + Random(223182).ToString + Random(231800).ToString;
end;

procedure TForm2318.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2318;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2318_List0 := TMyObj2318_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2318_List1 := TMyObj2318_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
