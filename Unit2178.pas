...
type
  ...
  TMyObj2178_List0 = TObjectList<TMyObj2178>;

  TMyObj2178_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2178_List1 = TObjectList<TMyObj2178_1>;
...
constructor TMyObj2178_1.Create;
begin
  inherited;
  FInt := 2178 * 3;
  FTest := 'Value: ' + Random(221782).ToString + Random(217800).ToString;
end;

procedure TForm2178.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2178;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2178_List0 := TMyObj2178_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2178_List1 := TMyObj2178_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
