...
type
  ...
  TMyObj1887_List0 = TObjectList<TMyObj1887>;

  TMyObj1887_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1887_List1 = TObjectList<TMyObj1887_1>;
...
constructor TMyObj1887_1.Create;
begin
  inherited;
  FInt := 1887 * 3;
  FTest := 'Value: ' + Random(218872).ToString + Random(188700).ToString;
end;

procedure TForm1887.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1887;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1887_List0 := TMyObj1887_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1887_List1 := TMyObj1887_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
