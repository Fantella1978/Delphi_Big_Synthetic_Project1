...
type
  ...
  TMyObj1381_List0 = TObjectList<TMyObj1381>;

  TMyObj1381_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1381_List1 = TObjectList<TMyObj1381_1>;
...
constructor TMyObj1381_1.Create;
begin
  inherited;
  FInt := 1381 * 3;
  FTest := 'Value: ' + Random(213812).ToString + Random(138100).ToString;
end;

procedure TForm1381.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1381;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1381_List0 := TMyObj1381_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1381_List1 := TMyObj1381_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
