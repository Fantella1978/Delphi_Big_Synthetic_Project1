...
type
  ...
  TMyObj2014_List0 = TObjectList<TMyObj2014>;

  TMyObj2014_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2014_List1 = TObjectList<TMyObj2014_1>;
...
constructor TMyObj2014_1.Create;
begin
  inherited;
  FInt := 2014 * 3;
  FTest := 'Value: ' + Random(220142).ToString + Random(201400).ToString;
end;

procedure TForm2014.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2014;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2014_List0 := TMyObj2014_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2014_List1 := TMyObj2014_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
