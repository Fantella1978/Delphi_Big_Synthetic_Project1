...
type
  ...
  TMyObj201_List0 = TObjectList<TMyObj201>;

  TMyObj201_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj201_List1 = TObjectList<TMyObj201_1>;
...
constructor TMyObj201_1.Create;
begin
  inherited;
  FInt := 201 * 3;
  FTest := 'Value: ' + Random(22012).ToString + Random(20100).ToString;
end;

procedure TForm201.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum201;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj201_List0 := TMyObj201_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj201_List1 := TMyObj201_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
