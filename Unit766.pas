...
type
  ...
  TMyObj766_List0 = TObjectList<TMyObj766>;

  TMyObj766_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj766_List1 = TObjectList<TMyObj766_1>;
...
constructor TMyObj766_1.Create;
begin
  inherited;
  FInt := 766 * 3;
  FTest := 'Value: ' + Random(27662).ToString + Random(76600).ToString;
end;

procedure TForm766.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum766;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj766_List0 := TMyObj766_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj766_List1 := TMyObj766_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
