...
type
  ...
  TMyObj1554_List0 = TObjectList<TMyObj1554>;

  TMyObj1554_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1554_List1 = TObjectList<TMyObj1554_1>;
...
constructor TMyObj1554_1.Create;
begin
  inherited;
  FInt := 1554 * 3;
  FTest := 'Value: ' + Random(215542).ToString + Random(155400).ToString;
end;

procedure TForm1554.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1554;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1554_List0 := TMyObj1554_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1554_List1 := TMyObj1554_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
