...
type
  ...
  TMyObj297_List0 = TObjectList<TMyObj297>;

  TMyObj297_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj297_List1 = TObjectList<TMyObj297_1>;
...
constructor TMyObj297_1.Create;
begin
  inherited;
  FInt := 297 * 3;
  FTest := 'Value: ' + Random(22972).ToString + Random(29700).ToString;
end;

procedure TForm297.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum297;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj297_List0 := TMyObj297_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj297_List1 := TMyObj297_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
