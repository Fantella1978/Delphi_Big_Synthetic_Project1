...
type
  ...
  TMyObj447_List0 = TObjectList<TMyObj447>;

  TMyObj447_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj447_List1 = TObjectList<TMyObj447_1>;
...
constructor TMyObj447_1.Create;
begin
  inherited;
  FInt := 447 * 3;
  FTest := 'Value: ' + Random(24472).ToString + Random(44700).ToString;
end;

procedure TForm447.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum447;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj447_List0 := TMyObj447_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj447_List1 := TMyObj447_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
