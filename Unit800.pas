...
type
  ...
  TMyObj800_List0 = TObjectList<TMyObj800>;

  TMyObj800_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj800_List1 = TObjectList<TMyObj800_1>;
...
constructor TMyObj800_1.Create;
begin
  inherited;
  FInt := 800 * 3;
  FTest := 'Value: ' + Random(28002).ToString + Random(80000).ToString;
end;

procedure TForm800.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum800;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj800_List0 := TMyObj800_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj800_List1 := TMyObj800_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
