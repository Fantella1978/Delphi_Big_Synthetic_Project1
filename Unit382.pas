...
type
  ...
  TMyObj382_List0 = TObjectList<TMyObj382>;

  TMyObj382_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj382_List1 = TObjectList<TMyObj382_1>;
...
constructor TMyObj382_1.Create;
begin
  inherited;
  FInt := 382 * 3;
  FTest := 'Value: ' + Random(23822).ToString + Random(38200).ToString;
end;

procedure TForm382.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum382;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj382_List0 := TMyObj382_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj382_List1 := TMyObj382_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
