...
type
  ...
  TMyObj1667_List0 = TObjectList<TMyObj1667>;

  TMyObj1667_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1667_List1 = TObjectList<TMyObj1667_1>;
...
constructor TMyObj1667_1.Create;
begin
  inherited;
  FInt := 1667 * 3;
  FTest := 'Value: ' + Random(216672).ToString + Random(166700).ToString;
end;

procedure TForm1667.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1667;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1667_List0 := TMyObj1667_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1667_List1 := TMyObj1667_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
