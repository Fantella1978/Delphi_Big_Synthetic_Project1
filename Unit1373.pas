...
type
  ...
  TMyObj1373_List0 = TObjectList<TMyObj1373>;

  TMyObj1373_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1373_List1 = TObjectList<TMyObj1373_1>;
...
constructor TMyObj1373_1.Create;
begin
  inherited;
  FInt := 1373 * 3;
  FTest := 'Value: ' + Random(213732).ToString + Random(137300).ToString;
end;

procedure TForm1373.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1373;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1373_List0 := TMyObj1373_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1373_List1 := TMyObj1373_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
