...
type
  ...
  TMyObj580_List0 = TObjectList<TMyObj580>;

  TMyObj580_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj580_List1 = TObjectList<TMyObj580_1>;
...
constructor TMyObj580_1.Create;
begin
  inherited;
  FInt := 580 * 3;
  FTest := 'Value: ' + Random(25802).ToString + Random(58000).ToString;
end;

procedure TForm580.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum580;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj580_List0 := TMyObj580_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj580_List1 := TMyObj580_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
