...
type
  ...
  TMyObj1496_List0 = TObjectList<TMyObj1496>;

  TMyObj1496_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1496_List1 = TObjectList<TMyObj1496_1>;
...
constructor TMyObj1496_1.Create;
begin
  inherited;
  FInt := 1496 * 3;
  FTest := 'Value: ' + Random(214962).ToString + Random(149600).ToString;
end;

procedure TForm1496.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1496;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1496_List0 := TMyObj1496_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1496_List1 := TMyObj1496_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
