...
type
  ...
  TMyObj174_List0 = TObjectList<TMyObj174>;

  TMyObj174_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj174_List1 = TObjectList<TMyObj174_1>;
...
constructor TMyObj174_1.Create;
begin
  inherited;
  FInt := 174 * 3;
  FTest := 'Value: ' + Random(21742).ToString + Random(17400).ToString;
end;

procedure TForm174.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum174;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj174_List0 := TMyObj174_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj174_List1 := TMyObj174_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
