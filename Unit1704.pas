...
type
  ...
  TMyObj1704_List0 = TObjectList<TMyObj1704>;

  TMyObj1704_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1704_List1 = TObjectList<TMyObj1704_1>;
...
constructor TMyObj1704_1.Create;
begin
  inherited;
  FInt := 1704 * 3;
  FTest := 'Value: ' + Random(217042).ToString + Random(170400).ToString;
end;

procedure TForm1704.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1704;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1704_List0 := TMyObj1704_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1704_List1 := TMyObj1704_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
