...
type
  ...
  TMyObj1573_List0 = TObjectList<TMyObj1573>;

  TMyObj1573_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1573_List1 = TObjectList<TMyObj1573_1>;
...
constructor TMyObj1573_1.Create;
begin
  inherited;
  FInt := 1573 * 3;
  FTest := 'Value: ' + Random(215732).ToString + Random(157300).ToString;
end;

procedure TForm1573.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1573;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1573_List0 := TMyObj1573_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1573_List1 := TMyObj1573_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
