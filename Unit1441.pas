...
type
  ...
  TMyObj1441_List0 = TObjectList<TMyObj1441>;

  TMyObj1441_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1441_List1 = TObjectList<TMyObj1441_1>;
...
constructor TMyObj1441_1.Create;
begin
  inherited;
  FInt := 1441 * 3;
  FTest := 'Value: ' + Random(214412).ToString + Random(144100).ToString;
end;

procedure TForm1441.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1441;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1441_List0 := TMyObj1441_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1441_List1 := TMyObj1441_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
