...
type
  ...
  TMyObj664_List0 = TObjectList<TMyObj664>;

  TMyObj664_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj664_List1 = TObjectList<TMyObj664_1>;
...
constructor TMyObj664_1.Create;
begin
  inherited;
  FInt := 664 * 3;
  FTest := 'Value: ' + Random(26642).ToString + Random(66400).ToString;
end;

procedure TForm664.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum664;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj664_List0 := TMyObj664_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj664_List1 := TMyObj664_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
