...
type
  ...
  TMyObj108_List0 = TObjectList<TMyObj108>;

  TMyObj108_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj108_List1 = TObjectList<TMyObj108_1>;
...
constructor TMyObj108_1.Create;
begin
  inherited;
  FInt := 108 * 3;
  FTest := 'Value: ' + Random(21082).ToString + Random(10800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj108_List0 := TMyObj108_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj108_List1 := TMyObj108_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
