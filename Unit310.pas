...
type
  ...
  TMyObj310_List0 = TObjectList<TMyObj310>;

  TMyObj310_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj310_List1 = TObjectList<TMyObj310_1>;
...
constructor TMyObj310_1.Create;
begin
  inherited;
  FInt := 310 * 3;
  FTest := 'Value: ' + Random(23102).ToString + Random(31000).ToString;
end;

procedure TForm310.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum310;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj310_List0 := TMyObj310_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj310_List1 := TMyObj310_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
