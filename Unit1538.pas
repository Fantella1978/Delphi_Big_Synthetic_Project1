...
type
  ...
  TMyObj1538_List0 = TObjectList<TMyObj1538>;

  TMyObj1538_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1538_List1 = TObjectList<TMyObj1538_1>;
...
constructor TMyObj1538_1.Create;
begin
  inherited;
  FInt := 1538 * 3;
  FTest := 'Value: ' + Random(215382).ToString + Random(153800).ToString;
end;

procedure TForm1538.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1538;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1538_List0 := TMyObj1538_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1538_List1 := TMyObj1538_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
