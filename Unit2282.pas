...
type
  ...
  TMyObj2282_List0 = TObjectList<TMyObj2282>;

  TMyObj2282_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2282_List1 = TObjectList<TMyObj2282_1>;
...
constructor TMyObj2282_1.Create;
begin
  inherited;
  FInt := 2282 * 3;
  FTest := 'Value: ' + Random(222822).ToString + Random(228200).ToString;
end;

procedure TForm2282.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2282;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2282_List0 := TMyObj2282_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2282_List1 := TMyObj2282_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
