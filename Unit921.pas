...
type
  ...
  TMyObj921_List0 = TObjectList<TMyObj921>;

  TMyObj921_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj921_List1 = TObjectList<TMyObj921_1>;
...
constructor TMyObj921_1.Create;
begin
  inherited;
  FInt := 921 * 3;
  FTest := 'Value: ' + Random(29212).ToString + Random(92100).ToString;
end;

procedure TForm921.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum921;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj921_List0 := TMyObj921_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj921_List1 := TMyObj921_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
