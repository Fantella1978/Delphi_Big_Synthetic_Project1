...
type
  ...
  TMyObj1722_List0 = TObjectList<TMyObj1722>;

  TMyObj1722_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1722_List1 = TObjectList<TMyObj1722_1>;
...
constructor TMyObj1722_1.Create;
begin
  inherited;
  FInt := 1722 * 3;
  FTest := 'Value: ' + Random(217222).ToString + Random(172200).ToString;
end;

procedure TForm1722.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1722;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1722_List0 := TMyObj1722_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1722_List1 := TMyObj1722_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
