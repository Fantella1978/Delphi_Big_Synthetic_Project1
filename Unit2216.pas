...
type
  ...
  TMyObj2216_List0 = TObjectList<TMyObj2216>;

  TMyObj2216_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2216_List1 = TObjectList<TMyObj2216_1>;
...
constructor TMyObj2216_1.Create;
begin
  inherited;
  FInt := 2216 * 3;
  FTest := 'Value: ' + Random(222162).ToString + Random(221600).ToString;
end;

procedure TForm2216.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2216;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2216_List0 := TMyObj2216_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2216_List1 := TMyObj2216_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
