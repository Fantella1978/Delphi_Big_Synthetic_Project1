...
type
  ...
  TMyObj1025_List0 = TObjectList<TMyObj1025>;

  TMyObj1025_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1025_List1 = TObjectList<TMyObj1025_1>;
...
constructor TMyObj1025_1.Create;
begin
  inherited;
  FInt := 1025 * 3;
  FTest := 'Value: ' + Random(210252).ToString + Random(102500).ToString;
end;

procedure TForm1025.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1025;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1025_List0 := TMyObj1025_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1025_List1 := TMyObj1025_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
