...
type
  ...
  TMyObj380_List0 = TObjectList<TMyObj380>;

  TMyObj380_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj380_List1 = TObjectList<TMyObj380_1>;
...
constructor TMyObj380_1.Create;
begin
  inherited;
  FInt := 380 * 3;
  FTest := 'Value: ' + Random(23802).ToString + Random(38000).ToString;
end;

procedure TForm380.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum380;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj380_List0 := TMyObj380_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj380_List1 := TMyObj380_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
