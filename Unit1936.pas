...
type
  ...
  TMyObj1936_List0 = TObjectList<TMyObj1936>;

  TMyObj1936_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1936_List1 = TObjectList<TMyObj1936_1>;
...
constructor TMyObj1936_1.Create;
begin
  inherited;
  FInt := 1936 * 3;
  FTest := 'Value: ' + Random(219362).ToString + Random(193600).ToString;
end;

procedure TForm1936.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1936;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1936_List0 := TMyObj1936_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1936_List1 := TMyObj1936_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
