...
type
  ...
  TMyObj2372_List0 = TObjectList<TMyObj2372>;

  TMyObj2372_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2372_List1 = TObjectList<TMyObj2372_1>;
...
constructor TMyObj2372_1.Create;
begin
  inherited;
  FInt := 2372 * 3;
  FTest := 'Value: ' + Random(223722).ToString + Random(237200).ToString;
end;

procedure TForm2372.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2372;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2372_List0 := TMyObj2372_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2372_List1 := TMyObj2372_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
