...
type
  ...
  TMyObj547_List0 = TObjectList<TMyObj547>;

  TMyObj547_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj547_List1 = TObjectList<TMyObj547_1>;
...
constructor TMyObj547_1.Create;
begin
  inherited;
  FInt := 547 * 3;
  FTest := 'Value: ' + Random(25472).ToString + Random(54700).ToString;
end;

procedure TForm547.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum547;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj547_List0 := TMyObj547_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj547_List1 := TMyObj547_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
