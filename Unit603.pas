...
type
  ...
  TMyObj603_List0 = TObjectList<TMyObj603>;

  TMyObj603_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj603_List1 = TObjectList<TMyObj603_1>;
...
constructor TMyObj603_1.Create;
begin
  inherited;
  FInt := 603 * 3;
  FTest := 'Value: ' + Random(26032).ToString + Random(60300).ToString;
end;

procedure TForm603.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum603;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj603_List0 := TMyObj603_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj603_List1 := TMyObj603_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
