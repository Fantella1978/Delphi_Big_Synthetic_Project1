...
type
  ...
  TMyObj1456_List0 = TObjectList<TMyObj1456>;

  TMyObj1456_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1456_List1 = TObjectList<TMyObj1456_1>;
...
constructor TMyObj1456_1.Create;
begin
  inherited;
  FInt := 1456 * 3;
  FTest := 'Value: ' + Random(214562).ToString + Random(145600).ToString;
end;

procedure TForm1456.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1456;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1456_List0 := TMyObj1456_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1456_List1 := TMyObj1456_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
