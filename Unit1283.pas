...
type
  ...
  TMyObj1283_List0 = TObjectList<TMyObj1283>;

  TMyObj1283_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1283_List1 = TObjectList<TMyObj1283_1>;
...
constructor TMyObj1283_1.Create;
begin
  inherited;
  FInt := 1283 * 3;
  FTest := 'Value: ' + Random(212832).ToString + Random(128300).ToString;
end;

procedure TForm1283.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1283;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1283_List0 := TMyObj1283_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1283_List1 := TMyObj1283_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
