...
type
  ...
  TMyObj1795_List0 = TObjectList<TMyObj1795>;

  TMyObj1795_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1795_List1 = TObjectList<TMyObj1795_1>;
...
constructor TMyObj1795_1.Create;
begin
  inherited;
  FInt := 1795 * 3;
  FTest := 'Value: ' + Random(217952).ToString + Random(179500).ToString;
end;

procedure TForm1795.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1795;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1795_List0 := TMyObj1795_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1795_List1 := TMyObj1795_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
