...
type
  ...
  TMyObj2207_List0 = TObjectList<TMyObj2207>;

  TMyObj2207_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2207_List1 = TObjectList<TMyObj2207_1>;
...
constructor TMyObj2207_1.Create;
begin
  inherited;
  FInt := 2207 * 3;
  FTest := 'Value: ' + Random(222072).ToString + Random(220700).ToString;
end;

procedure TForm2207.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2207;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2207_List0 := TMyObj2207_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2207_List1 := TMyObj2207_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
