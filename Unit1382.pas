...
type
  ...
  TMyObj1382_List0 = TObjectList<TMyObj1382>;

  TMyObj1382_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1382_List1 = TObjectList<TMyObj1382_1>;
...
constructor TMyObj1382_1.Create;
begin
  inherited;
  FInt := 1382 * 3;
  FTest := 'Value: ' + Random(213822).ToString + Random(138200).ToString;
end;

procedure TForm1382.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1382;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1382_List0 := TMyObj1382_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1382_List1 := TMyObj1382_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
