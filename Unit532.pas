...
type
  ...
  TMyObj532_List0 = TObjectList<TMyObj532>;

  TMyObj532_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj532_List1 = TObjectList<TMyObj532_1>;
...
constructor TMyObj532_1.Create;
begin
  inherited;
  FInt := 532 * 3;
  FTest := 'Value: ' + Random(25322).ToString + Random(53200).ToString;
end;

procedure TForm532.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum532;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj532_List0 := TMyObj532_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj532_List1 := TMyObj532_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
