...
type
  ...
  TMyObj2412_List0 = TObjectList<TMyObj2412>;

  TMyObj2412_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2412_List1 = TObjectList<TMyObj2412_1>;
...
constructor TMyObj2412_1.Create;
begin
  inherited;
  FInt := 2412 * 3;
  FTest := 'Value: ' + Random(224122).ToString + Random(241200).ToString;
end;

procedure TForm2412.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2412;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2412_List0 := TMyObj2412_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2412_List1 := TMyObj2412_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
