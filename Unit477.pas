...
type
  ...
  TMyObj477_List0 = TObjectList<TMyObj477>;

  TMyObj477_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj477_List1 = TObjectList<TMyObj477_1>;
...
constructor TMyObj477_1.Create;
begin
  inherited;
  FInt := 477 * 3;
  FTest := 'Value: ' + Random(24772).ToString + Random(47700).ToString;
end;

procedure TForm477.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum477;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj477_List0 := TMyObj477_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj477_List1 := TMyObj477_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
