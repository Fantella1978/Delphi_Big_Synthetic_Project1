...
type
  ...
  TMyObj2271_List0 = TObjectList<TMyObj2271>;

  TMyObj2271_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2271_List1 = TObjectList<TMyObj2271_1>;
...
constructor TMyObj2271_1.Create;
begin
  inherited;
  FInt := 2271 * 3;
  FTest := 'Value: ' + Random(222712).ToString + Random(227100).ToString;
end;

procedure TForm2271.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2271;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2271_List0 := TMyObj2271_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2271_List1 := TMyObj2271_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
