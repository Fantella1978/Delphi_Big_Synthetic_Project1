...
type
  ...
  TMyObj2137_List0 = TObjectList<TMyObj2137>;

  TMyObj2137_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2137_List1 = TObjectList<TMyObj2137_1>;
...
constructor TMyObj2137_1.Create;
begin
  inherited;
  FInt := 2137 * 3;
  FTest := 'Value: ' + Random(221372).ToString + Random(213700).ToString;
end;

procedure TForm2137.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2137;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2137_List0 := TMyObj2137_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2137_List1 := TMyObj2137_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
