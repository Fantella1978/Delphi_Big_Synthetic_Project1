...
type
  ...
  TMyObj2417_List0 = TObjectList<TMyObj2417>;

  TMyObj2417_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2417_List1 = TObjectList<TMyObj2417_1>;
...
constructor TMyObj2417_1.Create;
begin
  inherited;
  FInt := 2417 * 3;
  FTest := 'Value: ' + Random(224172).ToString + Random(241700).ToString;
end;

procedure TForm2417.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2417;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2417_List0 := TMyObj2417_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2417_List1 := TMyObj2417_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
