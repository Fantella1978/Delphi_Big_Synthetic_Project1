...
type
  ...
  TMyObj394_List0 = TObjectList<TMyObj394>;

  TMyObj394_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj394_List1 = TObjectList<TMyObj394_1>;
...
constructor TMyObj394_1.Create;
begin
  inherited;
  FInt := 394 * 3;
  FTest := 'Value: ' + Random(23942).ToString + Random(39400).ToString;
end;

procedure TForm394.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum394;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj394_List0 := TMyObj394_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj394_List1 := TMyObj394_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
