...
type
  ...
  TMyObj2272_List0 = TObjectList<TMyObj2272>;

  TMyObj2272_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2272_List1 = TObjectList<TMyObj2272_1>;
...
constructor TMyObj2272_1.Create;
begin
  inherited;
  FInt := 2272 * 3;
  FTest := 'Value: ' + Random(222722).ToString + Random(227200).ToString;
end;

procedure TForm2272.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2272;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2272_List0 := TMyObj2272_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2272_List1 := TMyObj2272_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
