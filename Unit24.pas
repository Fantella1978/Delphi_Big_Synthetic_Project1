...
type
  ...
  TMyObj24_List0 = TObjectList<TMyObj24>;

  TMyObj24_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj24_List1 = TObjectList<TMyObj24_1>;
...
constructor TMyObj24_1.Create;
begin
  inherited;
  FInt := 24 * 3;
  FTest := 'Value: ' + Random(2242).ToString + Random(2400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj24_List0 := TMyObj24_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj24_List1 := TMyObj24_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
