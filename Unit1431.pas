...
type
  ...
  TMyObj1431_List0 = TObjectList<TMyObj1431>;

  TMyObj1431_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1431_List1 = TObjectList<TMyObj1431_1>;
...
constructor TMyObj1431_1.Create;
begin
  inherited;
  FInt := 1431 * 3;
  FTest := 'Value: ' + Random(214312).ToString + Random(143100).ToString;
end;

procedure TForm1431.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1431;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1431_List0 := TMyObj1431_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1431_List1 := TMyObj1431_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
