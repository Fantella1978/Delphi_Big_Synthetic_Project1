...
type
  ...
  TMyObj939_List0 = TObjectList<TMyObj939>;

  TMyObj939_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj939_List1 = TObjectList<TMyObj939_1>;
...
constructor TMyObj939_1.Create;
begin
  inherited;
  FInt := 939 * 3;
  FTest := 'Value: ' + Random(29392).ToString + Random(93900).ToString;
end;

procedure TForm939.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum939;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj939_List0 := TMyObj939_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj939_List1 := TMyObj939_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
