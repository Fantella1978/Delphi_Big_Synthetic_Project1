...
type
  ...
  TMyObj257_List0 = TObjectList<TMyObj257>;

  TMyObj257_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj257_List1 = TObjectList<TMyObj257_1>;
...
constructor TMyObj257_1.Create;
begin
  inherited;
  FInt := 257 * 3;
  FTest := 'Value: ' + Random(22572).ToString + Random(25700).ToString;
end;

procedure TForm257.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum257;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj257_List0 := TMyObj257_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj257_List1 := TMyObj257_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
