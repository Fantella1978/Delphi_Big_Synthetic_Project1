...
type
  ...
  TMyObj1250_List0 = TObjectList<TMyObj1250>;

  TMyObj1250_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1250_List1 = TObjectList<TMyObj1250_1>;
...
constructor TMyObj1250_1.Create;
begin
  inherited;
  FInt := 1250 * 3;
  FTest := 'Value: ' + Random(212502).ToString + Random(125000).ToString;
end;

procedure TForm1250.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1250;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1250_List0 := TMyObj1250_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1250_List1 := TMyObj1250_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
