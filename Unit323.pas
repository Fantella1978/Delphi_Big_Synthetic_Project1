...
type
  ...
  TMyObj323_List0 = TObjectList<TMyObj323>;

  TMyObj323_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj323_List1 = TObjectList<TMyObj323_1>;
...
constructor TMyObj323_1.Create;
begin
  inherited;
  FInt := 323 * 3;
  FTest := 'Value: ' + Random(23232).ToString + Random(32300).ToString;
end;

procedure TForm323.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum323;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj323_List0 := TMyObj323_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj323_List1 := TMyObj323_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
