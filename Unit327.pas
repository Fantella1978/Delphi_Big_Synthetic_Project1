...
type
  ...
  TMyObj327_List0 = TObjectList<TMyObj327>;

  TMyObj327_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj327_List1 = TObjectList<TMyObj327_1>;
...
constructor TMyObj327_1.Create;
begin
  inherited;
  FInt := 327 * 3;
  FTest := 'Value: ' + Random(23272).ToString + Random(32700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj327_List0 := TMyObj327_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj327_List1 := TMyObj327_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
