...
type
  ...
  TMyObj2108_List0 = TObjectList<TMyObj2108>;

  TMyObj2108_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2108_List1 = TObjectList<TMyObj2108_1>;
...
constructor TMyObj2108_1.Create;
begin
  inherited;
  FInt := 2108 * 3;
  FTest := 'Value: ' + Random(221082).ToString + Random(210800).ToString;
end;

procedure TForm2108.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2108;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2108_List0 := TMyObj2108_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2108_List1 := TMyObj2108_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
