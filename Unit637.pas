...
type
  ...
  TMyObj637_List0 = TObjectList<TMyObj637>;

  TMyObj637_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj637_List1 = TObjectList<TMyObj637_1>;
...
constructor TMyObj637_1.Create;
begin
  inherited;
  FInt := 637 * 3;
  FTest := 'Value: ' + Random(26372).ToString + Random(63700).ToString;
end;

procedure TForm637.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum637;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj637_List0 := TMyObj637_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj637_List1 := TMyObj637_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
