...
type
  ...
  TMyObj1534_List0 = TObjectList<TMyObj1534>;

  TMyObj1534_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1534_List1 = TObjectList<TMyObj1534_1>;
...
constructor TMyObj1534_1.Create;
begin
  inherited;
  FInt := 1534 * 3;
  FTest := 'Value: ' + Random(215342).ToString + Random(153400).ToString;
end;

procedure TForm1534.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1534;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1534_List0 := TMyObj1534_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1534_List1 := TMyObj1534_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
