...
type
  ...
  TMyObj974_List0 = TObjectList<TMyObj974>;

  TMyObj974_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj974_List1 = TObjectList<TMyObj974_1>;
...
constructor TMyObj974_1.Create;
begin
  inherited;
  FInt := 974 * 3;
  FTest := 'Value: ' + Random(29742).ToString + Random(97400).ToString;
end;

procedure TForm974.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum974;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj974_List0 := TMyObj974_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj974_List1 := TMyObj974_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
