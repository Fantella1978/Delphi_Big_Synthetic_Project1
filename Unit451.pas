...
type
  ...
  TMyObj451_List0 = TObjectList<TMyObj451>;

  TMyObj451_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj451_List1 = TObjectList<TMyObj451_1>;
...
constructor TMyObj451_1.Create;
begin
  inherited;
  FInt := 451 * 3;
  FTest := 'Value: ' + Random(24512).ToString + Random(45100).ToString;
end;

procedure TForm451.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum451;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj451_List0 := TMyObj451_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj451_List1 := TMyObj451_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
