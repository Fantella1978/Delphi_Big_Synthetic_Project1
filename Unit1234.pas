...
type
  ...
  TMyObj1234_List0 = TObjectList<TMyObj1234>;

  TMyObj1234_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1234_List1 = TObjectList<TMyObj1234_1>;
...
constructor TMyObj1234_1.Create;
begin
  inherited;
  FInt := 1234 * 3;
  FTest := 'Value: ' + Random(212342).ToString + Random(123400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1234_List0 := TMyObj1234_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1234_List1 := TMyObj1234_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
