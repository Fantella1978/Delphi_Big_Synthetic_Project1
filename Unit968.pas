...
type
  ...
  TMyObj968_List0 = TObjectList<TMyObj968>;

  TMyObj968_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj968_List1 = TObjectList<TMyObj968_1>;
...
constructor TMyObj968_1.Create;
begin
  inherited;
  FInt := 968 * 3;
  FTest := 'Value: ' + Random(29682).ToString + Random(96800).ToString;
end;

procedure TForm968.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum968;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj968_List0 := TMyObj968_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj968_List1 := TMyObj968_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
