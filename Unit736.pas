...
type
  ...
  TMyObj736_List0 = TObjectList<TMyObj736>;

  TMyObj736_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj736_List1 = TObjectList<TMyObj736_1>;
...
constructor TMyObj736_1.Create;
begin
  inherited;
  FInt := 736 * 3;
  FTest := 'Value: ' + Random(27362).ToString + Random(73600).ToString;
end;

procedure TForm736.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum736;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj736_List0 := TMyObj736_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj736_List1 := TMyObj736_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
