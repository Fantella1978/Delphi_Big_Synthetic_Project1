...
type
  ...
  TMyObj377_List0 = TObjectList<TMyObj377>;

  TMyObj377_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj377_List1 = TObjectList<TMyObj377_1>;
...
constructor TMyObj377_1.Create;
begin
  inherited;
  FInt := 377 * 3;
  FTest := 'Value: ' + Random(23772).ToString + Random(37700).ToString;
end;

procedure TForm377.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum377;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj377_List0 := TMyObj377_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj377_List1 := TMyObj377_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
