...
type
  ...
  TMyObj1681_List0 = TObjectList<TMyObj1681>;

  TMyObj1681_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1681_List1 = TObjectList<TMyObj1681_1>;
...
constructor TMyObj1681_1.Create;
begin
  inherited;
  FInt := 1681 * 3;
  FTest := 'Value: ' + Random(216812).ToString + Random(168100).ToString;
end;

procedure TForm1681.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1681;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1681_List0 := TMyObj1681_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1681_List1 := TMyObj1681_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
