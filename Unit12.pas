...
type
  ...
  TMyObj12_List0 = TObjectList<TMyObj12>;

  TMyObj12_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj12_List1 = TObjectList<TMyObj12_1>;
...
constructor TMyObj12_1.Create;
begin
  inherited;
  FInt := 12 * 3;
  FTest := 'Value: ' + Random(2122).ToString + Random(1200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj12_List0 := TMyObj12_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj12_List1 := TMyObj12_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
