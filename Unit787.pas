...
type
  ...
  TMyObj787_List0 = TObjectList<TMyObj787>;

  TMyObj787_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj787_List1 = TObjectList<TMyObj787_1>;
...
constructor TMyObj787_1.Create;
begin
  inherited;
  FInt := 787 * 3;
  FTest := 'Value: ' + Random(27872).ToString + Random(78700).ToString;
end;

procedure TForm787.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum787;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj787_List0 := TMyObj787_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj787_List1 := TMyObj787_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
