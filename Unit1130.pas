...
type
  ...
  TMyObj1130_List0 = TObjectList<TMyObj1130>;

  TMyObj1130_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1130_List1 = TObjectList<TMyObj1130_1>;
...
constructor TMyObj1130_1.Create;
begin
  inherited;
  FInt := 1130 * 3;
  FTest := 'Value: ' + Random(211302).ToString + Random(113000).ToString;
end;

procedure TForm1130.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1130;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1130_List0 := TMyObj1130_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1130_List1 := TMyObj1130_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
