...
type
  ...
  TMyObj1617_List0 = TObjectList<TMyObj1617>;

  TMyObj1617_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1617_List1 = TObjectList<TMyObj1617_1>;
...
constructor TMyObj1617_1.Create;
begin
  inherited;
  FInt := 1617 * 3;
  FTest := 'Value: ' + Random(216172).ToString + Random(161700).ToString;
end;

procedure TForm1617.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1617;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1617_List0 := TMyObj1617_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1617_List1 := TMyObj1617_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
