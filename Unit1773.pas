...
type
  ...
  TMyObj1773_List0 = TObjectList<TMyObj1773>;

  TMyObj1773_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1773_List1 = TObjectList<TMyObj1773_1>;
...
constructor TMyObj1773_1.Create;
begin
  inherited;
  FInt := 1773 * 3;
  FTest := 'Value: ' + Random(217732).ToString + Random(177300).ToString;
end;

procedure TForm1773.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1773;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1773_List0 := TMyObj1773_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1773_List1 := TMyObj1773_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
