...
type
  ...
  TMyObj1826_List0 = TObjectList<TMyObj1826>;

  TMyObj1826_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1826_List1 = TObjectList<TMyObj1826_1>;
...
constructor TMyObj1826_1.Create;
begin
  inherited;
  FInt := 1826 * 3;
  FTest := 'Value: ' + Random(218262).ToString + Random(182600).ToString;
end;

procedure TForm1826.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1826;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1826_List0 := TMyObj1826_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1826_List1 := TMyObj1826_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
