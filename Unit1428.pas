...
type
  ...
  TMyObj1428_List0 = TObjectList<TMyObj1428>;

  TMyObj1428_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1428_List1 = TObjectList<TMyObj1428_1>;
...
constructor TMyObj1428_1.Create;
begin
  inherited;
  FInt := 1428 * 3;
  FTest := 'Value: ' + Random(214282).ToString + Random(142800).ToString;
end;

procedure TForm1428.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1428;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1428_List0 := TMyObj1428_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1428_List1 := TMyObj1428_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
