...
type
  ...
  TMyObj1386_List0 = TObjectList<TMyObj1386>;

  TMyObj1386_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1386_List1 = TObjectList<TMyObj1386_1>;
...
constructor TMyObj1386_1.Create;
begin
  inherited;
  FInt := 1386 * 3;
  FTest := 'Value: ' + Random(213862).ToString + Random(138600).ToString;
end;

procedure TForm1386.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1386;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1386_List0 := TMyObj1386_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1386_List1 := TMyObj1386_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
