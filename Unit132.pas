...
type
  ...
  TMyObj132_List0 = TObjectList<TMyObj132>;

  TMyObj132_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj132_List1 = TObjectList<TMyObj132_1>;
...
constructor TMyObj132_1.Create;
begin
  inherited;
  FInt := 132 * 3;
  FTest := 'Value: ' + Random(21322).ToString + Random(13200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj132_List0 := TMyObj132_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj132_List1 := TMyObj132_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
