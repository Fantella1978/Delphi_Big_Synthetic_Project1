...
type
  ...
  TMyObj138_List0 = TObjectList<TMyObj138>;

  TMyObj138_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj138_List1 = TObjectList<TMyObj138_1>;
...
constructor TMyObj138_1.Create;
begin
  inherited;
  FInt := 138 * 3;
  FTest := 'Value: ' + Random(21382).ToString + Random(13800).ToString;
end;

procedure TForm138.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum138;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj138_List0 := TMyObj138_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj138_List1 := TMyObj138_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
