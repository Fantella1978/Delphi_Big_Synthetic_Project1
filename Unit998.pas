...
type
  ...
  TMyObj998_List0 = TObjectList<TMyObj998>;

  TMyObj998_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj998_List1 = TObjectList<TMyObj998_1>;
...
constructor TMyObj998_1.Create;
begin
  inherited;
  FInt := 998 * 3;
  FTest := 'Value: ' + Random(29982).ToString + Random(99800).ToString;
end;

procedure TForm998.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum998;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj998_List0 := TMyObj998_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj998_List1 := TMyObj998_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
