...
type
  ...
  TMyObj311_List0 = TObjectList<TMyObj311>;

  TMyObj311_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj311_List1 = TObjectList<TMyObj311_1>;
...
constructor TMyObj311_1.Create;
begin
  inherited;
  FInt := 311 * 3;
  FTest := 'Value: ' + Random(23112).ToString + Random(31100).ToString;
end;

procedure TForm311.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum311;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj311_List0 := TMyObj311_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj311_List1 := TMyObj311_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
