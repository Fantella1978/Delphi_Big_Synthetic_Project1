...
type
  ...
  TMyObj843_List0 = TObjectList<TMyObj843>;

  TMyObj843_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj843_List1 = TObjectList<TMyObj843_1>;
...
constructor TMyObj843_1.Create;
begin
  inherited;
  FInt := 843 * 3;
  FTest := 'Value: ' + Random(28432).ToString + Random(84300).ToString;
end;

procedure TForm843.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum843;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj843_List0 := TMyObj843_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj843_List1 := TMyObj843_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
