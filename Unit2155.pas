...
type
  ...
  TMyObj2155_List0 = TObjectList<TMyObj2155>;

  TMyObj2155_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2155_List1 = TObjectList<TMyObj2155_1>;
...
constructor TMyObj2155_1.Create;
begin
  inherited;
  FInt := 2155 * 3;
  FTest := 'Value: ' + Random(221552).ToString + Random(215500).ToString;
end;

procedure TForm2155.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2155;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2155_List0 := TMyObj2155_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2155_List1 := TMyObj2155_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
