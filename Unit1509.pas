...
type
  ...
  TMyObj1509_List0 = TObjectList<TMyObj1509>;

  TMyObj1509_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1509_List1 = TObjectList<TMyObj1509_1>;
...
constructor TMyObj1509_1.Create;
begin
  inherited;
  FInt := 1509 * 3;
  FTest := 'Value: ' + Random(215092).ToString + Random(150900).ToString;
end;

procedure TForm1509.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1509;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1509_List0 := TMyObj1509_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1509_List1 := TMyObj1509_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
