...
type
  ...
  TMyObj2168_List0 = TObjectList<TMyObj2168>;

  TMyObj2168_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2168_List1 = TObjectList<TMyObj2168_1>;
...
constructor TMyObj2168_1.Create;
begin
  inherited;
  FInt := 2168 * 3;
  FTest := 'Value: ' + Random(221682).ToString + Random(216800).ToString;
end;

procedure TForm2168.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2168;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2168_List0 := TMyObj2168_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2168_List1 := TMyObj2168_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
