...
type
  ...
  TMyObj298_List0 = TObjectList<TMyObj298>;

  TMyObj298_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj298_List1 = TObjectList<TMyObj298_1>;
...
constructor TMyObj298_1.Create;
begin
  inherited;
  FInt := 298 * 3;
  FTest := 'Value: ' + Random(22982).ToString + Random(29800).ToString;
end;

procedure TForm298.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum298;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj298_List0 := TMyObj298_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj298_List1 := TMyObj298_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
