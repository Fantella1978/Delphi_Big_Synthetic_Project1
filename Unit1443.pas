...
type
  ...
  TMyObj1443_List0 = TObjectList<TMyObj1443>;

  TMyObj1443_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1443_List1 = TObjectList<TMyObj1443_1>;
...
constructor TMyObj1443_1.Create;
begin
  inherited;
  FInt := 1443 * 3;
  FTest := 'Value: ' + Random(214432).ToString + Random(144300).ToString;
end;

procedure TForm1443.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1443;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1443_List0 := TMyObj1443_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1443_List1 := TMyObj1443_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
