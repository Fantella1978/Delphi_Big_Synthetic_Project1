...
type
  ...
  TMyObj1863_List0 = TObjectList<TMyObj1863>;

  TMyObj1863_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1863_List1 = TObjectList<TMyObj1863_1>;
...
constructor TMyObj1863_1.Create;
begin
  inherited;
  FInt := 1863 * 3;
  FTest := 'Value: ' + Random(218632).ToString + Random(186300).ToString;
end;

procedure TForm1863.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1863;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1863_List0 := TMyObj1863_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1863_List1 := TMyObj1863_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
