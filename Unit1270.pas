...
type
  ...
  TMyObj1270_List0 = TObjectList<TMyObj1270>;

  TMyObj1270_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1270_List1 = TObjectList<TMyObj1270_1>;
...
constructor TMyObj1270_1.Create;
begin
  inherited;
  FInt := 1270 * 3;
  FTest := 'Value: ' + Random(212702).ToString + Random(127000).ToString;
end;

procedure TForm1270.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1270;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1270_List0 := TMyObj1270_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1270_List1 := TMyObj1270_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
