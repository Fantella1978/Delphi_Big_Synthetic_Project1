...
type
  ...
  TMyObj1974_List0 = TObjectList<TMyObj1974>;

  TMyObj1974_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1974_List1 = TObjectList<TMyObj1974_1>;
...
constructor TMyObj1974_1.Create;
begin
  inherited;
  FInt := 1974 * 3;
  FTest := 'Value: ' + Random(219742).ToString + Random(197400).ToString;
end;

procedure TForm1974.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1974;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1974_List0 := TMyObj1974_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1974_List1 := TMyObj1974_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
