...
type
  ...
  TMyObj700_List0 = TObjectList<TMyObj700>;

  TMyObj700_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj700_List1 = TObjectList<TMyObj700_1>;
...
constructor TMyObj700_1.Create;
begin
  inherited;
  FInt := 700 * 3;
  FTest := 'Value: ' + Random(27002).ToString + Random(70000).ToString;
end;

procedure TForm700.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum700;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj700_List0 := TMyObj700_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj700_List1 := TMyObj700_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
