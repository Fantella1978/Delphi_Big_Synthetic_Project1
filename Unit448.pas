...
type
  ...
  TMyObj448_List0 = TObjectList<TMyObj448>;

  TMyObj448_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj448_List1 = TObjectList<TMyObj448_1>;
...
constructor TMyObj448_1.Create;
begin
  inherited;
  FInt := 448 * 3;
  FTest := 'Value: ' + Random(24482).ToString + Random(44800).ToString;
end;

procedure TForm448.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum448;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj448_List0 := TMyObj448_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj448_List1 := TMyObj448_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
