...
type
  ...
  TMyObj568_List0 = TObjectList<TMyObj568>;

  TMyObj568_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj568_List1 = TObjectList<TMyObj568_1>;
...
constructor TMyObj568_1.Create;
begin
  inherited;
  FInt := 568 * 3;
  FTest := 'Value: ' + Random(25682).ToString + Random(56800).ToString;
end;

procedure TForm568.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum568;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj568_List0 := TMyObj568_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj568_List1 := TMyObj568_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
