...
type
  ...
  TMyObj581_List0 = TObjectList<TMyObj581>;

  TMyObj581_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj581_List1 = TObjectList<TMyObj581_1>;
...
constructor TMyObj581_1.Create;
begin
  inherited;
  FInt := 581 * 3;
  FTest := 'Value: ' + Random(25812).ToString + Random(58100).ToString;
end;

procedure TForm581.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum581;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj581_List0 := TMyObj581_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj581_List1 := TMyObj581_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
