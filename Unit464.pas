...
type
  ...
  TMyObj464_List0 = TObjectList<TMyObj464>;

  TMyObj464_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj464_List1 = TObjectList<TMyObj464_1>;
...
constructor TMyObj464_1.Create;
begin
  inherited;
  FInt := 464 * 3;
  FTest := 'Value: ' + Random(24642).ToString + Random(46400).ToString;
end;

procedure TForm464.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum464;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj464_List0 := TMyObj464_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj464_List1 := TMyObj464_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
