...
type
  ...
  TMyObj779_List0 = TObjectList<TMyObj779>;

  TMyObj779_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj779_List1 = TObjectList<TMyObj779_1>;
...
constructor TMyObj779_1.Create;
begin
  inherited;
  FInt := 779 * 3;
  FTest := 'Value: ' + Random(27792).ToString + Random(77900).ToString;
end;

procedure TForm779.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum779;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj779_List0 := TMyObj779_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj779_List1 := TMyObj779_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
