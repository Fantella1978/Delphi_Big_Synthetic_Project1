...
type
  ...
  TMyObj655_List0 = TObjectList<TMyObj655>;

  TMyObj655_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj655_List1 = TObjectList<TMyObj655_1>;
...
constructor TMyObj655_1.Create;
begin
  inherited;
  FInt := 655 * 3;
  FTest := 'Value: ' + Random(26552).ToString + Random(65500).ToString;
end;

procedure TForm655.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum655;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj655_List0 := TMyObj655_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj655_List1 := TMyObj655_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
