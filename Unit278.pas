...
type
  ...
  TMyObj278_List0 = TObjectList<TMyObj278>;

  TMyObj278_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj278_List1 = TObjectList<TMyObj278_1>;
...
constructor TMyObj278_1.Create;
begin
  inherited;
  FInt := 278 * 3;
  FTest := 'Value: ' + Random(22782).ToString + Random(27800).ToString;
end;

procedure TForm278.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum278;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj278_List0 := TMyObj278_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj278_List1 := TMyObj278_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
