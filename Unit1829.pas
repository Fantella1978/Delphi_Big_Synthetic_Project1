...
type
  ...
  TMyObj1829_List0 = TObjectList<TMyObj1829>;

  TMyObj1829_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1829_List1 = TObjectList<TMyObj1829_1>;
...
constructor TMyObj1829_1.Create;
begin
  inherited;
  FInt := 1829 * 3;
  FTest := 'Value: ' + Random(218292).ToString + Random(182900).ToString;
end;

procedure TForm1829.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1829;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1829_List0 := TMyObj1829_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1829_List1 := TMyObj1829_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
