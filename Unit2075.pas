...
type
  ...
  TMyObj2075_List0 = TObjectList<TMyObj2075>;

  TMyObj2075_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2075_List1 = TObjectList<TMyObj2075_1>;
...
constructor TMyObj2075_1.Create;
begin
  inherited;
  FInt := 2075 * 3;
  FTest := 'Value: ' + Random(220752).ToString + Random(207500).ToString;
end;

procedure TForm2075.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2075;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2075_List0 := TMyObj2075_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2075_List1 := TMyObj2075_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
