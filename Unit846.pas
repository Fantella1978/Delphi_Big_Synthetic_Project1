...
type
  ...
  TMyObj846_List0 = TObjectList<TMyObj846>;

  TMyObj846_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj846_List1 = TObjectList<TMyObj846_1>;
...
constructor TMyObj846_1.Create;
begin
  inherited;
  FInt := 846 * 3;
  FTest := 'Value: ' + Random(28462).ToString + Random(84600).ToString;
end;

procedure TForm846.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum846;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj846_List0 := TMyObj846_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj846_List1 := TMyObj846_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
