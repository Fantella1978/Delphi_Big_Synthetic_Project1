...
type
  ...
  TMyObj1690_List0 = TObjectList<TMyObj1690>;

  TMyObj1690_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1690_List1 = TObjectList<TMyObj1690_1>;
...
constructor TMyObj1690_1.Create;
begin
  inherited;
  FInt := 1690 * 3;
  FTest := 'Value: ' + Random(216902).ToString + Random(169000).ToString;
end;

procedure TForm1690.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1690;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1690_List0 := TMyObj1690_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1690_List1 := TMyObj1690_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
