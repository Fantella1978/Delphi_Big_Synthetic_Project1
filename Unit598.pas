...
type
  ...
  TMyObj598_List0 = TObjectList<TMyObj598>;

  TMyObj598_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj598_List1 = TObjectList<TMyObj598_1>;
...
constructor TMyObj598_1.Create;
begin
  inherited;
  FInt := 598 * 3;
  FTest := 'Value: ' + Random(25982).ToString + Random(59800).ToString;
end;

procedure TForm598.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum598;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj598_List0 := TMyObj598_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj598_List1 := TMyObj598_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
