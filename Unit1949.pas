...
type
  ...
  TMyObj1949_List0 = TObjectList<TMyObj1949>;

  TMyObj1949_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1949_List1 = TObjectList<TMyObj1949_1>;
...
constructor TMyObj1949_1.Create;
begin
  inherited;
  FInt := 1949 * 3;
  FTest := 'Value: ' + Random(219492).ToString + Random(194900).ToString;
end;

procedure TForm1949.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1949;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1949_List0 := TMyObj1949_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1949_List1 := TMyObj1949_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
