...
type
  ...
  TMyObj1120_List0 = TObjectList<TMyObj1120>;

  TMyObj1120_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1120_List1 = TObjectList<TMyObj1120_1>;
...
constructor TMyObj1120_1.Create;
begin
  inherited;
  FInt := 1120 * 3;
  FTest := 'Value: ' + Random(211202).ToString + Random(112000).ToString;
end;

procedure TForm1120.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1120;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1120_List0 := TMyObj1120_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1120_List1 := TMyObj1120_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
