...
type
  ...
  TMyObj2230_List0 = TObjectList<TMyObj2230>;

  TMyObj2230_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2230_List1 = TObjectList<TMyObj2230_1>;
...
constructor TMyObj2230_1.Create;
begin
  inherited;
  FInt := 2230 * 3;
  FTest := 'Value: ' + Random(222302).ToString + Random(223000).ToString;
end;

procedure TForm2230.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2230;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2230_List0 := TMyObj2230_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2230_List1 := TMyObj2230_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
