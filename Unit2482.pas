...
type
  ...
  TMyObj2482_List0 = TObjectList<TMyObj2482>;

  TMyObj2482_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2482_List1 = TObjectList<TMyObj2482_1>;
...
constructor TMyObj2482_1.Create;
begin
  inherited;
  FInt := 2482 * 3;
  FTest := 'Value: ' + Random(224822).ToString + Random(248200).ToString;
end;

procedure TForm2482.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2482;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2482_List0 := TMyObj2482_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2482_List1 := TMyObj2482_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
