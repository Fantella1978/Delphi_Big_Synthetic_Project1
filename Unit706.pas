...
type
  ...
  TMyObj706_List0 = TObjectList<TMyObj706>;

  TMyObj706_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj706_List1 = TObjectList<TMyObj706_1>;
...
constructor TMyObj706_1.Create;
begin
  inherited;
  FInt := 706 * 3;
  FTest := 'Value: ' + Random(27062).ToString + Random(70600).ToString;
end;

procedure TForm706.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum706;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj706_List0 := TMyObj706_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj706_List1 := TMyObj706_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
