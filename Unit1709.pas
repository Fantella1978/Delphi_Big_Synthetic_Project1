...
type
  ...
  TMyObj1709_List0 = TObjectList<TMyObj1709>;

  TMyObj1709_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1709_List1 = TObjectList<TMyObj1709_1>;
...
constructor TMyObj1709_1.Create;
begin
  inherited;
  FInt := 1709 * 3;
  FTest := 'Value: ' + Random(217092).ToString + Random(170900).ToString;
end;

procedure TForm1709.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1709;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1709_List0 := TMyObj1709_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1709_List1 := TMyObj1709_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
