...
type
  ...
  TMyObj2111_List0 = TObjectList<TMyObj2111>;

  TMyObj2111_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2111_List1 = TObjectList<TMyObj2111_1>;
...
constructor TMyObj2111_1.Create;
begin
  inherited;
  FInt := 2111 * 3;
  FTest := 'Value: ' + Random(221112).ToString + Random(211100).ToString;
end;

procedure TForm2111.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2111;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2111_List0 := TMyObj2111_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2111_List1 := TMyObj2111_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
