...
type
  ...
  TMyObj2278_List0 = TObjectList<TMyObj2278>;

  TMyObj2278_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2278_List1 = TObjectList<TMyObj2278_1>;
...
constructor TMyObj2278_1.Create;
begin
  inherited;
  FInt := 2278 * 3;
  FTest := 'Value: ' + Random(222782).ToString + Random(227800).ToString;
end;

procedure TForm2278.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2278;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2278_List0 := TMyObj2278_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2278_List1 := TMyObj2278_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
