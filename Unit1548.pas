...
type
  ...
  TMyObj1548_List0 = TObjectList<TMyObj1548>;

  TMyObj1548_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1548_List1 = TObjectList<TMyObj1548_1>;
...
constructor TMyObj1548_1.Create;
begin
  inherited;
  FInt := 1548 * 3;
  FTest := 'Value: ' + Random(215482).ToString + Random(154800).ToString;
end;

procedure TForm1548.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1548;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1548_List0 := TMyObj1548_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1548_List1 := TMyObj1548_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
