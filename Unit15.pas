...
type
  ...
  TMyObj15_List0 = TObjectList<TMyObj15>;

  TMyObj15_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj15_List1 = TObjectList<TMyObj15_1>;
...
constructor TMyObj15_1.Create;
begin
  inherited;
  FInt := 15 * 3;
  FTest := 'Value: ' + Random(2152).ToString + Random(1500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj15_List0 := TMyObj15_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj15_List1 := TMyObj15_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
