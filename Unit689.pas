...
type
  ...
  TMyObj689_List0 = TObjectList<TMyObj689>;

  TMyObj689_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj689_List1 = TObjectList<TMyObj689_1>;
...
constructor TMyObj689_1.Create;
begin
  inherited;
  FInt := 689 * 3;
  FTest := 'Value: ' + Random(26892).ToString + Random(68900).ToString;
end;

procedure TForm689.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum689;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj689_List0 := TMyObj689_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj689_List1 := TMyObj689_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
