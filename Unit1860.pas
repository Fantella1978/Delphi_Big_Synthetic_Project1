...
type
  ...
  TMyObj1860_List0 = TObjectList<TMyObj1860>;

  TMyObj1860_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1860_List1 = TObjectList<TMyObj1860_1>;
...
constructor TMyObj1860_1.Create;
begin
  inherited;
  FInt := 1860 * 3;
  FTest := 'Value: ' + Random(218602).ToString + Random(186000).ToString;
end;

procedure TForm1860.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1860;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1860_List0 := TMyObj1860_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1860_List1 := TMyObj1860_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
