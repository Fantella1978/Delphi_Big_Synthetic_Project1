...
type
  ...
  TMyObj1520_List0 = TObjectList<TMyObj1520>;

  TMyObj1520_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1520_List1 = TObjectList<TMyObj1520_1>;
...
constructor TMyObj1520_1.Create;
begin
  inherited;
  FInt := 1520 * 3;
  FTest := 'Value: ' + Random(215202).ToString + Random(152000).ToString;
end;

procedure TForm1520.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1520;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1520_List0 := TMyObj1520_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1520_List1 := TMyObj1520_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
