...
type
  ...
  TMyObj902_List0 = TObjectList<TMyObj902>;

  TMyObj902_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj902_List1 = TObjectList<TMyObj902_1>;
...
constructor TMyObj902_1.Create;
begin
  inherited;
  FInt := 902 * 3;
  FTest := 'Value: ' + Random(29022).ToString + Random(90200).ToString;
end;

procedure TForm902.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum902;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj902_List0 := TMyObj902_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj902_List1 := TMyObj902_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
