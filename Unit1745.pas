...
type
  ...
  TMyObj1745_List0 = TObjectList<TMyObj1745>;

  TMyObj1745_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1745_List1 = TObjectList<TMyObj1745_1>;
...
constructor TMyObj1745_1.Create;
begin
  inherited;
  FInt := 1745 * 3;
  FTest := 'Value: ' + Random(217452).ToString + Random(174500).ToString;
end;

procedure TForm1745.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1745;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1745_List0 := TMyObj1745_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1745_List1 := TMyObj1745_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
