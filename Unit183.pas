...
type
  ...
  TMyObj183_List0 = TObjectList<TMyObj183>;

  TMyObj183_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj183_List1 = TObjectList<TMyObj183_1>;
...
constructor TMyObj183_1.Create;
begin
  inherited;
  FInt := 183 * 3;
  FTest := 'Value: ' + Random(21832).ToString + Random(18300).ToString;
end;

procedure TForm183.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum183;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj183_List0 := TMyObj183_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj183_List1 := TMyObj183_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
