...
type
  ...
  TMyObj1657_List0 = TObjectList<TMyObj1657>;

  TMyObj1657_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1657_List1 = TObjectList<TMyObj1657_1>;
...
constructor TMyObj1657_1.Create;
begin
  inherited;
  FInt := 1657 * 3;
  FTest := 'Value: ' + Random(216572).ToString + Random(165700).ToString;
end;

procedure TForm1657.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1657;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1657_List0 := TMyObj1657_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1657_List1 := TMyObj1657_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
