...
type
  ...
  TMyObj2099_List0 = TObjectList<TMyObj2099>;

  TMyObj2099_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2099_List1 = TObjectList<TMyObj2099_1>;
...
constructor TMyObj2099_1.Create;
begin
  inherited;
  FInt := 2099 * 3;
  FTest := 'Value: ' + Random(220992).ToString + Random(209900).ToString;
end;

procedure TForm2099.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2099;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2099_List0 := TMyObj2099_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2099_List1 := TMyObj2099_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
