...
type
  ...
  TMyObj503_List0 = TObjectList<TMyObj503>;

  TMyObj503_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj503_List1 = TObjectList<TMyObj503_1>;
...
constructor TMyObj503_1.Create;
begin
  inherited;
  FInt := 503 * 3;
  FTest := 'Value: ' + Random(25032).ToString + Random(50300).ToString;
end;

procedure TForm503.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum503;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj503_List0 := TMyObj503_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj503_List1 := TMyObj503_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
