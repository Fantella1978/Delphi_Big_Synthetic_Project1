...
type
  ...
  TMyObj61_List0 = TObjectList<TMyObj61>;

  TMyObj61_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj61_List1 = TObjectList<TMyObj61_1>;
...
constructor TMyObj61_1.Create;
begin
  inherited;
  FInt := 61 * 3;
  FTest := 'Value: ' + Random(2612).ToString + Random(6100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj61_List0 := TMyObj61_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj61_List1 := TMyObj61_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
