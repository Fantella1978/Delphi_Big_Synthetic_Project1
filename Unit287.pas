...
type
  ...
  TMyObj287_List0 = TObjectList<TMyObj287>;

  TMyObj287_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj287_List1 = TObjectList<TMyObj287_1>;
...
constructor TMyObj287_1.Create;
begin
  inherited;
  FInt := 287 * 3;
  FTest := 'Value: ' + Random(22872).ToString + Random(28700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj287_List0 := TMyObj287_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj287_List1 := TMyObj287_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
