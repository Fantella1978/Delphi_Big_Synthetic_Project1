...
type
  ...
  TMyObj2166_List0 = TObjectList<TMyObj2166>;

  TMyObj2166_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2166_List1 = TObjectList<TMyObj2166_1>;
...
constructor TMyObj2166_1.Create;
begin
  inherited;
  FInt := 2166 * 3;
  FTest := 'Value: ' + Random(221662).ToString + Random(216600).ToString;
end;

procedure TForm2166.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2166;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2166_List0 := TMyObj2166_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2166_List1 := TMyObj2166_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
