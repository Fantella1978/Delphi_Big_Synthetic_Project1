...
type
  ...
  TMyObj1012_List0 = TObjectList<TMyObj1012>;

  TMyObj1012_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1012_List1 = TObjectList<TMyObj1012_1>;
...
constructor TMyObj1012_1.Create;
begin
  inherited;
  FInt := 1012 * 3;
  FTest := 'Value: ' + Random(210122).ToString + Random(101200).ToString;
end;

procedure TForm1012.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1012;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1012_List0 := TMyObj1012_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1012_List1 := TMyObj1012_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
