...
type
  ...
  TMyObj63_List0 = TObjectList<TMyObj63>;

  TMyObj63_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj63_List1 = TObjectList<TMyObj63_1>;
...
constructor TMyObj63_1.Create;
begin
  inherited;
  FInt := 63 * 3;
  FTest := 'Value: ' + Random(2632).ToString + Random(6300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj63_List0 := TMyObj63_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj63_List1 := TMyObj63_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
