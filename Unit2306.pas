...
type
  ...
  TMyObj2306_List0 = TObjectList<TMyObj2306>;

  TMyObj2306_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2306_List1 = TObjectList<TMyObj2306_1>;
...
constructor TMyObj2306_1.Create;
begin
  inherited;
  FInt := 2306 * 3;
  FTest := 'Value: ' + Random(223062).ToString + Random(230600).ToString;
end;

procedure TForm2306.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2306;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2306_List0 := TMyObj2306_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2306_List1 := TMyObj2306_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
