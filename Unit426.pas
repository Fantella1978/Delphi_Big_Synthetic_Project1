...
type
  ...
  TMyObj426_List0 = TObjectList<TMyObj426>;

  TMyObj426_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj426_List1 = TObjectList<TMyObj426_1>;
...
constructor TMyObj426_1.Create;
begin
  inherited;
  FInt := 426 * 3;
  FTest := 'Value: ' + Random(24262).ToString + Random(42600).ToString;
end;

procedure TForm426.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum426;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj426_List0 := TMyObj426_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj426_List1 := TMyObj426_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
