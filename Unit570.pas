...
type
  ...
  TMyObj570_List0 = TObjectList<TMyObj570>;

  TMyObj570_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj570_List1 = TObjectList<TMyObj570_1>;
...
constructor TMyObj570_1.Create;
begin
  inherited;
  FInt := 570 * 3;
  FTest := 'Value: ' + Random(25702).ToString + Random(57000).ToString;
end;

procedure TForm570.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum570;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj570_List0 := TMyObj570_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj570_List1 := TMyObj570_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
