...
type
  ...
  TMyObj469_List0 = TObjectList<TMyObj469>;

  TMyObj469_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj469_List1 = TObjectList<TMyObj469_1>;
...
constructor TMyObj469_1.Create;
begin
  inherited;
  FInt := 469 * 3;
  FTest := 'Value: ' + Random(24692).ToString + Random(46900).ToString;
end;

procedure TForm469.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum469;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj469_List0 := TMyObj469_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj469_List1 := TMyObj469_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
