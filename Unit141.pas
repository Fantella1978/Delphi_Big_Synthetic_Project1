...
type
  ...
  TMyObj141_List0 = TObjectList<TMyObj141>;

  TMyObj141_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj141_List1 = TObjectList<TMyObj141_1>;
...
constructor TMyObj141_1.Create;
begin
  inherited;
  FInt := 141 * 3;
  FTest := 'Value: ' + Random(21412).ToString + Random(14100).ToString;
end;

procedure TForm141.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum141;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj141_List0 := TMyObj141_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj141_List1 := TMyObj141_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
