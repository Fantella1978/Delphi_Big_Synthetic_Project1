...
type
  ...
  TMyObj1613_List0 = TObjectList<TMyObj1613>;

  TMyObj1613_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1613_List1 = TObjectList<TMyObj1613_1>;
...
constructor TMyObj1613_1.Create;
begin
  inherited;
  FInt := 1613 * 3;
  FTest := 'Value: ' + Random(216132).ToString + Random(161300).ToString;
end;

procedure TForm1613.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1613;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1613_List0 := TMyObj1613_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1613_List1 := TMyObj1613_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
