...
type
  ...
  TMyObj478_List0 = TObjectList<TMyObj478>;

  TMyObj478_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj478_List1 = TObjectList<TMyObj478_1>;
...
constructor TMyObj478_1.Create;
begin
  inherited;
  FInt := 478 * 3;
  FTest := 'Value: ' + Random(24782).ToString + Random(47800).ToString;
end;

procedure TForm478.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum478;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj478_List0 := TMyObj478_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj478_List1 := TMyObj478_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
