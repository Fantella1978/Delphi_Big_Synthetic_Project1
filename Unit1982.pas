...
type
  ...
  TMyObj1982_List0 = TObjectList<TMyObj1982>;

  TMyObj1982_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1982_List1 = TObjectList<TMyObj1982_1>;
...
constructor TMyObj1982_1.Create;
begin
  inherited;
  FInt := 1982 * 3;
  FTest := 'Value: ' + Random(219822).ToString + Random(198200).ToString;
end;

procedure TForm1982.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1982;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1982_List0 := TMyObj1982_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1982_List1 := TMyObj1982_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
