...
type
  ...
  TMyObj2233_List0 = TObjectList<TMyObj2233>;

  TMyObj2233_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2233_List1 = TObjectList<TMyObj2233_1>;
...
constructor TMyObj2233_1.Create;
begin
  inherited;
  FInt := 2233 * 3;
  FTest := 'Value: ' + Random(222332).ToString + Random(223300).ToString;
end;

procedure TForm2233.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2233;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2233_List0 := TMyObj2233_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2233_List1 := TMyObj2233_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
