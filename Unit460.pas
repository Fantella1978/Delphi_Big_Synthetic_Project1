...
type
  ...
  TMyObj460_List0 = TObjectList<TMyObj460>;

  TMyObj460_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj460_List1 = TObjectList<TMyObj460_1>;
...
constructor TMyObj460_1.Create;
begin
  inherited;
  FInt := 460 * 3;
  FTest := 'Value: ' + Random(24602).ToString + Random(46000).ToString;
end;

procedure TForm460.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum460;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj460_List0 := TMyObj460_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj460_List1 := TMyObj460_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
