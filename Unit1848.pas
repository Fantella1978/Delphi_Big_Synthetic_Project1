...
type
  ...
  TMyObj1848_List0 = TObjectList<TMyObj1848>;

  TMyObj1848_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1848_List1 = TObjectList<TMyObj1848_1>;
...
constructor TMyObj1848_1.Create;
begin
  inherited;
  FInt := 1848 * 3;
  FTest := 'Value: ' + Random(218482).ToString + Random(184800).ToString;
end;

procedure TForm1848.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1848;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1848_List0 := TMyObj1848_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1848_List1 := TMyObj1848_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
