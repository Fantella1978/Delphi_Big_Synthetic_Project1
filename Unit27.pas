...
type
  ...
  TMyObj27_List0 = TObjectList<TMyObj27>;

  TMyObj27_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj27_List1 = TObjectList<TMyObj27_1>;
...
constructor TMyObj27_1.Create;
begin
  inherited;
  FInt := 27 * 3;
  FTest := 'Value: ' + Random(2272).ToString + Random(2700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj27_List0 := TMyObj27_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj27_List1 := TMyObj27_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
