...
type
  ...
  TMyObj2493_List0 = TObjectList<TMyObj2493>;

  TMyObj2493_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2493_List1 = TObjectList<TMyObj2493_1>;
...
constructor TMyObj2493_1.Create;
begin
  inherited;
  FInt := 2493 * 3;
  FTest := 'Value: ' + Random(224932).ToString + Random(249300).ToString;
end;

procedure TForm2493.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2493;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2493_List0 := TMyObj2493_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2493_List1 := TMyObj2493_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
