...
type
  ...
  TMyObj473_List0 = TObjectList<TMyObj473>;

  TMyObj473_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj473_List1 = TObjectList<TMyObj473_1>;
...
constructor TMyObj473_1.Create;
begin
  inherited;
  FInt := 473 * 3;
  FTest := 'Value: ' + Random(24732).ToString + Random(47300).ToString;
end;

procedure TForm473.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum473;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj473_List0 := TMyObj473_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj473_List1 := TMyObj473_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
