...
type
  ...
  TMyObj435_List0 = TObjectList<TMyObj435>;

  TMyObj435_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj435_List1 = TObjectList<TMyObj435_1>;
...
constructor TMyObj435_1.Create;
begin
  inherited;
  FInt := 435 * 3;
  FTest := 'Value: ' + Random(24352).ToString + Random(43500).ToString;
end;

procedure TForm435.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum435;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj435_List0 := TMyObj435_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj435_List1 := TMyObj435_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
