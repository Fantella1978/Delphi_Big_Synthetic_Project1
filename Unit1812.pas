...
type
  ...
  TMyObj1812_List0 = TObjectList<TMyObj1812>;

  TMyObj1812_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1812_List1 = TObjectList<TMyObj1812_1>;
...
constructor TMyObj1812_1.Create;
begin
  inherited;
  FInt := 1812 * 3;
  FTest := 'Value: ' + Random(218122).ToString + Random(181200).ToString;
end;

procedure TForm1812.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1812;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1812_List0 := TMyObj1812_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1812_List1 := TMyObj1812_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
