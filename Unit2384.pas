...
type
  ...
  TMyObj2384_List0 = TObjectList<TMyObj2384>;

  TMyObj2384_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2384_List1 = TObjectList<TMyObj2384_1>;
...
constructor TMyObj2384_1.Create;
begin
  inherited;
  FInt := 2384 * 3;
  FTest := 'Value: ' + Random(223842).ToString + Random(238400).ToString;
end;

procedure TForm2384.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2384;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2384_List0 := TMyObj2384_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2384_List1 := TMyObj2384_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
