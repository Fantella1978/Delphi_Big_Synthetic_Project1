...
type
  ...
  TMyObj1134_List0 = TObjectList<TMyObj1134>;

  TMyObj1134_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1134_List1 = TObjectList<TMyObj1134_1>;
...
constructor TMyObj1134_1.Create;
begin
  inherited;
  FInt := 1134 * 3;
  FTest := 'Value: ' + Random(211342).ToString + Random(113400).ToString;
end;

procedure TForm1134.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1134;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1134_List0 := TMyObj1134_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1134_List1 := TMyObj1134_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
