...
type
  ...
  TMyObj1253_List0 = TObjectList<TMyObj1253>;

  TMyObj1253_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1253_List1 = TObjectList<TMyObj1253_1>;
...
constructor TMyObj1253_1.Create;
begin
  inherited;
  FInt := 1253 * 3;
  FTest := 'Value: ' + Random(212532).ToString + Random(125300).ToString;
end;

procedure TForm1253.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1253;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1253_List0 := TMyObj1253_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1253_List1 := TMyObj1253_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
