...
type
  ...
  TMyObj649_List0 = TObjectList<TMyObj649>;

  TMyObj649_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj649_List1 = TObjectList<TMyObj649_1>;
...
constructor TMyObj649_1.Create;
begin
  inherited;
  FInt := 649 * 3;
  FTest := 'Value: ' + Random(26492).ToString + Random(64900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj649_List0 := TMyObj649_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj649_List1 := TMyObj649_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
