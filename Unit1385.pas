...
type
  ...
  TMyObj1385_List0 = TObjectList<TMyObj1385>;

  TMyObj1385_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1385_List1 = TObjectList<TMyObj1385_1>;
...
constructor TMyObj1385_1.Create;
begin
  inherited;
  FInt := 1385 * 3;
  FTest := 'Value: ' + Random(213852).ToString + Random(138500).ToString;
end;

procedure TForm1385.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1385;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1385_List0 := TMyObj1385_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1385_List1 := TMyObj1385_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
