...
type
  ...
  TMyObj781_List0 = TObjectList<TMyObj781>;

  TMyObj781_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj781_List1 = TObjectList<TMyObj781_1>;
...
constructor TMyObj781_1.Create;
begin
  inherited;
  FInt := 781 * 3;
  FTest := 'Value: ' + Random(27812).ToString + Random(78100).ToString;
end;

procedure TForm781.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum781;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj781_List0 := TMyObj781_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj781_List1 := TMyObj781_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
