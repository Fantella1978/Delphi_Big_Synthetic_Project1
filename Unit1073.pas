...
type
  ...
  TMyObj1073_List0 = TObjectList<TMyObj1073>;

  TMyObj1073_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1073_List1 = TObjectList<TMyObj1073_1>;
...
constructor TMyObj1073_1.Create;
begin
  inherited;
  FInt := 1073 * 3;
  FTest := 'Value: ' + Random(210732).ToString + Random(107300).ToString;
end;

procedure TForm1073.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1073;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1073_List0 := TMyObj1073_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1073_List1 := TMyObj1073_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
