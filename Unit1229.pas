...
type
  ...
  TMyObj1229_List0 = TObjectList<TMyObj1229>;

  TMyObj1229_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1229_List1 = TObjectList<TMyObj1229_1>;
...
constructor TMyObj1229_1.Create;
begin
  inherited;
  FInt := 1229 * 3;
  FTest := 'Value: ' + Random(212292).ToString + Random(122900).ToString;
end;

procedure TForm1229.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1229;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1229_List0 := TMyObj1229_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1229_List1 := TMyObj1229_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
