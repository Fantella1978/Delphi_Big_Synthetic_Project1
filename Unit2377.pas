...
type
  ...
  TMyObj2377_List0 = TObjectList<TMyObj2377>;

  TMyObj2377_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2377_List1 = TObjectList<TMyObj2377_1>;
...
constructor TMyObj2377_1.Create;
begin
  inherited;
  FInt := 2377 * 3;
  FTest := 'Value: ' + Random(223772).ToString + Random(237700).ToString;
end;

procedure TForm2377.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2377;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2377_List0 := TMyObj2377_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2377_List1 := TMyObj2377_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
