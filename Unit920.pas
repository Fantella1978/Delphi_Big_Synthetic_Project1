...
type
  ...
  TMyObj920_List0 = TObjectList<TMyObj920>;

  TMyObj920_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj920_List1 = TObjectList<TMyObj920_1>;
...
constructor TMyObj920_1.Create;
begin
  inherited;
  FInt := 920 * 3;
  FTest := 'Value: ' + Random(29202).ToString + Random(92000).ToString;
end;

procedure TForm920.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum920;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj920_List0 := TMyObj920_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj920_List1 := TMyObj920_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
