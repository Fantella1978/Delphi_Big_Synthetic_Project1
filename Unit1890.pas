...
type
  ...
  TMyObj1890_List0 = TObjectList<TMyObj1890>;

  TMyObj1890_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1890_List1 = TObjectList<TMyObj1890_1>;
...
constructor TMyObj1890_1.Create;
begin
  inherited;
  FInt := 1890 * 3;
  FTest := 'Value: ' + Random(218902).ToString + Random(189000).ToString;
end;

procedure TForm1890.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1890;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1890_List0 := TMyObj1890_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1890_List1 := TMyObj1890_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
