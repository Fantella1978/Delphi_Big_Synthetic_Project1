...
type
  ...
  TMyObj929_List0 = TObjectList<TMyObj929>;

  TMyObj929_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj929_List1 = TObjectList<TMyObj929_1>;
...
constructor TMyObj929_1.Create;
begin
  inherited;
  FInt := 929 * 3;
  FTest := 'Value: ' + Random(29292).ToString + Random(92900).ToString;
end;

procedure TForm929.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum929;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj929_List0 := TMyObj929_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj929_List1 := TMyObj929_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
