...
type
  ...
  TMyObj995_List0 = TObjectList<TMyObj995>;

  TMyObj995_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj995_List1 = TObjectList<TMyObj995_1>;
...
constructor TMyObj995_1.Create;
begin
  inherited;
  FInt := 995 * 3;
  FTest := 'Value: ' + Random(29952).ToString + Random(99500).ToString;
end;

procedure TForm995.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum995;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj995_List0 := TMyObj995_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj995_List1 := TMyObj995_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
