...
type
  ...
  TMyObj927_List0 = TObjectList<TMyObj927>;

  TMyObj927_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj927_List1 = TObjectList<TMyObj927_1>;
...
constructor TMyObj927_1.Create;
begin
  inherited;
  FInt := 927 * 3;
  FTest := 'Value: ' + Random(29272).ToString + Random(92700).ToString;
end;

procedure TForm927.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum927;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj927_List0 := TMyObj927_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj927_List1 := TMyObj927_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
