...
type
  ...
  TMyObj2027_List0 = TObjectList<TMyObj2027>;

  TMyObj2027_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2027_List1 = TObjectList<TMyObj2027_1>;
...
constructor TMyObj2027_1.Create;
begin
  inherited;
  FInt := 2027 * 3;
  FTest := 'Value: ' + Random(220272).ToString + Random(202700).ToString;
end;

procedure TForm2027.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2027;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2027_List0 := TMyObj2027_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2027_List1 := TMyObj2027_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
