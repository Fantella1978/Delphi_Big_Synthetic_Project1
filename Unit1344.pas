...
type
  ...
  TMyObj1344_List0 = TObjectList<TMyObj1344>;

  TMyObj1344_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1344_List1 = TObjectList<TMyObj1344_1>;
...
constructor TMyObj1344_1.Create;
begin
  inherited;
  FInt := 1344 * 3;
  FTest := 'Value: ' + Random(213442).ToString + Random(134400).ToString;
end;

procedure TForm1344.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1344;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1344_List0 := TMyObj1344_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1344_List1 := TMyObj1344_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
