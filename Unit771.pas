...
type
  ...
  TMyObj771_List0 = TObjectList<TMyObj771>;

  TMyObj771_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj771_List1 = TObjectList<TMyObj771_1>;
...
constructor TMyObj771_1.Create;
begin
  inherited;
  FInt := 771 * 3;
  FTest := 'Value: ' + Random(27712).ToString + Random(77100).ToString;
end;

procedure TForm771.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum771;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj771_List0 := TMyObj771_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj771_List1 := TMyObj771_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
