...
type
  ...
  TMyObj910_List0 = TObjectList<TMyObj910>;

  TMyObj910_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj910_List1 = TObjectList<TMyObj910_1>;
...
constructor TMyObj910_1.Create;
begin
  inherited;
  FInt := 910 * 3;
  FTest := 'Value: ' + Random(29102).ToString + Random(91000).ToString;
end;

procedure TForm910.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum910;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj910_List0 := TMyObj910_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj910_List1 := TMyObj910_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
