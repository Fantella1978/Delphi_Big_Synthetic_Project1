...
type
  ...
  TMyObj281_List0 = TObjectList<TMyObj281>;

  TMyObj281_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj281_List1 = TObjectList<TMyObj281_1>;
...
constructor TMyObj281_1.Create;
begin
  inherited;
  FInt := 281 * 3;
  FTest := 'Value: ' + Random(22812).ToString + Random(28100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj281_List0 := TMyObj281_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj281_List1 := TMyObj281_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
