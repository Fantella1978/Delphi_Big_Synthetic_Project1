...
type
  ...
  TMyObj541_List0 = TObjectList<TMyObj541>;

  TMyObj541_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj541_List1 = TObjectList<TMyObj541_1>;
...
constructor TMyObj541_1.Create;
begin
  inherited;
  FInt := 541 * 3;
  FTest := 'Value: ' + Random(25412).ToString + Random(54100).ToString;
end;

procedure TForm541.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum541;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj541_List0 := TMyObj541_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj541_List1 := TMyObj541_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
