...
type
  ...
  TMyObj2344_List0 = TObjectList<TMyObj2344>;

  TMyObj2344_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2344_List1 = TObjectList<TMyObj2344_1>;
...
constructor TMyObj2344_1.Create;
begin
  inherited;
  FInt := 2344 * 3;
  FTest := 'Value: ' + Random(223442).ToString + Random(234400).ToString;
end;

procedure TForm2344.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2344;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2344_List0 := TMyObj2344_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2344_List1 := TMyObj2344_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
