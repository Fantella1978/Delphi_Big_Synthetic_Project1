...
type
  ...
  TMyObj1688_List0 = TObjectList<TMyObj1688>;

  TMyObj1688_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1688_List1 = TObjectList<TMyObj1688_1>;
...
constructor TMyObj1688_1.Create;
begin
  inherited;
  FInt := 1688 * 3;
  FTest := 'Value: ' + Random(216882).ToString + Random(168800).ToString;
end;

procedure TForm1688.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1688;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1688_List0 := TMyObj1688_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1688_List1 := TMyObj1688_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
