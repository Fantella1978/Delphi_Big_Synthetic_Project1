...
type
  ...
  TMyObj363_List0 = TObjectList<TMyObj363>;

  TMyObj363_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj363_List1 = TObjectList<TMyObj363_1>;
...
constructor TMyObj363_1.Create;
begin
  inherited;
  FInt := 363 * 3;
  FTest := 'Value: ' + Random(23632).ToString + Random(36300).ToString;
end;

procedure TForm363.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum363;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj363_List0 := TMyObj363_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj363_List1 := TMyObj363_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
