...
type
  ...
  TMyObj405_List0 = TObjectList<TMyObj405>;

  TMyObj405_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj405_List1 = TObjectList<TMyObj405_1>;
...
constructor TMyObj405_1.Create;
begin
  inherited;
  FInt := 405 * 3;
  FTest := 'Value: ' + Random(24052).ToString + Random(40500).ToString;
end;

procedure TForm405.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum405;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj405_List0 := TMyObj405_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj405_List1 := TMyObj405_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
