...
type
  ...
  TMyObj1050_List0 = TObjectList<TMyObj1050>;

  TMyObj1050_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1050_List1 = TObjectList<TMyObj1050_1>;
...
constructor TMyObj1050_1.Create;
begin
  inherited;
  FInt := 1050 * 3;
  FTest := 'Value: ' + Random(210502).ToString + Random(105000).ToString;
end;

procedure TForm1050.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1050;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1050_List0 := TMyObj1050_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1050_List1 := TMyObj1050_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
