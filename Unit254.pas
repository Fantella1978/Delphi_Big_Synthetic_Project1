...
type
  ...
  TMyObj254_List0 = TObjectList<TMyObj254>;

  TMyObj254_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj254_List1 = TObjectList<TMyObj254_1>;
...
constructor TMyObj254_1.Create;
begin
  inherited;
  FInt := 254 * 3;
  FTest := 'Value: ' + Random(22542).ToString + Random(25400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj254_List0 := TMyObj254_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj254_List1 := TMyObj254_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
