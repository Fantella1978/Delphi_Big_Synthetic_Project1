...
type
  ...
  TMyObj665_List0 = TObjectList<TMyObj665>;

  TMyObj665_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj665_List1 = TObjectList<TMyObj665_1>;
...
constructor TMyObj665_1.Create;
begin
  inherited;
  FInt := 665 * 3;
  FTest := 'Value: ' + Random(26652).ToString + Random(66500).ToString;
end;

procedure TForm665.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum665;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj665_List0 := TMyObj665_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj665_List1 := TMyObj665_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
