...
type
  ...
  TMyObj1862_List0 = TObjectList<TMyObj1862>;

  TMyObj1862_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1862_List1 = TObjectList<TMyObj1862_1>;
...
constructor TMyObj1862_1.Create;
begin
  inherited;
  FInt := 1862 * 3;
  FTest := 'Value: ' + Random(218622).ToString + Random(186200).ToString;
end;

procedure TForm1862.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1862;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1862_List0 := TMyObj1862_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1862_List1 := TMyObj1862_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
