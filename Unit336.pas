...
type
  ...
  TMyObj336_List0 = TObjectList<TMyObj336>;

  TMyObj336_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj336_List1 = TObjectList<TMyObj336_1>;
...
constructor TMyObj336_1.Create;
begin
  inherited;
  FInt := 336 * 3;
  FTest := 'Value: ' + Random(23362).ToString + Random(33600).ToString;
end;

procedure TForm336.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum336;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj336_List0 := TMyObj336_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj336_List1 := TMyObj336_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
