...
type
  ...
  TMyObj2454_List0 = TObjectList<TMyObj2454>;

  TMyObj2454_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2454_List1 = TObjectList<TMyObj2454_1>;
...
constructor TMyObj2454_1.Create;
begin
  inherited;
  FInt := 2454 * 3;
  FTest := 'Value: ' + Random(224542).ToString + Random(245400).ToString;
end;

procedure TForm2454.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2454;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2454_List0 := TMyObj2454_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2454_List1 := TMyObj2454_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
