...
type
  ...
  TMyObj1830_List0 = TObjectList<TMyObj1830>;

  TMyObj1830_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1830_List1 = TObjectList<TMyObj1830_1>;
...
constructor TMyObj1830_1.Create;
begin
  inherited;
  FInt := 1830 * 3;
  FTest := 'Value: ' + Random(218302).ToString + Random(183000).ToString;
end;

procedure TForm1830.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1830;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1830_List0 := TMyObj1830_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1830_List1 := TMyObj1830_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
