...
type
  ...
  TMyObj122_List0 = TObjectList<TMyObj122>;

  TMyObj122_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj122_List1 = TObjectList<TMyObj122_1>;
...
constructor TMyObj122_1.Create;
begin
  inherited;
  FInt := 122 * 3;
  FTest := 'Value: ' + Random(21222).ToString + Random(12200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj122_List0 := TMyObj122_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj122_List1 := TMyObj122_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
