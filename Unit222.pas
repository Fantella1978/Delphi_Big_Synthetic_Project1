...
type
  ...
  TMyObj222_List0 = TObjectList<TMyObj222>;

  TMyObj222_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj222_List1 = TObjectList<TMyObj222_1>;
...
constructor TMyObj222_1.Create;
begin
  inherited;
  FInt := 222 * 3;
  FTest := 'Value: ' + Random(22222).ToString + Random(22200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj222_List0 := TMyObj222_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj222_List1 := TMyObj222_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
