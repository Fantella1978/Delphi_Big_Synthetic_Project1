...
type
  ...
  TMyObj1726_List0 = TObjectList<TMyObj1726>;

  TMyObj1726_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1726_List1 = TObjectList<TMyObj1726_1>;
...
constructor TMyObj1726_1.Create;
begin
  inherited;
  FInt := 1726 * 3;
  FTest := 'Value: ' + Random(217262).ToString + Random(172600).ToString;
end;

procedure TForm1726.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1726;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1726_List0 := TMyObj1726_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1726_List1 := TMyObj1726_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
