...
type
  ...
  TMyObj618_List0 = TObjectList<TMyObj618>;

  TMyObj618_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj618_List1 = TObjectList<TMyObj618_1>;
...
constructor TMyObj618_1.Create;
begin
  inherited;
  FInt := 618 * 3;
  FTest := 'Value: ' + Random(26182).ToString + Random(61800).ToString;
end;

procedure TForm618.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum618;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj618_List0 := TMyObj618_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj618_List1 := TMyObj618_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
