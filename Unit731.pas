...
type
  ...
  TMyObj731_List0 = TObjectList<TMyObj731>;

  TMyObj731_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj731_List1 = TObjectList<TMyObj731_1>;
...
constructor TMyObj731_1.Create;
begin
  inherited;
  FInt := 731 * 3;
  FTest := 'Value: ' + Random(27312).ToString + Random(73100).ToString;
end;

procedure TForm731.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum731;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj731_List0 := TMyObj731_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj731_List1 := TMyObj731_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
