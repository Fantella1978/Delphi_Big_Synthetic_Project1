...
type
  ...
  TMyObj1871_List0 = TObjectList<TMyObj1871>;

  TMyObj1871_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1871_List1 = TObjectList<TMyObj1871_1>;
...
constructor TMyObj1871_1.Create;
begin
  inherited;
  FInt := 1871 * 3;
  FTest := 'Value: ' + Random(218712).ToString + Random(187100).ToString;
end;

procedure TForm1871.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1871;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1871_List0 := TMyObj1871_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1871_List1 := TMyObj1871_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
