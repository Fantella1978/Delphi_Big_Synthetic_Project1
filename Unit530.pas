...
type
  ...
  TMyObj530_List0 = TObjectList<TMyObj530>;

  TMyObj530_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj530_List1 = TObjectList<TMyObj530_1>;
...
constructor TMyObj530_1.Create;
begin
  inherited;
  FInt := 530 * 3;
  FTest := 'Value: ' + Random(25302).ToString + Random(53000).ToString;
end;

procedure TForm530.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum530;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj530_List0 := TMyObj530_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj530_List1 := TMyObj530_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
