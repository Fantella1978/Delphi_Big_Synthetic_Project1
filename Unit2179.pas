...
type
  ...
  TMyObj2179_List0 = TObjectList<TMyObj2179>;

  TMyObj2179_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2179_List1 = TObjectList<TMyObj2179_1>;
...
constructor TMyObj2179_1.Create;
begin
  inherited;
  FInt := 2179 * 3;
  FTest := 'Value: ' + Random(221792).ToString + Random(217900).ToString;
end;

procedure TForm2179.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2179;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2179_List0 := TMyObj2179_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2179_List1 := TMyObj2179_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
