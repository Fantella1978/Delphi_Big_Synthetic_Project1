...
type
  ...
  TMyObj1408_List0 = TObjectList<TMyObj1408>;

  TMyObj1408_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1408_List1 = TObjectList<TMyObj1408_1>;
...
constructor TMyObj1408_1.Create;
begin
  inherited;
  FInt := 1408 * 3;
  FTest := 'Value: ' + Random(214082).ToString + Random(140800).ToString;
end;

procedure TForm1408.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1408;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1408_List0 := TMyObj1408_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1408_List1 := TMyObj1408_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
