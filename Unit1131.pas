...
type
  ...
  TMyObj1131_List0 = TObjectList<TMyObj1131>;

  TMyObj1131_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1131_List1 = TObjectList<TMyObj1131_1>;
...
constructor TMyObj1131_1.Create;
begin
  inherited;
  FInt := 1131 * 3;
  FTest := 'Value: ' + Random(211312).ToString + Random(113100).ToString;
end;

procedure TForm1131.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1131;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1131_List0 := TMyObj1131_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1131_List1 := TMyObj1131_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
