...
type
  ...
  TMyObj358_List0 = TObjectList<TMyObj358>;

  TMyObj358_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj358_List1 = TObjectList<TMyObj358_1>;
...
constructor TMyObj358_1.Create;
begin
  inherited;
  FInt := 358 * 3;
  FTest := 'Value: ' + Random(23582).ToString + Random(35800).ToString;
end;

procedure TForm358.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum358;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj358_List0 := TMyObj358_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj358_List1 := TMyObj358_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
