...
type
  ...
  TMyObj1020_List0 = TObjectList<TMyObj1020>;

  TMyObj1020_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1020_List1 = TObjectList<TMyObj1020_1>;
...
constructor TMyObj1020_1.Create;
begin
  inherited;
  FInt := 1020 * 3;
  FTest := 'Value: ' + Random(210202).ToString + Random(102000).ToString;
end;

procedure TForm1020.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1020;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1020_List0 := TMyObj1020_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1020_List1 := TMyObj1020_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
