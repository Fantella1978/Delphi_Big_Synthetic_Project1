...
type
  ...
  TMyObj1285_List0 = TObjectList<TMyObj1285>;

  TMyObj1285_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1285_List1 = TObjectList<TMyObj1285_1>;
...
constructor TMyObj1285_1.Create;
begin
  inherited;
  FInt := 1285 * 3;
  FTest := 'Value: ' + Random(212852).ToString + Random(128500).ToString;
end;

procedure TForm1285.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1285;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1285_List0 := TMyObj1285_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1285_List1 := TMyObj1285_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
