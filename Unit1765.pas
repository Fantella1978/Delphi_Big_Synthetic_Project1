...
type
  ...
  TMyObj1765_List0 = TObjectList<TMyObj1765>;

  TMyObj1765_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1765_List1 = TObjectList<TMyObj1765_1>;
...
constructor TMyObj1765_1.Create;
begin
  inherited;
  FInt := 1765 * 3;
  FTest := 'Value: ' + Random(217652).ToString + Random(176500).ToString;
end;

procedure TForm1765.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1765;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1765_List0 := TMyObj1765_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1765_List1 := TMyObj1765_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
