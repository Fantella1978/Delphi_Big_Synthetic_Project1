...
type
  ...
  TMyObj1852_List0 = TObjectList<TMyObj1852>;

  TMyObj1852_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1852_List1 = TObjectList<TMyObj1852_1>;
...
constructor TMyObj1852_1.Create;
begin
  inherited;
  FInt := 1852 * 3;
  FTest := 'Value: ' + Random(218522).ToString + Random(185200).ToString;
end;

procedure TForm1852.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1852;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1852_List0 := TMyObj1852_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1852_List1 := TMyObj1852_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
