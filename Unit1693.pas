...
type
  ...
  TMyObj1693_List0 = TObjectList<TMyObj1693>;

  TMyObj1693_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1693_List1 = TObjectList<TMyObj1693_1>;
...
constructor TMyObj1693_1.Create;
begin
  inherited;
  FInt := 1693 * 3;
  FTest := 'Value: ' + Random(216932).ToString + Random(169300).ToString;
end;

procedure TForm1693.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1693;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1693_List0 := TMyObj1693_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1693_List1 := TMyObj1693_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
