...
type
  ...
  TMyObj1598_List0 = TObjectList<TMyObj1598>;

  TMyObj1598_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1598_List1 = TObjectList<TMyObj1598_1>;
...
constructor TMyObj1598_1.Create;
begin
  inherited;
  FInt := 1598 * 3;
  FTest := 'Value: ' + Random(215982).ToString + Random(159800).ToString;
end;

procedure TForm1598.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1598;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1598_List0 := TMyObj1598_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1598_List1 := TMyObj1598_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
