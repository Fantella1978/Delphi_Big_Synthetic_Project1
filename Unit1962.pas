...
type
  ...
  TMyObj1962_List0 = TObjectList<TMyObj1962>;

  TMyObj1962_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1962_List1 = TObjectList<TMyObj1962_1>;
...
constructor TMyObj1962_1.Create;
begin
  inherited;
  FInt := 1962 * 3;
  FTest := 'Value: ' + Random(219622).ToString + Random(196200).ToString;
end;

procedure TForm1962.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1962;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1962_List0 := TMyObj1962_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1962_List1 := TMyObj1962_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
