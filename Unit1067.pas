...
type
  ...
  TMyObj1067_List0 = TObjectList<TMyObj1067>;

  TMyObj1067_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1067_List1 = TObjectList<TMyObj1067_1>;
...
constructor TMyObj1067_1.Create;
begin
  inherited;
  FInt := 1067 * 3;
  FTest := 'Value: ' + Random(210672).ToString + Random(106700).ToString;
end;

procedure TForm1067.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1067;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1067_List0 := TMyObj1067_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1067_List1 := TMyObj1067_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
