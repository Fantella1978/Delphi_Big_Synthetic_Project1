...
type
  ...
  TMyObj1792_List0 = TObjectList<TMyObj1792>;

  TMyObj1792_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1792_List1 = TObjectList<TMyObj1792_1>;
...
constructor TMyObj1792_1.Create;
begin
  inherited;
  FInt := 1792 * 3;
  FTest := 'Value: ' + Random(217922).ToString + Random(179200).ToString;
end;

procedure TForm1792.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1792;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1792_List0 := TMyObj1792_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1792_List1 := TMyObj1792_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
