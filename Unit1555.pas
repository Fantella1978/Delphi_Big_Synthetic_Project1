...
type
  ...
  TMyObj1555_List0 = TObjectList<TMyObj1555>;

  TMyObj1555_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1555_List1 = TObjectList<TMyObj1555_1>;
...
constructor TMyObj1555_1.Create;
begin
  inherited;
  FInt := 1555 * 3;
  FTest := 'Value: ' + Random(215552).ToString + Random(155500).ToString;
end;

procedure TForm1555.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1555;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1555_List0 := TMyObj1555_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1555_List1 := TMyObj1555_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
