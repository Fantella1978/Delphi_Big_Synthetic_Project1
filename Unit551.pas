...
type
  ...
  TMyObj551_List0 = TObjectList<TMyObj551>;

  TMyObj551_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj551_List1 = TObjectList<TMyObj551_1>;
...
constructor TMyObj551_1.Create;
begin
  inherited;
  FInt := 551 * 3;
  FTest := 'Value: ' + Random(25512).ToString + Random(55100).ToString;
end;

procedure TForm551.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum551;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj551_List0 := TMyObj551_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj551_List1 := TMyObj551_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
