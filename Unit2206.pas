...
type
  ...
  TMyObj2206_List0 = TObjectList<TMyObj2206>;

  TMyObj2206_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2206_List1 = TObjectList<TMyObj2206_1>;
...
constructor TMyObj2206_1.Create;
begin
  inherited;
  FInt := 2206 * 3;
  FTest := 'Value: ' + Random(222062).ToString + Random(220600).ToString;
end;

procedure TForm2206.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2206;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2206_List0 := TMyObj2206_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2206_List1 := TMyObj2206_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
