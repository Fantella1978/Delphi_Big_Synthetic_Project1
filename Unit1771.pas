...
type
  ...
  TMyObj1771_List0 = TObjectList<TMyObj1771>;

  TMyObj1771_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1771_List1 = TObjectList<TMyObj1771_1>;
...
constructor TMyObj1771_1.Create;
begin
  inherited;
  FInt := 1771 * 3;
  FTest := 'Value: ' + Random(217712).ToString + Random(177100).ToString;
end;

procedure TForm1771.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1771;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1771_List0 := TMyObj1771_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1771_List1 := TMyObj1771_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
