...
type
  ...
  TMyObj730_List0 = TObjectList<TMyObj730>;

  TMyObj730_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj730_List1 = TObjectList<TMyObj730_1>;
...
constructor TMyObj730_1.Create;
begin
  inherited;
  FInt := 730 * 3;
  FTest := 'Value: ' + Random(27302).ToString + Random(73000).ToString;
end;

procedure TForm730.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum730;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj730_List0 := TMyObj730_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj730_List1 := TMyObj730_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
