...
type
  ...
  TMyObj347_List0 = TObjectList<TMyObj347>;

  TMyObj347_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj347_List1 = TObjectList<TMyObj347_1>;
...
constructor TMyObj347_1.Create;
begin
  inherited;
  FInt := 347 * 3;
  FTest := 'Value: ' + Random(23472).ToString + Random(34700).ToString;
end;

procedure TForm347.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum347;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj347_List0 := TMyObj347_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj347_List1 := TMyObj347_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
