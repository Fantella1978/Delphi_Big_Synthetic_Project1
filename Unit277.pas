...
type
  ...
  TMyObj277_List0 = TObjectList<TMyObj277>;

  TMyObj277_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj277_List1 = TObjectList<TMyObj277_1>;
...
constructor TMyObj277_1.Create;
begin
  inherited;
  FInt := 277 * 3;
  FTest := 'Value: ' + Random(22772).ToString + Random(27700).ToString;
end;

procedure TForm277.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum277;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj277_List0 := TMyObj277_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj277_List1 := TMyObj277_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
