...
type
  ...
  TMyObj1094_List0 = TObjectList<TMyObj1094>;

  TMyObj1094_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1094_List1 = TObjectList<TMyObj1094_1>;
...
constructor TMyObj1094_1.Create;
begin
  inherited;
  FInt := 1094 * 3;
  FTest := 'Value: ' + Random(210942).ToString + Random(109400).ToString;
end;

procedure TForm1094.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1094;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1094_List0 := TMyObj1094_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1094_List1 := TMyObj1094_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
