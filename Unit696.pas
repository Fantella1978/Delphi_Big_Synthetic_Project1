...
type
  ...
  TMyObj696_List0 = TObjectList<TMyObj696>;

  TMyObj696_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj696_List1 = TObjectList<TMyObj696_1>;
...
constructor TMyObj696_1.Create;
begin
  inherited;
  FInt := 696 * 3;
  FTest := 'Value: ' + Random(26962).ToString + Random(69600).ToString;
end;

procedure TForm696.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum696;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj696_List0 := TMyObj696_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj696_List1 := TMyObj696_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
