...
type
  ...
  TMyObj1397_List0 = TObjectList<TMyObj1397>;

  TMyObj1397_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1397_List1 = TObjectList<TMyObj1397_1>;
...
constructor TMyObj1397_1.Create;
begin
  inherited;
  FInt := 1397 * 3;
  FTest := 'Value: ' + Random(213972).ToString + Random(139700).ToString;
end;

procedure TForm1397.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1397;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1397_List0 := TMyObj1397_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1397_List1 := TMyObj1397_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
