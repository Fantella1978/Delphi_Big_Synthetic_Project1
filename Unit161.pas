...
type
  ...
  TMyObj161_List0 = TObjectList<TMyObj161>;

  TMyObj161_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj161_List1 = TObjectList<TMyObj161_1>;
...
constructor TMyObj161_1.Create;
begin
  inherited;
  FInt := 161 * 3;
  FTest := 'Value: ' + Random(21612).ToString + Random(16100).ToString;
end;

procedure TForm161.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum161;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj161_List0 := TMyObj161_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj161_List1 := TMyObj161_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
