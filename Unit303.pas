...
type
  ...
  TMyObj303_List0 = TObjectList<TMyObj303>;

  TMyObj303_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj303_List1 = TObjectList<TMyObj303_1>;
...
constructor TMyObj303_1.Create;
begin
  inherited;
  FInt := 303 * 3;
  FTest := 'Value: ' + Random(23032).ToString + Random(30300).ToString;
end;

procedure TForm303.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum303;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj303_List0 := TMyObj303_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj303_List1 := TMyObj303_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
