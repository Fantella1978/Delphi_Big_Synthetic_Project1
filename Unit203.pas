...
type
  ...
  TMyObj203_List0 = TObjectList<TMyObj203>;

  TMyObj203_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj203_List1 = TObjectList<TMyObj203_1>;
...
constructor TMyObj203_1.Create;
begin
  inherited;
  FInt := 203 * 3;
  FTest := 'Value: ' + Random(22032).ToString + Random(20300).ToString;
end;

procedure TForm203.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum203;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj203_List0 := TMyObj203_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj203_List1 := TMyObj203_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
