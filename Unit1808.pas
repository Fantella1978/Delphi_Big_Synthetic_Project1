...
type
  ...
  TMyObj1808_List0 = TObjectList<TMyObj1808>;

  TMyObj1808_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1808_List1 = TObjectList<TMyObj1808_1>;
...
constructor TMyObj1808_1.Create;
begin
  inherited;
  FInt := 1808 * 3;
  FTest := 'Value: ' + Random(218082).ToString + Random(180800).ToString;
end;

procedure TForm1808.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1808;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1808_List0 := TMyObj1808_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1808_List1 := TMyObj1808_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
