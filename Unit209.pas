...
type
  ...
  TMyObj209_List0 = TObjectList<TMyObj209>;

  TMyObj209_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj209_List1 = TObjectList<TMyObj209_1>;
...
constructor TMyObj209_1.Create;
begin
  inherited;
  FInt := 209 * 3;
  FTest := 'Value: ' + Random(22092).ToString + Random(20900).ToString;
end;

procedure TForm209.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum209;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj209_List0 := TMyObj209_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj209_List1 := TMyObj209_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
