...
type
  ...
  TMyObj1226_List0 = TObjectList<TMyObj1226>;

  TMyObj1226_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1226_List1 = TObjectList<TMyObj1226_1>;
...
constructor TMyObj1226_1.Create;
begin
  inherited;
  FInt := 1226 * 3;
  FTest := 'Value: ' + Random(212262).ToString + Random(122600).ToString;
end;

procedure TForm1226.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1226;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1226_List0 := TMyObj1226_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1226_List1 := TMyObj1226_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
