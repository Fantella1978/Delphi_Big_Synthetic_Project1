...
type
  ...
  TMyObj1109_List0 = TObjectList<TMyObj1109>;

  TMyObj1109_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1109_List1 = TObjectList<TMyObj1109_1>;
...
constructor TMyObj1109_1.Create;
begin
  inherited;
  FInt := 1109 * 3;
  FTest := 'Value: ' + Random(211092).ToString + Random(110900).ToString;
end;

procedure TForm1109.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1109;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1109_List0 := TMyObj1109_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1109_List1 := TMyObj1109_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
