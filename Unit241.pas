...
type
  ...
  TMyObj241_List0 = TObjectList<TMyObj241>;

  TMyObj241_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj241_List1 = TObjectList<TMyObj241_1>;
...
constructor TMyObj241_1.Create;
begin
  inherited;
  FInt := 241 * 3;
  FTest := 'Value: ' + Random(22412).ToString + Random(24100).ToString;
end;

procedure TForm241.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum241;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj241_List0 := TMyObj241_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj241_List1 := TMyObj241_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
