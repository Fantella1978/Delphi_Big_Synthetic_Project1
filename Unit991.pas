...
type
  ...
  TMyObj991_List0 = TObjectList<TMyObj991>;

  TMyObj991_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj991_List1 = TObjectList<TMyObj991_1>;
...
constructor TMyObj991_1.Create;
begin
  inherited;
  FInt := 991 * 3;
  FTest := 'Value: ' + Random(29912).ToString + Random(99100).ToString;
end;

procedure TForm991.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum991;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj991_List0 := TMyObj991_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj991_List1 := TMyObj991_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
