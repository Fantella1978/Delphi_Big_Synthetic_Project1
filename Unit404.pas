...
type
  ...
  TMyObj404_List0 = TObjectList<TMyObj404>;

  TMyObj404_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj404_List1 = TObjectList<TMyObj404_1>;
...
constructor TMyObj404_1.Create;
begin
  inherited;
  FInt := 404 * 3;
  FTest := 'Value: ' + Random(24042).ToString + Random(40400).ToString;
end;

procedure TForm404.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum404;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj404_List0 := TMyObj404_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj404_List1 := TMyObj404_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
