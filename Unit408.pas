...
type
  ...
  TMyObj408_List0 = TObjectList<TMyObj408>;

  TMyObj408_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj408_List1 = TObjectList<TMyObj408_1>;
...
constructor TMyObj408_1.Create;
begin
  inherited;
  FInt := 408 * 3;
  FTest := 'Value: ' + Random(24082).ToString + Random(40800).ToString;
end;

procedure TForm408.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum408;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj408_List0 := TMyObj408_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj408_List1 := TMyObj408_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
