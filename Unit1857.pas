...
type
  ...
  TMyObj1857_List0 = TObjectList<TMyObj1857>;

  TMyObj1857_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1857_List1 = TObjectList<TMyObj1857_1>;
...
constructor TMyObj1857_1.Create;
begin
  inherited;
  FInt := 1857 * 3;
  FTest := 'Value: ' + Random(218572).ToString + Random(185700).ToString;
end;

procedure TForm1857.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1857;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1857_List0 := TMyObj1857_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1857_List1 := TMyObj1857_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
