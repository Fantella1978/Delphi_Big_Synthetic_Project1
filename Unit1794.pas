...
type
  ...
  TMyObj1794_List0 = TObjectList<TMyObj1794>;

  TMyObj1794_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1794_List1 = TObjectList<TMyObj1794_1>;
...
constructor TMyObj1794_1.Create;
begin
  inherited;
  FInt := 1794 * 3;
  FTest := 'Value: ' + Random(217942).ToString + Random(179400).ToString;
end;

procedure TForm1794.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1794;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1794_List0 := TMyObj1794_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1794_List1 := TMyObj1794_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
