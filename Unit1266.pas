...
type
  ...
  TMyObj1266_List0 = TObjectList<TMyObj1266>;

  TMyObj1266_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1266_List1 = TObjectList<TMyObj1266_1>;
...
constructor TMyObj1266_1.Create;
begin
  inherited;
  FInt := 1266 * 3;
  FTest := 'Value: ' + Random(212662).ToString + Random(126600).ToString;
end;

procedure TForm1266.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1266;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1266_List0 := TMyObj1266_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1266_List1 := TMyObj1266_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
