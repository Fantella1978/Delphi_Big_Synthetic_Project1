...
type
  ...
  TMyObj897_List0 = TObjectList<TMyObj897>;

  TMyObj897_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj897_List1 = TObjectList<TMyObj897_1>;
...
constructor TMyObj897_1.Create;
begin
  inherited;
  FInt := 897 * 3;
  FTest := 'Value: ' + Random(28972).ToString + Random(89700).ToString;
end;

procedure TForm897.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum897;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj897_List0 := TMyObj897_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj897_List1 := TMyObj897_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
