...
type
  ...
  TMyObj1328_List0 = TObjectList<TMyObj1328>;

  TMyObj1328_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1328_List1 = TObjectList<TMyObj1328_1>;
...
constructor TMyObj1328_1.Create;
begin
  inherited;
  FInt := 1328 * 3;
  FTest := 'Value: ' + Random(213282).ToString + Random(132800).ToString;
end;

procedure TForm1328.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1328;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1328_List0 := TMyObj1328_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1328_List1 := TMyObj1328_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
