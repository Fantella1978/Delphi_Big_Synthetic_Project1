...
type
  ...
  TMyObj2481_List0 = TObjectList<TMyObj2481>;

  TMyObj2481_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2481_List1 = TObjectList<TMyObj2481_1>;
...
constructor TMyObj2481_1.Create;
begin
  inherited;
  FInt := 2481 * 3;
  FTest := 'Value: ' + Random(224812).ToString + Random(248100).ToString;
end;

procedure TForm2481.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2481;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2481_List0 := TMyObj2481_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2481_List1 := TMyObj2481_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
