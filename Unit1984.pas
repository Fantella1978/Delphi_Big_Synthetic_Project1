...
type
  ...
  TMyObj1984_List0 = TObjectList<TMyObj1984>;

  TMyObj1984_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1984_List1 = TObjectList<TMyObj1984_1>;
...
constructor TMyObj1984_1.Create;
begin
  inherited;
  FInt := 1984 * 3;
  FTest := 'Value: ' + Random(219842).ToString + Random(198400).ToString;
end;

procedure TForm1984.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1984;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1984_List0 := TMyObj1984_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1984_List1 := TMyObj1984_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
