...
type
  ...
  TMyObj1566_List0 = TObjectList<TMyObj1566>;

  TMyObj1566_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1566_List1 = TObjectList<TMyObj1566_1>;
...
constructor TMyObj1566_1.Create;
begin
  inherited;
  FInt := 1566 * 3;
  FTest := 'Value: ' + Random(215662).ToString + Random(156600).ToString;
end;

procedure TForm1566.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1566;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1566_List0 := TMyObj1566_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1566_List1 := TMyObj1566_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
