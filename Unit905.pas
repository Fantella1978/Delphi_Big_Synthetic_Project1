...
type
  ...
  TMyObj905_List0 = TObjectList<TMyObj905>;

  TMyObj905_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj905_List1 = TObjectList<TMyObj905_1>;
...
constructor TMyObj905_1.Create;
begin
  inherited;
  FInt := 905 * 3;
  FTest := 'Value: ' + Random(29052).ToString + Random(90500).ToString;
end;

procedure TForm905.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum905;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj905_List0 := TMyObj905_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj905_List1 := TMyObj905_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
