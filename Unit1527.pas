...
type
  ...
  TMyObj1527_List0 = TObjectList<TMyObj1527>;

  TMyObj1527_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1527_List1 = TObjectList<TMyObj1527_1>;
...
constructor TMyObj1527_1.Create;
begin
  inherited;
  FInt := 1527 * 3;
  FTest := 'Value: ' + Random(215272).ToString + Random(152700).ToString;
end;

procedure TForm1527.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1527;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1527_List0 := TMyObj1527_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1527_List1 := TMyObj1527_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
