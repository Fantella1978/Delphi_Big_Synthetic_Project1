...
type
  ...
  TMyObj692_List0 = TObjectList<TMyObj692>;

  TMyObj692_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj692_List1 = TObjectList<TMyObj692_1>;
...
constructor TMyObj692_1.Create;
begin
  inherited;
  FInt := 692 * 3;
  FTest := 'Value: ' + Random(26922).ToString + Random(69200).ToString;
end;

procedure TForm692.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum692;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj692_List0 := TMyObj692_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj692_List1 := TMyObj692_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
