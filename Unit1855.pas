...
type
  ...
  TMyObj1855_List0 = TObjectList<TMyObj1855>;

  TMyObj1855_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1855_List1 = TObjectList<TMyObj1855_1>;
...
constructor TMyObj1855_1.Create;
begin
  inherited;
  FInt := 1855 * 3;
  FTest := 'Value: ' + Random(218552).ToString + Random(185500).ToString;
end;

procedure TForm1855.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1855;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1855_List0 := TMyObj1855_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1855_List1 := TMyObj1855_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
