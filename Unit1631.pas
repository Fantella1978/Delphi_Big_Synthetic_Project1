...
type
  ...
  TMyObj1631_List0 = TObjectList<TMyObj1631>;

  TMyObj1631_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1631_List1 = TObjectList<TMyObj1631_1>;
...
constructor TMyObj1631_1.Create;
begin
  inherited;
  FInt := 1631 * 3;
  FTest := 'Value: ' + Random(216312).ToString + Random(163100).ToString;
end;

procedure TForm1631.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1631;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1631_List0 := TMyObj1631_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1631_List1 := TMyObj1631_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
