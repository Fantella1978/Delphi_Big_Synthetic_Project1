...
type
  ...
  TMyObj438_List0 = TObjectList<TMyObj438>;

  TMyObj438_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj438_List1 = TObjectList<TMyObj438_1>;
...
constructor TMyObj438_1.Create;
begin
  inherited;
  FInt := 438 * 3;
  FTest := 'Value: ' + Random(24382).ToString + Random(43800).ToString;
end;

procedure TForm438.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum438;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj438_List0 := TMyObj438_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj438_List1 := TMyObj438_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
