...
type
  ...
  TMyObj79_List0 = TObjectList<TMyObj79>;

  TMyObj79_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj79_List1 = TObjectList<TMyObj79_1>;
...
constructor TMyObj79_1.Create;
begin
  inherited;
  FInt := 79 * 3;
  FTest := 'Value: ' + Random(2792).ToString + Random(7900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj79_List0 := TMyObj79_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj79_List1 := TMyObj79_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
