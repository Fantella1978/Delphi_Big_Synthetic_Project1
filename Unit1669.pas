...
type
  ...
  TMyObj1669_List0 = TObjectList<TMyObj1669>;

  TMyObj1669_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1669_List1 = TObjectList<TMyObj1669_1>;
...
constructor TMyObj1669_1.Create;
begin
  inherited;
  FInt := 1669 * 3;
  FTest := 'Value: ' + Random(216692).ToString + Random(166900).ToString;
end;

procedure TForm1669.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1669;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1669_List0 := TMyObj1669_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1669_List1 := TMyObj1669_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
