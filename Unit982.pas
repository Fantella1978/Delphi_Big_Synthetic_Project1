...
type
  ...
  TMyObj982_List0 = TObjectList<TMyObj982>;

  TMyObj982_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj982_List1 = TObjectList<TMyObj982_1>;
...
constructor TMyObj982_1.Create;
begin
  inherited;
  FInt := 982 * 3;
  FTest := 'Value: ' + Random(29822).ToString + Random(98200).ToString;
end;

procedure TForm982.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum982;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj982_List0 := TMyObj982_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj982_List1 := TMyObj982_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
