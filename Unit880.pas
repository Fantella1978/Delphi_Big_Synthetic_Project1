...
type
  ...
  TMyObj880_List0 = TObjectList<TMyObj880>;

  TMyObj880_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj880_List1 = TObjectList<TMyObj880_1>;
...
constructor TMyObj880_1.Create;
begin
  inherited;
  FInt := 880 * 3;
  FTest := 'Value: ' + Random(28802).ToString + Random(88000).ToString;
end;

procedure TForm880.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum880;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj880_List0 := TMyObj880_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj880_List1 := TMyObj880_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
