...
type
  ...
  TMyObj2234_List0 = TObjectList<TMyObj2234>;

  TMyObj2234_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2234_List1 = TObjectList<TMyObj2234_1>;
...
constructor TMyObj2234_1.Create;
begin
  inherited;
  FInt := 2234 * 3;
  FTest := 'Value: ' + Random(222342).ToString + Random(223400).ToString;
end;

procedure TForm2234.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2234;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2234_List0 := TMyObj2234_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2234_List1 := TMyObj2234_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
