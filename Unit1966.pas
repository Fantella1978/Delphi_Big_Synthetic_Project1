...
type
  ...
  TMyObj1966_List0 = TObjectList<TMyObj1966>;

  TMyObj1966_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1966_List1 = TObjectList<TMyObj1966_1>;
...
constructor TMyObj1966_1.Create;
begin
  inherited;
  FInt := 1966 * 3;
  FTest := 'Value: ' + Random(219662).ToString + Random(196600).ToString;
end;

procedure TForm1966.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1966;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1966_List0 := TMyObj1966_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1966_List1 := TMyObj1966_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
