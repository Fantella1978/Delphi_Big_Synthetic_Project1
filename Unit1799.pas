...
type
  ...
  TMyObj1799_List0 = TObjectList<TMyObj1799>;

  TMyObj1799_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1799_List1 = TObjectList<TMyObj1799_1>;
...
constructor TMyObj1799_1.Create;
begin
  inherited;
  FInt := 1799 * 3;
  FTest := 'Value: ' + Random(217992).ToString + Random(179900).ToString;
end;

procedure TForm1799.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1799;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1799_List0 := TMyObj1799_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1799_List1 := TMyObj1799_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
