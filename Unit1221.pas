...
type
  ...
  TMyObj1221_List0 = TObjectList<TMyObj1221>;

  TMyObj1221_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1221_List1 = TObjectList<TMyObj1221_1>;
...
constructor TMyObj1221_1.Create;
begin
  inherited;
  FInt := 1221 * 3;
  FTest := 'Value: ' + Random(212212).ToString + Random(122100).ToString;
end;

procedure TForm1221.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1221;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1221_List0 := TMyObj1221_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1221_List1 := TMyObj1221_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
