...
type
  ...
  TMyObj2486_List0 = TObjectList<TMyObj2486>;

  TMyObj2486_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2486_List1 = TObjectList<TMyObj2486_1>;
...
constructor TMyObj2486_1.Create;
begin
  inherited;
  FInt := 2486 * 3;
  FTest := 'Value: ' + Random(224862).ToString + Random(248600).ToString;
end;

procedure TForm2486.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2486;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2486_List0 := TMyObj2486_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2486_List1 := TMyObj2486_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
