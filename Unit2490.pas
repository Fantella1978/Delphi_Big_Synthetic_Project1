...
type
  ...
  TMyObj2490_List0 = TObjectList<TMyObj2490>;

  TMyObj2490_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2490_List1 = TObjectList<TMyObj2490_1>;
...
constructor TMyObj2490_1.Create;
begin
  inherited;
  FInt := 2490 * 3;
  FTest := 'Value: ' + Random(224902).ToString + Random(249000).ToString;
end;

procedure TForm2490.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2490;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2490_List0 := TMyObj2490_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2490_List1 := TMyObj2490_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
