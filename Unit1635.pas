...
type
  ...
  TMyObj1635_List0 = TObjectList<TMyObj1635>;

  TMyObj1635_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1635_List1 = TObjectList<TMyObj1635_1>;
...
constructor TMyObj1635_1.Create;
begin
  inherited;
  FInt := 1635 * 3;
  FTest := 'Value: ' + Random(216352).ToString + Random(163500).ToString;
end;

procedure TForm1635.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1635;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1635_List0 := TMyObj1635_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1635_List1 := TMyObj1635_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
