...
type
  ...
  TMyObj2395_List0 = TObjectList<TMyObj2395>;

  TMyObj2395_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2395_List1 = TObjectList<TMyObj2395_1>;
...
constructor TMyObj2395_1.Create;
begin
  inherited;
  FInt := 2395 * 3;
  FTest := 'Value: ' + Random(223952).ToString + Random(239500).ToString;
end;

procedure TForm2395.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2395;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2395_List0 := TMyObj2395_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2395_List1 := TMyObj2395_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
