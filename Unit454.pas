...
type
  ...
  TMyObj454_List0 = TObjectList<TMyObj454>;

  TMyObj454_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj454_List1 = TObjectList<TMyObj454_1>;
...
constructor TMyObj454_1.Create;
begin
  inherited;
  FInt := 454 * 3;
  FTest := 'Value: ' + Random(24542).ToString + Random(45400).ToString;
end;

procedure TForm454.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum454;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj454_List0 := TMyObj454_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj454_List1 := TMyObj454_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
