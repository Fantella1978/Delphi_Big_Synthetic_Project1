...
type
  ...
  TMyObj819_List0 = TObjectList<TMyObj819>;

  TMyObj819_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj819_List1 = TObjectList<TMyObj819_1>;
...
constructor TMyObj819_1.Create;
begin
  inherited;
  FInt := 819 * 3;
  FTest := 'Value: ' + Random(28192).ToString + Random(81900).ToString;
end;

procedure TForm819.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum819;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj819_List0 := TMyObj819_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj819_List1 := TMyObj819_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
