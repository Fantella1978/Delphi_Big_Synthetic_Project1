...
type
  ...
  TMyObj2311_List0 = TObjectList<TMyObj2311>;

  TMyObj2311_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2311_List1 = TObjectList<TMyObj2311_1>;
...
constructor TMyObj2311_1.Create;
begin
  inherited;
  FInt := 2311 * 3;
  FTest := 'Value: ' + Random(223112).ToString + Random(231100).ToString;
end;

procedure TForm2311.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2311;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2311_List0 := TMyObj2311_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2311_List1 := TMyObj2311_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
