...
type
  ...
  TMyObj1387_List0 = TObjectList<TMyObj1387>;

  TMyObj1387_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1387_List1 = TObjectList<TMyObj1387_1>;
...
constructor TMyObj1387_1.Create;
begin
  inherited;
  FInt := 1387 * 3;
  FTest := 'Value: ' + Random(213872).ToString + Random(138700).ToString;
end;

procedure TForm1387.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1387;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1387_List0 := TMyObj1387_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1387_List1 := TMyObj1387_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
