...
type
  ...
  TMyObj1822_List0 = TObjectList<TMyObj1822>;

  TMyObj1822_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1822_List1 = TObjectList<TMyObj1822_1>;
...
constructor TMyObj1822_1.Create;
begin
  inherited;
  FInt := 1822 * 3;
  FTest := 'Value: ' + Random(218222).ToString + Random(182200).ToString;
end;

procedure TForm1822.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1822;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1822_List0 := TMyObj1822_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1822_List1 := TMyObj1822_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
