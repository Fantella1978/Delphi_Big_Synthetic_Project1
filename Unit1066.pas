...
type
  ...
  TMyObj1066_List0 = TObjectList<TMyObj1066>;

  TMyObj1066_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1066_List1 = TObjectList<TMyObj1066_1>;
...
constructor TMyObj1066_1.Create;
begin
  inherited;
  FInt := 1066 * 3;
  FTest := 'Value: ' + Random(210662).ToString + Random(106600).ToString;
end;

procedure TForm1066.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1066;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1066_List0 := TMyObj1066_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1066_List1 := TMyObj1066_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
