...
type
  ...
  TMyObj230_List0 = TObjectList<TMyObj230>;

  TMyObj230_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj230_List1 = TObjectList<TMyObj230_1>;
...
constructor TMyObj230_1.Create;
begin
  inherited;
  FInt := 230 * 3;
  FTest := 'Value: ' + Random(22302).ToString + Random(23000).ToString;
end;

procedure TForm230.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum230;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj230_List0 := TMyObj230_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj230_List1 := TMyObj230_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
