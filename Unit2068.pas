...
type
  ...
  TMyObj2068_List0 = TObjectList<TMyObj2068>;

  TMyObj2068_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2068_List1 = TObjectList<TMyObj2068_1>;
...
constructor TMyObj2068_1.Create;
begin
  inherited;
  FInt := 2068 * 3;
  FTest := 'Value: ' + Random(220682).ToString + Random(206800).ToString;
end;

procedure TForm2068.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2068;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2068_List0 := TMyObj2068_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2068_List1 := TMyObj2068_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
