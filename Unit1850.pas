...
type
  ...
  TMyObj1850_List0 = TObjectList<TMyObj1850>;

  TMyObj1850_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1850_List1 = TObjectList<TMyObj1850_1>;
...
constructor TMyObj1850_1.Create;
begin
  inherited;
  FInt := 1850 * 3;
  FTest := 'Value: ' + Random(218502).ToString + Random(185000).ToString;
end;

procedure TForm1850.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1850;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1850_List0 := TMyObj1850_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1850_List1 := TMyObj1850_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
