...
type
  ...
  TMyObj1403_List0 = TObjectList<TMyObj1403>;

  TMyObj1403_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1403_List1 = TObjectList<TMyObj1403_1>;
...
constructor TMyObj1403_1.Create;
begin
  inherited;
  FInt := 1403 * 3;
  FTest := 'Value: ' + Random(214032).ToString + Random(140300).ToString;
end;

procedure TForm1403.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1403;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1403_List0 := TMyObj1403_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1403_List1 := TMyObj1403_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
