...
type
  ...
  TMyObj1648_List0 = TObjectList<TMyObj1648>;

  TMyObj1648_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1648_List1 = TObjectList<TMyObj1648_1>;
...
constructor TMyObj1648_1.Create;
begin
  inherited;
  FInt := 1648 * 3;
  FTest := 'Value: ' + Random(216482).ToString + Random(164800).ToString;
end;

procedure TForm1648.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1648;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1648_List0 := TMyObj1648_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1648_List1 := TMyObj1648_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
