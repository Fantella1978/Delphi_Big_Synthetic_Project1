...
type
  ...
  TMyObj2347_List0 = TObjectList<TMyObj2347>;

  TMyObj2347_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2347_List1 = TObjectList<TMyObj2347_1>;
...
constructor TMyObj2347_1.Create;
begin
  inherited;
  FInt := 2347 * 3;
  FTest := 'Value: ' + Random(223472).ToString + Random(234700).ToString;
end;

procedure TForm2347.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2347;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2347_List0 := TMyObj2347_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2347_List1 := TMyObj2347_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
