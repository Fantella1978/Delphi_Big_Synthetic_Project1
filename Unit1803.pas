...
type
  ...
  TMyObj1803_List0 = TObjectList<TMyObj1803>;

  TMyObj1803_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1803_List1 = TObjectList<TMyObj1803_1>;
...
constructor TMyObj1803_1.Create;
begin
  inherited;
  FInt := 1803 * 3;
  FTest := 'Value: ' + Random(218032).ToString + Random(180300).ToString;
end;

procedure TForm1803.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1803;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1803_List0 := TMyObj1803_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1803_List1 := TMyObj1803_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
