...
type
  ...
  TMyObj5_List0 = TObjectList<TMyObj5>;

  TMyObj5_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj5_List1 = TObjectList<TMyObj5_1>;
...
constructor TMyObj5_1.Create;
begin
  inherited;
  FInt := 5 * 3;
  FTest := 'Value: ' + Random(252).ToString + Random(500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(50).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(55).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(57).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj5_List0 := TMyObj5_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj5_List1 := TMyObj5_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
