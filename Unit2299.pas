...
type
  ...
  TMyObj2299_List0 = TObjectList<TMyObj2299>;

  TMyObj2299_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2299_List1 = TObjectList<TMyObj2299_1>;
...
constructor TMyObj2299_1.Create;
begin
  inherited;
  FInt := 2299 * 3;
  FTest := 'Value: ' + Random(222992).ToString + Random(229900).ToString;
end;

procedure TForm2299.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2299;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2299_List0 := TMyObj2299_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2299_List1 := TMyObj2299_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
