...
type
  ...
  TMyObj854_List0 = TObjectList<TMyObj854>;

  TMyObj854_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj854_List1 = TObjectList<TMyObj854_1>;
...
constructor TMyObj854_1.Create;
begin
  inherited;
  FInt := 854 * 3;
  FTest := 'Value: ' + Random(28542).ToString + Random(85400).ToString;
end;

procedure TForm854.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum854;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj854_List0 := TMyObj854_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj854_List1 := TMyObj854_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
