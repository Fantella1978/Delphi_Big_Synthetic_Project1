...
type
  ...
  TMyObj105_List0 = TObjectList<TMyObj105>;

  TMyObj105_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj105_List1 = TObjectList<TMyObj105_1>;
...
constructor TMyObj105_1.Create;
begin
  inherited;
  FInt := 105 * 3;
  FTest := 'Value: ' + Random(21052).ToString + Random(10500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj105_List0 := TMyObj105_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj105_List1 := TMyObj105_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
