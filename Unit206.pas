...
type
  ...
  TMyObj206_List0 = TObjectList<TMyObj206>;

  TMyObj206_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj206_List1 = TObjectList<TMyObj206_1>;
...
constructor TMyObj206_1.Create;
begin
  inherited;
  FInt := 206 * 3;
  FTest := 'Value: ' + Random(22062).ToString + Random(20600).ToString;
end;

procedure TForm206.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum206;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj206_List0 := TMyObj206_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj206_List1 := TMyObj206_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
