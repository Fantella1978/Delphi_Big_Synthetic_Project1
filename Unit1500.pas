...
type
  ...
  TMyObj1500_List0 = TObjectList<TMyObj1500>;

  TMyObj1500_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1500_List1 = TObjectList<TMyObj1500_1>;
...
constructor TMyObj1500_1.Create;
begin
  inherited;
  FInt := 1500 * 3;
  FTest := 'Value: ' + Random(215002).ToString + Random(150000).ToString;
end;

procedure TForm1500.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1500;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1500_List0 := TMyObj1500_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1500_List1 := TMyObj1500_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
