...
type
  ...
  TMyObj1417_List0 = TObjectList<TMyObj1417>;

  TMyObj1417_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1417_List1 = TObjectList<TMyObj1417_1>;
...
constructor TMyObj1417_1.Create;
begin
  inherited;
  FInt := 1417 * 3;
  FTest := 'Value: ' + Random(214172).ToString + Random(141700).ToString;
end;

procedure TForm1417.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1417;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1417_List0 := TMyObj1417_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1417_List1 := TMyObj1417_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
