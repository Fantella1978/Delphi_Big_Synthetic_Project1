...
type
  ...
  TMyObj102_List0 = TObjectList<TMyObj102>;

  TMyObj102_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj102_List1 = TObjectList<TMyObj102_1>;
...
constructor TMyObj102_1.Create;
begin
  inherited;
  FInt := 102 * 3;
  FTest := 'Value: ' + Random(21022).ToString + Random(10200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj102_List0 := TMyObj102_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj102_List1 := TMyObj102_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
