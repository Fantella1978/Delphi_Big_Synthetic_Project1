...
type
  ...
  TMyObj1769_List0 = TObjectList<TMyObj1769>;

  TMyObj1769_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1769_List1 = TObjectList<TMyObj1769_1>;
...
constructor TMyObj1769_1.Create;
begin
  inherited;
  FInt := 1769 * 3;
  FTest := 'Value: ' + Random(217692).ToString + Random(176900).ToString;
end;

procedure TForm1769.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1769;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1769_List0 := TMyObj1769_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1769_List1 := TMyObj1769_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
