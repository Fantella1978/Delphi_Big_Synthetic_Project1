...
type
  ...
  TMyObj1097_List0 = TObjectList<TMyObj1097>;

  TMyObj1097_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1097_List1 = TObjectList<TMyObj1097_1>;
...
constructor TMyObj1097_1.Create;
begin
  inherited;
  FInt := 1097 * 3;
  FTest := 'Value: ' + Random(210972).ToString + Random(109700).ToString;
end;

procedure TForm1097.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1097;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1097_List0 := TMyObj1097_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1097_List1 := TMyObj1097_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
