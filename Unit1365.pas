...
type
  ...
  TMyObj1365_List0 = TObjectList<TMyObj1365>;

  TMyObj1365_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1365_List1 = TObjectList<TMyObj1365_1>;
...
constructor TMyObj1365_1.Create;
begin
  inherited;
  FInt := 1365 * 3;
  FTest := 'Value: ' + Random(213652).ToString + Random(136500).ToString;
end;

procedure TForm1365.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1365;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1365_List0 := TMyObj1365_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1365_List1 := TMyObj1365_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
