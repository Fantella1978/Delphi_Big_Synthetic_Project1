...
type
  ...
  TMyObj22_List0 = TObjectList<TMyObj22>;

  TMyObj22_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj22_List1 = TObjectList<TMyObj22_1>;
...
constructor TMyObj22_1.Create;
begin
  inherited;
  FInt := 22 * 3;
  FTest := 'Value: ' + Random(2222).ToString + Random(2200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj22_List0 := TMyObj22_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj22_List1 := TMyObj22_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
