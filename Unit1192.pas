...
type
  ...
  TMyObj1192_List0 = TObjectList<TMyObj1192>;

  TMyObj1192_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1192_List1 = TObjectList<TMyObj1192_1>;
...
constructor TMyObj1192_1.Create;
begin
  inherited;
  FInt := 1192 * 3;
  FTest := 'Value: ' + Random(211922).ToString + Random(119200).ToString;
end;

procedure TForm1192.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1192;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1192_List0 := TMyObj1192_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1192_List1 := TMyObj1192_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
