...
type
  ...
  TMyObj1118_List0 = TObjectList<TMyObj1118>;

  TMyObj1118_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1118_List1 = TObjectList<TMyObj1118_1>;
...
constructor TMyObj1118_1.Create;
begin
  inherited;
  FInt := 1118 * 3;
  FTest := 'Value: ' + Random(211182).ToString + Random(111800).ToString;
end;

procedure TForm1118.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1118;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1118_List0 := TMyObj1118_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1118_List1 := TMyObj1118_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
