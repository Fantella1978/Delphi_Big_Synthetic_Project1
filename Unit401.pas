...
type
  ...
  TMyObj401_List0 = TObjectList<TMyObj401>;

  TMyObj401_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj401_List1 = TObjectList<TMyObj401_1>;
...
constructor TMyObj401_1.Create;
begin
  inherited;
  FInt := 401 * 3;
  FTest := 'Value: ' + Random(24012).ToString + Random(40100).ToString;
end;

procedure TForm401.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum401;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj401_List0 := TMyObj401_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj401_List1 := TMyObj401_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
