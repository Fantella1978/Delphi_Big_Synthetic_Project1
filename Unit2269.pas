...
type
  ...
  TMyObj2269_List0 = TObjectList<TMyObj2269>;

  TMyObj2269_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2269_List1 = TObjectList<TMyObj2269_1>;
...
constructor TMyObj2269_1.Create;
begin
  inherited;
  FInt := 2269 * 3;
  FTest := 'Value: ' + Random(222692).ToString + Random(226900).ToString;
end;

procedure TForm2269.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2269;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2269_List0 := TMyObj2269_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2269_List1 := TMyObj2269_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
