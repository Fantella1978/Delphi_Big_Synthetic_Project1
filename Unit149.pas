...
type
  ...
  TMyObj149_List0 = TObjectList<TMyObj149>;

  TMyObj149_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj149_List1 = TObjectList<TMyObj149_1>;
...
constructor TMyObj149_1.Create;
begin
  inherited;
  FInt := 149 * 3;
  FTest := 'Value: ' + Random(21492).ToString + Random(14900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj149_List0 := TMyObj149_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj149_List1 := TMyObj149_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
