...
type
  ...
  TMyObj1464_List0 = TObjectList<TMyObj1464>;

  TMyObj1464_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1464_List1 = TObjectList<TMyObj1464_1>;
...
constructor TMyObj1464_1.Create;
begin
  inherited;
  FInt := 1464 * 3;
  FTest := 'Value: ' + Random(214642).ToString + Random(146400).ToString;
end;

procedure TForm1464.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1464;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1464_List0 := TMyObj1464_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1464_List1 := TMyObj1464_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
