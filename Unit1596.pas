...
type
  ...
  TMyObj1596_List0 = TObjectList<TMyObj1596>;

  TMyObj1596_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1596_List1 = TObjectList<TMyObj1596_1>;
...
constructor TMyObj1596_1.Create;
begin
  inherited;
  FInt := 1596 * 3;
  FTest := 'Value: ' + Random(215962).ToString + Random(159600).ToString;
end;

procedure TForm1596.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1596;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1596_List0 := TMyObj1596_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1596_List1 := TMyObj1596_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
