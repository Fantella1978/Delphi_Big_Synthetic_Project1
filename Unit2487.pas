...
type
  ...
  TMyObj2487_List0 = TObjectList<TMyObj2487>;

  TMyObj2487_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2487_List1 = TObjectList<TMyObj2487_1>;
...
constructor TMyObj2487_1.Create;
begin
  inherited;
  FInt := 2487 * 3;
  FTest := 'Value: ' + Random(224872).ToString + Random(248700).ToString;
end;

procedure TForm2487.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2487;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2487_List0 := TMyObj2487_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2487_List1 := TMyObj2487_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
