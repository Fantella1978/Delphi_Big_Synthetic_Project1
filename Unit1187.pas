...
type
  ...
  TMyObj1187_List0 = TObjectList<TMyObj1187>;

  TMyObj1187_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1187_List1 = TObjectList<TMyObj1187_1>;
...
constructor TMyObj1187_1.Create;
begin
  inherited;
  FInt := 1187 * 3;
  FTest := 'Value: ' + Random(211872).ToString + Random(118700).ToString;
end;

procedure TForm1187.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1187;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1187_List0 := TMyObj1187_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1187_List1 := TMyObj1187_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
