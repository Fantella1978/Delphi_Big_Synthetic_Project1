...
type
  ...
  TMyObj590_List0 = TObjectList<TMyObj590>;

  TMyObj590_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj590_List1 = TObjectList<TMyObj590_1>;
...
constructor TMyObj590_1.Create;
begin
  inherited;
  FInt := 590 * 3;
  FTest := 'Value: ' + Random(25902).ToString + Random(59000).ToString;
end;

procedure TForm590.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum590;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj590_List0 := TMyObj590_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj590_List1 := TMyObj590_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
