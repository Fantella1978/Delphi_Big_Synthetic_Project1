...
type
  ...
  TMyObj1638_List0 = TObjectList<TMyObj1638>;

  TMyObj1638_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1638_List1 = TObjectList<TMyObj1638_1>;
...
constructor TMyObj1638_1.Create;
begin
  inherited;
  FInt := 1638 * 3;
  FTest := 'Value: ' + Random(216382).ToString + Random(163800).ToString;
end;

procedure TForm1638.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1638;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1638_List0 := TMyObj1638_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1638_List1 := TMyObj1638_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
