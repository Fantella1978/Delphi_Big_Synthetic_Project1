...
type
  ...
  TMyObj1482_List0 = TObjectList<TMyObj1482>;

  TMyObj1482_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1482_List1 = TObjectList<TMyObj1482_1>;
...
constructor TMyObj1482_1.Create;
begin
  inherited;
  FInt := 1482 * 3;
  FTest := 'Value: ' + Random(214822).ToString + Random(148200).ToString;
end;

procedure TForm1482.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1482;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1482_List0 := TMyObj1482_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1482_List1 := TMyObj1482_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
