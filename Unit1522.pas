...
type
  ...
  TMyObj1522_List0 = TObjectList<TMyObj1522>;

  TMyObj1522_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1522_List1 = TObjectList<TMyObj1522_1>;
...
constructor TMyObj1522_1.Create;
begin
  inherited;
  FInt := 1522 * 3;
  FTest := 'Value: ' + Random(215222).ToString + Random(152200).ToString;
end;

procedure TForm1522.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1522;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1522_List0 := TMyObj1522_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1522_List1 := TMyObj1522_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
