...
type
  ...
  TMyObj1999_List0 = TObjectList<TMyObj1999>;

  TMyObj1999_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1999_List1 = TObjectList<TMyObj1999_1>;
...
constructor TMyObj1999_1.Create;
begin
  inherited;
  FInt := 1999 * 3;
  FTest := 'Value: ' + Random(219992).ToString + Random(199900).ToString;
end;

procedure TForm1999.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1999;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1999_List0 := TMyObj1999_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1999_List1 := TMyObj1999_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
