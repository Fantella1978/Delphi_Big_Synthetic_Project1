...
type
  ...
  TMyObj1002_List0 = TObjectList<TMyObj1002>;

  TMyObj1002_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1002_List1 = TObjectList<TMyObj1002_1>;
...
constructor TMyObj1002_1.Create;
begin
  inherited;
  FInt := 1002 * 3;
  FTest := 'Value: ' + Random(210022).ToString + Random(100200).ToString;
end;

procedure TForm1002.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1002;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1002_List0 := TMyObj1002_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1002_List1 := TMyObj1002_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
