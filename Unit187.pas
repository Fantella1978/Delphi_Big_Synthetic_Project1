...
type
  ...
  TMyObj187_List0 = TObjectList<TMyObj187>;

  TMyObj187_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj187_List1 = TObjectList<TMyObj187_1>;
...
constructor TMyObj187_1.Create;
begin
  inherited;
  FInt := 187 * 3;
  FTest := 'Value: ' + Random(21872).ToString + Random(18700).ToString;
end;

procedure TForm187.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum187;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj187_List0 := TMyObj187_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj187_List1 := TMyObj187_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
