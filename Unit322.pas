...
type
  ...
  TMyObj322_List0 = TObjectList<TMyObj322>;

  TMyObj322_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj322_List1 = TObjectList<TMyObj322_1>;
...
constructor TMyObj322_1.Create;
begin
  inherited;
  FInt := 322 * 3;
  FTest := 'Value: ' + Random(23222).ToString + Random(32200).ToString;
end;

procedure TForm322.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum322;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj322_List0 := TMyObj322_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj322_List1 := TMyObj322_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
