...
type
  ...
  TMyObj1568_List0 = TObjectList<TMyObj1568>;

  TMyObj1568_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1568_List1 = TObjectList<TMyObj1568_1>;
...
constructor TMyObj1568_1.Create;
begin
  inherited;
  FInt := 1568 * 3;
  FTest := 'Value: ' + Random(215682).ToString + Random(156800).ToString;
end;

procedure TForm1568.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1568;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1568_List0 := TMyObj1568_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1568_List1 := TMyObj1568_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
