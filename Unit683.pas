...
type
  ...
  TMyObj683_List0 = TObjectList<TMyObj683>;

  TMyObj683_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj683_List1 = TObjectList<TMyObj683_1>;
...
constructor TMyObj683_1.Create;
begin
  inherited;
  FInt := 683 * 3;
  FTest := 'Value: ' + Random(26832).ToString + Random(68300).ToString;
end;

procedure TForm683.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum683;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj683_List0 := TMyObj683_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj683_List1 := TMyObj683_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
