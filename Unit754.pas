...
type
  ...
  TMyObj754_List0 = TObjectList<TMyObj754>;

  TMyObj754_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj754_List1 = TObjectList<TMyObj754_1>;
...
constructor TMyObj754_1.Create;
begin
  inherited;
  FInt := 754 * 3;
  FTest := 'Value: ' + Random(27542).ToString + Random(75400).ToString;
end;

procedure TForm754.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum754;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj754_List0 := TMyObj754_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj754_List1 := TMyObj754_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
