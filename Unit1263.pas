...
type
  ...
  TMyObj1263_List0 = TObjectList<TMyObj1263>;

  TMyObj1263_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1263_List1 = TObjectList<TMyObj1263_1>;
...
constructor TMyObj1263_1.Create;
begin
  inherited;
  FInt := 1263 * 3;
  FTest := 'Value: ' + Random(212632).ToString + Random(126300).ToString;
end;

procedure TForm1263.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1263;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1263_List0 := TMyObj1263_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1263_List1 := TMyObj1263_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
