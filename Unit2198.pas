...
type
  ...
  TMyObj2198_List0 = TObjectList<TMyObj2198>;

  TMyObj2198_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2198_List1 = TObjectList<TMyObj2198_1>;
...
constructor TMyObj2198_1.Create;
begin
  inherited;
  FInt := 2198 * 3;
  FTest := 'Value: ' + Random(221982).ToString + Random(219800).ToString;
end;

procedure TForm2198.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2198;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2198_List0 := TMyObj2198_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2198_List1 := TMyObj2198_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
