...
type
  ...
  TMyObj932_List0 = TObjectList<TMyObj932>;

  TMyObj932_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj932_List1 = TObjectList<TMyObj932_1>;
...
constructor TMyObj932_1.Create;
begin
  inherited;
  FInt := 932 * 3;
  FTest := 'Value: ' + Random(29322).ToString + Random(93200).ToString;
end;

procedure TForm932.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum932;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj932_List0 := TMyObj932_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj932_List1 := TMyObj932_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
