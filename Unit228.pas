...
type
  ...
  TMyObj228_List0 = TObjectList<TMyObj228>;

  TMyObj228_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj228_List1 = TObjectList<TMyObj228_1>;
...
constructor TMyObj228_1.Create;
begin
  inherited;
  FInt := 228 * 3;
  FTest := 'Value: ' + Random(22282).ToString + Random(22800).ToString;
end;

procedure TForm228.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum228;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj228_List0 := TMyObj228_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj228_List1 := TMyObj228_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
