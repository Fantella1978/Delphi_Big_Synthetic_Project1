...
type
  ...
  TMyObj2448_List0 = TObjectList<TMyObj2448>;

  TMyObj2448_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2448_List1 = TObjectList<TMyObj2448_1>;
...
constructor TMyObj2448_1.Create;
begin
  inherited;
  FInt := 2448 * 3;
  FTest := 'Value: ' + Random(224482).ToString + Random(244800).ToString;
end;

procedure TForm2448.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2448;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2448_List0 := TMyObj2448_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2448_List1 := TMyObj2448_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
