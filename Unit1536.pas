...
type
  ...
  TMyObj1536_List0 = TObjectList<TMyObj1536>;

  TMyObj1536_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1536_List1 = TObjectList<TMyObj1536_1>;
...
constructor TMyObj1536_1.Create;
begin
  inherited;
  FInt := 1536 * 3;
  FTest := 'Value: ' + Random(215362).ToString + Random(153600).ToString;
end;

procedure TForm1536.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1536;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1536_List0 := TMyObj1536_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1536_List1 := TMyObj1536_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
