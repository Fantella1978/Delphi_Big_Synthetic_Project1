...
type
  ...
  TMyObj525_List0 = TObjectList<TMyObj525>;

  TMyObj525_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj525_List1 = TObjectList<TMyObj525_1>;
...
constructor TMyObj525_1.Create;
begin
  inherited;
  FInt := 525 * 3;
  FTest := 'Value: ' + Random(25252).ToString + Random(52500).ToString;
end;

procedure TForm525.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum525;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj525_List0 := TMyObj525_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj525_List1 := TMyObj525_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
