...
type
  ...
  TMyObj1513_List0 = TObjectList<TMyObj1513>;

  TMyObj1513_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1513_List1 = TObjectList<TMyObj1513_1>;
...
constructor TMyObj1513_1.Create;
begin
  inherited;
  FInt := 1513 * 3;
  FTest := 'Value: ' + Random(215132).ToString + Random(151300).ToString;
end;

procedure TForm1513.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1513;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1513_List0 := TMyObj1513_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1513_List1 := TMyObj1513_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
