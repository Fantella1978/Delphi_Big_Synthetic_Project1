...
type
  ...
  TMyObj1560_List0 = TObjectList<TMyObj1560>;

  TMyObj1560_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1560_List1 = TObjectList<TMyObj1560_1>;
...
constructor TMyObj1560_1.Create;
begin
  inherited;
  FInt := 1560 * 3;
  FTest := 'Value: ' + Random(215602).ToString + Random(156000).ToString;
end;

procedure TForm1560.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1560;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1560_List0 := TMyObj1560_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1560_List1 := TMyObj1560_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
