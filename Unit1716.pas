...
type
  ...
  TMyObj1716_List0 = TObjectList<TMyObj1716>;

  TMyObj1716_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1716_List1 = TObjectList<TMyObj1716_1>;
...
constructor TMyObj1716_1.Create;
begin
  inherited;
  FInt := 1716 * 3;
  FTest := 'Value: ' + Random(217162).ToString + Random(171600).ToString;
end;

procedure TForm1716.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1716;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1716_List0 := TMyObj1716_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1716_List1 := TMyObj1716_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
