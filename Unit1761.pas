...
type
  ...
  TMyObj1761_List0 = TObjectList<TMyObj1761>;

  TMyObj1761_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1761_List1 = TObjectList<TMyObj1761_1>;
...
constructor TMyObj1761_1.Create;
begin
  inherited;
  FInt := 1761 * 3;
  FTest := 'Value: ' + Random(217612).ToString + Random(176100).ToString;
end;

procedure TForm1761.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1761;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1761_List0 := TMyObj1761_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1761_List1 := TMyObj1761_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
