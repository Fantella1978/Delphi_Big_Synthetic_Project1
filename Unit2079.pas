...
type
  ...
  TMyObj2079_List0 = TObjectList<TMyObj2079>;

  TMyObj2079_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2079_List1 = TObjectList<TMyObj2079_1>;
...
constructor TMyObj2079_1.Create;
begin
  inherited;
  FInt := 2079 * 3;
  FTest := 'Value: ' + Random(220792).ToString + Random(207900).ToString;
end;

procedure TForm2079.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2079;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2079_List0 := TMyObj2079_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2079_List1 := TMyObj2079_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
