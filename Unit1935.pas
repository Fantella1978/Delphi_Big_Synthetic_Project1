...
type
  ...
  TMyObj1935_List0 = TObjectList<TMyObj1935>;

  TMyObj1935_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1935_List1 = TObjectList<TMyObj1935_1>;
...
constructor TMyObj1935_1.Create;
begin
  inherited;
  FInt := 1935 * 3;
  FTest := 'Value: ' + Random(219352).ToString + Random(193500).ToString;
end;

procedure TForm1935.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1935;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1935_List0 := TMyObj1935_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1935_List1 := TMyObj1935_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
