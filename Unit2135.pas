...
type
  ...
  TMyObj2135_List0 = TObjectList<TMyObj2135>;

  TMyObj2135_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2135_List1 = TObjectList<TMyObj2135_1>;
...
constructor TMyObj2135_1.Create;
begin
  inherited;
  FInt := 2135 * 3;
  FTest := 'Value: ' + Random(221352).ToString + Random(213500).ToString;
end;

procedure TForm2135.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2135;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2135_List0 := TMyObj2135_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2135_List1 := TMyObj2135_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
