...
type
  ...
  TMyObj329_List0 = TObjectList<TMyObj329>;

  TMyObj329_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj329_List1 = TObjectList<TMyObj329_1>;
...
constructor TMyObj329_1.Create;
begin
  inherited;
  FInt := 329 * 3;
  FTest := 'Value: ' + Random(23292).ToString + Random(32900).ToString;
end;

procedure TForm329.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum329;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj329_List0 := TMyObj329_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj329_List1 := TMyObj329_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
