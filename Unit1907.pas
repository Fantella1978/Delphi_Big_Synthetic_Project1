...
type
  ...
  TMyObj1907_List0 = TObjectList<TMyObj1907>;

  TMyObj1907_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1907_List1 = TObjectList<TMyObj1907_1>;
...
constructor TMyObj1907_1.Create;
begin
  inherited;
  FInt := 1907 * 3;
  FTest := 'Value: ' + Random(219072).ToString + Random(190700).ToString;
end;

procedure TForm1907.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1907;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1907_List0 := TMyObj1907_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1907_List1 := TMyObj1907_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
