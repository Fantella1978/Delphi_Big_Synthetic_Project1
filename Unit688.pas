...
type
  ...
  TMyObj688_List0 = TObjectList<TMyObj688>;

  TMyObj688_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj688_List1 = TObjectList<TMyObj688_1>;
...
constructor TMyObj688_1.Create;
begin
  inherited;
  FInt := 688 * 3;
  FTest := 'Value: ' + Random(26882).ToString + Random(68800).ToString;
end;

procedure TForm688.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum688;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj688_List0 := TMyObj688_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj688_List1 := TMyObj688_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
