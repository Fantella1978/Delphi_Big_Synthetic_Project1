...
type
  ...
  TMyObj1713_List0 = TObjectList<TMyObj1713>;

  TMyObj1713_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1713_List1 = TObjectList<TMyObj1713_1>;
...
constructor TMyObj1713_1.Create;
begin
  inherited;
  FInt := 1713 * 3;
  FTest := 'Value: ' + Random(217132).ToString + Random(171300).ToString;
end;

procedure TForm1713.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1713;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1713_List0 := TMyObj1713_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1713_List1 := TMyObj1713_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
