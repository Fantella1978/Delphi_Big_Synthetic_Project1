...
type
  ...
  TMyObj1712_List0 = TObjectList<TMyObj1712>;

  TMyObj1712_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1712_List1 = TObjectList<TMyObj1712_1>;
...
constructor TMyObj1712_1.Create;
begin
  inherited;
  FInt := 1712 * 3;
  FTest := 'Value: ' + Random(217122).ToString + Random(171200).ToString;
end;

procedure TForm1712.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1712;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1712_List0 := TMyObj1712_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1712_List1 := TMyObj1712_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
