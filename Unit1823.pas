...
type
  ...
  TMyObj1823_List0 = TObjectList<TMyObj1823>;

  TMyObj1823_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1823_List1 = TObjectList<TMyObj1823_1>;
...
constructor TMyObj1823_1.Create;
begin
  inherited;
  FInt := 1823 * 3;
  FTest := 'Value: ' + Random(218232).ToString + Random(182300).ToString;
end;

procedure TForm1823.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1823;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1823_List0 := TMyObj1823_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1823_List1 := TMyObj1823_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
