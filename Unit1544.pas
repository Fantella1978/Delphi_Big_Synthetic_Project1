...
type
  ...
  TMyObj1544_List0 = TObjectList<TMyObj1544>;

  TMyObj1544_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1544_List1 = TObjectList<TMyObj1544_1>;
...
constructor TMyObj1544_1.Create;
begin
  inherited;
  FInt := 1544 * 3;
  FTest := 'Value: ' + Random(215442).ToString + Random(154400).ToString;
end;

procedure TForm1544.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1544;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1544_List0 := TMyObj1544_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1544_List1 := TMyObj1544_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
