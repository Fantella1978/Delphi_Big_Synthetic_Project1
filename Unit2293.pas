...
type
  ...
  TMyObj2293_List0 = TObjectList<TMyObj2293>;

  TMyObj2293_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2293_List1 = TObjectList<TMyObj2293_1>;
...
constructor TMyObj2293_1.Create;
begin
  inherited;
  FInt := 2293 * 3;
  FTest := 'Value: ' + Random(222932).ToString + Random(229300).ToString;
end;

procedure TForm2293.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2293;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2293_List0 := TMyObj2293_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2293_List1 := TMyObj2293_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
