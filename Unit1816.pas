...
type
  ...
  TMyObj1816_List0 = TObjectList<TMyObj1816>;

  TMyObj1816_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1816_List1 = TObjectList<TMyObj1816_1>;
...
constructor TMyObj1816_1.Create;
begin
  inherited;
  FInt := 1816 * 3;
  FTest := 'Value: ' + Random(218162).ToString + Random(181600).ToString;
end;

procedure TForm1816.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1816;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1816_List0 := TMyObj1816_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1816_List1 := TMyObj1816_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
