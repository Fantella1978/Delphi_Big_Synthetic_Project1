...
type
  ...
  TMyObj1895_List0 = TObjectList<TMyObj1895>;

  TMyObj1895_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1895_List1 = TObjectList<TMyObj1895_1>;
...
constructor TMyObj1895_1.Create;
begin
  inherited;
  FInt := 1895 * 3;
  FTest := 'Value: ' + Random(218952).ToString + Random(189500).ToString;
end;

procedure TForm1895.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1895;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1895_List0 := TMyObj1895_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1895_List1 := TMyObj1895_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
