...
type
  ...
  TMyObj922_List0 = TObjectList<TMyObj922>;

  TMyObj922_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj922_List1 = TObjectList<TMyObj922_1>;
...
constructor TMyObj922_1.Create;
begin
  inherited;
  FInt := 922 * 3;
  FTest := 'Value: ' + Random(29222).ToString + Random(92200).ToString;
end;

procedure TForm922.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum922;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj922_List0 := TMyObj922_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj922_List1 := TMyObj922_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
