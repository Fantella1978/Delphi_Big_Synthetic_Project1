...
type
  ...
  TMyObj2485_List0 = TObjectList<TMyObj2485>;

  TMyObj2485_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2485_List1 = TObjectList<TMyObj2485_1>;
...
constructor TMyObj2485_1.Create;
begin
  inherited;
  FInt := 2485 * 3;
  FTest := 'Value: ' + Random(224852).ToString + Random(248500).ToString;
end;

procedure TForm2485.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2485;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2485_List0 := TMyObj2485_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2485_List1 := TMyObj2485_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
