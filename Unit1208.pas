...
type
  ...
  TMyObj1208_List0 = TObjectList<TMyObj1208>;

  TMyObj1208_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1208_List1 = TObjectList<TMyObj1208_1>;
...
constructor TMyObj1208_1.Create;
begin
  inherited;
  FInt := 1208 * 3;
  FTest := 'Value: ' + Random(212082).ToString + Random(120800).ToString;
end;

procedure TForm1208.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1208;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1208_List0 := TMyObj1208_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1208_List1 := TMyObj1208_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
