...
type
  ...
  TMyObj790_List0 = TObjectList<TMyObj790>;

  TMyObj790_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj790_List1 = TObjectList<TMyObj790_1>;
...
constructor TMyObj790_1.Create;
begin
  inherited;
  FInt := 790 * 3;
  FTest := 'Value: ' + Random(27902).ToString + Random(79000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj790_List0 := TMyObj790_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj790_List1 := TMyObj790_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
