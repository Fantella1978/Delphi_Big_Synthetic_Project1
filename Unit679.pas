...
type
  ...
  TMyObj679_List0 = TObjectList<TMyObj679>;

  TMyObj679_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj679_List1 = TObjectList<TMyObj679_1>;
...
constructor TMyObj679_1.Create;
begin
  inherited;
  FInt := 679 * 3;
  FTest := 'Value: ' + Random(26792).ToString + Random(67900).ToString;
end;

procedure TForm679.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum679;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj679_List0 := TMyObj679_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj679_List1 := TMyObj679_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
