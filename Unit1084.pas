...
type
  ...
  TMyObj1084_List0 = TObjectList<TMyObj1084>;

  TMyObj1084_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1084_List1 = TObjectList<TMyObj1084_1>;
...
constructor TMyObj1084_1.Create;
begin
  inherited;
  FInt := 1084 * 3;
  FTest := 'Value: ' + Random(210842).ToString + Random(108400).ToString;
end;

procedure TForm1084.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1084;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1084_List0 := TMyObj1084_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1084_List1 := TMyObj1084_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
