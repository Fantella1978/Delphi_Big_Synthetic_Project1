...
type
  ...
  TMyObj612_List0 = TObjectList<TMyObj612>;

  TMyObj612_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj612_List1 = TObjectList<TMyObj612_1>;
...
constructor TMyObj612_1.Create;
begin
  inherited;
  FInt := 612 * 3;
  FTest := 'Value: ' + Random(26122).ToString + Random(61200).ToString;
end;

procedure TForm612.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum612;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj612_List0 := TMyObj612_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj612_List1 := TMyObj612_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
