...
type
  ...
  TMyObj564_List0 = TObjectList<TMyObj564>;

  TMyObj564_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj564_List1 = TObjectList<TMyObj564_1>;
...
constructor TMyObj564_1.Create;
begin
  inherited;
  FInt := 564 * 3;
  FTest := 'Value: ' + Random(25642).ToString + Random(56400).ToString;
end;

procedure TForm564.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum564;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj564_List0 := TMyObj564_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj564_List1 := TMyObj564_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
