...
type
  ...
  TMyObj607_List0 = TObjectList<TMyObj607>;

  TMyObj607_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj607_List1 = TObjectList<TMyObj607_1>;
...
constructor TMyObj607_1.Create;
begin
  inherited;
  FInt := 607 * 3;
  FTest := 'Value: ' + Random(26072).ToString + Random(60700).ToString;
end;

procedure TForm607.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum607;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj607_List0 := TMyObj607_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj607_List1 := TMyObj607_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
