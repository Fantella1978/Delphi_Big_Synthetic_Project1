...
type
  ...
  TMyObj1626_List0 = TObjectList<TMyObj1626>;

  TMyObj1626_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1626_List1 = TObjectList<TMyObj1626_1>;
...
constructor TMyObj1626_1.Create;
begin
  inherited;
  FInt := 1626 * 3;
  FTest := 'Value: ' + Random(216262).ToString + Random(162600).ToString;
end;

procedure TForm1626.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1626;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1626_List0 := TMyObj1626_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1626_List1 := TMyObj1626_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
