...
type
  ...
  TMyObj1618_List0 = TObjectList<TMyObj1618>;

  TMyObj1618_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1618_List1 = TObjectList<TMyObj1618_1>;
...
constructor TMyObj1618_1.Create;
begin
  inherited;
  FInt := 1618 * 3;
  FTest := 'Value: ' + Random(216182).ToString + Random(161800).ToString;
end;

procedure TForm1618.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1618;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1618_List0 := TMyObj1618_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1618_List1 := TMyObj1618_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
