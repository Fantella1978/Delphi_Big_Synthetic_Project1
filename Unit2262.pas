...
type
  ...
  TMyObj2262_List0 = TObjectList<TMyObj2262>;

  TMyObj2262_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2262_List1 = TObjectList<TMyObj2262_1>;
...
constructor TMyObj2262_1.Create;
begin
  inherited;
  FInt := 2262 * 3;
  FTest := 'Value: ' + Random(222622).ToString + Random(226200).ToString;
end;

procedure TForm2262.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2262;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2262_List0 := TMyObj2262_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2262_List1 := TMyObj2262_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
