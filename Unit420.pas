...
type
  ...
  TMyObj420_List0 = TObjectList<TMyObj420>;

  TMyObj420_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj420_List1 = TObjectList<TMyObj420_1>;
...
constructor TMyObj420_1.Create;
begin
  inherited;
  FInt := 420 * 3;
  FTest := 'Value: ' + Random(24202).ToString + Random(42000).ToString;
end;

procedure TForm420.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum420;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj420_List0 := TMyObj420_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj420_List1 := TMyObj420_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
