...
type
  ...
  TMyObj1673_List0 = TObjectList<TMyObj1673>;

  TMyObj1673_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1673_List1 = TObjectList<TMyObj1673_1>;
...
constructor TMyObj1673_1.Create;
begin
  inherited;
  FInt := 1673 * 3;
  FTest := 'Value: ' + Random(216732).ToString + Random(167300).ToString;
end;

procedure TForm1673.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1673;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1673_List0 := TMyObj1673_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1673_List1 := TMyObj1673_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
