...
type
  ...
  TMyObj1305_List0 = TObjectList<TMyObj1305>;

  TMyObj1305_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1305_List1 = TObjectList<TMyObj1305_1>;
...
constructor TMyObj1305_1.Create;
begin
  inherited;
  FInt := 1305 * 3;
  FTest := 'Value: ' + Random(213052).ToString + Random(130500).ToString;
end;

procedure TForm1305.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1305;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1305_List0 := TMyObj1305_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1305_List1 := TMyObj1305_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
