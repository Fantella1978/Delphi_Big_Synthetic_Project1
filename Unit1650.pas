...
type
  ...
  TMyObj1650_List0 = TObjectList<TMyObj1650>;

  TMyObj1650_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1650_List1 = TObjectList<TMyObj1650_1>;
...
constructor TMyObj1650_1.Create;
begin
  inherited;
  FInt := 1650 * 3;
  FTest := 'Value: ' + Random(216502).ToString + Random(165000).ToString;
end;

procedure TForm1650.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1650;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1650_List0 := TMyObj1650_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1650_List1 := TMyObj1650_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
