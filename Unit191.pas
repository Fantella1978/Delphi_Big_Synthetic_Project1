...
type
  ...
  TMyObj191_List0 = TObjectList<TMyObj191>;

  TMyObj191_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj191_List1 = TObjectList<TMyObj191_1>;
...
constructor TMyObj191_1.Create;
begin
  inherited;
  FInt := 191 * 3;
  FTest := 'Value: ' + Random(21912).ToString + Random(19100).ToString;
end;

procedure TForm191.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum191;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj191_List0 := TMyObj191_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj191_List1 := TMyObj191_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
