...
type
  ...
  TMyObj283_List0 = TObjectList<TMyObj283>;

  TMyObj283_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj283_List1 = TObjectList<TMyObj283_1>;
...
constructor TMyObj283_1.Create;
begin
  inherited;
  FInt := 283 * 3;
  FTest := 'Value: ' + Random(22832).ToString + Random(28300).ToString;
end;

procedure TForm283.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum283;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj283_List0 := TMyObj283_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj283_List1 := TMyObj283_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
