...
type
  ...
  TMyObj589_List0 = TObjectList<TMyObj589>;

  TMyObj589_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj589_List1 = TObjectList<TMyObj589_1>;
...
constructor TMyObj589_1.Create;
begin
  inherited;
  FInt := 589 * 3;
  FTest := 'Value: ' + Random(25892).ToString + Random(58900).ToString;
end;

procedure TForm589.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum589;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj589_List0 := TMyObj589_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj589_List1 := TMyObj589_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
