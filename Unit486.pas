...
type
  ...
  TMyObj486_List0 = TObjectList<TMyObj486>;

  TMyObj486_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj486_List1 = TObjectList<TMyObj486_1>;
...
constructor TMyObj486_1.Create;
begin
  inherited;
  FInt := 486 * 3;
  FTest := 'Value: ' + Random(24862).ToString + Random(48600).ToString;
end;

procedure TForm486.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum486;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj486_List0 := TMyObj486_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj486_List1 := TMyObj486_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
