...
type
  ...
  TMyObj387_List0 = TObjectList<TMyObj387>;

  TMyObj387_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj387_List1 = TObjectList<TMyObj387_1>;
...
constructor TMyObj387_1.Create;
begin
  inherited;
  FInt := 387 * 3;
  FTest := 'Value: ' + Random(23872).ToString + Random(38700).ToString;
end;

procedure TForm387.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum387;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj387_List0 := TMyObj387_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj387_List1 := TMyObj387_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
