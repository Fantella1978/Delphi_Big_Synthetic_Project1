...
type
  ...
  TMyObj2021_List0 = TObjectList<TMyObj2021>;

  TMyObj2021_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2021_List1 = TObjectList<TMyObj2021_1>;
...
constructor TMyObj2021_1.Create;
begin
  inherited;
  FInt := 2021 * 3;
  FTest := 'Value: ' + Random(220212).ToString + Random(202100).ToString;
end;

procedure TForm2021.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2021;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2021_List0 := TMyObj2021_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2021_List1 := TMyObj2021_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
