...
type
  ...
  TMyObj488_List0 = TObjectList<TMyObj488>;

  TMyObj488_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj488_List1 = TObjectList<TMyObj488_1>;
...
constructor TMyObj488_1.Create;
begin
  inherited;
  FInt := 488 * 3;
  FTest := 'Value: ' + Random(24882).ToString + Random(48800).ToString;
end;

procedure TForm488.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum488;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj488_List0 := TMyObj488_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj488_List1 := TMyObj488_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
