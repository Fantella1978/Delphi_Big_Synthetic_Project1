...
type
  ...
  TMyObj344_List0 = TObjectList<TMyObj344>;

  TMyObj344_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj344_List1 = TObjectList<TMyObj344_1>;
...
constructor TMyObj344_1.Create;
begin
  inherited;
  FInt := 344 * 3;
  FTest := 'Value: ' + Random(23442).ToString + Random(34400).ToString;
end;

procedure TForm344.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum344;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj344_List0 := TMyObj344_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj344_List1 := TMyObj344_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
