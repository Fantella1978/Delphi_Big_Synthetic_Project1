...
type
  ...
  TMyObj1615_List0 = TObjectList<TMyObj1615>;

  TMyObj1615_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1615_List1 = TObjectList<TMyObj1615_1>;
...
constructor TMyObj1615_1.Create;
begin
  inherited;
  FInt := 1615 * 3;
  FTest := 'Value: ' + Random(216152).ToString + Random(161500).ToString;
end;

procedure TForm1615.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1615;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1615_List0 := TMyObj1615_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1615_List1 := TMyObj1615_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
