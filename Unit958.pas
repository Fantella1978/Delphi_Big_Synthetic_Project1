...
type
  ...
  TMyObj958_List0 = TObjectList<TMyObj958>;

  TMyObj958_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj958_List1 = TObjectList<TMyObj958_1>;
...
constructor TMyObj958_1.Create;
begin
  inherited;
  FInt := 958 * 3;
  FTest := 'Value: ' + Random(29582).ToString + Random(95800).ToString;
end;

procedure TForm958.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum958;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj958_List0 := TMyObj958_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj958_List1 := TMyObj958_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
