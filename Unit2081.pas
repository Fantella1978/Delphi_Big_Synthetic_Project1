...
type
  ...
  TMyObj2081_List0 = TObjectList<TMyObj2081>;

  TMyObj2081_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2081_List1 = TObjectList<TMyObj2081_1>;
...
constructor TMyObj2081_1.Create;
begin
  inherited;
  FInt := 2081 * 3;
  FTest := 'Value: ' + Random(220812).ToString + Random(208100).ToString;
end;

procedure TForm2081.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2081;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2081_List0 := TMyObj2081_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2081_List1 := TMyObj2081_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
