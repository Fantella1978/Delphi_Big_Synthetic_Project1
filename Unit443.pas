...
type
  ...
  TMyObj443_List0 = TObjectList<TMyObj443>;

  TMyObj443_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj443_List1 = TObjectList<TMyObj443_1>;
...
constructor TMyObj443_1.Create;
begin
  inherited;
  FInt := 443 * 3;
  FTest := 'Value: ' + Random(24432).ToString + Random(44300).ToString;
end;

procedure TForm443.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum443;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj443_List0 := TMyObj443_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj443_List1 := TMyObj443_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
