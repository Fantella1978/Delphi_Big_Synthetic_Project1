...
type
  ...
  TMyObj862_List0 = TObjectList<TMyObj862>;

  TMyObj862_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj862_List1 = TObjectList<TMyObj862_1>;
...
constructor TMyObj862_1.Create;
begin
  inherited;
  FInt := 862 * 3;
  FTest := 'Value: ' + Random(28622).ToString + Random(86200).ToString;
end;

procedure TForm862.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum862;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj862_List0 := TMyObj862_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj862_List1 := TMyObj862_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
