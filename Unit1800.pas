...
type
  ...
  TMyObj1800_List0 = TObjectList<TMyObj1800>;

  TMyObj1800_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1800_List1 = TObjectList<TMyObj1800_1>;
...
constructor TMyObj1800_1.Create;
begin
  inherited;
  FInt := 1800 * 3;
  FTest := 'Value: ' + Random(218002).ToString + Random(180000).ToString;
end;

procedure TForm1800.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1800;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1800_List0 := TMyObj1800_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1800_List1 := TMyObj1800_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
