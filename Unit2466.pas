...
type
  ...
  TMyObj2466_List0 = TObjectList<TMyObj2466>;

  TMyObj2466_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2466_List1 = TObjectList<TMyObj2466_1>;
...
constructor TMyObj2466_1.Create;
begin
  inherited;
  FInt := 2466 * 3;
  FTest := 'Value: ' + Random(224662).ToString + Random(246600).ToString;
end;

procedure TForm2466.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2466;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2466_List0 := TMyObj2466_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2466_List1 := TMyObj2466_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
