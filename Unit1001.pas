...
type
  ...
  TMyObj1001_List0 = TObjectList<TMyObj1001>;

  TMyObj1001_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1001_List1 = TObjectList<TMyObj1001_1>;
...
constructor TMyObj1001_1.Create;
begin
  inherited;
  FInt := 1001 * 3;
  FTest := 'Value: ' + Random(210012).ToString + Random(100100).ToString;
end;

procedure TForm1001.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1001;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1001_List0 := TMyObj1001_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1001_List1 := TMyObj1001_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
