...
type
  ...
  TMyObj370_List0 = TObjectList<TMyObj370>;

  TMyObj370_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj370_List1 = TObjectList<TMyObj370_1>;
...
constructor TMyObj370_1.Create;
begin
  inherited;
  FInt := 370 * 3;
  FTest := 'Value: ' + Random(23702).ToString + Random(37000).ToString;
end;

procedure TForm370.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum370;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj370_List0 := TMyObj370_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj370_List1 := TMyObj370_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
