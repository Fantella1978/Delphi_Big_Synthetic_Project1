...
type
  ...
  TMyObj1444_List0 = TObjectList<TMyObj1444>;

  TMyObj1444_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1444_List1 = TObjectList<TMyObj1444_1>;
...
constructor TMyObj1444_1.Create;
begin
  inherited;
  FInt := 1444 * 3;
  FTest := 'Value: ' + Random(214442).ToString + Random(144400).ToString;
end;

procedure TForm1444.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1444;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1444_List0 := TMyObj1444_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1444_List1 := TMyObj1444_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
