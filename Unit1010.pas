...
type
  ...
  TMyObj1010_List0 = TObjectList<TMyObj1010>;

  TMyObj1010_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1010_List1 = TObjectList<TMyObj1010_1>;
...
constructor TMyObj1010_1.Create;
begin
  inherited;
  FInt := 1010 * 3;
  FTest := 'Value: ' + Random(210102).ToString + Random(101000).ToString;
end;

procedure TForm1010.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1010;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1010_List0 := TMyObj1010_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1010_List1 := TMyObj1010_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
