...
type
  ...
  TMyObj372_List0 = TObjectList<TMyObj372>;

  TMyObj372_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj372_List1 = TObjectList<TMyObj372_1>;
...
constructor TMyObj372_1.Create;
begin
  inherited;
  FInt := 372 * 3;
  FTest := 'Value: ' + Random(23722).ToString + Random(37200).ToString;
end;

procedure TForm372.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum372;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj372_List0 := TMyObj372_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj372_List1 := TMyObj372_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
