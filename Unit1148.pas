...
type
  ...
  TMyObj1148_List0 = TObjectList<TMyObj1148>;

  TMyObj1148_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1148_List1 = TObjectList<TMyObj1148_1>;
...
constructor TMyObj1148_1.Create;
begin
  inherited;
  FInt := 1148 * 3;
  FTest := 'Value: ' + Random(211482).ToString + Random(114800).ToString;
end;

procedure TForm1148.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1148;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1148_List0 := TMyObj1148_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1148_List1 := TMyObj1148_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
