...
type
  ...
  TMyObj1526_List0 = TObjectList<TMyObj1526>;

  TMyObj1526_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1526_List1 = TObjectList<TMyObj1526_1>;
...
constructor TMyObj1526_1.Create;
begin
  inherited;
  FInt := 1526 * 3;
  FTest := 'Value: ' + Random(215262).ToString + Random(152600).ToString;
end;

procedure TForm1526.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1526;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1526_List0 := TMyObj1526_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1526_List1 := TMyObj1526_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
