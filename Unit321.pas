...
type
  ...
  TMyObj321_List0 = TObjectList<TMyObj321>;

  TMyObj321_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj321_List1 = TObjectList<TMyObj321_1>;
...
constructor TMyObj321_1.Create;
begin
  inherited;
  FInt := 321 * 3;
  FTest := 'Value: ' + Random(23212).ToString + Random(32100).ToString;
end;

procedure TForm321.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum321;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj321_List0 := TMyObj321_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj321_List1 := TMyObj321_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
