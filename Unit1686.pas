...
type
  ...
  TMyObj1686_List0 = TObjectList<TMyObj1686>;

  TMyObj1686_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1686_List1 = TObjectList<TMyObj1686_1>;
...
constructor TMyObj1686_1.Create;
begin
  inherited;
  FInt := 1686 * 3;
  FTest := 'Value: ' + Random(216862).ToString + Random(168600).ToString;
end;

procedure TForm1686.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1686;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1686_List0 := TMyObj1686_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1686_List1 := TMyObj1686_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
