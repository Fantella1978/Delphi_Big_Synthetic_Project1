...
type
  ...
  TMyObj1196_List0 = TObjectList<TMyObj1196>;

  TMyObj1196_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1196_List1 = TObjectList<TMyObj1196_1>;
...
constructor TMyObj1196_1.Create;
begin
  inherited;
  FInt := 1196 * 3;
  FTest := 'Value: ' + Random(211962).ToString + Random(119600).ToString;
end;

procedure TForm1196.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1196;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1196_List0 := TMyObj1196_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1196_List1 := TMyObj1196_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
