...
type
  ...
  TMyObj1135_List0 = TObjectList<TMyObj1135>;

  TMyObj1135_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1135_List1 = TObjectList<TMyObj1135_1>;
...
constructor TMyObj1135_1.Create;
begin
  inherited;
  FInt := 1135 * 3;
  FTest := 'Value: ' + Random(211352).ToString + Random(113500).ToString;
end;

procedure TForm1135.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1135;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1135_List0 := TMyObj1135_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1135_List1 := TMyObj1135_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
