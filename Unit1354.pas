...
type
  ...
  TMyObj1354_List0 = TObjectList<TMyObj1354>;

  TMyObj1354_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1354_List1 = TObjectList<TMyObj1354_1>;
...
constructor TMyObj1354_1.Create;
begin
  inherited;
  FInt := 1354 * 3;
  FTest := 'Value: ' + Random(213542).ToString + Random(135400).ToString;
end;

procedure TForm1354.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1354;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1354_List0 := TMyObj1354_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1354_List1 := TMyObj1354_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
