...
type
  ...
  TMyObj301_List0 = TObjectList<TMyObj301>;

  TMyObj301_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj301_List1 = TObjectList<TMyObj301_1>;
...
constructor TMyObj301_1.Create;
begin
  inherited;
  FInt := 301 * 3;
  FTest := 'Value: ' + Random(23012).ToString + Random(30100).ToString;
end;

procedure TForm301.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum301;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj301_List0 := TMyObj301_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj301_List1 := TMyObj301_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
