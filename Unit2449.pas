...
type
  ...
  TMyObj2449_List0 = TObjectList<TMyObj2449>;

  TMyObj2449_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2449_List1 = TObjectList<TMyObj2449_1>;
...
constructor TMyObj2449_1.Create;
begin
  inherited;
  FInt := 2449 * 3;
  FTest := 'Value: ' + Random(224492).ToString + Random(244900).ToString;
end;

procedure TForm2449.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2449;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2449_List0 := TMyObj2449_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2449_List1 := TMyObj2449_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
