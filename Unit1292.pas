...
type
  ...
  TMyObj1292_List0 = TObjectList<TMyObj1292>;

  TMyObj1292_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1292_List1 = TObjectList<TMyObj1292_1>;
...
constructor TMyObj1292_1.Create;
begin
  inherited;
  FInt := 1292 * 3;
  FTest := 'Value: ' + Random(212922).ToString + Random(129200).ToString;
end;

procedure TForm1292.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1292;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1292_List0 := TMyObj1292_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1292_List1 := TMyObj1292_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
