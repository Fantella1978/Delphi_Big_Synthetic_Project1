...
type
  ...
  TMyObj1206_List0 = TObjectList<TMyObj1206>;

  TMyObj1206_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1206_List1 = TObjectList<TMyObj1206_1>;
...
constructor TMyObj1206_1.Create;
begin
  inherited;
  FInt := 1206 * 3;
  FTest := 'Value: ' + Random(212062).ToString + Random(120600).ToString;
end;

procedure TForm1206.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1206;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1206_List0 := TMyObj1206_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1206_List1 := TMyObj1206_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
