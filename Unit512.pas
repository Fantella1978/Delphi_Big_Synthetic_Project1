...
type
  ...
  TMyObj512_List0 = TObjectList<TMyObj512>;

  TMyObj512_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj512_List1 = TObjectList<TMyObj512_1>;
...
constructor TMyObj512_1.Create;
begin
  inherited;
  FInt := 512 * 3;
  FTest := 'Value: ' + Random(25122).ToString + Random(51200).ToString;
end;

procedure TForm512.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum512;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj512_List0 := TMyObj512_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj512_List1 := TMyObj512_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
