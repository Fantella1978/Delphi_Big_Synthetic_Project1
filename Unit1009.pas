...
type
  ...
  TMyObj1009_List0 = TObjectList<TMyObj1009>;

  TMyObj1009_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1009_List1 = TObjectList<TMyObj1009_1>;
...
constructor TMyObj1009_1.Create;
begin
  inherited;
  FInt := 1009 * 3;
  FTest := 'Value: ' + Random(210092).ToString + Random(100900).ToString;
end;

procedure TForm1009.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1009;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1009_List0 := TMyObj1009_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1009_List1 := TMyObj1009_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
