...
type
  ...
  TMyObj876_List0 = TObjectList<TMyObj876>;

  TMyObj876_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj876_List1 = TObjectList<TMyObj876_1>;
...
constructor TMyObj876_1.Create;
begin
  inherited;
  FInt := 876 * 3;
  FTest := 'Value: ' + Random(28762).ToString + Random(87600).ToString;
end;

procedure TForm876.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum876;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj876_List0 := TMyObj876_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj876_List1 := TMyObj876_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
