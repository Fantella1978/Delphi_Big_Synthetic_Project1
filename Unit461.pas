...
type
  ...
  TMyObj461_List0 = TObjectList<TMyObj461>;

  TMyObj461_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj461_List1 = TObjectList<TMyObj461_1>;
...
constructor TMyObj461_1.Create;
begin
  inherited;
  FInt := 461 * 3;
  FTest := 'Value: ' + Random(24612).ToString + Random(46100).ToString;
end;

procedure TForm461.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum461;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj461_List0 := TMyObj461_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj461_List1 := TMyObj461_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
