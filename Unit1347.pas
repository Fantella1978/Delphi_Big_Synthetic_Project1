...
type
  ...
  TMyObj1347_List0 = TObjectList<TMyObj1347>;

  TMyObj1347_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1347_List1 = TObjectList<TMyObj1347_1>;
...
constructor TMyObj1347_1.Create;
begin
  inherited;
  FInt := 1347 * 3;
  FTest := 'Value: ' + Random(213472).ToString + Random(134700).ToString;
end;

procedure TForm1347.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1347;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1347_List0 := TMyObj1347_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1347_List1 := TMyObj1347_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
