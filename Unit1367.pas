...
type
  ...
  TMyObj1367_List0 = TObjectList<TMyObj1367>;

  TMyObj1367_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1367_List1 = TObjectList<TMyObj1367_1>;
...
constructor TMyObj1367_1.Create;
begin
  inherited;
  FInt := 1367 * 3;
  FTest := 'Value: ' + Random(213672).ToString + Random(136700).ToString;
end;

procedure TForm1367.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1367;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1367_List0 := TMyObj1367_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1367_List1 := TMyObj1367_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
