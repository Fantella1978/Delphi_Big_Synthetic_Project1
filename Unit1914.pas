...
type
  ...
  TMyObj1914_List0 = TObjectList<TMyObj1914>;

  TMyObj1914_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1914_List1 = TObjectList<TMyObj1914_1>;
...
constructor TMyObj1914_1.Create;
begin
  inherited;
  FInt := 1914 * 3;
  FTest := 'Value: ' + Random(219142).ToString + Random(191400).ToString;
end;

procedure TForm1914.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1914;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1914_List0 := TMyObj1914_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1914_List1 := TMyObj1914_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
