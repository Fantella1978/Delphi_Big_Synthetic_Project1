...
type
  ...
  TMyObj2002_List0 = TObjectList<TMyObj2002>;

  TMyObj2002_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2002_List1 = TObjectList<TMyObj2002_1>;
...
constructor TMyObj2002_1.Create;
begin
  inherited;
  FInt := 2002 * 3;
  FTest := 'Value: ' + Random(220022).ToString + Random(200200).ToString;
end;

procedure TForm2002.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2002;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2002_List0 := TMyObj2002_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2002_List1 := TMyObj2002_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
