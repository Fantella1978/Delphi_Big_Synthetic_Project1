...
type
  ...
  TMyObj2438_List0 = TObjectList<TMyObj2438>;

  TMyObj2438_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2438_List1 = TObjectList<TMyObj2438_1>;
...
constructor TMyObj2438_1.Create;
begin
  inherited;
  FInt := 2438 * 3;
  FTest := 'Value: ' + Random(224382).ToString + Random(243800).ToString;
end;

procedure TForm2438.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2438;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2438_List0 := TMyObj2438_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2438_List1 := TMyObj2438_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
