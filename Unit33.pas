...
type
  ...
  TMyObj33_List0 = TObjectList<TMyObj33>;

  TMyObj33_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj33_List1 = TObjectList<TMyObj33_1>;
...
constructor TMyObj33_1.Create;
begin
  inherited;
  FInt := 33 * 3;
  FTest := 'Value: ' + Random(2332).ToString + Random(3300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj33_List0 := TMyObj33_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj33_List1 := TMyObj33_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
