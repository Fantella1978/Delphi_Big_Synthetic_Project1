...
type
  ...
  TMyObj1076_List0 = TObjectList<TMyObj1076>;

  TMyObj1076_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1076_List1 = TObjectList<TMyObj1076_1>;
...
constructor TMyObj1076_1.Create;
begin
  inherited;
  FInt := 1076 * 3;
  FTest := 'Value: ' + Random(210762).ToString + Random(107600).ToString;
end;

procedure TForm1076.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1076;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1076_List0 := TMyObj1076_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1076_List1 := TMyObj1076_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
