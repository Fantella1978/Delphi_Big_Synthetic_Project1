...
type
  ...
  TMyObj1484_List0 = TObjectList<TMyObj1484>;

  TMyObj1484_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1484_List1 = TObjectList<TMyObj1484_1>;
...
constructor TMyObj1484_1.Create;
begin
  inherited;
  FInt := 1484 * 3;
  FTest := 'Value: ' + Random(214842).ToString + Random(148400).ToString;
end;

procedure TForm1484.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1484;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1484_List0 := TMyObj1484_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1484_List1 := TMyObj1484_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
