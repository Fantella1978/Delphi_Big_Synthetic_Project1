...
type
  ...
  TMyObj1918_List0 = TObjectList<TMyObj1918>;

  TMyObj1918_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1918_List1 = TObjectList<TMyObj1918_1>;
...
constructor TMyObj1918_1.Create;
begin
  inherited;
  FInt := 1918 * 3;
  FTest := 'Value: ' + Random(219182).ToString + Random(191800).ToString;
end;

procedure TForm1918.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1918;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1918_List0 := TMyObj1918_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1918_List1 := TMyObj1918_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
