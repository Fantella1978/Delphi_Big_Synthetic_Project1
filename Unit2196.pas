...
type
  ...
  TMyObj2196_List0 = TObjectList<TMyObj2196>;

  TMyObj2196_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2196_List1 = TObjectList<TMyObj2196_1>;
...
constructor TMyObj2196_1.Create;
begin
  inherited;
  FInt := 2196 * 3;
  FTest := 'Value: ' + Random(221962).ToString + Random(219600).ToString;
end;

procedure TForm2196.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2196;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2196_List0 := TMyObj2196_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2196_List1 := TMyObj2196_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
