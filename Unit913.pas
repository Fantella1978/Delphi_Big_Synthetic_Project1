...
type
  ...
  TMyObj913_List0 = TObjectList<TMyObj913>;

  TMyObj913_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj913_List1 = TObjectList<TMyObj913_1>;
...
constructor TMyObj913_1.Create;
begin
  inherited;
  FInt := 913 * 3;
  FTest := 'Value: ' + Random(29132).ToString + Random(91300).ToString;
end;

procedure TForm913.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum913;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj913_List0 := TMyObj913_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj913_List1 := TMyObj913_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
