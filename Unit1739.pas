...
type
  ...
  TMyObj1739_List0 = TObjectList<TMyObj1739>;

  TMyObj1739_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1739_List1 = TObjectList<TMyObj1739_1>;
...
constructor TMyObj1739_1.Create;
begin
  inherited;
  FInt := 1739 * 3;
  FTest := 'Value: ' + Random(217392).ToString + Random(173900).ToString;
end;

procedure TForm1739.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1739;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1739_List0 := TMyObj1739_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1739_List1 := TMyObj1739_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
