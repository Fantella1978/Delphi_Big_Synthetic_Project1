...
type
  ...
  TMyObj1737_List0 = TObjectList<TMyObj1737>;

  TMyObj1737_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1737_List1 = TObjectList<TMyObj1737_1>;
...
constructor TMyObj1737_1.Create;
begin
  inherited;
  FInt := 1737 * 3;
  FTest := 'Value: ' + Random(217372).ToString + Random(173700).ToString;
end;

procedure TForm1737.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1737;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1737_List0 := TMyObj1737_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1737_List1 := TMyObj1737_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
