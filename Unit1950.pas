...
type
  ...
  TMyObj1950_List0 = TObjectList<TMyObj1950>;

  TMyObj1950_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1950_List1 = TObjectList<TMyObj1950_1>;
...
constructor TMyObj1950_1.Create;
begin
  inherited;
  FInt := 1950 * 3;
  FTest := 'Value: ' + Random(219502).ToString + Random(195000).ToString;
end;

procedure TForm1950.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1950;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1950_List0 := TMyObj1950_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1950_List1 := TMyObj1950_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
