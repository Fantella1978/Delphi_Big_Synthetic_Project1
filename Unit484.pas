...
type
  ...
  TMyObj484_List0 = TObjectList<TMyObj484>;

  TMyObj484_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj484_List1 = TObjectList<TMyObj484_1>;
...
constructor TMyObj484_1.Create;
begin
  inherited;
  FInt := 484 * 3;
  FTest := 'Value: ' + Random(24842).ToString + Random(48400).ToString;
end;

procedure TForm484.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum484;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj484_List0 := TMyObj484_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj484_List1 := TMyObj484_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
