...
type
  ...
  TMyObj160_List0 = TObjectList<TMyObj160>;

  TMyObj160_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj160_List1 = TObjectList<TMyObj160_1>;
...
constructor TMyObj160_1.Create;
begin
  inherited;
  FInt := 160 * 3;
  FTest := 'Value: ' + Random(21602).ToString + Random(16000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj160_List0 := TMyObj160_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj160_List1 := TMyObj160_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
