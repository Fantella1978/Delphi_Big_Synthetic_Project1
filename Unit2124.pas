...
type
  ...
  TMyObj2124_List0 = TObjectList<TMyObj2124>;

  TMyObj2124_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2124_List1 = TObjectList<TMyObj2124_1>;
...
constructor TMyObj2124_1.Create;
begin
  inherited;
  FInt := 2124 * 3;
  FTest := 'Value: ' + Random(221242).ToString + Random(212400).ToString;
end;

procedure TForm2124.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2124;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2124_List0 := TMyObj2124_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2124_List1 := TMyObj2124_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
