...
type
  ...
  TMyObj2312_List0 = TObjectList<TMyObj2312>;

  TMyObj2312_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2312_List1 = TObjectList<TMyObj2312_1>;
...
constructor TMyObj2312_1.Create;
begin
  inherited;
  FInt := 2312 * 3;
  FTest := 'Value: ' + Random(223122).ToString + Random(231200).ToString;
end;

procedure TForm2312.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2312;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2312_List0 := TMyObj2312_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2312_List1 := TMyObj2312_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
