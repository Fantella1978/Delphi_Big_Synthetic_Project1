...
type
  ...
  TMyObj500_List0 = TObjectList<TMyObj500>;

  TMyObj500_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj500_List1 = TObjectList<TMyObj500_1>;
...
constructor TMyObj500_1.Create;
begin
  inherited;
  FInt := 500 * 3;
  FTest := 'Value: ' + Random(25002).ToString + Random(50000).ToString;
end;

procedure TForm500.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum500;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj500_List0 := TMyObj500_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj500_List1 := TMyObj500_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
