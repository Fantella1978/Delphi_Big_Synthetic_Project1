...
type
  ...
  TMyObj1151_List0 = TObjectList<TMyObj1151>;

  TMyObj1151_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1151_List1 = TObjectList<TMyObj1151_1>;
...
constructor TMyObj1151_1.Create;
begin
  inherited;
  FInt := 1151 * 3;
  FTest := 'Value: ' + Random(211512).ToString + Random(115100).ToString;
end;

procedure TForm1151.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1151;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1151_List0 := TMyObj1151_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1151_List1 := TMyObj1151_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
