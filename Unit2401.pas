...
type
  ...
  TMyObj2401_List0 = TObjectList<TMyObj2401>;

  TMyObj2401_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2401_List1 = TObjectList<TMyObj2401_1>;
...
constructor TMyObj2401_1.Create;
begin
  inherited;
  FInt := 2401 * 3;
  FTest := 'Value: ' + Random(224012).ToString + Random(240100).ToString;
end;

procedure TForm2401.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2401;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2401_List0 := TMyObj2401_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2401_List1 := TMyObj2401_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
