...
type
  ...
  TMyObj262_List0 = TObjectList<TMyObj262>;

  TMyObj262_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj262_List1 = TObjectList<TMyObj262_1>;
...
constructor TMyObj262_1.Create;
begin
  inherited;
  FInt := 262 * 3;
  FTest := 'Value: ' + Random(22622).ToString + Random(26200).ToString;
end;

procedure TForm262.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum262;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj262_List0 := TMyObj262_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj262_List1 := TMyObj262_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
