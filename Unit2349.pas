...
type
  ...
  TMyObj2349_List0 = TObjectList<TMyObj2349>;

  TMyObj2349_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2349_List1 = TObjectList<TMyObj2349_1>;
...
constructor TMyObj2349_1.Create;
begin
  inherited;
  FInt := 2349 * 3;
  FTest := 'Value: ' + Random(223492).ToString + Random(234900).ToString;
end;

procedure TForm2349.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2349;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2349_List0 := TMyObj2349_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2349_List1 := TMyObj2349_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
