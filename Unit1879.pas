...
type
  ...
  TMyObj1879_List0 = TObjectList<TMyObj1879>;

  TMyObj1879_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1879_List1 = TObjectList<TMyObj1879_1>;
...
constructor TMyObj1879_1.Create;
begin
  inherited;
  FInt := 1879 * 3;
  FTest := 'Value: ' + Random(218792).ToString + Random(187900).ToString;
end;

procedure TForm1879.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1879;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1879_List0 := TMyObj1879_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1879_List1 := TMyObj1879_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
