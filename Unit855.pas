...
type
  ...
  TMyObj855_List0 = TObjectList<TMyObj855>;

  TMyObj855_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj855_List1 = TObjectList<TMyObj855_1>;
...
constructor TMyObj855_1.Create;
begin
  inherited;
  FInt := 855 * 3;
  FTest := 'Value: ' + Random(28552).ToString + Random(85500).ToString;
end;

procedure TForm855.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum855;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj855_List0 := TMyObj855_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj855_List1 := TMyObj855_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
