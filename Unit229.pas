...
type
  ...
  TMyObj229_List0 = TObjectList<TMyObj229>;

  TMyObj229_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj229_List1 = TObjectList<TMyObj229_1>;
...
constructor TMyObj229_1.Create;
begin
  inherited;
  FInt := 229 * 3;
  FTest := 'Value: ' + Random(22292).ToString + Random(22900).ToString;
end;

procedure TForm229.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum229;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj229_List0 := TMyObj229_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj229_List1 := TMyObj229_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
