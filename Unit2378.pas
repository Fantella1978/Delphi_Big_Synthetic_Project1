...
type
  ...
  TMyObj2378_List0 = TObjectList<TMyObj2378>;

  TMyObj2378_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2378_List1 = TObjectList<TMyObj2378_1>;
...
constructor TMyObj2378_1.Create;
begin
  inherited;
  FInt := 2378 * 3;
  FTest := 'Value: ' + Random(223782).ToString + Random(237800).ToString;
end;

procedure TForm2378.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2378;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2378_List0 := TMyObj2378_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2378_List1 := TMyObj2378_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
