...
type
  ...
  TMyObj628_List0 = TObjectList<TMyObj628>;

  TMyObj628_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj628_List1 = TObjectList<TMyObj628_1>;
...
constructor TMyObj628_1.Create;
begin
  inherited;
  FInt := 628 * 3;
  FTest := 'Value: ' + Random(26282).ToString + Random(62800).ToString;
end;

procedure TForm628.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum628;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj628_List0 := TMyObj628_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj628_List1 := TMyObj628_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
