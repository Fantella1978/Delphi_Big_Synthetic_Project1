...
type
  ...
  TMyObj39_List0 = TObjectList<TMyObj39>;

  TMyObj39_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj39_List1 = TObjectList<TMyObj39_1>;
...
constructor TMyObj39_1.Create;
begin
  inherited;
  FInt := 39 * 3;
  FTest := 'Value: ' + Random(2392).ToString + Random(3900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj39_List0 := TMyObj39_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj39_List1 := TMyObj39_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
