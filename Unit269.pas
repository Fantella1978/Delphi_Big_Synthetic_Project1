...
type
  ...
  TMyObj269_List0 = TObjectList<TMyObj269>;

  TMyObj269_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj269_List1 = TObjectList<TMyObj269_1>;
...
constructor TMyObj269_1.Create;
begin
  inherited;
  FInt := 269 * 3;
  FTest := 'Value: ' + Random(22692).ToString + Random(26900).ToString;
end;

procedure TForm269.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum269;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj269_List0 := TMyObj269_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj269_List1 := TMyObj269_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
