...
type
  ...
  TMyObj1437_List0 = TObjectList<TMyObj1437>;

  TMyObj1437_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1437_List1 = TObjectList<TMyObj1437_1>;
...
constructor TMyObj1437_1.Create;
begin
  inherited;
  FInt := 1437 * 3;
  FTest := 'Value: ' + Random(214372).ToString + Random(143700).ToString;
end;

procedure TForm1437.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1437;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1437_List0 := TMyObj1437_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1437_List1 := TMyObj1437_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
