...
type
  ...
  TMyObj1873_List0 = TObjectList<TMyObj1873>;

  TMyObj1873_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1873_List1 = TObjectList<TMyObj1873_1>;
...
constructor TMyObj1873_1.Create;
begin
  inherited;
  FInt := 1873 * 3;
  FTest := 'Value: ' + Random(218732).ToString + Random(187300).ToString;
end;

procedure TForm1873.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1873;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1873_List0 := TMyObj1873_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1873_List1 := TMyObj1873_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
