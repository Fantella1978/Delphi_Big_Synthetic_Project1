...
type
  ...
  TMyObj1557_List0 = TObjectList<TMyObj1557>;

  TMyObj1557_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1557_List1 = TObjectList<TMyObj1557_1>;
...
constructor TMyObj1557_1.Create;
begin
  inherited;
  FInt := 1557 * 3;
  FTest := 'Value: ' + Random(215572).ToString + Random(155700).ToString;
end;

procedure TForm1557.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1557;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1557_List0 := TMyObj1557_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1557_List1 := TMyObj1557_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
