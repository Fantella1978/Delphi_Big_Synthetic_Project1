...
type
  ...
  TMyObj1222_List0 = TObjectList<TMyObj1222>;

  TMyObj1222_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1222_List1 = TObjectList<TMyObj1222_1>;
...
constructor TMyObj1222_1.Create;
begin
  inherited;
  FInt := 1222 * 3;
  FTest := 'Value: ' + Random(212222).ToString + Random(122200).ToString;
end;

procedure TForm1222.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1222;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1222_List0 := TMyObj1222_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1222_List1 := TMyObj1222_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
