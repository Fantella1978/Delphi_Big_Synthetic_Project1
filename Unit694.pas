...
type
  ...
  TMyObj694_List0 = TObjectList<TMyObj694>;

  TMyObj694_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj694_List1 = TObjectList<TMyObj694_1>;
...
constructor TMyObj694_1.Create;
begin
  inherited;
  FInt := 694 * 3;
  FTest := 'Value: ' + Random(26942).ToString + Random(69400).ToString;
end;

procedure TForm694.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum694;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj694_List0 := TMyObj694_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj694_List1 := TMyObj694_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
