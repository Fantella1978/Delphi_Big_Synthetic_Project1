...
type
  ...
  TMyObj1183_List0 = TObjectList<TMyObj1183>;

  TMyObj1183_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1183_List1 = TObjectList<TMyObj1183_1>;
...
constructor TMyObj1183_1.Create;
begin
  inherited;
  FInt := 1183 * 3;
  FTest := 'Value: ' + Random(211832).ToString + Random(118300).ToString;
end;

procedure TForm1183.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1183;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1183_List0 := TMyObj1183_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1183_List1 := TMyObj1183_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
