...
type
  ...
  TMyObj1454_List0 = TObjectList<TMyObj1454>;

  TMyObj1454_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1454_List1 = TObjectList<TMyObj1454_1>;
...
constructor TMyObj1454_1.Create;
begin
  inherited;
  FInt := 1454 * 3;
  FTest := 'Value: ' + Random(214542).ToString + Random(145400).ToString;
end;

procedure TForm1454.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1454;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1454_List0 := TMyObj1454_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1454_List1 := TMyObj1454_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
