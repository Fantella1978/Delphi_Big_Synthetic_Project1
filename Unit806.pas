...
type
  ...
  TMyObj806_List0 = TObjectList<TMyObj806>;

  TMyObj806_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj806_List1 = TObjectList<TMyObj806_1>;
...
constructor TMyObj806_1.Create;
begin
  inherited;
  FInt := 806 * 3;
  FTest := 'Value: ' + Random(28062).ToString + Random(80600).ToString;
end;

procedure TForm806.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum806;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj806_List0 := TMyObj806_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj806_List1 := TMyObj806_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
