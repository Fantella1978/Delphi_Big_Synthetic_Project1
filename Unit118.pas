...
type
  ...
  TMyObj118_List0 = TObjectList<TMyObj118>;

  TMyObj118_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj118_List1 = TObjectList<TMyObj118_1>;
...
constructor TMyObj118_1.Create;
begin
  inherited;
  FInt := 118 * 3;
  FTest := 'Value: ' + Random(21182).ToString + Random(11800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj118_List0 := TMyObj118_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj118_List1 := TMyObj118_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
