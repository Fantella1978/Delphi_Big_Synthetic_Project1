...
type
  ...
  TMyObj1099_List0 = TObjectList<TMyObj1099>;

  TMyObj1099_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1099_List1 = TObjectList<TMyObj1099_1>;
...
constructor TMyObj1099_1.Create;
begin
  inherited;
  FInt := 1099 * 3;
  FTest := 'Value: ' + Random(210992).ToString + Random(109900).ToString;
end;

procedure TForm1099.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1099;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1099_List0 := TMyObj1099_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1099_List1 := TMyObj1099_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
