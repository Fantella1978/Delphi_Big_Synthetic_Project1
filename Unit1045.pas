...
type
  ...
  TMyObj1045_List0 = TObjectList<TMyObj1045>;

  TMyObj1045_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1045_List1 = TObjectList<TMyObj1045_1>;
...
constructor TMyObj1045_1.Create;
begin
  inherited;
  FInt := 1045 * 3;
  FTest := 'Value: ' + Random(210452).ToString + Random(104500).ToString;
end;

procedure TForm1045.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1045;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1045_List0 := TMyObj1045_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1045_List1 := TMyObj1045_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
