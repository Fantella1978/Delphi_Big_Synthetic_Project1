...
type
  ...
  TMyObj1041_List0 = TObjectList<TMyObj1041>;

  TMyObj1041_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1041_List1 = TObjectList<TMyObj1041_1>;
...
constructor TMyObj1041_1.Create;
begin
  inherited;
  FInt := 1041 * 3;
  FTest := 'Value: ' + Random(210412).ToString + Random(104100).ToString;
end;

procedure TForm1041.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1041;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1041_List0 := TMyObj1041_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1041_List1 := TMyObj1041_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
