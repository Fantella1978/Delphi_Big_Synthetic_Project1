...
type
  ...
  TMyObj919_List0 = TObjectList<TMyObj919>;

  TMyObj919_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj919_List1 = TObjectList<TMyObj919_1>;
...
constructor TMyObj919_1.Create;
begin
  inherited;
  FInt := 919 * 3;
  FTest := 'Value: ' + Random(29192).ToString + Random(91900).ToString;
end;

procedure TForm919.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum919;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj919_List0 := TMyObj919_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj919_List1 := TMyObj919_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
