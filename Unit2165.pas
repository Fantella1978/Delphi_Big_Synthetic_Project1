...
type
  ...
  TMyObj2165_List0 = TObjectList<TMyObj2165>;

  TMyObj2165_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2165_List1 = TObjectList<TMyObj2165_1>;
...
constructor TMyObj2165_1.Create;
begin
  inherited;
  FInt := 2165 * 3;
  FTest := 'Value: ' + Random(221652).ToString + Random(216500).ToString;
end;

procedure TForm2165.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2165;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2165_List0 := TMyObj2165_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2165_List1 := TMyObj2165_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
