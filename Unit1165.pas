...
type
  ...
  TMyObj1165_List0 = TObjectList<TMyObj1165>;

  TMyObj1165_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1165_List1 = TObjectList<TMyObj1165_1>;
...
constructor TMyObj1165_1.Create;
begin
  inherited;
  FInt := 1165 * 3;
  FTest := 'Value: ' + Random(211652).ToString + Random(116500).ToString;
end;

procedure TForm1165.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1165;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1165_List0 := TMyObj1165_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1165_List1 := TMyObj1165_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
