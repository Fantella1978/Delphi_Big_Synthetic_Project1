...
type
  ...
  TMyObj309_List0 = TObjectList<TMyObj309>;

  TMyObj309_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj309_List1 = TObjectList<TMyObj309_1>;
...
constructor TMyObj309_1.Create;
begin
  inherited;
  FInt := 309 * 3;
  FTest := 'Value: ' + Random(23092).ToString + Random(30900).ToString;
end;

procedure TForm309.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum309;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj309_List0 := TMyObj309_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj309_List1 := TMyObj309_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
