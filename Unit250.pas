...
type
  ...
  TMyObj250_List0 = TObjectList<TMyObj250>;

  TMyObj250_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj250_List1 = TObjectList<TMyObj250_1>;
...
constructor TMyObj250_1.Create;
begin
  inherited;
  FInt := 250 * 3;
  FTest := 'Value: ' + Random(22502).ToString + Random(25000).ToString;
end;

procedure TForm250.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum250;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj250_List0 := TMyObj250_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj250_List1 := TMyObj250_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
