...
type
  ...
  TMyObj8_List0 = TObjectList<TMyObj8>;

  TMyObj8_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj8_List1 = TObjectList<TMyObj8_1>;
...
constructor TMyObj8_1.Create;
begin
  inherited;
  FInt := 8 * 3;
  FTest := 'Value: ' + Random(282).ToString + Random(800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(80).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(85).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(87).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj8_List0 := TMyObj8_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj8_List1 := TMyObj8_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
