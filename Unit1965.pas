...
type
  ...
  TMyObj1965_List0 = TObjectList<TMyObj1965>;

  TMyObj1965_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1965_List1 = TObjectList<TMyObj1965_1>;
...
constructor TMyObj1965_1.Create;
begin
  inherited;
  FInt := 1965 * 3;
  FTest := 'Value: ' + Random(219652).ToString + Random(196500).ToString;
end;

procedure TForm1965.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1965;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1965_List0 := TMyObj1965_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1965_List1 := TMyObj1965_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
