...
type
  ...
  TMyObj1493_List0 = TObjectList<TMyObj1493>;

  TMyObj1493_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1493_List1 = TObjectList<TMyObj1493_1>;
...
constructor TMyObj1493_1.Create;
begin
  inherited;
  FInt := 1493 * 3;
  FTest := 'Value: ' + Random(214932).ToString + Random(149300).ToString;
end;

procedure TForm1493.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1493;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1493_List0 := TMyObj1493_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1493_List1 := TMyObj1493_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
