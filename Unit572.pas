...
type
  ...
  TMyObj572_List0 = TObjectList<TMyObj572>;

  TMyObj572_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj572_List1 = TObjectList<TMyObj572_1>;
...
constructor TMyObj572_1.Create;
begin
  inherited;
  FInt := 572 * 3;
  FTest := 'Value: ' + Random(25722).ToString + Random(57200).ToString;
end;

procedure TForm572.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum572;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj572_List0 := TMyObj572_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj572_List1 := TMyObj572_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
