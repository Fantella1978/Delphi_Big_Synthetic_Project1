...
type
  ...
  TMyObj1915_List0 = TObjectList<TMyObj1915>;

  TMyObj1915_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1915_List1 = TObjectList<TMyObj1915_1>;
...
constructor TMyObj1915_1.Create;
begin
  inherited;
  FInt := 1915 * 3;
  FTest := 'Value: ' + Random(219152).ToString + Random(191500).ToString;
end;

procedure TForm1915.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1915;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1915_List0 := TMyObj1915_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1915_List1 := TMyObj1915_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
