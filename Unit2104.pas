...
type
  ...
  TMyObj2104_List0 = TObjectList<TMyObj2104>;

  TMyObj2104_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2104_List1 = TObjectList<TMyObj2104_1>;
...
constructor TMyObj2104_1.Create;
begin
  inherited;
  FInt := 2104 * 3;
  FTest := 'Value: ' + Random(221042).ToString + Random(210400).ToString;
end;

procedure TForm2104.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2104;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2104_List0 := TMyObj2104_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2104_List1 := TMyObj2104_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
