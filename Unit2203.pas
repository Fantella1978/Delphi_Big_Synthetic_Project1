...
type
  ...
  TMyObj2203_List0 = TObjectList<TMyObj2203>;

  TMyObj2203_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2203_List1 = TObjectList<TMyObj2203_1>;
...
constructor TMyObj2203_1.Create;
begin
  inherited;
  FInt := 2203 * 3;
  FTest := 'Value: ' + Random(222032).ToString + Random(220300).ToString;
end;

procedure TForm2203.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2203;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2203_List0 := TMyObj2203_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2203_List1 := TMyObj2203_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
