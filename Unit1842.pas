...
type
  ...
  TMyObj1842_List0 = TObjectList<TMyObj1842>;

  TMyObj1842_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1842_List1 = TObjectList<TMyObj1842_1>;
...
constructor TMyObj1842_1.Create;
begin
  inherited;
  FInt := 1842 * 3;
  FTest := 'Value: ' + Random(218422).ToString + Random(184200).ToString;
end;

procedure TForm1842.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1842;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1842_List0 := TMyObj1842_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1842_List1 := TMyObj1842_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
