...
type
  ...
  TMyObj2334_List0 = TObjectList<TMyObj2334>;

  TMyObj2334_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2334_List1 = TObjectList<TMyObj2334_1>;
...
constructor TMyObj2334_1.Create;
begin
  inherited;
  FInt := 2334 * 3;
  FTest := 'Value: ' + Random(223342).ToString + Random(233400).ToString;
end;

procedure TForm2334.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2334;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2334_List0 := TMyObj2334_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2334_List1 := TMyObj2334_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
