...
type
  ...
  TMyObj1032_List0 = TObjectList<TMyObj1032>;

  TMyObj1032_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1032_List1 = TObjectList<TMyObj1032_1>;
...
constructor TMyObj1032_1.Create;
begin
  inherited;
  FInt := 1032 * 3;
  FTest := 'Value: ' + Random(210322).ToString + Random(103200).ToString;
end;

procedure TForm1032.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1032;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1032_List0 := TMyObj1032_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1032_List1 := TMyObj1032_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
