...
type
  ...
  TMyObj1954_List0 = TObjectList<TMyObj1954>;

  TMyObj1954_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1954_List1 = TObjectList<TMyObj1954_1>;
...
constructor TMyObj1954_1.Create;
begin
  inherited;
  FInt := 1954 * 3;
  FTest := 'Value: ' + Random(219542).ToString + Random(195400).ToString;
end;

procedure TForm1954.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1954;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1954_List0 := TMyObj1954_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1954_List1 := TMyObj1954_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
