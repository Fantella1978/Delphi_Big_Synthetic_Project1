...
type
  ...
  TMyObj2000_List0 = TObjectList<TMyObj2000>;

  TMyObj2000_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2000_List1 = TObjectList<TMyObj2000_1>;
...
constructor TMyObj2000_1.Create;
begin
  inherited;
  FInt := 2000 * 3;
  FTest := 'Value: ' + Random(220002).ToString + Random(200000).ToString;
end;

procedure TForm2000.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2000;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2000_List0 := TMyObj2000_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2000_List1 := TMyObj2000_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
