...
type
  ...
  TMyObj2253_List0 = TObjectList<TMyObj2253>;

  TMyObj2253_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2253_List1 = TObjectList<TMyObj2253_1>;
...
constructor TMyObj2253_1.Create;
begin
  inherited;
  FInt := 2253 * 3;
  FTest := 'Value: ' + Random(222532).ToString + Random(225300).ToString;
end;

procedure TForm2253.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2253;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2253_List0 := TMyObj2253_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2253_List1 := TMyObj2253_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
