...
type
  ...
  TMyObj2120_List0 = TObjectList<TMyObj2120>;

  TMyObj2120_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2120_List1 = TObjectList<TMyObj2120_1>;
...
constructor TMyObj2120_1.Create;
begin
  inherited;
  FInt := 2120 * 3;
  FTest := 'Value: ' + Random(221202).ToString + Random(212000).ToString;
end;

procedure TForm2120.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2120;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2120_List0 := TMyObj2120_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2120_List1 := TMyObj2120_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
