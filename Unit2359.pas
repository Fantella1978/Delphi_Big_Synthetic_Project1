...
type
  ...
  TMyObj2359_List0 = TObjectList<TMyObj2359>;

  TMyObj2359_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2359_List1 = TObjectList<TMyObj2359_1>;
...
constructor TMyObj2359_1.Create;
begin
  inherited;
  FInt := 2359 * 3;
  FTest := 'Value: ' + Random(223592).ToString + Random(235900).ToString;
end;

procedure TForm2359.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2359;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2359_List0 := TMyObj2359_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2359_List1 := TMyObj2359_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
