...
type
  ...
  TMyObj1540_List0 = TObjectList<TMyObj1540>;

  TMyObj1540_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1540_List1 = TObjectList<TMyObj1540_1>;
...
constructor TMyObj1540_1.Create;
begin
  inherited;
  FInt := 1540 * 3;
  FTest := 'Value: ' + Random(215402).ToString + Random(154000).ToString;
end;

procedure TForm1540.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1540;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1540_List0 := TMyObj1540_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1540_List1 := TMyObj1540_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
