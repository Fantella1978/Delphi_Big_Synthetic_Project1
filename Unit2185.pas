...
type
  ...
  TMyObj2185_List0 = TObjectList<TMyObj2185>;

  TMyObj2185_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2185_List1 = TObjectList<TMyObj2185_1>;
...
constructor TMyObj2185_1.Create;
begin
  inherited;
  FInt := 2185 * 3;
  FTest := 'Value: ' + Random(221852).ToString + Random(218500).ToString;
end;

procedure TForm2185.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2185;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2185_List0 := TMyObj2185_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2185_List1 := TMyObj2185_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
