...
type
  ...
  TMyObj1951_List0 = TObjectList<TMyObj1951>;

  TMyObj1951_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1951_List1 = TObjectList<TMyObj1951_1>;
...
constructor TMyObj1951_1.Create;
begin
  inherited;
  FInt := 1951 * 3;
  FTest := 'Value: ' + Random(219512).ToString + Random(195100).ToString;
end;

procedure TForm1951.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1951;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1951_List0 := TMyObj1951_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1951_List1 := TMyObj1951_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
