...
type
  ...
  TMyObj1963_List0 = TObjectList<TMyObj1963>;

  TMyObj1963_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1963_List1 = TObjectList<TMyObj1963_1>;
...
constructor TMyObj1963_1.Create;
begin
  inherited;
  FInt := 1963 * 3;
  FTest := 'Value: ' + Random(219632).ToString + Random(196300).ToString;
end;

procedure TForm1963.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1963;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1963_List0 := TMyObj1963_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1963_List1 := TMyObj1963_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
