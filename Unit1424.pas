...
type
  ...
  TMyObj1424_List0 = TObjectList<TMyObj1424>;

  TMyObj1424_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1424_List1 = TObjectList<TMyObj1424_1>;
...
constructor TMyObj1424_1.Create;
begin
  inherited;
  FInt := 1424 * 3;
  FTest := 'Value: ' + Random(214242).ToString + Random(142400).ToString;
end;

procedure TForm1424.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1424;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1424_List0 := TMyObj1424_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1424_List1 := TMyObj1424_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
