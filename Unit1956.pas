...
type
  ...
  TMyObj1956_List0 = TObjectList<TMyObj1956>;

  TMyObj1956_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1956_List1 = TObjectList<TMyObj1956_1>;
...
constructor TMyObj1956_1.Create;
begin
  inherited;
  FInt := 1956 * 3;
  FTest := 'Value: ' + Random(219562).ToString + Random(195600).ToString;
end;

procedure TForm1956.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1956;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1956_List0 := TMyObj1956_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1956_List1 := TMyObj1956_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
