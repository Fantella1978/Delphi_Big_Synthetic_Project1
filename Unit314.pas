...
type
  ...
  TMyObj314_List0 = TObjectList<TMyObj314>;

  TMyObj314_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj314_List1 = TObjectList<TMyObj314_1>;
...
constructor TMyObj314_1.Create;
begin
  inherited;
  FInt := 314 * 3;
  FTest := 'Value: ' + Random(23142).ToString + Random(31400).ToString;
end;

procedure TForm314.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum314;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj314_List0 := TMyObj314_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj314_List1 := TMyObj314_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
