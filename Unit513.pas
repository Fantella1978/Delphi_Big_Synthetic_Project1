...
type
  ...
  TMyObj513_List0 = TObjectList<TMyObj513>;

  TMyObj513_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj513_List1 = TObjectList<TMyObj513_1>;
...
constructor TMyObj513_1.Create;
begin
  inherited;
  FInt := 513 * 3;
  FTest := 'Value: ' + Random(25132).ToString + Random(51300).ToString;
end;

procedure TForm513.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum513;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj513_List0 := TMyObj513_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj513_List1 := TMyObj513_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
