...
type
  ...
  TMyObj1577_List0 = TObjectList<TMyObj1577>;

  TMyObj1577_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1577_List1 = TObjectList<TMyObj1577_1>;
...
constructor TMyObj1577_1.Create;
begin
  inherited;
  FInt := 1577 * 3;
  FTest := 'Value: ' + Random(215772).ToString + Random(157700).ToString;
end;

procedure TForm1577.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1577;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1577_List0 := TMyObj1577_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1577_List1 := TMyObj1577_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
