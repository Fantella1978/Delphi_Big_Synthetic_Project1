...
type
  ...
  TMyObj2437_List0 = TObjectList<TMyObj2437>;

  TMyObj2437_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2437_List1 = TObjectList<TMyObj2437_1>;
...
constructor TMyObj2437_1.Create;
begin
  inherited;
  FInt := 2437 * 3;
  FTest := 'Value: ' + Random(224372).ToString + Random(243700).ToString;
end;

procedure TForm2437.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2437;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2437_List0 := TMyObj2437_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2437_List1 := TMyObj2437_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
