...
type
  ...
  TMyObj290_List0 = TObjectList<TMyObj290>;

  TMyObj290_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj290_List1 = TObjectList<TMyObj290_1>;
...
constructor TMyObj290_1.Create;
begin
  inherited;
  FInt := 290 * 3;
  FTest := 'Value: ' + Random(22902).ToString + Random(29000).ToString;
end;

procedure TForm290.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum290;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj290_List0 := TMyObj290_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj290_List1 := TMyObj290_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
