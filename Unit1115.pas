...
type
  ...
  TMyObj1115_List0 = TObjectList<TMyObj1115>;

  TMyObj1115_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1115_List1 = TObjectList<TMyObj1115_1>;
...
constructor TMyObj1115_1.Create;
begin
  inherited;
  FInt := 1115 * 3;
  FTest := 'Value: ' + Random(211152).ToString + Random(111500).ToString;
end;

procedure TForm1115.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1115;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1115_List0 := TMyObj1115_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1115_List1 := TMyObj1115_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
