...
type
  ...
  TMyObj2495_List0 = TObjectList<TMyObj2495>;

  TMyObj2495_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2495_List1 = TObjectList<TMyObj2495_1>;
...
constructor TMyObj2495_1.Create;
begin
  inherited;
  FInt := 2495 * 3;
  FTest := 'Value: ' + Random(224952).ToString + Random(249500).ToString;
end;

procedure TForm2495.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2495;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2495_List0 := TMyObj2495_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2495_List1 := TMyObj2495_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
