...
type
  ...
  TMyObj1570_List0 = TObjectList<TMyObj1570>;

  TMyObj1570_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1570_List1 = TObjectList<TMyObj1570_1>;
...
constructor TMyObj1570_1.Create;
begin
  inherited;
  FInt := 1570 * 3;
  FTest := 'Value: ' + Random(215702).ToString + Random(157000).ToString;
end;

procedure TForm1570.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1570;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1570_List0 := TMyObj1570_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1570_List1 := TMyObj1570_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
