...
type
  ...
  TMyObj1689_List0 = TObjectList<TMyObj1689>;

  TMyObj1689_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1689_List1 = TObjectList<TMyObj1689_1>;
...
constructor TMyObj1689_1.Create;
begin
  inherited;
  FInt := 1689 * 3;
  FTest := 'Value: ' + Random(216892).ToString + Random(168900).ToString;
end;

procedure TForm1689.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1689;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1689_List0 := TMyObj1689_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1689_List1 := TMyObj1689_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
