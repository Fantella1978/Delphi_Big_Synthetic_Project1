...
type
  ...
  TMyObj1684_List0 = TObjectList<TMyObj1684>;

  TMyObj1684_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1684_List1 = TObjectList<TMyObj1684_1>;
...
constructor TMyObj1684_1.Create;
begin
  inherited;
  FInt := 1684 * 3;
  FTest := 'Value: ' + Random(216842).ToString + Random(168400).ToString;
end;

procedure TForm1684.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1684;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1684_List0 := TMyObj1684_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1684_List1 := TMyObj1684_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
