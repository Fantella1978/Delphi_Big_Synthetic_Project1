...
type
  ...
  TMyObj684_List0 = TObjectList<TMyObj684>;

  TMyObj684_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj684_List1 = TObjectList<TMyObj684_1>;
...
constructor TMyObj684_1.Create;
begin
  inherited;
  FInt := 684 * 3;
  FTest := 'Value: ' + Random(26842).ToString + Random(68400).ToString;
end;

procedure TForm684.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum684;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj684_List0 := TMyObj684_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj684_List1 := TMyObj684_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
