...
type
  ...
  TMyObj379_List0 = TObjectList<TMyObj379>;

  TMyObj379_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj379_List1 = TObjectList<TMyObj379_1>;
...
constructor TMyObj379_1.Create;
begin
  inherited;
  FInt := 379 * 3;
  FTest := 'Value: ' + Random(23792).ToString + Random(37900).ToString;
end;

procedure TForm379.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum379;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj379_List0 := TMyObj379_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj379_List1 := TMyObj379_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
