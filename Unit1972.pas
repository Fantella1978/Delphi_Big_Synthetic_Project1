...
type
  ...
  TMyObj1972_List0 = TObjectList<TMyObj1972>;

  TMyObj1972_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1972_List1 = TObjectList<TMyObj1972_1>;
...
constructor TMyObj1972_1.Create;
begin
  inherited;
  FInt := 1972 * 3;
  FTest := 'Value: ' + Random(219722).ToString + Random(197200).ToString;
end;

procedure TForm1972.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1972;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1972_List0 := TMyObj1972_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1972_List1 := TMyObj1972_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
