...
type
  ...
  TMyObj444_List0 = TObjectList<TMyObj444>;

  TMyObj444_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj444_List1 = TObjectList<TMyObj444_1>;
...
constructor TMyObj444_1.Create;
begin
  inherited;
  FInt := 444 * 3;
  FTest := 'Value: ' + Random(24442).ToString + Random(44400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj444_List0 := TMyObj444_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj444_List1 := TMyObj444_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
