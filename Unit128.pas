...
type
  ...
  TMyObj128_List0 = TObjectList<TMyObj128>;

  TMyObj128_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj128_List1 = TObjectList<TMyObj128_1>;
...
constructor TMyObj128_1.Create;
begin
  inherited;
  FInt := 128 * 3;
  FTest := 'Value: ' + Random(21282).ToString + Random(12800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj128_List0 := TMyObj128_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj128_List1 := TMyObj128_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
