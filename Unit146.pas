...
type
  ...
  TMyObj146_List0 = TObjectList<TMyObj146>;

  TMyObj146_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj146_List1 = TObjectList<TMyObj146_1>;
...
constructor TMyObj146_1.Create;
begin
  inherited;
  FInt := 146 * 3;
  FTest := 'Value: ' + Random(21462).ToString + Random(14600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj146_List0 := TMyObj146_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj146_List1 := TMyObj146_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
