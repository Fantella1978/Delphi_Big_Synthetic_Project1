...
type
  ...
  TMyObj2435_List0 = TObjectList<TMyObj2435>;

  TMyObj2435_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2435_List1 = TObjectList<TMyObj2435_1>;
...
constructor TMyObj2435_1.Create;
begin
  inherited;
  FInt := 2435 * 3;
  FTest := 'Value: ' + Random(224352).ToString + Random(243500).ToString;
end;

procedure TForm2435.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2435;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2435_List0 := TMyObj2435_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2435_List1 := TMyObj2435_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
