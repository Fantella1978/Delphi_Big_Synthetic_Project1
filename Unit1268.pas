...
type
  ...
  TMyObj1268_List0 = TObjectList<TMyObj1268>;

  TMyObj1268_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1268_List1 = TObjectList<TMyObj1268_1>;
...
constructor TMyObj1268_1.Create;
begin
  inherited;
  FInt := 1268 * 3;
  FTest := 'Value: ' + Random(212682).ToString + Random(126800).ToString;
end;

procedure TForm1268.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1268;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1268_List0 := TMyObj1268_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1268_List1 := TMyObj1268_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
