...
type
  ...
  TMyObj279_List0 = TObjectList<TMyObj279>;

  TMyObj279_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj279_List1 = TObjectList<TMyObj279_1>;
...
constructor TMyObj279_1.Create;
begin
  inherited;
  FInt := 279 * 3;
  FTest := 'Value: ' + Random(22792).ToString + Random(27900).ToString;
end;

procedure TForm279.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum279;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj279_List0 := TMyObj279_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj279_List1 := TMyObj279_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
