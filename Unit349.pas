...
type
  ...
  TMyObj349_List0 = TObjectList<TMyObj349>;

  TMyObj349_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj349_List1 = TObjectList<TMyObj349_1>;
...
constructor TMyObj349_1.Create;
begin
  inherited;
  FInt := 349 * 3;
  FTest := 'Value: ' + Random(23492).ToString + Random(34900).ToString;
end;

procedure TForm349.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum349;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj349_List0 := TMyObj349_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj349_List1 := TMyObj349_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
