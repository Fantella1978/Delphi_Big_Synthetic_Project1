...
type
  ...
  TMyObj1612_List0 = TObjectList<TMyObj1612>;

  TMyObj1612_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1612_List1 = TObjectList<TMyObj1612_1>;
...
constructor TMyObj1612_1.Create;
begin
  inherited;
  FInt := 1612 * 3;
  FTest := 'Value: ' + Random(216122).ToString + Random(161200).ToString;
end;

procedure TForm1612.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1612;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1612_List0 := TMyObj1612_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1612_List1 := TMyObj1612_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
