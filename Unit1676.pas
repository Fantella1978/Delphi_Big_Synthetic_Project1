...
type
  ...
  TMyObj1676_List0 = TObjectList<TMyObj1676>;

  TMyObj1676_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1676_List1 = TObjectList<TMyObj1676_1>;
...
constructor TMyObj1676_1.Create;
begin
  inherited;
  FInt := 1676 * 3;
  FTest := 'Value: ' + Random(216762).ToString + Random(167600).ToString;
end;

procedure TForm1676.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1676;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1676_List0 := TMyObj1676_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1676_List1 := TMyObj1676_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
