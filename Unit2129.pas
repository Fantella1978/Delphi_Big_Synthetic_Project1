...
type
  ...
  TMyObj2129_List0 = TObjectList<TMyObj2129>;

  TMyObj2129_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2129_List1 = TObjectList<TMyObj2129_1>;
...
constructor TMyObj2129_1.Create;
begin
  inherited;
  FInt := 2129 * 3;
  FTest := 'Value: ' + Random(221292).ToString + Random(212900).ToString;
end;

procedure TForm2129.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2129;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2129_List0 := TMyObj2129_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2129_List1 := TMyObj2129_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
