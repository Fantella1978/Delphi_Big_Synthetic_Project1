...
type
  ...
  TMyObj796_List0 = TObjectList<TMyObj796>;

  TMyObj796_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj796_List1 = TObjectList<TMyObj796_1>;
...
constructor TMyObj796_1.Create;
begin
  inherited;
  FInt := 796 * 3;
  FTest := 'Value: ' + Random(27962).ToString + Random(79600).ToString;
end;

procedure TForm796.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum796;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj796_List0 := TMyObj796_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj796_List1 := TMyObj796_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
