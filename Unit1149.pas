...
type
  ...
  TMyObj1149_List0 = TObjectList<TMyObj1149>;

  TMyObj1149_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1149_List1 = TObjectList<TMyObj1149_1>;
...
constructor TMyObj1149_1.Create;
begin
  inherited;
  FInt := 1149 * 3;
  FTest := 'Value: ' + Random(211492).ToString + Random(114900).ToString;
end;

procedure TForm1149.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1149;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1149_List0 := TMyObj1149_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1149_List1 := TMyObj1149_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
