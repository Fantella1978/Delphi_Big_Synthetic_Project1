...
type
  ...
  TMyObj499_List0 = TObjectList<TMyObj499>;

  TMyObj499_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj499_List1 = TObjectList<TMyObj499_1>;
...
constructor TMyObj499_1.Create;
begin
  inherited;
  FInt := 499 * 3;
  FTest := 'Value: ' + Random(24992).ToString + Random(49900).ToString;
end;

procedure TForm499.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum499;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj499_List0 := TMyObj499_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj499_List1 := TMyObj499_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
