...
type
  ...
  TMyObj1026_List0 = TObjectList<TMyObj1026>;

  TMyObj1026_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1026_List1 = TObjectList<TMyObj1026_1>;
...
constructor TMyObj1026_1.Create;
begin
  inherited;
  FInt := 1026 * 3;
  FTest := 'Value: ' + Random(210262).ToString + Random(102600).ToString;
end;

procedure TForm1026.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1026;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1026_List0 := TMyObj1026_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1026_List1 := TMyObj1026_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
