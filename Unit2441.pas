...
type
  ...
  TMyObj2441_List0 = TObjectList<TMyObj2441>;

  TMyObj2441_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2441_List1 = TObjectList<TMyObj2441_1>;
...
constructor TMyObj2441_1.Create;
begin
  inherited;
  FInt := 2441 * 3;
  FTest := 'Value: ' + Random(224412).ToString + Random(244100).ToString;
end;

procedure TForm2441.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2441;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2441_List0 := TMyObj2441_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2441_List1 := TMyObj2441_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
