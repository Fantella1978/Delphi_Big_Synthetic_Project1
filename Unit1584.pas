...
type
  ...
  TMyObj1584_List0 = TObjectList<TMyObj1584>;

  TMyObj1584_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1584_List1 = TObjectList<TMyObj1584_1>;
...
constructor TMyObj1584_1.Create;
begin
  inherited;
  FInt := 1584 * 3;
  FTest := 'Value: ' + Random(215842).ToString + Random(158400).ToString;
end;

procedure TForm1584.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1584;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1584_List0 := TMyObj1584_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1584_List1 := TMyObj1584_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
