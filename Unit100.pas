...
type
  ...
  TMyObj100_List0 = TObjectList<TMyObj100>;

  TMyObj100_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj100_List1 = TObjectList<TMyObj100_1>;
...
constructor TMyObj100_1.Create;
begin
  inherited;
  FInt := 100 * 3;
  FTest := 'Value: ' + Random(21002).ToString + Random(10000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj100_List0 := TMyObj100_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj100_List1 := TMyObj100_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
