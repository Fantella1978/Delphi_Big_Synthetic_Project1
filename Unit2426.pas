...
type
  ...
  TMyObj2426_List0 = TObjectList<TMyObj2426>;

  TMyObj2426_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2426_List1 = TObjectList<TMyObj2426_1>;
...
constructor TMyObj2426_1.Create;
begin
  inherited;
  FInt := 2426 * 3;
  FTest := 'Value: ' + Random(224262).ToString + Random(242600).ToString;
end;

procedure TForm2426.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2426;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2426_List0 := TMyObj2426_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2426_List1 := TMyObj2426_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
