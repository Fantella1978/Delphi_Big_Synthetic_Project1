...
type
  ...
  TMyObj1835_List0 = TObjectList<TMyObj1835>;

  TMyObj1835_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1835_List1 = TObjectList<TMyObj1835_1>;
...
constructor TMyObj1835_1.Create;
begin
  inherited;
  FInt := 1835 * 3;
  FTest := 'Value: ' + Random(218352).ToString + Random(183500).ToString;
end;

procedure TForm1835.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1835;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1835_List0 := TMyObj1835_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1835_List1 := TMyObj1835_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
