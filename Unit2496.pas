...
type
  ...
  TMyObj2496_List0 = TObjectList<TMyObj2496>;

  TMyObj2496_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2496_List1 = TObjectList<TMyObj2496_1>;
...
constructor TMyObj2496_1.Create;
begin
  inherited;
  FInt := 2496 * 3;
  FTest := 'Value: ' + Random(224962).ToString + Random(249600).ToString;
end;

procedure TForm2496.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2496;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2496_List0 := TMyObj2496_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2496_List1 := TMyObj2496_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
