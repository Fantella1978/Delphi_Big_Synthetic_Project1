...
type
  ...
  TMyObj1786_List0 = TObjectList<TMyObj1786>;

  TMyObj1786_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1786_List1 = TObjectList<TMyObj1786_1>;
...
constructor TMyObj1786_1.Create;
begin
  inherited;
  FInt := 1786 * 3;
  FTest := 'Value: ' + Random(217862).ToString + Random(178600).ToString;
end;

procedure TForm1786.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1786;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1786_List0 := TMyObj1786_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1786_List1 := TMyObj1786_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
