...
type
  ...
  TMyObj715_List0 = TObjectList<TMyObj715>;

  TMyObj715_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj715_List1 = TObjectList<TMyObj715_1>;
...
constructor TMyObj715_1.Create;
begin
  inherited;
  FInt := 715 * 3;
  FTest := 'Value: ' + Random(27152).ToString + Random(71500).ToString;
end;

procedure TForm715.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum715;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj715_List0 := TMyObj715_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj715_List1 := TMyObj715_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
