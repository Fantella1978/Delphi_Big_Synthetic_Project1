...
type
  ...
  TMyObj220_List0 = TObjectList<TMyObj220>;

  TMyObj220_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj220_List1 = TObjectList<TMyObj220_1>;
...
constructor TMyObj220_1.Create;
begin
  inherited;
  FInt := 220 * 3;
  FTest := 'Value: ' + Random(22202).ToString + Random(22000).ToString;
end;

procedure TForm220.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum220;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj220_List0 := TMyObj220_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj220_List1 := TMyObj220_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
