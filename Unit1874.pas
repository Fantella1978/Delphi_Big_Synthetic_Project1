...
type
  ...
  TMyObj1874_List0 = TObjectList<TMyObj1874>;

  TMyObj1874_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1874_List1 = TObjectList<TMyObj1874_1>;
...
constructor TMyObj1874_1.Create;
begin
  inherited;
  FInt := 1874 * 3;
  FTest := 'Value: ' + Random(218742).ToString + Random(187400).ToString;
end;

procedure TForm1874.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1874;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1874_List0 := TMyObj1874_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1874_List1 := TMyObj1874_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
