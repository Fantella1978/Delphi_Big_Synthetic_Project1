...
type
  ...
  TMyObj2390_List0 = TObjectList<TMyObj2390>;

  TMyObj2390_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2390_List1 = TObjectList<TMyObj2390_1>;
...
constructor TMyObj2390_1.Create;
begin
  inherited;
  FInt := 2390 * 3;
  FTest := 'Value: ' + Random(223902).ToString + Random(239000).ToString;
end;

procedure TForm2390.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2390;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2390_List0 := TMyObj2390_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2390_List1 := TMyObj2390_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
