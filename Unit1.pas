...
type
  ...
  TMyObj1_List0 = TObjectList<TMyObj1>;

  TMyObj1_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1_List1 = TObjectList<TMyObj1_1>;
...
constructor TMyObj1_1.Create;
begin
  inherited;
  FInt := 1 * 3;
  FTest := 'Value: ' + Random(212).ToString + Random(100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1_List0 := TMyObj1_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1_List1 := TMyObj1_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
