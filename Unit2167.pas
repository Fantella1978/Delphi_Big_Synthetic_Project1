...
type
  ...
  TMyObj2167_List0 = TObjectList<TMyObj2167>;

  TMyObj2167_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2167_List1 = TObjectList<TMyObj2167_1>;
...
constructor TMyObj2167_1.Create;
begin
  inherited;
  FInt := 2167 * 3;
  FTest := 'Value: ' + Random(221672).ToString + Random(216700).ToString;
end;

procedure TForm2167.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2167;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2167_List0 := TMyObj2167_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2167_List1 := TMyObj2167_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
