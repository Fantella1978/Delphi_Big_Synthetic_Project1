...
type
  ...
  TMyObj1313_List0 = TObjectList<TMyObj1313>;

  TMyObj1313_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1313_List1 = TObjectList<TMyObj1313_1>;
...
constructor TMyObj1313_1.Create;
begin
  inherited;
  FInt := 1313 * 3;
  FTest := 'Value: ' + Random(213132).ToString + Random(131300).ToString;
end;

procedure TForm1313.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1313;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1313_List0 := TMyObj1313_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1313_List1 := TMyObj1313_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
