...
type
  ...
  TMyObj1233_List0 = TObjectList<TMyObj1233>;

  TMyObj1233_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1233_List1 = TObjectList<TMyObj1233_1>;
...
constructor TMyObj1233_1.Create;
begin
  inherited;
  FInt := 1233 * 3;
  FTest := 'Value: ' + Random(212332).ToString + Random(123300).ToString;
end;

procedure TForm1233.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1233;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1233_List0 := TMyObj1233_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1233_List1 := TMyObj1233_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
