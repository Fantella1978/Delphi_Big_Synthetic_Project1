...
type
  ...
  TMyObj1574_List0 = TObjectList<TMyObj1574>;

  TMyObj1574_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1574_List1 = TObjectList<TMyObj1574_1>;
...
constructor TMyObj1574_1.Create;
begin
  inherited;
  FInt := 1574 * 3;
  FTest := 'Value: ' + Random(215742).ToString + Random(157400).ToString;
end;

procedure TForm1574.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1574;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1574_List0 := TMyObj1574_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1574_List1 := TMyObj1574_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
