...
type
  ...
  TMyObj524_List0 = TObjectList<TMyObj524>;

  TMyObj524_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj524_List1 = TObjectList<TMyObj524_1>;
...
constructor TMyObj524_1.Create;
begin
  inherited;
  FInt := 524 * 3;
  FTest := 'Value: ' + Random(25242).ToString + Random(52400).ToString;
end;

procedure TForm524.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum524;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj524_List0 := TMyObj524_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj524_List1 := TMyObj524_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
