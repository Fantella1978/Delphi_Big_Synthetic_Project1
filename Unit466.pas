...
type
  ...
  TMyObj466_List0 = TObjectList<TMyObj466>;

  TMyObj466_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj466_List1 = TObjectList<TMyObj466_1>;
...
constructor TMyObj466_1.Create;
begin
  inherited;
  FInt := 466 * 3;
  FTest := 'Value: ' + Random(24662).ToString + Random(46600).ToString;
end;

procedure TForm466.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum466;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj466_List0 := TMyObj466_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj466_List1 := TMyObj466_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
