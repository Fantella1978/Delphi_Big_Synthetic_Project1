...
type
  ...
  TMyObj2138_List0 = TObjectList<TMyObj2138>;

  TMyObj2138_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2138_List1 = TObjectList<TMyObj2138_1>;
...
constructor TMyObj2138_1.Create;
begin
  inherited;
  FInt := 2138 * 3;
  FTest := 'Value: ' + Random(221382).ToString + Random(213800).ToString;
end;

procedure TForm2138.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2138;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2138_List0 := TMyObj2138_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2138_List1 := TMyObj2138_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
