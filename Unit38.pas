...
type
  ...
  TMyObj38_List0 = TObjectList<TMyObj38>;

  TMyObj38_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj38_List1 = TObjectList<TMyObj38_1>;
...
constructor TMyObj38_1.Create;
begin
  inherited;
  FInt := 38 * 3;
  FTest := 'Value: ' + Random(2382).ToString + Random(3800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj38_List0 := TMyObj38_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj38_List1 := TMyObj38_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
