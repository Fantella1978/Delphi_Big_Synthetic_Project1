...
type
  ...
  TMyObj1072_List0 = TObjectList<TMyObj1072>;

  TMyObj1072_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1072_List1 = TObjectList<TMyObj1072_1>;
...
constructor TMyObj1072_1.Create;
begin
  inherited;
  FInt := 1072 * 3;
  FTest := 'Value: ' + Random(210722).ToString + Random(107200).ToString;
end;

procedure TForm1072.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1072;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1072_List0 := TMyObj1072_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1072_List1 := TMyObj1072_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
