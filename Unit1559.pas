...
type
  ...
  TMyObj1559_List0 = TObjectList<TMyObj1559>;

  TMyObj1559_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1559_List1 = TObjectList<TMyObj1559_1>;
...
constructor TMyObj1559_1.Create;
begin
  inherited;
  FInt := 1559 * 3;
  FTest := 'Value: ' + Random(215592).ToString + Random(155900).ToString;
end;

procedure TForm1559.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1559;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1559_List0 := TMyObj1559_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1559_List1 := TMyObj1559_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
