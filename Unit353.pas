...
type
  ...
  TMyObj353_List0 = TObjectList<TMyObj353>;

  TMyObj353_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj353_List1 = TObjectList<TMyObj353_1>;
...
constructor TMyObj353_1.Create;
begin
  inherited;
  FInt := 353 * 3;
  FTest := 'Value: ' + Random(23532).ToString + Random(35300).ToString;
end;

procedure TForm353.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum353;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj353_List0 := TMyObj353_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj353_List1 := TMyObj353_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
