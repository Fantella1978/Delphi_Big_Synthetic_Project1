...
type
  ...
  TMyObj1995_List0 = TObjectList<TMyObj1995>;

  TMyObj1995_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1995_List1 = TObjectList<TMyObj1995_1>;
...
constructor TMyObj1995_1.Create;
begin
  inherited;
  FInt := 1995 * 3;
  FTest := 'Value: ' + Random(219952).ToString + Random(199500).ToString;
end;

procedure TForm1995.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1995;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1995_List0 := TMyObj1995_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1995_List1 := TMyObj1995_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
