...
type
  ...
  TMyObj1167_List0 = TObjectList<TMyObj1167>;

  TMyObj1167_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1167_List1 = TObjectList<TMyObj1167_1>;
...
constructor TMyObj1167_1.Create;
begin
  inherited;
  FInt := 1167 * 3;
  FTest := 'Value: ' + Random(211672).ToString + Random(116700).ToString;
end;

procedure TForm1167.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1167;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1167_List0 := TMyObj1167_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1167_List1 := TMyObj1167_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
