...
type
  ...
  TMyObj2320_List0 = TObjectList<TMyObj2320>;

  TMyObj2320_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2320_List1 = TObjectList<TMyObj2320_1>;
...
constructor TMyObj2320_1.Create;
begin
  inherited;
  FInt := 2320 * 3;
  FTest := 'Value: ' + Random(223202).ToString + Random(232000).ToString;
end;

procedure TForm2320.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2320;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2320_List0 := TMyObj2320_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2320_List1 := TMyObj2320_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
