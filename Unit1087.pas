...
type
  ...
  TMyObj1087_List0 = TObjectList<TMyObj1087>;

  TMyObj1087_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1087_List1 = TObjectList<TMyObj1087_1>;
...
constructor TMyObj1087_1.Create;
begin
  inherited;
  FInt := 1087 * 3;
  FTest := 'Value: ' + Random(210872).ToString + Random(108700).ToString;
end;

procedure TForm1087.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1087;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1087_List0 := TMyObj1087_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1087_List1 := TMyObj1087_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
