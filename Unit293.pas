...
type
  ...
  TMyObj293_List0 = TObjectList<TMyObj293>;

  TMyObj293_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj293_List1 = TObjectList<TMyObj293_1>;
...
constructor TMyObj293_1.Create;
begin
  inherited;
  FInt := 293 * 3;
  FTest := 'Value: ' + Random(22932).ToString + Random(29300).ToString;
end;

procedure TForm293.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum293;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj293_List0 := TMyObj293_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj293_List1 := TMyObj293_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
