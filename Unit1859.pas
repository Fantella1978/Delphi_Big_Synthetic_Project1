...
type
  ...
  TMyObj1859_List0 = TObjectList<TMyObj1859>;

  TMyObj1859_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1859_List1 = TObjectList<TMyObj1859_1>;
...
constructor TMyObj1859_1.Create;
begin
  inherited;
  FInt := 1859 * 3;
  FTest := 'Value: ' + Random(218592).ToString + Random(185900).ToString;
end;

procedure TForm1859.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1859;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1859_List0 := TMyObj1859_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1859_List1 := TMyObj1859_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
