...
type
  ...
  TMyObj1880_List0 = TObjectList<TMyObj1880>;

  TMyObj1880_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1880_List1 = TObjectList<TMyObj1880_1>;
...
constructor TMyObj1880_1.Create;
begin
  inherited;
  FInt := 1880 * 3;
  FTest := 'Value: ' + Random(218802).ToString + Random(188000).ToString;
end;

procedure TForm1880.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1880;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1880_List0 := TMyObj1880_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1880_List1 := TMyObj1880_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
