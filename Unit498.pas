...
type
  ...
  TMyObj498_List0 = TObjectList<TMyObj498>;

  TMyObj498_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj498_List1 = TObjectList<TMyObj498_1>;
...
constructor TMyObj498_1.Create;
begin
  inherited;
  FInt := 498 * 3;
  FTest := 'Value: ' + Random(24982).ToString + Random(49800).ToString;
end;

procedure TForm498.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum498;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj498_List0 := TMyObj498_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj498_List1 := TMyObj498_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
