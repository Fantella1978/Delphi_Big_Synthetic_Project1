...
type
  ...
  TMyObj714_List0 = TObjectList<TMyObj714>;

  TMyObj714_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj714_List1 = TObjectList<TMyObj714_1>;
...
constructor TMyObj714_1.Create;
begin
  inherited;
  FInt := 714 * 3;
  FTest := 'Value: ' + Random(27142).ToString + Random(71400).ToString;
end;

procedure TForm714.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum714;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj714_List0 := TMyObj714_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj714_List1 := TMyObj714_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
