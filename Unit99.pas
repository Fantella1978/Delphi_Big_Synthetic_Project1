...
type
  ...
  TMyObj99_List0 = TObjectList<TMyObj99>;

  TMyObj99_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj99_List1 = TObjectList<TMyObj99_1>;
...
constructor TMyObj99_1.Create;
begin
  inherited;
  FInt := 99 * 3;
  FTest := 'Value: ' + Random(2992).ToString + Random(9900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj99_List0 := TMyObj99_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj99_List1 := TMyObj99_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
