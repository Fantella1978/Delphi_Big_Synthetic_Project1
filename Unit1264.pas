...
type
  ...
  TMyObj1264_List0 = TObjectList<TMyObj1264>;

  TMyObj1264_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1264_List1 = TObjectList<TMyObj1264_1>;
...
constructor TMyObj1264_1.Create;
begin
  inherited;
  FInt := 1264 * 3;
  FTest := 'Value: ' + Random(212642).ToString + Random(126400).ToString;
end;

procedure TForm1264.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1264;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1264_List0 := TMyObj1264_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1264_List1 := TMyObj1264_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
