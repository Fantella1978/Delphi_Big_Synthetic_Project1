...
type
  ...
  TMyObj1714_List0 = TObjectList<TMyObj1714>;

  TMyObj1714_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1714_List1 = TObjectList<TMyObj1714_1>;
...
constructor TMyObj1714_1.Create;
begin
  inherited;
  FInt := 1714 * 3;
  FTest := 'Value: ' + Random(217142).ToString + Random(171400).ToString;
end;

procedure TForm1714.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1714;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1714_List0 := TMyObj1714_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1714_List1 := TMyObj1714_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
