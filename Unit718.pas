...
type
  ...
  TMyObj718_List0 = TObjectList<TMyObj718>;

  TMyObj718_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj718_List1 = TObjectList<TMyObj718_1>;
...
constructor TMyObj718_1.Create;
begin
  inherited;
  FInt := 718 * 3;
  FTest := 'Value: ' + Random(27182).ToString + Random(71800).ToString;
end;

procedure TForm718.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum718;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj718_List0 := TMyObj718_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj718_List1 := TMyObj718_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
