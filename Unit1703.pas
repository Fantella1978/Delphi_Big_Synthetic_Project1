...
type
  ...
  TMyObj1703_List0 = TObjectList<TMyObj1703>;

  TMyObj1703_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1703_List1 = TObjectList<TMyObj1703_1>;
...
constructor TMyObj1703_1.Create;
begin
  inherited;
  FInt := 1703 * 3;
  FTest := 'Value: ' + Random(217032).ToString + Random(170300).ToString;
end;

procedure TForm1703.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1703;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1703_List0 := TMyObj1703_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1703_List1 := TMyObj1703_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
