...
type
  ...
  TMyObj50_List0 = TObjectList<TMyObj50>;

  TMyObj50_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj50_List1 = TObjectList<TMyObj50_1>;
...
constructor TMyObj50_1.Create;
begin
  inherited;
  FInt := 50 * 3;
  FTest := 'Value: ' + Random(2502).ToString + Random(5000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj50_List0 := TMyObj50_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj50_List1 := TMyObj50_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
