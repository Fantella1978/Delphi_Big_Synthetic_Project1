...
type
  ...
  TMyObj1665_List0 = TObjectList<TMyObj1665>;

  TMyObj1665_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1665_List1 = TObjectList<TMyObj1665_1>;
...
constructor TMyObj1665_1.Create;
begin
  inherited;
  FInt := 1665 * 3;
  FTest := 'Value: ' + Random(216652).ToString + Random(166500).ToString;
end;

procedure TForm1665.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1665;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1665_List0 := TMyObj1665_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1665_List1 := TMyObj1665_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
