...
type
  ...
  TMyObj219_List0 = TObjectList<TMyObj219>;

  TMyObj219_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj219_List1 = TObjectList<TMyObj219_1>;
...
constructor TMyObj219_1.Create;
begin
  inherited;
  FInt := 219 * 3;
  FTest := 'Value: ' + Random(22192).ToString + Random(21900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj219_List0 := TMyObj219_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj219_List1 := TMyObj219_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
