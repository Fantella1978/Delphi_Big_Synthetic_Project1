...
type
  ...
  TMyObj1707_List0 = TObjectList<TMyObj1707>;

  TMyObj1707_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1707_List1 = TObjectList<TMyObj1707_1>;
...
constructor TMyObj1707_1.Create;
begin
  inherited;
  FInt := 1707 * 3;
  FTest := 'Value: ' + Random(217072).ToString + Random(170700).ToString;
end;

procedure TForm1707.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1707;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1707_List0 := TMyObj1707_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1707_List1 := TMyObj1707_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
