...
type
  ...
  TMyObj1806_List0 = TObjectList<TMyObj1806>;

  TMyObj1806_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1806_List1 = TObjectList<TMyObj1806_1>;
...
constructor TMyObj1806_1.Create;
begin
  inherited;
  FInt := 1806 * 3;
  FTest := 'Value: ' + Random(218062).ToString + Random(180600).ToString;
end;

procedure TForm1806.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1806;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1806_List0 := TMyObj1806_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1806_List1 := TMyObj1806_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
