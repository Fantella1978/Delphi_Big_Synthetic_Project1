...
type
  ...
  TMyObj231_List0 = TObjectList<TMyObj231>;

  TMyObj231_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj231_List1 = TObjectList<TMyObj231_1>;
...
constructor TMyObj231_1.Create;
begin
  inherited;
  FInt := 231 * 3;
  FTest := 'Value: ' + Random(22312).ToString + Random(23100).ToString;
end;

procedure TForm231.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum231;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj231_List0 := TMyObj231_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj231_List1 := TMyObj231_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
