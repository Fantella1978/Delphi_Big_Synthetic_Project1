...
type
  ...
  TMyObj611_List0 = TObjectList<TMyObj611>;

  TMyObj611_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj611_List1 = TObjectList<TMyObj611_1>;
...
constructor TMyObj611_1.Create;
begin
  inherited;
  FInt := 611 * 3;
  FTest := 'Value: ' + Random(26112).ToString + Random(61100).ToString;
end;

procedure TForm611.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum611;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj611_List0 := TMyObj611_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj611_List1 := TMyObj611_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
