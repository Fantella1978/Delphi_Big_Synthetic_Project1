...
type
  ...
  TMyObj673_List0 = TObjectList<TMyObj673>;

  TMyObj673_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj673_List1 = TObjectList<TMyObj673_1>;
...
constructor TMyObj673_1.Create;
begin
  inherited;
  FInt := 673 * 3;
  FTest := 'Value: ' + Random(26732).ToString + Random(67300).ToString;
end;

procedure TForm673.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum673;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj673_List0 := TMyObj673_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj673_List1 := TMyObj673_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
