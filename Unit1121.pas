...
type
  ...
  TMyObj1121_List0 = TObjectList<TMyObj1121>;

  TMyObj1121_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1121_List1 = TObjectList<TMyObj1121_1>;
...
constructor TMyObj1121_1.Create;
begin
  inherited;
  FInt := 1121 * 3;
  FTest := 'Value: ' + Random(211212).ToString + Random(112100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1121_List0 := TMyObj1121_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1121_List1 := TMyObj1121_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
