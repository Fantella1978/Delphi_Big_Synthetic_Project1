...
type
  ...
  TMyObj2146_List0 = TObjectList<TMyObj2146>;

  TMyObj2146_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2146_List1 = TObjectList<TMyObj2146_1>;
...
constructor TMyObj2146_1.Create;
begin
  inherited;
  FInt := 2146 * 3;
  FTest := 'Value: ' + Random(221462).ToString + Random(214600).ToString;
end;

procedure TForm2146.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2146;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2146_List0 := TMyObj2146_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2146_List1 := TMyObj2146_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
