...
type
  ...
  TMyObj1987_List0 = TObjectList<TMyObj1987>;

  TMyObj1987_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1987_List1 = TObjectList<TMyObj1987_1>;
...
constructor TMyObj1987_1.Create;
begin
  inherited;
  FInt := 1987 * 3;
  FTest := 'Value: ' + Random(219872).ToString + Random(198700).ToString;
end;

procedure TForm1987.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1987;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1987_List0 := TMyObj1987_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1987_List1 := TMyObj1987_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
