...
type
  ...
  TMyObj2325_List0 = TObjectList<TMyObj2325>;

  TMyObj2325_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2325_List1 = TObjectList<TMyObj2325_1>;
...
constructor TMyObj2325_1.Create;
begin
  inherited;
  FInt := 2325 * 3;
  FTest := 'Value: ' + Random(223252).ToString + Random(232500).ToString;
end;

procedure TForm2325.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2325;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2325_List0 := TMyObj2325_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2325_List1 := TMyObj2325_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
