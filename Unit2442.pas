...
type
  ...
  TMyObj2442_List0 = TObjectList<TMyObj2442>;

  TMyObj2442_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2442_List1 = TObjectList<TMyObj2442_1>;
...
constructor TMyObj2442_1.Create;
begin
  inherited;
  FInt := 2442 * 3;
  FTest := 'Value: ' + Random(224422).ToString + Random(244200).ToString;
end;

procedure TForm2442.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2442;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2442_List0 := TMyObj2442_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2442_List1 := TMyObj2442_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
