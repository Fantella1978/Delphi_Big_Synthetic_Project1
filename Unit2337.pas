...
type
  ...
  TMyObj2337_List0 = TObjectList<TMyObj2337>;

  TMyObj2337_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2337_List1 = TObjectList<TMyObj2337_1>;
...
constructor TMyObj2337_1.Create;
begin
  inherited;
  FInt := 2337 * 3;
  FTest := 'Value: ' + Random(223372).ToString + Random(233700).ToString;
end;

procedure TForm2337.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2337;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2337_List0 := TMyObj2337_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2337_List1 := TMyObj2337_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
