...
type
  ...
  TMyObj1569_List0 = TObjectList<TMyObj1569>;

  TMyObj1569_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1569_List1 = TObjectList<TMyObj1569_1>;
...
constructor TMyObj1569_1.Create;
begin
  inherited;
  FInt := 1569 * 3;
  FTest := 'Value: ' + Random(215692).ToString + Random(156900).ToString;
end;

procedure TForm1569.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1569;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1569_List0 := TMyObj1569_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1569_List1 := TMyObj1569_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
