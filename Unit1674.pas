...
type
  ...
  TMyObj1674_List0 = TObjectList<TMyObj1674>;

  TMyObj1674_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1674_List1 = TObjectList<TMyObj1674_1>;
...
constructor TMyObj1674_1.Create;
begin
  inherited;
  FInt := 1674 * 3;
  FTest := 'Value: ' + Random(216742).ToString + Random(167400).ToString;
end;

procedure TForm1674.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1674;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1674_List0 := TMyObj1674_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1674_List1 := TMyObj1674_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
