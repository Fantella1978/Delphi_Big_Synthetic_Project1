...
type
  ...
  TMyObj1370_List0 = TObjectList<TMyObj1370>;

  TMyObj1370_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1370_List1 = TObjectList<TMyObj1370_1>;
...
constructor TMyObj1370_1.Create;
begin
  inherited;
  FInt := 1370 * 3;
  FTest := 'Value: ' + Random(213702).ToString + Random(137000).ToString;
end;

procedure TForm1370.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1370;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1370_List0 := TMyObj1370_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1370_List1 := TMyObj1370_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
