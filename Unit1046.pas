...
type
  ...
  TMyObj1046_List0 = TObjectList<TMyObj1046>;

  TMyObj1046_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1046_List1 = TObjectList<TMyObj1046_1>;
...
constructor TMyObj1046_1.Create;
begin
  inherited;
  FInt := 1046 * 3;
  FTest := 'Value: ' + Random(210462).ToString + Random(104600).ToString;
end;

procedure TForm1046.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1046;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1046_List0 := TMyObj1046_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1046_List1 := TMyObj1046_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
