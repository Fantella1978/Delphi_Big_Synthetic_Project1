...
type
  ...
  TMyObj1189_List0 = TObjectList<TMyObj1189>;

  TMyObj1189_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1189_List1 = TObjectList<TMyObj1189_1>;
...
constructor TMyObj1189_1.Create;
begin
  inherited;
  FInt := 1189 * 3;
  FTest := 'Value: ' + Random(211892).ToString + Random(118900).ToString;
end;

procedure TForm1189.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1189;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1189_List0 := TMyObj1189_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1189_List1 := TMyObj1189_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
