...
type
  ...
  TMyObj1632_List0 = TObjectList<TMyObj1632>;

  TMyObj1632_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1632_List1 = TObjectList<TMyObj1632_1>;
...
constructor TMyObj1632_1.Create;
begin
  inherited;
  FInt := 1632 * 3;
  FTest := 'Value: ' + Random(216322).ToString + Random(163200).ToString;
end;

procedure TForm1632.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1632;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1632_List0 := TMyObj1632_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1632_List1 := TMyObj1632_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
