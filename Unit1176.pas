...
type
  ...
  TMyObj1176_List0 = TObjectList<TMyObj1176>;

  TMyObj1176_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1176_List1 = TObjectList<TMyObj1176_1>;
...
constructor TMyObj1176_1.Create;
begin
  inherited;
  FInt := 1176 * 3;
  FTest := 'Value: ' + Random(211762).ToString + Random(117600).ToString;
end;

procedure TForm1176.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1176;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1176_List0 := TMyObj1176_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1176_List1 := TMyObj1176_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
