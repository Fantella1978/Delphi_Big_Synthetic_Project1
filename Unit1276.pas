...
type
  ...
  TMyObj1276_List0 = TObjectList<TMyObj1276>;

  TMyObj1276_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1276_List1 = TObjectList<TMyObj1276_1>;
...
constructor TMyObj1276_1.Create;
begin
  inherited;
  FInt := 1276 * 3;
  FTest := 'Value: ' + Random(212762).ToString + Random(127600).ToString;
end;

procedure TForm1276.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1276;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1276_List0 := TMyObj1276_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1276_List1 := TMyObj1276_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
