...
type
  ...
  TMyObj423_List0 = TObjectList<TMyObj423>;

  TMyObj423_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj423_List1 = TObjectList<TMyObj423_1>;
...
constructor TMyObj423_1.Create;
begin
  inherited;
  FInt := 423 * 3;
  FTest := 'Value: ' + Random(24232).ToString + Random(42300).ToString;
end;

procedure TForm423.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum423;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj423_List0 := TMyObj423_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj423_List1 := TMyObj423_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
