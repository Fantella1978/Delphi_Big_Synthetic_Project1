...
type
  ...
  TMyObj238_List0 = TObjectList<TMyObj238>;

  TMyObj238_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj238_List1 = TObjectList<TMyObj238_1>;
...
constructor TMyObj238_1.Create;
begin
  inherited;
  FInt := 238 * 3;
  FTest := 'Value: ' + Random(22382).ToString + Random(23800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj238_List0 := TMyObj238_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj238_List1 := TMyObj238_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
