...
type
  ...
  TMyObj497_List0 = TObjectList<TMyObj497>;

  TMyObj497_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj497_List1 = TObjectList<TMyObj497_1>;
...
constructor TMyObj497_1.Create;
begin
  inherited;
  FInt := 497 * 3;
  FTest := 'Value: ' + Random(24972).ToString + Random(49700).ToString;
end;

procedure TForm497.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum497;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj497_List0 := TMyObj497_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj497_List1 := TMyObj497_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
