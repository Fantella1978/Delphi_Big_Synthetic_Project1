...
type
  ...
  TMyObj1317_List0 = TObjectList<TMyObj1317>;

  TMyObj1317_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1317_List1 = TObjectList<TMyObj1317_1>;
...
constructor TMyObj1317_1.Create;
begin
  inherited;
  FInt := 1317 * 3;
  FTest := 'Value: ' + Random(213172).ToString + Random(131700).ToString;
end;

procedure TForm1317.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1317;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1317_List0 := TMyObj1317_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1317_List1 := TMyObj1317_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
