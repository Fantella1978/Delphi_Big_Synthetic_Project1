...
type
  ...
  TMyObj2033_List0 = TObjectList<TMyObj2033>;

  TMyObj2033_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2033_List1 = TObjectList<TMyObj2033_1>;
...
constructor TMyObj2033_1.Create;
begin
  inherited;
  FInt := 2033 * 3;
  FTest := 'Value: ' + Random(220332).ToString + Random(203300).ToString;
end;

procedure TForm2033.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2033;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2033_List0 := TMyObj2033_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2033_List1 := TMyObj2033_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
