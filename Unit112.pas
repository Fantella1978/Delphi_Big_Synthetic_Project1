...
type
  ...
  TMyObj112_List0 = TObjectList<TMyObj112>;

  TMyObj112_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj112_List1 = TObjectList<TMyObj112_1>;
...
constructor TMyObj112_1.Create;
begin
  inherited;
  FInt := 112 * 3;
  FTest := 'Value: ' + Random(21122).ToString + Random(11200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj112_List0 := TMyObj112_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj112_List1 := TMyObj112_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
