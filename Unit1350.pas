...
type
  ...
  TMyObj1350_List0 = TObjectList<TMyObj1350>;

  TMyObj1350_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1350_List1 = TObjectList<TMyObj1350_1>;
...
constructor TMyObj1350_1.Create;
begin
  inherited;
  FInt := 1350 * 3;
  FTest := 'Value: ' + Random(213502).ToString + Random(135000).ToString;
end;

procedure TForm1350.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1350;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1350_List0 := TMyObj1350_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1350_List1 := TMyObj1350_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
