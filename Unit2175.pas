...
type
  ...
  TMyObj2175_List0 = TObjectList<TMyObj2175>;

  TMyObj2175_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2175_List1 = TObjectList<TMyObj2175_1>;
...
constructor TMyObj2175_1.Create;
begin
  inherited;
  FInt := 2175 * 3;
  FTest := 'Value: ' + Random(221752).ToString + Random(217500).ToString;
end;

procedure TForm2175.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2175;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2175_List0 := TMyObj2175_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2175_List1 := TMyObj2175_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
