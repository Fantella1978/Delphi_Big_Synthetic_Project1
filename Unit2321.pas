...
type
  ...
  TMyObj2321_List0 = TObjectList<TMyObj2321>;

  TMyObj2321_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2321_List1 = TObjectList<TMyObj2321_1>;
...
constructor TMyObj2321_1.Create;
begin
  inherited;
  FInt := 2321 * 3;
  FTest := 'Value: ' + Random(223212).ToString + Random(232100).ToString;
end;

procedure TForm2321.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2321;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2321_List0 := TMyObj2321_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2321_List1 := TMyObj2321_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
