...
type
  ...
  TMyObj656_List0 = TObjectList<TMyObj656>;

  TMyObj656_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj656_List1 = TObjectList<TMyObj656_1>;
...
constructor TMyObj656_1.Create;
begin
  inherited;
  FInt := 656 * 3;
  FTest := 'Value: ' + Random(26562).ToString + Random(65600).ToString;
end;

procedure TForm656.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum656;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj656_List0 := TMyObj656_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj656_List1 := TMyObj656_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
