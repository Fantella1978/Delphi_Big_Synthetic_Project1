...
type
  ...
  TMyObj633_List0 = TObjectList<TMyObj633>;

  TMyObj633_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj633_List1 = TObjectList<TMyObj633_1>;
...
constructor TMyObj633_1.Create;
begin
  inherited;
  FInt := 633 * 3;
  FTest := 'Value: ' + Random(26332).ToString + Random(63300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj633_List0 := TMyObj633_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj633_List1 := TMyObj633_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
