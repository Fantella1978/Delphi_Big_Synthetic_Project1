...
type
  ...
  TMyObj168_List0 = TObjectList<TMyObj168>;

  TMyObj168_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj168_List1 = TObjectList<TMyObj168_1>;
...
constructor TMyObj168_1.Create;
begin
  inherited;
  FInt := 168 * 3;
  FTest := 'Value: ' + Random(21682).ToString + Random(16800).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj168_List0 := TMyObj168_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj168_List1 := TMyObj168_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
