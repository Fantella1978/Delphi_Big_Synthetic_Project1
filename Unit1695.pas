...
type
  ...
  TMyObj1695_List0 = TObjectList<TMyObj1695>;

  TMyObj1695_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1695_List1 = TObjectList<TMyObj1695_1>;
...
constructor TMyObj1695_1.Create;
begin
  inherited;
  FInt := 1695 * 3;
  FTest := 'Value: ' + Random(216952).ToString + Random(169500).ToString;
end;

procedure TForm1695.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1695;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1695_List0 := TMyObj1695_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1695_List1 := TMyObj1695_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
