...
type
  ...
  TMyObj2363_List0 = TObjectList<TMyObj2363>;

  TMyObj2363_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2363_List1 = TObjectList<TMyObj2363_1>;
...
constructor TMyObj2363_1.Create;
begin
  inherited;
  FInt := 2363 * 3;
  FTest := 'Value: ' + Random(223632).ToString + Random(236300).ToString;
end;

procedure TForm2363.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2363;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2363_List0 := TMyObj2363_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2363_List1 := TMyObj2363_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
