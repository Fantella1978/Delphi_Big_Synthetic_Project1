...
type
  ...
  TMyObj1705_List0 = TObjectList<TMyObj1705>;

  TMyObj1705_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1705_List1 = TObjectList<TMyObj1705_1>;
...
constructor TMyObj1705_1.Create;
begin
  inherited;
  FInt := 1705 * 3;
  FTest := 'Value: ' + Random(217052).ToString + Random(170500).ToString;
end;

procedure TForm1705.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1705;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1705_List0 := TMyObj1705_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1705_List1 := TMyObj1705_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
