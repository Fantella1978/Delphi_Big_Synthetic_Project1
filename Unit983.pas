...
type
  ...
  TMyObj983_List0 = TObjectList<TMyObj983>;

  TMyObj983_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj983_List1 = TObjectList<TMyObj983_1>;
...
constructor TMyObj983_1.Create;
begin
  inherited;
  FInt := 983 * 3;
  FTest := 'Value: ' + Random(29832).ToString + Random(98300).ToString;
end;

procedure TForm983.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum983;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj983_List0 := TMyObj983_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj983_List1 := TMyObj983_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
