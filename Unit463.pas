...
type
  ...
  TMyObj463_List0 = TObjectList<TMyObj463>;

  TMyObj463_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj463_List1 = TObjectList<TMyObj463_1>;
...
constructor TMyObj463_1.Create;
begin
  inherited;
  FInt := 463 * 3;
  FTest := 'Value: ' + Random(24632).ToString + Random(46300).ToString;
end;

procedure TForm463.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum463;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj463_List0 := TMyObj463_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj463_List1 := TMyObj463_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
