...
type
  ...
  TMyObj1343_List0 = TObjectList<TMyObj1343>;

  TMyObj1343_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1343_List1 = TObjectList<TMyObj1343_1>;
...
constructor TMyObj1343_1.Create;
begin
  inherited;
  FInt := 1343 * 3;
  FTest := 'Value: ' + Random(213432).ToString + Random(134300).ToString;
end;

procedure TForm1343.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1343;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1343_List0 := TMyObj1343_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1343_List1 := TMyObj1343_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
