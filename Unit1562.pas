...
type
  ...
  TMyObj1562_List0 = TObjectList<TMyObj1562>;

  TMyObj1562_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1562_List1 = TObjectList<TMyObj1562_1>;
...
constructor TMyObj1562_1.Create;
begin
  inherited;
  FInt := 1562 * 3;
  FTest := 'Value: ' + Random(215622).ToString + Random(156200).ToString;
end;

procedure TForm1562.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1562;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1562_List0 := TMyObj1562_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1562_List1 := TMyObj1562_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
