...
type
  ...
  TMyObj808_List0 = TObjectList<TMyObj808>;

  TMyObj808_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj808_List1 = TObjectList<TMyObj808_1>;
...
constructor TMyObj808_1.Create;
begin
  inherited;
  FInt := 808 * 3;
  FTest := 'Value: ' + Random(28082).ToString + Random(80800).ToString;
end;

procedure TForm808.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum808;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj808_List0 := TMyObj808_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj808_List1 := TMyObj808_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
