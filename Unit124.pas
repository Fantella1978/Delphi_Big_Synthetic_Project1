...
type
  ...
  TMyObj124_List0 = TObjectList<TMyObj124>;

  TMyObj124_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj124_List1 = TObjectList<TMyObj124_1>;
...
constructor TMyObj124_1.Create;
begin
  inherited;
  FInt := 124 * 3;
  FTest := 'Value: ' + Random(21242).ToString + Random(12400).ToString;
end;

procedure TForm124.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum124;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj124_List0 := TMyObj124_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj124_List1 := TMyObj124_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
