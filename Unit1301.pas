...
type
  ...
  TMyObj1301_List0 = TObjectList<TMyObj1301>;

  TMyObj1301_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1301_List1 = TObjectList<TMyObj1301_1>;
...
constructor TMyObj1301_1.Create;
begin
  inherited;
  FInt := 1301 * 3;
  FTest := 'Value: ' + Random(213012).ToString + Random(130100).ToString;
end;

procedure TForm1301.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1301;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1301_List0 := TMyObj1301_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1301_List1 := TMyObj1301_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
