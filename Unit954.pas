...
type
  ...
  TMyObj954_List0 = TObjectList<TMyObj954>;

  TMyObj954_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj954_List1 = TObjectList<TMyObj954_1>;
...
constructor TMyObj954_1.Create;
begin
  inherited;
  FInt := 954 * 3;
  FTest := 'Value: ' + Random(29542).ToString + Random(95400).ToString;
end;

procedure TForm954.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum954;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj954_List0 := TMyObj954_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj954_List1 := TMyObj954_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
