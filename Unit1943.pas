...
type
  ...
  TMyObj1943_List0 = TObjectList<TMyObj1943>;

  TMyObj1943_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1943_List1 = TObjectList<TMyObj1943_1>;
...
constructor TMyObj1943_1.Create;
begin
  inherited;
  FInt := 1943 * 3;
  FTest := 'Value: ' + Random(219432).ToString + Random(194300).ToString;
end;

procedure TForm1943.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1943;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1943_List0 := TMyObj1943_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1943_List1 := TMyObj1943_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
