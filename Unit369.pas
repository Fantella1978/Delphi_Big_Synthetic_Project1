...
type
  ...
  TMyObj369_List0 = TObjectList<TMyObj369>;

  TMyObj369_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj369_List1 = TObjectList<TMyObj369_1>;
...
constructor TMyObj369_1.Create;
begin
  inherited;
  FInt := 369 * 3;
  FTest := 'Value: ' + Random(23692).ToString + Random(36900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj369_List0 := TMyObj369_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj369_List1 := TMyObj369_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
