...
type
  ...
  TMyObj1207_List0 = TObjectList<TMyObj1207>;

  TMyObj1207_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1207_List1 = TObjectList<TMyObj1207_1>;
...
constructor TMyObj1207_1.Create;
begin
  inherited;
  FInt := 1207 * 3;
  FTest := 'Value: ' + Random(212072).ToString + Random(120700).ToString;
end;

procedure TForm1207.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1207;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1207_List0 := TMyObj1207_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1207_List1 := TMyObj1207_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
