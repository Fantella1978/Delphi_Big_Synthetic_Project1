...
type
  ...
  TMyObj1639_List0 = TObjectList<TMyObj1639>;

  TMyObj1639_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1639_List1 = TObjectList<TMyObj1639_1>;
...
constructor TMyObj1639_1.Create;
begin
  inherited;
  FInt := 1639 * 3;
  FTest := 'Value: ' + Random(216392).ToString + Random(163900).ToString;
end;

procedure TForm1639.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1639;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1639_List0 := TMyObj1639_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1639_List1 := TMyObj1639_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
