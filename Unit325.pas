...
type
  ...
  TMyObj325_List0 = TObjectList<TMyObj325>;

  TMyObj325_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj325_List1 = TObjectList<TMyObj325_1>;
...
constructor TMyObj325_1.Create;
begin
  inherited;
  FInt := 325 * 3;
  FTest := 'Value: ' + Random(23252).ToString + Random(32500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj325_List0 := TMyObj325_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj325_List1 := TMyObj325_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
