...
type
  ...
  TMyObj1960_List0 = TObjectList<TMyObj1960>;

  TMyObj1960_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1960_List1 = TObjectList<TMyObj1960_1>;
...
constructor TMyObj1960_1.Create;
begin
  inherited;
  FInt := 1960 * 3;
  FTest := 'Value: ' + Random(219602).ToString + Random(196000).ToString;
end;

procedure TForm1960.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1960;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1960_List0 := TMyObj1960_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1960_List1 := TMyObj1960_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
