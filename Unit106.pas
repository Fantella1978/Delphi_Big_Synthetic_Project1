...
type
  ...
  TMyObj106_List0 = TObjectList<TMyObj106>;

  TMyObj106_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj106_List1 = TObjectList<TMyObj106_1>;
...
constructor TMyObj106_1.Create;
begin
  inherited;
  FInt := 106 * 3;
  FTest := 'Value: ' + Random(21062).ToString + Random(10600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj106_List0 := TMyObj106_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj106_List1 := TMyObj106_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
