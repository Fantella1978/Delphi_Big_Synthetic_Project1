...
type
  ...
  TMyObj1545_List0 = TObjectList<TMyObj1545>;

  TMyObj1545_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1545_List1 = TObjectList<TMyObj1545_1>;
...
constructor TMyObj1545_1.Create;
begin
  inherited;
  FInt := 1545 * 3;
  FTest := 'Value: ' + Random(215452).ToString + Random(154500).ToString;
end;

procedure TForm1545.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1545;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1545_List0 := TMyObj1545_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1545_List1 := TMyObj1545_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
