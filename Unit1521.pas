...
type
  ...
  TMyObj1521_List0 = TObjectList<TMyObj1521>;

  TMyObj1521_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1521_List1 = TObjectList<TMyObj1521_1>;
...
constructor TMyObj1521_1.Create;
begin
  inherited;
  FInt := 1521 * 3;
  FTest := 'Value: ' + Random(215212).ToString + Random(152100).ToString;
end;

procedure TForm1521.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1521;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1521_List0 := TMyObj1521_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1521_List1 := TMyObj1521_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
