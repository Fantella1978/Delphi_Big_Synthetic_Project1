...
type
  ...
  TMyObj2060_List0 = TObjectList<TMyObj2060>;

  TMyObj2060_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2060_List1 = TObjectList<TMyObj2060_1>;
...
constructor TMyObj2060_1.Create;
begin
  inherited;
  FInt := 2060 * 3;
  FTest := 'Value: ' + Random(220602).ToString + Random(206000).ToString;
end;

procedure TForm2060.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2060;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2060_List0 := TMyObj2060_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2060_List1 := TMyObj2060_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
