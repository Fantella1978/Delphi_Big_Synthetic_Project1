...
type
  ...
  TMyObj2500_List0 = TObjectList<TMyObj2500>;

  TMyObj2500_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2500_List1 = TObjectList<TMyObj2500_1>;
...
constructor TMyObj2500_1.Create;
begin
  inherited;
  FInt := 2500 * 3;
  FTest := 'Value: ' + Random(225002).ToString + Random(250000).ToString;
end;

procedure TForm2500.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2500;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(25000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(25005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(25007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2500_List0 := TMyObj2500_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2500_List1 := TMyObj2500_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
