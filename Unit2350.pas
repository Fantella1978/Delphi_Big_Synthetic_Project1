...
type
  ...
  TMyObj2350_List0 = TObjectList<TMyObj2350>;

  TMyObj2350_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2350_List1 = TObjectList<TMyObj2350_1>;
...
constructor TMyObj2350_1.Create;
begin
  inherited;
  FInt := 2350 * 3;
  FTest := 'Value: ' + Random(223502).ToString + Random(235000).ToString;
end;

procedure TForm2350.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2350;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2350_List0 := TMyObj2350_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2350_List1 := TMyObj2350_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
