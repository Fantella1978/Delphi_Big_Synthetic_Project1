...
type
  ...
  TMyObj378_List0 = TObjectList<TMyObj378>;

  TMyObj378_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj378_List1 = TObjectList<TMyObj378_1>;
...
constructor TMyObj378_1.Create;
begin
  inherited;
  FInt := 378 * 3;
  FTest := 'Value: ' + Random(23782).ToString + Random(37800).ToString;
end;

procedure TForm378.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum378;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj378_List0 := TMyObj378_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj378_List1 := TMyObj378_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
