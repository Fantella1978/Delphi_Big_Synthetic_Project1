...
type
  ...
  TMyObj2400_List0 = TObjectList<TMyObj2400>;

  TMyObj2400_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2400_List1 = TObjectList<TMyObj2400_1>;
...
constructor TMyObj2400_1.Create;
begin
  inherited;
  FInt := 2400 * 3;
  FTest := 'Value: ' + Random(224002).ToString + Random(240000).ToString;
end;

procedure TForm2400.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2400;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2400_List0 := TMyObj2400_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2400_List1 := TMyObj2400_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
