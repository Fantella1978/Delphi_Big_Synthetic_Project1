...
type
  ...
  TMyObj2067_List0 = TObjectList<TMyObj2067>;

  TMyObj2067_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2067_List1 = TObjectList<TMyObj2067_1>;
...
constructor TMyObj2067_1.Create;
begin
  inherited;
  FInt := 2067 * 3;
  FTest := 'Value: ' + Random(220672).ToString + Random(206700).ToString;
end;

procedure TForm2067.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2067;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2067_List0 := TMyObj2067_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2067_List1 := TMyObj2067_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
