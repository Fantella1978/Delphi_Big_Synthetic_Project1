...
type
  ...
  TMyObj1415_List0 = TObjectList<TMyObj1415>;

  TMyObj1415_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1415_List1 = TObjectList<TMyObj1415_1>;
...
constructor TMyObj1415_1.Create;
begin
  inherited;
  FInt := 1415 * 3;
  FTest := 'Value: ' + Random(214152).ToString + Random(141500).ToString;
end;

procedure TForm1415.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1415;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1415_List0 := TMyObj1415_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1415_List1 := TMyObj1415_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
