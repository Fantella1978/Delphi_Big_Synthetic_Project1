...
type
  ...
  TMyObj569_List0 = TObjectList<TMyObj569>;

  TMyObj569_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj569_List1 = TObjectList<TMyObj569_1>;
...
constructor TMyObj569_1.Create;
begin
  inherited;
  FInt := 569 * 3;
  FTest := 'Value: ' + Random(25692).ToString + Random(56900).ToString;
end;

procedure TForm569.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum569;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj569_List0 := TMyObj569_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj569_List1 := TMyObj569_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
