...
type
  ...
  TMyObj741_List0 = TObjectList<TMyObj741>;

  TMyObj741_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj741_List1 = TObjectList<TMyObj741_1>;
...
constructor TMyObj741_1.Create;
begin
  inherited;
  FInt := 741 * 3;
  FTest := 'Value: ' + Random(27412).ToString + Random(74100).ToString;
end;

procedure TForm741.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum741;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj741_List0 := TMyObj741_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj741_List1 := TMyObj741_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
