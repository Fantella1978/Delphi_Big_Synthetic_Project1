...
type
  ...
  TMyObj943_List0 = TObjectList<TMyObj943>;

  TMyObj943_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj943_List1 = TObjectList<TMyObj943_1>;
...
constructor TMyObj943_1.Create;
begin
  inherited;
  FInt := 943 * 3;
  FTest := 'Value: ' + Random(29432).ToString + Random(94300).ToString;
end;

procedure TForm943.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum943;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj943_List0 := TMyObj943_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj943_List1 := TMyObj943_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
