...
type
  ...
  TMyObj2307_List0 = TObjectList<TMyObj2307>;

  TMyObj2307_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2307_List1 = TObjectList<TMyObj2307_1>;
...
constructor TMyObj2307_1.Create;
begin
  inherited;
  FInt := 2307 * 3;
  FTest := 'Value: ' + Random(223072).ToString + Random(230700).ToString;
end;

procedure TForm2307.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2307;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2307_List0 := TMyObj2307_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2307_List1 := TMyObj2307_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
