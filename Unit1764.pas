...
type
  ...
  TMyObj1764_List0 = TObjectList<TMyObj1764>;

  TMyObj1764_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1764_List1 = TObjectList<TMyObj1764_1>;
...
constructor TMyObj1764_1.Create;
begin
  inherited;
  FInt := 1764 * 3;
  FTest := 'Value: ' + Random(217642).ToString + Random(176400).ToString;
end;

procedure TForm1764.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1764;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1764_List0 := TMyObj1764_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1764_List1 := TMyObj1764_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
