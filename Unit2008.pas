...
type
  ...
  TMyObj2008_List0 = TObjectList<TMyObj2008>;

  TMyObj2008_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2008_List1 = TObjectList<TMyObj2008_1>;
...
constructor TMyObj2008_1.Create;
begin
  inherited;
  FInt := 2008 * 3;
  FTest := 'Value: ' + Random(220082).ToString + Random(200800).ToString;
end;

procedure TForm2008.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2008;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2008_List0 := TMyObj2008_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2008_List1 := TMyObj2008_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
