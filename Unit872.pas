...
type
  ...
  TMyObj872_List0 = TObjectList<TMyObj872>;

  TMyObj872_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj872_List1 = TObjectList<TMyObj872_1>;
...
constructor TMyObj872_1.Create;
begin
  inherited;
  FInt := 872 * 3;
  FTest := 'Value: ' + Random(28722).ToString + Random(87200).ToString;
end;

procedure TForm872.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum872;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj872_List0 := TMyObj872_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj872_List1 := TMyObj872_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
