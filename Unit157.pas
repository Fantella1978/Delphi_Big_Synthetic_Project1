...
type
  ...
  TMyObj157_List0 = TObjectList<TMyObj157>;

  TMyObj157_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj157_List1 = TObjectList<TMyObj157_1>;
...
constructor TMyObj157_1.Create;
begin
  inherited;
  FInt := 157 * 3;
  FTest := 'Value: ' + Random(21572).ToString + Random(15700).ToString;
end;

procedure TForm157.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum157;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj157_List0 := TMyObj157_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj157_List1 := TMyObj157_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
