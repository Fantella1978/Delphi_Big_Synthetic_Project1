...
type
  ...
  TMyObj159_List0 = TObjectList<TMyObj159>;

  TMyObj159_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj159_List1 = TObjectList<TMyObj159_1>;
...
constructor TMyObj159_1.Create;
begin
  inherited;
  FInt := 159 * 3;
  FTest := 'Value: ' + Random(21592).ToString + Random(15900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj159_List0 := TMyObj159_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj159_List1 := TMyObj159_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
