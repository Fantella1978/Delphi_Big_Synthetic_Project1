...
type
  ...
  TMyObj2333_List0 = TObjectList<TMyObj2333>;

  TMyObj2333_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2333_List1 = TObjectList<TMyObj2333_1>;
...
constructor TMyObj2333_1.Create;
begin
  inherited;
  FInt := 2333 * 3;
  FTest := 'Value: ' + Random(223332).ToString + Random(233300).ToString;
end;

procedure TForm2333.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2333;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2333_List0 := TMyObj2333_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2333_List1 := TMyObj2333_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
