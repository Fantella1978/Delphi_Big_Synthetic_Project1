...
type
  ...
  TMyObj615_List0 = TObjectList<TMyObj615>;

  TMyObj615_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj615_List1 = TObjectList<TMyObj615_1>;
...
constructor TMyObj615_1.Create;
begin
  inherited;
  FInt := 615 * 3;
  FTest := 'Value: ' + Random(26152).ToString + Random(61500).ToString;
end;

procedure TForm615.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum615;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj615_List0 := TMyObj615_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj615_List1 := TMyObj615_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
