...
type
  ...
  TMyObj925_List0 = TObjectList<TMyObj925>;

  TMyObj925_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj925_List1 = TObjectList<TMyObj925_1>;
...
constructor TMyObj925_1.Create;
begin
  inherited;
  FInt := 925 * 3;
  FTest := 'Value: ' + Random(29252).ToString + Random(92500).ToString;
end;

procedure TForm925.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum925;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj925_List0 := TMyObj925_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj925_List1 := TMyObj925_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
