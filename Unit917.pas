...
type
  ...
  TMyObj917_List0 = TObjectList<TMyObj917>;

  TMyObj917_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj917_List1 = TObjectList<TMyObj917_1>;
...
constructor TMyObj917_1.Create;
begin
  inherited;
  FInt := 917 * 3;
  FTest := 'Value: ' + Random(29172).ToString + Random(91700).ToString;
end;

procedure TForm917.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum917;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj917_List0 := TMyObj917_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj917_List1 := TMyObj917_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
