...
type
  ...
  TMyObj761_List0 = TObjectList<TMyObj761>;

  TMyObj761_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj761_List1 = TObjectList<TMyObj761_1>;
...
constructor TMyObj761_1.Create;
begin
  inherited;
  FInt := 761 * 3;
  FTest := 'Value: ' + Random(27612).ToString + Random(76100).ToString;
end;

procedure TForm761.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum761;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj761_List0 := TMyObj761_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj761_List1 := TMyObj761_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
