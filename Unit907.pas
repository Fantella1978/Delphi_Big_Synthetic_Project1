...
type
  ...
  TMyObj907_List0 = TObjectList<TMyObj907>;

  TMyObj907_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj907_List1 = TObjectList<TMyObj907_1>;
...
constructor TMyObj907_1.Create;
begin
  inherited;
  FInt := 907 * 3;
  FTest := 'Value: ' + Random(29072).ToString + Random(90700).ToString;
end;

procedure TForm907.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum907;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj907_List0 := TMyObj907_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj907_List1 := TMyObj907_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
