...
type
  ...
  TMyObj2475_List0 = TObjectList<TMyObj2475>;

  TMyObj2475_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2475_List1 = TObjectList<TMyObj2475_1>;
...
constructor TMyObj2475_1.Create;
begin
  inherited;
  FInt := 2475 * 3;
  FTest := 'Value: ' + Random(224752).ToString + Random(247500).ToString;
end;

procedure TForm2475.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2475;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2475_List0 := TMyObj2475_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2475_List1 := TMyObj2475_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
