...
type
  ...
  TMyObj1720_List0 = TObjectList<TMyObj1720>;

  TMyObj1720_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1720_List1 = TObjectList<TMyObj1720_1>;
...
constructor TMyObj1720_1.Create;
begin
  inherited;
  FInt := 1720 * 3;
  FTest := 'Value: ' + Random(217202).ToString + Random(172000).ToString;
end;

procedure TForm1720.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1720;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1720_List0 := TMyObj1720_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1720_List1 := TMyObj1720_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
