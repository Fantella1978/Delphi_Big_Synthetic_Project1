...
type
  ...
  TMyObj1168_List0 = TObjectList<TMyObj1168>;

  TMyObj1168_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1168_List1 = TObjectList<TMyObj1168_1>;
...
constructor TMyObj1168_1.Create;
begin
  inherited;
  FInt := 1168 * 3;
  FTest := 'Value: ' + Random(211682).ToString + Random(116800).ToString;
end;

procedure TForm1168.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1168;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1168_List0 := TMyObj1168_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1168_List1 := TMyObj1168_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
