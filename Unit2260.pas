...
type
  ...
  TMyObj2260_List0 = TObjectList<TMyObj2260>;

  TMyObj2260_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2260_List1 = TObjectList<TMyObj2260_1>;
...
constructor TMyObj2260_1.Create;
begin
  inherited;
  FInt := 2260 * 3;
  FTest := 'Value: ' + Random(222602).ToString + Random(226000).ToString;
end;

procedure TForm2260.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2260;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2260_List0 := TMyObj2260_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2260_List1 := TMyObj2260_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
