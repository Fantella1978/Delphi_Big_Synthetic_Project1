...
type
  ...
  TMyObj1853_List0 = TObjectList<TMyObj1853>;

  TMyObj1853_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1853_List1 = TObjectList<TMyObj1853_1>;
...
constructor TMyObj1853_1.Create;
begin
  inherited;
  FInt := 1853 * 3;
  FTest := 'Value: ' + Random(218532).ToString + Random(185300).ToString;
end;

procedure TForm1853.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1853;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1853_List0 := TMyObj1853_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1853_List1 := TMyObj1853_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
