...
type
  ...
  TMyObj1223_List0 = TObjectList<TMyObj1223>;

  TMyObj1223_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1223_List1 = TObjectList<TMyObj1223_1>;
...
constructor TMyObj1223_1.Create;
begin
  inherited;
  FInt := 1223 * 3;
  FTest := 'Value: ' + Random(212232).ToString + Random(122300).ToString;
end;

procedure TForm1223.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1223;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1223_List0 := TMyObj1223_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1223_List1 := TMyObj1223_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
