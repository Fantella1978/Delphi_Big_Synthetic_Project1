...
type
  ...
  TMyObj733_List0 = TObjectList<TMyObj733>;

  TMyObj733_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj733_List1 = TObjectList<TMyObj733_1>;
...
constructor TMyObj733_1.Create;
begin
  inherited;
  FInt := 733 * 3;
  FTest := 'Value: ' + Random(27332).ToString + Random(73300).ToString;
end;

procedure TForm733.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum733;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj733_List0 := TMyObj733_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj733_List1 := TMyObj733_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
