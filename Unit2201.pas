...
type
  ...
  TMyObj2201_List0 = TObjectList<TMyObj2201>;

  TMyObj2201_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2201_List1 = TObjectList<TMyObj2201_1>;
...
constructor TMyObj2201_1.Create;
begin
  inherited;
  FInt := 2201 * 3;
  FTest := 'Value: ' + Random(222012).ToString + Random(220100).ToString;
end;

procedure TForm2201.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2201;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2201_List0 := TMyObj2201_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2201_List1 := TMyObj2201_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
