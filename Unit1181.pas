...
type
  ...
  TMyObj1181_List0 = TObjectList<TMyObj1181>;

  TMyObj1181_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1181_List1 = TObjectList<TMyObj1181_1>;
...
constructor TMyObj1181_1.Create;
begin
  inherited;
  FInt := 1181 * 3;
  FTest := 'Value: ' + Random(211812).ToString + Random(118100).ToString;
end;

procedure TForm1181.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1181;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1181_List0 := TMyObj1181_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1181_List1 := TMyObj1181_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
