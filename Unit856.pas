...
type
  ...
  TMyObj856_List0 = TObjectList<TMyObj856>;

  TMyObj856_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj856_List1 = TObjectList<TMyObj856_1>;
...
constructor TMyObj856_1.Create;
begin
  inherited;
  FInt := 856 * 3;
  FTest := 'Value: ' + Random(28562).ToString + Random(85600).ToString;
end;

procedure TForm856.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum856;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj856_List0 := TMyObj856_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj856_List1 := TMyObj856_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
