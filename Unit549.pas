...
type
  ...
  TMyObj549_List0 = TObjectList<TMyObj549>;

  TMyObj549_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj549_List1 = TObjectList<TMyObj549_1>;
...
constructor TMyObj549_1.Create;
begin
  inherited;
  FInt := 549 * 3;
  FTest := 'Value: ' + Random(25492).ToString + Random(54900).ToString;
end;

procedure TForm549.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum549;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj549_List0 := TMyObj549_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj549_List1 := TMyObj549_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
