...
type
  ...
  TMyObj566_List0 = TObjectList<TMyObj566>;

  TMyObj566_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj566_List1 = TObjectList<TMyObj566_1>;
...
constructor TMyObj566_1.Create;
begin
  inherited;
  FInt := 566 * 3;
  FTest := 'Value: ' + Random(25662).ToString + Random(56600).ToString;
end;

procedure TForm566.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum566;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj566_List0 := TMyObj566_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj566_List1 := TMyObj566_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
