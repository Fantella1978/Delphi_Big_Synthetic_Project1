...
type
  ...
  TMyObj441_List0 = TObjectList<TMyObj441>;

  TMyObj441_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj441_List1 = TObjectList<TMyObj441_1>;
...
constructor TMyObj441_1.Create;
begin
  inherited;
  FInt := 441 * 3;
  FTest := 'Value: ' + Random(24412).ToString + Random(44100).ToString;
end;

procedure TForm441.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum441;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj441_List0 := TMyObj441_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj441_List1 := TMyObj441_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
