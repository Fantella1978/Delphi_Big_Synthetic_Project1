...
type
  ...
  TMyObj816_List0 = TObjectList<TMyObj816>;

  TMyObj816_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj816_List1 = TObjectList<TMyObj816_1>;
...
constructor TMyObj816_1.Create;
begin
  inherited;
  FInt := 816 * 3;
  FTest := 'Value: ' + Random(28162).ToString + Random(81600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj816_List0 := TMyObj816_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj816_List1 := TMyObj816_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
