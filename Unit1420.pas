...
type
  ...
  TMyObj1420_List0 = TObjectList<TMyObj1420>;

  TMyObj1420_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1420_List1 = TObjectList<TMyObj1420_1>;
...
constructor TMyObj1420_1.Create;
begin
  inherited;
  FInt := 1420 * 3;
  FTest := 'Value: ' + Random(214202).ToString + Random(142000).ToString;
end;

procedure TForm1420.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1420;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1420_List0 := TMyObj1420_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1420_List1 := TMyObj1420_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
