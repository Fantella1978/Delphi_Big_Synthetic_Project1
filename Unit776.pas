...
type
  ...
  TMyObj776_List0 = TObjectList<TMyObj776>;

  TMyObj776_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj776_List1 = TObjectList<TMyObj776_1>;
...
constructor TMyObj776_1.Create;
begin
  inherited;
  FInt := 776 * 3;
  FTest := 'Value: ' + Random(27762).ToString + Random(77600).ToString;
end;

procedure TForm776.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum776;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj776_List0 := TMyObj776_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj776_List1 := TMyObj776_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
