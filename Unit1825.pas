...
type
  ...
  TMyObj1825_List0 = TObjectList<TMyObj1825>;

  TMyObj1825_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1825_List1 = TObjectList<TMyObj1825_1>;
...
constructor TMyObj1825_1.Create;
begin
  inherited;
  FInt := 1825 * 3;
  FTest := 'Value: ' + Random(218252).ToString + Random(182500).ToString;
end;

procedure TForm1825.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1825;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1825_List0 := TMyObj1825_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1825_List1 := TMyObj1825_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
