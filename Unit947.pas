...
type
  ...
  TMyObj947_List0 = TObjectList<TMyObj947>;

  TMyObj947_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj947_List1 = TObjectList<TMyObj947_1>;
...
constructor TMyObj947_1.Create;
begin
  inherited;
  FInt := 947 * 3;
  FTest := 'Value: ' + Random(29472).ToString + Random(94700).ToString;
end;

procedure TForm947.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum947;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj947_List0 := TMyObj947_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj947_List1 := TMyObj947_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
