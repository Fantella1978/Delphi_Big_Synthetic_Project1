...
type
  ...
  TMyObj1922_List0 = TObjectList<TMyObj1922>;

  TMyObj1922_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1922_List1 = TObjectList<TMyObj1922_1>;
...
constructor TMyObj1922_1.Create;
begin
  inherited;
  FInt := 1922 * 3;
  FTest := 'Value: ' + Random(219222).ToString + Random(192200).ToString;
end;

procedure TForm1922.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1922;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1922_List0 := TMyObj1922_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1922_List1 := TMyObj1922_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
