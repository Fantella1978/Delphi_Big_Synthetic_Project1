...
type
  ...
  TMyObj941_List0 = TObjectList<TMyObj941>;

  TMyObj941_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj941_List1 = TObjectList<TMyObj941_1>;
...
constructor TMyObj941_1.Create;
begin
  inherited;
  FInt := 941 * 3;
  FTest := 'Value: ' + Random(29412).ToString + Random(94100).ToString;
end;

procedure TForm941.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum941;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj941_List0 := TMyObj941_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj941_List1 := TMyObj941_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
