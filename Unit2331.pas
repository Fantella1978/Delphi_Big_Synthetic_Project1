...
type
  ...
  TMyObj2331_List0 = TObjectList<TMyObj2331>;

  TMyObj2331_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2331_List1 = TObjectList<TMyObj2331_1>;
...
constructor TMyObj2331_1.Create;
begin
  inherited;
  FInt := 2331 * 3;
  FTest := 'Value: ' + Random(223312).ToString + Random(233100).ToString;
end;

procedure TForm2331.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2331;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2331_List0 := TMyObj2331_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2331_List1 := TMyObj2331_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
