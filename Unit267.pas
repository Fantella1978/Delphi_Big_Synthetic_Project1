...
type
  ...
  TMyObj267_List0 = TObjectList<TMyObj267>;

  TMyObj267_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj267_List1 = TObjectList<TMyObj267_1>;
...
constructor TMyObj267_1.Create;
begin
  inherited;
  FInt := 267 * 3;
  FTest := 'Value: ' + Random(22672).ToString + Random(26700).ToString;
end;

procedure TForm267.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum267;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj267_List0 := TMyObj267_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj267_List1 := TMyObj267_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
