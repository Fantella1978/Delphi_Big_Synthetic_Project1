...
type
  ...
  TMyObj1837_List0 = TObjectList<TMyObj1837>;

  TMyObj1837_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1837_List1 = TObjectList<TMyObj1837_1>;
...
constructor TMyObj1837_1.Create;
begin
  inherited;
  FInt := 1837 * 3;
  FTest := 'Value: ' + Random(218372).ToString + Random(183700).ToString;
end;

procedure TForm1837.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1837;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1837_List0 := TMyObj1837_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1837_List1 := TMyObj1837_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
