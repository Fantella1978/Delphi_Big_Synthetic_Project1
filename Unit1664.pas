...
type
  ...
  TMyObj1664_List0 = TObjectList<TMyObj1664>;

  TMyObj1664_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1664_List1 = TObjectList<TMyObj1664_1>;
...
constructor TMyObj1664_1.Create;
begin
  inherited;
  FInt := 1664 * 3;
  FTest := 'Value: ' + Random(216642).ToString + Random(166400).ToString;
end;

procedure TForm1664.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1664;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1664_List0 := TMyObj1664_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1664_List1 := TMyObj1664_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
