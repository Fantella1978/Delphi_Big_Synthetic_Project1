...
type
  ...
  TMyObj1692_List0 = TObjectList<TMyObj1692>;

  TMyObj1692_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1692_List1 = TObjectList<TMyObj1692_1>;
...
constructor TMyObj1692_1.Create;
begin
  inherited;
  FInt := 1692 * 3;
  FTest := 'Value: ' + Random(216922).ToString + Random(169200).ToString;
end;

procedure TForm1692.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1692;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1692_List0 := TMyObj1692_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1692_List1 := TMyObj1692_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
