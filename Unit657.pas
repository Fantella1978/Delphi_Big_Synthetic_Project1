...
type
  ...
  TMyObj657_List0 = TObjectList<TMyObj657>;

  TMyObj657_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj657_List1 = TObjectList<TMyObj657_1>;
...
constructor TMyObj657_1.Create;
begin
  inherited;
  FInt := 657 * 3;
  FTest := 'Value: ' + Random(26572).ToString + Random(65700).ToString;
end;

procedure TForm657.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum657;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj657_List0 := TMyObj657_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj657_List1 := TMyObj657_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
