...
type
  ...
  TMyObj1161_List0 = TObjectList<TMyObj1161>;

  TMyObj1161_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1161_List1 = TObjectList<TMyObj1161_1>;
...
constructor TMyObj1161_1.Create;
begin
  inherited;
  FInt := 1161 * 3;
  FTest := 'Value: ' + Random(211612).ToString + Random(116100).ToString;
end;

procedure TForm1161.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1161;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1161_List0 := TMyObj1161_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1161_List1 := TMyObj1161_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
