...
type
  ...
  TMyObj1564_List0 = TObjectList<TMyObj1564>;

  TMyObj1564_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1564_List1 = TObjectList<TMyObj1564_1>;
...
constructor TMyObj1564_1.Create;
begin
  inherited;
  FInt := 1564 * 3;
  FTest := 'Value: ' + Random(215642).ToString + Random(156400).ToString;
end;

procedure TForm1564.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1564;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1564_List0 := TMyObj1564_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1564_List1 := TMyObj1564_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
