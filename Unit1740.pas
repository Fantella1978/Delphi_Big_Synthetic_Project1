...
type
  ...
  TMyObj1740_List0 = TObjectList<TMyObj1740>;

  TMyObj1740_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1740_List1 = TObjectList<TMyObj1740_1>;
...
constructor TMyObj1740_1.Create;
begin
  inherited;
  FInt := 1740 * 3;
  FTest := 'Value: ' + Random(217402).ToString + Random(174000).ToString;
end;

procedure TForm1740.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1740;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1740_List0 := TMyObj1740_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1740_List1 := TMyObj1740_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
