...
type
  ...
  TMyObj1302_List0 = TObjectList<TMyObj1302>;

  TMyObj1302_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1302_List1 = TObjectList<TMyObj1302_1>;
...
constructor TMyObj1302_1.Create;
begin
  inherited;
  FInt := 1302 * 3;
  FTest := 'Value: ' + Random(213022).ToString + Random(130200).ToString;
end;

procedure TForm1302.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1302;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1302_List0 := TMyObj1302_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1302_List1 := TMyObj1302_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
