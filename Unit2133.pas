...
type
  ...
  TMyObj2133_List0 = TObjectList<TMyObj2133>;

  TMyObj2133_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2133_List1 = TObjectList<TMyObj2133_1>;
...
constructor TMyObj2133_1.Create;
begin
  inherited;
  FInt := 2133 * 3;
  FTest := 'Value: ' + Random(221332).ToString + Random(213300).ToString;
end;

procedure TForm2133.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2133;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2133_List0 := TMyObj2133_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2133_List1 := TMyObj2133_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
