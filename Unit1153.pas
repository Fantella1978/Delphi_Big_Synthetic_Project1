...
type
  ...
  TMyObj1153_List0 = TObjectList<TMyObj1153>;

  TMyObj1153_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1153_List1 = TObjectList<TMyObj1153_1>;
...
constructor TMyObj1153_1.Create;
begin
  inherited;
  FInt := 1153 * 3;
  FTest := 'Value: ' + Random(211532).ToString + Random(115300).ToString;
end;

procedure TForm1153.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1153;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1153_List0 := TMyObj1153_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1153_List1 := TMyObj1153_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
