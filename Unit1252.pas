...
type
  ...
  TMyObj1252_List0 = TObjectList<TMyObj1252>;

  TMyObj1252_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1252_List1 = TObjectList<TMyObj1252_1>;
...
constructor TMyObj1252_1.Create;
begin
  inherited;
  FInt := 1252 * 3;
  FTest := 'Value: ' + Random(212522).ToString + Random(125200).ToString;
end;

procedure TForm1252.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1252;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1252_List0 := TMyObj1252_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1252_List1 := TMyObj1252_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
