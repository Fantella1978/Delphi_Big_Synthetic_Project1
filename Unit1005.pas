...
type
  ...
  TMyObj1005_List0 = TObjectList<TMyObj1005>;

  TMyObj1005_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1005_List1 = TObjectList<TMyObj1005_1>;
...
constructor TMyObj1005_1.Create;
begin
  inherited;
  FInt := 1005 * 3;
  FTest := 'Value: ' + Random(210052).ToString + Random(100500).ToString;
end;

procedure TForm1005.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1005;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1005_List0 := TMyObj1005_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1005_List1 := TMyObj1005_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
