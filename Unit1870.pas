...
type
  ...
  TMyObj1870_List0 = TObjectList<TMyObj1870>;

  TMyObj1870_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1870_List1 = TObjectList<TMyObj1870_1>;
...
constructor TMyObj1870_1.Create;
begin
  inherited;
  FInt := 1870 * 3;
  FTest := 'Value: ' + Random(218702).ToString + Random(187000).ToString;
end;

procedure TForm1870.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1870;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1870_List0 := TMyObj1870_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1870_List1 := TMyObj1870_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
