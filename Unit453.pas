...
type
  ...
  TMyObj453_List0 = TObjectList<TMyObj453>;

  TMyObj453_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj453_List1 = TObjectList<TMyObj453_1>;
...
constructor TMyObj453_1.Create;
begin
  inherited;
  FInt := 453 * 3;
  FTest := 'Value: ' + Random(24532).ToString + Random(45300).ToString;
end;

procedure TForm453.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum453;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj453_List0 := TMyObj453_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj453_List1 := TMyObj453_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
