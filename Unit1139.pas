...
type
  ...
  TMyObj1139_List0 = TObjectList<TMyObj1139>;

  TMyObj1139_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1139_List1 = TObjectList<TMyObj1139_1>;
...
constructor TMyObj1139_1.Create;
begin
  inherited;
  FInt := 1139 * 3;
  FTest := 'Value: ' + Random(211392).ToString + Random(113900).ToString;
end;

procedure TForm1139.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1139;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1139_List0 := TMyObj1139_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1139_List1 := TMyObj1139_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
