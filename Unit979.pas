...
type
  ...
  TMyObj979_List0 = TObjectList<TMyObj979>;

  TMyObj979_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj979_List1 = TObjectList<TMyObj979_1>;
...
constructor TMyObj979_1.Create;
begin
  inherited;
  FInt := 979 * 3;
  FTest := 'Value: ' + Random(29792).ToString + Random(97900).ToString;
end;

procedure TForm979.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum979;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj979_List0 := TMyObj979_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj979_List1 := TMyObj979_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
