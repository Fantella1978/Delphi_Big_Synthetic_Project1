...
type
  ...
  TMyObj2059_List0 = TObjectList<TMyObj2059>;

  TMyObj2059_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2059_List1 = TObjectList<TMyObj2059_1>;
...
constructor TMyObj2059_1.Create;
begin
  inherited;
  FInt := 2059 * 3;
  FTest := 'Value: ' + Random(220592).ToString + Random(205900).ToString;
end;

procedure TForm2059.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2059;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2059_List0 := TMyObj2059_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2059_List1 := TMyObj2059_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
