...
type
  ...
  TMyObj2065_List0 = TObjectList<TMyObj2065>;

  TMyObj2065_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2065_List1 = TObjectList<TMyObj2065_1>;
...
constructor TMyObj2065_1.Create;
begin
  inherited;
  FInt := 2065 * 3;
  FTest := 'Value: ' + Random(220652).ToString + Random(206500).ToString;
end;

procedure TForm2065.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2065;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2065_List0 := TMyObj2065_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2065_List1 := TMyObj2065_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
