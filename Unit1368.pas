...
type
  ...
  TMyObj1368_List0 = TObjectList<TMyObj1368>;

  TMyObj1368_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1368_List1 = TObjectList<TMyObj1368_1>;
...
constructor TMyObj1368_1.Create;
begin
  inherited;
  FInt := 1368 * 3;
  FTest := 'Value: ' + Random(213682).ToString + Random(136800).ToString;
end;

procedure TForm1368.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1368;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1368_List0 := TMyObj1368_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1368_List1 := TMyObj1368_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
