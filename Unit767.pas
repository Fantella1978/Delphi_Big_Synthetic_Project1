...
type
  ...
  TMyObj767_List0 = TObjectList<TMyObj767>;

  TMyObj767_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj767_List1 = TObjectList<TMyObj767_1>;
...
constructor TMyObj767_1.Create;
begin
  inherited;
  FInt := 767 * 3;
  FTest := 'Value: ' + Random(27672).ToString + Random(76700).ToString;
end;

procedure TForm767.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum767;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj767_List0 := TMyObj767_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj767_List1 := TMyObj767_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
