...
type
  ...
  TMyObj41_List0 = TObjectList<TMyObj41>;

  TMyObj41_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj41_List1 = TObjectList<TMyObj41_1>;
...
constructor TMyObj41_1.Create;
begin
  inherited;
  FInt := 41 * 3;
  FTest := 'Value: ' + Random(2412).ToString + Random(4100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj41_List0 := TMyObj41_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj41_List1 := TMyObj41_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
