...
type
  ...
  TMyObj1797_List0 = TObjectList<TMyObj1797>;

  TMyObj1797_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1797_List1 = TObjectList<TMyObj1797_1>;
...
constructor TMyObj1797_1.Create;
begin
  inherited;
  FInt := 1797 * 3;
  FTest := 'Value: ' + Random(217972).ToString + Random(179700).ToString;
end;

procedure TForm1797.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1797;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1797_List0 := TMyObj1797_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1797_List1 := TMyObj1797_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
