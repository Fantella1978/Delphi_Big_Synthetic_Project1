...
type
  ...
  TMyObj1671_List0 = TObjectList<TMyObj1671>;

  TMyObj1671_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1671_List1 = TObjectList<TMyObj1671_1>;
...
constructor TMyObj1671_1.Create;
begin
  inherited;
  FInt := 1671 * 3;
  FTest := 'Value: ' + Random(216712).ToString + Random(167100).ToString;
end;

procedure TForm1671.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1671;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1671_List0 := TMyObj1671_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1671_List1 := TMyObj1671_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
