...
type
  ...
  TMyObj2194_List0 = TObjectList<TMyObj2194>;

  TMyObj2194_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2194_List1 = TObjectList<TMyObj2194_1>;
...
constructor TMyObj2194_1.Create;
begin
  inherited;
  FInt := 2194 * 3;
  FTest := 'Value: ' + Random(221942).ToString + Random(219400).ToString;
end;

procedure TForm2194.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2194;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2194_List0 := TMyObj2194_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2194_List1 := TMyObj2194_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
