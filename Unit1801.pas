...
type
  ...
  TMyObj1801_List0 = TObjectList<TMyObj1801>;

  TMyObj1801_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1801_List1 = TObjectList<TMyObj1801_1>;
...
constructor TMyObj1801_1.Create;
begin
  inherited;
  FInt := 1801 * 3;
  FTest := 'Value: ' + Random(218012).ToString + Random(180100).ToString;
end;

procedure TForm1801.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1801;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1801_List0 := TMyObj1801_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1801_List1 := TMyObj1801_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
