...
type
  ...
  TMyObj2302_List0 = TObjectList<TMyObj2302>;

  TMyObj2302_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2302_List1 = TObjectList<TMyObj2302_1>;
...
constructor TMyObj2302_1.Create;
begin
  inherited;
  FInt := 2302 * 3;
  FTest := 'Value: ' + Random(223022).ToString + Random(230200).ToString;
end;

procedure TForm2302.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2302;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23020).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23025).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23027).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2302_List0 := TMyObj2302_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2302_List1 := TMyObj2302_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
