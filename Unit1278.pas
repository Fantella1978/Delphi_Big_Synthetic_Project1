...
type
  ...
  TMyObj1278_List0 = TObjectList<TMyObj1278>;

  TMyObj1278_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1278_List1 = TObjectList<TMyObj1278_1>;
...
constructor TMyObj1278_1.Create;
begin
  inherited;
  FInt := 1278 * 3;
  FTest := 'Value: ' + Random(212782).ToString + Random(127800).ToString;
end;

procedure TForm1278.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1278;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1278_List0 := TMyObj1278_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1278_List1 := TMyObj1278_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
