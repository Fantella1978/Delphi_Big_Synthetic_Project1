...
type
  ...
  TMyObj1254_List0 = TObjectList<TMyObj1254>;

  TMyObj1254_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1254_List1 = TObjectList<TMyObj1254_1>;
...
constructor TMyObj1254_1.Create;
begin
  inherited;
  FInt := 1254 * 3;
  FTest := 'Value: ' + Random(212542).ToString + Random(125400).ToString;
end;

procedure TForm1254.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1254;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1254_List0 := TMyObj1254_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1254_List1 := TMyObj1254_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
