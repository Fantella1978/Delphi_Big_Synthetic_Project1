...
type
  ...
  TMyObj698_List0 = TObjectList<TMyObj698>;

  TMyObj698_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj698_List1 = TObjectList<TMyObj698_1>;
...
constructor TMyObj698_1.Create;
begin
  inherited;
  FInt := 698 * 3;
  FTest := 'Value: ' + Random(26982).ToString + Random(69800).ToString;
end;

procedure TForm698.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum698;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj698_List0 := TMyObj698_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj698_List1 := TMyObj698_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
