...
type
  ...
  TMyObj893_List0 = TObjectList<TMyObj893>;

  TMyObj893_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj893_List1 = TObjectList<TMyObj893_1>;
...
constructor TMyObj893_1.Create;
begin
  inherited;
  FInt := 893 * 3;
  FTest := 'Value: ' + Random(28932).ToString + Random(89300).ToString;
end;

procedure TForm893.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum893;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj893_List0 := TMyObj893_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj893_List1 := TMyObj893_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
