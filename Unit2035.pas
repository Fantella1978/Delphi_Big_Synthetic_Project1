...
type
  ...
  TMyObj2035_List0 = TObjectList<TMyObj2035>;

  TMyObj2035_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2035_List1 = TObjectList<TMyObj2035_1>;
...
constructor TMyObj2035_1.Create;
begin
  inherited;
  FInt := 2035 * 3;
  FTest := 'Value: ' + Random(220352).ToString + Random(203500).ToString;
end;

procedure TForm2035.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2035;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2035_List0 := TMyObj2035_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2035_List1 := TMyObj2035_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
