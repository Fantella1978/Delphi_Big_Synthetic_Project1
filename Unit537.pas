...
type
  ...
  TMyObj537_List0 = TObjectList<TMyObj537>;

  TMyObj537_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj537_List1 = TObjectList<TMyObj537_1>;
...
constructor TMyObj537_1.Create;
begin
  inherited;
  FInt := 537 * 3;
  FTest := 'Value: ' + Random(25372).ToString + Random(53700).ToString;
end;

procedure TForm537.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum537;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj537_List0 := TMyObj537_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj537_List1 := TMyObj537_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
