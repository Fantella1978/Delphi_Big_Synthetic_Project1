...
type
  ...
  TMyObj2077_List0 = TObjectList<TMyObj2077>;

  TMyObj2077_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2077_List1 = TObjectList<TMyObj2077_1>;
...
constructor TMyObj2077_1.Create;
begin
  inherited;
  FInt := 2077 * 3;
  FTest := 'Value: ' + Random(220772).ToString + Random(207700).ToString;
end;

procedure TForm2077.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2077;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2077_List0 := TMyObj2077_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2077_List1 := TMyObj2077_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
