...
type
  ...
  TMyObj2199_List0 = TObjectList<TMyObj2199>;

  TMyObj2199_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2199_List1 = TObjectList<TMyObj2199_1>;
...
constructor TMyObj2199_1.Create;
begin
  inherited;
  FInt := 2199 * 3;
  FTest := 'Value: ' + Random(221992).ToString + Random(219900).ToString;
end;

procedure TForm2199.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2199;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2199_List0 := TMyObj2199_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2199_List1 := TMyObj2199_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
