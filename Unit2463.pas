...
type
  ...
  TMyObj2463_List0 = TObjectList<TMyObj2463>;

  TMyObj2463_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2463_List1 = TObjectList<TMyObj2463_1>;
...
constructor TMyObj2463_1.Create;
begin
  inherited;
  FInt := 2463 * 3;
  FTest := 'Value: ' + Random(224632).ToString + Random(246300).ToString;
end;

procedure TForm2463.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2463;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2463_List0 := TMyObj2463_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2463_List1 := TMyObj2463_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
