...
type
  ...
  TMyObj216_List0 = TObjectList<TMyObj216>;

  TMyObj216_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj216_List1 = TObjectList<TMyObj216_1>;
...
constructor TMyObj216_1.Create;
begin
  inherited;
  FInt := 216 * 3;
  FTest := 'Value: ' + Random(22162).ToString + Random(21600).ToString;
end;

procedure TForm216.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum216;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj216_List0 := TMyObj216_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj216_List1 := TMyObj216_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
