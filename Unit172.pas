...
type
  ...
  TMyObj172_List0 = TObjectList<TMyObj172>;

  TMyObj172_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj172_List1 = TObjectList<TMyObj172_1>;
...
constructor TMyObj172_1.Create;
begin
  inherited;
  FInt := 172 * 3;
  FTest := 'Value: ' + Random(21722).ToString + Random(17200).ToString;
end;

procedure TForm172.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum172;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj172_List0 := TMyObj172_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj172_List1 := TMyObj172_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
