...
type
  ...
  TMyObj2451_List0 = TObjectList<TMyObj2451>;

  TMyObj2451_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2451_List1 = TObjectList<TMyObj2451_1>;
...
constructor TMyObj2451_1.Create;
begin
  inherited;
  FInt := 2451 * 3;
  FTest := 'Value: ' + Random(224512).ToString + Random(245100).ToString;
end;

procedure TForm2451.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2451;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2451_List0 := TMyObj2451_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2451_List1 := TMyObj2451_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
