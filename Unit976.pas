...
type
  ...
  TMyObj976_List0 = TObjectList<TMyObj976>;

  TMyObj976_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj976_List1 = TObjectList<TMyObj976_1>;
...
constructor TMyObj976_1.Create;
begin
  inherited;
  FInt := 976 * 3;
  FTest := 'Value: ' + Random(29762).ToString + Random(97600).ToString;
end;

procedure TForm976.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum976;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj976_List0 := TMyObj976_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj976_List1 := TMyObj976_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
