...
type
  ...
  TMyObj181_List0 = TObjectList<TMyObj181>;

  TMyObj181_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj181_List1 = TObjectList<TMyObj181_1>;
...
constructor TMyObj181_1.Create;
begin
  inherited;
  FInt := 181 * 3;
  FTest := 'Value: ' + Random(21812).ToString + Random(18100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj181_List0 := TMyObj181_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj181_List1 := TMyObj181_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
