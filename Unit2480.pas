...
type
  ...
  TMyObj2480_List0 = TObjectList<TMyObj2480>;

  TMyObj2480_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2480_List1 = TObjectList<TMyObj2480_1>;
...
constructor TMyObj2480_1.Create;
begin
  inherited;
  FInt := 2480 * 3;
  FTest := 'Value: ' + Random(224802).ToString + Random(248000).ToString;
end;

procedure TForm2480.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2480;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2480_List0 := TMyObj2480_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2480_List1 := TMyObj2480_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
