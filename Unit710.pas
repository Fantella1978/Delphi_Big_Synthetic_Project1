...
type
  ...
  TMyObj710_List0 = TObjectList<TMyObj710>;

  TMyObj710_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj710_List1 = TObjectList<TMyObj710_1>;
...
constructor TMyObj710_1.Create;
begin
  inherited;
  FInt := 710 * 3;
  FTest := 'Value: ' + Random(27102).ToString + Random(71000).ToString;
end;

procedure TForm710.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum710;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj710_List0 := TMyObj710_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj710_List1 := TMyObj710_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
