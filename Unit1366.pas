...
type
  ...
  TMyObj1366_List0 = TObjectList<TMyObj1366>;

  TMyObj1366_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1366_List1 = TObjectList<TMyObj1366_1>;
...
constructor TMyObj1366_1.Create;
begin
  inherited;
  FInt := 1366 * 3;
  FTest := 'Value: ' + Random(213662).ToString + Random(136600).ToString;
end;

procedure TForm1366.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1366;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1366_List0 := TMyObj1366_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1366_List1 := TMyObj1366_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
