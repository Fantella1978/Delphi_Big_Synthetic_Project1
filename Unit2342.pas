...
type
  ...
  TMyObj2342_List0 = TObjectList<TMyObj2342>;

  TMyObj2342_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2342_List1 = TObjectList<TMyObj2342_1>;
...
constructor TMyObj2342_1.Create;
begin
  inherited;
  FInt := 2342 * 3;
  FTest := 'Value: ' + Random(223422).ToString + Random(234200).ToString;
end;

procedure TForm2342.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2342;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2342_List0 := TMyObj2342_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2342_List1 := TMyObj2342_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
