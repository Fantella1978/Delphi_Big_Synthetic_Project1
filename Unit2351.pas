...
type
  ...
  TMyObj2351_List0 = TObjectList<TMyObj2351>;

  TMyObj2351_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2351_List1 = TObjectList<TMyObj2351_1>;
...
constructor TMyObj2351_1.Create;
begin
  inherited;
  FInt := 2351 * 3;
  FTest := 'Value: ' + Random(223512).ToString + Random(235100).ToString;
end;

procedure TForm2351.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2351;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2351_List0 := TMyObj2351_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2351_List1 := TMyObj2351_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
