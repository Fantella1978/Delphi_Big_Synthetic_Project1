...
type
  ...
  TMyObj1479_List0 = TObjectList<TMyObj1479>;

  TMyObj1479_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1479_List1 = TObjectList<TMyObj1479_1>;
...
constructor TMyObj1479_1.Create;
begin
  inherited;
  FInt := 1479 * 3;
  FTest := 'Value: ' + Random(214792).ToString + Random(147900).ToString;
end;

procedure TForm1479.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1479;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1479_List0 := TMyObj1479_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1479_List1 := TMyObj1479_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
