...
type
  ...
  TMyObj2324_List0 = TObjectList<TMyObj2324>;

  TMyObj2324_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2324_List1 = TObjectList<TMyObj2324_1>;
...
constructor TMyObj2324_1.Create;
begin
  inherited;
  FInt := 2324 * 3;
  FTest := 'Value: ' + Random(223242).ToString + Random(232400).ToString;
end;

procedure TForm2324.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2324;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2324_List0 := TMyObj2324_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2324_List1 := TMyObj2324_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
