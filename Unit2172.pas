...
type
  ...
  TMyObj2172_List0 = TObjectList<TMyObj2172>;

  TMyObj2172_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2172_List1 = TObjectList<TMyObj2172_1>;
...
constructor TMyObj2172_1.Create;
begin
  inherited;
  FInt := 2172 * 3;
  FTest := 'Value: ' + Random(221722).ToString + Random(217200).ToString;
end;

procedure TForm2172.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2172;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2172_List0 := TMyObj2172_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2172_List1 := TMyObj2172_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
