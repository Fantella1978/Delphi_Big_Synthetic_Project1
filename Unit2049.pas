...
type
  ...
  TMyObj2049_List0 = TObjectList<TMyObj2049>;

  TMyObj2049_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2049_List1 = TObjectList<TMyObj2049_1>;
...
constructor TMyObj2049_1.Create;
begin
  inherited;
  FInt := 2049 * 3;
  FTest := 'Value: ' + Random(220492).ToString + Random(204900).ToString;
end;

procedure TForm2049.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2049;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2049_List0 := TMyObj2049_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2049_List1 := TMyObj2049_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
