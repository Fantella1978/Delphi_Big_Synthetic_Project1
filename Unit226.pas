...
type
  ...
  TMyObj226_List0 = TObjectList<TMyObj226>;

  TMyObj226_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj226_List1 = TObjectList<TMyObj226_1>;
...
constructor TMyObj226_1.Create;
begin
  inherited;
  FInt := 226 * 3;
  FTest := 'Value: ' + Random(22262).ToString + Random(22600).ToString;
end;

procedure TForm226.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum226;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj226_List0 := TMyObj226_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj226_List1 := TMyObj226_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
