...
type
  ...
  TMyObj2452_List0 = TObjectList<TMyObj2452>;

  TMyObj2452_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2452_List1 = TObjectList<TMyObj2452_1>;
...
constructor TMyObj2452_1.Create;
begin
  inherited;
  FInt := 2452 * 3;
  FTest := 'Value: ' + Random(224522).ToString + Random(245200).ToString;
end;

procedure TForm2452.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2452;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2452_List0 := TMyObj2452_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2452_List1 := TMyObj2452_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
