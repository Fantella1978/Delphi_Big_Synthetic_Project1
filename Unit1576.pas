...
type
  ...
  TMyObj1576_List0 = TObjectList<TMyObj1576>;

  TMyObj1576_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1576_List1 = TObjectList<TMyObj1576_1>;
...
constructor TMyObj1576_1.Create;
begin
  inherited;
  FInt := 1576 * 3;
  FTest := 'Value: ' + Random(215762).ToString + Random(157600).ToString;
end;

procedure TForm1576.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1576;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1576_List0 := TMyObj1576_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1576_List1 := TMyObj1576_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
