...
type
  ...
  TMyObj1834_List0 = TObjectList<TMyObj1834>;

  TMyObj1834_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1834_List1 = TObjectList<TMyObj1834_1>;
...
constructor TMyObj1834_1.Create;
begin
  inherited;
  FInt := 1834 * 3;
  FTest := 'Value: ' + Random(218342).ToString + Random(183400).ToString;
end;

procedure TForm1834.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1834;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1834_List0 := TMyObj1834_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1834_List1 := TMyObj1834_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
