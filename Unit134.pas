...
type
  ...
  TMyObj134_List0 = TObjectList<TMyObj134>;

  TMyObj134_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj134_List1 = TObjectList<TMyObj134_1>;
...
constructor TMyObj134_1.Create;
begin
  inherited;
  FInt := 134 * 3;
  FTest := 'Value: ' + Random(21342).ToString + Random(13400).ToString;
end;

procedure TForm134.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum134;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj134_List0 := TMyObj134_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj134_List1 := TMyObj134_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
