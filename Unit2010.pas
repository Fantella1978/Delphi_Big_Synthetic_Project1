...
type
  ...
  TMyObj2010_List0 = TObjectList<TMyObj2010>;

  TMyObj2010_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2010_List1 = TObjectList<TMyObj2010_1>;
...
constructor TMyObj2010_1.Create;
begin
  inherited;
  FInt := 2010 * 3;
  FTest := 'Value: ' + Random(220102).ToString + Random(201000).ToString;
end;

procedure TForm2010.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2010;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2010_List0 := TMyObj2010_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2010_List1 := TMyObj2010_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
