...
type
  ...
  TMyObj1827_List0 = TObjectList<TMyObj1827>;

  TMyObj1827_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1827_List1 = TObjectList<TMyObj1827_1>;
...
constructor TMyObj1827_1.Create;
begin
  inherited;
  FInt := 1827 * 3;
  FTest := 'Value: ' + Random(218272).ToString + Random(182700).ToString;
end;

procedure TForm1827.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1827;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1827_List0 := TMyObj1827_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1827_List1 := TMyObj1827_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
