...
type
  ...
  TMyObj1563_List0 = TObjectList<TMyObj1563>;

  TMyObj1563_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1563_List1 = TObjectList<TMyObj1563_1>;
...
constructor TMyObj1563_1.Create;
begin
  inherited;
  FInt := 1563 * 3;
  FTest := 'Value: ' + Random(215632).ToString + Random(156300).ToString;
end;

procedure TForm1563.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1563;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1563_List0 := TMyObj1563_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1563_List1 := TMyObj1563_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
