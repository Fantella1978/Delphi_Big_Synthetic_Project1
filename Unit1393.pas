...
type
  ...
  TMyObj1393_List0 = TObjectList<TMyObj1393>;

  TMyObj1393_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1393_List1 = TObjectList<TMyObj1393_1>;
...
constructor TMyObj1393_1.Create;
begin
  inherited;
  FInt := 1393 * 3;
  FTest := 'Value: ' + Random(213932).ToString + Random(139300).ToString;
end;

procedure TForm1393.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1393;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1393_List0 := TMyObj1393_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1393_List1 := TMyObj1393_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
