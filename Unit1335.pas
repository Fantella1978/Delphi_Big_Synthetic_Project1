...
type
  ...
  TMyObj1335_List0 = TObjectList<TMyObj1335>;

  TMyObj1335_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1335_List1 = TObjectList<TMyObj1335_1>;
...
constructor TMyObj1335_1.Create;
begin
  inherited;
  FInt := 1335 * 3;
  FTest := 'Value: ' + Random(213352).ToString + Random(133500).ToString;
end;

procedure TForm1335.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1335;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1335_List0 := TMyObj1335_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1335_List1 := TMyObj1335_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
