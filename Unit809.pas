...
type
  ...
  TMyObj809_List0 = TObjectList<TMyObj809>;

  TMyObj809_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj809_List1 = TObjectList<TMyObj809_1>;
...
constructor TMyObj809_1.Create;
begin
  inherited;
  FInt := 809 * 3;
  FTest := 'Value: ' + Random(28092).ToString + Random(80900).ToString;
end;

procedure TForm809.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum809;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj809_List0 := TMyObj809_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj809_List1 := TMyObj809_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
