...
type
  ...
  TMyObj1193_List0 = TObjectList<TMyObj1193>;

  TMyObj1193_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1193_List1 = TObjectList<TMyObj1193_1>;
...
constructor TMyObj1193_1.Create;
begin
  inherited;
  FInt := 1193 * 3;
  FTest := 'Value: ' + Random(211932).ToString + Random(119300).ToString;
end;

procedure TForm1193.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1193;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1193_List0 := TMyObj1193_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1193_List1 := TMyObj1193_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
