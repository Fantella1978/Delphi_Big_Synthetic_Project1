...
type
  ...
  TMyObj359_List0 = TObjectList<TMyObj359>;

  TMyObj359_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj359_List1 = TObjectList<TMyObj359_1>;
...
constructor TMyObj359_1.Create;
begin
  inherited;
  FInt := 359 * 3;
  FTest := 'Value: ' + Random(23592).ToString + Random(35900).ToString;
end;

procedure TForm359.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum359;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj359_List0 := TMyObj359_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj359_List1 := TMyObj359_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
