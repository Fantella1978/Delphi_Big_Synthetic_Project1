...
type
  ...
  TMyObj407_List0 = TObjectList<TMyObj407>;

  TMyObj407_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj407_List1 = TObjectList<TMyObj407_1>;
...
constructor TMyObj407_1.Create;
begin
  inherited;
  FInt := 407 * 3;
  FTest := 'Value: ' + Random(24072).ToString + Random(40700).ToString;
end;

procedure TForm407.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum407;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj407_List0 := TMyObj407_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj407_List1 := TMyObj407_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
