...
type
  ...
  TMyObj385_List0 = TObjectList<TMyObj385>;

  TMyObj385_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj385_List1 = TObjectList<TMyObj385_1>;
...
constructor TMyObj385_1.Create;
begin
  inherited;
  FInt := 385 * 3;
  FTest := 'Value: ' + Random(23852).ToString + Random(38500).ToString;
end;

procedure TForm385.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum385;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj385_List0 := TMyObj385_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj385_List1 := TMyObj385_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
