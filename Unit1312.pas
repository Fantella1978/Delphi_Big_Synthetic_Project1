...
type
  ...
  TMyObj1312_List0 = TObjectList<TMyObj1312>;

  TMyObj1312_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1312_List1 = TObjectList<TMyObj1312_1>;
...
constructor TMyObj1312_1.Create;
begin
  inherited;
  FInt := 1312 * 3;
  FTest := 'Value: ' + Random(213122).ToString + Random(131200).ToString;
end;

procedure TForm1312.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1312;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1312_List0 := TMyObj1312_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1312_List1 := TMyObj1312_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
