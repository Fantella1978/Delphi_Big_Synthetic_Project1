...
type
  ...
  TMyObj2362_List0 = TObjectList<TMyObj2362>;

  TMyObj2362_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2362_List1 = TObjectList<TMyObj2362_1>;
...
constructor TMyObj2362_1.Create;
begin
  inherited;
  FInt := 2362 * 3;
  FTest := 'Value: ' + Random(223622).ToString + Random(236200).ToString;
end;

procedure TForm2362.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2362;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2362_List0 := TMyObj2362_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2362_List1 := TMyObj2362_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
