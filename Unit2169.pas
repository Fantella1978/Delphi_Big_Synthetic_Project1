...
type
  ...
  TMyObj2169_List0 = TObjectList<TMyObj2169>;

  TMyObj2169_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2169_List1 = TObjectList<TMyObj2169_1>;
...
constructor TMyObj2169_1.Create;
begin
  inherited;
  FInt := 2169 * 3;
  FTest := 'Value: ' + Random(221692).ToString + Random(216900).ToString;
end;

procedure TForm2169.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2169;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2169_List0 := TMyObj2169_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2169_List1 := TMyObj2169_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
