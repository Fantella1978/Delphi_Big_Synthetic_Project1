...
type
  ...
  TMyObj1497_List0 = TObjectList<TMyObj1497>;

  TMyObj1497_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1497_List1 = TObjectList<TMyObj1497_1>;
...
constructor TMyObj1497_1.Create;
begin
  inherited;
  FInt := 1497 * 3;
  FTest := 'Value: ' + Random(214972).ToString + Random(149700).ToString;
end;

procedure TForm1497.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1497;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1497_List0 := TMyObj1497_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1497_List1 := TMyObj1497_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
