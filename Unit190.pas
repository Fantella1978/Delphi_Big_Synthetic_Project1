...
type
  ...
  TMyObj190_List0 = TObjectList<TMyObj190>;

  TMyObj190_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj190_List1 = TObjectList<TMyObj190_1>;
...
constructor TMyObj190_1.Create;
begin
  inherited;
  FInt := 190 * 3;
  FTest := 'Value: ' + Random(21902).ToString + Random(19000).ToString;
end;

procedure TForm190.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum190;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj190_List0 := TMyObj190_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj190_List1 := TMyObj190_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
