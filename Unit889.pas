...
type
  ...
  TMyObj889_List0 = TObjectList<TMyObj889>;

  TMyObj889_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj889_List1 = TObjectList<TMyObj889_1>;
...
constructor TMyObj889_1.Create;
begin
  inherited;
  FInt := 889 * 3;
  FTest := 'Value: ' + Random(28892).ToString + Random(88900).ToString;
end;

procedure TForm889.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum889;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj889_List0 := TMyObj889_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj889_List1 := TMyObj889_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
