...
type
  ...
  TMyObj1539_List0 = TObjectList<TMyObj1539>;

  TMyObj1539_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1539_List1 = TObjectList<TMyObj1539_1>;
...
constructor TMyObj1539_1.Create;
begin
  inherited;
  FInt := 1539 * 3;
  FTest := 'Value: ' + Random(215392).ToString + Random(153900).ToString;
end;

procedure TForm1539.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1539;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1539_List0 := TMyObj1539_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1539_List1 := TMyObj1539_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
