...
type
  ...
  TMyObj1321_List0 = TObjectList<TMyObj1321>;

  TMyObj1321_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1321_List1 = TObjectList<TMyObj1321_1>;
...
constructor TMyObj1321_1.Create;
begin
  inherited;
  FInt := 1321 * 3;
  FTest := 'Value: ' + Random(213212).ToString + Random(132100).ToString;
end;

procedure TForm1321.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1321;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1321_List0 := TMyObj1321_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1321_List1 := TMyObj1321_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
