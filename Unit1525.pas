...
type
  ...
  TMyObj1525_List0 = TObjectList<TMyObj1525>;

  TMyObj1525_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1525_List1 = TObjectList<TMyObj1525_1>;
...
constructor TMyObj1525_1.Create;
begin
  inherited;
  FInt := 1525 * 3;
  FTest := 'Value: ' + Random(215252).ToString + Random(152500).ToString;
end;

procedure TForm1525.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1525;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15250).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15255).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15257).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1525_List0 := TMyObj1525_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1525_List1 := TMyObj1525_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
