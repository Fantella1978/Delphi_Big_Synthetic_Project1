...
type
  ...
  TMyObj1989_List0 = TObjectList<TMyObj1989>;

  TMyObj1989_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1989_List1 = TObjectList<TMyObj1989_1>;
...
constructor TMyObj1989_1.Create;
begin
  inherited;
  FInt := 1989 * 3;
  FTest := 'Value: ' + Random(219892).ToString + Random(198900).ToString;
end;

procedure TForm1989.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1989;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1989_List0 := TMyObj1989_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1989_List1 := TMyObj1989_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
