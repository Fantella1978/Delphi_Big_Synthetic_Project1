...
type
  ...
  TMyObj740_List0 = TObjectList<TMyObj740>;

  TMyObj740_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj740_List1 = TObjectList<TMyObj740_1>;
...
constructor TMyObj740_1.Create;
begin
  inherited;
  FInt := 740 * 3;
  FTest := 'Value: ' + Random(27402).ToString + Random(74000).ToString;
end;

procedure TForm740.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum740;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj740_List0 := TMyObj740_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj740_List1 := TMyObj740_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
