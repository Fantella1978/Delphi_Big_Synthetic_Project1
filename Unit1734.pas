...
type
  ...
  TMyObj1734_List0 = TObjectList<TMyObj1734>;

  TMyObj1734_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1734_List1 = TObjectList<TMyObj1734_1>;
...
constructor TMyObj1734_1.Create;
begin
  inherited;
  FInt := 1734 * 3;
  FTest := 'Value: ' + Random(217342).ToString + Random(173400).ToString;
end;

procedure TForm1734.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1734;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1734_List0 := TMyObj1734_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1734_List1 := TMyObj1734_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
