...
type
  ...
  TMyObj720_List0 = TObjectList<TMyObj720>;

  TMyObj720_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj720_List1 = TObjectList<TMyObj720_1>;
...
constructor TMyObj720_1.Create;
begin
  inherited;
  FInt := 720 * 3;
  FTest := 'Value: ' + Random(27202).ToString + Random(72000).ToString;
end;

procedure TForm720.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum720;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7200).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7205).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7207).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj720_List0 := TMyObj720_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj720_List1 := TMyObj720_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
