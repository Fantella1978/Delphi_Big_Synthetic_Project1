...
type
  ...
  TMyObj483_List0 = TObjectList<TMyObj483>;

  TMyObj483_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj483_List1 = TObjectList<TMyObj483_1>;
...
constructor TMyObj483_1.Create;
begin
  inherited;
  FInt := 483 * 3;
  FTest := 'Value: ' + Random(24832).ToString + Random(48300).ToString;
end;

procedure TForm483.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum483;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj483_List0 := TMyObj483_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj483_List1 := TMyObj483_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
