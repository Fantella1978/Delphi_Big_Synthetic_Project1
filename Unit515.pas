...
type
  ...
  TMyObj515_List0 = TObjectList<TMyObj515>;

  TMyObj515_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj515_List1 = TObjectList<TMyObj515_1>;
...
constructor TMyObj515_1.Create;
begin
  inherited;
  FInt := 515 * 3;
  FTest := 'Value: ' + Random(25152).ToString + Random(51500).ToString;
end;

procedure TForm515.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum515;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj515_List0 := TMyObj515_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj515_List1 := TMyObj515_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
