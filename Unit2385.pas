...
type
  ...
  TMyObj2385_List0 = TObjectList<TMyObj2385>;

  TMyObj2385_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2385_List1 = TObjectList<TMyObj2385_1>;
...
constructor TMyObj2385_1.Create;
begin
  inherited;
  FInt := 2385 * 3;
  FTest := 'Value: ' + Random(223852).ToString + Random(238500).ToString;
end;

procedure TForm2385.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2385;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2385_List0 := TMyObj2385_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2385_List1 := TMyObj2385_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
