...
type
  ...
  TMyObj852_List0 = TObjectList<TMyObj852>;

  TMyObj852_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj852_List1 = TObjectList<TMyObj852_1>;
...
constructor TMyObj852_1.Create;
begin
  inherited;
  FInt := 852 * 3;
  FTest := 'Value: ' + Random(28522).ToString + Random(85200).ToString;
end;

procedure TForm852.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum852;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj852_List0 := TMyObj852_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj852_List1 := TMyObj852_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
