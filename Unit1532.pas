...
type
  ...
  TMyObj1532_List0 = TObjectList<TMyObj1532>;

  TMyObj1532_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1532_List1 = TObjectList<TMyObj1532_1>;
...
constructor TMyObj1532_1.Create;
begin
  inherited;
  FInt := 1532 * 3;
  FTest := 'Value: ' + Random(215322).ToString + Random(153200).ToString;
end;

procedure TForm1532.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1532;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1532_List0 := TMyObj1532_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1532_List1 := TMyObj1532_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
