...
type
  ...
  TMyObj215_List0 = TObjectList<TMyObj215>;

  TMyObj215_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj215_List1 = TObjectList<TMyObj215_1>;
...
constructor TMyObj215_1.Create;
begin
  inherited;
  FInt := 215 * 3;
  FTest := 'Value: ' + Random(22152).ToString + Random(21500).ToString;
end;

procedure TForm215.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum215;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj215_List0 := TMyObj215_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj215_List1 := TMyObj215_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
