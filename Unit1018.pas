...
type
  ...
  TMyObj1018_List0 = TObjectList<TMyObj1018>;

  TMyObj1018_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1018_List1 = TObjectList<TMyObj1018_1>;
...
constructor TMyObj1018_1.Create;
begin
  inherited;
  FInt := 1018 * 3;
  FTest := 'Value: ' + Random(210182).ToString + Random(101800).ToString;
end;

procedure TForm1018.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1018;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1018_List0 := TMyObj1018_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1018_List1 := TMyObj1018_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
