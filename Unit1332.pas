...
type
  ...
  TMyObj1332_List0 = TObjectList<TMyObj1332>;

  TMyObj1332_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1332_List1 = TObjectList<TMyObj1332_1>;
...
constructor TMyObj1332_1.Create;
begin
  inherited;
  FInt := 1332 * 3;
  FTest := 'Value: ' + Random(213322).ToString + Random(133200).ToString;
end;

procedure TForm1332.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1332;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1332_List0 := TMyObj1332_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1332_List1 := TMyObj1332_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
