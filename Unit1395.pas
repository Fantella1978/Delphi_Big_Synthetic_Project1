...
type
  ...
  TMyObj1395_List0 = TObjectList<TMyObj1395>;

  TMyObj1395_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1395_List1 = TObjectList<TMyObj1395_1>;
...
constructor TMyObj1395_1.Create;
begin
  inherited;
  FInt := 1395 * 3;
  FTest := 'Value: ' + Random(213952).ToString + Random(139500).ToString;
end;

procedure TForm1395.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1395;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1395_List0 := TMyObj1395_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1395_List1 := TMyObj1395_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
