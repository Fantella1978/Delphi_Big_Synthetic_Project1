...
type
  ...
  TMyObj1788_List0 = TObjectList<TMyObj1788>;

  TMyObj1788_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1788_List1 = TObjectList<TMyObj1788_1>;
...
constructor TMyObj1788_1.Create;
begin
  inherited;
  FInt := 1788 * 3;
  FTest := 'Value: ' + Random(217882).ToString + Random(178800).ToString;
end;

procedure TForm1788.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1788;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17880).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17885).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17887).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1788_List0 := TMyObj1788_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1788_List1 := TMyObj1788_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
