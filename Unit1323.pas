...
type
  ...
  TMyObj1323_List0 = TObjectList<TMyObj1323>;

  TMyObj1323_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1323_List1 = TObjectList<TMyObj1323_1>;
...
constructor TMyObj1323_1.Create;
begin
  inherited;
  FInt := 1323 * 3;
  FTest := 'Value: ' + Random(213232).ToString + Random(132300).ToString;
end;

procedure TForm1323.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1323;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1323_List0 := TMyObj1323_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1323_List1 := TMyObj1323_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
