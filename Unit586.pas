...
type
  ...
  TMyObj586_List0 = TObjectList<TMyObj586>;

  TMyObj586_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj586_List1 = TObjectList<TMyObj586_1>;
...
constructor TMyObj586_1.Create;
begin
  inherited;
  FInt := 586 * 3;
  FTest := 'Value: ' + Random(25862).ToString + Random(58600).ToString;
end;

procedure TForm586.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum586;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj586_List0 := TMyObj586_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj586_List1 := TMyObj586_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
