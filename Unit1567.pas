...
type
  ...
  TMyObj1567_List0 = TObjectList<TMyObj1567>;

  TMyObj1567_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1567_List1 = TObjectList<TMyObj1567_1>;
...
constructor TMyObj1567_1.Create;
begin
  inherited;
  FInt := 1567 * 3;
  FTest := 'Value: ' + Random(215672).ToString + Random(156700).ToString;
end;

procedure TForm1567.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1567;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1567_List0 := TMyObj1567_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1567_List1 := TMyObj1567_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
