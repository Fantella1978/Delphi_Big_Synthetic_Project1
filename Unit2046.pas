...
type
  ...
  TMyObj2046_List0 = TObjectList<TMyObj2046>;

  TMyObj2046_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2046_List1 = TObjectList<TMyObj2046_1>;
...
constructor TMyObj2046_1.Create;
begin
  inherited;
  FInt := 2046 * 3;
  FTest := 'Value: ' + Random(220462).ToString + Random(204600).ToString;
end;

procedure TForm2046.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2046;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2046_List0 := TMyObj2046_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2046_List1 := TMyObj2046_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
