...
type
  ...
  TMyObj2148_List0 = TObjectList<TMyObj2148>;

  TMyObj2148_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2148_List1 = TObjectList<TMyObj2148_1>;
...
constructor TMyObj2148_1.Create;
begin
  inherited;
  FInt := 2148 * 3;
  FTest := 'Value: ' + Random(221482).ToString + Random(214800).ToString;
end;

procedure TForm2148.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2148;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2148_List0 := TMyObj2148_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2148_List1 := TMyObj2148_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
