...
type
  ...
  TMyObj1828_List0 = TObjectList<TMyObj1828>;

  TMyObj1828_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1828_List1 = TObjectList<TMyObj1828_1>;
...
constructor TMyObj1828_1.Create;
begin
  inherited;
  FInt := 1828 * 3;
  FTest := 'Value: ' + Random(218282).ToString + Random(182800).ToString;
end;

procedure TForm1828.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1828;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1828_List0 := TMyObj1828_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1828_List1 := TMyObj1828_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
