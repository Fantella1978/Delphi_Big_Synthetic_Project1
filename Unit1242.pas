...
type
  ...
  TMyObj1242_List0 = TObjectList<TMyObj1242>;

  TMyObj1242_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1242_List1 = TObjectList<TMyObj1242_1>;
...
constructor TMyObj1242_1.Create;
begin
  inherited;
  FInt := 1242 * 3;
  FTest := 'Value: ' + Random(212422).ToString + Random(124200).ToString;
end;

procedure TForm1242.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1242;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1242_List0 := TMyObj1242_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1242_List1 := TMyObj1242_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
