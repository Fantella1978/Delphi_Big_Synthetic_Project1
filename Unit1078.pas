...
type
  ...
  TMyObj1078_List0 = TObjectList<TMyObj1078>;

  TMyObj1078_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1078_List1 = TObjectList<TMyObj1078_1>;
...
constructor TMyObj1078_1.Create;
begin
  inherited;
  FInt := 1078 * 3;
  FTest := 'Value: ' + Random(210782).ToString + Random(107800).ToString;
end;

procedure TForm1078.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1078;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1078_List0 := TMyObj1078_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1078_List1 := TMyObj1078_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
