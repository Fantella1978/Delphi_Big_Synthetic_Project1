...
type
  ...
  TMyObj1926_List0 = TObjectList<TMyObj1926>;

  TMyObj1926_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1926_List1 = TObjectList<TMyObj1926_1>;
...
constructor TMyObj1926_1.Create;
begin
  inherited;
  FInt := 1926 * 3;
  FTest := 'Value: ' + Random(219262).ToString + Random(192600).ToString;
end;

procedure TForm1926.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1926;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1926_List0 := TMyObj1926_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1926_List1 := TMyObj1926_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
