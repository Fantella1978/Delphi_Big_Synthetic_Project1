...
type
  ...
  TMyObj1944_List0 = TObjectList<TMyObj1944>;

  TMyObj1944_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1944_List1 = TObjectList<TMyObj1944_1>;
...
constructor TMyObj1944_1.Create;
begin
  inherited;
  FInt := 1944 * 3;
  FTest := 'Value: ' + Random(219442).ToString + Random(194400).ToString;
end;

procedure TForm1944.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1944;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1944_List0 := TMyObj1944_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1944_List1 := TMyObj1944_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
