...
type
  ...
  TMyObj2419_List0 = TObjectList<TMyObj2419>;

  TMyObj2419_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2419_List1 = TObjectList<TMyObj2419_1>;
...
constructor TMyObj2419_1.Create;
begin
  inherited;
  FInt := 2419 * 3;
  FTest := 'Value: ' + Random(224192).ToString + Random(241900).ToString;
end;

procedure TForm2419.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2419;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2419_List0 := TMyObj2419_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2419_List1 := TMyObj2419_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
