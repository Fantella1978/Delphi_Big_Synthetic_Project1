...
type
  ...
  TMyObj1315_List0 = TObjectList<TMyObj1315>;

  TMyObj1315_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1315_List1 = TObjectList<TMyObj1315_1>;
...
constructor TMyObj1315_1.Create;
begin
  inherited;
  FInt := 1315 * 3;
  FTest := 'Value: ' + Random(213152).ToString + Random(131500).ToString;
end;

procedure TForm1315.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1315;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1315_List0 := TMyObj1315_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1315_List1 := TMyObj1315_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
