...
type
  ...
  TMyObj476_List0 = TObjectList<TMyObj476>;

  TMyObj476_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj476_List1 = TObjectList<TMyObj476_1>;
...
constructor TMyObj476_1.Create;
begin
  inherited;
  FInt := 476 * 3;
  FTest := 'Value: ' + Random(24762).ToString + Random(47600).ToString;
end;

procedure TForm476.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum476;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj476_List0 := TMyObj476_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj476_List1 := TMyObj476_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
