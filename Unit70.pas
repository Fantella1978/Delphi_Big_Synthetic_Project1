...
type
  ...
  TMyObj70_List0 = TObjectList<TMyObj70>;

  TMyObj70_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj70_List1 = TObjectList<TMyObj70_1>;
...
constructor TMyObj70_1.Create;
begin
  inherited;
  FInt := 70 * 3;
  FTest := 'Value: ' + Random(2702).ToString + Random(7000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj70_List0 := TMyObj70_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj70_List1 := TMyObj70_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
