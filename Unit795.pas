...
type
  ...
  TMyObj795_List0 = TObjectList<TMyObj795>;

  TMyObj795_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj795_List1 = TObjectList<TMyObj795_1>;
...
constructor TMyObj795_1.Create;
begin
  inherited;
  FInt := 795 * 3;
  FTest := 'Value: ' + Random(27952).ToString + Random(79500).ToString;
end;

procedure TForm795.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum795;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj795_List0 := TMyObj795_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj795_List1 := TMyObj795_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
