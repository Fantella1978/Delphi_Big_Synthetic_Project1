...
type
  ...
  TMyObj2314_List0 = TObjectList<TMyObj2314>;

  TMyObj2314_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2314_List1 = TObjectList<TMyObj2314_1>;
...
constructor TMyObj2314_1.Create;
begin
  inherited;
  FInt := 2314 * 3;
  FTest := 'Value: ' + Random(223142).ToString + Random(231400).ToString;
end;

procedure TForm2314.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2314;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2314_List0 := TMyObj2314_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2314_List1 := TMyObj2314_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
