...
type
  ...
  TMyObj814_List0 = TObjectList<TMyObj814>;

  TMyObj814_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj814_List1 = TObjectList<TMyObj814_1>;
...
constructor TMyObj814_1.Create;
begin
  inherited;
  FInt := 814 * 3;
  FTest := 'Value: ' + Random(28142).ToString + Random(81400).ToString;
end;

procedure TForm814.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum814;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj814_List0 := TMyObj814_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj814_List1 := TMyObj814_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
