...
type
  ...
  TMyObj2001_List0 = TObjectList<TMyObj2001>;

  TMyObj2001_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2001_List1 = TObjectList<TMyObj2001_1>;
...
constructor TMyObj2001_1.Create;
begin
  inherited;
  FInt := 2001 * 3;
  FTest := 'Value: ' + Random(220012).ToString + Random(200100).ToString;
end;

procedure TForm2001.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2001;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20010).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20015).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20017).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2001_List0 := TMyObj2001_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2001_List1 := TMyObj2001_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
