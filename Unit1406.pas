...
type
  ...
  TMyObj1406_List0 = TObjectList<TMyObj1406>;

  TMyObj1406_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1406_List1 = TObjectList<TMyObj1406_1>;
...
constructor TMyObj1406_1.Create;
begin
  inherited;
  FInt := 1406 * 3;
  FTest := 'Value: ' + Random(214062).ToString + Random(140600).ToString;
end;

procedure TForm1406.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1406;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1406_List0 := TMyObj1406_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1406_List1 := TMyObj1406_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
