...
type
  ...
  TMyObj234_List0 = TObjectList<TMyObj234>;

  TMyObj234_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj234_List1 = TObjectList<TMyObj234_1>;
...
constructor TMyObj234_1.Create;
begin
  inherited;
  FInt := 234 * 3;
  FTest := 'Value: ' + Random(22342).ToString + Random(23400).ToString;
end;

procedure TForm234.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum234;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2340).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2345).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2347).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj234_List0 := TMyObj234_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj234_List1 := TMyObj234_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
