...
type
  ...
  TMyObj1390_List0 = TObjectList<TMyObj1390>;

  TMyObj1390_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1390_List1 = TObjectList<TMyObj1390_1>;
...
constructor TMyObj1390_1.Create;
begin
  inherited;
  FInt := 1390 * 3;
  FTest := 'Value: ' + Random(213902).ToString + Random(139000).ToString;
end;

procedure TForm1390.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1390;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1390_List0 := TMyObj1390_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1390_List1 := TMyObj1390_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
