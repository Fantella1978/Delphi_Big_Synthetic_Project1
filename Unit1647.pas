...
type
  ...
  TMyObj1647_List0 = TObjectList<TMyObj1647>;

  TMyObj1647_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1647_List1 = TObjectList<TMyObj1647_1>;
...
constructor TMyObj1647_1.Create;
begin
  inherited;
  FInt := 1647 * 3;
  FTest := 'Value: ' + Random(216472).ToString + Random(164700).ToString;
end;

procedure TForm1647.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1647;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1647_List0 := TMyObj1647_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1647_List1 := TMyObj1647_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
