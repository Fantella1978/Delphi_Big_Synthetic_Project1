...
type
  ...
  TMyObj555_List0 = TObjectList<TMyObj555>;

  TMyObj555_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj555_List1 = TObjectList<TMyObj555_1>;
...
constructor TMyObj555_1.Create;
begin
  inherited;
  FInt := 555 * 3;
  FTest := 'Value: ' + Random(25552).ToString + Random(55500).ToString;
end;

procedure TForm555.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum555;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj555_List0 := TMyObj555_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj555_List1 := TMyObj555_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
