...
type
  ...
  TMyObj1289_List0 = TObjectList<TMyObj1289>;

  TMyObj1289_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1289_List1 = TObjectList<TMyObj1289_1>;
...
constructor TMyObj1289_1.Create;
begin
  inherited;
  FInt := 1289 * 3;
  FTest := 'Value: ' + Random(212892).ToString + Random(128900).ToString;
end;

procedure TForm1289.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1289;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1289_List0 := TMyObj1289_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1289_List1 := TMyObj1289_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
