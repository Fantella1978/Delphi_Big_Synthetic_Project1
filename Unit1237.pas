...
type
  ...
  TMyObj1237_List0 = TObjectList<TMyObj1237>;

  TMyObj1237_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1237_List1 = TObjectList<TMyObj1237_1>;
...
constructor TMyObj1237_1.Create;
begin
  inherited;
  FInt := 1237 * 3;
  FTest := 'Value: ' + Random(212372).ToString + Random(123700).ToString;
end;

procedure TForm1237.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1237;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1237_List0 := TMyObj1237_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1237_List1 := TMyObj1237_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
