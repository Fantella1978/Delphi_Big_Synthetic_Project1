...
type
  ...
  TMyObj777_List0 = TObjectList<TMyObj777>;

  TMyObj777_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj777_List1 = TObjectList<TMyObj777_1>;
...
constructor TMyObj777_1.Create;
begin
  inherited;
  FInt := 777 * 3;
  FTest := 'Value: ' + Random(27772).ToString + Random(77700).ToString;
end;

procedure TForm777.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum777;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj777_List0 := TMyObj777_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj777_List1 := TMyObj777_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
