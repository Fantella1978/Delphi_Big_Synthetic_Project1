...
type
  ...
  TMyObj236_List0 = TObjectList<TMyObj236>;

  TMyObj236_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj236_List1 = TObjectList<TMyObj236_1>;
...
constructor TMyObj236_1.Create;
begin
  inherited;
  FInt := 236 * 3;
  FTest := 'Value: ' + Random(22362).ToString + Random(23600).ToString;
end;

procedure TForm236.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum236;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj236_List0 := TMyObj236_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj236_List1 := TMyObj236_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
