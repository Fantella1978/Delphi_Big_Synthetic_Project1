...
type
  ...
  TMyObj2492_List0 = TObjectList<TMyObj2492>;

  TMyObj2492_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2492_List1 = TObjectList<TMyObj2492_1>;
...
constructor TMyObj2492_1.Create;
begin
  inherited;
  FInt := 2492 * 3;
  FTest := 'Value: ' + Random(224922).ToString + Random(249200).ToString;
end;

procedure TForm2492.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2492;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2492_List0 := TMyObj2492_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2492_List1 := TMyObj2492_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
