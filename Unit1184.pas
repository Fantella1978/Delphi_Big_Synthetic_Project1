...
type
  ...
  TMyObj1184_List0 = TObjectList<TMyObj1184>;

  TMyObj1184_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1184_List1 = TObjectList<TMyObj1184_1>;
...
constructor TMyObj1184_1.Create;
begin
  inherited;
  FInt := 1184 * 3;
  FTest := 'Value: ' + Random(211842).ToString + Random(118400).ToString;
end;

procedure TForm1184.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1184;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1184_List0 := TMyObj1184_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1184_List1 := TMyObj1184_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
