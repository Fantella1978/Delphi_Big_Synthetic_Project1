...
type
  ...
  TMyObj2149_List0 = TObjectList<TMyObj2149>;

  TMyObj2149_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2149_List1 = TObjectList<TMyObj2149_1>;
...
constructor TMyObj2149_1.Create;
begin
  inherited;
  FInt := 2149 * 3;
  FTest := 'Value: ' + Random(221492).ToString + Random(214900).ToString;
end;

procedure TForm2149.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2149;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2149_List0 := TMyObj2149_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2149_List1 := TMyObj2149_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
