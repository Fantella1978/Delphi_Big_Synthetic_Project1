...
type
  ...
  TMyObj494_List0 = TObjectList<TMyObj494>;

  TMyObj494_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj494_List1 = TObjectList<TMyObj494_1>;
...
constructor TMyObj494_1.Create;
begin
  inherited;
  FInt := 494 * 3;
  FTest := 'Value: ' + Random(24942).ToString + Random(49400).ToString;
end;

procedure TForm494.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum494;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj494_List0 := TMyObj494_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj494_List1 := TMyObj494_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
