...
type
  ...
  TMyObj2360_List0 = TObjectList<TMyObj2360>;

  TMyObj2360_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2360_List1 = TObjectList<TMyObj2360_1>;
...
constructor TMyObj2360_1.Create;
begin
  inherited;
  FInt := 2360 * 3;
  FTest := 'Value: ' + Random(223602).ToString + Random(236000).ToString;
end;

procedure TForm2360.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2360;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2360_List0 := TMyObj2360_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2360_List1 := TMyObj2360_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
