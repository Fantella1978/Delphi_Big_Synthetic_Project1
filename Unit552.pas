...
type
  ...
  TMyObj552_List0 = TObjectList<TMyObj552>;

  TMyObj552_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj552_List1 = TObjectList<TMyObj552_1>;
...
constructor TMyObj552_1.Create;
begin
  inherited;
  FInt := 552 * 3;
  FTest := 'Value: ' + Random(25522).ToString + Random(55200).ToString;
end;

procedure TForm552.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum552;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj552_List0 := TMyObj552_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj552_List1 := TMyObj552_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
