...
type
  ...
  TMyObj1380_List0 = TObjectList<TMyObj1380>;

  TMyObj1380_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1380_List1 = TObjectList<TMyObj1380_1>;
...
constructor TMyObj1380_1.Create;
begin
  inherited;
  FInt := 1380 * 3;
  FTest := 'Value: ' + Random(213802).ToString + Random(138000).ToString;
end;

procedure TForm1380.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1380;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1380_List0 := TMyObj1380_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1380_List1 := TMyObj1380_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
