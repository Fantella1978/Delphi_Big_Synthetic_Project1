...
type
  ...
  TMyObj599_List0 = TObjectList<TMyObj599>;

  TMyObj599_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj599_List1 = TObjectList<TMyObj599_1>;
...
constructor TMyObj599_1.Create;
begin
  inherited;
  FInt := 599 * 3;
  FTest := 'Value: ' + Random(25992).ToString + Random(59900).ToString;
end;

procedure TForm599.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum599;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj599_List0 := TMyObj599_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj599_List1 := TMyObj599_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
