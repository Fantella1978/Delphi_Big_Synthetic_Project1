...
type
  ...
  TMyObj1757_List0 = TObjectList<TMyObj1757>;

  TMyObj1757_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1757_List1 = TObjectList<TMyObj1757_1>;
...
constructor TMyObj1757_1.Create;
begin
  inherited;
  FInt := 1757 * 3;
  FTest := 'Value: ' + Random(217572).ToString + Random(175700).ToString;
end;

procedure TForm1757.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1757;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1757_List0 := TMyObj1757_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1757_List1 := TMyObj1757_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
