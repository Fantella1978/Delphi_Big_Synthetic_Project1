...
type
  ...
  TMyObj1213_List0 = TObjectList<TMyObj1213>;

  TMyObj1213_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1213_List1 = TObjectList<TMyObj1213_1>;
...
constructor TMyObj1213_1.Create;
begin
  inherited;
  FInt := 1213 * 3;
  FTest := 'Value: ' + Random(212132).ToString + Random(121300).ToString;
end;

procedure TForm1213.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1213;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1213_List0 := TMyObj1213_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1213_List1 := TMyObj1213_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
