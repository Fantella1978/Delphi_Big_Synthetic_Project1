...
type
  ...
  TMyObj2284_List0 = TObjectList<TMyObj2284>;

  TMyObj2284_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2284_List1 = TObjectList<TMyObj2284_1>;
...
constructor TMyObj2284_1.Create;
begin
  inherited;
  FInt := 2284 * 3;
  FTest := 'Value: ' + Random(222842).ToString + Random(228400).ToString;
end;

procedure TForm2284.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2284;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2284_List0 := TMyObj2284_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2284_List1 := TMyObj2284_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
