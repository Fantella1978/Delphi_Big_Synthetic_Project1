...
type
  ...
  TMyObj2061_List0 = TObjectList<TMyObj2061>;

  TMyObj2061_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2061_List1 = TObjectList<TMyObj2061_1>;
...
constructor TMyObj2061_1.Create;
begin
  inherited;
  FInt := 2061 * 3;
  FTest := 'Value: ' + Random(220612).ToString + Random(206100).ToString;
end;

procedure TForm2061.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2061;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2061_List0 := TMyObj2061_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2061_List1 := TMyObj2061_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
