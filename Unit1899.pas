...
type
  ...
  TMyObj1899_List0 = TObjectList<TMyObj1899>;

  TMyObj1899_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1899_List1 = TObjectList<TMyObj1899_1>;
...
constructor TMyObj1899_1.Create;
begin
  inherited;
  FInt := 1899 * 3;
  FTest := 'Value: ' + Random(218992).ToString + Random(189900).ToString;
end;

procedure TForm1899.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1899;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1899_List0 := TMyObj1899_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1899_List1 := TMyObj1899_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
