...
type
  ...
  TMyObj217_List0 = TObjectList<TMyObj217>;

  TMyObj217_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj217_List1 = TObjectList<TMyObj217_1>;
...
constructor TMyObj217_1.Create;
begin
  inherited;
  FInt := 217 * 3;
  FTest := 'Value: ' + Random(22172).ToString + Random(21700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj217_List0 := TMyObj217_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj217_List1 := TMyObj217_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
