...
type
  ...
  TMyObj1917_List0 = TObjectList<TMyObj1917>;

  TMyObj1917_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1917_List1 = TObjectList<TMyObj1917_1>;
...
constructor TMyObj1917_1.Create;
begin
  inherited;
  FInt := 1917 * 3;
  FTest := 'Value: ' + Random(219172).ToString + Random(191700).ToString;
end;

procedure TForm1917.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1917;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1917_List0 := TMyObj1917_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1917_List1 := TMyObj1917_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
