...
type
  ...
  TMyObj60_List0 = TObjectList<TMyObj60>;

  TMyObj60_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj60_List1 = TObjectList<TMyObj60_1>;
...
constructor TMyObj60_1.Create;
begin
  inherited;
  FInt := 60 * 3;
  FTest := 'Value: ' + Random(2602).ToString + Random(6000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj60_List0 := TMyObj60_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj60_List1 := TMyObj60_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
