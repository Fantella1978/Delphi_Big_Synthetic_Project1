...
type
  ...
  TMyObj319_List0 = TObjectList<TMyObj319>;

  TMyObj319_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj319_List1 = TObjectList<TMyObj319_1>;
...
constructor TMyObj319_1.Create;
begin
  inherited;
  FInt := 319 * 3;
  FTest := 'Value: ' + Random(23192).ToString + Random(31900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj319_List0 := TMyObj319_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj319_List1 := TMyObj319_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
