...
type
  ...
  TMyObj1182_List0 = TObjectList<TMyObj1182>;

  TMyObj1182_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1182_List1 = TObjectList<TMyObj1182_1>;
...
constructor TMyObj1182_1.Create;
begin
  inherited;
  FInt := 1182 * 3;
  FTest := 'Value: ' + Random(211822).ToString + Random(118200).ToString;
end;

procedure TForm1182.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1182;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1182_List0 := TMyObj1182_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1182_List1 := TMyObj1182_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
