...
type
  ...
  TMyObj2227_List0 = TObjectList<TMyObj2227>;

  TMyObj2227_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2227_List1 = TObjectList<TMyObj2227_1>;
...
constructor TMyObj2227_1.Create;
begin
  inherited;
  FInt := 2227 * 3;
  FTest := 'Value: ' + Random(222272).ToString + Random(222700).ToString;
end;

procedure TForm2227.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2227;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2227_List0 := TMyObj2227_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2227_List1 := TMyObj2227_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
