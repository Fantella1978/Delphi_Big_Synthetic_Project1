...
type
  ...
  TMyObj1507_List0 = TObjectList<TMyObj1507>;

  TMyObj1507_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1507_List1 = TObjectList<TMyObj1507_1>;
...
constructor TMyObj1507_1.Create;
begin
  inherited;
  FInt := 1507 * 3;
  FTest := 'Value: ' + Random(215072).ToString + Random(150700).ToString;
end;

procedure TForm1507.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1507;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15070).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15075).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15077).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1507_List0 := TMyObj1507_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1507_List1 := TMyObj1507_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
