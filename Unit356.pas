...
type
  ...
  TMyObj356_List0 = TObjectList<TMyObj356>;

  TMyObj356_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj356_List1 = TObjectList<TMyObj356_1>;
...
constructor TMyObj356_1.Create;
begin
  inherited;
  FInt := 356 * 3;
  FTest := 'Value: ' + Random(23562).ToString + Random(35600).ToString;
end;

procedure TForm356.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum356;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj356_List0 := TMyObj356_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj356_List1 := TMyObj356_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
