...
type
  ...
  TMyObj1939_List0 = TObjectList<TMyObj1939>;

  TMyObj1939_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1939_List1 = TObjectList<TMyObj1939_1>;
...
constructor TMyObj1939_1.Create;
begin
  inherited;
  FInt := 1939 * 3;
  FTest := 'Value: ' + Random(219392).ToString + Random(193900).ToString;
end;

procedure TForm1939.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1939;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1939_List0 := TMyObj1939_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1939_List1 := TMyObj1939_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
