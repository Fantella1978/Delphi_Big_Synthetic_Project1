...
type
  ...
  TMyObj1593_List0 = TObjectList<TMyObj1593>;

  TMyObj1593_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1593_List1 = TObjectList<TMyObj1593_1>;
...
constructor TMyObj1593_1.Create;
begin
  inherited;
  FInt := 1593 * 3;
  FTest := 'Value: ' + Random(215932).ToString + Random(159300).ToString;
end;

procedure TForm1593.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1593;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1593_List0 := TMyObj1593_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1593_List1 := TMyObj1593_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
