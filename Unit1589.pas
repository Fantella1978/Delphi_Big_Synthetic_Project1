...
type
  ...
  TMyObj1589_List0 = TObjectList<TMyObj1589>;

  TMyObj1589_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1589_List1 = TObjectList<TMyObj1589_1>;
...
constructor TMyObj1589_1.Create;
begin
  inherited;
  FInt := 1589 * 3;
  FTest := 'Value: ' + Random(215892).ToString + Random(158900).ToString;
end;

procedure TForm1589.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1589;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1589_List0 := TMyObj1589_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1589_List1 := TMyObj1589_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
