...
type
  ...
  TMyObj259_List0 = TObjectList<TMyObj259>;

  TMyObj259_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj259_List1 = TObjectList<TMyObj259_1>;
...
constructor TMyObj259_1.Create;
begin
  inherited;
  FInt := 259 * 3;
  FTest := 'Value: ' + Random(22592).ToString + Random(25900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2590).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2595).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2597).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj259_List0 := TMyObj259_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj259_List1 := TMyObj259_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
