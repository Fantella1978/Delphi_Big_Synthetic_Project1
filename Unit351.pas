...
type
  ...
  TMyObj351_List0 = TObjectList<TMyObj351>;

  TMyObj351_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj351_List1 = TObjectList<TMyObj351_1>;
...
constructor TMyObj351_1.Create;
begin
  inherited;
  FInt := 351 * 3;
  FTest := 'Value: ' + Random(23512).ToString + Random(35100).ToString;
end;

procedure TForm351.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum351;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj351_List0 := TMyObj351_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj351_List1 := TMyObj351_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
