...
type
  ...
  TMyObj2357_List0 = TObjectList<TMyObj2357>;

  TMyObj2357_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2357_List1 = TObjectList<TMyObj2357_1>;
...
constructor TMyObj2357_1.Create;
begin
  inherited;
  FInt := 2357 * 3;
  FTest := 'Value: ' + Random(223572).ToString + Random(235700).ToString;
end;

procedure TForm2357.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2357;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2357_List0 := TMyObj2357_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2357_List1 := TMyObj2357_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
