...
type
  ...
  TMyObj1475_List0 = TObjectList<TMyObj1475>;

  TMyObj1475_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1475_List1 = TObjectList<TMyObj1475_1>;
...
constructor TMyObj1475_1.Create;
begin
  inherited;
  FInt := 1475 * 3;
  FTest := 'Value: ' + Random(214752).ToString + Random(147500).ToString;
end;

procedure TForm1475.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1475;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1475_List0 := TMyObj1475_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1475_List1 := TMyObj1475_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
