...
type
  ...
  TMyObj2011_List0 = TObjectList<TMyObj2011>;

  TMyObj2011_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2011_List1 = TObjectList<TMyObj2011_1>;
...
constructor TMyObj2011_1.Create;
begin
  inherited;
  FInt := 2011 * 3;
  FTest := 'Value: ' + Random(220112).ToString + Random(201100).ToString;
end;

procedure TForm2011.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2011;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2011_List0 := TMyObj2011_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2011_List1 := TMyObj2011_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
