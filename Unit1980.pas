...
type
  ...
  TMyObj1980_List0 = TObjectList<TMyObj1980>;

  TMyObj1980_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1980_List1 = TObjectList<TMyObj1980_1>;
...
constructor TMyObj1980_1.Create;
begin
  inherited;
  FInt := 1980 * 3;
  FTest := 'Value: ' + Random(219802).ToString + Random(198000).ToString;
end;

procedure TForm1980.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1980;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1980_List0 := TMyObj1980_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1980_List1 := TMyObj1980_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
