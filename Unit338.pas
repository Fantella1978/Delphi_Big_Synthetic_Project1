...
type
  ...
  TMyObj338_List0 = TObjectList<TMyObj338>;

  TMyObj338_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj338_List1 = TObjectList<TMyObj338_1>;
...
constructor TMyObj338_1.Create;
begin
  inherited;
  FInt := 338 * 3;
  FTest := 'Value: ' + Random(23382).ToString + Random(33800).ToString;
end;

procedure TForm338.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum338;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj338_List0 := TMyObj338_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj338_List1 := TMyObj338_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
