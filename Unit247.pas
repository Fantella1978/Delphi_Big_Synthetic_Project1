...
type
  ...
  TMyObj247_List0 = TObjectList<TMyObj247>;

  TMyObj247_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj247_List1 = TObjectList<TMyObj247_1>;
...
constructor TMyObj247_1.Create;
begin
  inherited;
  FInt := 247 * 3;
  FTest := 'Value: ' + Random(22472).ToString + Random(24700).ToString;
end;

procedure TForm247.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum247;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj247_List0 := TMyObj247_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj247_List1 := TMyObj247_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
