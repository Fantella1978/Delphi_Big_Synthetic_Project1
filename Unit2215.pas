...
type
  ...
  TMyObj2215_List0 = TObjectList<TMyObj2215>;

  TMyObj2215_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2215_List1 = TObjectList<TMyObj2215_1>;
...
constructor TMyObj2215_1.Create;
begin
  inherited;
  FInt := 2215 * 3;
  FTest := 'Value: ' + Random(222152).ToString + Random(221500).ToString;
end;

procedure TForm2215.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2215;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22150).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22155).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22157).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2215_List0 := TMyObj2215_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2215_List1 := TMyObj2215_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
