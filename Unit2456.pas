...
type
  ...
  TMyObj2456_List0 = TObjectList<TMyObj2456>;

  TMyObj2456_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2456_List1 = TObjectList<TMyObj2456_1>;
...
constructor TMyObj2456_1.Create;
begin
  inherited;
  FInt := 2456 * 3;
  FTest := 'Value: ' + Random(224562).ToString + Random(245600).ToString;
end;

procedure TForm2456.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2456;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2456_List0 := TMyObj2456_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2456_List1 := TMyObj2456_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
