...
type
  ...
  TMyObj285_List0 = TObjectList<TMyObj285>;

  TMyObj285_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj285_List1 = TObjectList<TMyObj285_1>;
...
constructor TMyObj285_1.Create;
begin
  inherited;
  FInt := 285 * 3;
  FTest := 'Value: ' + Random(22852).ToString + Random(28500).ToString;
end;

procedure TForm285.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum285;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj285_List0 := TMyObj285_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj285_List1 := TMyObj285_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
