...
type
  ...
  TMyObj2040_List0 = TObjectList<TMyObj2040>;

  TMyObj2040_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2040_List1 = TObjectList<TMyObj2040_1>;
...
constructor TMyObj2040_1.Create;
begin
  inherited;
  FInt := 2040 * 3;
  FTest := 'Value: ' + Random(220402).ToString + Random(204000).ToString;
end;

procedure TForm2040.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2040;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20400).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20405).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20407).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2040_List0 := TMyObj2040_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2040_List1 := TMyObj2040_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
