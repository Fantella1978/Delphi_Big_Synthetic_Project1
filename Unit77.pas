...
type
  ...
  TMyObj77_List0 = TObjectList<TMyObj77>;

  TMyObj77_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj77_List1 = TObjectList<TMyObj77_1>;
...
constructor TMyObj77_1.Create;
begin
  inherited;
  FInt := 77 * 3;
  FTest := 'Value: ' + Random(2772).ToString + Random(7700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj77_List0 := TMyObj77_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj77_List1 := TMyObj77_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
