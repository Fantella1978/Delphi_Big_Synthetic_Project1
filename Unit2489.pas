...
type
  ...
  TMyObj2489_List0 = TObjectList<TMyObj2489>;

  TMyObj2489_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2489_List1 = TObjectList<TMyObj2489_1>;
...
constructor TMyObj2489_1.Create;
begin
  inherited;
  FInt := 2489 * 3;
  FTest := 'Value: ' + Random(224892).ToString + Random(248900).ToString;
end;

procedure TForm2489.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2489;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2489_List0 := TMyObj2489_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2489_List1 := TMyObj2489_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
