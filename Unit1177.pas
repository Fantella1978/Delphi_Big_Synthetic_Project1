...
type
  ...
  TMyObj1177_List0 = TObjectList<TMyObj1177>;

  TMyObj1177_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1177_List1 = TObjectList<TMyObj1177_1>;
...
constructor TMyObj1177_1.Create;
begin
  inherited;
  FInt := 1177 * 3;
  FTest := 'Value: ' + Random(211772).ToString + Random(117700).ToString;
end;

procedure TForm1177.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1177;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1177_List0 := TMyObj1177_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1177_List1 := TMyObj1177_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
