...
type
  ...
  TMyObj1514_List0 = TObjectList<TMyObj1514>;

  TMyObj1514_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1514_List1 = TObjectList<TMyObj1514_1>;
...
constructor TMyObj1514_1.Create;
begin
  inherited;
  FInt := 1514 * 3;
  FTest := 'Value: ' + Random(215142).ToString + Random(151400).ToString;
end;

procedure TForm1514.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1514;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1514_List0 := TMyObj1514_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1514_List1 := TMyObj1514_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
