...
type
  ...
  TMyObj308_List0 = TObjectList<TMyObj308>;

  TMyObj308_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj308_List1 = TObjectList<TMyObj308_1>;
...
constructor TMyObj308_1.Create;
begin
  inherited;
  FInt := 308 * 3;
  FTest := 'Value: ' + Random(23082).ToString + Random(30800).ToString;
end;

procedure TForm308.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum308;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj308_List0 := TMyObj308_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj308_List1 := TMyObj308_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
