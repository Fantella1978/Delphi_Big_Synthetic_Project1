...
type
  ...
  TMyObj1537_List0 = TObjectList<TMyObj1537>;

  TMyObj1537_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1537_List1 = TObjectList<TMyObj1537_1>;
...
constructor TMyObj1537_1.Create;
begin
  inherited;
  FInt := 1537 * 3;
  FTest := 'Value: ' + Random(215372).ToString + Random(153700).ToString;
end;

procedure TForm1537.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1537;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1537_List0 := TMyObj1537_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1537_List1 := TMyObj1537_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
