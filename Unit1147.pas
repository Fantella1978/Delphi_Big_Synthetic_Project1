...
type
  ...
  TMyObj1147_List0 = TObjectList<TMyObj1147>;

  TMyObj1147_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1147_List1 = TObjectList<TMyObj1147_1>;
...
constructor TMyObj1147_1.Create;
begin
  inherited;
  FInt := 1147 * 3;
  FTest := 'Value: ' + Random(211472).ToString + Random(114700).ToString;
end;

procedure TForm1147.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1147;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11470).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11475).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11477).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1147_List0 := TMyObj1147_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1147_List1 := TMyObj1147_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
