...
type
  ...
  TMyObj1884_List0 = TObjectList<TMyObj1884>;

  TMyObj1884_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1884_List1 = TObjectList<TMyObj1884_1>;
...
constructor TMyObj1884_1.Create;
begin
  inherited;
  FInt := 1884 * 3;
  FTest := 'Value: ' + Random(218842).ToString + Random(188400).ToString;
end;

procedure TForm1884.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1884;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1884_List0 := TMyObj1884_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1884_List1 := TMyObj1884_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
