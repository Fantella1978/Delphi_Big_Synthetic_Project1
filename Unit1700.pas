...
type
  ...
  TMyObj1700_List0 = TObjectList<TMyObj1700>;

  TMyObj1700_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1700_List1 = TObjectList<TMyObj1700_1>;
...
constructor TMyObj1700_1.Create;
begin
  inherited;
  FInt := 1700 * 3;
  FTest := 'Value: ' + Random(217002).ToString + Random(170000).ToString;
end;

procedure TForm1700.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1700;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1700_List0 := TMyObj1700_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1700_List1 := TMyObj1700_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
