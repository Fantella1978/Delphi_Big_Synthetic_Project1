...
type
  ...
  TMyObj1793_List0 = TObjectList<TMyObj1793>;

  TMyObj1793_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1793_List1 = TObjectList<TMyObj1793_1>;
...
constructor TMyObj1793_1.Create;
begin
  inherited;
  FInt := 1793 * 3;
  FTest := 'Value: ' + Random(217932).ToString + Random(179300).ToString;
end;

procedure TForm1793.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1793;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1793_List0 := TMyObj1793_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1793_List1 := TMyObj1793_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
