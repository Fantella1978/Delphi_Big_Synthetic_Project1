...
type
  ...
  TMyObj1351_List0 = TObjectList<TMyObj1351>;

  TMyObj1351_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1351_List1 = TObjectList<TMyObj1351_1>;
...
constructor TMyObj1351_1.Create;
begin
  inherited;
  FInt := 1351 * 3;
  FTest := 'Value: ' + Random(213512).ToString + Random(135100).ToString;
end;

procedure TForm1351.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1351;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1351_List0 := TMyObj1351_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1351_List1 := TMyObj1351_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
