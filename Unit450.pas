...
type
  ...
  TMyObj450_List0 = TObjectList<TMyObj450>;

  TMyObj450_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj450_List1 = TObjectList<TMyObj450_1>;
...
constructor TMyObj450_1.Create;
begin
  inherited;
  FInt := 450 * 3;
  FTest := 'Value: ' + Random(24502).ToString + Random(45000).ToString;
end;

procedure TForm450.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum450;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4500).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4505).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4507).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj450_List0 := TMyObj450_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj450_List1 := TMyObj450_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
