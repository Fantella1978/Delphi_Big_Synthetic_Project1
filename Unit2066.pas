...
type
  ...
  TMyObj2066_List0 = TObjectList<TMyObj2066>;

  TMyObj2066_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2066_List1 = TObjectList<TMyObj2066_1>;
...
constructor TMyObj2066_1.Create;
begin
  inherited;
  FInt := 2066 * 3;
  FTest := 'Value: ' + Random(220662).ToString + Random(206600).ToString;
end;

procedure TForm2066.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2066;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2066_List0 := TMyObj2066_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2066_List1 := TMyObj2066_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
