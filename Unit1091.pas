...
type
  ...
  TMyObj1091_List0 = TObjectList<TMyObj1091>;

  TMyObj1091_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1091_List1 = TObjectList<TMyObj1091_1>;
...
constructor TMyObj1091_1.Create;
begin
  inherited;
  FInt := 1091 * 3;
  FTest := 'Value: ' + Random(210912).ToString + Random(109100).ToString;
end;

procedure TForm1091.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1091;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1091_List0 := TMyObj1091_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1091_List1 := TMyObj1091_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
