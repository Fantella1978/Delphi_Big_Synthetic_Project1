...
type
  ...
  TMyObj822_List0 = TObjectList<TMyObj822>;

  TMyObj822_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj822_List1 = TObjectList<TMyObj822_1>;
...
constructor TMyObj822_1.Create;
begin
  inherited;
  FInt := 822 * 3;
  FTest := 'Value: ' + Random(28222).ToString + Random(82200).ToString;
end;

procedure TForm822.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum822;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj822_List0 := TMyObj822_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj822_List1 := TMyObj822_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
