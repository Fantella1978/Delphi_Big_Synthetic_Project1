...
type
  ...
  TMyObj2263_List0 = TObjectList<TMyObj2263>;

  TMyObj2263_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2263_List1 = TObjectList<TMyObj2263_1>;
...
constructor TMyObj2263_1.Create;
begin
  inherited;
  FInt := 2263 * 3;
  FTest := 'Value: ' + Random(222632).ToString + Random(226300).ToString;
end;

procedure TForm2263.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2263;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2263_List0 := TMyObj2263_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2263_List1 := TMyObj2263_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
