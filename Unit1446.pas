...
type
  ...
  TMyObj1446_List0 = TObjectList<TMyObj1446>;

  TMyObj1446_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1446_List1 = TObjectList<TMyObj1446_1>;
...
constructor TMyObj1446_1.Create;
begin
  inherited;
  FInt := 1446 * 3;
  FTest := 'Value: ' + Random(214462).ToString + Random(144600).ToString;
end;

procedure TForm1446.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1446;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1446_List0 := TMyObj1446_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1446_List1 := TMyObj1446_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
