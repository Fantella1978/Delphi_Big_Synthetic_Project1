...
type
  ...
  TMyObj2411_List0 = TObjectList<TMyObj2411>;

  TMyObj2411_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2411_List1 = TObjectList<TMyObj2411_1>;
...
constructor TMyObj2411_1.Create;
begin
  inherited;
  FInt := 2411 * 3;
  FTest := 'Value: ' + Random(224112).ToString + Random(241100).ToString;
end;

procedure TForm2411.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2411;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2411_List0 := TMyObj2411_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2411_List1 := TMyObj2411_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
