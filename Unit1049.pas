...
type
  ...
  TMyObj1049_List0 = TObjectList<TMyObj1049>;

  TMyObj1049_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1049_List1 = TObjectList<TMyObj1049_1>;
...
constructor TMyObj1049_1.Create;
begin
  inherited;
  FInt := 1049 * 3;
  FTest := 'Value: ' + Random(210492).ToString + Random(104900).ToString;
end;

procedure TForm1049.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1049;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1049_List0 := TMyObj1049_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1049_List1 := TMyObj1049_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
