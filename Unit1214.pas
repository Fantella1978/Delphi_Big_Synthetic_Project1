...
type
  ...
  TMyObj1214_List0 = TObjectList<TMyObj1214>;

  TMyObj1214_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1214_List1 = TObjectList<TMyObj1214_1>;
...
constructor TMyObj1214_1.Create;
begin
  inherited;
  FInt := 1214 * 3;
  FTest := 'Value: ' + Random(212142).ToString + Random(121400).ToString;
end;

procedure TForm1214.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1214;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12140).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12145).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12147).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1214_List0 := TMyObj1214_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1214_List1 := TMyObj1214_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
