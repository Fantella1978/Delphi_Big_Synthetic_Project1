...
type
  ...
  TMyObj253_List0 = TObjectList<TMyObj253>;

  TMyObj253_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj253_List1 = TObjectList<TMyObj253_1>;
...
constructor TMyObj253_1.Create;
begin
  inherited;
  FInt := 253 * 3;
  FTest := 'Value: ' + Random(22532).ToString + Random(25300).ToString;
end;

procedure TForm253.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum253;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj253_List0 := TMyObj253_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj253_List1 := TMyObj253_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
