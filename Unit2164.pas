...
type
  ...
  TMyObj2164_List0 = TObjectList<TMyObj2164>;

  TMyObj2164_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2164_List1 = TObjectList<TMyObj2164_1>;
...
constructor TMyObj2164_1.Create;
begin
  inherited;
  FInt := 2164 * 3;
  FTest := 'Value: ' + Random(221642).ToString + Random(216400).ToString;
end;

procedure TForm2164.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2164;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2164_List0 := TMyObj2164_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2164_List1 := TMyObj2164_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
