...
type
  ...
  TMyObj680_List0 = TObjectList<TMyObj680>;

  TMyObj680_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj680_List1 = TObjectList<TMyObj680_1>;
...
constructor TMyObj680_1.Create;
begin
  inherited;
  FInt := 680 * 3;
  FTest := 'Value: ' + Random(26802).ToString + Random(68000).ToString;
end;

procedure TForm680.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum680;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj680_List0 := TMyObj680_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj680_List1 := TMyObj680_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
