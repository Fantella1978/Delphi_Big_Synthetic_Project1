...
type
  ...
  TMyObj284_List0 = TObjectList<TMyObj284>;

  TMyObj284_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj284_List1 = TObjectList<TMyObj284_1>;
...
constructor TMyObj284_1.Create;
begin
  inherited;
  FInt := 284 * 3;
  FTest := 'Value: ' + Random(22842).ToString + Random(28400).ToString;
end;

procedure TForm284.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum284;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj284_List0 := TMyObj284_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj284_List1 := TMyObj284_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
