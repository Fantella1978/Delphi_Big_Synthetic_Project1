...
type
  ...
  TMyObj873_List0 = TObjectList<TMyObj873>;

  TMyObj873_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj873_List1 = TObjectList<TMyObj873_1>;
...
constructor TMyObj873_1.Create;
begin
  inherited;
  FInt := 873 * 3;
  FTest := 'Value: ' + Random(28732).ToString + Random(87300).ToString;
end;

procedure TForm873.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum873;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj873_List0 := TMyObj873_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj873_List1 := TMyObj873_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
