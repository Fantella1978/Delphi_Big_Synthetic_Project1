...
type
  ...
  TMyObj2181_List0 = TObjectList<TMyObj2181>;

  TMyObj2181_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2181_List1 = TObjectList<TMyObj2181_1>;
...
constructor TMyObj2181_1.Create;
begin
  inherited;
  FInt := 2181 * 3;
  FTest := 'Value: ' + Random(221812).ToString + Random(218100).ToString;
end;

procedure TForm2181.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2181;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2181_List0 := TMyObj2181_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2181_List1 := TMyObj2181_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
