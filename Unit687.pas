...
type
  ...
  TMyObj687_List0 = TObjectList<TMyObj687>;

  TMyObj687_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj687_List1 = TObjectList<TMyObj687_1>;
...
constructor TMyObj687_1.Create;
begin
  inherited;
  FInt := 687 * 3;
  FTest := 'Value: ' + Random(26872).ToString + Random(68700).ToString;
end;

procedure TForm687.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum687;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj687_List0 := TMyObj687_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj687_List1 := TMyObj687_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
