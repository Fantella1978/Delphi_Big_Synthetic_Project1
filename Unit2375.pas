...
type
  ...
  TMyObj2375_List0 = TObjectList<TMyObj2375>;

  TMyObj2375_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2375_List1 = TObjectList<TMyObj2375_1>;
...
constructor TMyObj2375_1.Create;
begin
  inherited;
  FInt := 2375 * 3;
  FTest := 'Value: ' + Random(223752).ToString + Random(237500).ToString;
end;

procedure TForm2375.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2375;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2375_List0 := TMyObj2375_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2375_List1 := TMyObj2375_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
