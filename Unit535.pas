...
type
  ...
  TMyObj535_List0 = TObjectList<TMyObj535>;

  TMyObj535_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj535_List1 = TObjectList<TMyObj535_1>;
...
constructor TMyObj535_1.Create;
begin
  inherited;
  FInt := 535 * 3;
  FTest := 'Value: ' + Random(25352).ToString + Random(53500).ToString;
end;

procedure TForm535.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum535;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5350).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5355).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5357).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj535_List0 := TMyObj535_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj535_List1 := TMyObj535_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
