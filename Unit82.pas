...
type
  ...
  TMyObj82_List0 = TObjectList<TMyObj82>;

  TMyObj82_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj82_List1 = TObjectList<TMyObj82_1>;
...
constructor TMyObj82_1.Create;
begin
  inherited;
  FInt := 82 * 3;
  FTest := 'Value: ' + Random(2822).ToString + Random(8200).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj82_List0 := TMyObj82_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj82_List1 := TMyObj82_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
