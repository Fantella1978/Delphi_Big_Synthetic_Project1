...
type
  ...
  TMyObj1644_List0 = TObjectList<TMyObj1644>;

  TMyObj1644_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1644_List1 = TObjectList<TMyObj1644_1>;
...
constructor TMyObj1644_1.Create;
begin
  inherited;
  FInt := 1644 * 3;
  FTest := 'Value: ' + Random(216442).ToString + Random(164400).ToString;
end;

procedure TForm1644.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1644;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1644_List0 := TMyObj1644_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1644_List1 := TMyObj1644_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
