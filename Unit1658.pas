...
type
  ...
  TMyObj1658_List0 = TObjectList<TMyObj1658>;

  TMyObj1658_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1658_List1 = TObjectList<TMyObj1658_1>;
...
constructor TMyObj1658_1.Create;
begin
  inherited;
  FInt := 1658 * 3;
  FTest := 'Value: ' + Random(216582).ToString + Random(165800).ToString;
end;

procedure TForm1658.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1658;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1658_List0 := TMyObj1658_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1658_List1 := TMyObj1658_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
