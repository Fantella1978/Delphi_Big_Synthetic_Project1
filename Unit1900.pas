...
type
  ...
  TMyObj1900_List0 = TObjectList<TMyObj1900>;

  TMyObj1900_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1900_List1 = TObjectList<TMyObj1900_1>;
...
constructor TMyObj1900_1.Create;
begin
  inherited;
  FInt := 1900 * 3;
  FTest := 'Value: ' + Random(219002).ToString + Random(190000).ToString;
end;

procedure TForm1900.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1900;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1900_List0 := TMyObj1900_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1900_List1 := TMyObj1900_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
