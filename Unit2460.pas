...
type
  ...
  TMyObj2460_List0 = TObjectList<TMyObj2460>;

  TMyObj2460_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2460_List1 = TObjectList<TMyObj2460_1>;
...
constructor TMyObj2460_1.Create;
begin
  inherited;
  FInt := 2460 * 3;
  FTest := 'Value: ' + Random(224602).ToString + Random(246000).ToString;
end;

procedure TForm2460.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2460;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2460_List0 := TMyObj2460_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2460_List1 := TMyObj2460_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
