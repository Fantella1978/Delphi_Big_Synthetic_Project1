...
type
  ...
  TMyObj1056_List0 = TObjectList<TMyObj1056>;

  TMyObj1056_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1056_List1 = TObjectList<TMyObj1056_1>;
...
constructor TMyObj1056_1.Create;
begin
  inherited;
  FInt := 1056 * 3;
  FTest := 'Value: ' + Random(210562).ToString + Random(105600).ToString;
end;

procedure TForm1056.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1056;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1056_List0 := TMyObj1056_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1056_List1 := TMyObj1056_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
