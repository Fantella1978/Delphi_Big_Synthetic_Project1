...
type
  ...
  TMyObj693_List0 = TObjectList<TMyObj693>;

  TMyObj693_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj693_List1 = TObjectList<TMyObj693_1>;
...
constructor TMyObj693_1.Create;
begin
  inherited;
  FInt := 693 * 3;
  FTest := 'Value: ' + Random(26932).ToString + Random(69300).ToString;
end;

procedure TForm693.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum693;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj693_List0 := TMyObj693_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj693_List1 := TMyObj693_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
