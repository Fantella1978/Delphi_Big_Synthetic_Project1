...
type
  ...
  TMyObj1306_List0 = TObjectList<TMyObj1306>;

  TMyObj1306_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1306_List1 = TObjectList<TMyObj1306_1>;
...
constructor TMyObj1306_1.Create;
begin
  inherited;
  FInt := 1306 * 3;
  FTest := 'Value: ' + Random(213062).ToString + Random(130600).ToString;
end;

procedure TForm1306.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1306;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13060).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13065).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13067).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1306_List0 := TMyObj1306_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1306_List1 := TMyObj1306_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
