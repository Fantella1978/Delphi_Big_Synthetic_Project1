...
type
  ...
  TMyObj1217_List0 = TObjectList<TMyObj1217>;

  TMyObj1217_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1217_List1 = TObjectList<TMyObj1217_1>;
...
constructor TMyObj1217_1.Create;
begin
  inherited;
  FInt := 1217 * 3;
  FTest := 'Value: ' + Random(212172).ToString + Random(121700).ToString;
end;

procedure TForm1217.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1217;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1217_List0 := TMyObj1217_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1217_List1 := TMyObj1217_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
