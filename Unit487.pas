...
type
  ...
  TMyObj487_List0 = TObjectList<TMyObj487>;

  TMyObj487_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj487_List1 = TObjectList<TMyObj487_1>;
...
constructor TMyObj487_1.Create;
begin
  inherited;
  FInt := 487 * 3;
  FTest := 'Value: ' + Random(24872).ToString + Random(48700).ToString;
end;

procedure TForm487.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum487;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj487_List0 := TMyObj487_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj487_List1 := TMyObj487_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
