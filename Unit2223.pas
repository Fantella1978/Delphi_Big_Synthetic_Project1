...
type
  ...
  TMyObj2223_List0 = TObjectList<TMyObj2223>;

  TMyObj2223_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2223_List1 = TObjectList<TMyObj2223_1>;
...
constructor TMyObj2223_1.Create;
begin
  inherited;
  FInt := 2223 * 3;
  FTest := 'Value: ' + Random(222232).ToString + Random(222300).ToString;
end;

procedure TForm2223.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2223;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2223_List0 := TMyObj2223_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2223_List1 := TMyObj2223_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
