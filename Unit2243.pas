...
type
  ...
  TMyObj2243_List0 = TObjectList<TMyObj2243>;

  TMyObj2243_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2243_List1 = TObjectList<TMyObj2243_1>;
...
constructor TMyObj2243_1.Create;
begin
  inherited;
  FInt := 2243 * 3;
  FTest := 'Value: ' + Random(222432).ToString + Random(224300).ToString;
end;

procedure TForm2243.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2243;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2243_List0 := TMyObj2243_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2243_List1 := TMyObj2243_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
