...
type
  ...
  TMyObj2090_List0 = TObjectList<TMyObj2090>;

  TMyObj2090_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2090_List1 = TObjectList<TMyObj2090_1>;
...
constructor TMyObj2090_1.Create;
begin
  inherited;
  FInt := 2090 * 3;
  FTest := 'Value: ' + Random(220902).ToString + Random(209000).ToString;
end;

procedure TForm2090.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2090;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20900).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20905).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20907).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2090_List0 := TMyObj2090_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2090_List1 := TMyObj2090_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
