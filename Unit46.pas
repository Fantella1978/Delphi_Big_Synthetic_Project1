...
type
  ...
  TMyObj46_List0 = TObjectList<TMyObj46>;

  TMyObj46_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj46_List1 = TObjectList<TMyObj46_1>;
...
constructor TMyObj46_1.Create;
begin
  inherited;
  FInt := 46 * 3;
  FTest := 'Value: ' + Random(2462).ToString + Random(4600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj46_List0 := TMyObj46_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj46_List1 := TMyObj46_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
