...
type
  ...
  TMyObj753_List0 = TObjectList<TMyObj753>;

  TMyObj753_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj753_List1 = TObjectList<TMyObj753_1>;
...
constructor TMyObj753_1.Create;
begin
  inherited;
  FInt := 753 * 3;
  FTest := 'Value: ' + Random(27532).ToString + Random(75300).ToString;
end;

procedure TForm753.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum753;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj753_List0 := TMyObj753_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj753_List1 := TMyObj753_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
