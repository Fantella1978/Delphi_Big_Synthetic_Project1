...
type
  ...
  TMyObj2336_List0 = TObjectList<TMyObj2336>;

  TMyObj2336_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2336_List1 = TObjectList<TMyObj2336_1>;
...
constructor TMyObj2336_1.Create;
begin
  inherited;
  FInt := 2336 * 3;
  FTest := 'Value: ' + Random(223362).ToString + Random(233600).ToString;
end;

procedure TForm2336.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2336;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2336_List0 := TMyObj2336_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2336_List1 := TMyObj2336_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
