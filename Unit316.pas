...
type
  ...
  TMyObj316_List0 = TObjectList<TMyObj316>;

  TMyObj316_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj316_List1 = TObjectList<TMyObj316_1>;
...
constructor TMyObj316_1.Create;
begin
  inherited;
  FInt := 316 * 3;
  FTest := 'Value: ' + Random(23162).ToString + Random(31600).ToString;
end;

procedure TForm316.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum316;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj316_List0 := TMyObj316_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj316_List1 := TMyObj316_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
