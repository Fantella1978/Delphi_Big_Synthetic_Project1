...
type
  ...
  TMyObj783_List0 = TObjectList<TMyObj783>;

  TMyObj783_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj783_List1 = TObjectList<TMyObj783_1>;
...
constructor TMyObj783_1.Create;
begin
  inherited;
  FInt := 783 * 3;
  FTest := 'Value: ' + Random(27832).ToString + Random(78300).ToString;
end;

procedure TForm783.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum783;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj783_List0 := TMyObj783_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj783_List1 := TMyObj783_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
