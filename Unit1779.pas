...
type
  ...
  TMyObj1779_List0 = TObjectList<TMyObj1779>;

  TMyObj1779_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1779_List1 = TObjectList<TMyObj1779_1>;
...
constructor TMyObj1779_1.Create;
begin
  inherited;
  FInt := 1779 * 3;
  FTest := 'Value: ' + Random(217792).ToString + Random(177900).ToString;
end;

procedure TForm1779.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1779;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1779_List0 := TMyObj1779_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1779_List1 := TMyObj1779_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
