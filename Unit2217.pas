...
type
  ...
  TMyObj2217_List0 = TObjectList<TMyObj2217>;

  TMyObj2217_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2217_List1 = TObjectList<TMyObj2217_1>;
...
constructor TMyObj2217_1.Create;
begin
  inherited;
  FInt := 2217 * 3;
  FTest := 'Value: ' + Random(222172).ToString + Random(221700).ToString;
end;

procedure TForm2217.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2217;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2217_List0 := TMyObj2217_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2217_List1 := TMyObj2217_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
