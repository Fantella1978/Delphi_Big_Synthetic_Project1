...
type
  ...
  TMyObj2281_List0 = TObjectList<TMyObj2281>;

  TMyObj2281_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2281_List1 = TObjectList<TMyObj2281_1>;
...
constructor TMyObj2281_1.Create;
begin
  inherited;
  FInt := 2281 * 3;
  FTest := 'Value: ' + Random(222812).ToString + Random(228100).ToString;
end;

procedure TForm2281.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2281;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2281_List0 := TMyObj2281_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2281_List1 := TMyObj2281_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
