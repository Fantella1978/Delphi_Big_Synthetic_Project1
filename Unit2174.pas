...
type
  ...
  TMyObj2174_List0 = TObjectList<TMyObj2174>;

  TMyObj2174_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2174_List1 = TObjectList<TMyObj2174_1>;
...
constructor TMyObj2174_1.Create;
begin
  inherited;
  FInt := 2174 * 3;
  FTest := 'Value: ' + Random(221742).ToString + Random(217400).ToString;
end;

procedure TForm2174.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2174;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21740).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21745).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21747).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2174_List0 := TMyObj2174_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2174_List1 := TMyObj2174_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
