...
type
  ...
  TMyObj365_List0 = TObjectList<TMyObj365>;

  TMyObj365_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj365_List1 = TObjectList<TMyObj365_1>;
...
constructor TMyObj365_1.Create;
begin
  inherited;
  FInt := 365 * 3;
  FTest := 'Value: ' + Random(23652).ToString + Random(36500).ToString;
end;

procedure TForm365.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum365;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj365_List0 := TMyObj365_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj365_List1 := TMyObj365_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
