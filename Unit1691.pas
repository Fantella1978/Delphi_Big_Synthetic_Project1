...
type
  ...
  TMyObj1691_List0 = TObjectList<TMyObj1691>;

  TMyObj1691_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1691_List1 = TObjectList<TMyObj1691_1>;
...
constructor TMyObj1691_1.Create;
begin
  inherited;
  FInt := 1691 * 3;
  FTest := 'Value: ' + Random(216912).ToString + Random(169100).ToString;
end;

procedure TForm1691.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1691;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1691_List0 := TMyObj1691_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1691_List1 := TMyObj1691_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
