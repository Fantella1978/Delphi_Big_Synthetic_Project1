...
type
  ...
  TMyObj2045_List0 = TObjectList<TMyObj2045>;

  TMyObj2045_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2045_List1 = TObjectList<TMyObj2045_1>;
...
constructor TMyObj2045_1.Create;
begin
  inherited;
  FInt := 2045 * 3;
  FTest := 'Value: ' + Random(220452).ToString + Random(204500).ToString;
end;

procedure TForm2045.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2045;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2045_List0 := TMyObj2045_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2045_List1 := TMyObj2045_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
