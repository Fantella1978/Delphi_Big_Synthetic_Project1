...
type
  ...
  TMyObj1549_List0 = TObjectList<TMyObj1549>;

  TMyObj1549_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1549_List1 = TObjectList<TMyObj1549_1>;
...
constructor TMyObj1549_1.Create;
begin
  inherited;
  FInt := 1549 * 3;
  FTest := 'Value: ' + Random(215492).ToString + Random(154900).ToString;
end;

procedure TForm1549.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1549;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1549_List0 := TMyObj1549_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1549_List1 := TMyObj1549_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
