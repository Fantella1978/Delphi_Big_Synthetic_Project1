...
type
  ...
  TMyObj69_List0 = TObjectList<TMyObj69>;

  TMyObj69_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj69_List1 = TObjectList<TMyObj69_1>;
...
constructor TMyObj69_1.Create;
begin
  inherited;
  FInt := 69 * 3;
  FTest := 'Value: ' + Random(2692).ToString + Random(6900).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(690).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(695).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(697).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj69_List0 := TMyObj69_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj69_List1 := TMyObj69_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
