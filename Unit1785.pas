...
type
  ...
  TMyObj1785_List0 = TObjectList<TMyObj1785>;

  TMyObj1785_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1785_List1 = TObjectList<TMyObj1785_1>;
...
constructor TMyObj1785_1.Create;
begin
  inherited;
  FInt := 1785 * 3;
  FTest := 'Value: ' + Random(217852).ToString + Random(178500).ToString;
end;

procedure TForm1785.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1785;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1785_List0 := TMyObj1785_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1785_List1 := TMyObj1785_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
