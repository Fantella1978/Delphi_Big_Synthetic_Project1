...
type
  ...
  TMyObj1976_List0 = TObjectList<TMyObj1976>;

  TMyObj1976_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1976_List1 = TObjectList<TMyObj1976_1>;
...
constructor TMyObj1976_1.Create;
begin
  inherited;
  FInt := 1976 * 3;
  FTest := 'Value: ' + Random(219762).ToString + Random(197600).ToString;
end;

procedure TForm1976.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1976;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1976_List0 := TMyObj1976_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1976_List1 := TMyObj1976_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
