...
type
  ...
  TMyObj422_List0 = TObjectList<TMyObj422>;

  TMyObj422_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj422_List1 = TObjectList<TMyObj422_1>;
...
constructor TMyObj422_1.Create;
begin
  inherited;
  FInt := 422 * 3;
  FTest := 'Value: ' + Random(24222).ToString + Random(42200).ToString;
end;

procedure TForm422.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum422;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj422_List0 := TMyObj422_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj422_List1 := TMyObj422_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
