...
type
  ...
  TMyObj2187_List0 = TObjectList<TMyObj2187>;

  TMyObj2187_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2187_List1 = TObjectList<TMyObj2187_1>;
...
constructor TMyObj2187_1.Create;
begin
  inherited;
  FInt := 2187 * 3;
  FTest := 'Value: ' + Random(221872).ToString + Random(218700).ToString;
end;

procedure TForm2187.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2187;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2187_List0 := TMyObj2187_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2187_List1 := TMyObj2187_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
