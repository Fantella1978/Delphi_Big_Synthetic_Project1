...
type
  ...
  TMyObj119_List0 = TObjectList<TMyObj119>;

  TMyObj119_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj119_List1 = TObjectList<TMyObj119_1>;
...
constructor TMyObj119_1.Create;
begin
  inherited;
  FInt := 119 * 3;
  FTest := 'Value: ' + Random(21192).ToString + Random(11900).ToString;
end;

procedure TForm119.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum119;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj119_List0 := TMyObj119_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj119_List1 := TMyObj119_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
