...
type
  ...
  TMyObj177_List0 = TObjectList<TMyObj177>;

  TMyObj177_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj177_List1 = TObjectList<TMyObj177_1>;
...
constructor TMyObj177_1.Create;
begin
  inherited;
  FInt := 177 * 3;
  FTest := 'Value: ' + Random(21772).ToString + Random(17700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1770).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1775).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1777).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj177_List0 := TMyObj177_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj177_List1 := TMyObj177_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
