...
type
  ...
  TMyObj1297_List0 = TObjectList<TMyObj1297>;

  TMyObj1297_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1297_List1 = TObjectList<TMyObj1297_1>;
...
constructor TMyObj1297_1.Create;
begin
  inherited;
  FInt := 1297 * 3;
  FTest := 'Value: ' + Random(212972).ToString + Random(129700).ToString;
end;

procedure TForm1297.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1297;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1297_List0 := TMyObj1297_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1297_List1 := TMyObj1297_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
