...
type
  ...
  TMyObj2186_List0 = TObjectList<TMyObj2186>;

  TMyObj2186_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2186_List1 = TObjectList<TMyObj2186_1>;
...
constructor TMyObj2186_1.Create;
begin
  inherited;
  FInt := 2186 * 3;
  FTest := 'Value: ' + Random(221862).ToString + Random(218600).ToString;
end;

procedure TForm2186.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2186;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2186_List0 := TMyObj2186_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2186_List1 := TMyObj2186_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
