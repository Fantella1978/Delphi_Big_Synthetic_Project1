...
type
  ...
  TMyObj2109_List0 = TObjectList<TMyObj2109>;

  TMyObj2109_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2109_List1 = TObjectList<TMyObj2109_1>;
...
constructor TMyObj2109_1.Create;
begin
  inherited;
  FInt := 2109 * 3;
  FTest := 'Value: ' + Random(221092).ToString + Random(210900).ToString;
end;

procedure TForm2109.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2109;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2109_List0 := TMyObj2109_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2109_List1 := TMyObj2109_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
