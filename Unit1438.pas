...
type
  ...
  TMyObj1438_List0 = TObjectList<TMyObj1438>;

  TMyObj1438_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1438_List1 = TObjectList<TMyObj1438_1>;
...
constructor TMyObj1438_1.Create;
begin
  inherited;
  FInt := 1438 * 3;
  FTest := 'Value: ' + Random(214382).ToString + Random(143800).ToString;
end;

procedure TForm1438.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1438;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1438_List0 := TMyObj1438_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1438_List1 := TMyObj1438_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
