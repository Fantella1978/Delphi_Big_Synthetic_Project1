...
type
  ...
  TMyObj860_List0 = TObjectList<TMyObj860>;

  TMyObj860_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj860_List1 = TObjectList<TMyObj860_1>;
...
constructor TMyObj860_1.Create;
begin
  inherited;
  FInt := 860 * 3;
  FTest := 'Value: ' + Random(28602).ToString + Random(86000).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj860_List0 := TMyObj860_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj860_List1 := TMyObj860_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
