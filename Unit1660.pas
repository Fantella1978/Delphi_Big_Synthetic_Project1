...
type
  ...
  TMyObj1660_List0 = TObjectList<TMyObj1660>;

  TMyObj1660_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1660_List1 = TObjectList<TMyObj1660_1>;
...
constructor TMyObj1660_1.Create;
begin
  inherited;
  FInt := 1660 * 3;
  FTest := 'Value: ' + Random(216602).ToString + Random(166000).ToString;
end;

procedure TForm1660.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1660;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1660_List0 := TMyObj1660_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1660_List1 := TMyObj1660_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
