...
type
  ...
  TMyObj2472_List0 = TObjectList<TMyObj2472>;

  TMyObj2472_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2472_List1 = TObjectList<TMyObj2472_1>;
...
constructor TMyObj2472_1.Create;
begin
  inherited;
  FInt := 2472 * 3;
  FTest := 'Value: ' + Random(224722).ToString + Random(247200).ToString;
end;

procedure TForm2472.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2472;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24720).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24725).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24727).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2472_List0 := TMyObj2472_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2472_List1 := TMyObj2472_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
