...
type
  ...
  TMyObj337_List0 = TObjectList<TMyObj337>;

  TMyObj337_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj337_List1 = TObjectList<TMyObj337_1>;
...
constructor TMyObj337_1.Create;
begin
  inherited;
  FInt := 337 * 3;
  FTest := 'Value: ' + Random(23372).ToString + Random(33700).ToString;
end;

procedure TForm337.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum337;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj337_List0 := TMyObj337_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj337_List1 := TMyObj337_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
