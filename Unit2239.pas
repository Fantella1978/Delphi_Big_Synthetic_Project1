...
type
  ...
  TMyObj2239_List0 = TObjectList<TMyObj2239>;

  TMyObj2239_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2239_List1 = TObjectList<TMyObj2239_1>;
...
constructor TMyObj2239_1.Create;
begin
  inherited;
  FInt := 2239 * 3;
  FTest := 'Value: ' + Random(222392).ToString + Random(223900).ToString;
end;

procedure TForm2239.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2239;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2239_List0 := TMyObj2239_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2239_List1 := TMyObj2239_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
