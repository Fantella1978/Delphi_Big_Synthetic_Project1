...
type
  ...
  TMyObj1322_List0 = TObjectList<TMyObj1322>;

  TMyObj1322_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1322_List1 = TObjectList<TMyObj1322_1>;
...
constructor TMyObj1322_1.Create;
begin
  inherited;
  FInt := 1322 * 3;
  FTest := 'Value: ' + Random(213222).ToString + Random(132200).ToString;
end;

procedure TForm1322.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1322;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1322_List0 := TMyObj1322_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1322_List1 := TMyObj1322_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
