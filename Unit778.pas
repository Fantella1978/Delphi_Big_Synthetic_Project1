...
type
  ...
  TMyObj778_List0 = TObjectList<TMyObj778>;

  TMyObj778_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj778_List1 = TObjectList<TMyObj778_1>;
...
constructor TMyObj778_1.Create;
begin
  inherited;
  FInt := 778 * 3;
  FTest := 'Value: ' + Random(27782).ToString + Random(77800).ToString;
end;

procedure TForm778.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum778;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj778_List0 := TMyObj778_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj778_List1 := TMyObj778_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
