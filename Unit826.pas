...
type
  ...
  TMyObj826_List0 = TObjectList<TMyObj826>;

  TMyObj826_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj826_List1 = TObjectList<TMyObj826_1>;
...
constructor TMyObj826_1.Create;
begin
  inherited;
  FInt := 826 * 3;
  FTest := 'Value: ' + Random(28262).ToString + Random(82600).ToString;
end;

procedure TForm826.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum826;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj826_List0 := TMyObj826_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj826_List1 := TMyObj826_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
