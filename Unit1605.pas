...
type
  ...
  TMyObj1605_List0 = TObjectList<TMyObj1605>;

  TMyObj1605_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1605_List1 = TObjectList<TMyObj1605_1>;
...
constructor TMyObj1605_1.Create;
begin
  inherited;
  FInt := 1605 * 3;
  FTest := 'Value: ' + Random(216052).ToString + Random(160500).ToString;
end;

procedure TForm1605.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1605;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1605_List0 := TMyObj1605_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1605_List1 := TMyObj1605_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
