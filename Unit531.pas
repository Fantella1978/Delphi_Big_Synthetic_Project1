...
type
  ...
  TMyObj531_List0 = TObjectList<TMyObj531>;

  TMyObj531_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj531_List1 = TObjectList<TMyObj531_1>;
...
constructor TMyObj531_1.Create;
begin
  inherited;
  FInt := 531 * 3;
  FTest := 'Value: ' + Random(25312).ToString + Random(53100).ToString;
end;

procedure TForm531.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum531;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj531_List0 := TMyObj531_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj531_List1 := TMyObj531_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
