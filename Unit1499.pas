...
type
  ...
  TMyObj1499_List0 = TObjectList<TMyObj1499>;

  TMyObj1499_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1499_List1 = TObjectList<TMyObj1499_1>;
...
constructor TMyObj1499_1.Create;
begin
  inherited;
  FInt := 1499 * 3;
  FTest := 'Value: ' + Random(214992).ToString + Random(149900).ToString;
end;

procedure TForm1499.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1499;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1499_List0 := TMyObj1499_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1499_List1 := TMyObj1499_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
