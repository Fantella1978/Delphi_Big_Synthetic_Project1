...
type
  ...
  TMyObj152_List0 = TObjectList<TMyObj152>;

  TMyObj152_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj152_List1 = TObjectList<TMyObj152_1>;
...
constructor TMyObj152_1.Create;
begin
  inherited;
  FInt := 152 * 3;
  FTest := 'Value: ' + Random(21522).ToString + Random(15200).ToString;
end;

procedure TForm152.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum152;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj152_List0 := TMyObj152_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj152_List1 := TMyObj152_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
