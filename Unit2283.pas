...
type
  ...
  TMyObj2283_List0 = TObjectList<TMyObj2283>;

  TMyObj2283_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2283_List1 = TObjectList<TMyObj2283_1>;
...
constructor TMyObj2283_1.Create;
begin
  inherited;
  FInt := 2283 * 3;
  FTest := 'Value: ' + Random(222832).ToString + Random(228300).ToString;
end;

procedure TForm2283.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2283;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2283_List0 := TMyObj2283_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2283_List1 := TMyObj2283_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
