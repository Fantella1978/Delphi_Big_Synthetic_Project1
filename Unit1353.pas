...
type
  ...
  TMyObj1353_List0 = TObjectList<TMyObj1353>;

  TMyObj1353_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1353_List1 = TObjectList<TMyObj1353_1>;
...
constructor TMyObj1353_1.Create;
begin
  inherited;
  FInt := 1353 * 3;
  FTest := 'Value: ' + Random(213532).ToString + Random(135300).ToString;
end;

procedure TForm1353.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1353;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13530).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13535).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13537).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1353_List0 := TMyObj1353_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1353_List1 := TMyObj1353_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
