...
type
  ...
  TMyObj395_List0 = TObjectList<TMyObj395>;

  TMyObj395_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj395_List1 = TObjectList<TMyObj395_1>;
...
constructor TMyObj395_1.Create;
begin
  inherited;
  FInt := 395 * 3;
  FTest := 'Value: ' + Random(23952).ToString + Random(39500).ToString;
end;

procedure TForm395.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum395;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3950).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3955).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3957).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj395_List0 := TMyObj395_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj395_List1 := TMyObj395_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
