...
type
  ...
  TMyObj1473_List0 = TObjectList<TMyObj1473>;

  TMyObj1473_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1473_List1 = TObjectList<TMyObj1473_1>;
...
constructor TMyObj1473_1.Create;
begin
  inherited;
  FInt := 1473 * 3;
  FTest := 'Value: ' + Random(214732).ToString + Random(147300).ToString;
end;

procedure TForm1473.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1473;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1473_List0 := TMyObj1473_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1473_List1 := TMyObj1473_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
