...
type
  ...
  TMyObj1144_List0 = TObjectList<TMyObj1144>;

  TMyObj1144_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1144_List1 = TObjectList<TMyObj1144_1>;
...
constructor TMyObj1144_1.Create;
begin
  inherited;
  FInt := 1144 * 3;
  FTest := 'Value: ' + Random(211442).ToString + Random(114400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1144_List0 := TMyObj1144_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1144_List1 := TMyObj1144_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
