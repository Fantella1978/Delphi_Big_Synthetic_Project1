...
type
  ...
  TMyObj1180_List0 = TObjectList<TMyObj1180>;

  TMyObj1180_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1180_List1 = TObjectList<TMyObj1180_1>;
...
constructor TMyObj1180_1.Create;
begin
  inherited;
  FInt := 1180 * 3;
  FTest := 'Value: ' + Random(211802).ToString + Random(118000).ToString;
end;

procedure TForm1180.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1180;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11800).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11805).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11807).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1180_List0 := TMyObj1180_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1180_List1 := TMyObj1180_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
