...
type
  ...
  TMyObj1138_List0 = TObjectList<TMyObj1138>;

  TMyObj1138_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1138_List1 = TObjectList<TMyObj1138_1>;
...
constructor TMyObj1138_1.Create;
begin
  inherited;
  FInt := 1138 * 3;
  FTest := 'Value: ' + Random(211382).ToString + Random(113800).ToString;
end;

procedure TForm1138.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1138;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1138_List0 := TMyObj1138_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1138_List1 := TMyObj1138_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
