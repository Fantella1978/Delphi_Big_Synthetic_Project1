...
type
  ...
  TMyObj1160_List0 = TObjectList<TMyObj1160>;

  TMyObj1160_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1160_List1 = TObjectList<TMyObj1160_1>;
...
constructor TMyObj1160_1.Create;
begin
  inherited;
  FInt := 1160 * 3;
  FTest := 'Value: ' + Random(211602).ToString + Random(116000).ToString;
end;

procedure TForm1160.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1160;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1160_List0 := TMyObj1160_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1160_List1 := TMyObj1160_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
