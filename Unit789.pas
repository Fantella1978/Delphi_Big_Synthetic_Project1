...
type
  ...
  TMyObj789_List0 = TObjectList<TMyObj789>;

  TMyObj789_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj789_List1 = TObjectList<TMyObj789_1>;
...
constructor TMyObj789_1.Create;
begin
  inherited;
  FInt := 789 * 3;
  FTest := 'Value: ' + Random(27892).ToString + Random(78900).ToString;
end;

procedure TForm789.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum789;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7890).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7895).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7897).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj789_List0 := TMyObj789_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj789_List1 := TMyObj789_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
