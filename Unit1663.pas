...
type
  ...
  TMyObj1663_List0 = TObjectList<TMyObj1663>;

  TMyObj1663_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1663_List1 = TObjectList<TMyObj1663_1>;
...
constructor TMyObj1663_1.Create;
begin
  inherited;
  FInt := 1663 * 3;
  FTest := 'Value: ' + Random(216632).ToString + Random(166300).ToString;
end;

procedure TForm1663.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1663;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16630).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16635).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16637).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1663_List0 := TMyObj1663_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1663_List1 := TMyObj1663_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
