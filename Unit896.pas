...
type
  ...
  TMyObj896_List0 = TObjectList<TMyObj896>;

  TMyObj896_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj896_List1 = TObjectList<TMyObj896_1>;
...
constructor TMyObj896_1.Create;
begin
  inherited;
  FInt := 896 * 3;
  FTest := 'Value: ' + Random(28962).ToString + Random(89600).ToString;
end;

procedure TForm896.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum896;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj896_List0 := TMyObj896_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj896_List1 := TMyObj896_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
