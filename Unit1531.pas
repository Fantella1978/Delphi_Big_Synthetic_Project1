...
type
  ...
  TMyObj1531_List0 = TObjectList<TMyObj1531>;

  TMyObj1531_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1531_List1 = TObjectList<TMyObj1531_1>;
...
constructor TMyObj1531_1.Create;
begin
  inherited;
  FInt := 1531 * 3;
  FTest := 'Value: ' + Random(215312).ToString + Random(153100).ToString;
end;

procedure TForm1531.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1531;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15310).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15315).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15317).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1531_List0 := TMyObj1531_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1531_List1 := TMyObj1531_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
