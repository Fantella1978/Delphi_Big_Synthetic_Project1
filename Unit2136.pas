...
type
  ...
  TMyObj2136_List0 = TObjectList<TMyObj2136>;

  TMyObj2136_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2136_List1 = TObjectList<TMyObj2136_1>;
...
constructor TMyObj2136_1.Create;
begin
  inherited;
  FInt := 2136 * 3;
  FTest := 'Value: ' + Random(221362).ToString + Random(213600).ToString;
end;

procedure TForm2136.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2136;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2136_List0 := TMyObj2136_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2136_List1 := TMyObj2136_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
