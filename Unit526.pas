...
type
  ...
  TMyObj526_List0 = TObjectList<TMyObj526>;

  TMyObj526_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj526_List1 = TObjectList<TMyObj526_1>;
...
constructor TMyObj526_1.Create;
begin
  inherited;
  FInt := 526 * 3;
  FTest := 'Value: ' + Random(25262).ToString + Random(52600).ToString;
end;

procedure TForm526.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum526;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj526_List0 := TMyObj526_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj526_List1 := TMyObj526_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
