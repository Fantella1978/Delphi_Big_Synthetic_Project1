...
type
  ...
  TMyObj645_List0 = TObjectList<TMyObj645>;

  TMyObj645_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj645_List1 = TObjectList<TMyObj645_1>;
...
constructor TMyObj645_1.Create;
begin
  inherited;
  FInt := 645 * 3;
  FTest := 'Value: ' + Random(26452).ToString + Random(64500).ToString;
end;

procedure TForm645.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum645;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj645_List0 := TMyObj645_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj645_List1 := TMyObj645_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
