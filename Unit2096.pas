...
type
  ...
  TMyObj2096_List0 = TObjectList<TMyObj2096>;

  TMyObj2096_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2096_List1 = TObjectList<TMyObj2096_1>;
...
constructor TMyObj2096_1.Create;
begin
  inherited;
  FInt := 2096 * 3;
  FTest := 'Value: ' + Random(220962).ToString + Random(209600).ToString;
end;

procedure TForm2096.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2096;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20960).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20965).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20967).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2096_List0 := TMyObj2096_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2096_List1 := TMyObj2096_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
