...
type
  ...
  TMyObj1505_List0 = TObjectList<TMyObj1505>;

  TMyObj1505_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1505_List1 = TObjectList<TMyObj1505_1>;
...
constructor TMyObj1505_1.Create;
begin
  inherited;
  FInt := 1505 * 3;
  FTest := 'Value: ' + Random(215052).ToString + Random(150500).ToString;
end;

procedure TForm1505.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1505;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1505_List0 := TMyObj1505_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1505_List1 := TMyObj1505_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
