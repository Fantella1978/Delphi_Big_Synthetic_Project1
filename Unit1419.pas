...
type
  ...
  TMyObj1419_List0 = TObjectList<TMyObj1419>;

  TMyObj1419_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1419_List1 = TObjectList<TMyObj1419_1>;
...
constructor TMyObj1419_1.Create;
begin
  inherited;
  FInt := 1419 * 3;
  FTest := 'Value: ' + Random(214192).ToString + Random(141900).ToString;
end;

procedure TForm1419.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1419;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1419_List0 := TMyObj1419_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1419_List1 := TMyObj1419_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
