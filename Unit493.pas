...
type
  ...
  TMyObj493_List0 = TObjectList<TMyObj493>;

  TMyObj493_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj493_List1 = TObjectList<TMyObj493_1>;
...
constructor TMyObj493_1.Create;
begin
  inherited;
  FInt := 493 * 3;
  FTest := 'Value: ' + Random(24932).ToString + Random(49300).ToString;
end;

procedure TForm493.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum493;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj493_List0 := TMyObj493_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj493_List1 := TMyObj493_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
