...
type
  ...
  TMyObj538_List0 = TObjectList<TMyObj538>;

  TMyObj538_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj538_List1 = TObjectList<TMyObj538_1>;
...
constructor TMyObj538_1.Create;
begin
  inherited;
  FInt := 538 * 3;
  FTest := 'Value: ' + Random(25382).ToString + Random(53800).ToString;
end;

procedure TForm538.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum538;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj538_List0 := TMyObj538_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj538_List1 := TMyObj538_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
