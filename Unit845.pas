...
type
  ...
  TMyObj845_List0 = TObjectList<TMyObj845>;

  TMyObj845_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj845_List1 = TObjectList<TMyObj845_1>;
...
constructor TMyObj845_1.Create;
begin
  inherited;
  FInt := 845 * 3;
  FTest := 'Value: ' + Random(28452).ToString + Random(84500).ToString;
end;

procedure TForm845.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum845;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj845_List0 := TMyObj845_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj845_List1 := TMyObj845_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
