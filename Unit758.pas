...
type
  ...
  TMyObj758_List0 = TObjectList<TMyObj758>;

  TMyObj758_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj758_List1 = TObjectList<TMyObj758_1>;
...
constructor TMyObj758_1.Create;
begin
  inherited;
  FInt := 758 * 3;
  FTest := 'Value: ' + Random(27582).ToString + Random(75800).ToString;
end;

procedure TForm758.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum758;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj758_List0 := TMyObj758_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj758_List1 := TMyObj758_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
