...
type
  ...
  TMyObj2382_List0 = TObjectList<TMyObj2382>;

  TMyObj2382_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2382_List1 = TObjectList<TMyObj2382_1>;
...
constructor TMyObj2382_1.Create;
begin
  inherited;
  FInt := 2382 * 3;
  FTest := 'Value: ' + Random(223822).ToString + Random(238200).ToString;
end;

procedure TForm2382.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2382;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2382_List0 := TMyObj2382_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2382_List1 := TMyObj2382_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
