...
type
  ...
  TMyObj2219_List0 = TObjectList<TMyObj2219>;

  TMyObj2219_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2219_List1 = TObjectList<TMyObj2219_1>;
...
constructor TMyObj2219_1.Create;
begin
  inherited;
  FInt := 2219 * 3;
  FTest := 'Value: ' + Random(222192).ToString + Random(221900).ToString;
end;

procedure TForm2219.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2219;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2219_List0 := TMyObj2219_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2219_List1 := TMyObj2219_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
