...
type
  ...
  TMyObj743_List0 = TObjectList<TMyObj743>;

  TMyObj743_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj743_List1 = TObjectList<TMyObj743_1>;
...
constructor TMyObj743_1.Create;
begin
  inherited;
  FInt := 743 * 3;
  FTest := 'Value: ' + Random(27432).ToString + Random(74300).ToString;
end;

procedure TForm743.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum743;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7430).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7435).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7437).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj743_List0 := TMyObj743_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj743_List1 := TMyObj743_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
