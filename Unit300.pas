...
type
  ...
  TMyObj300_List0 = TObjectList<TMyObj300>;

  TMyObj300_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj300_List1 = TObjectList<TMyObj300_1>;
...
constructor TMyObj300_1.Create;
begin
  inherited;
  FInt := 300 * 3;
  FTest := 'Value: ' + Random(23002).ToString + Random(30000).ToString;
end;

procedure TForm300.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum300;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3000).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3005).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3007).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj300_List0 := TMyObj300_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj300_List1 := TMyObj300_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
