...
type
  ...
  TMyObj770_List0 = TObjectList<TMyObj770>;

  TMyObj770_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj770_List1 = TObjectList<TMyObj770_1>;
...
constructor TMyObj770_1.Create;
begin
  inherited;
  FInt := 770 * 3;
  FTest := 'Value: ' + Random(27702).ToString + Random(77000).ToString;
end;

procedure TForm770.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum770;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7700).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7705).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7707).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj770_List0 := TMyObj770_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj770_List1 := TMyObj770_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
