...
type
  ...
  TMyObj521_List0 = TObjectList<TMyObj521>;

  TMyObj521_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj521_List1 = TObjectList<TMyObj521_1>;
...
constructor TMyObj521_1.Create;
begin
  inherited;
  FInt := 521 * 3;
  FTest := 'Value: ' + Random(25212).ToString + Random(52100).ToString;
end;

procedure TForm521.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum521;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5210).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5215).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5217).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj521_List0 := TMyObj521_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj521_List1 := TMyObj521_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
