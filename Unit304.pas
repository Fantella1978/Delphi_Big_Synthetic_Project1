...
type
  ...
  TMyObj304_List0 = TObjectList<TMyObj304>;

  TMyObj304_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj304_List1 = TObjectList<TMyObj304_1>;
...
constructor TMyObj304_1.Create;
begin
  inherited;
  FInt := 304 * 3;
  FTest := 'Value: ' + Random(23042).ToString + Random(30400).ToString;
end;

procedure TForm304.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum304;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj304_List0 := TMyObj304_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj304_List1 := TMyObj304_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
