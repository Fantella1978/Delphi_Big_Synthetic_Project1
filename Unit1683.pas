...
type
  ...
  TMyObj1683_List0 = TObjectList<TMyObj1683>;

  TMyObj1683_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1683_List1 = TObjectList<TMyObj1683_1>;
...
constructor TMyObj1683_1.Create;
begin
  inherited;
  FInt := 1683 * 3;
  FTest := 'Value: ' + Random(216832).ToString + Random(168300).ToString;
end;

procedure TForm1683.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1683;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1683_List0 := TMyObj1683_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1683_List1 := TMyObj1683_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
