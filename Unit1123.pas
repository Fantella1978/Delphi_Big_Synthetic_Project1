...
type
  ...
  TMyObj1123_List0 = TObjectList<TMyObj1123>;

  TMyObj1123_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1123_List1 = TObjectList<TMyObj1123_1>;
...
constructor TMyObj1123_1.Create;
begin
  inherited;
  FInt := 1123 * 3;
  FTest := 'Value: ' + Random(211232).ToString + Random(112300).ToString;
end;

procedure TForm1123.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1123;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1123_List0 := TMyObj1123_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1123_List1 := TMyObj1123_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
