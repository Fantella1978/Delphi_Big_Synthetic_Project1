...
type
  ...
  TMyObj2110_List0 = TObjectList<TMyObj2110>;

  TMyObj2110_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2110_List1 = TObjectList<TMyObj2110_1>;
...
constructor TMyObj2110_1.Create;
begin
  inherited;
  FInt := 2110 * 3;
  FTest := 'Value: ' + Random(221102).ToString + Random(211000).ToString;
end;

procedure TForm2110.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2110;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21100).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21105).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21107).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2110_List0 := TMyObj2110_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2110_List1 := TMyObj2110_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
