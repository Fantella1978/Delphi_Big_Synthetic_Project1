...
type
  ...
  TMyObj1630_List0 = TObjectList<TMyObj1630>;

  TMyObj1630_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1630_List1 = TObjectList<TMyObj1630_1>;
...
constructor TMyObj1630_1.Create;
begin
  inherited;
  FInt := 1630 * 3;
  FTest := 'Value: ' + Random(216302).ToString + Random(163000).ToString;
end;

procedure TForm1630.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1630;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1630_List0 := TMyObj1630_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1630_List1 := TMyObj1630_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
