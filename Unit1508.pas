...
type
  ...
  TMyObj1508_List0 = TObjectList<TMyObj1508>;

  TMyObj1508_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1508_List1 = TObjectList<TMyObj1508_1>;
...
constructor TMyObj1508_1.Create;
begin
  inherited;
  FInt := 1508 * 3;
  FTest := 'Value: ' + Random(215082).ToString + Random(150800).ToString;
end;

procedure TForm1508.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1508;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1508_List0 := TMyObj1508_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1508_List1 := TMyObj1508_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
