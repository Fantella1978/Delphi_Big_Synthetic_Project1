...
type
  ...
  TMyObj2279_List0 = TObjectList<TMyObj2279>;

  TMyObj2279_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2279_List1 = TObjectList<TMyObj2279_1>;
...
constructor TMyObj2279_1.Create;
begin
  inherited;
  FInt := 2279 * 3;
  FTest := 'Value: ' + Random(222792).ToString + Random(227900).ToString;
end;

procedure TForm2279.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2279;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2279_List0 := TMyObj2279_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2279_List1 := TMyObj2279_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
