...
type
  ...
  TMyObj1251_List0 = TObjectList<TMyObj1251>;

  TMyObj1251_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1251_List1 = TObjectList<TMyObj1251_1>;
...
constructor TMyObj1251_1.Create;
begin
  inherited;
  FInt := 1251 * 3;
  FTest := 'Value: ' + Random(212512).ToString + Random(125100).ToString;
end;

procedure TForm1251.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1251;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12510).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12515).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12517).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1251_List0 := TMyObj1251_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1251_List1 := TMyObj1251_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
