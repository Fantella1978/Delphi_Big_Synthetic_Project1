...
type
  ...
  TMyObj2444_List0 = TObjectList<TMyObj2444>;

  TMyObj2444_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2444_List1 = TObjectList<TMyObj2444_1>;
...
constructor TMyObj2444_1.Create;
begin
  inherited;
  FInt := 2444 * 3;
  FTest := 'Value: ' + Random(224442).ToString + Random(244400).ToString;
end;

procedure TForm2444.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2444;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2444_List0 := TMyObj2444_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2444_List1 := TMyObj2444_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
