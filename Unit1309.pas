...
type
  ...
  TMyObj1309_List0 = TObjectList<TMyObj1309>;

  TMyObj1309_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1309_List1 = TObjectList<TMyObj1309_1>;
...
constructor TMyObj1309_1.Create;
begin
  inherited;
  FInt := 1309 * 3;
  FTest := 'Value: ' + Random(213092).ToString + Random(130900).ToString;
end;

procedure TForm1309.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1309;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1309_List0 := TMyObj1309_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1309_List1 := TMyObj1309_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
