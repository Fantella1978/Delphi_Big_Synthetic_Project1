...
type
  ...
  TMyObj885_List0 = TObjectList<TMyObj885>;

  TMyObj885_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj885_List1 = TObjectList<TMyObj885_1>;
...
constructor TMyObj885_1.Create;
begin
  inherited;
  FInt := 885 * 3;
  FTest := 'Value: ' + Random(28852).ToString + Random(88500).ToString;
end;

procedure TForm885.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum885;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj885_List0 := TMyObj885_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj885_List1 := TMyObj885_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
