...
type
  ...
  TMyObj1893_List0 = TObjectList<TMyObj1893>;

  TMyObj1893_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1893_List1 = TObjectList<TMyObj1893_1>;
...
constructor TMyObj1893_1.Create;
begin
  inherited;
  FInt := 1893 * 3;
  FTest := 'Value: ' + Random(218932).ToString + Random(189300).ToString;
end;

procedure TForm1893.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1893;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1893_List0 := TMyObj1893_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1893_List1 := TMyObj1893_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
