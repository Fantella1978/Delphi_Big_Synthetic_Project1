...
type
  ...
  TMyObj1241_List0 = TObjectList<TMyObj1241>;

  TMyObj1241_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1241_List1 = TObjectList<TMyObj1241_1>;
...
constructor TMyObj1241_1.Create;
begin
  inherited;
  FInt := 1241 * 3;
  FTest := 'Value: ' + Random(212412).ToString + Random(124100).ToString;
end;

procedure TForm1241.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1241;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12410).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12415).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12417).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1241_List0 := TMyObj1241_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1241_List1 := TMyObj1241_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
