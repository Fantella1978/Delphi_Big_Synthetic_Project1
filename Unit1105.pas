...
type
  ...
  TMyObj1105_List0 = TObjectList<TMyObj1105>;

  TMyObj1105_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1105_List1 = TObjectList<TMyObj1105_1>;
...
constructor TMyObj1105_1.Create;
begin
  inherited;
  FInt := 1105 * 3;
  FTest := 'Value: ' + Random(211052).ToString + Random(110500).ToString;
end;

procedure TForm1105.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1105;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11050).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11055).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11057).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1105_List0 := TMyObj1105_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1105_List1 := TMyObj1105_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
