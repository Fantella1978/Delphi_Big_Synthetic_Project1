...
type
  ...
  TMyObj638_List0 = TObjectList<TMyObj638>;

  TMyObj638_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj638_List1 = TObjectList<TMyObj638_1>;
...
constructor TMyObj638_1.Create;
begin
  inherited;
  FInt := 638 * 3;
  FTest := 'Value: ' + Random(26382).ToString + Random(63800).ToString;
end;

procedure TForm638.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum638;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6380).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6385).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6387).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj638_List0 := TMyObj638_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj638_List1 := TMyObj638_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
