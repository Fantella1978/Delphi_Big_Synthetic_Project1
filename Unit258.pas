...
type
  ...
  TMyObj258_List0 = TObjectList<TMyObj258>;

  TMyObj258_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj258_List1 = TObjectList<TMyObj258_1>;
...
constructor TMyObj258_1.Create;
begin
  inherited;
  FInt := 258 * 3;
  FTest := 'Value: ' + Random(22582).ToString + Random(25800).ToString;
end;

procedure TForm258.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum258;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj258_List0 := TMyObj258_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj258_List1 := TMyObj258_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
