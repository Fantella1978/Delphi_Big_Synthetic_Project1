...
type
  ...
  TMyObj71_List0 = TObjectList<TMyObj71>;

  TMyObj71_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj71_List1 = TObjectList<TMyObj71_1>;
...
constructor TMyObj71_1.Create;
begin
  inherited;
  FInt := 71 * 3;
  FTest := 'Value: ' + Random(2712).ToString + Random(7100).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj71_List0 := TMyObj71_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj71_List1 := TMyObj71_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
