...
type
  ...
  TMyObj660_List0 = TObjectList<TMyObj660>;

  TMyObj660_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj660_List1 = TObjectList<TMyObj660_1>;
...
constructor TMyObj660_1.Create;
begin
  inherited;
  FInt := 660 * 3;
  FTest := 'Value: ' + Random(26602).ToString + Random(66000).ToString;
end;

procedure TForm660.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum660;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj660_List0 := TMyObj660_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj660_List1 := TMyObj660_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
