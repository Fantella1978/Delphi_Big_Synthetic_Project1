...
type
  ...
  TMyObj583_List0 = TObjectList<TMyObj583>;

  TMyObj583_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj583_List1 = TObjectList<TMyObj583_1>;
...
constructor TMyObj583_1.Create;
begin
  inherited;
  FInt := 583 * 3;
  FTest := 'Value: ' + Random(25832).ToString + Random(58300).ToString;
end;

procedure TForm583.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum583;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5830).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5835).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5837).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj583_List0 := TMyObj583_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj583_List1 := TMyObj583_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
