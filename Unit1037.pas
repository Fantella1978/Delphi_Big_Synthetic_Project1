...
type
  ...
  TMyObj1037_List0 = TObjectList<TMyObj1037>;

  TMyObj1037_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1037_List1 = TObjectList<TMyObj1037_1>;
...
constructor TMyObj1037_1.Create;
begin
  inherited;
  FInt := 1037 * 3;
  FTest := 'Value: ' + Random(210372).ToString + Random(103700).ToString;
end;

procedure TForm1037.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1037;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10370).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10375).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10377).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1037_List0 := TMyObj1037_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1037_List1 := TMyObj1037_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
