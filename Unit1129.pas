...
type
  ...
  TMyObj1129_List0 = TObjectList<TMyObj1129>;

  TMyObj1129_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1129_List1 = TObjectList<TMyObj1129_1>;
...
constructor TMyObj1129_1.Create;
begin
  inherited;
  FInt := 1129 * 3;
  FTest := 'Value: ' + Random(211292).ToString + Random(112900).ToString;
end;

procedure TForm1129.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1129;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11290).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11295).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11297).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1129_List0 := TMyObj1129_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1129_List1 := TMyObj1129_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
