...
type
  ...
  TMyObj2028_List0 = TObjectList<TMyObj2028>;

  TMyObj2028_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2028_List1 = TObjectList<TMyObj2028_1>;
...
constructor TMyObj2028_1.Create;
begin
  inherited;
  FInt := 2028 * 3;
  FTest := 'Value: ' + Random(220282).ToString + Random(202800).ToString;
end;

procedure TForm2028.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2028;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(20280).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(20285).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(20287).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2028_List0 := TMyObj2028_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2028_List1 := TMyObj2028_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
