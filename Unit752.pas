...
type
  ...
  TMyObj752_List0 = TObjectList<TMyObj752>;

  TMyObj752_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj752_List1 = TObjectList<TMyObj752_1>;
...
constructor TMyObj752_1.Create;
begin
  inherited;
  FInt := 752 * 3;
  FTest := 'Value: ' + Random(27522).ToString + Random(75200).ToString;
end;

procedure TForm752.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum752;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7520).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7525).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7527).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj752_List0 := TMyObj752_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj752_List1 := TMyObj752_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
