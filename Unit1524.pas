...
type
  ...
  TMyObj1524_List0 = TObjectList<TMyObj1524>;

  TMyObj1524_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1524_List1 = TObjectList<TMyObj1524_1>;
...
constructor TMyObj1524_1.Create;
begin
  inherited;
  FInt := 1524 * 3;
  FTest := 'Value: ' + Random(215242).ToString + Random(152400).ToString;
end;

procedure TForm1524.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1524;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1524_List0 := TMyObj1524_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1524_List1 := TMyObj1524_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
