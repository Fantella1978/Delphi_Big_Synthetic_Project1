...
type
  ...
  TMyObj899_List0 = TObjectList<TMyObj899>;

  TMyObj899_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj899_List1 = TObjectList<TMyObj899_1>;
...
constructor TMyObj899_1.Create;
begin
  inherited;
  FInt := 899 * 3;
  FTest := 'Value: ' + Random(28992).ToString + Random(89900).ToString;
end;

procedure TForm899.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum899;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8990).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8995).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8997).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj899_List0 := TMyObj899_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj899_List1 := TMyObj899_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
