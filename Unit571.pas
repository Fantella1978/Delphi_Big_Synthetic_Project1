...
type
  ...
  TMyObj571_List0 = TObjectList<TMyObj571>;

  TMyObj571_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj571_List1 = TObjectList<TMyObj571_1>;
...
constructor TMyObj571_1.Create;
begin
  inherited;
  FInt := 571 * 3;
  FTest := 'Value: ' + Random(25712).ToString + Random(57100).ToString;
end;

procedure TForm571.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum571;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj571_List0 := TMyObj571_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj571_List1 := TMyObj571_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
