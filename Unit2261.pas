...
type
  ...
  TMyObj2261_List0 = TObjectList<TMyObj2261>;

  TMyObj2261_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2261_List1 = TObjectList<TMyObj2261_1>;
...
constructor TMyObj2261_1.Create;
begin
  inherited;
  FInt := 2261 * 3;
  FTest := 'Value: ' + Random(222612).ToString + Random(226100).ToString;
end;

procedure TForm2261.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2261;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22610).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22615).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22617).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2261_List0 := TMyObj2261_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2261_List1 := TMyObj2261_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
