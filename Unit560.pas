...
type
  ...
  TMyObj560_List0 = TObjectList<TMyObj560>;

  TMyObj560_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj560_List1 = TObjectList<TMyObj560_1>;
...
constructor TMyObj560_1.Create;
begin
  inherited;
  FInt := 560 * 3;
  FTest := 'Value: ' + Random(25602).ToString + Random(56000).ToString;
end;

procedure TForm560.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum560;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj560_List0 := TMyObj560_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj560_List1 := TMyObj560_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
