...
type
  ...
  TMyObj1267_List0 = TObjectList<TMyObj1267>;

  TMyObj1267_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1267_List1 = TObjectList<TMyObj1267_1>;
...
constructor TMyObj1267_1.Create;
begin
  inherited;
  FInt := 1267 * 3;
  FTest := 'Value: ' + Random(212672).ToString + Random(126700).ToString;
end;

procedure TForm1267.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1267;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1267_List0 := TMyObj1267_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1267_List1 := TMyObj1267_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
