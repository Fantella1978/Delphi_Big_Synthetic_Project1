...
type
  ...
  TMyObj1818_List0 = TObjectList<TMyObj1818>;

  TMyObj1818_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1818_List1 = TObjectList<TMyObj1818_1>;
...
constructor TMyObj1818_1.Create;
begin
  inherited;
  FInt := 1818 * 3;
  FTest := 'Value: ' + Random(218182).ToString + Random(181800).ToString;
end;

procedure TForm1818.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1818;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18180).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18185).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18187).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1818_List0 := TMyObj1818_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1818_List1 := TMyObj1818_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
