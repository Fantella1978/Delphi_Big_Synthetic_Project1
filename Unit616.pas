...
type
  ...
  TMyObj616_List0 = TObjectList<TMyObj616>;

  TMyObj616_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj616_List1 = TObjectList<TMyObj616_1>;
...
constructor TMyObj616_1.Create;
begin
  inherited;
  FInt := 616 * 3;
  FTest := 'Value: ' + Random(26162).ToString + Random(61600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj616_List0 := TMyObj616_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj616_List1 := TMyObj616_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
