...
type
  ...
  TMyObj762_List0 = TObjectList<TMyObj762>;

  TMyObj762_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj762_List1 = TObjectList<TMyObj762_1>;
...
constructor TMyObj762_1.Create;
begin
  inherited;
  FInt := 762 * 3;
  FTest := 'Value: ' + Random(27622).ToString + Random(76200).ToString;
end;

procedure TForm762.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum762;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7620).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7625).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7627).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj762_List0 := TMyObj762_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj762_List1 := TMyObj762_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
