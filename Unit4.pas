...
type
  ...
  TMyObj4_List0 = TObjectList<TMyObj4>;

  TMyObj4_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj4_List1 = TObjectList<TMyObj4_1>;
...
constructor TMyObj4_1.Create;
begin
  inherited;
  FInt := 4 * 3;
  FTest := 'Value: ' + Random(242).ToString + Random(400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(40).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(45).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(47).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj4_List0 := TMyObj4_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj4_List1 := TMyObj4_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
