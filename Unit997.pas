...
type
  ...
  TMyObj997_List0 = TObjectList<TMyObj997>;

  TMyObj997_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj997_List1 = TObjectList<TMyObj997_1>;
...
constructor TMyObj997_1.Create;
begin
  inherited;
  FInt := 997 * 3;
  FTest := 'Value: ' + Random(29972).ToString + Random(99700).ToString;
end;

procedure TForm997.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum997;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj997_List0 := TMyObj997_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj997_List1 := TMyObj997_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
