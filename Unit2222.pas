...
type
  ...
  TMyObj2222_List0 = TObjectList<TMyObj2222>;

  TMyObj2222_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2222_List1 = TObjectList<TMyObj2222_1>;
...
constructor TMyObj2222_1.Create;
begin
  inherited;
  FInt := 2222 * 3;
  FTest := 'Value: ' + Random(222222).ToString + Random(222200).ToString;
end;

procedure TForm2222.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2222;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2222_List0 := TMyObj2222_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2222_List1 := TMyObj2222_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
