...
type
  ...
  TMyObj912_List0 = TObjectList<TMyObj912>;

  TMyObj912_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj912_List1 = TObjectList<TMyObj912_1>;
...
constructor TMyObj912_1.Create;
begin
  inherited;
  FInt := 912 * 3;
  FTest := 'Value: ' + Random(29122).ToString + Random(91200).ToString;
end;

procedure TForm912.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum912;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj912_List0 := TMyObj912_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj912_List1 := TMyObj912_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
