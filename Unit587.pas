...
type
  ...
  TMyObj587_List0 = TObjectList<TMyObj587>;

  TMyObj587_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj587_List1 = TObjectList<TMyObj587_1>;
...
constructor TMyObj587_1.Create;
begin
  inherited;
  FInt := 587 * 3;
  FTest := 'Value: ' + Random(25872).ToString + Random(58700).ToString;
end;

procedure TForm587.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum587;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5870).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5875).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5877).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj587_List0 := TMyObj587_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj587_List1 := TMyObj587_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
