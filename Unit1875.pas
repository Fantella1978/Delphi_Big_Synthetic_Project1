...
type
  ...
  TMyObj1875_List0 = TObjectList<TMyObj1875>;

  TMyObj1875_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1875_List1 = TObjectList<TMyObj1875_1>;
...
constructor TMyObj1875_1.Create;
begin
  inherited;
  FInt := 1875 * 3;
  FTest := 'Value: ' + Random(218752).ToString + Random(187500).ToString;
end;

procedure TForm1875.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1875;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1875_List0 := TMyObj1875_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1875_List1 := TMyObj1875_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
