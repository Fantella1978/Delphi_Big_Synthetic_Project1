...
type
  ...
  TMyObj67_List0 = TObjectList<TMyObj67>;

  TMyObj67_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj67_List1 = TObjectList<TMyObj67_1>;
...
constructor TMyObj67_1.Create;
begin
  inherited;
  FInt := 67 * 3;
  FTest := 'Value: ' + Random(2672).ToString + Random(6700).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj67_List0 := TMyObj67_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj67_List1 := TMyObj67_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
