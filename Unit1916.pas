...
type
  ...
  TMyObj1916_List0 = TObjectList<TMyObj1916>;

  TMyObj1916_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1916_List1 = TObjectList<TMyObj1916_1>;
...
constructor TMyObj1916_1.Create;
begin
  inherited;
  FInt := 1916 * 3;
  FTest := 'Value: ' + Random(219162).ToString + Random(191600).ToString;
end;

procedure TForm1916.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1916;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19160).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19165).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19167).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1916_List0 := TMyObj1916_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1916_List1 := TMyObj1916_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
