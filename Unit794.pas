...
type
  ...
  TMyObj794_List0 = TObjectList<TMyObj794>;

  TMyObj794_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj794_List1 = TObjectList<TMyObj794_1>;
...
constructor TMyObj794_1.Create;
begin
  inherited;
  FInt := 794 * 3;
  FTest := 'Value: ' + Random(27942).ToString + Random(79400).ToString;
end;

procedure TForm794.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum794;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj794_List0 := TMyObj794_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj794_List1 := TMyObj794_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
