...
type
  ...
  TMyObj164_List0 = TObjectList<TMyObj164>;

  TMyObj164_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj164_List1 = TObjectList<TMyObj164_1>;
...
constructor TMyObj164_1.Create;
begin
  inherited;
  FInt := 164 * 3;
  FTest := 'Value: ' + Random(21642).ToString + Random(16400).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1640).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1645).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1647).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj164_List0 := TMyObj164_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj164_List1 := TMyObj164_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
