...
type
  ...
  TMyObj1649_List0 = TObjectList<TMyObj1649>;

  TMyObj1649_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1649_List1 = TObjectList<TMyObj1649_1>;
...
constructor TMyObj1649_1.Create;
begin
  inherited;
  FInt := 1649 * 3;
  FTest := 'Value: ' + Random(216492).ToString + Random(164900).ToString;
end;

procedure TForm1649.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1649;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1649_List0 := TMyObj1649_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1649_List1 := TMyObj1649_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
