...
type
  ...
  TMyObj1422_List0 = TObjectList<TMyObj1422>;

  TMyObj1422_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1422_List1 = TObjectList<TMyObj1422_1>;
...
constructor TMyObj1422_1.Create;
begin
  inherited;
  FInt := 1422 * 3;
  FTest := 'Value: ' + Random(214222).ToString + Random(142200).ToString;
end;

procedure TForm1422.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1422;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1422_List0 := TMyObj1422_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1422_List1 := TMyObj1422_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
