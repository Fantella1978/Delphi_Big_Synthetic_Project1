...
type
  ...
  TMyObj1455_List0 = TObjectList<TMyObj1455>;

  TMyObj1455_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1455_List1 = TObjectList<TMyObj1455_1>;
...
constructor TMyObj1455_1.Create;
begin
  inherited;
  FInt := 1455 * 3;
  FTest := 'Value: ' + Random(214552).ToString + Random(145500).ToString;
end;

procedure TForm1455.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1455;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14550).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14555).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14557).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1455_List0 := TMyObj1455_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1455_List1 := TMyObj1455_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
