...
type
  ...
  TMyObj1219_List0 = TObjectList<TMyObj1219>;

  TMyObj1219_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1219_List1 = TObjectList<TMyObj1219_1>;
...
constructor TMyObj1219_1.Create;
begin
  inherited;
  FInt := 1219 * 3;
  FTest := 'Value: ' + Random(212192).ToString + Random(121900).ToString;
end;

procedure TForm1219.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1219;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12190).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12195).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12197).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1219_List0 := TMyObj1219_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1219_List1 := TMyObj1219_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
