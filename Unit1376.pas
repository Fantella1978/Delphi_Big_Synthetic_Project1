...
type
  ...
  TMyObj1376_List0 = TObjectList<TMyObj1376>;

  TMyObj1376_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1376_List1 = TObjectList<TMyObj1376_1>;
...
constructor TMyObj1376_1.Create;
begin
  inherited;
  FInt := 1376 * 3;
  FTest := 'Value: ' + Random(213762).ToString + Random(137600).ToString;
end;

procedure TForm1376.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1376;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13760).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13765).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13767).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1376_List0 := TMyObj1376_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1376_List1 := TMyObj1376_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
