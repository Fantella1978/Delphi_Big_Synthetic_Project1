...
type
  ...
  TMyObj1892_List0 = TObjectList<TMyObj1892>;

  TMyObj1892_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1892_List1 = TObjectList<TMyObj1892_1>;
...
constructor TMyObj1892_1.Create;
begin
  inherited;
  FInt := 1892 * 3;
  FTest := 'Value: ' + Random(218922).ToString + Random(189200).ToString;
end;

procedure TForm1892.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1892;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18920).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18925).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18927).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1892_List0 := TMyObj1892_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1892_List1 := TMyObj1892_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
