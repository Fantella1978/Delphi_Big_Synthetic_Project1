...
type
  ...
  TMyObj1898_List0 = TObjectList<TMyObj1898>;

  TMyObj1898_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1898_List1 = TObjectList<TMyObj1898_1>;
...
constructor TMyObj1898_1.Create;
begin
  inherited;
  FInt := 1898 * 3;
  FTest := 'Value: ' + Random(218982).ToString + Random(189800).ToString;
end;

procedure TForm1898.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1898;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(18980).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(18985).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(18987).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1898_List0 := TMyObj1898_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1898_List1 := TMyObj1898_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
