...
type
  ...
  TMyObj1471_List0 = TObjectList<TMyObj1471>;

  TMyObj1471_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1471_List1 = TObjectList<TMyObj1471_1>;
...
constructor TMyObj1471_1.Create;
begin
  inherited;
  FInt := 1471 * 3;
  FTest := 'Value: ' + Random(214712).ToString + Random(147100).ToString;
end;

procedure TForm1471.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1471;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1471_List0 := TMyObj1471_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1471_List1 := TMyObj1471_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
