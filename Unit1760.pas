...
type
  ...
  TMyObj1760_List0 = TObjectList<TMyObj1760>;

  TMyObj1760_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1760_List1 = TObjectList<TMyObj1760_1>;
...
constructor TMyObj1760_1.Create;
begin
  inherited;
  FInt := 1760 * 3;
  FTest := 'Value: ' + Random(217602).ToString + Random(176000).ToString;
end;

procedure TForm1760.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1760;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17600).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17605).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17607).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1760_List0 := TMyObj1760_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1760_List1 := TMyObj1760_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
