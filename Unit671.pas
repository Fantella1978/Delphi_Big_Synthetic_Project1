...
type
  ...
  TMyObj671_List0 = TObjectList<TMyObj671>;

  TMyObj671_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj671_List1 = TObjectList<TMyObj671_1>;
...
constructor TMyObj671_1.Create;
begin
  inherited;
  FInt := 671 * 3;
  FTest := 'Value: ' + Random(26712).ToString + Random(67100).ToString;
end;

procedure TForm671.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum671;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj671_List0 := TMyObj671_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj671_List1 := TMyObj671_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
