...
type
  ...
  TMyObj2158_List0 = TObjectList<TMyObj2158>;

  TMyObj2158_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2158_List1 = TObjectList<TMyObj2158_1>;
...
constructor TMyObj2158_1.Create;
begin
  inherited;
  FInt := 2158 * 3;
  FTest := 'Value: ' + Random(221582).ToString + Random(215800).ToString;
end;

procedure TForm2158.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2158;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21580).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21585).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21587).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2158_List0 := TMyObj2158_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2158_List1 := TMyObj2158_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
