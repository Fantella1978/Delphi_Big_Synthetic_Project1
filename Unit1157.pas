...
type
  ...
  TMyObj1157_List0 = TObjectList<TMyObj1157>;

  TMyObj1157_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1157_List1 = TObjectList<TMyObj1157_1>;
...
constructor TMyObj1157_1.Create;
begin
  inherited;
  FInt := 1157 * 3;
  FTest := 'Value: ' + Random(211572).ToString + Random(115700).ToString;
end;

procedure TForm1157.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1157;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11570).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11575).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11577).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1157_List0 := TMyObj1157_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1157_List1 := TMyObj1157_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
