...
type
  ...
  TMyObj1611_List0 = TObjectList<TMyObj1611>;

  TMyObj1611_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1611_List1 = TObjectList<TMyObj1611_1>;
...
constructor TMyObj1611_1.Create;
begin
  inherited;
  FInt := 1611 * 3;
  FTest := 'Value: ' + Random(216112).ToString + Random(161100).ToString;
end;

procedure TForm1611.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1611;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(16110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(16115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(16117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1611_List0 := TMyObj1611_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1611_List1 := TMyObj1611_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
