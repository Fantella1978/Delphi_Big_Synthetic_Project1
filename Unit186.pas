...
type
  ...
  TMyObj186_List0 = TObjectList<TMyObj186>;

  TMyObj186_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj186_List1 = TObjectList<TMyObj186_1>;
...
constructor TMyObj186_1.Create;
begin
  inherited;
  FInt := 186 * 3;
  FTest := 'Value: ' + Random(21862).ToString + Random(18600).ToString;
end;

procedure TForm186.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum186;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj186_List0 := TMyObj186_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj186_List1 := TMyObj186_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
