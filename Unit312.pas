...
type
  ...
  TMyObj312_List0 = TObjectList<TMyObj312>;

  TMyObj312_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj312_List1 = TObjectList<TMyObj312_1>;
...
constructor TMyObj312_1.Create;
begin
  inherited;
  FInt := 312 * 3;
  FTest := 'Value: ' + Random(23122).ToString + Random(31200).ToString;
end;

procedure TForm312.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum312;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3120).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3125).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3127).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj312_List0 := TMyObj312_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj312_List1 := TMyObj312_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
