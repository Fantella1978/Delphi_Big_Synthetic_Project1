...
type
  ...
  TMyObj836_List0 = TObjectList<TMyObj836>;

  TMyObj836_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj836_List1 = TObjectList<TMyObj836_1>;
...
constructor TMyObj836_1.Create;
begin
  inherited;
  FInt := 836 * 3;
  FTest := 'Value: ' + Random(28362).ToString + Random(83600).ToString;
end;

procedure TForm836.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum836;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8360).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8365).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8367).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj836_List0 := TMyObj836_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj836_List1 := TMyObj836_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
