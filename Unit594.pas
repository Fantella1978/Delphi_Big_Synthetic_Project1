...
type
  ...
  TMyObj594_List0 = TObjectList<TMyObj594>;

  TMyObj594_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj594_List1 = TObjectList<TMyObj594_1>;
...
constructor TMyObj594_1.Create;
begin
  inherited;
  FInt := 594 * 3;
  FTest := 'Value: ' + Random(25942).ToString + Random(59400).ToString;
end;

procedure TForm594.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum594;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5940).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5945).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5947).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj594_List0 := TMyObj594_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj594_List1 := TMyObj594_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
