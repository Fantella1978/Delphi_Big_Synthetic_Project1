...
type
  ...
  TMyObj1413_List0 = TObjectList<TMyObj1413>;

  TMyObj1413_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1413_List1 = TObjectList<TMyObj1413_1>;
...
constructor TMyObj1413_1.Create;
begin
  inherited;
  FInt := 1413 * 3;
  FTest := 'Value: ' + Random(214132).ToString + Random(141300).ToString;
end;

procedure TForm1413.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1413;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1413_List0 := TMyObj1413_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1413_List1 := TMyObj1413_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
