...
type
  ...
  TMyObj427_List0 = TObjectList<TMyObj427>;

  TMyObj427_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj427_List1 = TObjectList<TMyObj427_1>;
...
constructor TMyObj427_1.Create;
begin
  inherited;
  FInt := 427 * 3;
  FTest := 'Value: ' + Random(24272).ToString + Random(42700).ToString;
end;

procedure TForm427.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum427;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(4270).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(4275).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(4277).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj427_List0 := TMyObj427_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj427_List1 := TMyObj427_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
