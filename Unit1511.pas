...
type
  ...
  TMyObj1511_List0 = TObjectList<TMyObj1511>;

  TMyObj1511_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1511_List1 = TObjectList<TMyObj1511_1>;
...
constructor TMyObj1511_1.Create;
begin
  inherited;
  FInt := 1511 * 3;
  FTest := 'Value: ' + Random(215112).ToString + Random(151100).ToString;
end;

procedure TForm1511.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1511;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15110).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15115).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15117).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1511_List0 := TMyObj1511_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1511_List1 := TMyObj1511_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
