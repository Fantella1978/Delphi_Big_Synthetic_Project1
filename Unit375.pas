...
type
  ...
  TMyObj375_List0 = TObjectList<TMyObj375>;

  TMyObj375_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj375_List1 = TObjectList<TMyObj375_1>;
...
constructor TMyObj375_1.Create;
begin
  inherited;
  FInt := 375 * 3;
  FTest := 'Value: ' + Random(23752).ToString + Random(37500).ToString;
end;

procedure TForm375.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum375;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3750).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3755).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3757).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj375_List0 := TMyObj375_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj375_List1 := TMyObj375_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
