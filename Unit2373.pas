...
type
  ...
  TMyObj2373_List0 = TObjectList<TMyObj2373>;

  TMyObj2373_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2373_List1 = TObjectList<TMyObj2373_1>;
...
constructor TMyObj2373_1.Create;
begin
  inherited;
  FInt := 2373 * 3;
  FTest := 'Value: ' + Random(223732).ToString + Random(237300).ToString;
end;

procedure TForm2373.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2373;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23730).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23735).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23737).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2373_List0 := TMyObj2373_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2373_List1 := TMyObj2373_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
