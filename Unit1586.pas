...
type
  ...
  TMyObj1586_List0 = TObjectList<TMyObj1586>;

  TMyObj1586_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1586_List1 = TObjectList<TMyObj1586_1>;
...
constructor TMyObj1586_1.Create;
begin
  inherited;
  FInt := 1586 * 3;
  FTest := 'Value: ' + Random(215862).ToString + Random(158600).ToString;
end;

procedure TForm1586.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1586;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15860).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15865).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15867).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1586_List0 := TMyObj1586_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1586_List1 := TMyObj1586_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
