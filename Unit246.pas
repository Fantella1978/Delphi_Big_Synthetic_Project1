...
type
  ...
  TMyObj246_List0 = TObjectList<TMyObj246>;

  TMyObj246_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj246_List1 = TObjectList<TMyObj246_1>;
...
constructor TMyObj246_1.Create;
begin
  inherited;
  FInt := 246 * 3;
  FTest := 'Value: ' + Random(22462).ToString + Random(24600).ToString;
end;

procedure TForm246.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum246;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(2460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(2465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(2467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj246_List0 := TMyObj246_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj246_List1 := TMyObj246_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
