...
type
  ...
  TMyObj782_List0 = TObjectList<TMyObj782>;

  TMyObj782_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj782_List1 = TObjectList<TMyObj782_1>;
...
constructor TMyObj782_1.Create;
begin
  inherited;
  FInt := 782 * 3;
  FTest := 'Value: ' + Random(27822).ToString + Random(78200).ToString;
end;

procedure TForm782.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum782;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7820).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7825).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7827).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj782_List0 := TMyObj782_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj782_List1 := TMyObj782_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
