...
type
  ...
  TMyObj1133_List0 = TObjectList<TMyObj1133>;

  TMyObj1133_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1133_List1 = TObjectList<TMyObj1133_1>;
...
constructor TMyObj1133_1.Create;
begin
  inherited;
  FInt := 1133 * 3;
  FTest := 'Value: ' + Random(211332).ToString + Random(113300).ToString;
end;

procedure TForm1133.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1133;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1133_List0 := TMyObj1133_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1133_List1 := TMyObj1133_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
