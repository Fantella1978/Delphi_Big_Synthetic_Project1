...
type
  ...
  TMyObj1185_List0 = TObjectList<TMyObj1185>;

  TMyObj1185_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1185_List1 = TObjectList<TMyObj1185_1>;
...
constructor TMyObj1185_1.Create;
begin
  inherited;
  FInt := 1185 * 3;
  FTest := 'Value: ' + Random(211852).ToString + Random(118500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(11850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(11855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(11857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1185_List0 := TMyObj1185_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1185_List1 := TMyObj1185_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
