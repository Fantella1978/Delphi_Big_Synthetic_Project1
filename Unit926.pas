...
type
  ...
  TMyObj926_List0 = TObjectList<TMyObj926>;

  TMyObj926_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj926_List1 = TObjectList<TMyObj926_1>;
...
constructor TMyObj926_1.Create;
begin
  inherited;
  FInt := 926 * 3;
  FTest := 'Value: ' + Random(29262).ToString + Random(92600).ToString;
end;

procedure TForm926.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum926;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9260).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9265).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9267).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj926_List0 := TMyObj926_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj926_List1 := TMyObj926_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
