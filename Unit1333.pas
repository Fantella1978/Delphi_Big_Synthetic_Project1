...
type
  ...
  TMyObj1333_List0 = TObjectList<TMyObj1333>;

  TMyObj1333_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1333_List1 = TObjectList<TMyObj1333_1>;
...
constructor TMyObj1333_1.Create;
begin
  inherited;
  FInt := 1333 * 3;
  FTest := 'Value: ' + Random(213332).ToString + Random(133300).ToString;
end;

procedure TForm1333.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1333;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13330).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13335).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13337).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1333_List0 := TMyObj1333_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1333_List1 := TMyObj1333_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
