...
type
  ...
  TMyObj1304_List0 = TObjectList<TMyObj1304>;

  TMyObj1304_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1304_List1 = TObjectList<TMyObj1304_1>;
...
constructor TMyObj1304_1.Create;
begin
  inherited;
  FInt := 1304 * 3;
  FTest := 'Value: ' + Random(213042).ToString + Random(130400).ToString;
end;

procedure TForm1304.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1304;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(13040).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(13045).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(13047).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1304_List0 := TMyObj1304_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1304_List1 := TMyObj1304_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
