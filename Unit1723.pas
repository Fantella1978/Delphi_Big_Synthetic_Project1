...
type
  ...
  TMyObj1723_List0 = TObjectList<TMyObj1723>;

  TMyObj1723_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1723_List1 = TObjectList<TMyObj1723_1>;
...
constructor TMyObj1723_1.Create;
begin
  inherited;
  FInt := 1723 * 3;
  FTest := 'Value: ' + Random(217232).ToString + Random(172300).ToString;
end;

procedure TForm1723.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1723;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(17230).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(17235).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(17237).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1723_List0 := TMyObj1723_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1723_List1 := TMyObj1723_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
