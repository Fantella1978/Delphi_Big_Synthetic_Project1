...
type
  ...
  TMyObj1409_List0 = TObjectList<TMyObj1409>;

  TMyObj1409_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1409_List1 = TObjectList<TMyObj1409_1>;
...
constructor TMyObj1409_1.Create;
begin
  inherited;
  FInt := 1409 * 3;
  FTest := 'Value: ' + Random(214092).ToString + Random(140900).ToString;
end;

procedure TForm1409.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1409;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14090).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14095).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14097).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1409_List0 := TMyObj1409_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1409_List1 := TMyObj1409_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
