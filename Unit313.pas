...
type
  ...
  TMyObj313_List0 = TObjectList<TMyObj313>;

  TMyObj313_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj313_List1 = TObjectList<TMyObj313_1>;
...
constructor TMyObj313_1.Create;
begin
  inherited;
  FInt := 313 * 3;
  FTest := 'Value: ' + Random(23132).ToString + Random(31300).ToString;
end;

procedure TForm313.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum313;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3130).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3135).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3137).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj313_List0 := TMyObj313_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj313_List1 := TMyObj313_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
