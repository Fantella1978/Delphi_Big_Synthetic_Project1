...
type
  ...
  TMyObj2130_List0 = TObjectList<TMyObj2130>;

  TMyObj2130_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2130_List1 = TObjectList<TMyObj2130_1>;
...
constructor TMyObj2130_1.Create;
begin
  inherited;
  FInt := 2130 * 3;
  FTest := 'Value: ' + Random(221302).ToString + Random(213000).ToString;
end;

procedure TForm2130.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2130;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21300).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21305).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21307).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2130_List0 := TMyObj2130_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2130_List1 := TMyObj2130_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
