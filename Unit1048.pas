...
type
  ...
  TMyObj1048_List0 = TObjectList<TMyObj1048>;

  TMyObj1048_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1048_List1 = TObjectList<TMyObj1048_1>;
...
constructor TMyObj1048_1.Create;
begin
  inherited;
  FInt := 1048 * 3;
  FTest := 'Value: ' + Random(210482).ToString + Random(104800).ToString;
end;

procedure TForm1048.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1048;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10480).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10485).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10487).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1048_List0 := TMyObj1048_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1048_List1 := TMyObj1048_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
