...
type
  ...
  TMyObj1467_List0 = TObjectList<TMyObj1467>;

  TMyObj1467_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1467_List1 = TObjectList<TMyObj1467_1>;
...
constructor TMyObj1467_1.Create;
begin
  inherited;
  FInt := 1467 * 3;
  FTest := 'Value: ' + Random(214672).ToString + Random(146700).ToString;
end;

procedure TForm1467.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1467;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14670).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14675).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14677).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1467_List0 := TMyObj1467_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1467_List1 := TMyObj1467_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
