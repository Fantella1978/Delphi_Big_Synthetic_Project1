...
type
  ...
  TMyObj2332_List0 = TObjectList<TMyObj2332>;

  TMyObj2332_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2332_List1 = TObjectList<TMyObj2332_1>;
...
constructor TMyObj2332_1.Create;
begin
  inherited;
  FInt := 2332 * 3;
  FTest := 'Value: ' + Random(223322).ToString + Random(233200).ToString;
end;

procedure TForm2332.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2332;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2332_List0 := TMyObj2332_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2332_List1 := TMyObj2332_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
