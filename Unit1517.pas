...
type
  ...
  TMyObj1517_List0 = TObjectList<TMyObj1517>;

  TMyObj1517_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1517_List1 = TObjectList<TMyObj1517_1>;
...
constructor TMyObj1517_1.Create;
begin
  inherited;
  FInt := 1517 * 3;
  FTest := 'Value: ' + Random(215172).ToString + Random(151700).ToString;
end;

procedure TForm1517.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1517;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15170).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15175).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15177).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1517_List0 := TMyObj1517_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1517_List1 := TMyObj1517_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
