...
type
  ...
  TMyObj1466_List0 = TObjectList<TMyObj1466>;

  TMyObj1466_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1466_List1 = TObjectList<TMyObj1466_1>;
...
constructor TMyObj1466_1.Create;
begin
  inherited;
  FInt := 1466 * 3;
  FTest := 'Value: ' + Random(214662).ToString + Random(146600).ToString;
end;

procedure TForm1466.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1466;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14660).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14665).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14667).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1466_List0 := TMyObj1466_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1466_List1 := TMyObj1466_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
