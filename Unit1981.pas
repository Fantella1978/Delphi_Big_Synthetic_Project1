...
type
  ...
  TMyObj1981_List0 = TObjectList<TMyObj1981>;

  TMyObj1981_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1981_List1 = TObjectList<TMyObj1981_1>;
...
constructor TMyObj1981_1.Create;
begin
  inherited;
  FInt := 1981 * 3;
  FTest := 'Value: ' + Random(219812).ToString + Random(198100).ToString;
end;

procedure TForm1981.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1981;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(19810).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(19815).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(19817).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1981_List0 := TMyObj1981_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1981_List1 := TMyObj1981_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
