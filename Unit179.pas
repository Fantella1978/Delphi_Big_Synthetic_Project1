...
type
  ...
  TMyObj179_List0 = TObjectList<TMyObj179>;

  TMyObj179_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj179_List1 = TObjectList<TMyObj179_1>;
...
constructor TMyObj179_1.Create;
begin
  inherited;
  FInt := 179 * 3;
  FTest := 'Value: ' + Random(21792).ToString + Random(17900).ToString;
end;

procedure TForm179.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum179;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1790).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1795).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1797).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj179_List0 := TMyObj179_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj179_List1 := TMyObj179_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
