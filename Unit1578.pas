...
type
  ...
  TMyObj1578_List0 = TObjectList<TMyObj1578>;

  TMyObj1578_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1578_List1 = TObjectList<TMyObj1578_1>;
...
constructor TMyObj1578_1.Create;
begin
  inherited;
  FInt := 1578 * 3;
  FTest := 'Value: ' + Random(215782).ToString + Random(157800).ToString;
end;

procedure TForm1578.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1578;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(15780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(15785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(15787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1578_List0 := TMyObj1578_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1578_List1 := TMyObj1578_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
