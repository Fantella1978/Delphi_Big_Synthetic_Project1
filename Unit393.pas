...
type
  ...
  TMyObj393_List0 = TObjectList<TMyObj393>;

  TMyObj393_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj393_List1 = TObjectList<TMyObj393_1>;
...
constructor TMyObj393_1.Create;
begin
  inherited;
  FInt := 393 * 3;
  FTest := 'Value: ' + Random(23932).ToString + Random(39300).ToString;
end;

procedure TForm393.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum393;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(3930).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(3935).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(3937).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj393_List0 := TMyObj393_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj393_List1 := TMyObj393_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
