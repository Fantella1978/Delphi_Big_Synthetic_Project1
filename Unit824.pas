...
type
  ...
  TMyObj824_List0 = TObjectList<TMyObj824>;

  TMyObj824_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj824_List1 = TObjectList<TMyObj824_1>;
...
constructor TMyObj824_1.Create;
begin
  inherited;
  FInt := 824 * 3;
  FTest := 'Value: ' + Random(28242).ToString + Random(82400).ToString;
end;

procedure TForm824.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum824;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj824_List0 := TMyObj824_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj824_List1 := TMyObj824_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
