...
type
  ...
  TMyObj2208_List0 = TObjectList<TMyObj2208>;

  TMyObj2208_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2208_List1 = TObjectList<TMyObj2208_1>;
...
constructor TMyObj2208_1.Create;
begin
  inherited;
  FInt := 2208 * 3;
  FTest := 'Value: ' + Random(222082).ToString + Random(220800).ToString;
end;

procedure TForm2208.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2208;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(22080).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(22085).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(22087).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2208_List0 := TMyObj2208_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2208_List1 := TMyObj2208_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
