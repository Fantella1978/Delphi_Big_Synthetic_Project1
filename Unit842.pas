...
type
  ...
  TMyObj842_List0 = TObjectList<TMyObj842>;

  TMyObj842_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj842_List1 = TObjectList<TMyObj842_1>;
...
constructor TMyObj842_1.Create;
begin
  inherited;
  FInt := 842 * 3;
  FTest := 'Value: ' + Random(28422).ToString + Random(84200).ToString;
end;

procedure TForm842.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum842;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8420).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8425).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8427).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj842_List0 := TMyObj842_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj842_List1 := TMyObj842_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
