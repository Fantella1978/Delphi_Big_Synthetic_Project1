...
type
  ...
  TMyObj724_List0 = TObjectList<TMyObj724>;

  TMyObj724_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj724_List1 = TObjectList<TMyObj724_1>;
...
constructor TMyObj724_1.Create;
begin
  inherited;
  FInt := 724 * 3;
  FTest := 'Value: ' + Random(27242).ToString + Random(72400).ToString;
end;

procedure TForm724.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum724;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7240).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7245).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7247).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj724_List0 := TMyObj724_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj724_List1 := TMyObj724_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
