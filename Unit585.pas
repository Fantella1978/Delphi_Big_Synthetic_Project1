...
type
  ...
  TMyObj585_List0 = TObjectList<TMyObj585>;

  TMyObj585_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj585_List1 = TObjectList<TMyObj585_1>;
...
constructor TMyObj585_1.Create;
begin
  inherited;
  FInt := 585 * 3;
  FTest := 'Value: ' + Random(25852).ToString + Random(58500).ToString;
end;

procedure TForm585.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum585;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(5850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(5855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(5857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj585_List0 := TMyObj585_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj585_List1 := TMyObj585_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
