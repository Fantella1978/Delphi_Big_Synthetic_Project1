...
type
  ...
  TMyObj644_List0 = TObjectList<TMyObj644>;

  TMyObj644_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj644_List1 = TObjectList<TMyObj644_1>;
...
constructor TMyObj644_1.Create;
begin
  inherited;
  FInt := 644 * 3;
  FTest := 'Value: ' + Random(26442).ToString + Random(64400).ToString;
end;

procedure TForm644.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum644;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6440).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6445).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6447).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj644_List0 := TMyObj644_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj644_List1 := TMyObj644_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
