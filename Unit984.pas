...
type
  ...
  TMyObj984_List0 = TObjectList<TMyObj984>;

  TMyObj984_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj984_List1 = TObjectList<TMyObj984_1>;
...
constructor TMyObj984_1.Create;
begin
  inherited;
  FInt := 984 * 3;
  FTest := 'Value: ' + Random(29842).ToString + Random(98400).ToString;
end;

procedure TForm984.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum984;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(9840).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(9845).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(9847).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj984_List0 := TMyObj984_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj984_List1 := TMyObj984_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
