...
type
  ...
  TMyObj185_List0 = TObjectList<TMyObj185>;

  TMyObj185_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj185_List1 = TObjectList<TMyObj185_1>;
...
constructor TMyObj185_1.Create;
begin
  inherited;
  FInt := 185 * 3;
  FTest := 'Value: ' + Random(21852).ToString + Random(18500).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1850).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1855).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1857).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj185_List0 := TMyObj185_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj185_List1 := TMyObj185_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
