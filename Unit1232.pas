...
type
  ...
  TMyObj1232_List0 = TObjectList<TMyObj1232>;

  TMyObj1232_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1232_List1 = TObjectList<TMyObj1232_1>;
...
constructor TMyObj1232_1.Create;
begin
  inherited;
  FInt := 1232 * 3;
  FTest := 'Value: ' + Random(212322).ToString + Random(123200).ToString;
end;

procedure TForm1232.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1232;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12320).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12325).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12327).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1232_List0 := TMyObj1232_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1232_List1 := TMyObj1232_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
