...
type
  ...
  TMyObj139_List0 = TObjectList<TMyObj139>;

  TMyObj139_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj139_List1 = TObjectList<TMyObj139_1>;
...
constructor TMyObj139_1.Create;
begin
  inherited;
  FInt := 139 * 3;
  FTest := 'Value: ' + Random(21392).ToString + Random(13900).ToString;
end;

procedure TForm139.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum139;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj139_List0 := TMyObj139_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj139_List1 := TMyObj139_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
