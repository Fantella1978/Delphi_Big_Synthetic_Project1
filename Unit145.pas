...
type
  ...
  TMyObj145_List0 = TObjectList<TMyObj145>;

  TMyObj145_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj145_List1 = TObjectList<TMyObj145_1>;
...
constructor TMyObj145_1.Create;
begin
  inherited;
  FInt := 145 * 3;
  FTest := 'Value: ' + Random(21452).ToString + Random(14500).ToString;
end;

procedure TForm145.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum145;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1450).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1455).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1457).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj145_List0 := TMyObj145_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj145_List1 := TMyObj145_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
