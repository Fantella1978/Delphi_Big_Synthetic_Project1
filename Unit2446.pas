...
type
  ...
  TMyObj2446_List0 = TObjectList<TMyObj2446>;

  TMyObj2446_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2446_List1 = TObjectList<TMyObj2446_1>;
...
constructor TMyObj2446_1.Create;
begin
  inherited;
  FInt := 2446 * 3;
  FTest := 'Value: ' + Random(224462).ToString + Random(244600).ToString;
end;

procedure TForm2446.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2446;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24460).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24465).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24467).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2446_List0 := TMyObj2446_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2446_List1 := TMyObj2446_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
