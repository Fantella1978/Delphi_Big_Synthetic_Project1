...
type
  ...
  TMyObj2354_List0 = TObjectList<TMyObj2354>;

  TMyObj2354_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2354_List1 = TObjectList<TMyObj2354_1>;
...
constructor TMyObj2354_1.Create;
begin
  inherited;
  FInt := 2354 * 3;
  FTest := 'Value: ' + Random(223542).ToString + Random(235400).ToString;
end;

procedure TForm2354.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2354;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(23540).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(23545).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(23547).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2354_List0 := TMyObj2354_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2354_List1 := TMyObj2354_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
