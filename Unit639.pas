...
type
  ...
  TMyObj639_List0 = TObjectList<TMyObj639>;

  TMyObj639_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj639_List1 = TObjectList<TMyObj639_1>;
...
constructor TMyObj639_1.Create;
begin
  inherited;
  FInt := 639 * 3;
  FTest := 'Value: ' + Random(26392).ToString + Random(63900).ToString;
end;

procedure TForm639.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum639;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(6390).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(6395).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(6397).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj639_List0 := TMyObj639_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj639_List1 := TMyObj639_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
