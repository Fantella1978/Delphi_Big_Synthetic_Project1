...
type
  ...
  TMyObj2468_List0 = TObjectList<TMyObj2468>;

  TMyObj2468_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2468_List1 = TObjectList<TMyObj2468_1>;
...
constructor TMyObj2468_1.Create;
begin
  inherited;
  FInt := 2468 * 3;
  FTest := 'Value: ' + Random(224682).ToString + Random(246800).ToString;
end;

procedure TForm2468.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2468;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24680).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24685).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24687).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2468_List0 := TMyObj2468_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2468_List1 := TMyObj2468_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
