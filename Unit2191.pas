...
type
  ...
  TMyObj2191_List0 = TObjectList<TMyObj2191>;

  TMyObj2191_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2191_List1 = TObjectList<TMyObj2191_1>;
...
constructor TMyObj2191_1.Create;
begin
  inherited;
  FInt := 2191 * 3;
  FTest := 'Value: ' + Random(221912).ToString + Random(219100).ToString;
end;

procedure TForm2191.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2191;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21910).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21915).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21917).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2191_List0 := TMyObj2191_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2191_List1 := TMyObj2191_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
