...
type
  ...
  TMyObj722_List0 = TObjectList<TMyObj722>;

  TMyObj722_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj722_List1 = TObjectList<TMyObj722_1>;
...
constructor TMyObj722_1.Create;
begin
  inherited;
  FInt := 722 * 3;
  FTest := 'Value: ' + Random(27222).ToString + Random(72200).ToString;
end;

procedure TForm722.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum722;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(7220).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(7225).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(7227).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj722_List0 := TMyObj722_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj722_List1 := TMyObj722_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
