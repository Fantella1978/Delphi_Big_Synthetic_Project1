...
type
  ...
  TMyObj6_List0 = TObjectList<TMyObj6>;

  TMyObj6_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj6_List1 = TObjectList<TMyObj6_1>;
...
constructor TMyObj6_1.Create;
begin
  inherited;
  FInt := 6 * 3;
  FTest := 'Value: ' + Random(262).ToString + Random(600).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(60).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(65).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(67).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj6_List0 := TMyObj6_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj6_List1 := TMyObj6_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
