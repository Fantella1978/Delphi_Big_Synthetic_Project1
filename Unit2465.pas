...
type
  ...
  TMyObj2465_List0 = TObjectList<TMyObj2465>;

  TMyObj2465_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2465_List1 = TObjectList<TMyObj2465_1>;
...
constructor TMyObj2465_1.Create;
begin
  inherited;
  FInt := 2465 * 3;
  FTest := 'Value: ' + Random(224652).ToString + Random(246500).ToString;
end;

procedure TForm2465.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2465;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(24650).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(24655).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(24657).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2465_List0 := TMyObj2465_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2465_List1 := TMyObj2465_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
