...
type
  ...
  TMyObj103_List0 = TObjectList<TMyObj103>;

  TMyObj103_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj103_List1 = TObjectList<TMyObj103_1>;
...
constructor TMyObj103_1.Create;
begin
  inherited;
  FInt := 103 * 3;
  FTest := 'Value: ' + Random(21032).ToString + Random(10300).ToString;
end;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(1030).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(1035).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(1037).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj103_List0 := TMyObj103_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj103_List1 := TMyObj103_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
