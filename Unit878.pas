...
type
  ...
  TMyObj878_List0 = TObjectList<TMyObj878>;

  TMyObj878_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj878_List1 = TObjectList<TMyObj878_1>;
...
constructor TMyObj878_1.Create;
begin
  inherited;
  FInt := 878 * 3;
  FTest := 'Value: ' + Random(28782).ToString + Random(87800).ToString;
end;

procedure TForm878.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum878;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(8780).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(8785).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(8787).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj878_List0 := TMyObj878_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj878_List1 := TMyObj878_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
