...
type
  ...
  TMyObj1071_List0 = TObjectList<TMyObj1071>;

  TMyObj1071_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1071_List1 = TObjectList<TMyObj1071_1>;
...
constructor TMyObj1071_1.Create;
begin
  inherited;
  FInt := 1071 * 3;
  FTest := 'Value: ' + Random(210712).ToString + Random(107100).ToString;
end;

procedure TForm1071.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1071;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(10710).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(10715).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(10717).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1071_List0 := TMyObj1071_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1071_List1 := TMyObj1071_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
