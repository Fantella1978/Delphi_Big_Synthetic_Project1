...
type
  ...
  TMyObj1256_List0 = TObjectList<TMyObj1256>;

  TMyObj1256_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1256_List1 = TObjectList<TMyObj1256_1>;
...
constructor TMyObj1256_1.Create;
begin
  inherited;
  FInt := 1256 * 3;
  FTest := 'Value: ' + Random(212562).ToString + Random(125600).ToString;
end;

procedure TForm1256.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1256;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(12560).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(12565).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(12567).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1256_List0 := TMyObj1256_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1256_List1 := TMyObj1256_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
