...
type
  ...
  TMyObj2197_List0 = TObjectList<TMyObj2197>;

  TMyObj2197_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj2197_List1 = TObjectList<TMyObj2197_1>;
...
constructor TMyObj2197_1.Create;
begin
  inherited;
  FInt := 2197 * 3;
  FTest := 'Value: ' + Random(221972).ToString + Random(219700).ToString;
end;

procedure TForm2197.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum2197;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(21970).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(21975).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(21977).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj2197_List0 := TMyObj2197_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj2197_List1 := TMyObj2197_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
