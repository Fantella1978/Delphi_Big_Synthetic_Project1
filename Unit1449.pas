...
type
  ...
  TMyObj1449_List0 = TObjectList<TMyObj1449>;

  TMyObj1449_1 = class(TObject)
     strict private
        FInt: integer;
        FTest: string;
     public
  ...
  TMyObj1449_List1 = TObjectList<TMyObj1449_1>;
...
constructor TMyObj1449_1.Create;
begin
  inherited;
  FInt := 1449 * 3;
  FTest := 'Value: ' + Random(214492).ToString + Random(144900).ToString;
end;

procedure TForm1449.Button1Click(Sender: TObject);

  procedure CalculateProc2;
  var
    mas : array[1..1000] of RInum1449;
...
begin
  ...
  try
    FStList .Add('Line #: ' + Random(14490).ToString + ' ' + Random(500).ToString);
    FStList .Add('Line #: ' + Random(14495).ToString + ' ' + Random(600).ToString);
    FStList .Add('Line #: ' + Random(14497).ToString + ' ' + Random(1000).ToString);
    FStList .Sort;
  finally
    FreeAndNil(FStList);
  end;
...
initialization
  ...
  var o0: TMyObj1449_List0 := TMyObj1449_List0.Create;
  try
    o0.Sort;
  finally
    o0.Free;
  ...
  var o1: TMyObj1449_List1 := TMyObj1449_List1.Create;
  try
    o1.Sort;
  finally
    o1.Free;
